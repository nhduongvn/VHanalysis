...
#endif
void nC_medium_jets_signal_16_logY()
{
...
//=========  (Fri Mar 10 14:09:13 2023) by ROOT version 6.26/06
   ...
   nC_medium_jets_signal_16->Range(-2.683529,0.4519349,11.21633,2.929058);
   ...
   nC_medium_jets_signal_16->SetLogy();
   ...
   st_stack_31->SetMinimum(5.612932);
   st_stack_31->SetMaximum(480.1158);
