...
#endif
void GenJet_all_nGenJet_signal_16_logY()
{
...
//=========  (Fri Mar 10 12:49:21 2023) by ROOT version 6.26/06
   ...
   GenJet_all_nGenJet_signal_16->Range(-4.867058,-0.7654548,22.93266,2.834768);
   ...
   GenJet_all_nGenJet_signal_16->SetLogy();
   ...
   st_stack_1->SetMinimum(0.4640577);
   st_stack_1->SetMaximum(298.3633);
