...
#endif
void CvL_jets_all_signal_18_logY()
{
...
//=========  (Fri Mar 10 14:09:16 2023) by ROOT version 6.26/06
   ...
   CvL_jets_all_signal_18->Range(-0.2183529,0.120426,1.171633,4.337455);
   ...
   CvL_jets_all_signal_18->SetLogy();
   ...
   st->SetTitle("");
   st->SetMinimum(10);
   st->SetMaximum(5329.995);
   
   TH1F *st_stack_173 = new TH1F("st_stack_173","",20,0,1);
   st_stack_173->SetMinimum(4.231258);
   st_stack_173->SetMaximum(8236.683);
   ...
   st_stack_173->GetYaxis()->SetTitle("Event/0.05");
