...
#endif
void GenJet_all_nGenL_signal_18_logY()
{
...
//=========  (Fri Mar 10 12:49:21 2023) by ROOT version 6.26/06
   ...
   GenJet_all_nGenL_signal_18->Range(-4.867058,-0.8790922,22.93266,3.335296);
   ...
   GenJet_all_nGenL_signal_18->SetLogy();
   ...
   st_stack_11->SetMinimum(0.4232865);
   st_stack_11->SetMaximum(820.0818);
