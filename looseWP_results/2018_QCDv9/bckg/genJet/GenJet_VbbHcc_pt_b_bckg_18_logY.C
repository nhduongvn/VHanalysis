...
#endif
void GenJet_VbbHcc_pt_b_bckg_18_logY()
{
//=========Macro generated from canvas: GenJet_VbbHcc_pt_b_bckg_18/GenJet_VbbHcc_pt_b_bckg_18
//=========  (Fri Mar 10 12:49:25 2023) by ROOT version 6.26/06
   TCanvas *GenJet_VbbHcc_pt_b_bckg_18 = new TCanvas("GenJet_VbbHcc_pt_b_bckg_18", "GenJet_VbbHcc_pt_b_bckg_18",0,0,600,600);
   GenJet_VbbHcc_pt_b_bckg_18->SetHighLightColor(2);
   GenJet_VbbHcc_pt_b_bckg_18->Range(-436.7058,-nan,2343.266,-nan);
   GenJet_VbbHcc_pt_b_bckg_18->SetFillColor(0);
   GenJet_VbbHcc_pt_b_bckg_18->SetFillStyle(4000);
   GenJet_VbbHcc_pt_b_bckg_18->SetBorderMode(0);
   GenJet_VbbHcc_pt_b_bckg_18->SetBorderSize(2);
   GenJet_VbbHcc_pt_b_bckg_18->SetLogy();
   GenJet_VbbHcc_pt_b_bckg_18->SetLeftMargin(0.15709);
   GenJet_VbbHcc_pt_b_bckg_18->SetRightMargin(0.1234783);
   GenJet_VbbHcc_pt_b_bckg_18->SetBottomMargin(0.12);
   GenJet_VbbHcc_pt_b_bckg_18->SetFrameFillStyle(1000);
   GenJet_VbbHcc_pt_b_bckg_18->SetFrameBorderMode(0);
   GenJet_VbbHcc_pt_b_bckg_18->SetFrameFillStyle(1000);
   GenJet_VbbHcc_pt_b_bckg_18->SetFrameBorderMode(0);
   ...
   st_stack_204->GetXaxis()->SetTitle("pt (b-jet) [GeV]");
...
tex->SetNDC();
   ...
   tex->SetLineWidth(2);
   tex->Draw();
   GenJet_VbbHcc_pt_b_bckg_18->Modified();
   GenJet_VbbHcc_pt_b_bckg_18->cd();
   GenJet_VbbHcc_pt_b_bckg_18->SetSelected(GenJet_VbbHcc_pt_b_bckg_18);
}
