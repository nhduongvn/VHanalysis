...
#endif
void GenJet_cuts_nGenGlu_bckg_18_logY()
{
...
//=========  (Fri Mar 10 12:49:23 2023) by ROOT version 6.26/06
   ...
   GenJet_cuts_nGenGlu_bckg_18->Range(-4.867058,-2.934842,22.93266,14.43741);
   ...
   GenJet_cuts_nGenGlu_bckg_18->SetLogy();
   ...
   st_stack_102->SetMinimum(0.1411978);
   st_stack_102->SetMaximum(5.013991e+12);
