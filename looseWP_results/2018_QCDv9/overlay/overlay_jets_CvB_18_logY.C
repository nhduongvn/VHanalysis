...
//=========  (Fri Mar 10 12:48:05 2023) by ROOT version 6.26/06
   ...
   overlay_jets_CvB_18->Range(-0.2,-3.425468,1.133333,0.0359888);
   ...
   st_stack_66->SetMinimum(0.0008330622);
   st_stack_66->SetMaximum(0.4896019);
   ...
   VbbHcc_jets_CvB_stack_2->SetBinContent(1,0.01487589);
   VbbHcc_jets_CvB_stack_2->SetBinContent(2,0.002632891);
   VbbHcc_jets_CvB_stack_2->SetBinContent(3,0.001979079);
   VbbHcc_jets_CvB_stack_2->SetBinContent(4,0.002026482);
   VbbHcc_jets_CvB_stack_2->SetBinContent(5,0.002221102);
   VbbHcc_jets_CvB_stack_2->SetBinContent(6,0.002517183);
   VbbHcc_jets_CvB_stack_2->SetBinContent(7,0.002958589);
   VbbHcc_jets_CvB_stack_2->SetBinContent(8,0.003618819);
   VbbHcc_jets_CvB_stack_2->SetBinContent(9,0.004722463);
   VbbHcc_jets_CvB_stack_2->SetBinContent(10,0.006477545);
   VbbHcc_jets_CvB_stack_2->SetBinContent(11,0.00884379);
   VbbHcc_jets_CvB_stack_2->SetBinContent(12,0.01241789);
   VbbHcc_jets_CvB_stack_2->SetBinContent(13,0.01861792);
   VbbHcc_jets_CvB_stack_2->SetBinContent(14,0.02789351);
   VbbHcc_jets_CvB_stack_2->SetBinContent(15,0.04603352);
   VbbHcc_jets_CvB_stack_2->SetBinContent(16,0.08022519);
   VbbHcc_jets_CvB_stack_2->SetBinContent(17,0.1577659);
   VbbHcc_jets_CvB_stack_2->SetBinContent(18,0.3364405);
   VbbHcc_jets_CvB_stack_2->SetBinContent(19,0.2470164);
   VbbHcc_jets_CvB_stack_2->SetBinContent(20,0.02071534);
   VbbHcc_jets_CvB_stack_2->SetBinError(1,1.621723e-05);
   VbbHcc_jets_CvB_stack_2->SetBinError(2,6.787034e-06);
   VbbHcc_jets_CvB_stack_2->SetBinError(3,5.807117e-06);
   VbbHcc_jets_CvB_stack_2->SetBinError(4,5.904503e-06);
   VbbHcc_jets_CvB_stack_2->SetBinError(5,6.215125e-06);
   VbbHcc_jets_CvB_stack_2->SetBinError(6,6.471995e-06);
   VbbHcc_jets_CvB_stack_2->SetBinError(7,7.080064e-06);
   VbbHcc_jets_CvB_stack_2->SetBinError(8,7.929905e-06);
   VbbHcc_jets_CvB_stack_2->SetBinError(9,9.114998e-06);
   VbbHcc_jets_CvB_stack_2->SetBinError(10,1.061556e-05);
   VbbHcc_jets_CvB_stack_2->SetBinError(11,1.239724e-05);
   VbbHcc_jets_CvB_stack_2->SetBinError(12,1.474763e-05);
   VbbHcc_jets_CvB_stack_2->SetBinError(13,1.812324e-05);
   VbbHcc_jets_CvB_stack_2->SetBinError(14,2.212641e-05);
   VbbHcc_jets_CvB_stack_2->SetBinError(15,2.844025e-05);
   VbbHcc_jets_CvB_stack_2->SetBinError(16,3.787427e-05);
   VbbHcc_jets_CvB_stack_2->SetBinError(17,5.308747e-05);
   VbbHcc_jets_CvB_stack_2->SetBinError(18,7.830323e-05);
   VbbHcc_jets_CvB_stack_2->SetBinError(19,6.870086e-05);
   VbbHcc_jets_CvB_stack_2->SetBinError(20,1.945581e-05);
   VbbHcc_jets_CvB_stack_2->SetEntries(3.143429e+09);
