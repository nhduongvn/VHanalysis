...
#endif
void GenJet_cuts_nGenL_bckg_17_logY()
{
...
//=========  (Fri Mar 10 12:49:23 2023) by ROOT version 6.26/06
   ...
   GenJet_cuts_nGenL_bckg_17->Range(-4.867058,-2.932768,22.93266,14.42494);
   ...
   GenJet_cuts_nGenL_bckg_17->SetLogy();
   ...
   st_stack_82->SetMinimum(0.141305);
   st_stack_82->SetMaximum(4.888447e+12);
