...
//=========  (Fri Mar 10 12:13:58 2023) by ROOT version 6.26/06
   ...
   CvB_jets_signal_17->Range(-0.2183529,-89.44175,1.171633,655.9062);
   ...
   st_stack_21->GetYaxis()->SetTitle("Event/0.05");
