...
#endif
void GenJet_cuts_nGenJet_signal_17_logY()
{
...
//=========  (Fri Mar 10 12:49:22 2023) by ROOT version 6.26/06
   ...
   GenJet_cuts_nGenJet_signal_17->Range(-4.867058,-0.8312267,22.93266,3.122326);
   ...
   GenJet_cuts_nGenJet_signal_17->SetLogy();
   ...
   st_stack_75->SetMinimum(0.4397438);
   st_stack_75->SetMaximum(533.2992);
