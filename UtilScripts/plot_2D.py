...
for i in range(len(plots)):
  ...
  for y in years:
    ...
    plotName = 'tags_MH_v_MZ_' + plots[i] + '_' + y
    make2DPlots(hTags[y].Clone(), "Tagging Only", plotName, 
      plotFolder + '/20' + y, xAxisTitles[i], yAxisTitles[i])
    
    plotName = 'algo_MH_v_MZ_' + plots[i] + '_' + y
    make2DPlots(hAlgo[y].Clone(), "DHZ Prioritized", plotName, 
      plotFolder + '/20' + y, xAxisTitles[i], yAxisTitles[i])
    
    plotName = 'both_MH_v_MZ_' + plots[i] + '_' + y
    make2DPlots(hBoth[y].Clone(), "Tagging Prioritized", plotName, 
      plotFolder + '/20' + y, xAxisTitles[i], yAxisTitles[i])
