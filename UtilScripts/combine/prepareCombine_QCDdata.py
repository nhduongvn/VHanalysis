...
out_file = ROOT.TFile("../histos_QCDdata.root", "RECREATE")
dc_name = '../tmp/dataCard_QCDdata'
...
for r in regions:
  ...
  ## These two are used for data & QCD data-driven background
  hData = getHist(hN, ['Data'], histFiles, lumiScales)
  hData_2b1c = getHist(hN2, ['Data'], histFiles, lumiScales)
  
  ## The following are the backgrounds
  ...
  hQCDA = hData_2b1c['16'].Clone(hData_2b1c['16'].GetName()+'_all')
  hQCDA.Scale(QCD_CR_SF['16'])
