...
out_file = ROOT.TFile("../tmp/Combine/histos_DHZfirst_18only.root", "RECREATE")
dc_name = '../tmp/Combine/dataCard_DHZfirst_18only'
...
for r in regions:
  ...
  hDataA = hData[initYear].Clone(hData[initYear].GetName()+'_all')
  hZHccA = hZHcc[initYear].Clone(hZHcc[initYear].GetName()+'_all')
  hZHbbA = hZHbb[initYear].Clone(hZHbb[initYear].GetName()+'_all')
  hggZHccA = hggZHcc[initYear].Clone(hggZHcc[initYear].GetName()+'_all')
  hggZHbbA = hggZHbb[initYear].Clone(hggZHbb[initYear].GetName()+'_all')
  hQCDA = hQCD[initYear].Clone(hQCD[initYear].GetName()+'_all')
  hSTA = hST[initYear].Clone(hST[initYear].GetName()+'_all')
  hTTA = hTT[initYear].Clone(hTT[initYear].GetName()+'_all')
  hZJA = hZJ[initYear].Clone(hZJ[initYear].GetName()+'_all')
  hWJA = hWJ[initYear].Clone(hWJ[initYear].GetName()+'_all')
  hWWA = hWW[initYear].Clone(hWW[initYear].GetName()+'_all')
  hWZA = hWZ[initYear].Clone(hWZ[initYear].GetName()+'_all')
  hZZA = hZZ[initYear].Clone(hZZ[initYear].GetName()+'_all')
  
  ## ...and then we add the 2017-18 data onto it
  #for y in ['17',initYear]:
  #  hDataA.Add(hData[y])
  #  hZHccA.Add(hZHcc[y])
  #  hZHbbA.Add(hZHbb[y])
