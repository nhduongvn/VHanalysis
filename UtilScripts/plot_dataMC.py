...
for r in regions:
  ...
  for plN in plotNames:
    ...
    plots_process = [hDatA.Clone().Rebin(nRebin),
        ...
        hZHbbA.Clone().Rebin(nRebin),import ROOT
import sys,os
import copy
import math
sys.path.append('/uscms_data/d3/duong/CMSSW/CMSSW_7_6_5/src/ZplusC/python/')
