...
class TreeCache:
    ...
    def get_tree(self, sample, cut):
        ...
        print('more cuts added, finding or creating new tree')
        ...
        try:
              ...
              print (input_,"file is corrupted or not available. I'm creating tree")
        ...
        #inputTmp = ROOT.TFile.Open('%s/dummy_%s.root'%(self.__cachedPath,self.__hashDict[sample.name]),'recreate')
        
        #ROOT.gROOT.cd()
        #print('getting the tree after applying cuts')
        #cuttedTree=tree.CopyTree(cut)
        #print('=============> Finish copy tree 1')
        #cuttedTree.SetDirectory(0)
        #input.Close()
        #del input
        #del tree
        #print('=============> Finish copy tree 2')
        #return cuttedTree
