...
import ConfigParser
from math import *
from my_funcs import ScaleToLumi1, make2DplotWithRegions, isWithinEllipse, within_line_range
...
for sel in selection_methods:
  ...
  for y in years:
    ...
    for cat in categories:
      ...
      ## Determine the event count in each region
      nBinsX = plot.GetNbinsX()
      nBinsY = plot.GetNbinsY()
      
      for line_key in ["I", "II"]:
        ...
        for y in range(1, nBinsY+1):
          ...
          for x in range(1, nBinsX+1):
            ...
            region = "all"
            if isWithinEllipse(cX, cY, 125.0, 91.0, 30, 30) and within_line:
              region = "SR"
            elif isWithinEllipse(cX, cY, 125.0, 91.0, 40, 40) and within_line:
              region = "VR"
            elif isWithinEllipse(cX, cY, 125.0, 91.0, 60, 60) and within_line:
              region = "CR"
            elif within_line:
              region = "other"
        ...
        ## Print out the values & percentages
        ...
        print "|~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~|"
        print "Sector: ", line_key
        print "|~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~|"
        for region in ["SR", "VR", "CR", "other"]:
          print region, ": ", event_multiplicity[region], " | ", percentages[region]
        print "|~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~|"
        print "Total: ", total
        print "|~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~|"
