...
for sector in ["I", "II", "both"]:
  ...
  for var in variables:
    ...
    for y in years:
      ...
      output_path = output_directory + "/20" + y + "/bckg_subtraction/" + sector + "/QCD/"
      logY = useLogY
      ...
      output_path = output_directory + "/20" + y + "/bckg_subtraction/" + sector + "/full/"
      logY = useLogY
      makeDataMCPlot(plots_process, plotNames_process,  ## Plots
        var + "_" + sel + "_" + y, output_path,         ## Folders
        xA_title, xA_range, 'MC unc. (stat.)', False,   ## Axes
      ...
      output_path = output_directory + "/20" + y + "/bckg_subtraction/" + sector + "/w_overlay/"
      makeDataMCPlot(plots_process, plotNames_process,  ## Plots
        var + "_" + sel + "_" + y, output_path,         ## Folders
        xA_title, xA_range, 'MC unc. (stat.)', False,   ## Axes
