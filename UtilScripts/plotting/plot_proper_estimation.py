...
## == < non-MC versions> ======================================================
      ...
      for cat in other_backgrounds:
        ...
        QCD_plot.Add(bckg_plot, -1)
      
      QCD_plot.Scale(SF)
      
      ## Get the QCD MC plot
      QCD_MC = plots_2b2c_by_year["QCD"][y].Clone()
      plots_process = [
        QCD_plot.Clone().Rebin(nRebin),
        QCD_MC.Clone().Rebin(nRebin)
      ]
      plotNames_process = [
        "Data-Driven QCD",
        "QCD MC Sample"
      ]
      print ">>> | comparing QCD versions"
      output_path = output_directory + "/20" + y + "/proper_estimate/QCD"
      logY = useLogY
      ...
      output_path = output_directory + "/20" + y + "/proper_estimate/noMC/full/"
      logY = useLogY
      makeDataMCPlot(plots_process, plotNames_process,  ## Plots
        var + "_" + sel + "_" + y, output_path,         ## Folders
        xA_title, xA_range, 'MC unc. (stat.)', False,   ## Axes
      ...
      output_path = output_directory + "/20" + y + "/proper_estimate/noMC/VR/"
      ...
      output_path = output_directory + "/20" + y + "/proper_estimate/noMC/SR/"
      ...
      output_path = output_directory + "/20" + y + "/proper_estimate/noMC/ref/"
      plots_process = [
...
## == < MC versions > =========================================================
      ...
      output_path = output_directory + "/20" + y + "/proper_estimate/MC/full/"
      logY = useLogY
      makeDataMCPlot(plots_process, plotNames_process,  ## Plots
        var + "_" + sel + "_" + y, output_path,         ## Folders
        xA_title, xA_range, 'MC unc. (stat.)', False,   ## Axes
      ...
      output_path = output_directory + "/20" + y + "/proper_estimate/MC/SR/"
      logY = useLogY
      makeDataMCPlot(plots_process, plotNames_process,  ## Plots
      ...
      output_path = output_directory + "/20" + y + "/proper_estimate/MC/VR/"
      logY = useLogY
      makeDataMCPlot(plots_process, plotNames_process,  ## Plots
