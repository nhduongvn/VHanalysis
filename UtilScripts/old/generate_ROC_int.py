...
for plN in plotNames:
  ...
  hSignal_tags = getHist("VbbHcc_tags_" + plN, ss_signal, fHist, lumiScales)
  hBckg_tags   = getHist("VbbHcc_tags_" + plN, ss_bckg,   fHist, lumiScales)
  
  hSignal_algo = getHist("VbbHcc_algo_" + plN, ss_signal, fHist, lumiScales)
  hBckg_algo   = getHist("VbbHcc_algo_" + plN, ss_bckg,   fHist, lumiScales)
  
  hSignal_both = getHist("VbbHcc_both_" + plN, ss_signal, fHist, lumiScales)
  hBckg_both   = getHist("VbbHcc_both_" + plN, ss_bckg,   fHist, lumiScales)
  ...
  for y in years:
    ...
    makeROCinterval(signal_plots, bckg_plots, plotNames_process, plN,
      "ROC_" + plN + "_" + y, plotFolder + '/20' + y + '_QCDv9' + '/ROC_int/', 
      colors, lumi=lumiS[y])
