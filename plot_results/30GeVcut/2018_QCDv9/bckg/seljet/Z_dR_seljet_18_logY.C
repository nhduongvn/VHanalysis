...
//=========  (Tue Feb 14 16:02:05 2023) by ROOT version 6.26/06
   ...
   Z_dR_seljet_18->Range(-1.310117,0.2301173,7.029799,13.06441);
   ...
   st->SetName("st");
   st->SetTitle("");
   st->SetMinimum(319.1751);
   st->SetMaximum(2.182594e+11);
   
   TH1F *st_stack_275 = new TH1F("st_stack_275","",30,0,6);
   st_stack_275->SetMinimum(58.91588);
   st_stack_275->SetMaximum(6.039213e+11);
