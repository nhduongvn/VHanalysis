...
//=========  (Tue Feb 14 16:02:05 2023) by ROOT version 6.26/06
   ...
   H_dR_seljet_18->Range(-1.353788,0.04472777,7.264125,13.38509);
   ...
   st->SetName("st");
   st->SetTitle("");
   st->SetMinimum(247.6875);
   st->SetMaximum(3.959362e+11);
   
   TH1F *st_stack_279 = new TH1F("st_stack_279","",30,0,6);
   st_stack_279->SetMinimum(44.21521);
   st_stack_279->SetMaximum(1.124754e+12);
