...
//=========  (Tue Feb 14 16:02:02 2023) by ROOT version 6.26/06
   ...
   Aplanarity_tags_18->Range(-0.2183529,-1.204149,1.171633,11.16387);
   ...
   st->SetTitle("");
   st->SetMinimum(10);
   st->SetMaximum(3.132112e+09);
   
   TH1F *st_stack_63 = new TH1F("st_stack_63","",50,0,1);
   st_stack_63->SetMinimum(1.905517);
   st_stack_63->SetMaximum(8.454094e+09);
