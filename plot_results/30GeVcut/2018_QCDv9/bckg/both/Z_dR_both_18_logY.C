...
//=========  (Tue Feb 14 16:02:03 2023) by ROOT version 6.26/06
   ...
   Z_dR_both_18->Range(-1.310117,-1.9491,7.029799,10.46816);
   ...
   st->SetName("st");
   st->SetTitle("");
   st->SetMinimum(1.82994);
   st->SetMaximum(6.223828e+08);
   
   TH1F *st_stack_147 = new TH1F("st_stack_147","",30,0,6);
   st_stack_147->SetMinimum(0.3475136);
   st_stack_147->SetMaximum(1.68437e+09);
