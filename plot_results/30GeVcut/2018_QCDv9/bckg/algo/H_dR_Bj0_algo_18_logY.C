...
//=========  (Tue Feb 14 16:02:02 2023) by ROOT version 6.26/06
   ...
   H_dR_Bj0_algo_18->Range(-1.310117,-0.9577652,7.029799,9.786799);
   ...
   st->SetTitle("");
   st->SetMinimum(10);
   st->SetMaximum(2.09256e+08);
   
   TH1F *st_stack_107 = new TH1F("st_stack_107","",30,0,6);
   st_stack_107->SetMinimum(2.145767);
   st_stack_107->SetMaximum(5.156351e+08);
