...
//=========  (Tue Feb 14 16:02:02 2023) by ROOT version 6.26/06
   ...
   H_dR_Bj1_algo_18->Range(-1.310117,-0.8707009,7.029799,9.309597);
   ...
   st->SetTitle("");
   st->SetMinimum(10);
   st->SetMaximum(8.212254e+07);
   
   TH1F *st_stack_111 = new TH1F("st_stack_111","",30,0,6);
   st_stack_111->SetMinimum(2.243545);
   st_stack_111->SetMaximum(1.956892e+08);
