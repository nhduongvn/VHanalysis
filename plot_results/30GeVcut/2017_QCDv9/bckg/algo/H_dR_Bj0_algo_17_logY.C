...
//=========  (Tue Feb 14 16:02:02 2023) by ROOT version 6.26/06
   ...
   H_dR_Bj0_algo_17->Range(-1.310117,-0.937594,7.029799,9.675779);
   ...
   st->SetTitle("");
   st->SetMinimum(10);
   st->SetMaximum(1.683151e+08);
   
   TH1F *st_stack_106 = new TH1F("st_stack_106","",30,0,6);
   st_stack_106->SetMinimum(2.167758);
   st_stack_106->SetMaximum(4.115682e+08);
