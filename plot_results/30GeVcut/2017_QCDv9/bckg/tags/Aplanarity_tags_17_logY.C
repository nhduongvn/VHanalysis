...
//=========  (Tue Feb 14 16:02:02 2023) by ROOT version 6.26/06
   ...
   Aplanarity_tags_17->Range(-0.2183529,-1.18175,1.171633,11.03715);
   ...
   st->SetTitle("");
   st->SetMinimum(10);
   st->SetMaximum(2.440775e+09);
   
   TH1F *st_stack_62 = new TH1F("st_stack_62","",50,0,1);
   st_stack_62->SetMinimum(1.925386);
   st_stack_62->SetMaximum(6.535188e+09);
