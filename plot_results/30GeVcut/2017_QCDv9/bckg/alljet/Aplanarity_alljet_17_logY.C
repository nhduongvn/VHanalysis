...
//=========  (Tue Feb 14 16:02:05 2023) by ROOT version 6.26/06
   ...
   Aplanarity_alljet_17->Range(-0.2183529,-2.090365,1.171633,16.37671);
   ...
   st->SetTitle("");
   st->SetMinimum(10);
   st->SetMaximum(9.425744e+13);
   
   TH1F *st_stack_254 = new TH1F("st_stack_254","",50,0,1);
   st_stack_254->SetMinimum(1.33562);
   st_stack_254->SetMaximum(3.388426e+14);
