...
//=========  (Tue Feb 14 16:02:04 2023) by ROOT version 6.26/06
   ...
   Z_dR_alljet_all->Range(-1.310117,2.662332,7.029799,14.97107);
   ...
   st->SetName("st");
   st->SetTitle("");
   st->SetMinimum(72041.25);
   st->SetMaximum(2.04339e+13);
   
   TH1F *st_stack_212 = new TH1F("st_stack_212","",30,0,6);
   st_stack_212->SetMinimum(13784.15);
   st_stack_212->SetMaximum(5.497852e+13);
