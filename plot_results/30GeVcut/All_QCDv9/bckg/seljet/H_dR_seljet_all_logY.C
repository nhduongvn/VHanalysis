...
//=========  (Tue Feb 14 16:02:05 2023) by ROOT version 6.26/06
   ...
   H_dR_seljet_all->Range(-1.353788,0.3737406,7.264125,13.74812);
   ...
   st->SetName("st");
   st->SetTitle("");
   st->SetMinimum(534.5137);
   st->SetMaximum(9.046698e+11);
   
   TH1F *st_stack_280 = new TH1F("st_stack_280","",30,0,6);
   st_stack_280->SetMinimum(95.20634);
   st_stack_280->SetMaximum(2.574424e+12);
