...
//=========  (Tue Feb 14 16:02:01 2023) by ROOT version 6.26/06
   ...
   H_dR_tags_all->Range(-1.353788,-1.498784,7.264125,10.77965);
   ...
   st->SetName("st");
   st->SetTitle("");
   st->SetMinimum(4.919413);
   st->SetMaximum(1.326394e+09);
   
   TH1F *st_stack_24 = new TH1F("st_stack_24","",30,0,6);
   st_stack_24->SetMinimum(0.9432511);
   st_stack_24->SetMaximum(3.562895e+09);
