...
//=========  (Tue Feb 14 16:02:02 2023) by ROOT version 6.26/06
   ...
   Aplanarity_tags_all->Range(-0.2183529,-1.277723,1.171633,11.58212);
   ...
   st->SetTitle("");
   st->SetMinimum(10);
   st->SetMaximum(7.137495e+09);
   
   TH1F *st_stack_64 = new TH1F("st_stack_64","",50,0,1);
   st_stack_64->SetMinimum(1.842716);
   st_stack_64->SetMaximum(1.977592e+10);
