...
//=========  (Tue Feb 14 16:02:04 2023) by ROOT version 6.26/06
   ...
   Aplanarity_both_all->Range(-0.2183529,-1.279586,1.171633,11.59275);
   ...
   st->SetTitle("");
   st->SetMinimum(10);
   st->SetMaximum(7.288523e+09);
   
   TH1F *st_stack_192 = new TH1F("st_stack_192","",50,0,1);
   st_stack_192->SetMinimum(1.841173);
   st_stack_192->SetMaximum(2.020763e+10);
