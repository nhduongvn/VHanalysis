...
//=========  (Wed Jan 25 10:51:22 2023) by ROOT version 6.26/06
   ...
   0.9952812,
   0.9973366};
   TGraph *graph = new TGraph(28,Graph_fx71,Graph_fy71);
   graph->SetName("Graph");
   ...
   TH1F *Graph_Graph71 = new TH1F("Graph_Graph71","Tagging Only",100,0,1.08557);
   Graph_Graph71->SetMinimum(0.06158332);
   Graph_Graph71->SetMaximum(1.082405);
   ...
   TLatex *   tex = new TLatex(0.1004627,0.2865711,"#pm0");
   tex->SetTextSize(0.02);
   tex->SetLineWidth(2);
   tex->Draw();
   graph->GetListOfFunctions()->Add(72);
      tex = new TLatex(0.2466208,0.5952103,"#pm1");
   tex->SetTextSize(0.02);
   tex->SetLineWidth(2);
   tex->Draw();
   graph->GetListOfFunctions()->Add(73);
      tex = new TLatex(0.3684944,0.7631265,"#pm2");
   tex->SetTextSize(0.02);
   tex->SetLineWidth(2);
   tex->Draw();
   graph->GetListOfFunctions()->Add(74);
      tex = new TLatex(0.4774438,0.8571208,"#pm3");
   tex->SetTextSize(0.02);
   tex->SetLineWidth(2);
   tex->Draw();
   graph->GetListOfFunctions()->Add(75);
      tex = new TLatex(0.540997,0.9060329,"#pm4");
   tex->SetTextSize(0.02);
   tex->SetLineWidth(2);
   tex->Draw();
   graph->GetListOfFunctions()->Add(76);
      tex = new TLatex(0.6122923,0.9411603,"#pm5");
   tex->SetTextSize(0.02);
   tex->SetLineWidth(2);
   tex->Draw();
   graph->GetListOfFunctions()->Add(77);
      tex = new TLatex(0.6722408,0.9680893,"#pm6");
   tex->SetTextSize(0.02);
   tex->SetLineWidth(2);
   tex->Draw();
   graph->GetListOfFunctions()->Add(78);
      tex = new TLatex(0.7114977,0.9818695,"#pm7");
   tex->SetTextSize(0.02);
   tex->SetLineWidth(2);
   tex->Draw();
   graph->GetListOfFunctions()->Add(79);
      tex = new TLatex(0.7537473,0.9899956,"#pm8");
   tex->SetTextSize(0.02);
   tex->SetLineWidth(2);
   tex->Draw();
   graph->GetListOfFunctions()->Add(80);
      tex = new TLatex(0.7792986,0.9983715,"#pm9");
   tex->SetTextSize(0.02);
   tex->SetLineWidth(2);
   tex->Draw();
   ...
   TH1F *Graph_Graph82 = new TH1F("Graph_Graph82","Mass-Matching Prioritized",100,0.01063744,1.088541);
   Graph_Graph82->SetMinimum(0.1712282);
   Graph_Graph82->SetMaximum(1.075343);
   ...
   0.9976804,
   0.999028};
   graph = new TGraph(29,Graph_fx83,Graph_fy83);
   graph->SetName("Graph");
   ...
   TH1F *Graph_Graph83 = new TH1F("Graph_Graph83","Tagging Prioritized",100,0,1.089424);
   Graph_Graph83->SetMinimum(0.0557568);
   Graph_Graph83->SetMaximum(1.08478);
