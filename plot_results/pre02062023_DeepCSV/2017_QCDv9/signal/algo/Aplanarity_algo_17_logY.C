...
//=========  (Wed Jan 18 11:42:14 2023) by ROOT version 6.26/06
   ...
   Aplanarity_algo_17->Range(-0.2183529,-0.1147594,1.171633,0.8415687);
   ...
   st->SetTitle("");
   st->SetMinimum(1e+10);
   st->SetMaximum(71.04151);
   
   TH1F *st_stack_126 = new TH1F("st_stack_126","",50,0,1);
   st_stack_126->SetMinimum(-3.252832e+09);
   st_stack_126->SetMaximum(-44.73467);
