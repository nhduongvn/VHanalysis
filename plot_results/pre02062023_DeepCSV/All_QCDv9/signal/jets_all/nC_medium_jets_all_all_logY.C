...
//=========  (Mon Dec 19 11:03:35 2022) by ROOT version 6.26/06
   ...
   nC_medium_jets_all_all->Range(-2.683529,-0.1990075,11.21633,5.831946);
   ...
   st->SetTitle("");
   st->SetMinimum(10);
   st->SetMaximum(94361.71);
   
   TH1F *st_stack_128 = new TH1F("st_stack_128","",10,-0.5,9.5);
   st_stack_128->SetMinimum(3.347395);
   st_stack_128->SetMaximum(169375.4);
