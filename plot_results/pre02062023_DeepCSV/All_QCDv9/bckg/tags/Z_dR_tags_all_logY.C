...
//=========  (Wed Jan 18 11:42:51 2023) by ROOT version 6.26/06
   ...
   Z_dR_tags_all->Range(-1.310117,-2.121602,7.029799,11.00872);
   ...
   st->SetName("st");
   st->SetTitle("");
   st->SetMinimum(1.571778);
   st->SetMaximum(1.765886e+09);
   
   TH1F *st_stack_20 = new TH1F("st_stack_20","",30,0,6);
   st_stack_20->SetMinimum(0.28447);
   st_stack_20->SetMaximum(4.962341e+09);
