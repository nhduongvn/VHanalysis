...
//=========  (Wed Jan 18 11:42:56 2023) by ROOT version 6.26/06
   ...
   Aplanarity_alljet_all->Range(-0.2183529,-2.183619,1.171633,16.94411);
   ...
   st->SetTitle("");
   st->SetMinimum(10);
   st->SetMaximum(2.910615e+14);
   
   TH1F *st_stack_256 = new TH1F("st_stack_256","",50,0,1);
   st_stack_256->SetMinimum(1.293328);
   st_stack_256->SetMaximum(1.074831e+15);
