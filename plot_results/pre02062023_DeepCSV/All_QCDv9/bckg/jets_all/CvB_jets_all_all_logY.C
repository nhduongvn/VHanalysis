...
//=========  (Mon Dec 19 11:02:06 2022) by ROOT version 6.26/06
   ...
   CvB_jets_all_all->Range(-0.2183529,5.630087,1.171633,15.96421);
   ...
   st->SetName("st");
   st->SetTitle("");
   st->SetMinimum(3.346586e+07);
   st->SetMaximum(3.545486e+14);
   
   TH1F *st_stack_120 = new TH1F("st_stack_120","",20,0,1);
   st_stack_120->SetMinimum(7416197);
   st_stack_120->SetMaximum(8.526946e+14);
