...
//=========  (Wed Jan 18 11:42:53 2023) by ROOT version 6.26/06
   ...
   H_dR_both_all->Range(-1.353788,-1.469396,7.264125,10.99366);
   ...
   st->SetName("st");
   st->SetTitle("");
   st->SetMinimum(5.61057);
   st->SetMaximum(2.060212e+09);
   
   TH1F *st_stack_152 = new TH1F("st_stack_152","",30,0,6);
   st_stack_152->SetMinimum(1.062115);
   st_stack_152->SetMaximum(5.589315e+09);
