...
//=========  (Wed Jan 18 11:42:14 2023) by ROOT version 6.26/06
   ...
   Aplanarity_algo_16->Range(-0.2183529,-0.07722684,1.171633,0.5663302);
   ...
   st->SetTitle("");
   st->SetMinimum(1e+10);
   st->SetMaximum(47.80709);
   
   TH1F *st_stack_125 = new TH1F("st_stack_125","",50,0,1);
   st_stack_125->SetMinimum(-3.164303e+09);
   st_stack_125->SetMaximum(-31.74876);
