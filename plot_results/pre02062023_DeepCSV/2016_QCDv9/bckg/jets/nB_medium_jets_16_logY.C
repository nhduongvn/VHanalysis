...
//=========  (Mon Dec 19 11:02:03 2022) by ROOT version 6.26/06
   ...
   nB_medium_jets_16->Range(-2.683529,-2.102264,11.21633,16.44893);
   ...
   st->SetTitle("");
   st->SetMinimum(10);
   st->SetMaximum(1.087991e+14);
   
   TH1F *st_stack_17 = new TH1F("st_stack_17","",10,-0.5,9.5);
   st_stack_17->SetMinimum(1.330086);
   st_stack_17->SetMaximum(3.924736e+14);
