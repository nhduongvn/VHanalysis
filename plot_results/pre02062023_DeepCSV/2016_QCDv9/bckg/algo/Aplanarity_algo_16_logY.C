...
//=========  (Wed Jan 18 11:42:53 2023) by ROOT version 6.26/06
   ...
   Aplanarity_algo_16->Range(-0.2183529,-0.9895429,1.171633,9.96225);
   ...
   st->SetTitle("");
   st->SetMinimum(10);
   st->SetMaximum(2.952354e+08);
   
   TH1F *st_stack_125 = new TH1F("st_stack_125","",50,0,1);
   st_stack_125->SetMinimum(2.111895);
   st_stack_125->SetMaximum(7.36327e+08);
