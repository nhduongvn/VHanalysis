...
//=========  (Mon Dec 19 11:02:06 2022) by ROOT version 6.26/06
   ...
   nB_medium_jets_all_16->Range(-2.683529,-2.096784,11.21633,16.41566);
   ...
   st->SetTitle("");
   st->SetMinimum(10);
   st->SetMaximum(1.018406e+14);
   
   TH1F *st_stack_121 = new TH1F("st_stack_121","",10,-0.5,9.5);
   st_stack_121->SetMinimum(1.33263);
   st_stack_121->SetMaximum(3.667877e+14);
