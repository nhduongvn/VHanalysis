...
//=========  (Wed Jan 18 11:42:55 2023) by ROOT version 6.26/06
   ...
   Z_dR_alljet_16->Range(-1.310117,2.23835,7.029799,14.30905);
   ...
   st->SetName("st");
   st->SetTitle("");
   st->SetMinimum(24991.66);
   st->SetMaximum(4.761597e+12);
   
   TH1F *st_stack_209 = new TH1F("st_stack_209","",30,0,6);
   st_stack_209->SetMinimum(4862.21);
   st_stack_209->SetMaximum(1.264676e+13);
