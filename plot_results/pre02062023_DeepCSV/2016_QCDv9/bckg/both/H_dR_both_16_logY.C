...
//=========  (Wed Jan 18 11:42:53 2023) by ROOT version 6.26/06
   ...
   H_dR_both_16->Range(-1.353788,-2.115143,7.264125,10.29807);
   ...
   st->SetName("st");
   st->SetTitle("");
   st->SetMinimum(1.246768);
   st->SetMaximum(4.21174e+08);
   
   TH1F *st_stack_149 = new TH1F("st_stack_149","",30,0,6);
   st_stack_149->SetMinimum(0.2368329);
   st_stack_149->SetMaximum(1.139585e+09);
