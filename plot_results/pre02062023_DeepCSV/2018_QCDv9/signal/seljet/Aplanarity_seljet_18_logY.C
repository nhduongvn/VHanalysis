...
//=========  (Wed Jan 18 11:42:18 2023) by ROOT version 6.26/06
   ...
   Aplanarity_seljet_18->Range(-0.2183529,0.01137174,1.171633,4.83386);
   ...
   st->SetTitle("");
   st->SetMinimum(10);
   st->SetMaximum(13802.54);
   
   TH1F *st_stack_319 = new TH1F("st_stack_319","",50,0,1);
   st_stack_319->SetMinimum(3.891082);
   st_stack_319->SetMaximum(22470.42);
