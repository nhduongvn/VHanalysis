...
//=========  (Mon Dec 19 11:02:03 2022) by ROOT version 6.26/06
   ...
   CvB_jets_18->Range(-0.2183529,4.885892,1.171633,15.3928);
   ...
   st->SetName("st");
   st->SetTitle("");
   st->SetMinimum(6413359);
   st->SetMaximum(9.047393e+13);
   
   TH1F *st_stack_15 = new TH1F("st_stack_15","",20,0,1);
   st_stack_15->SetMinimum(1401913);
   st_stack_15->SetMaximum(2.198415e+14);
