...
//=========  (Wed Jan 18 11:42:56 2023) by ROOT version 6.26/06
   ...
   Z_dR_seljet_18->Range(-1.310117,0.3655521,7.029799,13.1481);
   ...
   st->SetName("st");
   st->SetTitle("");
   st->SetMinimum(428.2948);
   st->SetMaximum(2.685499e+11);
   
   TH1F *st_stack_275 = new TH1F("st_stack_275","",30,0,6);
   st_stack_275->SetMinimum(79.33381);
   st_stack_275->SetMaximum(7.410519e+11);
