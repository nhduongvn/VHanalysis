...
//=========  (Wed May  3 17:41:46 2023) by ROOT version 6.26/06
   ...
   BvL_2018_QuadJet_TripleTag_18_ideal_ref->Range(-0.2,1.445089,1.133333,4.027113);
   ...
   _QuadJet_TripleTag_ideal_BvL_ref__21->SetBinContent(1,1397);
   _QuadJet_TripleTag_ideal_BvL_ref__21->SetBinContent(2,101);
   _QuadJet_TripleTag_ideal_BvL_ref__21->SetBinContent(3,218);
   _QuadJet_TripleTag_ideal_BvL_ref__21->SetBinContent(4,622);
   _QuadJet_TripleTag_ideal_BvL_ref__21->SetBinContent(5,533);
   _QuadJet_TripleTag_ideal_BvL_ref__21->SetBinContent(6,426);
   _QuadJet_TripleTag_ideal_BvL_ref__21->SetBinContent(7,427);
   _QuadJet_TripleTag_ideal_BvL_ref__21->SetBinContent(8,440);
   _QuadJet_TripleTag_ideal_BvL_ref__21->SetBinContent(9,508);
   _QuadJet_TripleTag_ideal_BvL_ref__21->SetBinContent(10,3100);
   _QuadJet_TripleTag_ideal_BvL_ref__21->SetEntries(7772);
   ...
   ptstats_LaTex = ptstats->AddText("Mean  = 0.6273");
