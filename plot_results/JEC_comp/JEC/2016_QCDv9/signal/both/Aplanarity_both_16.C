...
//=========  (Mon Mar 20 11:49:43 2023) by ROOT version 6.26/06
   ...
   Aplanarity_both_16->Range(-0.2183529,-0.9017652,1.171633,6.612944);
   ...
   VbbHcc_both_Aplanarity_stack_1->SetBinContent(1,3.43845);
   VbbHcc_both_Aplanarity_stack_1->SetBinContent(2,0.3429802);
   VbbHcc_both_Aplanarity_stack_1->SetBinContent(3,0.08498995);
   VbbHcc_both_Aplanarity_stack_1->SetBinContent(4,0.02363911);
   VbbHcc_both_Aplanarity_stack_1->SetBinContent(5,0.001888398);
   VbbHcc_both_Aplanarity_stack_1->SetBinContent(6,0.005520994);
   VbbHcc_both_Aplanarity_stack_1->SetBinError(1,0.1010859);
   VbbHcc_both_Aplanarity_stack_1->SetBinError(2,0.0320387);
   VbbHcc_both_Aplanarity_stack_1->SetBinError(3,0.01589005);
   VbbHcc_both_Aplanarity_stack_1->SetBinError(4,0.008366778);
   VbbHcc_both_Aplanarity_stack_1->SetBinError(5,0.001888398);
   VbbHcc_both_Aplanarity_stack_1->SetBinError(6,0.00390562);
   ...
   VbbHcc_both_Aplanarity_stack_2->SetBinContent(1,1.426573);
   VbbHcc_both_Aplanarity_stack_2->SetBinContent(2,0.160753);
   VbbHcc_both_Aplanarity_stack_2->SetBinContent(3,0.03942987);
   VbbHcc_both_Aplanarity_stack_2->SetBinContent(4,0.0138408);
   VbbHcc_both_Aplanarity_stack_2->SetBinContent(5,0.00503572);
   VbbHcc_both_Aplanarity_stack_2->SetBinContent(6,0.001319481);
   VbbHcc_both_Aplanarity_stack_2->SetBinContent(7,0.001175971);
   VbbHcc_both_Aplanarity_stack_2->SetBinContent(8,0.002021428);
   VbbHcc_both_Aplanarity_stack_2->SetBinContent(9,0.0007584156);
   VbbHcc_both_Aplanarity_stack_2->SetBinContent(17,0.0003753755);
   VbbHcc_both_Aplanarity_stack_2->SetBinError(1,0.02332922);
   VbbHcc_both_Aplanarity_stack_2->SetBinError(2,0.007827295);
   VbbHcc_both_Aplanarity_stack_2->SetBinError(3,0.003863267);
   VbbHcc_both_Aplanarity_stack_2->SetBinError(4,0.002291348);
   VbbHcc_both_Aplanarity_stack_2->SetBinError(5,0.001399382);
   VbbHcc_both_Aplanarity_stack_2->SetBinError(6,0.0006825484);
   VbbHcc_both_Aplanarity_stack_2->SetBinError(7,0.0006806894);
   VbbHcc_both_Aplanarity_stack_2->SetBinError(8,0.0008534785);
   VbbHcc_both_Aplanarity_stack_2->SetBinError(9,0.0005363066);
