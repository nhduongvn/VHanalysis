...
//=========  (Mon Mar 20 11:50:02 2023) by ROOT version 6.26/06
   ...
   Sphericity_tags_16->Range(-0.2183529,-0.3202455,1.171633,2.348467);
   ...
   st_stack_57->SetMaximum(2.081596);
   ...
   VbbHcc_tags_Sphericity_stack_1->SetBinContent(2,1.107757);
   ...
   VbbHcc_tags_Sphericity_stack_1->SetBinError(2,0.05752045);
   ...
   VbbHcc_tags_Sphericity_stack_2->SetBinContent(1,0.5290896);
   VbbHcc_tags_Sphericity_stack_2->SetBinContent(2,0.4670303);
   ...
   VbbHcc_tags_Sphericity_stack_2->SetBinError(1,0.01418823);
   VbbHcc_tags_Sphericity_stack_2->SetBinError(2,0.01338321);
