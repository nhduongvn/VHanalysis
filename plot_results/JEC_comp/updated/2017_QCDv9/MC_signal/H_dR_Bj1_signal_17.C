...
//=========  (Thu Mar 23 11:54:00 2023) by ROOT version 6.26/06
   ...
   H_dR_Bj1_signal_17->Range(-1.310117,-36.24341,7.029799,265.785);
   ...
   st_stack_21->SetMaximum(235.5821);
   ...
   VbbHcc_MC_H_dR_Bj1_stack_1->SetBinContent(1,173.1039);
   VbbHcc_MC_H_dR_Bj1_stack_1->SetBinError(1,0.5230178);
   ...
   VbbHcc_MC_H_dR_Bj1_stack_2->SetBinContent(1,22.4293);
   VbbHcc_MC_H_dR_Bj1_stack_2->SetBinError(1,0.06823818);
