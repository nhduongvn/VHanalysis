...
//=========  (Thu Mar 23 11:54:00 2023) by ROOT version 6.26/06
   ...
   H_mass_signal_17->Range(-65.50587,-37.93451,351.4899,278.1864);
   ...
   st_stack_3->SetMaximum(246.5743);
   ...
   VbbHcc_MC_H_mass_stack_1->SetBinContent(1,179.8186);
   VbbHcc_MC_H_mass_stack_1->SetBinError(1,0.5926708);
   ...
   VbbHcc_MC_H_mass_stack_2->SetBinContent(1,24.83809);
   VbbHcc_MC_H_mass_stack_2->SetBinError(1,0.07724779);
