...
//=========  (Thu Mar 23 11:54:01 2023) by ROOT version 6.26/06
   ...
   H_pt_signal_17->Range(37.97653,-33.3306,1705.96,244.4244);
   ...
   VbbHcc_MC_H_pt_stack_1->SetBinContent(1,179.8186);
   VbbHcc_MC_H_pt_stack_1->SetBinError(1,0.5926708);
   ...
   VbbHcc_MC_H_pt_stack_2->SetBinContent(1,24.83809);
   VbbHcc_MC_H_pt_stack_2->SetBinError(1,0.07724779);
