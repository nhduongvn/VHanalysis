...
//=========  (Thu Mar 23 11:54:01 2023) by ROOT version 6.26/06
   ...
   Aplanarity_signal_17->Range(-0.2183529,-21.29921,1.171633,156.1942);
   ...
   VbbHcc_MC_Aplanarity_stack_1->SetBinContent(0,89.74746);
   VbbHcc_MC_Aplanarity_stack_1->SetBinContent(1,90.07112);
   VbbHcc_MC_Aplanarity_stack_1->SetBinError(0,0.4185437);
   VbbHcc_MC_Aplanarity_stack_1->SetBinError(1,0.4196187);
   ...
   VbbHcc_MC_Aplanarity_stack_2->SetBinContent(1,24.83809);
   VbbHcc_MC_Aplanarity_stack_2->SetBinError(1,0.07724779);
