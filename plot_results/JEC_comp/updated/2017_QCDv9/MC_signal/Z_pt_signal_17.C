...
//=========  (Thu Mar 23 11:54:01 2023) by ROOT version 6.26/06
   ...
   Z_pt_signal_17->Range(37.97653,-0.1538462,1705.96,1.128205);
   ...
   VbbHcc_MC_Z_pt_stack_1->SetBinContent(1001,179.8186);
   VbbHcc_MC_Z_pt_stack_1->SetBinError(1001,0.5926708);
   ...
   VbbHcc_MC_Z_pt_stack_2->SetBinContent(1001,24.83809);
   VbbHcc_MC_Z_pt_stack_2->SetBinError(1001,0.07724779);
