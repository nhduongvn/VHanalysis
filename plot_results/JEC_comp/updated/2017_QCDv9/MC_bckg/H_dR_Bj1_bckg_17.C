...
#endif
void H_dR_Bj1_bckg_17()
{
//=========Macro generated from canvas: H_dR_Bj1_bckg_17/H_dR_Bj1_bckg_17
//=========  (Thu Mar 23 11:54:00 2023) by ROOT version 6.26/06
   TCanvas *H_dR_Bj1_bckg_17 = new TCanvas("H_dR_Bj1_bckg_17", "H_dR_Bj1_bckg_17",0,0,600,600);
   H_dR_Bj1_bckg_17->SetHighLightColor(2);
   H_dR_Bj1_bckg_17->Range(-1.310117,-0.1538462,7.029799,1.128205);
   H_dR_Bj1_bckg_17->SetFillColor(0);
   H_dR_Bj1_bckg_17->SetFillStyle(4000);
   H_dR_Bj1_bckg_17->SetBorderMode(0);
   H_dR_Bj1_bckg_17->SetBorderSize(2);
   H_dR_Bj1_bckg_17->SetLeftMargin(0.15709);
   H_dR_Bj1_bckg_17->SetRightMargin(0.1234783);
   H_dR_Bj1_bckg_17->SetBottomMargin(0.12);
   H_dR_Bj1_bckg_17->SetFrameFillStyle(1000);
   H_dR_Bj1_bckg_17->SetFrameBorderMode(0);
   H_dR_Bj1_bckg_17->SetFrameFillStyle(1000);
   H_dR_Bj1_bckg_17->SetFrameBorderMode(0);
   ...
   st_stack_22->GetXaxis()->SetTitle("#DeltaR(H,j_{2})");
   st_stack_22->GetXaxis()->SetRange(1,30);
...
tex->SetNDC();
   ...
   tex->SetLineWidth(2);
   tex->Draw();
   H_dR_Bj1_bckg_17->Modified();
   H_dR_Bj1_bckg_17->cd();
   H_dR_Bj1_bckg_17->SetSelected(H_dR_Bj1_bckg_17);
}
