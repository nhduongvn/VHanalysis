...
void Z_pt_bckg_17()
{
//=========Macro generated from canvas: Z_pt_bckg_17/Z_pt_bckg_17
//=========  (Thu Mar 23 11:54:01 2023) by ROOT version 6.26/06
   TCanvas *Z_pt_bckg_17 = new TCanvas("Z_pt_bckg_17", "Z_pt_bckg_17",0,0,600,600);
   Z_pt_bckg_17->SetHighLightColor(2);
   Z_pt_bckg_17->Range(37.97653,-0.1538462,1705.96,1.128205);
   Z_pt_bckg_17->SetFillColor(0);
   Z_pt_bckg_17->SetFillStyle(4000);
   Z_pt_bckg_17->SetBorderMode(0);
   Z_pt_bckg_17->SetBorderSize(2);
   Z_pt_bckg_17->SetLeftMargin(0.15709);
   Z_pt_bckg_17->SetRightMargin(0.1234783);
   Z_pt_bckg_17->SetBottomMargin(0.12);
   Z_pt_bckg_17->SetFrameFillStyle(1000);
   Z_pt_bckg_17->SetFrameBorderMode(0);
   Z_pt_bckg_17->SetFrameFillStyle(1000);
   Z_pt_bckg_17->SetFrameBorderMode(0);
   ...
   st_stack_64->GetXaxis()->SetTitle("Z p_{T} [GeV]");
   st_stack_64->GetXaxis()->SetRange(151,750);
...
tex->SetNDC();
   ...
   tex->SetLineWidth(2);
   tex->Draw();
   Z_pt_bckg_17->Modified();
   Z_pt_bckg_17->cd();
   Z_pt_bckg_17->SetSelected(Z_pt_bckg_17);
}
