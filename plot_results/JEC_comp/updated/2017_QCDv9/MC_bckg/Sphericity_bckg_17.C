...
#endif
void Sphericity_bckg_17()
{
//=========Macro generated from canvas: Sphericity_bckg_17/Sphericity_bckg_17
//=========  (Thu Mar 23 11:54:01 2023) by ROOT version 6.26/06
   TCanvas *Sphericity_bckg_17 = new TCanvas("Sphericity_bckg_17", "Sphericity_bckg_17",0,0,600,600);
   Sphericity_bckg_17->SetHighLightColor(2);
   Sphericity_bckg_17->Range(-0.2183529,-0.1538462,1.171633,1.128205);
   Sphericity_bckg_17->SetFillColor(0);
   Sphericity_bckg_17->SetFillStyle(4000);
   Sphericity_bckg_17->SetBorderMode(0);
   Sphericity_bckg_17->SetBorderSize(2);
   Sphericity_bckg_17->SetLeftMargin(0.15709);
   Sphericity_bckg_17->SetRightMargin(0.1234783);
   Sphericity_bckg_17->SetBottomMargin(0.12);
   Sphericity_bckg_17->SetFrameFillStyle(1000);
   Sphericity_bckg_17->SetFrameBorderMode(0);
   Sphericity_bckg_17->SetFrameFillStyle(1000);
   Sphericity_bckg_17->SetFrameBorderMode(0);
   ...
   TH1F *st_stack_76 = new TH1F("st_stack_76","",25,0,1);
...
tex->SetNDC();
   ...
   tex->SetLineWidth(2);
   tex->Draw();
   Sphericity_bckg_17->Modified();
   Sphericity_bckg_17->cd();
   Sphericity_bckg_17->SetSelected(Sphericity_bckg_17);
}
