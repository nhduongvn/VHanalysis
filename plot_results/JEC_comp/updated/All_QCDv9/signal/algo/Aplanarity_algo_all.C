...
//=========  (Thu Mar 23 11:25:13 2023) by ROOT version 6.26/06
   ...
   Aplanarity_algo_all->Range(-0.2183529,-0.3353841,1.171633,2.459483);
   ...
   VbbHcc_algo_Aplanarity_all_stack_1->SetBinContent(1,1.385237);
   VbbHcc_algo_Aplanarity_all_stack_1->SetBinContent(2,0.2806083);
   VbbHcc_algo_Aplanarity_all_stack_1->SetBinContent(3,0.05780019);
   VbbHcc_algo_Aplanarity_all_stack_1->SetBinContent(4,0.02571556);
   VbbHcc_algo_Aplanarity_all_stack_1->SetBinContent(5,0.007399942);
   VbbHcc_algo_Aplanarity_all_stack_1->SetBinContent(6,0.001787764);
   VbbHcc_algo_Aplanarity_all_stack_1->SetBinError(1,0.07079742);
   VbbHcc_algo_Aplanarity_all_stack_1->SetBinError(2,0.02665381);
   VbbHcc_algo_Aplanarity_all_stack_1->SetBinError(3,0.01147103);
   VbbHcc_algo_Aplanarity_all_stack_1->SetBinError(4,0.007797854);
   VbbHcc_algo_Aplanarity_all_stack_1->SetBinError(5,0.003707203);
   VbbHcc_algo_Aplanarity_all_stack_1->SetBinError(6,0.001787764);
   VbbHcc_algo_Aplanarity_all_stack_1->SetEntries(781);
   ...
   VbbHcc_algo_Aplanarity_all_stack_2->SetBinContent(1,0.4241604);
   VbbHcc_algo_Aplanarity_all_stack_2->SetBinContent(2,0.1230595);
   VbbHcc_algo_Aplanarity_all_stack_2->SetBinContent(3,0.03091307);
   VbbHcc_algo_Aplanarity_all_stack_2->SetBinContent(4,0.01231551);
   VbbHcc_algo_Aplanarity_all_stack_2->SetBinContent(5,0.003799763);
   VbbHcc_algo_Aplanarity_all_stack_2->SetBinContent(6,0.0006989857);
   VbbHcc_algo_Aplanarity_all_stack_2->SetBinContent(7,0.0007260972);
   VbbHcc_algo_Aplanarity_all_stack_2->SetBinContent(8,0.0003453574);
   VbbHcc_algo_Aplanarity_all_stack_2->SetBinContent(10,0.0001602772);
   VbbHcc_algo_Aplanarity_all_stack_2->SetBinContent(11,0.0003667146);
   VbbHcc_algo_Aplanarity_all_stack_2->SetBinError(1,0.01208394);
   VbbHcc_algo_Aplanarity_all_stack_2->SetBinError(2,0.006270146);
   VbbHcc_algo_Aplanarity_all_stack_2->SetBinError(3,0.003106867);
   VbbHcc_algo_Aplanarity_all_stack_2->SetBinError(4,0.001995329);
   VbbHcc_algo_Aplanarity_all_stack_2->SetBinError(5,0.001174515);
   VbbHcc_algo_Aplanarity_all_stack_2->SetBinError(6,0.0004959484);
   VbbHcc_algo_Aplanarity_all_stack_2->SetBinError(7,0.0004406355);
   VbbHcc_algo_Aplanarity_all_stack_2->SetBinError(8,0.0002444298);
   VbbHcc_algo_Aplanarity_all_stack_2->SetBinError(10,0.0001602772);
   VbbHcc_algo_Aplanarity_all_stack_2->SetBinError(11,0.0002649957);
   VbbHcc_algo_Aplanarity_all_stack_2->SetEntries(2012);
