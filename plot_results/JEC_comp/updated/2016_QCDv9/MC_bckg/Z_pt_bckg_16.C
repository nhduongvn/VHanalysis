...
void Z_pt_bckg_16()
{
//=========Macro generated from canvas: Z_pt_bckg_16/Z_pt_bckg_16
//=========  (Thu Mar 23 11:54:01 2023) by ROOT version 6.26/06
   TCanvas *Z_pt_bckg_16 = new TCanvas("Z_pt_bckg_16", "Z_pt_bckg_16",0,0,600,600);
   Z_pt_bckg_16->SetHighLightColor(2);
   Z_pt_bckg_16->Range(37.97653,-0.1538462,1705.96,1.128205);
   Z_pt_bckg_16->SetFillColor(0);
   Z_pt_bckg_16->SetFillStyle(4000);
   Z_pt_bckg_16->SetBorderMode(0);
   Z_pt_bckg_16->SetBorderSize(2);
   Z_pt_bckg_16->SetLeftMargin(0.15709);
   Z_pt_bckg_16->SetRightMargin(0.1234783);
   Z_pt_bckg_16->SetBottomMargin(0.12);
   Z_pt_bckg_16->SetFrameFillStyle(1000);
   Z_pt_bckg_16->SetFrameBorderMode(0);
   Z_pt_bckg_16->SetFrameFillStyle(1000);
   Z_pt_bckg_16->SetFrameBorderMode(0);
   ...
   st_stack_62->GetXaxis()->SetTitle("Z p_{T} [GeV]");
   st_stack_62->GetXaxis()->SetRange(151,750);
...
tex->SetNDC();
   ...
   tex->SetLineWidth(2);
   tex->Draw();
   Z_pt_bckg_16->Modified();
   Z_pt_bckg_16->cd();
   Z_pt_bckg_16->SetSelected(Z_pt_bckg_16);
}
