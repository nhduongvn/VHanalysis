...
//=========  (Thu Mar 23 11:25:13 2023) by ROOT version 6.26/06
   ...
   Aplanarity_algo_16->Range(-0.2183529,-0.06647831,1.171633,0.4875076);
   ...
   VbbHcc_algo_Aplanarity_stack_1->SetBinContent(1,0.2783248);
   VbbHcc_algo_Aplanarity_stack_1->SetBinContent(2,0.06735018);
   VbbHcc_algo_Aplanarity_stack_1->SetBinContent(3,0.01001423);
   VbbHcc_algo_Aplanarity_stack_1->SetBinContent(4,0.006906783);
   VbbHcc_algo_Aplanarity_stack_1->SetBinError(1,0.02861794);
   VbbHcc_algo_Aplanarity_stack_1->SetBinError(2,0.01414125);
   VbbHcc_algo_Aplanarity_stack_1->SetBinError(3,0.005205269);
   VbbHcc_algo_Aplanarity_stack_1->SetBinError(4,0.00436992);
   VbbHcc_algo_Aplanarity_stack_1->SetEntries(126);
   ...
   VbbHcc_algo_Aplanarity_stack_2->SetBinContent(1,0.08032569);
   VbbHcc_algo_Aplanarity_stack_2->SetBinContent(2,0.02427244);
   VbbHcc_algo_Aplanarity_stack_2->SetBinContent(3,0.005355874);
   VbbHcc_algo_Aplanarity_stack_2->SetBinContent(4,0.003095758);
   VbbHcc_algo_Aplanarity_stack_2->SetBinContent(5,0.0007799712);
   VbbHcc_algo_Aplanarity_stack_2->SetBinContent(6,0.0003784267);
   VbbHcc_algo_Aplanarity_stack_2->SetBinError(1,0.005518071);
   VbbHcc_algo_Aplanarity_stack_2->SetBinError(2,0.003034615);
   VbbHcc_algo_Aplanarity_stack_2->SetBinError(3,0.001433419);
   VbbHcc_algo_Aplanarity_stack_2->SetBinError(4,0.001095958);
   VbbHcc_algo_Aplanarity_stack_2->SetBinError(5,0.0005521356);
   VbbHcc_algo_Aplanarity_stack_2->SetBinError(6,0.0003784267);
   VbbHcc_algo_Aplanarity_stack_2->SetEntries(308);
