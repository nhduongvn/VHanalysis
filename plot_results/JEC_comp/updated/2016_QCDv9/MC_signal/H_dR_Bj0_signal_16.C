...
#endif
void H_dR_Bj0_signal_16()
{
//=========Macro generated from canvas: H_dR_Bj0_signal_16/H_dR_Bj0_signal_16
//=========  (Thu Mar 23 11:54:00 2023) by ROOT version 6.26/06
   TCanvas *H_dR_Bj0_signal_16 = new TCanvas("H_dR_Bj0_signal_16", "H_dR_Bj0_signal_16",0,0,600,600);
   H_dR_Bj0_signal_16->SetHighLightColor(2);
   H_dR_Bj0_signal_16->Range(-1.310117,-31.20377,7.029799,228.8277);
   H_dR_Bj0_signal_16->SetFillColor(0);
   H_dR_Bj0_signal_16->SetFillStyle(4000);
   H_dR_Bj0_signal_16->SetBorderMode(0);
   H_dR_Bj0_signal_16->SetBorderSize(2);
   H_dR_Bj0_signal_16->SetLeftMargin(0.15709);
   H_dR_Bj0_signal_16->SetRightMargin(0.1234783);
   H_dR_Bj0_signal_16->SetBottomMargin(0.12);
   H_dR_Bj0_signal_16->SetFrameFillStyle(1000);
   H_dR_Bj0_signal_16->SetFrameBorderMode(0);
   H_dR_Bj0_signal_16->SetFrameFillStyle(1000);
   H_dR_Bj0_signal_16->SetFrameBorderMode(0);
   ...
   st_stack_13->SetMaximum(202.8245);
   ...
   VbbHcc_MC_H_dR_Bj0_stack_1->SetBinContent(1,148.8719);
   VbbHcc_MC_H_dR_Bj0_stack_1->SetBinError(1,0.6380955);
   ...
   VbbHcc_MC_H_dR_Bj0_stack_2->SetBinContent(1,19.47242);
   VbbHcc_MC_H_dR_Bj0_stack_2->SetBinError(1,0.08340761);
...
tex->SetNDC();
   ...
   tex->SetLineWidth(2);
   tex->Draw();
   H_dR_Bj0_signal_16->Modified();
   H_dR_Bj0_signal_16->cd();
   H_dR_Bj0_signal_16->SetSelected(H_dR_Bj0_signal_16);
}
