...
//=========  (Thu Mar 23 11:54:01 2023) by ROOT version 6.26/06
   ...
   H_pt_signal_16->Range(37.97653,-27.28969,1705.96,200.1244);
   ...
   VbbHcc_MC_H_pt_stack_1->SetBinContent(1,147.2279);
   VbbHcc_MC_H_pt_stack_1->SetBinError(1,0.6764884);
   ...
   VbbHcc_MC_H_pt_stack_2->SetBinContent(1,20.43485);
   VbbHcc_MC_H_pt_stack_2->SetBinError(1,0.08835185);
