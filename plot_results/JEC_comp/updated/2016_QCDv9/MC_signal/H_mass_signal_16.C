...
//=========  (Thu Mar 23 11:54:00 2023) by ROOT version 6.26/06
   ...
   H_mass_signal_16->Range(-65.50587,-31.07743,351.4899,227.9012);
   ...
   VbbHcc_MC_H_mass_stack_1->SetBinContent(1,147.2279);
   VbbHcc_MC_H_mass_stack_1->SetBinError(1,0.6764884);
   ...
   VbbHcc_MC_H_mass_stack_2->SetBinContent(1,20.43485);
   VbbHcc_MC_H_mass_stack_2->SetBinError(1,0.08835185);
