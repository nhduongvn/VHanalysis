...
void H_dR_bckg_18()
{
//=========Macro generated from canvas: H_dR_bckg_18/H_dR_bckg_18
//=========  (Thu Mar 23 11:54:00 2023) by ROOT version 6.26/06
   TCanvas *H_dR_bckg_18 = new TCanvas("H_dR_bckg_18", "H_dR_bckg_18",0,0,600,600);
   H_dR_bckg_18->SetHighLightColor(2);
   H_dR_bckg_18->Range(-1.353788,-0.1538462,7.264125,1.128205);
   H_dR_bckg_18->SetFillColor(0);
   H_dR_bckg_18->SetFillStyle(4000);
   H_dR_bckg_18->SetBorderMode(0);
   H_dR_bckg_18->SetBorderSize(2);
   H_dR_bckg_18->SetLeftMargin(0.15709);
   H_dR_bckg_18->SetRightMargin(0.1234783);
   H_dR_bckg_18->SetBottomMargin(0.12);
   H_dR_bckg_18->SetFrameFillStyle(1000);
   H_dR_bckg_18->SetFrameBorderMode(0);
   H_dR_bckg_18->SetFrameFillStyle(1000);
   H_dR_bckg_18->SetFrameBorderMode(0);
   ...
   st_stack_12->GetXaxis()->SetTitle("#DeltaR(c,c)");
   st_stack_12->GetXaxis()->SetRange(1,31);
...
tex->SetNDC();
   ...
   tex->SetLineWidth(2);
   tex->Draw();
   H_dR_bckg_18->Modified();
   H_dR_bckg_18->cd();
   H_dR_bckg_18->SetSelected(H_dR_bckg_18);
}
