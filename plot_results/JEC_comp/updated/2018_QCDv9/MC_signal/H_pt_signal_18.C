...
//=========  (Thu Mar 23 11:54:01 2023) by ROOT version 6.26/06
   ...
   H_pt_signal_18->Range(37.97653,-49.0471,1705.96,359.6788);
   ...
   st_stack_59->SetMaximum(318.8062);
   ...
   VbbHcc_MC_H_pt_stack_1->SetBinContent(1,264.6091);
   VbbHcc_MC_H_pt_stack_1->SetBinError(1,0.9255166);
   ...
   VbbHcc_MC_H_pt_stack_2->SetBinContent(1,36.8655);
   VbbHcc_MC_H_pt_stack_2->SetBinError(1,0.123835);
