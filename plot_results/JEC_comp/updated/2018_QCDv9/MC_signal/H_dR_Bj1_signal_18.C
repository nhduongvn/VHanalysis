...
#endif
void H_dR_Bj1_signal_18()
{
//=========Macro generated from canvas: H_dR_Bj1_signal_18/H_dR_Bj1_signal_18
//=========  (Thu Mar 23 11:54:00 2023) by ROOT version 6.26/06
   TCanvas *H_dR_Bj1_signal_18 = new TCanvas("H_dR_Bj1_signal_18", "H_dR_Bj1_signal_18",0,0,600,600);
   H_dR_Bj1_signal_18->SetHighLightColor(2);
   H_dR_Bj1_signal_18->Range(-1.310117,-51.88318,7.029799,380.4766);
   H_dR_Bj1_signal_18->SetFillColor(0);
   H_dR_Bj1_signal_18->SetFillStyle(4000);
   H_dR_Bj1_signal_18->SetBorderMode(0);
   H_dR_Bj1_signal_18->SetBorderSize(2);
   H_dR_Bj1_signal_18->SetLeftMargin(0.15709);
   H_dR_Bj1_signal_18->SetRightMargin(0.1234783);
   H_dR_Bj1_signal_18->SetBottomMargin(0.12);
   H_dR_Bj1_signal_18->SetFrameFillStyle(1000);
   H_dR_Bj1_signal_18->SetFrameBorderMode(0);
   H_dR_Bj1_signal_18->SetFrameFillStyle(1000);
   H_dR_Bj1_signal_18->SetFrameBorderMode(0);
   ...
   st_stack_23->SetMaximum(337.2406);
   ...
   VbbHcc_MC_H_dR_Bj1_stack_1->SetBinContent(1,247.5255);
   VbbHcc_MC_H_dR_Bj1_stack_1->SetBinError(1,0.7505392);
   ...
   VbbHcc_MC_H_dR_Bj1_stack_2->SetBinContent(1,32.38421);
   VbbHcc_MC_H_dR_Bj1_stack_2->SetBinError(1,0.09850964);
...
tex->SetNDC();
   ...
   tex->SetLineWidth(2);
   tex->Draw();
   H_dR_Bj1_signal_18->Modified();
   H_dR_Bj1_signal_18->cd();
   H_dR_Bj1_signal_18->SetSelected(H_dR_Bj1_signal_18);
}
