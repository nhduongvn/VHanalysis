...
//=========  (Thu Mar 23 11:54:00 2023) by ROOT version 6.26/06
   ...
   H_dR_signal_18->Range(-1.353788,-55.88038,7.264125,409.7894);
   ...
   st_stack_11->SetMaximum(363.2224);
   ...
   VbbHcc_MC_H_dR_stack_1->SetBinContent(1,264.6091);
   VbbHcc_MC_H_dR_stack_1->SetBinError(1,0.9255166);
   ...
   VbbHcc_MC_H_dR_stack_2->SetBinContent(1,36.8655);
   VbbHcc_MC_H_dR_stack_2->SetBinError(1,0.123835);
