...
//=========  (Thu Mar 30 10:44:40 2023) by ROOT version 6.14/09
   ...
   H_dR_both_all->Range(-1.353788,-0.5187513,7.264125,3.804176);
   ...
   TH1F *st_stack_600 = new TH1F("st_stack_600","",30,0,6);
   st_stack_600->SetMinimum(0);
   st_stack_600->SetMaximum(3.371883);
   st_stack_600->SetDirectory(0);
   st_stack_600->SetStats(0);

   Int_t ci;      // for color index setting
   TColor *color; // for color definition with alpha
   ci = TColor::GetColor("#000099");
   st_stack_600->SetLineColor(ci);
   st_stack_600->GetXaxis()->SetTitle("#DeltaR(c,c)");
   st_stack_600->GetXaxis()->SetRange(1,31);
   st_stack_600->GetXaxis()->SetLabelFont(42);
   st_stack_600->GetXaxis()->SetLabelSize(0.035);
   st_stack_600->GetXaxis()->SetTitleSize(0.035);
   st_stack_600->GetXaxis()->SetTitleFont(42);
   st_stack_600->GetYaxis()->SetTitle("Event/0.2");
   st_stack_600->GetYaxis()->SetLabelFont(42);
   st_stack_600->GetYaxis()->SetLabelSize(0.035);
   st_stack_600->GetYaxis()->SetTitleSize(0.037);
   st_stack_600->GetYaxis()->SetTitleOffset(0);
   st_stack_600->GetYaxis()->SetTitleFont(42);
   st_stack_600->GetZaxis()->SetLabelFont(42);
   st_stack_600->GetZaxis()->SetLabelSize(0.035);
   st_stack_600->GetZaxis()->SetTitleSize(0.035);
   st_stack_600->GetZaxis()->SetTitleFont(42);
   st->SetHistogram(st_stack_600);
