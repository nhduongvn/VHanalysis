...
//=========  (Thu Mar 30 10:44:43 2023) by ROOT version 6.14/09
   ...
   H_jetpt_JEC_both_all->Range(-65.50587,-2.107028,351.4899,15.45154);
   ...
   TH1F *st_stack_648 = new TH1F("st_stack_648","",150,0,300);
   st_stack_648->SetMinimum(0);
   st_stack_648->SetMaximum(13.69568);
   st_stack_648->SetDirectory(0);
   st_stack_648->SetStats(0);

   Int_t ci;      // for color index setting
   TColor *color; // for color definition with alpha
   ci = TColor::GetColor("#000099");
   st_stack_648->SetLineColor(ci);
   st_stack_648->GetXaxis()->SetTitle("c-jet p_{T} (w/ JEC) [GeV]");
   st_stack_648->GetXaxis()->SetRange(1,150);
   st_stack_648->GetXaxis()->SetLabelFont(42);
   st_stack_648->GetXaxis()->SetLabelSize(0.035);
   st_stack_648->GetXaxis()->SetTitleSize(0.035);
   st_stack_648->GetXaxis()->SetTitleFont(42);
   st_stack_648->GetYaxis()->SetTitle("Event/2.0 GeV");
   st_stack_648->GetYaxis()->SetLabelFont(42);
   st_stack_648->GetYaxis()->SetLabelSize(0.035);
   st_stack_648->GetYaxis()->SetTitleSize(0.037);
   st_stack_648->GetYaxis()->SetTitleOffset(0);
   st_stack_648->GetYaxis()->SetTitleFont(42);
   st_stack_648->GetZaxis()->SetLabelFont(42);
   st_stack_648->GetZaxis()->SetLabelSize(0.035);
   st_stack_648->GetZaxis()->SetTitleSize(0.035);
   st_stack_648->GetZaxis()->SetTitleFont(42);
   st->SetHistogram(st_stack_648);
