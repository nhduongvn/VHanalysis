...
//=========  (Thu Mar 30 10:44:24 2023) by ROOT version 6.14/09
   ...
   H_dR_Bj0_algo_all->Range(-1.310117,-0.4021551,7.029799,2.949138);
   ...
   TH1F *st_stack_332 = new TH1F("st_stack_332","",30,0,6);
   st_stack_332->SetMinimum(0);
   st_stack_332->SetMaximum(2.614008);
   ...
   st_stack_332->GetXaxis()->SetTitle("#DeltaR(H,j_{1})");
   st_stack_332->GetXaxis()->SetRange(1,30);
   ...
   st_stack_332->GetYaxis()->SetTitle("Event/0.2");
   st_stack_332->GetYaxis()->SetLabelFont(42);
   st_stack_332->GetYaxis()->SetLabelSize(0.035);
   st_stack_332->GetYaxis()->SetTitleSize(0.037);
   st_stack_332->GetYaxis()->SetTitleOffset(0);
