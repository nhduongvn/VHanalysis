...
//=========  (Thu Mar 30 10:44:24 2023) by ROOT version 6.14/09
   ...
   H_dR_Bj1_algo_all->Range(-1.310117,-0.2596743,7.029799,1.904278);
   ...
   TH1F *st_stack_336 = new TH1F("st_stack_336","",30,0,6);
   st_stack_336->SetMinimum(0);
   st_stack_336->SetMaximum(1.687883);
   ...
   st_stack_336->GetXaxis()->SetTitle("#DeltaR(H,j_{2})");
   ...
   st_stack_336->GetYaxis()->SetTitle("Event/0.2");
   st_stack_336->GetYaxis()->SetLabelFont(42);
   st_stack_336->GetYaxis()->SetLabelSize(0.035);
   st_stack_336->GetYaxis()->SetTitleSize(0.037);
   st_stack_336->GetYaxis()->SetTitleOffset(0);
