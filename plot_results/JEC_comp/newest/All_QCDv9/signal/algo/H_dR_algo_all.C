...
//=========  (Thu Mar 30 10:44:23 2023) by ROOT version 6.14/09
   ...
   H_dR_algo_all->Range(-1.353788,-0.2141642,7.264125,1.570538);
   ...
   st_stack_312->SetMaximum(1.392067);
   ...
   st_stack_312->GetXaxis()->SetTitle("#DeltaR(c,c)");
   st_stack_312->GetXaxis()->SetRange(1,31);
   ...
   st_stack_312->GetYaxis()->SetTitle("Event/0.2");
