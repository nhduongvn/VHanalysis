...
//=========  (Thu Mar 30 10:44:26 2023) by ROOT version 6.14/09
   ...
   H_jetmass_JEC_algo_all->Range(-65.50587,-0.8667744,351.4899,6.356346);
   ...
   TH1F *st_stack_368 = new TH1F("st_stack_368","",150,0,300);
   st_stack_368->SetMinimum(0);
   st_stack_368->SetMaximum(5.634034);
   st_stack_368->SetDirectory(0);
   st_stack_368->SetStats(0);

   Int_t ci;      // for color index setting
   TColor *color; // for color definition with alpha
   ci = TColor::GetColor("#000099");
   st_stack_368->SetLineColor(ci);
   st_stack_368->GetXaxis()->SetTitle("c-jet mass (w/ JEC) [GeV]");
   st_stack_368->GetXaxis()->SetRange(1,150);
   st_stack_368->GetXaxis()->SetLabelFont(42);
   st_stack_368->GetXaxis()->SetLabelSize(0.035);
   st_stack_368->GetXaxis()->SetTitleSize(0.035);
   st_stack_368->GetXaxis()->SetTitleFont(42);
   st_stack_368->GetYaxis()->SetTitle("Event/2.0 GeV");
   st_stack_368->GetYaxis()->SetLabelFont(42);
   st_stack_368->GetYaxis()->SetLabelSize(0.035);
   st_stack_368->GetYaxis()->SetTitleSize(0.037);
   st_stack_368->GetYaxis()->SetTitleOffset(0);
   st_stack_368->GetYaxis()->SetTitleFont(42);
   st_stack_368->GetZaxis()->SetLabelFont(42);
   st_stack_368->GetZaxis()->SetLabelSize(0.035);
   st_stack_368->GetZaxis()->SetTitleSize(0.035);
   st_stack_368->GetZaxis()->SetTitleFont(42);
   st->SetHistogram(st_stack_368);
   ...
   VbbHcc_algo_H_jetmass_JEC_all_stack_1->SetBinContent(151,0.001576883);
   ...
   VbbHcc_algo_H_jetmass_JEC_all_stack_1->SetBinError(151,0.001576883);
