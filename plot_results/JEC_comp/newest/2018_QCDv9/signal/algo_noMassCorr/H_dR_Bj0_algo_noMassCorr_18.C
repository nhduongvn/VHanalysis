void H_dR_Bj0_algo_noMassCorr_18()
{
//=========Macro generated from canvas: H_dR_Bj0_algo_noMassCorr_18/H_dR_Bj0_algo_noMassCorr_18
//=========  (Thu Mar 30 10:44:30 2023) by ROOT version 6.14/09
   TCanvas *H_dR_Bj0_algo_noMassCorr_18 = new TCanvas("H_dR_Bj0_algo_noMassCorr_18", "H_dR_Bj0_algo_noMassCorr_18",0,0,600,600);
   H_dR_Bj0_algo_noMassCorr_18->SetHighLightColor(2);
   H_dR_Bj0_algo_noMassCorr_18->Range(-1.310117,-0.5334158,7.029799,3.911716);
   H_dR_Bj0_algo_noMassCorr_18->SetFillColor(0);
   H_dR_Bj0_algo_noMassCorr_18->SetFillStyle(4000);
   H_dR_Bj0_algo_noMassCorr_18->SetBorderMode(0);
   H_dR_Bj0_algo_noMassCorr_18->SetBorderSize(2);
   H_dR_Bj0_algo_noMassCorr_18->SetLeftMargin(0.15709);
   H_dR_Bj0_algo_noMassCorr_18->SetRightMargin(0.1234783);
   H_dR_Bj0_algo_noMassCorr_18->SetBottomMargin(0.12);
   H_dR_Bj0_algo_noMassCorr_18->SetFrameFillStyle(1000);
   H_dR_Bj0_algo_noMassCorr_18->SetFrameBorderMode(0);
   H_dR_Bj0_algo_noMassCorr_18->SetFrameFillStyle(1000);
   H_dR_Bj0_algo_noMassCorr_18->SetFrameBorderMode(0);
   ...
   st->SetName("st");
   st->SetTitle("");
   st->SetMaximum(3.302098);
   
   TH1F *st_stack_427 = new TH1F("st_stack_427","",30,0,6);
   st_stack_427->SetMinimum(0);
   st_stack_427->SetMaximum(3.467203);
   st_stack_427->SetDirectory(0);
   st_stack_427->SetStats(0);

   Int_t ci;      // for color index setting
   TColor *color; // for color definition with alpha
   ci = TColor::GetColor("#000099");
   st_stack_427->SetLineColor(ci);
   st_stack_427->GetXaxis()->SetTitle("#DeltaR(H,j_{1})");
   st_stack_427->GetXaxis()->SetRange(1,30);
   st_stack_427->GetXaxis()->SetLabelFont(42);
   st_stack_427->GetXaxis()->SetLabelSize(0.035);
   st_stack_427->GetXaxis()->SetTitleSize(0.035);
   st_stack_427->GetXaxis()->SetTitleFont(42);
   st_stack_427->GetYaxis()->SetTitle("Event/0.2");
   st_stack_427->GetYaxis()->SetLabelFont(42);
   st_stack_427->GetYaxis()->SetLabelSize(0.035);
   st_stack_427->GetYaxis()->SetTitleSize(0.037);
   st_stack_427->GetYaxis()->SetTitleOffset(0);
   st_stack_427->GetYaxis()->SetTitleFont(42);
   st_stack_427->GetZaxis()->SetLabelFont(42);
   st_stack_427->GetZaxis()->SetLabelSize(0.035);
   st_stack_427->GetZaxis()->SetTitleSize(0.035);
   st_stack_427->GetZaxis()->SetTitleFont(42);
   st->SetHistogram(st_stack_427);
   
   
   TH1D *VbbHcc_algo_noMassCorr_H_dR_Bj0_stack_1 = new TH1D("VbbHcc_algo_noMassCorr_H_dR_Bj0_stack_1","",30,0,6);
   VbbHcc_algo_noMassCorr_H_dR_Bj0_stack_1->SetBinContent(1,2.064116);
   VbbHcc_algo_noMassCorr_H_dR_Bj0_stack_1->SetBinError(1,0.06853785);
   VbbHcc_algo_noMassCorr_H_dR_Bj0_stack_1->SetEntries(907);
   ...
   VbbHcc_algo_noMassCorr_H_dR_Bj0_stack_2->SetBinContent(1,0.676625);
   VbbHcc_algo_noMassCorr_H_dR_Bj0_stack_2->SetBinError(1,0.01423922);
   VbbHcc_algo_noMassCorr_H_dR_Bj0_stack_2->SetEntries(2258);
...
tex->SetNDC();
   ...
   tex->SetLineWidth(2);
   tex->Draw();
   H_dR_Bj0_algo_noMassCorr_18->Modified();
   H_dR_Bj0_algo_noMassCorr_18->cd();
   H_dR_Bj0_algo_noMassCorr_18->SetSelected(H_dR_Bj0_algo_noMassCorr_18);
}
