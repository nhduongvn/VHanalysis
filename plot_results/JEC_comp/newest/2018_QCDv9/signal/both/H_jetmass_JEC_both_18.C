...
//=========  (Thu Mar 30 10:44:43 2023) by ROOT version 6.14/09
   ...
   H_jetmass_JEC_both_18->Range(-65.50587,-1.597242,351.4899,11.71311);
   ...
   TH1F *st_stack_655 = new TH1F("st_stack_655","",150,0,300);
   st_stack_655->SetMinimum(0);
   st_stack_655->SetMaximum(10.38207);
   st_stack_655->SetDirectory(0);
   st_stack_655->SetStats(0);

   Int_t ci;      // for color index setting
   TColor *color; // for color definition with alpha
   ci = TColor::GetColor("#000099");
   st_stack_655->SetLineColor(ci);
   st_stack_655->GetXaxis()->SetTitle("c-jet mass (w/ JEC) [GeV]");
   st_stack_655->GetXaxis()->SetRange(1,150);
   st_stack_655->GetXaxis()->SetLabelFont(42);
   st_stack_655->GetXaxis()->SetLabelSize(0.035);
   st_stack_655->GetXaxis()->SetTitleSize(0.035);
   st_stack_655->GetXaxis()->SetTitleFont(42);
   st_stack_655->GetYaxis()->SetTitle("Event/2.0 GeV");
   st_stack_655->GetYaxis()->SetLabelFont(42);
   st_stack_655->GetYaxis()->SetLabelSize(0.035);
   st_stack_655->GetYaxis()->SetTitleSize(0.037);
   st_stack_655->GetYaxis()->SetTitleOffset(0);
   st_stack_655->GetYaxis()->SetTitleFont(42);
   st_stack_655->GetZaxis()->SetLabelFont(42);
   st_stack_655->GetZaxis()->SetLabelSize(0.035);
   st_stack_655->GetZaxis()->SetTitleSize(0.035);
   st_stack_655->GetZaxis()->SetTitleFont(42);
   st->SetHistogram(st_stack_655);
   
   
   TH1D *VbbHcc_both_H_jetmass_JEC_stack_1 = new TH1D("VbbHcc_both_H_jetmass_JEC_stack_1","",150,0,300);
   VbbHcc_both_H_jetmass_JEC_stack_1->SetBinContent(2,5.898395);
   VbbHcc_both_H_jetmass_JEC_stack_1->SetBinContent(3,2.213074);
   VbbHcc_both_H_jetmass_JEC_stack_1->SetBinContent(151,0.001576883);
   VbbHcc_both_H_jetmass_JEC_stack_1->SetBinError(2,0.1407918);
   VbbHcc_both_H_jetmass_JEC_stack_1->SetBinError(3,0.07862308);
   VbbHcc_both_H_jetmass_JEC_stack_1->SetBinError(151,0.001576883);
   VbbHcc_both_H_jetmass_JEC_stack_1->SetEntries(3234);
   ...
   VbbHcc_both_H_jetmass_JEC_stack_2->SetBinContent(2,2.308387);
   VbbHcc_both_H_jetmass_JEC_stack_2->SetBinContent(3,1.208258);
   VbbHcc_both_H_jetmass_JEC_stack_2->SetBinError(2,0.02969172);
   VbbHcc_both_H_jetmass_JEC_stack_2->SetBinError(3,0.02199144);
   VbbHcc_both_H_jetmass_JEC_stack_2->SetEntries(10352);
