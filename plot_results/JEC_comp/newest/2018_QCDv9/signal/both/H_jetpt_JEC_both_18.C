...
//=========  (Thu Mar 30 10:44:43 2023) by ROOT version 6.14/09
   ...
   H_jetpt_JEC_both_18->Range(-65.50587,-0.9610614,351.4899,7.047784);
   ...
   TH1F *st_stack_647 = new TH1F("st_stack_647","",150,0,300);
   st_stack_647->SetMinimum(0);
   st_stack_647->SetMaximum(6.246899);
   st_stack_647->SetDirectory(0);
   st_stack_647->SetStats(0);

   Int_t ci;      // for color index setting
   TColor *color; // for color definition with alpha
   ci = TColor::GetColor("#000099");
   st_stack_647->SetLineColor(ci);
   st_stack_647->GetXaxis()->SetTitle("c-jet p_{T} (w/ JEC) [GeV]");
   st_stack_647->GetXaxis()->SetRange(1,150);
   st_stack_647->GetXaxis()->SetLabelFont(42);
   st_stack_647->GetXaxis()->SetLabelSize(0.035);
   st_stack_647->GetXaxis()->SetTitleSize(0.035);
   st_stack_647->GetXaxis()->SetTitleFont(42);
   st_stack_647->GetYaxis()->SetTitle("Event/2.0 GeV");
   st_stack_647->GetYaxis()->SetLabelFont(42);
   st_stack_647->GetYaxis()->SetLabelSize(0.035);
   st_stack_647->GetYaxis()->SetTitleSize(0.037);
   st_stack_647->GetYaxis()->SetTitleOffset(0);
   st_stack_647->GetYaxis()->SetTitleFont(42);
   st_stack_647->GetZaxis()->SetLabelFont(42);
   st_stack_647->GetZaxis()->SetLabelSize(0.035);
   st_stack_647->GetZaxis()->SetTitleSize(0.035);
   st_stack_647->GetZaxis()->SetTitleFont(42);
   st->SetHistogram(st_stack_647);
