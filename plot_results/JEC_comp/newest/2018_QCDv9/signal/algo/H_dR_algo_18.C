...
//=========  (Thu Mar 30 10:44:23 2023) by ROOT version 6.14/09
   ...
   H_dR_algo_18->Range(-1.353788,-0.1062438,7.264125,0.7791213);
   ...
   st_stack_311->SetMaximum(0.6905848);
   ...
   st_stack_311->GetXaxis()->SetTitle("#DeltaR(c,c)");
   st_stack_311->GetXaxis()->SetRange(1,31);
   ...
   st_stack_311->GetYaxis()->SetTitle("Event/0.2");
