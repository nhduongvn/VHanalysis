...
//=========  (Thu Mar 30 10:44:24 2023) by ROOT version 6.14/09
   ...
   H_dR_Bj1_algo_18->Range(-1.310117,-0.1175472,7.029799,0.8620125);
   ...
   TH1F *st_stack_335 = new TH1F("st_stack_335","",30,0,6);
   st_stack_335->SetMinimum(0);
   st_stack_335->SetMaximum(0.7640565);
   ...
   st_stack_335->GetXaxis()->SetTitle("#DeltaR(H,j_{2})");
   ...
   st_stack_335->GetYaxis()->SetTitle("Event/0.2");
   st_stack_335->GetYaxis()->SetLabelFont(42);
   st_stack_335->GetYaxis()->SetLabelSize(0.035);
   st_stack_335->GetYaxis()->SetTitleSize(0.037);
   st_stack_335->GetYaxis()->SetTitleOffset(0);
