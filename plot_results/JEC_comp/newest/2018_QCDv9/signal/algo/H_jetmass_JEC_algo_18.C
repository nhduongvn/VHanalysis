...
//=========  (Thu Mar 30 10:44:26 2023) by ROOT version 6.14/09
   ...
   H_jetmass_JEC_algo_18->Range(-65.50587,-0.4058705,351.4899,2.976384);
   ...
   TH1F *st_stack_367 = new TH1F("st_stack_367","",150,0,300);
   st_stack_367->SetMinimum(0);
   st_stack_367->SetMaximum(2.638158);
   st_stack_367->SetDirectory(0);
   st_stack_367->SetStats(0);

   Int_t ci;      // for color index setting
   TColor *color; // for color definition with alpha
   ci = TColor::GetColor("#000099");
   st_stack_367->SetLineColor(ci);
   st_stack_367->GetXaxis()->SetTitle("c-jet mass (w/ JEC) [GeV]");
   st_stack_367->GetXaxis()->SetRange(1,150);
   st_stack_367->GetXaxis()->SetLabelFont(42);
   st_stack_367->GetXaxis()->SetLabelSize(0.035);
   st_stack_367->GetXaxis()->SetTitleSize(0.035);
   st_stack_367->GetXaxis()->SetTitleFont(42);
   st_stack_367->GetYaxis()->SetTitle("Event/2.0 GeV");
   st_stack_367->GetYaxis()->SetLabelFont(42);
   st_stack_367->GetYaxis()->SetLabelSize(0.035);
   st_stack_367->GetYaxis()->SetTitleSize(0.037);
   st_stack_367->GetYaxis()->SetTitleOffset(0);
   st_stack_367->GetYaxis()->SetTitleFont(42);
   st_stack_367->GetZaxis()->SetLabelFont(42);
   st_stack_367->GetZaxis()->SetLabelSize(0.035);
   st_stack_367->GetZaxis()->SetTitleSize(0.035);
   st_stack_367->GetZaxis()->SetTitleFont(42);
   st->SetHistogram(st_stack_367);
   ...
   VbbHcc_algo_H_jetmass_JEC_stack_1->SetBinContent(151,0.001576883);
   VbbHcc_algo_H_jetmass_JEC_stack_1->SetBinError(2,0.07704275);
   VbbHcc_algo_H_jetmass_JEC_stack_1->SetBinError(3,0.04165713);
   VbbHcc_algo_H_jetmass_JEC_stack_1->SetBinError(151,0.001576883);
