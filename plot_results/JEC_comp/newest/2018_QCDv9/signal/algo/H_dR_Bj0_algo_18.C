...
//=========  (Thu Mar 30 10:44:24 2023) by ROOT version 6.14/09
   ...
   H_dR_Bj0_algo_18->Range(-1.310117,-0.1867829,7.029799,1.369742);
   ...
   TH1F *st_stack_331 = new TH1F("st_stack_331","",30,0,6);
   st_stack_331->SetMinimum(0);
   st_stack_331->SetMaximum(1.214089);
   ...
   st_stack_331->GetXaxis()->SetTitle("#DeltaR(H,j_{1})");
   st_stack_331->GetXaxis()->SetRange(1,30);
   ...
   st_stack_331->GetYaxis()->SetTitle("Event/0.2");
   st_stack_331->GetYaxis()->SetLabelFont(42);
   st_stack_331->GetYaxis()->SetLabelSize(0.035);
   st_stack_331->GetYaxis()->SetTitleSize(0.037);
   st_stack_331->GetYaxis()->SetTitleOffset(0);
