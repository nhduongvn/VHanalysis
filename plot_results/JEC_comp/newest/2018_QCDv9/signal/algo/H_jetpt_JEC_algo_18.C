...
//=========  (Thu Mar 30 10:44:26 2023) by ROOT version 6.14/09
   ...
   H_jetpt_JEC_algo_18->Range(-65.50587,-0.2538766,351.4899,1.861762);
   ...
   TH1F *st_stack_359 = new TH1F("st_stack_359","",150,0,300);
   st_stack_359->SetMinimum(0);
   st_stack_359->SetMaximum(1.650198);
   st_stack_359->SetDirectory(0);
   st_stack_359->SetStats(0);

   Int_t ci;      // for color index setting
   TColor *color; // for color definition with alpha
   ci = TColor::GetColor("#000099");
   st_stack_359->SetLineColor(ci);
   st_stack_359->GetXaxis()->SetTitle("c-jet p_{T} (w/ JEC) [GeV]");
   st_stack_359->GetXaxis()->SetRange(1,150);
   st_stack_359->GetXaxis()->SetLabelFont(42);
   st_stack_359->GetXaxis()->SetLabelSize(0.035);
   st_stack_359->GetXaxis()->SetTitleSize(0.035);
   st_stack_359->GetXaxis()->SetTitleFont(42);
   st_stack_359->GetYaxis()->SetTitle("Event/2.0 GeV");
   st_stack_359->GetYaxis()->SetLabelFont(42);
   st_stack_359->GetYaxis()->SetLabelSize(0.035);
   st_stack_359->GetYaxis()->SetTitleSize(0.037);
   st_stack_359->GetYaxis()->SetTitleOffset(0);
   st_stack_359->GetYaxis()->SetTitleFont(42);
   st_stack_359->GetZaxis()->SetLabelFont(42);
   st_stack_359->GetZaxis()->SetLabelSize(0.035);
   st_stack_359->GetZaxis()->SetTitleSize(0.035);
   st_stack_359->GetZaxis()->SetTitleFont(42);
   st->SetHistogram(st_stack_359);
