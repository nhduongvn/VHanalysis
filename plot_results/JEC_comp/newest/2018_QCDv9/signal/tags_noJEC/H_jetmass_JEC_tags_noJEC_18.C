void H_jetmass_JEC_tags_noJEC_18()
{
//=========Macro generated from canvas: H_jetmass_JEC_tags_noJEC_18/H_jetmass_JEC_tags_noJEC_18
//=========  (Thu Mar 30 10:44:19 2023) by ROOT version 6.14/09
   TCanvas *H_jetmass_JEC_tags_noJEC_18 = new TCanvas("H_jetmass_JEC_tags_noJEC_18", "H_jetmass_JEC_tags_noJEC_18",0,0,600,600);
   H_jetmass_JEC_tags_noJEC_18->SetHighLightColor(2);
   H_jetmass_JEC_tags_noJEC_18->Range(-65.50587,-1.567653,351.4899,11.49612);
   H_jetmass_JEC_tags_noJEC_18->SetFillColor(0);
   H_jetmass_JEC_tags_noJEC_18->SetFillStyle(4000);
   H_jetmass_JEC_tags_noJEC_18->SetBorderMode(0);
   H_jetmass_JEC_tags_noJEC_18->SetBorderSize(2);
   H_jetmass_JEC_tags_noJEC_18->SetLeftMargin(0.15709);
   H_jetmass_JEC_tags_noJEC_18->SetRightMargin(0.1234783);
   H_jetmass_JEC_tags_noJEC_18->SetBottomMargin(0.12);
   H_jetmass_JEC_tags_noJEC_18->SetFrameFillStyle(1000);
   H_jetmass_JEC_tags_noJEC_18->SetFrameBorderMode(0);
   H_jetmass_JEC_tags_noJEC_18->SetFrameFillStyle(1000);
   H_jetmass_JEC_tags_noJEC_18->SetFrameBorderMode(0);
   ...
   st_stack_271->SetMaximum(10.18975);
   ...
   VbbHcc_tags_noJEC_H_jetmass_JEC_stack_1->SetBinContent(2,5.797021);
   VbbHcc_tags_noJEC_H_jetmass_JEC_stack_1->SetBinContent(3,2.155679);
   VbbHcc_tags_noJEC_H_jetmass_JEC_stack_1->SetBinContent(151,0.001576883);
   VbbHcc_tags_noJEC_H_jetmass_JEC_stack_1->SetBinError(2,0.1398271);
   VbbHcc_tags_noJEC_H_jetmass_JEC_stack_1->SetBinError(3,0.07766383);
   VbbHcc_tags_noJEC_H_jetmass_JEC_stack_1->SetBinError(151,0.001576883);
   VbbHcc_tags_noJEC_H_jetmass_JEC_stack_1->SetEntries(3172);
   ...
   VbbHcc_tags_noJEC_H_jetmass_JEC_stack_2->SetBinContent(2,2.257731);
   VbbHcc_tags_noJEC_H_jetmass_JEC_stack_2->SetBinContent(3,1.184723);
   VbbHcc_tags_noJEC_H_jetmass_JEC_stack_2->SetBinError(2,0.02939088);
   VbbHcc_tags_noJEC_H_jetmass_JEC_stack_2->SetBinError(3,0.02180238);
   VbbHcc_tags_noJEC_H_jetmass_JEC_stack_2->SetEntries(10130);
...
tex->SetNDC();
   ...
   tex->SetLineWidth(2);
   tex->Draw();
   H_jetmass_JEC_tags_noJEC_18->Modified();
   H_jetmass_JEC_tags_noJEC_18->cd();
   H_jetmass_JEC_tags_noJEC_18->SetSelected(H_jetmass_JEC_tags_noJEC_18);
}
