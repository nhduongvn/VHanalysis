void H_jetpt_JEC_tags_noJEC_18()
{
//=========Macro generated from canvas: H_jetpt_JEC_tags_noJEC_18/H_jetpt_JEC_tags_noJEC_18
//=========  (Thu Mar 30 10:44:18 2023) by ROOT version 6.14/09
   TCanvas *H_jetpt_JEC_tags_noJEC_18 = new TCanvas("H_jetpt_JEC_tags_noJEC_18", "H_jetpt_JEC_tags_noJEC_18",0,0,600,600);
   H_jetpt_JEC_tags_noJEC_18->SetHighLightColor(2);
   H_jetpt_JEC_tags_noJEC_18->Range(-65.50587,-0.9462304,351.4899,6.939023);
   H_jetpt_JEC_tags_noJEC_18->SetFillColor(0);
   H_jetpt_JEC_tags_noJEC_18->SetFillStyle(4000);
   H_jetpt_JEC_tags_noJEC_18->SetBorderMode(0);
   H_jetpt_JEC_tags_noJEC_18->SetBorderSize(2);
   H_jetpt_JEC_tags_noJEC_18->SetLeftMargin(0.15709);
   H_jetpt_JEC_tags_noJEC_18->SetRightMargin(0.1234783);
   H_jetpt_JEC_tags_noJEC_18->SetBottomMargin(0.12);
   H_jetpt_JEC_tags_noJEC_18->SetFrameFillStyle(1000);
   H_jetpt_JEC_tags_noJEC_18->SetFrameBorderMode(0);
   H_jetpt_JEC_tags_noJEC_18->SetFrameFillStyle(1000);
   H_jetpt_JEC_tags_noJEC_18->SetFrameBorderMode(0);
   ...
   st_stack_263->SetMaximum(6.150497);
   ...
   VbbHcc_tags_noJEC_H_jetpt_JEC_stack_1->SetBinContent(0,3.872592);
   VbbHcc_tags_noJEC_H_jetpt_JEC_stack_1->SetBinContent(1,0.01985387);
   VbbHcc_tags_noJEC_H_jetpt_JEC_stack_1->SetBinContent(2,3.430331);
   VbbHcc_tags_noJEC_H_jetpt_JEC_stack_1->SetBinContent(3,0.6315009);
   VbbHcc_tags_noJEC_H_jetpt_JEC_stack_1->SetBinError(0,0.1080107);
   VbbHcc_tags_noJEC_H_jetpt_JEC_stack_1->SetBinError(1,0.007152531);
   VbbHcc_tags_noJEC_H_jetpt_JEC_stack_1->SetBinError(2,0.1099362);
   VbbHcc_tags_noJEC_H_jetpt_JEC_stack_1->SetBinError(3,0.04221761);
   VbbHcc_tags_noJEC_H_jetpt_JEC_stack_1->SetEntries(3172);
   ...
   VbbHcc_tags_noJEC_H_jetpt_JEC_stack_2->SetBinContent(0,1.692873);
   VbbHcc_tags_noJEC_H_jetpt_JEC_stack_2->SetBinContent(1,0.007756853);
   VbbHcc_tags_noJEC_H_jetpt_JEC_stack_2->SetBinContent(2,1.431491);
   VbbHcc_tags_noJEC_H_jetpt_JEC_stack_2->SetBinContent(3,0.3103337);
   VbbHcc_tags_noJEC_H_jetpt_JEC_stack_2->SetBinError(0,0.02615511);
   VbbHcc_tags_noJEC_H_jetpt_JEC_stack_2->SetBinError(1,0.001660555);
   VbbHcc_tags_noJEC_H_jetpt_JEC_stack_2->SetBinError(2,0.02317715);
   VbbHcc_tags_noJEC_H_jetpt_JEC_stack_2->SetBinError(3,0.01073033);
   VbbHcc_tags_noJEC_H_jetpt_JEC_stack_2->SetEntries(10130);
...
tex->SetNDC();
   ...
   tex->SetLineWidth(2);
   tex->Draw();
   H_jetpt_JEC_tags_noJEC_18->Modified();
   H_jetpt_JEC_tags_noJEC_18->cd();
   H_jetpt_JEC_tags_noJEC_18->SetSelected(H_jetpt_JEC_tags_noJEC_18);
}
