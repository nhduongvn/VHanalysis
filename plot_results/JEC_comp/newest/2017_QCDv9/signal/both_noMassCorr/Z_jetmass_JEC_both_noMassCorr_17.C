void Z_jetmass_JEC_both_noMassCorr_17()
{
//=========Macro generated from canvas: Z_jetmass_JEC_both_noMassCorr_17/Z_jetmass_JEC_both_noMassCorr_17
//=========  (Thu Mar 30 10:44:50 2023) by ROOT version 6.14/09
   TCanvas *Z_jetmass_JEC_both_noMassCorr_17 = new TCanvas("Z_jetmass_JEC_both_noMassCorr_17", "Z_jetmass_JEC_both_noMassCorr_17",0,0,600,600);
   Z_jetmass_JEC_both_noMassCorr_17->SetHighLightColor(2);
   Z_jetmass_JEC_both_noMassCorr_17->Range(-65.50587,-1.18814,351.4899,8.71303);
   Z_jetmass_JEC_both_noMassCorr_17->SetFillColor(0);
   Z_jetmass_JEC_both_noMassCorr_17->SetFillStyle(4000);
   Z_jetmass_JEC_both_noMassCorr_17->SetBorderMode(0);
   Z_jetmass_JEC_both_noMassCorr_17->SetBorderSize(2);
   Z_jetmass_JEC_both_noMassCorr_17->SetLeftMargin(0.15709);
   Z_jetmass_JEC_both_noMassCorr_17->SetRightMargin(0.1234783);
   Z_jetmass_JEC_both_noMassCorr_17->SetBottomMargin(0.12);
   Z_jetmass_JEC_both_noMassCorr_17->SetFrameFillStyle(1000);
   Z_jetmass_JEC_both_noMassCorr_17->SetFrameBorderMode(0);
   Z_jetmass_JEC_both_noMassCorr_17->SetFrameFillStyle(1000);
   Z_jetmass_JEC_both_noMassCorr_17->SetFrameBorderMode(0);
   ...
   TH1F *st_stack_766 = new TH1F("st_stack_766","",150,0,300);
   st_stack_766->SetMinimum(0);
   st_stack_766->SetMaximum(7.722913);
   st_stack_766->SetDirectory(0);
   st_stack_766->SetStats(0);

   Int_t ci;      // for color index setting
   TColor *color; // for color definition with alpha
   ci = TColor::GetColor("#000099");
   st_stack_766->SetLineColor(ci);
   st_stack_766->GetXaxis()->SetTitle("b-jet mass (w/ JEC) [GeV]");
   st_stack_766->GetXaxis()->SetRange(1,150);
   st_stack_766->GetXaxis()->SetLabelFont(42);
   st_stack_766->GetXaxis()->SetLabelSize(0.035);
   st_stack_766->GetXaxis()->SetTitleSize(0.035);
   st_stack_766->GetXaxis()->SetTitleFont(42);
   st_stack_766->GetYaxis()->SetTitle("Event/2.0 GeV");
   st_stack_766->GetYaxis()->SetLabelFont(42);
   st_stack_766->GetYaxis()->SetLabelSize(0.035);
   st_stack_766->GetYaxis()->SetTitleSize(0.037);
   st_stack_766->GetYaxis()->SetTitleOffset(0);
   st_stack_766->GetYaxis()->SetTitleFont(42);
   st_stack_766->GetZaxis()->SetLabelFont(42);
   st_stack_766->GetZaxis()->SetLabelSize(0.035);
   st_stack_766->GetZaxis()->SetTitleSize(0.035);
   st_stack_766->GetZaxis()->SetTitleFont(42);
   st->SetHistogram(st_stack_766);
   
   
   TH1D *VbbHcc_both_noMassCorr_Z_jetmass_JEC_stack_1 = new TH1D("VbbHcc_both_noMassCorr_Z_jetmass_JEC_stack_1","",150,0,300);
   VbbHcc_both_noMassCorr_Z_jetmass_JEC_stack_1->SetBinContent(2,4.385427);
   VbbHcc_both_noMassCorr_Z_jetmass_JEC_stack_1->SetBinContent(3,1.730643);
   VbbHcc_both_noMassCorr_Z_jetmass_JEC_stack_1->SetBinError(2,0.09141184);
   VbbHcc_both_noMassCorr_Z_jetmass_JEC_stack_1->SetBinError(3,0.05666745);
   VbbHcc_both_noMassCorr_Z_jetmass_JEC_stack_1->SetEntries(3542);
   ...
   VbbHcc_both_noMassCorr_Z_jetmass_JEC_stack_2->SetBinContent(2,1.719352);
   VbbHcc_both_noMassCorr_Z_jetmass_JEC_stack_2->SetBinContent(3,0.8802571);
   VbbHcc_both_noMassCorr_Z_jetmass_JEC_stack_2->SetBinError(2,0.02035872);
   VbbHcc_both_noMassCorr_Z_jetmass_JEC_stack_2->SetBinError(3,0.01454299);
   VbbHcc_both_noMassCorr_Z_jetmass_JEC_stack_2->SetEntries(11286);
...
tex->SetNDC();
   ...
   tex->SetLineWidth(2);
   tex->Draw();
   Z_jetmass_JEC_both_noMassCorr_17->Modified();
   Z_jetmass_JEC_both_noMassCorr_17->cd();
   Z_jetmass_JEC_both_noMassCorr_17->SetSelected(Z_jetmass_JEC_both_noMassCorr_17);
}
