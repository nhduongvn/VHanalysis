void H_jetmass_JEC_algo_noJEC_17()
{
//=========Macro generated from canvas: H_jetmass_JEC_algo_noJEC_17/H_jetmass_JEC_algo_noJEC_17
//=========  (Thu Mar 30 10:44:37 2023) by ROOT version 6.14/09
   TCanvas *H_jetmass_JEC_algo_noJEC_17 = new TCanvas("H_jetmass_JEC_algo_noJEC_17", "H_jetmass_JEC_algo_noJEC_17",0,0,600,600);
   H_jetmass_JEC_algo_noJEC_17->SetHighLightColor(2);
   H_jetmass_JEC_algo_noJEC_17->Range(-65.50587,-0.2892358,351.4899,2.121063);
   H_jetmass_JEC_algo_noJEC_17->SetFillColor(0);
   H_jetmass_JEC_algo_noJEC_17->SetFillStyle(4000);
   H_jetmass_JEC_algo_noJEC_17->SetBorderMode(0);
   H_jetmass_JEC_algo_noJEC_17->SetBorderSize(2);
   H_jetmass_JEC_algo_noJEC_17->SetLeftMargin(0.15709);
   H_jetmass_JEC_algo_noJEC_17->SetRightMargin(0.1234783);
   H_jetmass_JEC_algo_noJEC_17->SetBottomMargin(0.12);
   H_jetmass_JEC_algo_noJEC_17->SetFrameFillStyle(1000);
   H_jetmass_JEC_algo_noJEC_17->SetFrameBorderMode(0);
   H_jetmass_JEC_algo_noJEC_17->SetFrameFillStyle(1000);
   H_jetmass_JEC_algo_noJEC_17->SetFrameBorderMode(0);
   ...
   TH1F *st_stack_558 = new TH1F("st_stack_558","",150,0,300);
   st_stack_558->SetMinimum(0);
   st_stack_558->SetMaximum(1.880033);
   st_stack_558->SetDirectory(0);
   st_stack_558->SetStats(0);

   Int_t ci;      // for color index setting
   TColor *color; // for color definition with alpha
   ci = TColor::GetColor("#000099");
   st_stack_558->SetLineColor(ci);
   st_stack_558->GetXaxis()->SetTitle("c-jet mass (w/ JEC) [GeV]");
   st_stack_558->GetXaxis()->SetRange(1,150);
   st_stack_558->GetXaxis()->SetLabelFont(42);
   st_stack_558->GetXaxis()->SetLabelSize(0.035);
   st_stack_558->GetXaxis()->SetTitleSize(0.035);
   st_stack_558->GetXaxis()->SetTitleFont(42);
   st_stack_558->GetYaxis()->SetTitle("Event/2.0 GeV");
   st_stack_558->GetYaxis()->SetLabelFont(42);
   st_stack_558->GetYaxis()->SetLabelSize(0.035);
   st_stack_558->GetYaxis()->SetTitleSize(0.037);
   st_stack_558->GetYaxis()->SetTitleOffset(0);
   st_stack_558->GetYaxis()->SetTitleFont(42);
   st_stack_558->GetZaxis()->SetLabelFont(42);
   st_stack_558->GetZaxis()->SetLabelSize(0.035);
   st_stack_558->GetZaxis()->SetTitleSize(0.035);
   st_stack_558->GetZaxis()->SetTitleFont(42);
   st->SetHistogram(st_stack_558);
   
   
   TH1D *VbbHcc_algo_noJEC_H_jetmass_JEC_stack_1 = new TH1D("VbbHcc_algo_noJEC_H_jetmass_JEC_stack_1","",150,0,300);
   VbbHcc_algo_noJEC_H_jetmass_JEC_stack_1->SetBinContent(2,1.119876);
   VbbHcc_algo_noJEC_H_jetmass_JEC_stack_1->SetBinContent(3,0.4249394);
   VbbHcc_algo_noJEC_H_jetmass_JEC_stack_1->SetBinError(2,0.04624645);
   VbbHcc_algo_noJEC_H_jetmass_JEC_stack_1->SetBinError(3,0.02845611);
   VbbHcc_algo_noJEC_H_jetmass_JEC_stack_1->SetEntries(919);
   ...
   VbbHcc_algo_noJEC_H_jetmass_JEC_stack_2->SetBinContent(2,0.3662455);
   VbbHcc_algo_noJEC_H_jetmass_JEC_stack_2->SetBinContent(3,0.1911838);
   VbbHcc_algo_noJEC_H_jetmass_JEC_stack_2->SetBinError(2,0.009394608);
   VbbHcc_algo_noJEC_H_jetmass_JEC_stack_2->SetBinError(3,0.006802002);
   VbbHcc_algo_noJEC_H_jetmass_JEC_stack_2->SetEntries(2405);
...
tex->SetNDC();
   ...
   tex->SetLineWidth(2);
   tex->Draw();
   H_jetmass_JEC_algo_noJEC_17->Modified();
   H_jetmass_JEC_algo_noJEC_17->cd();
   H_jetmass_JEC_algo_noJEC_17->SetSelected(H_jetmass_JEC_algo_noJEC_17);
}
