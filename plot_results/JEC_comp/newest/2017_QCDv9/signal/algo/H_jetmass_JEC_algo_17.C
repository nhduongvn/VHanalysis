...
//=========  (Thu Mar 30 10:44:26 2023) by ROOT version 6.14/09
   ...
   H_jetmass_JEC_algo_17->Range(-65.50587,-0.2892358,351.4899,2.121063);
   ...
   TH1F *st_stack_366 = new TH1F("st_stack_366","",150,0,300);
   st_stack_366->SetMinimum(0);
   st_stack_366->SetMaximum(1.880033);
   st_stack_366->SetDirectory(0);
   st_stack_366->SetStats(0);

   Int_t ci;      // for color index setting
   TColor *color; // for color definition with alpha
   ci = TColor::GetColor("#000099");
   st_stack_366->SetLineColor(ci);
   st_stack_366->GetXaxis()->SetTitle("c-jet mass (w/ JEC) [GeV]");
   st_stack_366->GetXaxis()->SetRange(1,150);
   st_stack_366->GetXaxis()->SetLabelFont(42);
   st_stack_366->GetXaxis()->SetLabelSize(0.035);
   st_stack_366->GetXaxis()->SetTitleSize(0.035);
   st_stack_366->GetXaxis()->SetTitleFont(42);
   st_stack_366->GetYaxis()->SetTitle("Event/2.0 GeV");
   st_stack_366->GetYaxis()->SetLabelFont(42);
   st_stack_366->GetYaxis()->SetLabelSize(0.035);
   st_stack_366->GetYaxis()->SetTitleSize(0.037);
   st_stack_366->GetYaxis()->SetTitleOffset(0);
   st_stack_366->GetYaxis()->SetTitleFont(42);
   st_stack_366->GetZaxis()->SetLabelFont(42);
   st_stack_366->GetZaxis()->SetLabelSize(0.035);
   st_stack_366->GetZaxis()->SetTitleSize(0.035);
   st_stack_366->GetZaxis()->SetTitleFont(42);
   st->SetHistogram(st_stack_366);
