...
//=========  (Thu Mar 30 10:44:24 2023) by ROOT version 6.14/09
   ...
   H_dR_Bj0_algo_17->Range(-1.310117,-0.1340148,7.029799,0.9827754);
   ...
   TH1F *st_stack_330 = new TH1F("st_stack_330","",30,0,6);
   st_stack_330->SetMinimum(0);
   st_stack_330->SetMaximum(0.8710964);
   ...
   st_stack_330->GetXaxis()->SetTitle("#DeltaR(H,j_{1})");
   st_stack_330->GetXaxis()->SetRange(1,30);
   ...
   st_stack_330->GetYaxis()->SetTitle("Event/0.2");
   st_stack_330->GetYaxis()->SetLabelFont(42);
   st_stack_330->GetYaxis()->SetLabelSize(0.035);
   st_stack_330->GetYaxis()->SetTitleSize(0.037);
   st_stack_330->GetYaxis()->SetTitleOffset(0);
