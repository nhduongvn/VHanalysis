...
//=========  (Thu Mar 30 10:44:26 2023) by ROOT version 6.14/09
   ...
   H_jetpt_JEC_algo_17->Range(-65.50587,-0.1765801,351.4899,1.294921);
   ...
   TH1F *st_stack_358 = new TH1F("st_stack_358","",150,0,300);
   st_stack_358->SetMinimum(0);
   st_stack_358->SetMaximum(1.147771);
   st_stack_358->SetDirectory(0);
   st_stack_358->SetStats(0);

   Int_t ci;      // for color index setting
   TColor *color; // for color definition with alpha
   ci = TColor::GetColor("#000099");
   st_stack_358->SetLineColor(ci);
   st_stack_358->GetXaxis()->SetTitle("c-jet p_{T} (w/ JEC) [GeV]");
   st_stack_358->GetXaxis()->SetRange(1,150);
   st_stack_358->GetXaxis()->SetLabelFont(42);
   st_stack_358->GetXaxis()->SetLabelSize(0.035);
   st_stack_358->GetXaxis()->SetTitleSize(0.035);
   st_stack_358->GetXaxis()->SetTitleFont(42);
   st_stack_358->GetYaxis()->SetTitle("Event/2.0 GeV");
   st_stack_358->GetYaxis()->SetLabelFont(42);
   st_stack_358->GetYaxis()->SetLabelSize(0.035);
   st_stack_358->GetYaxis()->SetTitleSize(0.037);
   st_stack_358->GetYaxis()->SetTitleOffset(0);
   st_stack_358->GetYaxis()->SetTitleFont(42);
   st_stack_358->GetZaxis()->SetLabelFont(42);
   st_stack_358->GetZaxis()->SetLabelSize(0.035);
   st_stack_358->GetZaxis()->SetTitleSize(0.035);
   st_stack_358->GetZaxis()->SetTitleFont(42);
   st->SetHistogram(st_stack_358);
