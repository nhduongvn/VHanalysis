...
//=========  (Thu Mar 30 10:44:23 2023) by ROOT version 6.14/09
   ...
   H_dR_algo_17->Range(-1.353788,-0.06590672,7.264125,0.4833159);
   ...
   st_stack_310->SetMaximum(0.4283937);
   ...
   st_stack_310->GetXaxis()->SetTitle("#DeltaR(c,c)");
   st_stack_310->GetXaxis()->SetRange(1,31);
   ...
   st_stack_310->GetYaxis()->SetTitle("Event/0.2");
