...
//=========  (Thu Mar 30 10:44:24 2023) by ROOT version 6.14/09
   ...
   H_dR_Bj1_algo_17->Range(-1.310117,-0.08452643,7.029799,0.6198605);
   ...
   TH1F *st_stack_334 = new TH1F("st_stack_334","",30,0,6);
   st_stack_334->SetMinimum(0);
   st_stack_334->SetMaximum(0.5494218);
   ...
   st_stack_334->GetXaxis()->SetTitle("#DeltaR(H,j_{2})");
   ...
   st_stack_334->GetYaxis()->SetTitle("Event/0.2");
   st_stack_334->GetYaxis()->SetLabelFont(42);
   st_stack_334->GetYaxis()->SetLabelSize(0.035);
   st_stack_334->GetYaxis()->SetTitleSize(0.037);
   st_stack_334->GetYaxis()->SetTitleOffset(0);
