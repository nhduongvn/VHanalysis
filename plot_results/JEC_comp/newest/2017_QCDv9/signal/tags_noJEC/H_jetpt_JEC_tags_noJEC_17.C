void H_jetpt_JEC_tags_noJEC_17()
{
//=========Macro generated from canvas: H_jetpt_JEC_tags_noJEC_17/H_jetpt_JEC_tags_noJEC_17
//=========  (Thu Mar 30 10:44:18 2023) by ROOT version 6.14/09
   TCanvas *H_jetpt_JEC_tags_noJEC_17 = new TCanvas("H_jetpt_JEC_tags_noJEC_17", "H_jetpt_JEC_tags_noJEC_17",0,0,600,600);
   H_jetpt_JEC_tags_noJEC_17->SetHighLightColor(2);
   H_jetpt_JEC_tags_noJEC_17->Range(-65.50587,-0.6927188,351.4899,5.079938);
   H_jetpt_JEC_tags_noJEC_17->SetFillColor(0);
   H_jetpt_JEC_tags_noJEC_17->SetFillStyle(4000);
   H_jetpt_JEC_tags_noJEC_17->SetBorderMode(0);
   H_jetpt_JEC_tags_noJEC_17->SetBorderSize(2);
   H_jetpt_JEC_tags_noJEC_17->SetLeftMargin(0.15709);
   H_jetpt_JEC_tags_noJEC_17->SetRightMargin(0.1234783);
   H_jetpt_JEC_tags_noJEC_17->SetBottomMargin(0.12);
   H_jetpt_JEC_tags_noJEC_17->SetFrameFillStyle(1000);
   H_jetpt_JEC_tags_noJEC_17->SetFrameBorderMode(0);
   H_jetpt_JEC_tags_noJEC_17->SetFrameFillStyle(1000);
   H_jetpt_JEC_tags_noJEC_17->SetFrameBorderMode(0);
   ...
   st_stack_262->SetMaximum(4.502672);
   ...
   VbbHcc_tags_noJEC_H_jetpt_JEC_stack_1->SetBinContent(0,2.947272);
   VbbHcc_tags_noJEC_H_jetpt_JEC_stack_1->SetBinContent(1,0.02157855);
   VbbHcc_tags_noJEC_H_jetpt_JEC_stack_1->SetBinContent(2,2.514246);
   VbbHcc_tags_noJEC_H_jetpt_JEC_stack_1->SetBinContent(3,0.5187881);
   VbbHcc_tags_noJEC_H_jetpt_JEC_stack_1->SetBinError(0,0.0748081);
   VbbHcc_tags_noJEC_H_jetpt_JEC_stack_1->SetBinError(1,0.006305843);
   VbbHcc_tags_noJEC_H_jetpt_JEC_stack_1->SetBinError(2,0.0689723);
   VbbHcc_tags_noJEC_H_jetpt_JEC_stack_1->SetBinError(3,0.03102927);
   VbbHcc_tags_noJEC_H_jetpt_JEC_stack_1->SetEntries(3477);
   ...
   VbbHcc_tags_noJEC_H_jetpt_JEC_stack_2->SetBinContent(0,1.27038);
   VbbHcc_tags_noJEC_H_jetpt_JEC_stack_2->SetBinContent(1,0.006167587);
   VbbHcc_tags_noJEC_H_jetpt_JEC_stack_2->SetBinContent(2,1.045009);
   VbbHcc_tags_noJEC_H_jetpt_JEC_stack_2->SetBinContent(3,0.2132785);
   VbbHcc_tags_noJEC_H_jetpt_JEC_stack_2->SetBinError(0,0.0174915);
   VbbHcc_tags_noJEC_H_jetpt_JEC_stack_2->SetBinError(1,0.001204978);
   VbbHcc_tags_noJEC_H_jetpt_JEC_stack_2->SetBinError(2,0.01585403);
   VbbHcc_tags_noJEC_H_jetpt_JEC_stack_2->SetBinError(3,0.007183422);
   VbbHcc_tags_noJEC_H_jetpt_JEC_stack_2->SetEntries(11007);
...
tex->SetNDC();
   ...
   tex->SetLineWidth(2);
   tex->Draw();
   H_jetpt_JEC_tags_noJEC_17->Modified();
   H_jetpt_JEC_tags_noJEC_17->cd();
   H_jetpt_JEC_tags_noJEC_17->SetSelected(H_jetpt_JEC_tags_noJEC_17);
}
