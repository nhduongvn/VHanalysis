void H_jetmass_JEC_tags_noJEC_17()
{
//=========Macro generated from canvas: H_jetmass_JEC_tags_noJEC_17/H_jetmass_JEC_tags_noJEC_17
//=========  (Thu Mar 30 10:44:19 2023) by ROOT version 6.14/09
   TCanvas *H_jetmass_JEC_tags_noJEC_17 = new TCanvas("H_jetmass_JEC_tags_noJEC_17", "H_jetmass_JEC_tags_noJEC_17",0,0,600,600);
   H_jetmass_JEC_tags_noJEC_17->SetHighLightColor(2);
   H_jetmass_JEC_tags_noJEC_17->Range(-65.50587,-1.16652,351.4899,8.554478);
   H_jetmass_JEC_tags_noJEC_17->SetFillColor(0);
   H_jetmass_JEC_tags_noJEC_17->SetFillStyle(4000);
   H_jetmass_JEC_tags_noJEC_17->SetBorderMode(0);
   H_jetmass_JEC_tags_noJEC_17->SetBorderSize(2);
   H_jetmass_JEC_tags_noJEC_17->SetLeftMargin(0.15709);
   H_jetmass_JEC_tags_noJEC_17->SetRightMargin(0.1234783);
   H_jetmass_JEC_tags_noJEC_17->SetBottomMargin(0.12);
   H_jetmass_JEC_tags_noJEC_17->SetFrameFillStyle(1000);
   H_jetmass_JEC_tags_noJEC_17->SetFrameBorderMode(0);
   H_jetmass_JEC_tags_noJEC_17->SetFrameFillStyle(1000);
   H_jetmass_JEC_tags_noJEC_17->SetFrameBorderMode(0);
   ...
   st_stack_270->SetMaximum(7.582378);
   ...
   st_stack_270->GetYaxis()->SetLabelSize(0.035);
   st_stack_270->GetYaxis()->SetTitleSize(0.037);
   st_stack_270->GetYaxis()->SetTitleOffset(0);
   ...
   VbbHcc_tags_noJEC_H_jetmass_JEC_stack_1->SetBinContent(2,4.31402);
   VbbHcc_tags_noJEC_H_jetmass_JEC_stack_1->SetBinContent(3,1.687865);
   VbbHcc_tags_noJEC_H_jetmass_JEC_stack_1->SetBinError(2,0.09068578);
   VbbHcc_tags_noJEC_H_jetmass_JEC_stack_1->SetBinError(3,0.05596515);
   VbbHcc_tags_noJEC_H_jetmass_JEC_stack_1->SetEntries(3477);
   ...
   VbbHcc_tags_noJEC_H_jetmass_JEC_stack_2->SetBinContent(2,1.679669);
   VbbHcc_tags_noJEC_H_jetmass_JEC_stack_2->SetBinContent(3,0.8551652);
   VbbHcc_tags_noJEC_H_jetmass_JEC_stack_2->SetBinError(2,0.02012647);
   VbbHcc_tags_noJEC_H_jetmass_JEC_stack_2->SetBinError(3,0.01432765);
   VbbHcc_tags_noJEC_H_jetmass_JEC_stack_2->SetEntries(11007);
...
tex->SetNDC();
   ...
   tex->SetLineWidth(2);
   tex->Draw();
   H_jetmass_JEC_tags_noJEC_17->Modified();
   H_jetmass_JEC_tags_noJEC_17->cd();
   H_jetmass_JEC_tags_noJEC_17->SetSelected(H_jetmass_JEC_tags_noJEC_17);
}
