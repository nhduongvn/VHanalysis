...
//=========  (Thu Mar 30 10:44:43 2023) by ROOT version 6.14/09
   ...
   H_jetmass_JEC_both_17->Range(-65.50587,-1.18814,351.4899,8.71303);
   ...
   TH1F *st_stack_654 = new TH1F("st_stack_654","",150,0,300);
   st_stack_654->SetMinimum(0);
   st_stack_654->SetMaximum(7.722913);
   st_stack_654->SetDirectory(0);
   st_stack_654->SetStats(0);

   Int_t ci;      // for color index setting
   TColor *color; // for color definition with alpha
   ci = TColor::GetColor("#000099");
   st_stack_654->SetLineColor(ci);
   st_stack_654->GetXaxis()->SetTitle("c-jet mass (w/ JEC) [GeV]");
   st_stack_654->GetXaxis()->SetRange(1,150);
   st_stack_654->GetXaxis()->SetLabelFont(42);
   st_stack_654->GetXaxis()->SetLabelSize(0.035);
   st_stack_654->GetXaxis()->SetTitleSize(0.035);
   st_stack_654->GetXaxis()->SetTitleFont(42);
   st_stack_654->GetYaxis()->SetTitle("Event/2.0 GeV");
   st_stack_654->GetYaxis()->SetLabelFont(42);
   st_stack_654->GetYaxis()->SetLabelSize(0.035);
   st_stack_654->GetYaxis()->SetTitleSize(0.037);
   st_stack_654->GetYaxis()->SetTitleOffset(0);
   st_stack_654->GetYaxis()->SetTitleFont(42);
   st_stack_654->GetZaxis()->SetLabelFont(42);
   st_stack_654->GetZaxis()->SetLabelSize(0.035);
   st_stack_654->GetZaxis()->SetTitleSize(0.035);
   st_stack_654->GetZaxis()->SetTitleFont(42);
   st->SetHistogram(st_stack_654);
