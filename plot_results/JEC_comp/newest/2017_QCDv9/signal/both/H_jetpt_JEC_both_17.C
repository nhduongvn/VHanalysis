...
//=========  (Thu Mar 30 10:44:43 2023) by ROOT version 6.14/09
   ...
   H_jetpt_JEC_both_17->Range(-65.50587,-0.7066459,351.4899,5.18207);
   ...
   TH1F *st_stack_646 = new TH1F("st_stack_646","",150,0,300);
   st_stack_646->SetMinimum(0);
   st_stack_646->SetMaximum(4.593198);
   st_stack_646->SetDirectory(0);
   st_stack_646->SetStats(0);

   Int_t ci;      // for color index setting
   TColor *color; // for color definition with alpha
   ci = TColor::GetColor("#000099");
   st_stack_646->SetLineColor(ci);
   st_stack_646->GetXaxis()->SetTitle("c-jet p_{T} (w/ JEC) [GeV]");
   st_stack_646->GetXaxis()->SetRange(1,150);
   st_stack_646->GetXaxis()->SetLabelFont(42);
   st_stack_646->GetXaxis()->SetLabelSize(0.035);
   st_stack_646->GetXaxis()->SetTitleSize(0.035);
   st_stack_646->GetXaxis()->SetTitleFont(42);
   st_stack_646->GetYaxis()->SetTitle("Event/2.0 GeV");
   st_stack_646->GetYaxis()->SetLabelFont(42);
   st_stack_646->GetYaxis()->SetLabelSize(0.035);
   st_stack_646->GetYaxis()->SetTitleSize(0.037);
   st_stack_646->GetYaxis()->SetTitleOffset(0);
   st_stack_646->GetYaxis()->SetTitleFont(42);
   st_stack_646->GetZaxis()->SetLabelFont(42);
   st_stack_646->GetZaxis()->SetLabelSize(0.035);
   st_stack_646->GetZaxis()->SetTitleSize(0.035);
   st_stack_646->GetZaxis()->SetTitleFont(42);
   st->SetHistogram(st_stack_646);
