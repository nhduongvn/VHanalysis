...
//=========  (Thu Mar 30 10:44:41 2023) by ROOT version 6.14/09
   ...
   H_dR_Bj0_both_16->Range(-1.310117,-0.1708524,7.029799,1.252918);
   ...
   TH1F *st_stack_617 = new TH1F("st_stack_617","",30,0,6);
   st_stack_617->SetMinimum(0);
   st_stack_617->SetMaximum(1.110541);
   st_stack_617->SetDirectory(0);
   st_stack_617->SetStats(0);

   Int_t ci;      // for color index setting
   TColor *color; // for color definition with alpha
   ci = TColor::GetColor("#000099");
   st_stack_617->SetLineColor(ci);
   st_stack_617->GetXaxis()->SetTitle("#DeltaR(H,j_{1})");
   st_stack_617->GetXaxis()->SetRange(1,30);
   st_stack_617->GetXaxis()->SetLabelFont(42);
   st_stack_617->GetXaxis()->SetLabelSize(0.035);
   st_stack_617->GetXaxis()->SetTitleSize(0.035);
   st_stack_617->GetXaxis()->SetTitleFont(42);
   st_stack_617->GetYaxis()->SetTitle("Event/0.2");
   st_stack_617->GetYaxis()->SetLabelFont(42);
   st_stack_617->GetYaxis()->SetLabelSize(0.035);
   st_stack_617->GetYaxis()->SetTitleSize(0.037);
   st_stack_617->GetYaxis()->SetTitleOffset(0);
   st_stack_617->GetYaxis()->SetTitleFont(42);
   st_stack_617->GetZaxis()->SetLabelFont(42);
   st_stack_617->GetZaxis()->SetLabelSize(0.035);
   st_stack_617->GetZaxis()->SetTitleSize(0.035);
   st_stack_617->GetZaxis()->SetTitleFont(42);
   st->SetHistogram(st_stack_617);
