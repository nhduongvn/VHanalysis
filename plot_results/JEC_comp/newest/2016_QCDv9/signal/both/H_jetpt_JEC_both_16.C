...
//=========  (Thu Mar 30 10:44:43 2023) by ROOT version 6.14/09
   ...
   H_jetpt_JEC_both_16->Range(-65.50587,-0.439321,351.4899,3.221687);
   ...
   TH1F *st_stack_645 = new TH1F("st_stack_645","",150,0,300);
   st_stack_645->SetMinimum(0);
   st_stack_645->SetMaximum(2.855586);
   st_stack_645->SetDirectory(0);
   st_stack_645->SetStats(0);

   Int_t ci;      // for color index setting
   TColor *color; // for color definition with alpha
   ci = TColor::GetColor("#000099");
   st_stack_645->SetLineColor(ci);
   st_stack_645->GetXaxis()->SetTitle("c-jet p_{T} (w/ JEC) [GeV]");
   st_stack_645->GetXaxis()->SetRange(1,150);
   st_stack_645->GetXaxis()->SetLabelFont(42);
   st_stack_645->GetXaxis()->SetLabelSize(0.035);
   st_stack_645->GetXaxis()->SetTitleSize(0.035);
   st_stack_645->GetXaxis()->SetTitleFont(42);
   st_stack_645->GetYaxis()->SetTitle("Event/2.0 GeV");
   st_stack_645->GetYaxis()->SetLabelFont(42);
   st_stack_645->GetYaxis()->SetLabelSize(0.035);
   st_stack_645->GetYaxis()->SetTitleSize(0.037);
   st_stack_645->GetYaxis()->SetTitleOffset(0);
   st_stack_645->GetYaxis()->SetTitleFont(42);
   st_stack_645->GetZaxis()->SetLabelFont(42);
   st_stack_645->GetZaxis()->SetLabelSize(0.035);
   st_stack_645->GetZaxis()->SetTitleSize(0.035);
   st_stack_645->GetZaxis()->SetTitleFont(42);
   st->SetHistogram(st_stack_645);
