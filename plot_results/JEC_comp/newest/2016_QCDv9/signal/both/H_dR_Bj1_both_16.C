...
//=========  (Thu Mar 30 10:44:41 2023) by ROOT version 6.14/09
   ...
   H_dR_Bj1_both_16->Range(-1.310117,-0.1705527,7.029799,1.25072);
   ...
   TH1F *st_stack_621 = new TH1F("st_stack_621","",30,0,6);
   st_stack_621->SetMinimum(0);
   st_stack_621->SetMaximum(1.108592);
   st_stack_621->SetDirectory(0);
   st_stack_621->SetStats(0);

   Int_t ci;      // for color index setting
   TColor *color; // for color definition with alpha
   ci = TColor::GetColor("#000099");
   st_stack_621->SetLineColor(ci);
   st_stack_621->GetXaxis()->SetTitle("#DeltaR(H,j_{2})");
   st_stack_621->GetXaxis()->SetRange(1,30);
   st_stack_621->GetXaxis()->SetLabelFont(42);
   st_stack_621->GetXaxis()->SetLabelSize(0.035);
   st_stack_621->GetXaxis()->SetTitleSize(0.035);
   st_stack_621->GetXaxis()->SetTitleFont(42);
   st_stack_621->GetYaxis()->SetTitle("Event/0.2");
   st_stack_621->GetYaxis()->SetLabelFont(42);
   st_stack_621->GetYaxis()->SetLabelSize(0.035);
   st_stack_621->GetYaxis()->SetTitleSize(0.037);
   st_stack_621->GetYaxis()->SetTitleOffset(0);
   st_stack_621->GetYaxis()->SetTitleFont(42);
   st_stack_621->GetZaxis()->SetLabelFont(42);
   st_stack_621->GetZaxis()->SetLabelSize(0.035);
   st_stack_621->GetZaxis()->SetTitleSize(0.035);
   st_stack_621->GetZaxis()->SetTitleFont(42);
   st->SetHistogram(st_stack_621);
