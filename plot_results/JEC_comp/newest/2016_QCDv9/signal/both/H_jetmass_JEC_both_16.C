...
//=========  (Thu Mar 30 10:44:43 2023) by ROOT version 6.14/09
   ...
   H_jetmass_JEC_both_16->Range(-65.50587,-0.7458697,351.4899,5.469711);
   ...
   TH1F *st_stack_653 = new TH1F("st_stack_653","",150,0,300);
   st_stack_653->SetMinimum(0);
   st_stack_653->SetMaximum(4.848153);
   st_stack_653->SetDirectory(0);
   st_stack_653->SetStats(0);

   Int_t ci;      // for color index setting
   TColor *color; // for color definition with alpha
   ci = TColor::GetColor("#000099");
   st_stack_653->SetLineColor(ci);
   st_stack_653->GetXaxis()->SetTitle("c-jet mass (w/ JEC) [GeV]");
   st_stack_653->GetXaxis()->SetRange(1,150);
   st_stack_653->GetXaxis()->SetLabelFont(42);
   st_stack_653->GetXaxis()->SetLabelSize(0.035);
   st_stack_653->GetXaxis()->SetTitleSize(0.035);
   st_stack_653->GetXaxis()->SetTitleFont(42);
   st_stack_653->GetYaxis()->SetTitle("Event/2.0 GeV");
   st_stack_653->GetYaxis()->SetLabelFont(42);
   st_stack_653->GetYaxis()->SetLabelSize(0.035);
   st_stack_653->GetYaxis()->SetTitleSize(0.037);
   st_stack_653->GetYaxis()->SetTitleOffset(0);
   st_stack_653->GetYaxis()->SetTitleFont(42);
   st_stack_653->GetZaxis()->SetLabelFont(42);
   st_stack_653->GetZaxis()->SetLabelSize(0.035);
   st_stack_653->GetZaxis()->SetTitleSize(0.035);
   st_stack_653->GetZaxis()->SetTitleFont(42);
   st->SetHistogram(st_stack_653);
