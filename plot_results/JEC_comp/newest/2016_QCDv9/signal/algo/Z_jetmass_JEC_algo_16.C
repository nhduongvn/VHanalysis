...
//=========  (Thu Mar 30 10:44:27 2023) by ROOT version 6.14/09
   ...
   Z_jetmass_JEC_algo_16->Range(-65.50587,-0.04868833,351.4899,0.3429748);
   ...
   TH1F *st_stack_381 = new TH1F("st_stack_381","",150,0,300);
   st_stack_381->SetMinimum(-0.001688756);
   st_stack_381->SetMaximum(0.3038085);
   st_stack_381->SetDirectory(0);
   st_stack_381->SetStats(0);

   Int_t ci;      // for color index setting
   TColor *color; // for color definition with alpha
   ci = TColor::GetColor("#000099");
   st_stack_381->SetLineColor(ci);
   st_stack_381->GetXaxis()->SetTitle("b-jet mass (w/ JEC) [GeV]");
   st_stack_381->GetXaxis()->SetRange(1,150);
   st_stack_381->GetXaxis()->SetLabelFont(42);
   st_stack_381->GetXaxis()->SetLabelSize(0.035);
   st_stack_381->GetXaxis()->SetTitleSize(0.035);
   st_stack_381->GetXaxis()->SetTitleFont(42);
   st_stack_381->GetYaxis()->SetTitle("Event/2.0 GeV");
   st_stack_381->GetYaxis()->SetLabelFont(42);
   st_stack_381->GetYaxis()->SetLabelSize(0.035);
   st_stack_381->GetYaxis()->SetTitleSize(0.037);
   st_stack_381->GetYaxis()->SetTitleOffset(0);
   st_stack_381->GetYaxis()->SetTitleFont(42);
   st_stack_381->GetZaxis()->SetLabelFont(42);
   st_stack_381->GetZaxis()->SetLabelSize(0.035);
   st_stack_381->GetZaxis()->SetTitleSize(0.035);
   st_stack_381->GetZaxis()->SetTitleFont(42);
   st->SetHistogram(st_stack_381);
