...
//=========  (Thu Mar 30 10:44:24 2023) by ROOT version 6.14/09
   ...
   H_dR_Bj1_algo_16->Range(-1.310117,-0.05760071,7.029799,0.4224052);
   ...
   TH1F *st_stack_333 = new TH1F("st_stack_333","",30,0,6);
   st_stack_333->SetMinimum(0);
   st_stack_333->SetMaximum(0.3744046);
   ...
   st_stack_333->GetXaxis()->SetTitle("#DeltaR(H,j_{2})");
   ...
   st_stack_333->GetYaxis()->SetTitle("Event/0.2");
   st_stack_333->GetYaxis()->SetLabelFont(42);
   st_stack_333->GetYaxis()->SetLabelSize(0.035);
   st_stack_333->GetYaxis()->SetTitleSize(0.037);
   st_stack_333->GetYaxis()->SetTitleOffset(0);
