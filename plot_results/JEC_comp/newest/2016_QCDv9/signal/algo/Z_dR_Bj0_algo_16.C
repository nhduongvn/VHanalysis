...
//=========  (Thu Mar 30 10:44:24 2023) by ROOT version 6.14/09
   ...
   Z_dR_Bj0_algo_16->Range(-1.310117,-0.09705059,7.029799,0.7117043);
   ...
   TH1F *st_stack_337 = new TH1F("st_stack_337","",30,0,6);
   st_stack_337->SetMinimum(0);
   st_stack_337->SetMaximum(0.6308288);
   ...
   st_stack_337->GetXaxis()->SetTitle("#DeltaR(Z,j_{1})");
   ...
   st_stack_337->GetYaxis()->SetTitle("Event/0.2");
   st_stack_337->GetYaxis()->SetLabelFont(42);
   st_stack_337->GetYaxis()->SetLabelSize(0.035);
   st_stack_337->GetYaxis()->SetTitleSize(0.037);
   st_stack_337->GetYaxis()->SetTitleOffset(0);
