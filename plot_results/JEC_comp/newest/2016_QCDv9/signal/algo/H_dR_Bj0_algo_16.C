...
//=========  (Thu Mar 30 10:44:24 2023) by ROOT version 6.14/09
   ...
   H_dR_Bj0_algo_16->Range(-1.310117,-0.08135737,7.029799,0.5966207);
   ...
   TH1F *st_stack_329 = new TH1F("st_stack_329","",30,0,6);
   st_stack_329->SetMinimum(0);
   st_stack_329->SetMaximum(0.5288229);
   ...
   st_stack_329->GetXaxis()->SetTitle("#DeltaR(H,j_{1})");
   st_stack_329->GetXaxis()->SetRange(1,30);
   ...
   st_stack_329->GetYaxis()->SetTitle("Event/0.2");
   st_stack_329->GetYaxis()->SetLabelFont(42);
   st_stack_329->GetYaxis()->SetLabelSize(0.035);
   st_stack_329->GetYaxis()->SetTitleSize(0.037);
   st_stack_329->GetYaxis()->SetTitleOffset(0);
