...
//=========  (Thu Mar 30 10:44:31 2023) by ROOT version 6.14/09
   ...
   H_jetmass_JEC_algo_noMassCorr_16->Range(-65.50587,-0.1716681,351.4899,1.258899);
   ...
   TH1F *st_stack_461 = new TH1F("st_stack_461","",150,0,300);
   st_stack_461->SetMinimum(0);
   st_stack_461->SetMaximum(1.115843);
   st_stack_461->SetDirectory(0);
   st_stack_461->SetStats(0);

   Int_t ci;      // for color index setting
   TColor *color; // for color definition with alpha
   ci = TColor::GetColor("#000099");
   st_stack_461->SetLineColor(ci);
   st_stack_461->GetXaxis()->SetTitle("c-jet mass (w/ JEC) [GeV]");
   st_stack_461->GetXaxis()->SetRange(1,150);
   st_stack_461->GetXaxis()->SetLabelFont(42);
   st_stack_461->GetXaxis()->SetLabelSize(0.035);
   st_stack_461->GetXaxis()->SetTitleSize(0.035);
   st_stack_461->GetXaxis()->SetTitleFont(42);
   st_stack_461->GetYaxis()->SetTitle("Event/2.0 GeV");
   st_stack_461->GetYaxis()->SetLabelFont(42);
   st_stack_461->GetYaxis()->SetLabelSize(0.035);
   st_stack_461->GetYaxis()->SetTitleSize(0.037);
   st_stack_461->GetYaxis()->SetTitleOffset(0);
   st_stack_461->GetYaxis()->SetTitleFont(42);
   st_stack_461->GetZaxis()->SetLabelFont(42);
   st_stack_461->GetZaxis()->SetLabelSize(0.035);
   st_stack_461->GetZaxis()->SetTitleSize(0.035);
   st_stack_461->GetZaxis()->SetTitleFont(42);
   st->SetHistogram(st_stack_461);
