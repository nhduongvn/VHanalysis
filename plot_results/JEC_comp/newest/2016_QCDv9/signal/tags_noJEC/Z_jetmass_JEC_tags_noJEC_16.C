void Z_jetmass_JEC_tags_noJEC_16()
{
//=========Macro generated from canvas: Z_jetmass_JEC_tags_noJEC_16/Z_jetmass_JEC_tags_noJEC_16
//=========  (Thu Mar 30 10:44:20 2023) by ROOT version 6.14/09
   TCanvas *Z_jetmass_JEC_tags_noJEC_16 = new TCanvas("Z_jetmass_JEC_tags_noJEC_16", "Z_jetmass_JEC_tags_noJEC_16",0,0,600,600);
   Z_jetmass_JEC_tags_noJEC_16->SetHighLightColor(2);
   Z_jetmass_JEC_tags_noJEC_16->Range(-65.50587,-0.7340604,351.4899,5.383109);
   Z_jetmass_JEC_tags_noJEC_16->SetFillColor(0);
   Z_jetmass_JEC_tags_noJEC_16->SetFillStyle(4000);
   Z_jetmass_JEC_tags_noJEC_16->SetBorderMode(0);
   Z_jetmass_JEC_tags_noJEC_16->SetBorderSize(2);
   Z_jetmass_JEC_tags_noJEC_16->SetLeftMargin(0.15709);
   Z_jetmass_JEC_tags_noJEC_16->SetRightMargin(0.1234783);
   Z_jetmass_JEC_tags_noJEC_16->SetBottomMargin(0.12);
   Z_jetmass_JEC_tags_noJEC_16->SetFrameFillStyle(1000);
   Z_jetmass_JEC_tags_noJEC_16->SetFrameBorderMode(0);
   Z_jetmass_JEC_tags_noJEC_16->SetFrameFillStyle(1000);
   Z_jetmass_JEC_tags_noJEC_16->SetFrameBorderMode(0);
   ...
   st_stack_285->SetMaximum(4.771392);
   ...
   VbbHcc_tags_noJEC_Z_jetmass_JEC_stack_1->SetBinContent(2,2.709204);
   VbbHcc_tags_noJEC_Z_jetmass_JEC_stack_1->SetBinContent(3,1.119881);
   VbbHcc_tags_noJEC_Z_jetmass_JEC_stack_1->SetBinError(2,0.08964226);
   VbbHcc_tags_noJEC_Z_jetmass_JEC_stack_1->SetBinError(3,0.05783517);
   VbbHcc_tags_noJEC_Z_jetmass_JEC_stack_1->SetEntries(1354);
   ...
   VbbHcc_tags_noJEC_Z_jetmass_JEC_stack_2->SetBinContent(2,1.062468);
   VbbHcc_tags_noJEC_Z_jetmass_JEC_stack_2->SetBinContent(3,0.555656);
   VbbHcc_tags_noJEC_Z_jetmass_JEC_stack_2->SetBinError(2,0.02012794);
   VbbHcc_tags_noJEC_Z_jetmass_JEC_stack_2->SetBinError(3,0.01456098);
   VbbHcc_tags_noJEC_Z_jetmass_JEC_stack_2->SetEntries(4322);
...
tex->SetNDC();
   ...
   tex->SetLineWidth(2);
   tex->Draw();
   Z_jetmass_JEC_tags_noJEC_16->Modified();
   Z_jetmass_JEC_tags_noJEC_16->cd();
   Z_jetmass_JEC_tags_noJEC_16->SetSelected(Z_jetmass_JEC_tags_noJEC_16);
}
