...
//=========  (Thu Mar 30 10:44:38 2023) by ROOT version 6.14/09
   ...
   Z_jetmass_JEC_algo_noJEC_16->Range(-65.50587,-0.1716681,351.4899,1.258899);
   ...
   TH1F *st_stack_573 = new TH1F("st_stack_573","",150,0,300);
   st_stack_573->SetMinimum(0);
   st_stack_573->SetMaximum(1.115843);
   st_stack_573->SetDirectory(0);
   st_stack_573->SetStats(0);

   Int_t ci;      // for color index setting
   TColor *color; // for color definition with alpha
   ci = TColor::GetColor("#000099");
   st_stack_573->SetLineColor(ci);
   st_stack_573->GetXaxis()->SetTitle("b-jet mass (w/ JEC) [GeV]");
   st_stack_573->GetXaxis()->SetRange(1,150);
   st_stack_573->GetXaxis()->SetLabelFont(42);
   st_stack_573->GetXaxis()->SetLabelSize(0.035);
   st_stack_573->GetXaxis()->SetTitleSize(0.035);
   st_stack_573->GetXaxis()->SetTitleFont(42);
   st_stack_573->GetYaxis()->SetTitle("Event/2.0 GeV");
   st_stack_573->GetYaxis()->SetLabelFont(42);
   st_stack_573->GetYaxis()->SetLabelSize(0.035);
   st_stack_573->GetYaxis()->SetTitleSize(0.037);
   st_stack_573->GetYaxis()->SetTitleOffset(0);
   st_stack_573->GetYaxis()->SetTitleFont(42);
   st_stack_573->GetZaxis()->SetLabelFont(42);
   st_stack_573->GetZaxis()->SetLabelSize(0.035);
   st_stack_573->GetZaxis()->SetTitleSize(0.035);
   st_stack_573->GetZaxis()->SetTitleFont(42);
   st->SetHistogram(st_stack_573);
