...
void H_mass_bckg_16()
{
//=========Macro generated from canvas: H_mass_bckg_16/H_mass_bckg_16
//=========  (Thu Mar 23 11:52:35 2023) by ROOT version 6.26/06
   TCanvas *H_mass_bckg_16 = new TCanvas("H_mass_bckg_16", "H_mass_bckg_16",0,0,600,600);
   H_mass_bckg_16->SetHighLightColor(2);
   H_mass_bckg_16->Range(-65.50587,-0.1538462,351.4899,1.128205);
   H_mass_bckg_16->SetFillColor(0);
   H_mass_bckg_16->SetFillStyle(4000);
   H_mass_bckg_16->SetBorderMode(0);
   H_mass_bckg_16->SetBorderSize(2);
   H_mass_bckg_16->SetLeftMargin(0.15709);
   H_mass_bckg_16->SetRightMargin(0.1234783);
   H_mass_bckg_16->SetBottomMargin(0.12);
   H_mass_bckg_16->SetFrameFillStyle(1000);
   H_mass_bckg_16->SetFrameBorderMode(0);
   H_mass_bckg_16->SetFrameFillStyle(1000);
   H_mass_bckg_16->SetFrameBorderMode(0);
...
tex->SetNDC();
   ...
   tex->SetLineWidth(2);
   tex->Draw();
   H_mass_bckg_16->Modified();
   H_mass_bckg_16->cd();
   H_mass_bckg_16->SetSelected(H_mass_bckg_16);
}
