...
void H_dR_signal_16()
{
//=========Macro generated from canvas: H_dR_signal_16/H_dR_signal_16
//=========  (Thu Mar 23 11:52:35 2023) by ROOT version 6.26/06
   TCanvas *H_dR_signal_16 = new TCanvas("H_dR_signal_16", "H_dR_signal_16",0,0,600,600);
   H_dR_signal_16->SetHighLightColor(2);
   H_dR_signal_16->Range(-1.353788,-3.552381,7.264125,26.05079);
   H_dR_signal_16->SetFillColor(0);
   H_dR_signal_16->SetFillStyle(4000);
   H_dR_signal_16->SetBorderMode(0);
   H_dR_signal_16->SetBorderSize(2);
   H_dR_signal_16->SetLeftMargin(0.15709);
   H_dR_signal_16->SetRightMargin(0.1234783);
   H_dR_signal_16->SetBottomMargin(0.12);
   H_dR_signal_16->SetFrameFillStyle(1000);
   H_dR_signal_16->SetFrameBorderMode(0);
   H_dR_signal_16->SetFrameFillStyle(1000);
   H_dR_signal_16->SetFrameBorderMode(0);
   ...
   st_stack_7->GetYaxis()->SetTitle("Event/0.2");
...
tex->SetNDC();
   ...
   tex->SetLineWidth(2);
   tex->Draw();
   H_dR_signal_16->Modified();
   H_dR_signal_16->cd();
   H_dR_signal_16->SetSelected(H_dR_signal_16);
}
