...
//=========  (Mon Mar 20 11:48:34 2023) by ROOT version 6.26/06
   ...
   Z_jetmass_JEC_both_16->Range(-65.50587,-0.7103521,351.4899,5.209249);
   ...
   st_stack_285->SetMaximum(4.617289);
   ...
   VbbHcc_both_Z_jetmass_JEC_stack_1->SetBinContent(2,2.747396);
   VbbHcc_both_Z_jetmass_JEC_stack_1->SetBinContent(3,1.150073);
   VbbHcc_both_Z_jetmass_JEC_stack_1->SetBinError(2,0.09027644);
   VbbHcc_both_Z_jetmass_JEC_stack_1->SetBinError(3,0.05862009);
   VbbHcc_both_Z_jetmass_JEC_stack_1->SetEntries(1377);
   ...
   VbbHcc_both_Z_jetmass_JEC_stack_2->SetBinContent(2,1.084953);
   VbbHcc_both_Z_jetmass_JEC_stack_2->SetBinContent(3,0.5663296);
   VbbHcc_both_Z_jetmass_JEC_stack_2->SetBinError(2,0.02033716);
   VbbHcc_both_Z_jetmass_JEC_stack_2->SetBinError(3,0.01470165);
   VbbHcc_both_Z_jetmass_JEC_stack_2->SetEntries(4411);
