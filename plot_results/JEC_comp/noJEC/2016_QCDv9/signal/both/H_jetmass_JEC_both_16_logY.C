...
//=========  (Mon Mar 20 11:48:19 2023) by ROOT version 6.26/06
   ...
   H_jetmass_JEC_both_16->Range(-65.50587,-0.2542807,351.4899,0.8266645);
   ...
   st_stack_269->SetMinimum(0.7506417);
   st_stack_269->SetMaximum(5.230822);
   ...
   VbbHcc_both_H_jetmass_JEC_stack_1->SetBinContent(3,1.150073);
   VbbHcc_both_H_jetmass_JEC_stack_1->SetBinError(2,0.09027644);
   VbbHcc_both_H_jetmass_JEC_stack_1->SetBinError(3,0.05862009);
   ...
   VbbHcc_both_H_jetmass_JEC_stack_2->SetBinContent(2,1.084953);
   VbbHcc_both_H_jetmass_JEC_stack_2->SetBinContent(3,0.5663296);
   VbbHcc_both_H_jetmass_JEC_stack_2->SetBinError(2,0.02033716);
   VbbHcc_both_H_jetmass_JEC_stack_2->SetBinError(3,0.01470165);
