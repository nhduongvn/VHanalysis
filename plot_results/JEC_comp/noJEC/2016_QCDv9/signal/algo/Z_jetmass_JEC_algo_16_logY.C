...
//=========  (Mon Mar 20 11:48:17 2023) by ROOT version 6.26/06
   ...
   Z_jetmass_JEC_algo_16->Range(-65.50587,-0.01099042,351.4899,0.03311215);
   ...
   st_stack_189->SetMinimum(0.9869653);
   st_stack_189->SetMaximum(1.068321);
   ...
   VbbHcc_algo_Z_jetmass_JEC_stack_1->SetBinContent(2,0.6708204);
   VbbHcc_algo_Z_jetmass_JEC_stack_1->SetBinContent(3,0.2869799);
   VbbHcc_algo_Z_jetmass_JEC_stack_1->SetBinError(2,0.04476983);
   VbbHcc_algo_Z_jetmass_JEC_stack_1->SetBinError(3,0.02935466);
   ...
   VbbHcc_algo_Z_jetmass_JEC_stack_2->SetBinContent(2,0.2112267);
   VbbHcc_algo_Z_jetmass_JEC_stack_2->SetBinContent(3,0.1220968);
   VbbHcc_algo_Z_jetmass_JEC_stack_2->SetBinError(2,0.009004458);
   VbbHcc_algo_Z_jetmass_JEC_stack_2->SetBinError(3,0.006848452);
