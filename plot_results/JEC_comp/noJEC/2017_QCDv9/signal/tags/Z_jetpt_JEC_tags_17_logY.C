...
//=========  (Mon Mar 20 11:48:16 2023) by ROOT version 6.26/06
   ...
   Z_jetpt_JEC_tags_17->Range(-65.50587,-0.2428865,351.4899,0.7869822);
   ...
   st_stack_86->SetMinimum(0.7597973);
   st_stack_86->SetMaximum(4.830536);
   ...
   VbbHcc_tags_Z_jetpt_JEC_stack_1->SetBinContent(0,2.947272);
   VbbHcc_tags_Z_jetpt_JEC_stack_1->SetBinContent(1,0.02157855);
   VbbHcc_tags_Z_jetpt_JEC_stack_1->SetBinContent(2,2.514246);
   VbbHcc_tags_Z_jetpt_JEC_stack_1->SetBinContent(3,0.5187881);
   VbbHcc_tags_Z_jetpt_JEC_stack_1->SetBinError(0,0.0748081);
   VbbHcc_tags_Z_jetpt_JEC_stack_1->SetBinError(1,0.006305843);
   VbbHcc_tags_Z_jetpt_JEC_stack_1->SetBinError(2,0.0689723);
   VbbHcc_tags_Z_jetpt_JEC_stack_1->SetBinError(3,0.03102927);
   ...
   VbbHcc_tags_Z_jetpt_JEC_stack_2->SetBinContent(0,1.27038);
   VbbHcc_tags_Z_jetpt_JEC_stack_2->SetBinContent(1,0.006167587);
   VbbHcc_tags_Z_jetpt_JEC_stack_2->SetBinContent(2,1.045009);
   VbbHcc_tags_Z_jetpt_JEC_stack_2->SetBinContent(3,0.2132785);
   VbbHcc_tags_Z_jetpt_JEC_stack_2->SetBinError(0,0.0174915);
   VbbHcc_tags_Z_jetpt_JEC_stack_2->SetBinError(1,0.001204978);
   VbbHcc_tags_Z_jetpt_JEC_stack_2->SetBinError(2,0.01585403);
   VbbHcc_tags_Z_jetpt_JEC_stack_2->SetBinError(3,0.007183422);
