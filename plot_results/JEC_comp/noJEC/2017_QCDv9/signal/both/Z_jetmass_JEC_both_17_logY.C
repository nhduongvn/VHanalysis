...
//=========  (Mon Mar 20 11:48:19 2023) by ROOT version 6.26/06
   ...
   Z_jetmass_JEC_both_17->Range(-65.50587,-0.3243887,351.4899,1.076052);
   ...
   st_stack_286->SetMinimum(0.6976926);
   st_stack_286->SetMaximum(8.629938);
   ...
   VbbHcc_both_Z_jetmass_JEC_stack_1->SetBinContent(2,4.385427);
   VbbHcc_both_Z_jetmass_JEC_stack_1->SetBinContent(3,1.730643);
   VbbHcc_both_Z_jetmass_JEC_stack_1->SetBinError(2,0.09141184);
   VbbHcc_both_Z_jetmass_JEC_stack_1->SetBinError(3,0.05666745);
   ...
   VbbHcc_both_Z_jetmass_JEC_stack_2->SetBinContent(2,1.719352);
   VbbHcc_both_Z_jetmass_JEC_stack_2->SetBinContent(3,0.8802571);
   VbbHcc_both_Z_jetmass_JEC_stack_2->SetBinError(2,0.02035872);
   VbbHcc_both_Z_jetmass_JEC_stack_2->SetBinError(3,0.01454299);
