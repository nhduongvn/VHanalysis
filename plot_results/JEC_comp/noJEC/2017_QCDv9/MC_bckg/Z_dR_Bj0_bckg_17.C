...
#endif
void Z_dR_Bj0_bckg_17()
{
//=========Macro generated from canvas: Z_dR_Bj0_bckg_17/Z_dR_Bj0_bckg_17
//=========  (Thu Mar 23 11:52:35 2023) by ROOT version 6.26/06
   TCanvas *Z_dR_Bj0_bckg_17 = new TCanvas("Z_dR_Bj0_bckg_17", "Z_dR_Bj0_bckg_17",0,0,600,600);
   Z_dR_Bj0_bckg_17->SetHighLightColor(2);
   Z_dR_Bj0_bckg_17->Range(-1.310117,-0.1538462,7.029799,1.128205);
   Z_dR_Bj0_bckg_17->SetFillColor(0);
   Z_dR_Bj0_bckg_17->SetFillStyle(4000);
   Z_dR_Bj0_bckg_17->SetBorderMode(0);
   Z_dR_Bj0_bckg_17->SetBorderSize(2);
   Z_dR_Bj0_bckg_17->SetLeftMargin(0.15709);
   Z_dR_Bj0_bckg_17->SetRightMargin(0.1234783);
   Z_dR_Bj0_bckg_17->SetBottomMargin(0.12);
   Z_dR_Bj0_bckg_17->SetFrameFillStyle(1000);
   Z_dR_Bj0_bckg_17->SetFrameBorderMode(0);
   Z_dR_Bj0_bckg_17->SetFrameFillStyle(1000);
   Z_dR_Bj0_bckg_17->SetFrameBorderMode(0);
   ...
   st_stack_40->GetXaxis()->SetTitle("#DeltaR(Z,j_{1})");
   ...
   st_stack_40->GetYaxis()->SetTitle("Event/0.2");
...
tex->SetNDC();
   ...
   tex->SetLineWidth(2);
   tex->Draw();
   Z_dR_Bj0_bckg_17->Modified();
   Z_dR_Bj0_bckg_17->cd();
   Z_dR_Bj0_bckg_17->SetSelected(Z_dR_Bj0_bckg_17);
}
