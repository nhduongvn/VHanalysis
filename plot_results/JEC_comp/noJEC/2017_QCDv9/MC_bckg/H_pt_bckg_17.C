...
void H_pt_bckg_17()
{
//=========Macro generated from canvas: H_pt_bckg_17/H_pt_bckg_17
//=========  (Thu Mar 23 11:52:36 2023) by ROOT version 6.26/06
   TCanvas *H_pt_bckg_17 = new TCanvas("H_pt_bckg_17", "H_pt_bckg_17",0,0,600,600);
   H_pt_bckg_17->SetHighLightColor(2);
   H_pt_bckg_17->Range(37.97653,-0.1538462,1705.96,1.128205);
   H_pt_bckg_17->SetFillColor(0);
   H_pt_bckg_17->SetFillStyle(4000);
   H_pt_bckg_17->SetBorderMode(0);
   H_pt_bckg_17->SetBorderSize(2);
   H_pt_bckg_17->SetLeftMargin(0.15709);
   H_pt_bckg_17->SetRightMargin(0.1234783);
   H_pt_bckg_17->SetBottomMargin(0.12);
   H_pt_bckg_17->SetFrameFillStyle(1000);
   H_pt_bckg_17->SetFrameBorderMode(0);
   H_pt_bckg_17->SetFrameFillStyle(1000);
   H_pt_bckg_17->SetFrameBorderMode(0);
   ...
   st_stack_58->GetXaxis()->SetTitle("H p_{T} [GeV]");
   st_stack_58->GetXaxis()->SetRange(151,750);
...
tex->SetNDC();
   ...
   tex->SetLineWidth(2);
   tex->Draw();
   H_pt_bckg_17->Modified();
   H_pt_bckg_17->cd();
   H_pt_bckg_17->SetSelected(H_pt_bckg_17);
}
