...
//=========  (Mon Mar 20 11:48:17 2023) by ROOT version 6.26/06
   ...
   H_jetpt_JEC_algo_all->Range(-65.50587,-0.2029271,351.4899,0.6497257);
   ...
   st_stack_168->SetMinimum(0.7932156);
   st_stack_168->SetMaximum(3.668262);
