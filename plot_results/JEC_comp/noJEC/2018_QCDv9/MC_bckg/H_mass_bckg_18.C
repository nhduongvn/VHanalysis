...
void H_mass_bckg_18()
{
//=========Macro generated from canvas: H_mass_bckg_18/H_mass_bckg_18
//=========  (Thu Mar 23 11:52:35 2023) by ROOT version 6.26/06
   TCanvas *H_mass_bckg_18 = new TCanvas("H_mass_bckg_18", "H_mass_bckg_18",0,0,600,600);
   H_mass_bckg_18->SetHighLightColor(2);
   H_mass_bckg_18->Range(-65.50587,-0.1538462,351.4899,1.128205);
   H_mass_bckg_18->SetFillColor(0);
   H_mass_bckg_18->SetFillStyle(4000);
   H_mass_bckg_18->SetBorderMode(0);
   H_mass_bckg_18->SetBorderSize(2);
   H_mass_bckg_18->SetLeftMargin(0.15709);
   H_mass_bckg_18->SetRightMargin(0.1234783);
   H_mass_bckg_18->SetBottomMargin(0.12);
   H_mass_bckg_18->SetFrameFillStyle(1000);
   H_mass_bckg_18->SetFrameBorderMode(0);
   H_mass_bckg_18->SetFrameFillStyle(1000);
   H_mass_bckg_18->SetFrameBorderMode(0);
...
tex->SetNDC();
   ...
   tex->SetLineWidth(2);
   tex->Draw();
   H_mass_bckg_18->Modified();
   H_mass_bckg_18->cd();
   H_mass_bckg_18->SetSelected(H_mass_bckg_18);
}
