...
void Z_mass_bckg_18()
{
//=========Macro generated from canvas: Z_mass_bckg_18/Z_mass_bckg_18
//=========  (Thu Mar 23 11:52:35 2023) by ROOT version 6.26/06
   TCanvas *Z_mass_bckg_18 = new TCanvas("Z_mass_bckg_18", "Z_mass_bckg_18",0,0,600,600);
   Z_mass_bckg_18->SetHighLightColor(2);
   Z_mass_bckg_18->Range(-65.50587,-0.1538462,351.4899,1.128205);
   Z_mass_bckg_18->SetFillColor(0);
   Z_mass_bckg_18->SetFillStyle(4000);
   Z_mass_bckg_18->SetBorderMode(0);
   Z_mass_bckg_18->SetBorderSize(2);
   Z_mass_bckg_18->SetLeftMargin(0.15709);
   Z_mass_bckg_18->SetRightMargin(0.1234783);
   Z_mass_bckg_18->SetBottomMargin(0.12);
   Z_mass_bckg_18->SetFrameFillStyle(1000);
   Z_mass_bckg_18->SetFrameBorderMode(0);
   Z_mass_bckg_18->SetFrameFillStyle(1000);
   Z_mass_bckg_18->SetFrameBorderMode(0);
   ...
   TH1F *st_stack_30 = new TH1F("st_stack_30","",200,0,400);
   st_stack_30->SetMinimum(0);
   st_stack_30->SetMaximum(0);
   ...
   st_stack_30->GetXaxis()->SetTitle("M_{Z} [GeV]");
   ...
   st_stack_30->GetYaxis()->SetTitle("Event/2.0 GeV");
...
tex->SetNDC();
   ...
   tex->SetLineWidth(2);
   tex->Draw();
   Z_mass_bckg_18->Modified();
   Z_mass_bckg_18->cd();
   Z_mass_bckg_18->SetSelected(Z_mass_bckg_18);
}
