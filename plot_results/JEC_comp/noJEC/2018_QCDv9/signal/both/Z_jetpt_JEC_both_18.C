...
//=========  (Mon Mar 20 11:48:34 2023) by ROOT version 6.26/06
   ...
   Z_jetpt_JEC_both_18->Range(-65.50587,-0.9152966,351.4899,6.712175);
   ...
   st_stack_279->SetMaximum(5.949428);
   ...
   VbbHcc_both_Z_jetpt_JEC_stack_1->SetBinContent(0,3.977234);
   VbbHcc_both_Z_jetpt_JEC_stack_1->SetBinContent(1,0.01985387);
   VbbHcc_both_Z_jetpt_JEC_stack_1->SetBinContent(2,3.470783);
   VbbHcc_both_Z_jetpt_JEC_stack_1->SetBinContent(3,0.6451752);
   VbbHcc_both_Z_jetpt_JEC_stack_1->SetBinError(0,0.1093321);
   VbbHcc_both_Z_jetpt_JEC_stack_1->SetBinError(1,0.007152531);
   VbbHcc_both_Z_jetpt_JEC_stack_1->SetBinError(2,0.1104145);
   VbbHcc_both_Z_jetpt_JEC_stack_1->SetBinError(3,0.0425484);
   ...
   VbbHcc_both_Z_jetpt_JEC_stack_2->SetBinContent(0,1.725771);
   VbbHcc_both_Z_jetpt_JEC_stack_2->SetBinContent(1,0.007756853);
   VbbHcc_both_Z_jetpt_JEC_stack_2->SetBinContent(2,1.467242);
   VbbHcc_both_Z_jetpt_JEC_stack_2->SetBinContent(3,0.3158748);
   VbbHcc_both_Z_jetpt_JEC_stack_2->SetBinError(0,0.02637081);
   VbbHcc_both_Z_jetpt_JEC_stack_2->SetBinError(1,0.001660555);
   VbbHcc_both_Z_jetpt_JEC_stack_2->SetBinError(2,0.02345164);
   VbbHcc_both_Z_jetpt_JEC_stack_2->SetBinError(3,0.01081967);
