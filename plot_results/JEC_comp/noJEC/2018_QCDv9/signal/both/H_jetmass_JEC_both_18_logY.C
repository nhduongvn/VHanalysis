...
//=========  (Mon Mar 20 11:48:19 2023) by ROOT version 6.26/06
   ...
   H_jetmass_JEC_both_18->Range(-65.50587,-0.3675808,351.4899,1.234088);
   ...
   st_stack_271->SetMinimum(0.6677585);
   st_stack_271->SetMaximum(11.85553);
   ...
   VbbHcc_both_H_jetmass_JEC_stack_1->SetBinContent(1,0.001576883);
   VbbHcc_both_H_jetmass_JEC_stack_1->SetBinContent(2,5.898395);
   VbbHcc_both_H_jetmass_JEC_stack_1->SetBinContent(3,2.213074);
   VbbHcc_both_H_jetmass_JEC_stack_1->SetBinError(1,0.001576883);
