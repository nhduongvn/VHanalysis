...
//=========  (Mon Mar 20 11:48:16 2023) by ROOT version 6.26/06
   ...
   Z_jetmass_JEC_tags_18->Range(-65.50587,-0.3648804,351.4899,1.224111);
   ...
   st_stack_95->SetMinimum(0.6695739);
   st_stack_95->SetMaximum(11.62014);
   ...
   VbbHcc_tags_Z_jetmass_JEC_stack_1->SetBinContent(1,0.001576883);
   VbbHcc_tags_Z_jetmass_JEC_stack_1->SetBinContent(2,5.797021);
   VbbHcc_tags_Z_jetmass_JEC_stack_1->SetBinContent(3,2.155679);
   VbbHcc_tags_Z_jetmass_JEC_stack_1->SetBinError(1,0.001576883);
   VbbHcc_tags_Z_jetmass_JEC_stack_1->SetBinError(2,0.1398271);
   VbbHcc_tags_Z_jetmass_JEC_stack_1->SetBinError(3,0.07766383);
   ...
   VbbHcc_tags_Z_jetmass_JEC_stack_2->SetBinContent(2,2.257731);
   VbbHcc_tags_Z_jetmass_JEC_stack_2->SetBinContent(3,1.184723);
   VbbHcc_tags_Z_jetmass_JEC_stack_2->SetBinError(2,0.02939088);
   VbbHcc_tags_Z_jetmass_JEC_stack_2->SetBinError(3,0.02180238);
