...
//=========  (Tue Apr 25 23:03:08 2023) by ROOT version 6.26/06
   ...
   CvB_2016_QuadJet_DoubleTag_16_tagged_ref->Range(-0.2,3.217488,1.133333,4.928946);
   ...
   _QuadJet_DoubleTag_tagged_CvB_ref__210->SetBinContent(1,30217);
   _QuadJet_DoubleTag_tagged_CvB_ref__210->SetBinContent(2,5660);
   _QuadJet_DoubleTag_tagged_CvB_ref__210->SetBinContent(3,4894);
   _QuadJet_DoubleTag_tagged_CvB_ref__210->SetBinContent(4,5657);
   _QuadJet_DoubleTag_tagged_CvB_ref__210->SetBinContent(5,6409);
   _QuadJet_DoubleTag_tagged_CvB_ref__210->SetBinContent(6,7539);
   _QuadJet_DoubleTag_tagged_CvB_ref__210->SetBinContent(7,10289);
   _QuadJet_DoubleTag_tagged_CvB_ref__210->SetBinContent(8,13978);
   _QuadJet_DoubleTag_tagged_CvB_ref__210->SetBinContent(9,18997);
   _QuadJet_DoubleTag_tagged_CvB_ref__210->SetBinContent(10,11772);
   _QuadJet_DoubleTag_tagged_CvB_ref__210->SetEntries(115412);
