...
//=========  (Wed Apr 26 16:41:43 2023) by ROOT version 6.26/06
   ...
   CvB_2016_QuadJet_TripleTag_16_tagged_ref->Range(-0.2,3.213407,1.133333,4.926452);
   ...
   _QuadJet_TripleTag_tagged_CvB_ref__207->SetBinContent(1,30033);
   _QuadJet_TripleTag_tagged_CvB_ref__207->SetBinContent(2,5621);
   _QuadJet_TripleTag_tagged_CvB_ref__207->SetBinContent(3,4850);
   _QuadJet_TripleTag_tagged_CvB_ref__207->SetBinContent(4,5633);
   _QuadJet_TripleTag_tagged_CvB_ref__207->SetBinContent(5,6375);
   _QuadJet_TripleTag_tagged_CvB_ref__207->SetBinContent(6,7466);
   _QuadJet_TripleTag_tagged_CvB_ref__207->SetBinContent(7,10232);
   _QuadJet_TripleTag_tagged_CvB_ref__207->SetBinContent(8,13903);
   _QuadJet_TripleTag_tagged_CvB_ref__207->SetBinContent(9,18874);
   _QuadJet_TripleTag_tagged_CvB_ref__207->SetBinContent(10,11685);
   _QuadJet_TripleTag_tagged_CvB_ref__207->SetEntries(114672);
