...
//=========  (Thu Apr 27 10:18:38 2023) by ROOT version 6.26/06
   ...
   pt_jet3_2016_DoubleJet_TripleTag_16_tagged_ref->Range(-100,-0.8630931,566.6667,4.757537);
   ...
   _DoubleJet_TripleTag_tagged_pt_jet3_ref__153->SetBinContent(5,5322);
   _DoubleJet_TripleTag_tagged_pt_jet3_ref__153->SetBinContent(6,8278);
   _DoubleJet_TripleTag_tagged_pt_jet3_ref__153->SetBinContent(7,5520);
   _DoubleJet_TripleTag_tagged_pt_jet3_ref__153->SetBinContent(8,3510);
   _DoubleJet_TripleTag_tagged_pt_jet3_ref__153->SetBinContent(9,2046);
   _DoubleJet_TripleTag_tagged_pt_jet3_ref__153->SetBinContent(10,1354);
   _DoubleJet_TripleTag_tagged_pt_jet3_ref__153->SetBinContent(11,901);
   _DoubleJet_TripleTag_tagged_pt_jet3_ref__153->SetBinContent(12,596);
   _DoubleJet_TripleTag_tagged_pt_jet3_ref__153->SetBinContent(13,356);
   _DoubleJet_TripleTag_tagged_pt_jet3_ref__153->SetBinContent(14,247);
   _DoubleJet_TripleTag_tagged_pt_jet3_ref__153->SetBinContent(15,155);
   _DoubleJet_TripleTag_tagged_pt_jet3_ref__153->SetBinContent(16,100);
   ...
   _DoubleJet_TripleTag_tagged_pt_jet3_ref__153->SetEntries(28668);
