...
//=========  (Tue Apr 18 16:14:02 2023) by ROOT version 6.26/06
   ...
   CvB_2016_QuadJet_DoubleTag_16->Range(-0.2,2.434539,1.133333,4.362804);
   ...
   _QuadJet_DoubleTag_CvB__197->SetBinContent(1,6216);
   _QuadJet_DoubleTag_CvB__197->SetBinContent(2,1045);
   _QuadJet_DoubleTag_CvB__197->SetBinContent(3,858);
   _QuadJet_DoubleTag_CvB__197->SetBinContent(4,848);
   _QuadJet_DoubleTag_CvB__197->SetBinContent(5,940);
   _QuadJet_DoubleTag_CvB__197->SetBinContent(6,1162);
   _QuadJet_DoubleTag_CvB__197->SetBinContent(7,1946);
   _QuadJet_DoubleTag_CvB__197->SetBinContent(8,3649);
   _QuadJet_DoubleTag_CvB__197->SetBinContent(9,7806);
   _QuadJet_DoubleTag_CvB__197->SetBinContent(10,4054);
   _QuadJet_DoubleTag_CvB__197->SetEntries(28524);
   ...
   ptstats_LaTex = ptstats->AddText("Std Dev   = 0.3521");
