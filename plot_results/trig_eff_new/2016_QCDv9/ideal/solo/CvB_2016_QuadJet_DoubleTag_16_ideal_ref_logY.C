...
//=========  (Tue Apr 25 23:03:10 2023) by ROOT version 6.26/06
   ...
   CvB_2016_QuadJet_DoubleTag_16_ideal_ref->Range(-0.2,3.216002,1.133333,4.928104);
   ...
   _QuadJet_DoubleTag_ideal_CvB_ref__318->SetBinContent(1,30154);
   _QuadJet_DoubleTag_ideal_CvB_ref__318->SetBinContent(2,5647);
   _QuadJet_DoubleTag_ideal_CvB_ref__318->SetBinContent(3,4878);
   _QuadJet_DoubleTag_ideal_CvB_ref__318->SetBinContent(4,5637);
   _QuadJet_DoubleTag_ideal_CvB_ref__318->SetBinContent(5,6397);
   _QuadJet_DoubleTag_ideal_CvB_ref__318->SetBinContent(6,7510);
   _QuadJet_DoubleTag_ideal_CvB_ref__318->SetBinContent(7,10269);
   _QuadJet_DoubleTag_ideal_CvB_ref__318->SetBinContent(8,13946);
   _QuadJet_DoubleTag_ideal_CvB_ref__318->SetBinContent(9,18939);
   _QuadJet_DoubleTag_ideal_CvB_ref__318->SetBinContent(10,11739);
   _QuadJet_DoubleTag_ideal_CvB_ref__318->SetEntries(115116);
