...
//=========  (Tue Apr 18 16:14:02 2023) by ROOT version 6.26/06
   ...
   CvB_2016_DoubleJet_DoubleTag_16->Range(-0.2183529,0.005187682,1.171633,0.0120719);
   ...
   _DoubleJet_DoubleTag_CvB__202->SetBinContent(1,0.01112778);
   _DoubleJet_DoubleTag_CvB__202->SetBinContent(2,0.01106953);
   _DoubleJet_DoubleTag_CvB__202->SetBinContent(3,0.0101096);
   _DoubleJet_DoubleTag_CvB__202->SetBinContent(4,0.009636504);
   _DoubleJet_DoubleTag_CvB__202->SetBinContent(5,0.008582327);
   _DoubleJet_DoubleTag_CvB__202->SetBinContent(6,0.008020551);
   _DoubleJet_DoubleTag_CvB__202->SetBinContent(7,0.007243738);
   _DoubleJet_DoubleTag_CvB__202->SetBinContent(8,0.006364859);
   _DoubleJet_DoubleTag_CvB__202->SetBinContent(9,0.006257311);
   _DoubleJet_DoubleTag_CvB__202->SetBinContent(10,0.006380259);
   _DoubleJet_DoubleTag_CvB__202->SetEntries(0.08479246);
   ...
   ptstats_LaTex = ptstats->AddText("Mean  = 0.4393");
   ptstats_LaTex = ptstats->AddText("Std Dev   = 0.2833");
