...
//=========  (Mon Apr 24 10:39:14 2023) by ROOT version 6.26/06
   ...
   _DoubleJet_DoubleTag_pt_jet0__11->SetBinContent(17,269);
   _DoubleJet_DoubleTag_pt_jet0__11->SetBinContent(18,195);
   ...
   _DoubleJet_DoubleTag_pt_jet0__11->SetEntries(4080);
   ...
   ptstats_LaTex = ptstats->AddText("Std Dev   =  78.89");
