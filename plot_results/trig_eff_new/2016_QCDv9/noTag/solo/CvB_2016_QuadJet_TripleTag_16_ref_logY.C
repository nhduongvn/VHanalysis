...
//=========  (Wed Apr 26 16:41:42 2023) by ROOT version 6.26/06
   ...
   CvB_2016_QuadJet_TripleTag_16_ref->Range(-0.2,4.185229,1.133333,6.356237);
   ...
   _QuadJet_TripleTag_CvB_ref__99->SetBinContent(1,307278);
   _QuadJet_TripleTag_CvB_ref__99->SetBinContent(2,57157);
   _QuadJet_TripleTag_CvB_ref__99->SetBinContent(3,50544);
   _QuadJet_TripleTag_CvB_ref__99->SetBinContent(4,50508);
   _QuadJet_TripleTag_CvB_ref__99->SetBinContent(5,62911);
   _QuadJet_TripleTag_CvB_ref__99->SetBinContent(6,89130);
   _QuadJet_TripleTag_CvB_ref__99->SetBinContent(7,153765);
   _QuadJet_TripleTag_CvB_ref__99->SetBinContent(8,322061);
   _QuadJet_TripleTag_CvB_ref__99->SetBinContent(9,727089);
   _QuadJet_TripleTag_CvB_ref__99->SetBinContent(10,345517);
   _QuadJet_TripleTag_CvB_ref__99->SetEntries(2165960);
