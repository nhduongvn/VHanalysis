...
//=========  (Wed Apr 26 16:41:41 2023) by ROOT version 6.26/06
   ...
   pt_jet3_2016_DoubleJet_DoubleTag_16->Range(-100,-0.749957,566.6667,3.739313);
   ...
   _DoubleJet_DoubleTag_pt_jet3__47->SetBinContent(5,597);
   _DoubleJet_DoubleTag_pt_jet3__47->SetBinContent(6,1030);
   _DoubleJet_DoubleTag_pt_jet3__47->SetBinContent(7,869);
   _DoubleJet_DoubleTag_pt_jet3__47->SetBinContent(8,561);
   _DoubleJet_DoubleTag_pt_jet3__47->SetBinContent(9,380);
   ...
   _DoubleJet_DoubleTag_pt_jet3__47->SetEntries(4039);
   ...
   ptstats_LaTex = ptstats->AddText("Mean  =  70.66");
   ptstats_LaTex = ptstats->AddText("Std Dev   =  25.39");
