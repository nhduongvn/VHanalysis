...
//=========  (Thu Apr 27 10:18:11 2023) by ROOT version 6.26/06
   ...
   CvB_2018_QuadJet_noTag_18_ideal->Range(-0.2183529,0.005417585,1.171633,0.006717239);
   ...
   _QuadJet_noTag_ideal_CvB__160->SetBinContent(1,0.005666682);
   _QuadJet_noTag_ideal_CvB__160->SetBinContent(2,0.005619518);
   _QuadJet_noTag_ideal_CvB__160->SetBinContent(3,0.0061238);
   _QuadJet_noTag_ideal_CvB__160->SetBinContent(4,0.006221719);
   _QuadJet_noTag_ideal_CvB__160->SetBinContent(5,0.006539);
   _QuadJet_noTag_ideal_CvB__160->SetBinContent(6,0.005956588);
   _QuadJet_noTag_ideal_CvB__160->SetBinContent(7,0.006420546);
   _QuadJet_noTag_ideal_CvB__160->SetBinContent(8,0.006461631);
   _QuadJet_noTag_ideal_CvB__160->SetBinContent(9,0.005681624);
   _QuadJet_noTag_ideal_CvB__160->SetBinContent(10,0.005883941);
   _QuadJet_noTag_ideal_CvB__160->SetEntries(0.06057505);
   ...
   ptstats_LaTex = ptstats->AddText("Std Dev   = 0.2822");
