...
//=========  (Tue Apr 25 23:01:42 2023) by ROOT version 6.26/06
   ...
   BvL_2018_QuadJet_TripleTag_18_ideal_ref->Range(-0.2,3.221037,1.133333,5.423694);
   ...
   _QuadJet_TripleTag_ideal_BvL_ref__147->SetBinContent(1,84310);
   _QuadJet_TripleTag_ideal_BvL_ref__147->SetBinContent(2,14033);
   _QuadJet_TripleTag_ideal_BvL_ref__147->SetBinContent(3,7578);
   _QuadJet_TripleTag_ideal_BvL_ref__147->SetBinContent(4,8593);
   _QuadJet_TripleTag_ideal_BvL_ref__147->SetBinContent(5,6692);
   _QuadJet_TripleTag_ideal_BvL_ref__147->SetBinContent(6,5983);
   _QuadJet_TripleTag_ideal_BvL_ref__147->SetBinContent(7,5525);
   _QuadJet_TripleTag_ideal_BvL_ref__147->SetBinContent(8,5961);
   _QuadJet_TripleTag_ideal_BvL_ref__147->SetBinContent(9,7774);
   _QuadJet_TripleTag_ideal_BvL_ref__147->SetBinContent(10,52151);
   _QuadJet_TripleTag_ideal_BvL_ref__147->SetEntries(198600);
