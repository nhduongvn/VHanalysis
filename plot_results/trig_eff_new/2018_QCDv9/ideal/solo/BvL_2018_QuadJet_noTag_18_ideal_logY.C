...
//=========  (Thu Apr 27 10:18:11 2023) by ROOT version 6.26/06
   ...
   BvL_2018_QuadJet_noTag_18_ideal->Range(-0.2,0.8065651,1.133333,3.154841);
   ...
   _QuadJet_noTag_ideal_BvL__149->SetBinContent(1,439);
   _QuadJet_noTag_ideal_BvL__149->SetBinContent(2,67);
   _QuadJet_noTag_ideal_BvL__149->SetBinContent(3,37);
   _QuadJet_noTag_ideal_BvL__149->SetBinContent(4,37);
   _QuadJet_noTag_ideal_BvL__149->SetBinContent(5,49);
   _QuadJet_noTag_ideal_BvL__149->SetBinContent(6,31);
   _QuadJet_noTag_ideal_BvL__149->SetBinContent(7,22);
   _QuadJet_noTag_ideal_BvL__149->SetBinContent(8,26);
   _QuadJet_noTag_ideal_BvL__149->SetBinContent(9,38);
   _QuadJet_noTag_ideal_BvL__149->SetBinContent(10,238);
   _QuadJet_noTag_ideal_BvL__149->SetEntries(984);
   ...
   ptstats_LaTex = ptstats->AddText("Std Dev   = 0.4016");
