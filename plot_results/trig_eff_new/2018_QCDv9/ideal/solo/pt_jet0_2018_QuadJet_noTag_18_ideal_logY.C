...
//=========  (Thu Apr 27 10:18:10 2023) by ROOT version 6.26/06
   ...
   _QuadJet_noTag_ideal_pt_jet0__113->SetBinContent(10,3);
   _QuadJet_noTag_ideal_pt_jet0__113->SetBinContent(11,8);
   _QuadJet_noTag_ideal_pt_jet0__113->SetBinContent(12,5);
   _QuadJet_noTag_ideal_pt_jet0__113->SetBinContent(13,17);
   _QuadJet_noTag_ideal_pt_jet0__113->SetBinContent(14,16);
   _QuadJet_noTag_ideal_pt_jet0__113->SetBinContent(15,18);
   ...
   _QuadJet_noTag_ideal_pt_jet0__113->SetEntries(246);
   ...
   ptstats_LaTex = ptstats->AddText("Mean  =    210");
   ptstats_LaTex = ptstats->AddText("Std Dev   =  87.11");
