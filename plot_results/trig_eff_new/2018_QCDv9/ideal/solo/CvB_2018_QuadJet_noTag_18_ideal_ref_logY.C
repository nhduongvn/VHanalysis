...
//=========  (Wed Apr 26 16:41:58 2023) by ROOT version 6.26/06
   ...
   CvB_2018_QuadJet_noTag_18_ideal_ref->Range(-0.2,3.299683,1.133333,5.104362);
   ...
   _QuadJet_noTag_ideal_CvB_ref__162->SetBinContent(1,44294);
   _QuadJet_noTag_ideal_CvB_ref__162->SetBinContent(2,7296);
   _QuadJet_noTag_ideal_CvB_ref__162->SetBinContent(3,6042);
   _QuadJet_noTag_ideal_CvB_ref__162->SetBinContent(4,7072);
   _QuadJet_noTag_ideal_CvB_ref__162->SetBinContent(5,8564);
   _QuadJet_noTag_ideal_CvB_ref__162->SetBinContent(6,9905);
   _QuadJet_noTag_ideal_CvB_ref__162->SetBinContent(7,14329);
   _QuadJet_noTag_ideal_CvB_ref__162->SetBinContent(8,19964);
   _QuadJet_noTag_ideal_CvB_ref__162->SetBinContent(9,29217);
   _QuadJet_noTag_ideal_CvB_ref__162->SetBinContent(10,18525);
   _QuadJet_noTag_ideal_CvB_ref__162->SetEntries(165208);
