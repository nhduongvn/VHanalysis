...
//=========  (Tue Apr 18 16:14:01 2023) by ROOT version 6.26/06
   ...
   BvL_2018_QuadJet_TripleTag_18->Range(-0.2183529,-0.1615385,1.171633,1.184615);
   ...
   TH1D *_QuadJet_TripleTag_BvL__163 = new TH1D("_QuadJet_TripleTag_BvL__163","",10,0,1);
   ...
   ptstats->SetOptFit(0);
   ptstats->Draw();
   _QuadJet_TripleTag_BvL__163->GetListOfFunctions()->Add(ptstats);
   ptstats->SetParent(_QuadJet_TripleTag_BvL__163);

   Int_t ci;      // for color index setting
   TColor *color; // for color definition with alpha
   ci = TColor::GetColor("#000099");
   _QuadJet_TripleTag_BvL__163->SetLineColor(ci);
   _QuadJet_TripleTag_BvL__163->GetXaxis()->SetTitle("BvL tagging score");
   _QuadJet_TripleTag_BvL__163->GetXaxis()->SetRange(1,100);
   _QuadJet_TripleTag_BvL__163->GetXaxis()->SetLabelFont(42);
   _QuadJet_TripleTag_BvL__163->GetXaxis()->SetTitleOffset(1);
   _QuadJet_TripleTag_BvL__163->GetXaxis()->SetTitleFont(42);
   _QuadJet_TripleTag_BvL__163->GetYaxis()->SetTitle("Efficiency");
   _QuadJet_TripleTag_BvL__163->GetYaxis()->SetLabelFont(42);
   _QuadJet_TripleTag_BvL__163->GetYaxis()->SetTitleFont(42);
   _QuadJet_TripleTag_BvL__163->GetZaxis()->SetLabelFont(42);
   _QuadJet_TripleTag_BvL__163->GetZaxis()->SetTitleOffset(1);
   _QuadJet_TripleTag_BvL__163->GetZaxis()->SetTitleFont(42);
   _QuadJet_TripleTag_BvL__163->Draw("HIST");
