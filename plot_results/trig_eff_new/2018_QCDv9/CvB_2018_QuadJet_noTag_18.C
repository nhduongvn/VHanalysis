...
//=========  (Tue Apr 18 16:14:02 2023) by ROOT version 6.26/06
   ...
   CvB_2018_QuadJet_noTag_18->Range(-0.2183529,-0.1615385,1.171633,1.184615);
   ...
   TH1D *_QuadJet_noTag_CvB__214 = new TH1D("_QuadJet_noTag_CvB__214","",10,0,1);
   ...
   ptstats->SetOptFit(0);
   ptstats->Draw();
   _QuadJet_noTag_CvB__214->GetListOfFunctions()->Add(ptstats);
   ptstats->SetParent(_QuadJet_noTag_CvB__214);

   Int_t ci;      // for color index setting
   TColor *color; // for color definition with alpha
   ci = TColor::GetColor("#000099");
   _QuadJet_noTag_CvB__214->SetLineColor(ci);
   _QuadJet_noTag_CvB__214->GetXaxis()->SetTitle("CvB tagging score");
   _QuadJet_noTag_CvB__214->GetXaxis()->SetRange(1,100);
   _QuadJet_noTag_CvB__214->GetXaxis()->SetLabelFont(42);
   _QuadJet_noTag_CvB__214->GetXaxis()->SetTitleOffset(1);
   _QuadJet_noTag_CvB__214->GetXaxis()->SetTitleFont(42);
   _QuadJet_noTag_CvB__214->GetYaxis()->SetTitle("Efficiency");
   _QuadJet_noTag_CvB__214->GetYaxis()->SetLabelFont(42);
   _QuadJet_noTag_CvB__214->GetYaxis()->SetTitleFont(42);
   _QuadJet_noTag_CvB__214->GetZaxis()->SetLabelFont(42);
   _QuadJet_noTag_CvB__214->GetZaxis()->SetTitleOffset(1);
   _QuadJet_noTag_CvB__214->GetZaxis()->SetTitleFont(42);
   _QuadJet_noTag_CvB__214->Draw("HIST");
