...
//=========  (Mon Apr 24 10:45:57 2023) by ROOT version 6.26/06
   ...
   CvL_2018_QuadJet_TripleTag_18->Range(-0.2183529,0.1729655,1.171633,0.3268505);
   ...
   _QuadJet_TripleTag_tagged_CvL__97->SetBinContent(1,0.3057463);
   _QuadJet_TripleTag_tagged_CvL__97->SetBinContent(2,0.1968753);
   _QuadJet_TripleTag_tagged_CvL__97->SetBinContent(3,0.2146987);
   _QuadJet_TripleTag_tagged_CvL__97->SetBinContent(4,0.2181574);
   _QuadJet_TripleTag_tagged_CvL__97->SetBinContent(5,0.232927);
   _QuadJet_TripleTag_tagged_CvL__97->SetBinContent(6,0.2298122);
   _QuadJet_TripleTag_tagged_CvL__97->SetBinContent(7,0.2342027);
   _QuadJet_TripleTag_tagged_CvL__97->SetBinContent(8,0.2342211);
   _QuadJet_TripleTag_tagged_CvL__97->SetBinContent(9,0.2366051);
   _QuadJet_TripleTag_tagged_CvL__97->SetBinContent(10,0.2513424);
   _QuadJet_TripleTag_tagged_CvL__97->SetEntries(2.354588);
   ...
   ptstats_LaTex = ptstats->AddText("Std Dev   = 0.2953");
