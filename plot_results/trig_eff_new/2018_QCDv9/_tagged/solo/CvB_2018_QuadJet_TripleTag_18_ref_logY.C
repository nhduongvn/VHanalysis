...
//=========  (Mon Apr 24 10:45:57 2023) by ROOT version 6.26/06
   ...
   CvB_2018_QuadJet_TripleTag_18_ref->Range(-0.2,3.429829,1.133333,5.225881);
   ...
   _QuadJet_TripleTag_tagged_CvB_ref__105->SetBinContent(1,58712);
   _QuadJet_TripleTag_tagged_CvB_ref__105->SetBinContent(2,9741);
   _QuadJet_TripleTag_tagged_CvB_ref__105->SetBinContent(3,8137);
   _QuadJet_TripleTag_tagged_CvB_ref__105->SetBinContent(4,9452);
   _QuadJet_TripleTag_tagged_CvB_ref__105->SetBinContent(5,11529);
   _QuadJet_TripleTag_tagged_CvB_ref__105->SetBinContent(6,13199);
   _QuadJet_TripleTag_tagged_CvB_ref__105->SetBinContent(7,18780);
   _QuadJet_TripleTag_tagged_CvB_ref__105->SetBinContent(8,25177);
   _QuadJet_TripleTag_tagged_CvB_ref__105->SetBinContent(9,35270);
   _QuadJet_TripleTag_tagged_CvB_ref__105->SetBinContent(10,23239);
   _QuadJet_TripleTag_tagged_CvB_ref__105->SetEntries(213236);
