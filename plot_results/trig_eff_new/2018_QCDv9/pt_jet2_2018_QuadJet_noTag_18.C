...
//=========  (Tue Apr 18 16:14:00 2023) by ROOT version 6.26/06
   ...
   pt_jet2_2018_QuadJet_noTag_18->Range(-109.1764,-0.1615385,585.8166,1.184615);
   ...
   TH1D *_QuadJet_noTag_pt_jet2__70 = new TH1D("_QuadJet_noTag_pt_jet2__70","",50,0,500);
   ...
   ptstats->SetOptFit(0);
   ptstats->Draw();
   _QuadJet_noTag_pt_jet2__70->GetListOfFunctions()->Add(ptstats);
   ptstats->SetParent(_QuadJet_noTag_pt_jet2__70);

   Int_t ci;      // for color index setting
   TColor *color; // for color definition with alpha
   ci = TColor::GetColor("#000099");
   _QuadJet_noTag_pt_jet2__70->SetLineColor(ci);
   _QuadJet_noTag_pt_jet2__70->GetXaxis()->SetTitle("Subsubleading jet p_{T} [GeV]");
   _QuadJet_noTag_pt_jet2__70->GetXaxis()->SetRange(1,500);
   _QuadJet_noTag_pt_jet2__70->GetXaxis()->SetLabelFont(42);
   _QuadJet_noTag_pt_jet2__70->GetXaxis()->SetTitleOffset(1);
   _QuadJet_noTag_pt_jet2__70->GetXaxis()->SetTitleFont(42);
   _QuadJet_noTag_pt_jet2__70->GetYaxis()->SetTitle("Efficiency");
   _QuadJet_noTag_pt_jet2__70->GetYaxis()->SetLabelFont(42);
   _QuadJet_noTag_pt_jet2__70->GetYaxis()->SetTitleFont(42);
   _QuadJet_noTag_pt_jet2__70->GetZaxis()->SetLabelFont(42);
   _QuadJet_noTag_pt_jet2__70->GetZaxis()->SetTitleOffset(1);
   _QuadJet_noTag_pt_jet2__70->GetZaxis()->SetTitleFont(42);
   _QuadJet_noTag_pt_jet2__70->Draw("HIST");
