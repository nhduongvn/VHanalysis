...
//=========  (Mon Apr 24 10:45:56 2023) by ROOT version 6.26/06
   ...
   BvL_2018_QuadJet_TripleTag_18->Range(-0.2183529,0.02607626,1.171633,0.115322);
   ...
   _QuadJet_TripleTag_BvL__37->SetBinContent(1,0.03994274);
   _QuadJet_TripleTag_BvL__37->SetBinContent(2,0.07206649);
   _QuadJet_TripleTag_BvL__37->SetBinContent(3,0.08503412);
   _QuadJet_TripleTag_BvL__37->SetBinContent(4,0.091557);
   _QuadJet_TripleTag_BvL__37->SetBinContent(5,0.0957776);
   _QuadJet_TripleTag_BvL__37->SetBinContent(6,0.09706844);
   _QuadJet_TripleTag_BvL__37->SetBinContent(7,0.1001632);
   _QuadJet_TripleTag_BvL__37->SetBinContent(8,0.09890624);
   _QuadJet_TripleTag_BvL__37->SetBinContent(9,0.09901439);
   _QuadJet_TripleTag_BvL__37->SetBinContent(10,0.1030826);
   _QuadJet_TripleTag_BvL__37->SetEntries(0.8826128);
   ...
   ptstats_LaTex = ptstats->AddText("Mean  = 0.5483");
