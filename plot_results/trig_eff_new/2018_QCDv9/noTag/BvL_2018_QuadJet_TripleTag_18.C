...
//=========  (Tue Apr 25 23:01:40 2023) by ROOT version 6.26/06
   ...
   BvL_2018_QuadJet_TripleTag_18->Range(-0.2183529,0.02609,1.171633,0.1152829);
   ...
   _QuadJet_TripleTag_BvL__37->SetBinContent(1,0.03994827);
   _QuadJet_TripleTag_BvL__37->SetBinContent(2,0.07211173);
   _QuadJet_TripleTag_BvL__37->SetBinContent(3,0.08506631);
   _QuadJet_TripleTag_BvL__37->SetBinContent(4,0.0914932);
   _QuadJet_TripleTag_BvL__37->SetBinContent(5,0.09577139);
   _QuadJet_TripleTag_BvL__37->SetBinContent(6,0.09708196);
   _QuadJet_TripleTag_BvL__37->SetBinContent(7,0.1001239);
   _QuadJet_TripleTag_BvL__37->SetBinContent(8,0.09871855);
   _QuadJet_TripleTag_BvL__37->SetBinContent(9,0.09897259);
   _QuadJet_TripleTag_BvL__37->SetBinContent(10,0.1030507);
   _QuadJet_TripleTag_BvL__37->SetEntries(0.8823386);
   ...
   ptstats_LaTex = ptstats->AddText("Mean  = 0.5482");
