...
//=========  (Mon Apr 24 10:45:56 2023) by ROOT version 6.26/06
   ...
   BvL_2018_QuadJet_TripleTag_18_ref->Range(-0.2,4.143944,1.133333,6.963353);
   ...
   _QuadJet_TripleTag_BvL_ref__39->SetBinContent(1,2534328);
   _QuadJet_TripleTag_BvL_ref__39->SetBinContent(2,179043);
   _QuadJet_TripleTag_BvL_ref__39->SetBinContent(3,93045);
   _QuadJet_TripleTag_BvL_ref__39->SetBinContent(4,67630);
   _QuadJet_TripleTag_BvL_ref__39->SetBinContent(5,56224);
   _QuadJet_TripleTag_BvL_ref__39->SetBinContent(6,53828);
   _QuadJet_TripleTag_BvL_ref__39->SetBinContent(7,53323);
   _QuadJet_TripleTag_BvL_ref__39->SetBinContent(8,61988);
   _QuadJet_TripleTag_BvL_ref__39->SetBinContent(9,81574);
   _QuadJet_TripleTag_BvL_ref__39->SetBinContent(10,545097);
   _QuadJet_TripleTag_BvL_ref__39->SetEntries(3726080);
   ...
   ptstats_LaTex = ptstats->AddText("Mean  = 0.2314");
