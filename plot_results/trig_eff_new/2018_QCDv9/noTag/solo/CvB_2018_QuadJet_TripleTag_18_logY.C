...
//=========  (Thu Apr 27 10:18:10 2023) by ROOT version 6.26/06
   ...
   CvB_2018_QuadJet_TripleTag_18->Range(-0.2,3.385719,1.133333,5.229869);
   ...
   _QuadJet_TripleTag_CvB__50->SetBinContent(1,58601);
   _QuadJet_TripleTag_CvB__50->SetBinContent(2,9154);
   _QuadJet_TripleTag_CvB__50->SetBinContent(3,7839);
   _QuadJet_TripleTag_CvB__50->SetBinContent(4,7433);
   _QuadJet_TripleTag_CvB__50->SetBinContent(5,8486);
   _QuadJet_TripleTag_CvB__50->SetBinContent(6,10376);
   _QuadJet_TripleTag_CvB__50->SetBinContent(7,15285);
   _QuadJet_TripleTag_CvB__50->SetBinContent(8,25665);
   _QuadJet_TripleTag_CvB__50->SetBinContent(9,49040);
   _QuadJet_TripleTag_CvB__50->SetBinContent(10,23489);
   _QuadJet_TripleTag_CvB__50->SetEntries(215368);
