...
//=========  (Tue Apr 25 23:01:40 2023) by ROOT version 6.26/06
   ...
   CvB_2018_QuadJet_TripleTag_18->Range(-0.2,3.383542,1.133333,5.227791);
   ...
   _QuadJet_TripleTag_CvB__50->SetBinContent(1,58320);
   _QuadJet_TripleTag_CvB__50->SetBinContent(2,9079);
   _QuadJet_TripleTag_CvB__50->SetBinContent(3,7794);
   _QuadJet_TripleTag_CvB__50->SetBinContent(4,7396);
   _QuadJet_TripleTag_CvB__50->SetBinContent(5,8425);
   _QuadJet_TripleTag_CvB__50->SetBinContent(6,10327);
   _QuadJet_TripleTag_CvB__50->SetBinContent(7,15233);
   _QuadJet_TripleTag_CvB__50->SetBinContent(8,25538);
   _QuadJet_TripleTag_CvB__50->SetBinContent(9,48804);
   _QuadJet_TripleTag_CvB__50->SetBinContent(10,23384);
   _QuadJet_TripleTag_CvB__50->SetEntries(214300);
   ...
   ptstats_LaTex = ptstats->AddText("Mean  = 0.5085");
