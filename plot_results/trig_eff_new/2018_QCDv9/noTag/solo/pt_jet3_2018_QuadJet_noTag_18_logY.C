...
//=========  (Wed Apr 26 16:41:56 2023) by ROOT version 6.26/06
   ...
   pt_jet3_2018_QuadJet_noTag_18->Range(-100,-0.747697,566.6667,3.718973);
   ...
   _QuadJet_noTag_pt_jet3__23->SetBinContent(6,988);
   _QuadJet_noTag_pt_jet3__23->SetBinContent(7,842);
   _QuadJet_noTag_pt_jet3__23->SetBinContent(8,540);
   _QuadJet_noTag_pt_jet3__23->SetBinContent(9,283);
   _QuadJet_noTag_pt_jet3__23->SetBinContent(10,184);
   _QuadJet_noTag_pt_jet3__23->SetBinContent(11,114);
   _QuadJet_noTag_pt_jet3__23->SetBinContent(12,63);
   _QuadJet_noTag_pt_jet3__23->SetBinContent(13,42);
   _QuadJet_noTag_pt_jet3__23->SetBinContent(14,28);
   ...
   _QuadJet_noTag_pt_jet3__23->SetEntries(3602);
   ...
   ptstats_LaTex = ptstats->AddText("Mean  =  69.44");
   ptstats_LaTex = ptstats->AddText("Std Dev   =  22.82");
