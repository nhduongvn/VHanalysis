...
//=========  (Mon Apr 24 10:45:55 2023) by ROOT version 6.26/06
   ...
   pt_jet3_2018_QuadJet_noTag_18->Range(-100,-0.7472002,566.6667,3.714502);
   ...
   _QuadJet_noTag_pt_jet3__23->SetBinContent(6,979);
   _QuadJet_noTag_pt_jet3__23->SetBinContent(7,836);
   _QuadJet_noTag_pt_jet3__23->SetBinContent(8,540);
   _QuadJet_noTag_pt_jet3__23->SetBinContent(9,286);
   _QuadJet_noTag_pt_jet3__23->SetBinContent(10,182);
   ...
   _QuadJet_noTag_pt_jet3__23->SetEntries(3595);
   ...
   ptstats_LaTex = ptstats->AddText("Mean  =  69.52");
