...
//=========  (Tue Apr 18 16:14:00 2023) by ROOT version 6.26/06
   ...
   TH1D *_QuadJet_TripleTag_pt_jet3__91 = new TH1D("_QuadJet_TripleTag_pt_jet3__91","",50,0,500);
   ...
   ptstats->SetOptFit(0);
   ptstats->Draw();
   _QuadJet_TripleTag_pt_jet3__91->GetListOfFunctions()->Add(ptstats);
   ptstats->SetParent(_QuadJet_TripleTag_pt_jet3__91);

   Int_t ci;      // for color index setting
   TColor *color; // for color definition with alpha
   ci = TColor::GetColor("#000099");
   _QuadJet_TripleTag_pt_jet3__91->SetLineColor(ci);
   _QuadJet_TripleTag_pt_jet3__91->GetXaxis()->SetTitle("Sub^{(3)}leading jet p_{T} [GeV]");
   _QuadJet_TripleTag_pt_jet3__91->GetXaxis()->SetRange(1,500);
   _QuadJet_TripleTag_pt_jet3__91->GetXaxis()->SetLabelFont(42);
   _QuadJet_TripleTag_pt_jet3__91->GetXaxis()->SetTitleOffset(1);
   _QuadJet_TripleTag_pt_jet3__91->GetXaxis()->SetTitleFont(42);
   _QuadJet_TripleTag_pt_jet3__91->GetYaxis()->SetTitle("Efficiency");
   _QuadJet_TripleTag_pt_jet3__91->GetYaxis()->SetLabelFont(42);
   _QuadJet_TripleTag_pt_jet3__91->GetYaxis()->SetTitleFont(42);
   _QuadJet_TripleTag_pt_jet3__91->GetZaxis()->SetLabelFont(42);
   _QuadJet_TripleTag_pt_jet3__91->GetZaxis()->SetTitleOffset(1);
   _QuadJet_TripleTag_pt_jet3__91->GetZaxis()->SetTitleFont(42);
   _QuadJet_TripleTag_pt_jet3__91->Draw("HIST");
