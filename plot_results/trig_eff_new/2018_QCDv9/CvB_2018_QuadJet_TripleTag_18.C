...
//=========  (Tue Apr 18 16:14:02 2023) by ROOT version 6.26/06
   ...
   CvB_2018_QuadJet_TripleTag_18->Range(-0.2183529,-0.1615385,1.171633,1.184615);
   ...
   TH1D *_QuadJet_TripleTag_CvB__211 = new TH1D("_QuadJet_TripleTag_CvB__211","",10,0,1);
   ...
   ptstats->SetOptFit(0);
   ptstats->Draw();
   _QuadJet_TripleTag_CvB__211->GetListOfFunctions()->Add(ptstats);
   ptstats->SetParent(_QuadJet_TripleTag_CvB__211);

   Int_t ci;      // for color index setting
   TColor *color; // for color definition with alpha
   ci = TColor::GetColor("#000099");
   _QuadJet_TripleTag_CvB__211->SetLineColor(ci);
   _QuadJet_TripleTag_CvB__211->GetXaxis()->SetTitle("CvB tagging score");
   _QuadJet_TripleTag_CvB__211->GetXaxis()->SetRange(1,100);
   _QuadJet_TripleTag_CvB__211->GetXaxis()->SetLabelFont(42);
   _QuadJet_TripleTag_CvB__211->GetXaxis()->SetTitleOffset(1);
   _QuadJet_TripleTag_CvB__211->GetXaxis()->SetTitleFont(42);
   _QuadJet_TripleTag_CvB__211->GetYaxis()->SetTitle("Efficiency");
   _QuadJet_TripleTag_CvB__211->GetYaxis()->SetLabelFont(42);
   _QuadJet_TripleTag_CvB__211->GetYaxis()->SetTitleFont(42);
   _QuadJet_TripleTag_CvB__211->GetZaxis()->SetLabelFont(42);
   _QuadJet_TripleTag_CvB__211->GetZaxis()->SetTitleOffset(1);
   _QuadJet_TripleTag_CvB__211->GetZaxis()->SetTitleFont(42);
   _QuadJet_TripleTag_CvB__211->Draw("HIST");
