...
//=========  (Tue Apr 18 16:14:00 2023) by ROOT version 6.26/06
   ...
   pt_jet0_2018_QuadJet_noTag_18->Range(-109.1764,-0.1615385,585.8166,1.184615);
   ...
   TH1D *_QuadJet_noTag_pt_jet0__22 = new TH1D("_QuadJet_noTag_pt_jet0__22","",50,0,500);
   ...
   ptstats->SetOptFit(0);
   ptstats->Draw();
   _QuadJet_noTag_pt_jet0__22->GetListOfFunctions()->Add(ptstats);
   ptstats->SetParent(_QuadJet_noTag_pt_jet0__22);

   Int_t ci;      // for color index setting
   TColor *color; // for color definition with alpha
   ci = TColor::GetColor("#000099");
   _QuadJet_noTag_pt_jet0__22->SetLineColor(ci);
   _QuadJet_noTag_pt_jet0__22->GetXaxis()->SetTitle("Leading jet p_{T} [GeV]");
   _QuadJet_noTag_pt_jet0__22->GetXaxis()->SetRange(1,500);
   _QuadJet_noTag_pt_jet0__22->GetXaxis()->SetLabelFont(42);
   _QuadJet_noTag_pt_jet0__22->GetXaxis()->SetTitleOffset(1);
   _QuadJet_noTag_pt_jet0__22->GetXaxis()->SetTitleFont(42);
   _QuadJet_noTag_pt_jet0__22->GetYaxis()->SetTitle("Efficiency");
   _QuadJet_noTag_pt_jet0__22->GetYaxis()->SetLabelFont(42);
   _QuadJet_noTag_pt_jet0__22->GetYaxis()->SetTitleFont(42);
   _QuadJet_noTag_pt_jet0__22->GetZaxis()->SetLabelFont(42);
   _QuadJet_noTag_pt_jet0__22->GetZaxis()->SetTitleOffset(1);
   _QuadJet_noTag_pt_jet0__22->GetZaxis()->SetTitleFont(42);
   _QuadJet_noTag_pt_jet0__22->Draw("HIST");
