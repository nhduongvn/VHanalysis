...
//=========  (Wed Apr 26 16:41:58 2023) by ROOT version 6.26/06
   ...
   CvL_2018_QuadJet_noTag_18_tagged->Range(-0.2,1.073769,1.133333,2.888805);
   ...
   _QuadJet_noTag_tagged_CvL__101->SetBinContent(2,269);
   _QuadJet_noTag_tagged_CvL__101->SetBinContent(3,69);
   _QuadJet_noTag_tagged_CvL__101->SetBinContent(4,56);
   ...
   ptstats_LaTex = ptstats->AddText("Mean  = 0.4551");
