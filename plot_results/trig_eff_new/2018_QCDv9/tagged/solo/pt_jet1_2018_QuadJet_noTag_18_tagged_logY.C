...
//=========  (Thu Apr 27 10:18:10 2023) by ROOT version 6.26/06
   ...
   _QuadJet_noTag_tagged_pt_jet1__65->SetEntries(253);
   ...
   ptstats_LaTex = ptstats->AddText("Mean  =    144");
   ptstats_LaTex = ptstats->AddText("Std Dev   =  62.45");
