...
//=========  (Wed Apr 26 16:41:57 2023) by ROOT version 6.26/06
   ...
   BvL_2018_QuadJet_TripleTag_18_tagged->Range(-0.2,2.62428,1.133333,4.80445);
   ...
   _QuadJet_TripleTag_tagged_BvL__92->SetBinContent(1,20365);
   _QuadJet_TripleTag_tagged_BvL__92->SetBinContent(2,3895);
   _QuadJet_TripleTag_tagged_BvL__92->SetBinContent(3,2292);
   _QuadJet_TripleTag_tagged_BvL__92->SetBinContent(4,2275);
   _QuadJet_TripleTag_tagged_BvL__92->SetBinContent(5,1813);
   _QuadJet_TripleTag_tagged_BvL__92->SetBinContent(6,1642);
   _QuadJet_TripleTag_tagged_BvL__92->SetBinContent(7,1391);
   _QuadJet_TripleTag_tagged_BvL__92->SetBinContent(8,1413);
   _QuadJet_TripleTag_tagged_BvL__92->SetBinContent(9,1955);
   _QuadJet_TripleTag_tagged_BvL__92->SetBinContent(10,13155);
   _QuadJet_TripleTag_tagged_BvL__92->SetEntries(50196);
   ...
   ptstats_LaTex = ptstats->AddText("Mean  = 0.4153");
