...
//=========  (Thu Apr 27 10:18:10 2023) by ROOT version 6.26/06
   ...
   CvL_2018_QuadJet_TripleTag_18_tagged->Range(-0.2183529,0.1736818,1.171633,0.3259464);
   ...
   _QuadJet_TripleTag_tagged_CvL__97->SetBinContent(1,0.3050644);
   _QuadJet_TripleTag_tagged_CvL__97->SetBinContent(2,0.1973398);
   _QuadJet_TripleTag_tagged_CvL__97->SetBinContent(3,0.214997);
   _QuadJet_TripleTag_tagged_CvL__97->SetBinContent(4,0.2179352);
   _QuadJet_TripleTag_tagged_CvL__97->SetBinContent(5,0.2317834);
   _QuadJet_TripleTag_tagged_CvL__97->SetBinContent(6,0.2313566);
   _QuadJet_TripleTag_tagged_CvL__97->SetBinContent(7,0.2342065);
   _QuadJet_TripleTag_tagged_CvL__97->SetBinContent(8,0.2339854);
   _QuadJet_TripleTag_tagged_CvL__97->SetBinContent(9,0.2374436);
   _QuadJet_TripleTag_tagged_CvL__97->SetBinContent(10,0.2519668);
   _QuadJet_TripleTag_tagged_CvL__97->SetEntries(2.356079);
   ...
   ptstats_LaTex = ptstats->AddText("Mean  = 0.4989");
