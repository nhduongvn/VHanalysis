...
//=========  (Tue Apr 25 23:02:19 2023) by ROOT version 6.26/06
   ...
   pt_jet3_2017_QuadJet_noTag_17_ideal->Range(-100,-0.578784,566.6667,2.198756);
   ...
   _QuadJet_noTag_ideal_pt_jet3__131->SetBinContent(5,10);
   _QuadJet_noTag_ideal_pt_jet3__131->SetBinContent(6,29);
   _QuadJet_noTag_ideal_pt_jet3__131->SetBinContent(7,44);
   _QuadJet_noTag_ideal_pt_jet3__131->SetBinContent(8,17);
   ...
   ptstats_LaTex = ptstats->AddText("Mean  =  73.51");
   ptstats_LaTex = ptstats->AddText("Std Dev   =   23.3");
