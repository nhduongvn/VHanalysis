...
//=========  (Wed Apr 26 16:41:51 2023) by ROOT version 6.26/06
   ...
   _QuadJet_noTag_ideal_HTmod__143->SetBinContent(41,1);
   _QuadJet_noTag_ideal_HTmod__143->SetBinContent(42,2);
   _QuadJet_noTag_ideal_HTmod__143->SetBinContent(44,1);
   ...
   _QuadJet_noTag_ideal_HTmod__143->SetBinContent(53,4);
   ...
   _QuadJet_noTag_ideal_HTmod__143->SetBinContent(61,4);
   ...
   _QuadJet_noTag_ideal_HTmod__143->SetBinContent(73,5);
   ...
   _QuadJet_noTag_ideal_HTmod__143->SetEntries(135);
   ...
   ptstats_LaTex = ptstats->AddText("Mean  =  650.6");
   ptstats_LaTex = ptstats->AddText("Std Dev   =  172.2");
