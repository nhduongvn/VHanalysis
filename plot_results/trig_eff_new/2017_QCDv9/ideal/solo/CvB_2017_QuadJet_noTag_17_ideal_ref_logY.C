...
//=========  (Tue Apr 25 23:02:19 2023) by ROOT version 6.26/06
   ...
   CvB_2017_QuadJet_noTag_17_ideal_ref->Range(-0.2,3.121617,1.133333,4.940651);
   ...
   _QuadJet_noTag_ideal_CvB_ref__162->SetBinContent(1,30283);
   _QuadJet_noTag_ideal_CvB_ref__162->SetBinContent(2,5057);
   _QuadJet_noTag_ideal_CvB_ref__162->SetBinContent(3,4023);
   _QuadJet_noTag_ideal_CvB_ref__162->SetBinContent(4,4788);
   _QuadJet_noTag_ideal_CvB_ref__162->SetBinContent(5,5588);
   _QuadJet_noTag_ideal_CvB_ref__162->SetBinContent(6,6656);
   _QuadJet_noTag_ideal_CvB_ref__162->SetBinContent(7,9456);
   _QuadJet_noTag_ideal_CvB_ref__162->SetBinContent(8,13060);
   _QuadJet_noTag_ideal_CvB_ref__162->SetBinContent(9,18515);
   _QuadJet_noTag_ideal_CvB_ref__162->SetBinContent(10,12234);
   _QuadJet_noTag_ideal_CvB_ref__162->SetEntries(109660);
