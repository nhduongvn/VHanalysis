...
//=========  (Tue Apr 25 23:02:19 2023) by ROOT version 6.26/06
   ...
   CvB_2017_QuadJet_noTag_17_ideal->Range(-0.2,0.7414857,1.133333,2.620818);
   ...
   _QuadJet_noTag_ideal_CvB__161->SetBinContent(1,143);
   _QuadJet_noTag_ideal_CvB__161->SetBinContent(2,24);
   _QuadJet_noTag_ideal_CvB__161->SetBinContent(3,17);
   _QuadJet_noTag_ideal_CvB__161->SetBinContent(4,30);
   _QuadJet_noTag_ideal_CvB__161->SetBinContent(5,31);
   _QuadJet_noTag_ideal_CvB__161->SetBinContent(6,29);
   _QuadJet_noTag_ideal_CvB__161->SetBinContent(7,50);
   _QuadJet_noTag_ideal_CvB__161->SetBinContent(8,73);
   _QuadJet_noTag_ideal_CvB__161->SetBinContent(9,91);
   _QuadJet_noTag_ideal_CvB__161->SetBinContent(10,84);
   _QuadJet_noTag_ideal_CvB__161->SetEntries(572);
   ...
   ptstats_LaTex = ptstats->AddText("Mean  = 0.5139");
   ptstats_LaTex = ptstats->AddText("Std Dev   = 0.3528");
