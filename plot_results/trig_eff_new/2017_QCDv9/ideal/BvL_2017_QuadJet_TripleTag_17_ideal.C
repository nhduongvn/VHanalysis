...
//=========  (Thu Apr 27 10:18:24 2023) by ROOT version 6.26/06
   ...
   BvL_2017_QuadJet_TripleTag_17_ideal->Range(-0.2183529,0.161024,1.171633,0.2318035);
   ...
   _QuadJet_TripleTag_ideal_BvL__145->SetBinContent(1,0.1720213);
   _QuadJet_TripleTag_ideal_BvL__145->SetBinContent(2,0.2130487);
   _QuadJet_TripleTag_ideal_BvL__145->SetBinContent(3,0.2220966);
   _QuadJet_TripleTag_ideal_BvL__145->SetBinContent(4,0.1992453);
   _QuadJet_TripleTag_ideal_BvL__145->SetBinContent(5,0.1947484);
   _QuadJet_TripleTag_ideal_BvL__145->SetBinContent(6,0.207204);
   _QuadJet_TripleTag_ideal_BvL__145->SetBinContent(7,0.1851707);
   _QuadJet_TripleTag_ideal_BvL__145->SetBinContent(8,0.1774252);
   _QuadJet_TripleTag_ideal_BvL__145->SetBinContent(9,0.1752791);
   _QuadJet_TripleTag_ideal_BvL__145->SetBinContent(10,0.1986999);
   _QuadJet_TripleTag_ideal_BvL__145->SetEntries(1.944939);
   ...
   ptstats_LaTex = ptstats->AddText("Mean  = 0.4929");
