...
//=========  (Tue Apr 25 23:02:17 2023) by ROOT version 6.26/06
   ...
   CvL_2017_QuadJet_TripleTag_17->Range(-0.2,2.865003,1.133333,4.920888);
   ...
   _QuadJet_TripleTag_CvL__44->SetBinContent(1,27400);
   _QuadJet_TripleTag_CvL__44->SetBinContent(2,10890);
   _QuadJet_TripleTag_CvL__44->SetBinContent(3,4135);
   _QuadJet_TripleTag_CvL__44->SetBinContent(4,2727);
   _QuadJet_TripleTag_CvL__44->SetBinContent(5,2353);
   _QuadJet_TripleTag_CvL__44->SetBinContent(6,2635);
   _QuadJet_TripleTag_CvL__44->SetBinContent(7,3279);
   _QuadJet_TripleTag_CvL__44->SetBinContent(8,4788);
   _QuadJet_TripleTag_CvL__44->SetBinContent(9,8176);
   _QuadJet_TripleTag_CvL__44->SetBinContent(10,21017);
   _QuadJet_TripleTag_CvL__44->SetEntries(87400);
   ...
   ptstats_LaTex = ptstats->AddText("Mean  = 0.4648");
