...
//=========  (Tue Apr 25 23:02:18 2023) by ROOT version 6.26/06
   ...
   CvB_2017_QuadJet_TripleTag_17_ref->Range(-0.2,4.141055,1.133333,6.356181);
   ...
   _QuadJet_TripleTag_CvB_ref__51->SetBinContent(1,326375);
   _QuadJet_TripleTag_CvB_ref__51->SetBinContent(2,53591);
   _QuadJet_TripleTag_CvB_ref__51->SetBinContent(3,46449);
   _QuadJet_TripleTag_CvB_ref__51->SetBinContent(4,46089);
   _QuadJet_TripleTag_CvB_ref__51->SetBinContent(5,57135);
   _QuadJet_TripleTag_CvB_ref__51->SetBinContent(6,80589);
   _QuadJet_TripleTag_CvB_ref__51->SetBinContent(7,138761);
   _QuadJet_TripleTag_CvB_ref__51->SetBinContent(8,294482);
   _QuadJet_TripleTag_CvB_ref__51->SetBinContent(9,719647);
   _QuadJet_TripleTag_CvB_ref__51->SetBinContent(10,356578);
   _QuadJet_TripleTag_CvB_ref__51->SetEntries(2119696);
