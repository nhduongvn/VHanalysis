...
//=========  (Tue Apr 25 23:02:18 2023) by ROOT version 6.26/06
   ...
   pt_jet3_2017_QuadJet_noTag_17_tagged->Range(-100,-0.578784,566.6667,2.198756);
   ...
   _QuadJet_noTag_tagged_pt_jet3__77->SetBinContent(6,30);
   _QuadJet_noTag_tagged_pt_jet3__77->SetBinContent(7,44);
   _QuadJet_noTag_tagged_pt_jet3__77->SetBinContent(8,17);
   ...
   ptstats_LaTex = ptstats->AddText("Std Dev   =  23.29");
