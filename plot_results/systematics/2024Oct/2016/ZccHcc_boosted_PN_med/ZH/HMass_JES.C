...
// ------------>Primitives in pad: pad1_v1
   ...
   pad1_v1__8->Draw();
   pad1_v1__8->cd();
   pad1_v1__8->Range(-37.5,-3.00606,337.5,27.05454);
   ...
   ZccHcc_boosted_PN_med_HMass__21->SetMaximum(24.04848);
   ...
   ZccHcc_boosted_PN_med_HMass__21->GetXaxis()->SetTitle("M_{H} [GeV]");
   ZccHcc_boosted_PN_med_HMass__21->GetXaxis()->SetRange(1,30);
   ZccHcc_boosted_PN_med_HMass__21->GetXaxis()->SetLabelFont(42);
   ZccHcc_boosted_PN_med_HMass__21->GetXaxis()->SetTitleOffset(1.15);
   ZccHcc_boosted_PN_med_HMass__21->GetXaxis()->SetTitleFont(42);
   ZccHcc_boosted_PN_med_HMass__21->GetYaxis()->SetTitle("Events/10.0 GeV");
   ...
   ZccHcc_boosted_PN_med_HMass__22->SetBinContent(12,10.98423);
   ZccHcc_boosted_PN_med_HMass__22->SetBinContent(13,21.16408);
   ZccHcc_boosted_PN_med_HMass__22->SetBinContent(14,22.04848);
   ZccHcc_boosted_PN_med_HMass__22->SetBinContent(15,2.917014);
   ZccHcc_boosted_PN_med_HMass__22->SetBinContent(17,1.08031);
   ZccHcc_boosted_PN_med_HMass__22->SetBinError(10,1.981682);
   ZccHcc_boosted_PN_med_HMass__22->SetBinError(11,1.468997);
   ZccHcc_boosted_PN_med_HMass__22->SetBinError(12,3.904602);
   ZccHcc_boosted_PN_med_HMass__22->SetBinError(13,5.687424);
   ZccHcc_boosted_PN_med_HMass__22->SetBinError(14,5.469172);
   ZccHcc_boosted_PN_med_HMass__22->SetBinError(15,2.062644);
   ZccHcc_boosted_PN_med_HMass__22->SetBinError(17,1.08031);
   ZccHcc_boosted_PN_med_HMass__22->SetEntries(50);
   ...
   TH1D *ZccHcc_boosted_PN_med_HMass__23 = new TH1D("ZccHcc_boosted_PN_med_HMass__23","",30,0,300);
   ZccHcc_boosted_PN_med_HMass__23->SetBinContent(10,2.80211);
   ZccHcc_boosted_PN_med_HMass__23->SetBinContent(11,1.468997);
   ZccHcc_boosted_PN_med_HMass__23->SetBinContent(12,9.795003);
   ZccHcc_boosted_PN_med_HMass__23->SetBinContent(13,21.16408);
   ZccHcc_boosted_PN_med_HMass__23->SetBinContent(14,20.82849);
   ZccHcc_boosted_PN_med_HMass__23->SetBinContent(15,2.917014);
   ZccHcc_boosted_PN_med_HMass__23->SetBinContent(17,1.205237);
   ZccHcc_boosted_PN_med_HMass__23->SetBinError(10,1.981682);
   ZccHcc_boosted_PN_med_HMass__23->SetBinError(11,1.468997);
   ZccHcc_boosted_PN_med_HMass__23->SetBinError(12,3.73073);
   ZccHcc_boosted_PN_med_HMass__23->SetBinError(13,5.687424);
   ZccHcc_boosted_PN_med_HMass__23->SetBinError(14,5.323644);
   ZccHcc_boosted_PN_med_HMass__23->SetBinError(15,2.062644);
   ZccHcc_boosted_PN_med_HMass__23->SetBinError(17,1.205237);
   ZccHcc_boosted_PN_med_HMass__23->SetEntries(48);

   ci = TColor::GetColor("#ff0000");
   ZccHcc_boosted_PN_med_HMass__23->SetLineColor(ci);
   ZccHcc_boosted_PN_med_HMass__23->SetLineWidth(2);
   ZccHcc_boosted_PN_med_HMass__23->GetXaxis()->SetRange(1,300);
...
// ------------>Primitives in pad: pad1_v2
   ...
   TH1D *ZccHcc_boosted_PN_med_HMass__25 = new TH1D("ZccHcc_boosted_PN_med_HMass__25","",30,0,300);
   ZccHcc_boosted_PN_med_HMass__25->SetBinContent(10,1);
   ZccHcc_boosted_PN_med_HMass__25->SetBinContent(11,1);
   ZccHcc_boosted_PN_med_HMass__25->SetBinContent(12,0.8804802);
   ZccHcc_boosted_PN_med_HMass__25->SetBinContent(13,1);
   ZccHcc_boosted_PN_med_HMass__25->SetBinContent(14,1.004113);
   ZccHcc_boosted_PN_med_HMass__25->SetBinContent(15,1);
   ZccHcc_boosted_PN_med_HMass__25->SetBinContent(17,1);
   ZccHcc_boosted_PN_med_HMass__25->SetBinError(10,1.000147);
   ZccHcc_boosted_PN_med_HMass__25->SetBinError(11,1.414214);
   ZccHcc_boosted_PN_med_HMass__25->SetBinError(12,0.4590506);
   ZccHcc_boosted_PN_med_HMass__25->SetBinError(13,0.3800416);
   ZccHcc_boosted_PN_med_HMass__25->SetBinError(14,0.3632697);
   ZccHcc_boosted_PN_med_HMass__25->SetBinError(15,1.000002);
   ZccHcc_boosted_PN_med_HMass__25->SetBinError(17,1.414214);
   ZccHcc_boosted_PN_med_HMass__25->SetEntries(7.306082);

   ci = TColor::GetColor("#ff0000");
   ZccHcc_boosted_PN_med_HMass__25->SetLineColor(ci);
   ZccHcc_boosted_PN_med_HMass__25->SetLineWidth(2);
   ZccHcc_boosted_PN_med_HMass__25->GetXaxis()->SetTitle("M_{H} [GeV]");
   ZccHcc_boosted_PN_med_HMass__25->GetXaxis()->SetRange(1,300);
   ZccHcc_boosted_PN_med_HMass__25->GetXaxis()->SetLabelFont(42);
   ZccHcc_boosted_PN_med_HMass__25->GetXaxis()->SetTitleSize(0.13);
