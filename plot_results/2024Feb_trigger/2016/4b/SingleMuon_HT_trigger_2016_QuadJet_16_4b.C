...
#endif
void SingleMuon_HT_trigger_2016_QuadJet_16_4b()
{
//=========Macro generated from canvas: SingleMuon_HT_trigger_2016_QuadJet_16_4b/SingleMuon_HT_trigger_2016_QuadJet_16_4b
//=========  (Sat Feb 10 18:21:36 2024) by ROOT version 6.28/10
   TCanvas *SingleMuon_HT_trigger_2016_QuadJet_16_4b = new TCanvas("SingleMuon_HT_trigger_2016_QuadJet_16_4b", "SingleMuon_HT_trigger_2016_QuadJet_16_4b",0,0,600,600);
   gStyle->SetOptStat(0);
   SingleMuon_HT_trigger_2016_QuadJet_16_4b->SetHighLightColor(2);
   SingleMuon_HT_trigger_2016_QuadJet_16_4b->Range(-400,-4.33125,2266.667,38.98125);
   SingleMuon_HT_trigger_2016_QuadJet_16_4b->SetFillColor(0);
   SingleMuon_HT_trigger_2016_QuadJet_16_4b->SetBorderMode(0);
   SingleMuon_HT_trigger_2016_QuadJet_16_4b->SetBorderSize(2);
   SingleMuon_HT_trigger_2016_QuadJet_16_4b->SetLeftMargin(0.15);
   SingleMuon_HT_trigger_2016_QuadJet_16_4b->SetFrameBorderMode(0);
   SingleMuon_HT_trigger_2016_QuadJet_16_4b->SetFrameBorderMode(0);
   ...
   tex->SetLineWidth(2);
   tex->Draw();
   SingleMuon_HT_trigger_2016_QuadJet_16_4b->Modified();
   SingleMuon_HT_trigger_2016_QuadJet_16_4b->cd();
   SingleMuon_HT_trigger_2016_QuadJet_16_4b->SetSelected(SingleMuon_HT_trigger_2016_QuadJet_16_4b);
}
