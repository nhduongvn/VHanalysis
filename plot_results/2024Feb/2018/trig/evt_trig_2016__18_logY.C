...
// ------------>Primitives in pad: topPad
   ...
   topPad->Draw();
   topPad->cd();
   topPad->Range(-0.6129016,-3.009486,4.209678,18.2432);
   ...
   st->SetTitle("");
   st->SetMinimum(0.01);
   st->SetMaximum(2.920037e+15);
   
   TH1F *st_stack_3 = new TH1F("st_stack_3","",4,0,4);
   st_stack_3->SetMinimum(0.001027465);
   st_stack_3->SetMaximum(1.311995e+16);
