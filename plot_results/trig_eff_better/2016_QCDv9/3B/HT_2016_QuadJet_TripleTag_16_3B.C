...
//=========  (Fri May  5 14:05:47 2023) by ROOT version 6.26/06
   ...
   HT_2016_QuadJet_TripleTag_16_3B->Range(-480.3764,-0.09710412,2577.593,0.8654243);
   ...
   TH1F *Graph_Graph3003 = new TH1F("Graph_Graph3003","",100,0,2200);
