...
//=========  (Thu May 25 11:52:40 2023) by ROOT version 6.26/06
   ...
   Aplanarity_algo_noMassCorr_16->Range(-0.2183529,-0.21864,1.171633,1.60336);
   ...
   TH1F *st_stack_112 = new TH1F("st_stack_112","",50,0,1);
   st_stack_112->SetMinimum(0);
   st_stack_112->SetMaximum(1.42116);
   ...
   st_stack_112->GetXaxis()->SetTitle("Aplanarity");
   ...
   VbbHcc_algo_noMassCorr_Aplanarity_stack_1->SetBinContent(1,0.884354);
   VbbHcc_algo_noMassCorr_Aplanarity_stack_1->SetBinContent(2,0.0662068);
   VbbHcc_algo_noMassCorr_Aplanarity_stack_1->SetBinContent(3,0.004305993);
   VbbHcc_algo_noMassCorr_Aplanarity_stack_1->SetBinContent(4,0.002933475);
   VbbHcc_algo_noMassCorr_Aplanarity_stack_1->SetBinError(1,0.0514338);
   VbbHcc_algo_noMassCorr_Aplanarity_stack_1->SetBinError(2,0.01418353);
   VbbHcc_algo_noMassCorr_Aplanarity_stack_1->SetBinError(3,0.003289315);
   VbbHcc_algo_noMassCorr_Aplanarity_stack_1->SetBinError(4,0.002933475);
   ...
   VbbHcc_algo_noMassCorr_Aplanarity_stack_1->GetXaxis()->SetTitleOffset(1);
   ...
   VbbHcc_algo_noMassCorr_Aplanarity_stack_1->GetZaxis()->SetTitleOffset(1);
   ...
   VbbHcc_algo_noMassCorr_Aplanarity_stack_2->SetBinContent(1,0.2952085);
   VbbHcc_algo_noMassCorr_Aplanarity_stack_2->SetBinContent(2,0.03276166);
   VbbHcc_algo_noMassCorr_Aplanarity_stack_2->SetBinContent(3,0.003839844);
   VbbHcc_algo_noMassCorr_Aplanarity_stack_2->SetBinContent(4,0.001513447);
   VbbHcc_algo_noMassCorr_Aplanarity_stack_2->SetBinError(1,0.01065253);
   VbbHcc_algo_noMassCorr_Aplanarity_stack_2->SetBinError(2,0.003529304);
   VbbHcc_algo_noMassCorr_Aplanarity_stack_2->SetBinError(3,0.001215155);
   VbbHcc_algo_noMassCorr_Aplanarity_stack_2->SetBinError(4,0.0007567548);
   ...
   VbbHcc_algo_noMassCorr_Aplanarity_stack_2->GetXaxis()->SetTitleOffset(1);
   ...
   VbbHcc_algo_noMassCorr_Aplanarity_stack_2->GetZaxis()->SetTitleOffset(1);
