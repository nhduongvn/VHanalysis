...
//=========  (Thu May 25 11:52:41 2023) by ROOT version 6.26/06
   ...
   H_jetmass_JEC_both_16->Range(-65.50587,-0.7104314,351.4899,5.20983);
   ...
   st_stack_164->SetMaximum(4.617804);
   ...
   st_stack_164->GetXaxis()->SetTitle("c-jet mass (w/ JEC) [GeV]");
   ...
   VbbHcc_both_H_jetmass_JEC_stack_1->SetBinContent(2,2.747396);
   VbbHcc_both_H_jetmass_JEC_stack_1->SetBinContent(3,1.152929);
   VbbHcc_both_H_jetmass_JEC_stack_1->SetBinError(2,0.09027644);
   VbbHcc_both_H_jetmass_JEC_stack_1->SetBinError(3,0.05868964);
   VbbHcc_both_H_jetmass_JEC_stack_1->SetEntries(1378);
   ...
   VbbHcc_both_H_jetmass_JEC_stack_2->SetBinContent(2,1.085381);
   VbbHcc_both_H_jetmass_JEC_stack_2->SetBinContent(3,0.5666827);
   VbbHcc_both_H_jetmass_JEC_stack_2->SetBinError(2,0.02034166);
   VbbHcc_both_H_jetmass_JEC_stack_2->SetBinError(3,0.01470589);
   VbbHcc_both_H_jetmass_JEC_stack_2->SetEntries(4413);
