...
//=========  (Thu May 25 11:52:41 2023) by ROOT version 6.26/06
   ...
   H_jetpt_JEC_both_16->Range(-65.50587,-0.4184802,351.4899,3.068855);
   ...
   st_stack_162->SetMaximum(2.720121);
   ...
   st_stack_162->GetXaxis()->SetTitle("c-jet p_{T} (w/ JEC) [GeV]");
   ...
   VbbHcc_both_H_jetpt_JEC_stack_1->SetBinContent(0,1.934851);
   ...
   VbbHcc_both_H_jetpt_JEC_stack_1->SetBinError(0,0.0759355);
   ...
   VbbHcc_both_H_jetpt_JEC_stack_1->SetEntries(1378);
   ...
   VbbHcc_both_H_jetpt_JEC_stack_2->SetBinContent(0,0.8444514);
   VbbHcc_both_H_jetpt_JEC_stack_2->SetBinContent(1,0.00509725);
   VbbHcc_both_H_jetpt_JEC_stack_2->SetBinContent(2,0.6650206);
   VbbHcc_both_H_jetpt_JEC_stack_2->SetBinContent(3,0.1374945);
   VbbHcc_both_H_jetpt_JEC_stack_2->SetBinError(0,0.01794988);
   VbbHcc_both_H_jetpt_JEC_stack_2->SetBinError(1,0.001390526);
   VbbHcc_both_H_jetpt_JEC_stack_2->SetBinError(2,0.01592129);
   VbbHcc_both_H_jetpt_JEC_stack_2->SetBinError(3,0.007240632);
   VbbHcc_both_H_jetpt_JEC_stack_2->SetEntries(4413);
