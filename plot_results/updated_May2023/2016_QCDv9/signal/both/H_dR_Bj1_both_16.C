...
//=========  (Thu May 25 11:52:41 2023) by ROOT version 6.26/06
   ...
   st_stack_156->SetMaximum(1.055802);
   ...
   st_stack_156->GetXaxis()->SetTitle("#DeltaR(H,j_{2})");
   ...
   st_stack_156->GetYaxis()->SetTitle("Event/0.2");
   ...
   VbbHcc_both_H_dR_Bj1_stack_1->SetBinContent(7,0.2051256);
   ...
   VbbHcc_both_H_dR_Bj1_stack_1->SetBinError(7,0.02368586);
   ...
   VbbHcc_both_H_dR_Bj1_stack_1->SetEntries(1378);
   ...
   VbbHcc_both_H_dR_Bj1_stack_2->SetBinContent(4,0.247228);
   VbbHcc_both_H_dR_Bj1_stack_2->SetBinContent(5,0.2004261);
   ...
   VbbHcc_both_H_dR_Bj1_stack_2->SetBinError(4,0.009398197);
   VbbHcc_both_H_dR_Bj1_stack_2->SetBinError(5,0.008461998);
   ...
   VbbHcc_both_H_dR_Bj1_stack_2->SetEntries(4413);
