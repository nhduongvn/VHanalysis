...
//=========  (Thu Aug  3 12:23:28 2023) by ROOT version 6.14/09
   ...
   VbbHcc_tags_Z_dR_Bj0_stack_11->GetXaxis()->SetTitle("#DeltaR(Z,j_{1})");
   VbbHcc_tags_Z_dR_Bj0_stack_11->GetXaxis()->SetRange(1,30);
   ...
   VbbHcc_tags_Z_dR_Bj0_stack_11->Draw("HIST");
