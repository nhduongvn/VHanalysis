...
//=========  (Thu Aug  3 12:23:31 2023) by ROOT version 6.14/09
   ...
   Z_dR_Bj1_tags_18->Range(-1.2,-0.005973875,6.8,0.05376488);
   ...
   VbbHcc_tags_Z_dR_Bj1_stack_11->GetXaxis()->SetTitle("#DeltaR(Z,j_{2})");
   VbbHcc_tags_Z_dR_Bj1_stack_11->GetXaxis()->SetRange(1,30);
   ...
   VbbHcc_tags_Z_dR_Bj1_stack_11->Draw("HIST");
