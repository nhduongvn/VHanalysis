...
//=========  (Thu Aug  3 12:23:28 2023) by ROOT version 6.14/09
   ...
   Z_dR_Bj0_tags_17->Range(-1.2,-0.0413839,6.8,0.3724551);
   ...
   VbbHcc_tags_Z_dR_Bj0_stack_6->GetXaxis()->SetTitle("#DeltaR(Z,j_{1})");
   VbbHcc_tags_Z_dR_Bj0_stack_6->GetXaxis()->SetRange(1,30);
   ...
   VbbHcc_tags_Z_dR_Bj0_stack_6->Draw("HIST");
