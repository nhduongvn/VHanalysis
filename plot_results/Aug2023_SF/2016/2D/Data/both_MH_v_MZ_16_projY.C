...
//=========  (Tue Sep 12 12:59:01 2023) by ROOT version 6.28/04
   ...
   both_MH_v_MZ_16_projY->Range(-40,19652.36,226.6667,26613.27);
   ...
   TH1D *VbbHcc_both_MH_v_MZ_py__2 = new TH1D("VbbHcc_both_MH_v_MZ_py__2","",2,0,200);
   VbbHcc_both_MH_v_MZ_py__2->SetBinContent(1,20601);
   VbbHcc_both_MH_v_MZ_py__2->SetBinContent(2,25652);
   VbbHcc_both_MH_v_MZ_py__2->SetBinContent(3,54247);
   VbbHcc_both_MH_v_MZ_py__2->SetEntries(100500);
   VbbHcc_both_MH_v_MZ_py__2->SetStats(0);
   VbbHcc_both_MH_v_MZ_py__2->SetLineColor(0);
   VbbHcc_both_MH_v_MZ_py__2->GetXaxis()->SetTitle("m_{Z} [GeV]");
   VbbHcc_both_MH_v_MZ_py__2->GetXaxis()->SetRange(1,20);
   ...
   VbbHcc_both_MH_v_MZ_py__2->Draw("HIST");
