...
//=========  (Tue Sep 12 12:59:01 2023) by ROOT version 6.28/04
   ...
   both_MH_v_MZ_16_projX->Range(-40,233.7088,226.6667,665.5555);
   ...
   TH1D *VbbHcc_both_MH_v_MZ_px__9 = new TH1D("VbbHcc_both_MH_v_MZ_px__9","",2,0,200);
   VbbHcc_both_MH_v_MZ_px__9->SetBinContent(1,292.5614);
   VbbHcc_both_MH_v_MZ_px__9->SetBinContent(2,605.9195);
   VbbHcc_both_MH_v_MZ_px__9->SetBinContent(3,875.5241);
   VbbHcc_both_MH_v_MZ_px__9->SetEntries(1774);
   VbbHcc_both_MH_v_MZ_px__9->SetStats(0);
   VbbHcc_both_MH_v_MZ_px__9->SetLineColor(0);
   ...
   VbbHcc_both_MH_v_MZ_px__9->Draw("HIST");
