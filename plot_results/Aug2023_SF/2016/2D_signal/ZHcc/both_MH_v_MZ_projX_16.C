...
#endif
void both_MH_v_MZ_projX_16()
{
//=========Macro generated from canvas: both_MH_v_MZ_projX_16/both_MH_v_MZ_projX_16
//=========  (Tue Sep 12 15:29:07 2023) by ROOT version 6.28/04
   TCanvas *both_MH_v_MZ_projX_16 = new TCanvas("both_MH_v_MZ_projX_16", "both_MH_v_MZ_projX_16",0,0,600,600);
   gStyle->SetOptStat(0);
   both_MH_v_MZ_projX_16->SetHighLightColor(2);
   both_MH_v_MZ_projX_16->Range(-40,-25,226.6667,225);
   both_MH_v_MZ_projX_16->SetFillColor(0);
   both_MH_v_MZ_projX_16->SetBorderMode(0);
   both_MH_v_MZ_projX_16->SetBorderSize(2);
   both_MH_v_MZ_projX_16->SetLeftMargin(0.15);
   both_MH_v_MZ_projX_16->SetFrameBorderMode(0);
   both_MH_v_MZ_projX_16->SetFrameBorderMode(0);
   ...
   VbbHcc_both_MH_v_MZ__1->GetYaxis()->SetTitle("Events/10 GeV");
   ...
   VbbHcc_both_MH_v_MZ__1->Draw("HIST");
   ...
   tex->SetLineWidth(2);
   tex->Draw();
   both_MH_v_MZ_projX_16->Modified();
   both_MH_v_MZ_projX_16->cd();
   both_MH_v_MZ_projX_16->SetSelected(both_MH_v_MZ_projX_16);
}
