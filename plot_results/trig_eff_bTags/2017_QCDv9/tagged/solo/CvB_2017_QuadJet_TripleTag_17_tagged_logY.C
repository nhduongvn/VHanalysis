...
//=========  (Thu Apr 27 10:19:53 2023) by ROOT version 6.26/06
   ...
   CvB_2017_QuadJet_TripleTag_17_tagged->Range(-0.2,1.410217,1.133333,3.591935);
   ...
   _QuadJet_TripleTag_tagged_CvB__104->SetBinContent(1,1248);
   _QuadJet_TripleTag_tagged_CvB__104->SetBinContent(2,212);
   _QuadJet_TripleTag_tagged_CvB__104->SetBinContent(3,216);
   _QuadJet_TripleTag_tagged_CvB__104->SetBinContent(4,167);
   _QuadJet_TripleTag_tagged_CvB__104->SetBinContent(5,181);
   _QuadJet_TripleTag_tagged_CvB__104->SetBinContent(6,152);
   _QuadJet_TripleTag_tagged_CvB__104->SetBinContent(7,128);
   _QuadJet_TripleTag_tagged_CvB__104->SetBinContent(8,85);
   _QuadJet_TripleTag_tagged_CvB__104->SetBinContent(9,251);
   _QuadJet_TripleTag_tagged_CvB__104->SetBinContent(10,124);
   _QuadJet_TripleTag_tagged_CvB__104->SetEntries(2764);
   ...
   ptstats_LaTex = ptstats->AddText("Std Dev   = 0.3181");
