...
//=========  (Thu Apr 27 10:19:53 2023) by ROOT version 6.26/06
   ...
   CvL_2017_QuadJet_noTag_17_tagged_ref->Range(-0.2,1.899117,1.133333,3.681626);
   ...
   _QuadJet_noTag_tagged_CvL_ref__102->SetBinContent(1,593);
   _QuadJet_noTag_tagged_CvL_ref__102->SetBinContent(2,239);
   _QuadJet_noTag_tagged_CvL_ref__102->SetBinContent(3,240);
   _QuadJet_noTag_tagged_CvL_ref__102->SetBinContent(4,244);
   _QuadJet_noTag_tagged_CvL_ref__102->SetBinContent(5,251);
   _QuadJet_noTag_tagged_CvL_ref__102->SetBinContent(6,265);
   _QuadJet_noTag_tagged_CvL_ref__102->SetBinContent(7,336);
   _QuadJet_noTag_tagged_CvL_ref__102->SetBinContent(8,464);
   _QuadJet_noTag_tagged_CvL_ref__102->SetBinContent(9,714);
   _QuadJet_noTag_tagged_CvL_ref__102->SetBinContent(10,1682);
   _QuadJet_noTag_tagged_CvL_ref__102->SetEntries(5028);
   ...
   ptstats_LaTex = ptstats->AddText("Mean  = 0.6501");
   ptstats_LaTex = ptstats->AddText("Std Dev   = 0.3288");
