...
//=========  (Thu Apr 27 10:19:53 2023) by ROOT version 6.26/06
   ...
   CvB_2017_QuadJet_TripleTag_17->Range(-0.2183529,0.01587339,1.171633,0.08851036);
   ...
   _QuadJet_TripleTag_CvB__49->SetBinContent(1,0.07854872);
   _QuadJet_TripleTag_CvB__49->SetBinContent(2,0.06825497);
   _QuadJet_TripleTag_CvB__49->SetBinContent(3,0.06640617);
   _QuadJet_TripleTag_CvB__49->SetBinContent(4,0.06082898);
   _QuadJet_TripleTag_CvB__49->SetBinContent(5,0.05556327);
   _QuadJet_TripleTag_CvB__49->SetBinContent(6,0.04752056);
   _QuadJet_TripleTag_CvB__49->SetBinContent(7,0.04108816);
   _QuadJet_TripleTag_CvB__49->SetBinContent(8,0.03309615);
   _QuadJet_TripleTag_CvB__49->SetBinContent(9,0.02767073);
   _QuadJet_TripleTag_CvB__49->SetBinContent(10,0.0271593);
   _QuadJet_TripleTag_CvB__49->SetEntries(0.506137);
   ...
   ptstats_LaTex = ptstats->AddText("Mean  = 0.4031");
