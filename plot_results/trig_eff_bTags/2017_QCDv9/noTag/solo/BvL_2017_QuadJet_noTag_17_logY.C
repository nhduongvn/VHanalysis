...
//=========  (Thu Apr 27 10:19:52 2023) by ROOT version 6.26/06
   ...
   BvL_2017_QuadJet_noTag_17->Range(-0.2,1.560449,1.133333,4.437854);
   ...
   _QuadJet_noTag_BvL__41->SetBinContent(1,7457);
   _QuadJet_noTag_BvL__41->SetBinContent(2,478);
   _QuadJet_noTag_BvL__41->SetBinContent(3,245);
   _QuadJet_noTag_BvL__41->SetBinContent(4,202);
   _QuadJet_noTag_BvL__41->SetBinContent(5,182);
   _QuadJet_noTag_BvL__41->SetBinContent(6,155);
   _QuadJet_noTag_BvL__41->SetBinContent(7,141);
   _QuadJet_noTag_BvL__41->SetBinContent(8,167);
   _QuadJet_noTag_BvL__41->SetBinContent(9,233);
   _QuadJet_noTag_BvL__41->SetBinContent(10,1536);
   _QuadJet_noTag_BvL__41->SetEntries(10796);
   ...
   ptstats_LaTex = ptstats->AddText("Mean  = 0.2251");
   ptstats_LaTex = ptstats->AddText("Std Dev   = 0.3601");
