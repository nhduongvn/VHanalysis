...
//=========  (Thu Apr 27 10:19:53 2023) by ROOT version 6.26/06
   ...
   CvB_2017_QuadJet_noTag_17->Range(-0.2,1.834941,1.133333,4.073588);
   ...
   _QuadJet_noTag_CvB__53->SetBinContent(1,1590);
   _QuadJet_noTag_CvB__53->SetBinContent(2,271);
   _QuadJet_noTag_CvB__53->SetBinContent(3,242);
   _QuadJet_noTag_CvB__53->SetBinContent(4,229);
   _QuadJet_noTag_CvB__53->SetBinContent(5,257);
   _QuadJet_noTag_CvB__53->SetBinContent(6,381);
   _QuadJet_noTag_CvB__53->SetBinContent(7,676);
   _QuadJet_noTag_CvB__53->SetBinContent(8,1470);
   _QuadJet_noTag_CvB__53->SetBinContent(9,3734);
   _QuadJet_noTag_CvB__53->SetBinContent(10,1946);
   _QuadJet_noTag_CvB__53->SetEntries(10796);
   ...
   ptstats_LaTex = ptstats->AddText("Mean  = 0.6569");
   ptstats_LaTex = ptstats->AddText("Std Dev   = 0.3207");
