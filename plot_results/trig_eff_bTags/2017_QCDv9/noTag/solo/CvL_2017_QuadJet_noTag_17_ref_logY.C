...
//=========  (Thu Apr 27 10:19:53 2023) by ROOT version 6.26/06
   ...
   CvL_2017_QuadJet_noTag_17_ref->Range(-0.2,4.111648,1.133333,6.558961);
   ...
   _QuadJet_noTag_CvL_ref__48->SetBinContent(1,1088131);
   _QuadJet_noTag_CvL_ref__48->SetBinContent(2,320154);
   _QuadJet_noTag_CvL_ref__48->SetBinContent(3,98901);
   _QuadJet_noTag_CvL_ref__48->SetBinContent(4,58311);
   _QuadJet_noTag_CvL_ref__48->SetBinContent(5,46403);
   _QuadJet_noTag_CvL_ref__48->SetBinContent(6,45437);
   _QuadJet_noTag_CvL_ref__48->SetBinContent(7,51616);
   _QuadJet_noTag_CvL_ref__48->SetBinContent(8,68853);
   _QuadJet_noTag_CvL_ref__48->SetBinContent(9,107887);
   _QuadJet_noTag_CvL_ref__48->SetBinContent(10,253115);
   _QuadJet_noTag_CvL_ref__48->SetEntries(2138808);
   ...
   ptstats_LaTex = ptstats->AddText("Std Dev   = 0.3368");
