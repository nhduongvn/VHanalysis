...
//=========  (Thu Apr 27 10:19:52 2023) by ROOT version 6.26/06
   ...
   CvL_2017_QuadJet_TripleTag_17->Range(-0.2,2.867945,1.133333,4.923843);
   ...
   _QuadJet_TripleTag_CvL__44->SetBinContent(1,27587);
   _QuadJet_TripleTag_CvL__44->SetBinContent(2,10951);
   _QuadJet_TripleTag_CvL__44->SetBinContent(3,4165);
   _QuadJet_TripleTag_CvL__44->SetBinContent(4,2742);
   _QuadJet_TripleTag_CvL__44->SetBinContent(5,2369);
   _QuadJet_TripleTag_CvL__44->SetBinContent(6,2653);
   _QuadJet_TripleTag_CvL__44->SetBinContent(7,3306);
   _QuadJet_TripleTag_CvL__44->SetBinContent(8,4825);
   _QuadJet_TripleTag_CvL__44->SetBinContent(9,8235);
   _QuadJet_TripleTag_CvL__44->SetBinContent(10,21179);
   _QuadJet_TripleTag_CvL__44->SetEntries(88012);
   ...
   ptstats_LaTex = ptstats->AddText("Mean  = 0.4649");
   ptstats_LaTex = ptstats->AddText("Std Dev   = 0.3852");
