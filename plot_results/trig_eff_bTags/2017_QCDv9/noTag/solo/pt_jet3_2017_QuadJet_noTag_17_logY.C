...
//=========  (Thu Apr 27 10:19:52 2023) by ROOT version 6.26/06
   ...
   pt_jet3_2017_QuadJet_noTag_17->Range(-100,-0.7364418,566.6667,3.617676);
   ...
   _QuadJet_noTag_pt_jet3__23->SetBinContent(5,428);
   _QuadJet_noTag_pt_jet3__23->SetBinContent(6,803);
   _QuadJet_noTag_pt_jet3__23->SetBinContent(7,546);
   _QuadJet_noTag_pt_jet3__23->SetBinContent(8,397);
   _QuadJet_noTag_pt_jet3__23->SetBinContent(9,216);
   _QuadJet_noTag_pt_jet3__23->SetBinContent(10,110);
   _QuadJet_noTag_pt_jet3__23->SetBinContent(11,72);
   _QuadJet_noTag_pt_jet3__23->SetBinContent(12,44);
   ...
   _QuadJet_noTag_pt_jet3__23->SetEntries(2699);
   ...
   ptstats_LaTex = ptstats->AddText("Mean  =  67.47");
   ptstats_LaTex = ptstats->AddText("Std Dev   =   20.9");
