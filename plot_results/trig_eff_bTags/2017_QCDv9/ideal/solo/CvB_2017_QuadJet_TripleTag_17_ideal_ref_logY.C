...
//=========  (Tue May  2 10:43:26 2023) by ROOT version 6.26/06
   ...
   CvB_2017_QuadJet_TripleTag_17_ideal_ref->Range(-0.2,0.9991463,1.133333,3.182523);
   ...
   _QuadJet_TripleTag_ideal_CvB_ref__51->SetBinContent(1,486);
   _QuadJet_TripleTag_ideal_CvB_ref__51->SetBinContent(2,102);
   _QuadJet_TripleTag_ideal_CvB_ref__51->SetBinContent(3,104);
   _QuadJet_TripleTag_ideal_CvB_ref__51->SetBinContent(4,81);
   _QuadJet_TripleTag_ideal_CvB_ref__51->SetBinContent(5,86);
   _QuadJet_TripleTag_ideal_CvB_ref__51->SetBinContent(6,72);
   _QuadJet_TripleTag_ideal_CvB_ref__51->SetBinContent(7,63);
   _QuadJet_TripleTag_ideal_CvB_ref__51->SetBinContent(8,33);
   _QuadJet_TripleTag_ideal_CvB_ref__51->SetBinContent(9,101);
   _QuadJet_TripleTag_ideal_CvB_ref__51->SetBinContent(10,40);
   _QuadJet_TripleTag_ideal_CvB_ref__51->SetEntries(1168);
