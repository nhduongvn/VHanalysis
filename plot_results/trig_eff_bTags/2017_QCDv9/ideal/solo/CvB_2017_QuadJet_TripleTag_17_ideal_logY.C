...
//=========  (Thu Apr 27 10:19:54 2023) by ROOT version 6.26/06
   ...
   CvB_2017_QuadJet_TripleTag_17_ideal->Range(-0.2,1.411183,1.133333,3.583246);
   ...
   _QuadJet_TripleTag_ideal_CvB__158->SetBinContent(1,1226);
   _QuadJet_TripleTag_ideal_CvB__158->SetBinContent(2,210);
   _QuadJet_TripleTag_ideal_CvB__158->SetBinContent(3,207);
   _QuadJet_TripleTag_ideal_CvB__158->SetBinContent(4,164);
   _QuadJet_TripleTag_ideal_CvB__158->SetBinContent(5,176);
   _QuadJet_TripleTag_ideal_CvB__158->SetBinContent(6,150);
   _QuadJet_TripleTag_ideal_CvB__158->SetBinContent(7,128);
   _QuadJet_TripleTag_ideal_CvB__158->SetBinContent(8,85);
   _QuadJet_TripleTag_ideal_CvB__158->SetBinContent(9,251);
   _QuadJet_TripleTag_ideal_CvB__158->SetBinContent(10,123);
   _QuadJet_TripleTag_ideal_CvB__158->SetEntries(2720);
   ...
   ptstats_LaTex = ptstats->AddText("Mean  = 0.2936");
   ptstats_LaTex = ptstats->AddText("Std Dev   = 0.3193");
