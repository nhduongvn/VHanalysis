...
//=========  (Thu Apr 27 10:19:54 2023) by ROOT version 6.26/06
   ...
   pt_jet3_2017_QuadJet_noTag_17_ideal->Range(-100,-0.4486099,566.6667,1.027189);
   ...
   _QuadJet_noTag_ideal_pt_jet3__131->SetBinContent(6,4);
   _QuadJet_noTag_ideal_pt_jet3__131->SetBinContent(7,3);
   _QuadJet_noTag_ideal_pt_jet3__131->SetBinContent(8,1);
   _QuadJet_noTag_ideal_pt_jet3__131->SetBinContent(11,1);
   _QuadJet_noTag_ideal_pt_jet3__131->SetBinContent(14,1);
   _QuadJet_noTag_ideal_pt_jet3__131->SetBinContent(15,1);
   _QuadJet_noTag_ideal_pt_jet3__131->SetEntries(11);
   ...
   ptstats_LaTex = ptstats->AddText("Mean  =  79.94");
   ptstats_LaTex = ptstats->AddText("Std Dev   =  33.19");
