...
//=========  (Thu Apr 27 10:19:54 2023) by ROOT version 6.26/06
   ...
   pt_jet1_2017_QuadJet_noTag_17_ideal->Range(-100,-0.4109811,566.6667,0.68853);
   ...
   _QuadJet_noTag_ideal_pt_jet1__119->SetBinContent(10,2);
   _QuadJet_noTag_ideal_pt_jet1__119->SetBinContent(11,1);
   _QuadJet_noTag_ideal_pt_jet1__119->SetBinContent(13,2);
   _QuadJet_noTag_ideal_pt_jet1__119->SetBinContent(14,2);
   _QuadJet_noTag_ideal_pt_jet1__119->SetBinContent(15,2);
   _QuadJet_noTag_ideal_pt_jet1__119->SetBinContent(29,1);
   _QuadJet_noTag_ideal_pt_jet1__119->SetBinContent(34,1);
   _QuadJet_noTag_ideal_pt_jet1__119->SetEntries(11);
   ...
   ptstats_LaTex = ptstats->AddText("Mean  =    158");
   ptstats_LaTex = ptstats->AddText("Std Dev   =  73.87");
