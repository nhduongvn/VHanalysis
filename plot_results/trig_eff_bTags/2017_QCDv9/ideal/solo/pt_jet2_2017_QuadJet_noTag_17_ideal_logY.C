...
//=========  (Thu Apr 27 10:19:54 2023) by ROOT version 6.26/06
   ...
   pt_jet2_2017_QuadJet_noTag_17_ideal->Range(-100,-0.4109811,566.6667,0.68853);
   ...
   _QuadJet_noTag_ideal_pt_jet2__125->SetBinContent(6,1);
   _QuadJet_noTag_ideal_pt_jet2__125->SetBinContent(7,1);
   _QuadJet_noTag_ideal_pt_jet2__125->SetBinContent(8,2);
   _QuadJet_noTag_ideal_pt_jet2__125->SetBinContent(10,2);
   _QuadJet_noTag_ideal_pt_jet2__125->SetBinContent(11,1);
   _QuadJet_noTag_ideal_pt_jet2__125->SetBinContent(13,2);
   _QuadJet_noTag_ideal_pt_jet2__125->SetBinContent(16,1);
   _QuadJet_noTag_ideal_pt_jet2__125->SetBinContent(21,1);
   _QuadJet_noTag_ideal_pt_jet2__125->SetEntries(11);
   ...
   ptstats_LaTex = ptstats->AddText("Mean  =  107.6");
   ptstats_LaTex = ptstats->AddText("Std Dev   =  41.15");
