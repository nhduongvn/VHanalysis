...
//=========  (Tue May  2 10:43:26 2023) by ROOT version 6.26/06
   ...
   pt_jet0_2017_QuadJet_noTag_17_ideal->Range(-100,-3.748352,566.6667,0.7248713);
   ...
   _QuadJet_noTag_ideal_pt_jet0__5->SetBinContent(13,1);
   _QuadJet_noTag_ideal_pt_jet0__5->SetBinContent(14,1);
   _QuadJet_noTag_ideal_pt_jet0__5->SetEntries(2);
   ...
   ptstats_LaTex = ptstats->AddText("Mean  =  128.4");
   ptstats_LaTex = ptstats->AddText("Std Dev   =  6.594");
