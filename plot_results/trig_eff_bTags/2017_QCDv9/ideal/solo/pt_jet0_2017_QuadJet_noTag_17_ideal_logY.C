...
//=========  (Thu Apr 27 10:19:53 2023) by ROOT version 6.26/06
   ...
   pt_jet0_2017_QuadJet_noTag_17_ideal->Range(-100,-0.4109811,566.6667,0.68853);
   ...
   _QuadJet_noTag_ideal_pt_jet0__113->SetBinContent(13,2);
   _QuadJet_noTag_ideal_pt_jet0__113->SetBinContent(14,2);
   _QuadJet_noTag_ideal_pt_jet0__113->SetBinContent(15,1);
   _QuadJet_noTag_ideal_pt_jet0__113->SetBinContent(17,1);
   ...
   _QuadJet_noTag_ideal_pt_jet0__113->SetBinContent(51,2);
   _QuadJet_noTag_ideal_pt_jet0__113->SetEntries(11);
   ...
   ptstats_LaTex = ptstats->AddText("Mean  =  201.1");
   ptstats_LaTex = ptstats->AddText("Std Dev   =   93.6");
