...
//=========  (Thu Apr 27 10:19:54 2023) by ROOT version 6.26/06
   ...
   CvB_2017_QuadJet_noTag_17_ideal_ref->Range(-0.2,1.63405,1.133333,3.775441);
   ...
   _QuadJet_noTag_ideal_CvB_ref__162->SetBinContent(1,1922);
   _QuadJet_noTag_ideal_CvB_ref__162->SetBinContent(2,384);
   _QuadJet_noTag_ideal_CvB_ref__162->SetBinContent(3,376);
   _QuadJet_noTag_ideal_CvB_ref__162->SetBinContent(4,323);
   _QuadJet_noTag_ideal_CvB_ref__162->SetBinContent(5,319);
   _QuadJet_noTag_ideal_CvB_ref__162->SetBinContent(6,261);
   _QuadJet_noTag_ideal_CvB_ref__162->SetBinContent(7,215);
   _QuadJet_noTag_ideal_CvB_ref__162->SetBinContent(8,141);
   _QuadJet_noTag_ideal_CvB_ref__162->SetBinContent(9,392);
   _QuadJet_noTag_ideal_CvB_ref__162->SetBinContent(10,195);
   _QuadJet_noTag_ideal_CvB_ref__162->SetEntries(4528);
