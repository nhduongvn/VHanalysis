...
//=========  (Thu Apr 27 10:20:02 2023) by ROOT version 6.26/06
   ...
   BvL_2018_QuadJet_noTag_18_ideal->Range(-0.2183529,-0.00157215,1.171633,0.0115291);
   ...
   _QuadJet_noTag_ideal_BvL__148->SetBinContent(1,0.006130268);
   _QuadJet_noTag_ideal_BvL__148->SetBinContent(4,0.006980803);
   _QuadJet_noTag_ideal_BvL__148->SetBinContent(5,0.008080808);
   _QuadJet_noTag_ideal_BvL__148->SetBinContent(7,0.002439024);
   _QuadJet_noTag_ideal_BvL__148->SetBinContent(8,0.00973236);
   _QuadJet_noTag_ideal_BvL__148->SetBinContent(9,0.004246285);
   _QuadJet_noTag_ideal_BvL__148->SetBinContent(10,0.003084304);
   _QuadJet_noTag_ideal_BvL__148->SetEntries(0.04069385);
   ...
   ptstats_LaTex = ptstats->AddText("Mean  =  0.536");
   ptstats_LaTex = ptstats->AddText("Std Dev   = 0.2793");
