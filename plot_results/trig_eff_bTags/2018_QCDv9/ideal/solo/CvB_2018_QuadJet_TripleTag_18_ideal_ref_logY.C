...
//=========  (Wed May  3 17:28:54 2023) by ROOT version 6.26/06
   ...
   _QuadJet_TripleTag_ideal_CvB_ref__27->SetBinContent(1,3059);
   _QuadJet_TripleTag_ideal_CvB_ref__27->SetBinContent(2,597);
   _QuadJet_TripleTag_ideal_CvB_ref__27->SetBinContent(3,610);
   _QuadJet_TripleTag_ideal_CvB_ref__27->SetBinContent(4,537);
   _QuadJet_TripleTag_ideal_CvB_ref__27->SetBinContent(5,470);
   _QuadJet_TripleTag_ideal_CvB_ref__27->SetBinContent(6,380);
   _QuadJet_TripleTag_ideal_CvB_ref__27->SetBinContent(7,328);
   _QuadJet_TripleTag_ideal_CvB_ref__27->SetBinContent(8,271);
   _QuadJet_TripleTag_ideal_CvB_ref__27->SetBinContent(9,650);
   _QuadJet_TripleTag_ideal_CvB_ref__27->SetBinContent(10,310);
   _QuadJet_TripleTag_ideal_CvB_ref__27->SetEntries(7212);
