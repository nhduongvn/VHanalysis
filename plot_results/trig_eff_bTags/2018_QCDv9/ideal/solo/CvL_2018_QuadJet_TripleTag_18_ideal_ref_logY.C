...
//=========  (Thu Apr 27 10:20:02 2023) by ROOT version 6.26/06
   ...
   CvL_2018_QuadJet_TripleTag_18_ideal_ref->Range(-0.2,2.029854,1.133333,3.81304);
   ...
   _QuadJet_TripleTag_ideal_CvL_ref__153->SetBinContent(1,953);
   _QuadJet_TripleTag_ideal_CvL_ref__153->SetBinContent(2,424);
   _QuadJet_TripleTag_ideal_CvL_ref__153->SetBinContent(3,323);
   _QuadJet_TripleTag_ideal_CvL_ref__153->SetBinContent(4,349);
   _QuadJet_TripleTag_ideal_CvL_ref__153->SetBinContent(5,385);
   _QuadJet_TripleTag_ideal_CvL_ref__153->SetBinContent(6,410);
   _QuadJet_TripleTag_ideal_CvL_ref__153->SetBinContent(7,502);
   _QuadJet_TripleTag_ideal_CvL_ref__153->SetBinContent(8,626);
   _QuadJet_TripleTag_ideal_CvL_ref__153->SetBinContent(9,1024);
   _QuadJet_TripleTag_ideal_CvL_ref__153->SetBinContent(10,2276);
   _QuadJet_TripleTag_ideal_CvL_ref__153->SetEntries(7272);
