...
//=========  (Thu Apr 27 10:20:02 2023) by ROOT version 6.26/06
   ...
   _QuadJet_noTag_ideal_HTmod__142->SetBinContent(49,0.02173913);
   _QuadJet_noTag_ideal_HTmod__142->SetBinContent(55,0.01923077);
   _QuadJet_noTag_ideal_HTmod__142->SetBinContent(62,0.02631579);
   _QuadJet_noTag_ideal_HTmod__142->SetBinContent(64,0.025);
   _QuadJet_noTag_ideal_HTmod__142->SetBinContent(77,0.04347826);
   _QuadJet_noTag_ideal_HTmod__142->SetBinContent(82,0.05882353);
   _QuadJet_noTag_ideal_HTmod__142->SetBinContent(86,0.05882353);
   _QuadJet_noTag_ideal_HTmod__142->SetBinContent(106,0.25);
   _QuadJet_noTag_ideal_HTmod__142->SetEntries(0.503411);
   ...
   ptstats_LaTex = ptstats->AddText("Mean  =  890.6");
   ptstats_LaTex = ptstats->AddText("Std Dev   =  185.7");
