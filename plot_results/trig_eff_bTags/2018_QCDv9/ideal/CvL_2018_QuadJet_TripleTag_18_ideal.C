...
//=========  (Thu Apr 27 10:20:02 2023) by ROOT version 6.26/06
   ...
   CvL_2018_QuadJet_TripleTag_18_ideal->Range(-0.2183529,0.5773042,1.171633,0.8266486);
   ...
   _QuadJet_TripleTag_ideal_CvL__151->SetBinContent(1,0.7743966);
   _QuadJet_TripleTag_ideal_CvL__151->SetBinContent(2,0.7924528);
   _QuadJet_TripleTag_ideal_CvL__151->SetBinContent(3,0.6315789);
   _QuadJet_TripleTag_ideal_CvL__151->SetBinContent(4,0.6160458);
   _QuadJet_TripleTag_ideal_CvL__151->SetBinContent(5,0.6623377);
   _QuadJet_TripleTag_ideal_CvL__151->SetBinContent(6,0.6902439);
   _QuadJet_TripleTag_ideal_CvL__151->SetBinContent(7,0.6673307);
   _QuadJet_TripleTag_ideal_CvL__151->SetBinContent(8,0.7348243);
   _QuadJet_TripleTag_ideal_CvL__151->SetBinContent(9,0.7324219);
   _QuadJet_TripleTag_ideal_CvL__151->SetBinContent(10,0.7398946);
   _QuadJet_TripleTag_ideal_CvL__151->SetEntries(7.041527);
   ...
   ptstats_LaTex = ptstats->AddText("Mean  = 0.4998");
