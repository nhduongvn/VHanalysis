...
//=========  (Thu Apr 27 10:20:01 2023) by ROOT version 6.26/06
   ...
   CvL_2018_QuadJet_noTag_18_tagged->Range(-0.2183529,-0.001755853,1.171633,0.01287625);
   ...
   _QuadJet_noTag_tagged_CvL__100->SetBinContent(1,0.003018109);
   _QuadJet_noTag_tagged_CvL__100->SetBinContent(2,0.01086957);
   _QuadJet_noTag_tagged_CvL__100->SetBinContent(3,0.01025641);
   _QuadJet_noTag_tagged_CvL__100->SetBinContent(4,0.002475248);
   _QuadJet_noTag_tagged_CvL__100->SetBinContent(5,0.002169197);
   _QuadJet_noTag_tagged_CvL__100->SetBinContent(6,0.002020202);
   _QuadJet_noTag_tagged_CvL__100->SetBinContent(7,0.003367003);
   _QuadJet_noTag_tagged_CvL__100->SetBinContent(8,0.006385696);
   _QuadJet_noTag_tagged_CvL__100->SetBinContent(10,0.003653635);
   _QuadJet_noTag_tagged_CvL__100->SetEntries(0.04421507);
   ...
   ptstats_LaTex = ptstats->AddText("Mean  = 0.4014");
   ptstats_LaTex = ptstats->AddText("Std Dev   = 0.2787");
