...
//=========  (Thu Apr 27 10:20:00 2023) by ROOT version 6.26/06
   ...
   BvL_2018_QuadJet_noTag_18->Range(-0.2183529,0.003529774,1.171633,0.004109722);
   ...
   _QuadJet_noTag_BvL__40->SetBinContent(1,0.003876331);
   _QuadJet_noTag_BvL__40->SetBinContent(2,0.00401948);
   _QuadJet_noTag_BvL__40->SetBinContent(3,0.003841421);
   _QuadJet_noTag_BvL__40->SetBinContent(4,0.003619883);
   _QuadJet_noTag_BvL__40->SetBinContent(5,0.003770646);
   _QuadJet_noTag_BvL__40->SetBinContent(6,0.003715685);
   _QuadJet_noTag_BvL__40->SetBinContent(7,0.003695547);
   _QuadJet_noTag_BvL__40->SetBinContent(8,0.004030186);
   _QuadJet_noTag_BvL__40->SetBinContent(9,0.003709353);
   _QuadJet_noTag_BvL__40->SetBinContent(10,0.003786786);
   _QuadJet_noTag_BvL__40->SetEntries(0.03806532);
   ...
   ptstats_LaTex = ptstats->AddText("Mean  = 0.4976");
