...
//=========  (Thu Apr 27 10:20:00 2023) by ROOT version 6.26/06
   ...
   CvB_2018_QuadJet_noTag_18->Range(-0.2,1.952685,1.133333,4.201196);
   ...
   _QuadJet_noTag_CvB__53->SetBinContent(1,2174);
   _QuadJet_noTag_CvB__53->SetBinContent(2,355);
   _QuadJet_noTag_CvB__53->SetBinContent(3,324);
   _QuadJet_noTag_CvB__53->SetBinContent(4,301);
   _QuadJet_noTag_CvB__53->SetBinContent(5,358);
   _QuadJet_noTag_CvB__53->SetBinContent(6,545);
   _QuadJet_noTag_CvB__53->SetBinContent(7,971);
   _QuadJet_noTag_CvB__53->SetBinContent(8,2011);
   _QuadJet_noTag_CvB__53->SetBinContent(9,4998);
   _QuadJet_noTag_CvB__53->SetBinContent(10,2399);
   _QuadJet_noTag_CvB__53->SetEntries(14436);
   ...
   ptstats_LaTex = ptstats->AddText("Entries = 14436  ");
   ptstats_LaTex = ptstats->AddText("Mean  = 0.6514");
