...
//=========  (Thu Apr 27 10:20:00 2023) by ROOT version 6.26/06
   ...
   BvL_2018_QuadJet_noTag_18->Range(-0.2,1.711117,1.133333,4.556296);
   ...
   _QuadJet_noTag_BvL__41->SetBinContent(1,9868);
   _QuadJet_noTag_BvL__41->SetBinContent(2,723);
   _QuadJet_noTag_BvL__41->SetBinContent(3,359);
   ...
   _QuadJet_noTag_BvL__41->SetBinContent(8,251);
   _QuadJet_noTag_BvL__41->SetBinContent(9,304);
   _QuadJet_noTag_BvL__41->SetBinContent(10,2073);
   _QuadJet_noTag_BvL__41->SetEntries(14436);
   ...
   ptstats_LaTex = ptstats->AddText("Mean  = 0.2279");
   ptstats_LaTex = ptstats->AddText("Std Dev   = 0.3609");
