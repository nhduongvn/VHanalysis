...
//=========  (Thu Apr 27 10:19:45 2023) by ROOT version 6.26/06
   ...
   CvB_2016_QuadJet_TripleTag_16->Range(-0.2183529,0.06738054,1.171633,0.226804);
   ...
   _QuadJet_TripleTag_CvB__97->SetBinContent(1,0.2049402);
   _QuadJet_TripleTag_CvB__97->SetBinContent(2,0.1961172);
   _QuadJet_TripleTag_CvB__97->SetBinContent(3,0.1915236);
   _QuadJet_TripleTag_CvB__97->SetBinContent(4,0.1773811);
   _QuadJet_TripleTag_CvB__97->SetBinContent(5,0.1684328);
   _QuadJet_TripleTag_CvB__97->SetBinContent(6,0.1486997);
   _QuadJet_TripleTag_CvB__97->SetBinContent(7,0.1323867);
   _QuadJet_TripleTag_CvB__97->SetBinContent(8,0.1115006);
   _QuadJet_TripleTag_CvB__97->SetBinContent(9,0.0938045);
   _QuadJet_TripleTag_CvB__97->SetBinContent(10,0.09215082);
   _QuadJet_TripleTag_CvB__97->SetEntries(1.516937);
   ...
   ptstats_LaTex = ptstats->AddText("Std Dev   = 0.2739");
