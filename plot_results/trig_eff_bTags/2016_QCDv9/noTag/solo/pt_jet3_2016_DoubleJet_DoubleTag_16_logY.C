...
//=========  (Thu Apr 27 10:19:44 2023) by ROOT version 6.26/06
   ...
   pt_jet3_2016_DoubleJet_DoubleTag_16->Range(-100,-0.7508457,566.6667,3.747311);
   ...
   _DoubleJet_DoubleTag_pt_jet3__47->SetBinContent(6,1047);
   _DoubleJet_DoubleTag_pt_jet3__47->SetBinContent(7,880);
   _DoubleJet_DoubleTag_pt_jet3__47->SetBinContent(8,568);
   _DoubleJet_DoubleTag_pt_jet3__47->SetBinContent(9,386);
   _DoubleJet_DoubleTag_pt_jet3__47->SetBinContent(10,218);
   _DoubleJet_DoubleTag_pt_jet3__47->SetBinContent(11,137);
   ...
   _DoubleJet_DoubleTag_pt_jet3__47->SetEntries(4089);
   ...
   ptstats_LaTex = ptstats->AddText("Mean  =  70.59");
