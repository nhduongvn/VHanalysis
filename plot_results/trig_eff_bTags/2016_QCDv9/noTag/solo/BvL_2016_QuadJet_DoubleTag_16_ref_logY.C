...
//=========  (Thu Apr 27 10:19:45 2023) by ROOT version 6.26/06
   ...
   BvL_2016_QuadJet_DoubleTag_16_ref->Range(-0.2,3.923148,1.133333,6.735716);
   ...
   _QuadJet_DoubleTag_BvL_ref__78->SetBinContent(1,1502832);
   _QuadJet_DoubleTag_BvL_ref__78->SetBinContent(2,109564);
   _QuadJet_DoubleTag_BvL_ref__78->SetBinContent(3,56274);
   _QuadJet_DoubleTag_BvL_ref__78->SetBinContent(4,40814);
   _QuadJet_DoubleTag_BvL_ref__78->SetBinContent(5,33912);
   _QuadJet_DoubleTag_BvL_ref__78->SetBinContent(6,32440);
   _QuadJet_DoubleTag_BvL_ref__78->SetBinContent(7,32021);
   _QuadJet_DoubleTag_BvL_ref__78->SetBinContent(8,37038);
   _QuadJet_DoubleTag_BvL_ref__78->SetBinContent(9,48460);
   _QuadJet_DoubleTag_BvL_ref__78->SetBinContent(10,292917);
   _QuadJet_DoubleTag_BvL_ref__78->SetEntries(2186272);
