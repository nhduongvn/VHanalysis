...
//=========  (Thu Apr 27 10:19:45 2023) by ROOT version 6.26/06
   ...
   BvL_2016_DoubleJet_DoubleTag_16->Range(-0.2,1.937894,1.133333,4.504097);
   ...
   _DoubleJet_DoubleTag_BvL__83->SetBinContent(1,9331);
   _DoubleJet_DoubleTag_BvL__83->SetBinContent(2,896);
   _DoubleJet_DoubleTag_BvL__83->SetBinContent(3,497);
   _DoubleJet_DoubleTag_BvL__83->SetBinContent(4,367);
   _DoubleJet_DoubleTag_BvL__83->SetBinContent(5,371);
   _DoubleJet_DoubleTag_BvL__83->SetBinContent(6,313);
   _DoubleJet_DoubleTag_BvL__83->SetBinContent(7,337);
   _DoubleJet_DoubleTag_BvL__83->SetBinContent(8,412);
   _DoubleJet_DoubleTag_BvL__83->SetBinContent(9,566);
   _DoubleJet_DoubleTag_BvL__83->SetBinContent(10,3266);
   _DoubleJet_DoubleTag_BvL__83->SetEntries(16356);
   ...
   ptstats_LaTex = ptstats->AddText("Mean  = 0.3137");
