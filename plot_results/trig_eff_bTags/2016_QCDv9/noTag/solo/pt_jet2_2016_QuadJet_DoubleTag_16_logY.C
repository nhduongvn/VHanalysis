...
//=========  (Thu Apr 27 10:19:44 2023) by ROOT version 6.26/06
   ...
   pt_jet2_2016_QuadJet_DoubleTag_16->Range(-100,-0.7665408,566.6667,3.888567);
   ...
   _QuadJet_DoubleTag_pt_jet2__29->SetBinContent(6,977);
   _QuadJet_DoubleTag_pt_jet2__29->SetBinContent(7,1398);
   _QuadJet_DoubleTag_pt_jet2__29->SetBinContent(8,1320);
   _QuadJet_DoubleTag_pt_jet2__29->SetBinContent(9,950);
   _QuadJet_DoubleTag_pt_jet2__29->SetBinContent(10,699);
   _QuadJet_DoubleTag_pt_jet2__29->SetBinContent(11,511);
   _QuadJet_DoubleTag_pt_jet2__29->SetBinContent(12,339);
   _QuadJet_DoubleTag_pt_jet2__29->SetBinContent(13,251);
   _QuadJet_DoubleTag_pt_jet2__29->SetBinContent(14,157);
   ...
   _QuadJet_DoubleTag_pt_jet2__29->SetEntries(7184);
   ...
   ptstats_LaTex = ptstats->AddText("Mean  =  87.25");
   ptstats_LaTex = ptstats->AddText("Std Dev   =   33.6");
