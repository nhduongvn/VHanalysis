...
//=========  (Thu Apr 27 10:19:45 2023) by ROOT version 6.26/06
   ...
   CvL_2016_DoubleJet_TripleTag_16->Range(-0.2183529,0.0448064,1.171633,0.1761103);
   ...
   _DoubleJet_TripleTag_CvL__91->SetBinContent(1,0.06520764);
   _DoubleJet_TripleTag_CvL__91->SetBinContent(2,0.08989172);
   _DoubleJet_TripleTag_CvL__91->SetBinContent(3,0.1084281);
   _DoubleJet_TripleTag_CvL__91->SetBinContent(4,0.1196711);
   _DoubleJet_TripleTag_CvL__91->SetBinContent(5,0.127848);
   _DoubleJet_TripleTag_CvL__91->SetBinContent(6,0.1338079);
   _DoubleJet_TripleTag_CvL__91->SetBinContent(7,0.1387641);
   _DoubleJet_TripleTag_CvL__91->SetBinContent(8,0.1451184);
   _DoubleJet_TripleTag_CvL__91->SetBinContent(9,0.1511931);
   _DoubleJet_TripleTag_CvL__91->SetBinContent(10,0.1581029);
   _DoubleJet_TripleTag_CvL__91->SetEntries(1.238033);
