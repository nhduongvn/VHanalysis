...
//=========  (Thu Apr 27 10:19:46 2023) by ROOT version 6.26/06
   ...
   BvL_2016_QuadJet_DoubleTag_16_tagged_ref->Range(-0.2,1.054012,1.133333,3.736088);
   ...
   _QuadJet_DoubleTag_tagged_BvL_ref__186->SetBinContent(1,633);
   _QuadJet_DoubleTag_tagged_BvL_ref__186->SetBinContent(2,42);
   _QuadJet_DoubleTag_tagged_BvL_ref__186->SetBinContent(3,106);
   _QuadJet_DoubleTag_tagged_BvL_ref__186->SetBinContent(4,364);
   _QuadJet_DoubleTag_tagged_BvL_ref__186->SetBinContent(5,275);
   _QuadJet_DoubleTag_tagged_BvL_ref__186->SetBinContent(6,249);
   _QuadJet_DoubleTag_tagged_BvL_ref__186->SetBinContent(7,210);
   _QuadJet_DoubleTag_tagged_BvL_ref__186->SetBinContent(8,239);
   _QuadJet_DoubleTag_tagged_BvL_ref__186->SetBinContent(9,264);
   _QuadJet_DoubleTag_tagged_BvL_ref__186->SetBinContent(10,1550);
   _QuadJet_DoubleTag_tagged_BvL_ref__186->SetEntries(3932);
