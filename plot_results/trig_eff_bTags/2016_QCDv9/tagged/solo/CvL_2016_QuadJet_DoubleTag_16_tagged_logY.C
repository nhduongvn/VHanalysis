...
//=========  (Thu Apr 27 10:19:46 2023) by ROOT version 6.26/06
   ...
   CvL_2016_QuadJet_DoubleTag_16_tagged->Range(-0.2,0.2361172,1.133333,1.854345);
   ...
   _QuadJet_DoubleTag_tagged_CvL__197->SetBinContent(1,9);
   _QuadJet_DoubleTag_tagged_CvL__197->SetBinContent(2,7);
   _QuadJet_DoubleTag_tagged_CvL__197->SetBinContent(3,6);
   _QuadJet_DoubleTag_tagged_CvL__197->SetBinContent(4,6);
   _QuadJet_DoubleTag_tagged_CvL__197->SetBinContent(5,7);
   _QuadJet_DoubleTag_tagged_CvL__197->SetBinContent(6,5);
   _QuadJet_DoubleTag_tagged_CvL__197->SetBinContent(7,9);
   _QuadJet_DoubleTag_tagged_CvL__197->SetBinContent(8,8);
   _QuadJet_DoubleTag_tagged_CvL__197->SetBinContent(9,17);
   _QuadJet_DoubleTag_tagged_CvL__197->SetBinContent(10,26);
   _QuadJet_DoubleTag_tagged_CvL__197->SetEntries(100);
   ...
   ptstats_LaTex = ptstats->AddText("Mean  = 0.6229");
   ptstats_LaTex = ptstats->AddText("Std Dev   =  0.319");
