...
//=========  (Thu Apr 27 10:19:46 2023) by ROOT version 6.26/06
   ...
   CvL_2016_DoubleJet_TripleTag_16_tagged->Range(-0.2,1.549961,1.133333,3.333889);
   ...
   _DoubleJet_TripleTag_tagged_CvL__200->SetBinContent(1,344);
   _DoubleJet_TripleTag_tagged_CvL__200->SetBinContent(2,169);
   _DoubleJet_TripleTag_tagged_CvL__200->SetBinContent(3,130);
   _DoubleJet_TripleTag_tagged_CvL__200->SetBinContent(4,136);
   _DoubleJet_TripleTag_tagged_CvL__200->SetBinContent(5,107);
   _DoubleJet_TripleTag_tagged_CvL__200->SetBinContent(6,135);
   _DoubleJet_TripleTag_tagged_CvL__200->SetBinContent(7,152);
   _DoubleJet_TripleTag_tagged_CvL__200->SetBinContent(8,247);
   _DoubleJet_TripleTag_tagged_CvL__200->SetBinContent(9,361);
   _DoubleJet_TripleTag_tagged_CvL__200->SetBinContent(10,755);
   _DoubleJet_TripleTag_tagged_CvL__200->SetEntries(2536);
   ...
   ptstats_LaTex = ptstats->AddText("Mean  =  0.617");
   ptstats_LaTex = ptstats->AddText("Std Dev   =  0.338");
