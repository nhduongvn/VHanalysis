...
//=========  (Thu Apr 27 10:19:46 2023) by ROOT version 6.26/06
   ...
   CvL_2016_QuadJet_TripleTag_16_tagged->Range(-0.2,1.642056,1.133333,3.416932);
   ...
   _QuadJet_TripleTag_tagged_CvL__194->SetBinContent(1,405);
   _QuadJet_TripleTag_tagged_CvL__194->SetBinContent(2,192);
   _QuadJet_TripleTag_tagged_CvL__194->SetBinContent(3,149);
   _QuadJet_TripleTag_tagged_CvL__194->SetBinContent(4,170);
   _QuadJet_TripleTag_tagged_CvL__194->SetBinContent(5,132);
   _QuadJet_TripleTag_tagged_CvL__194->SetBinContent(6,183);
   _QuadJet_TripleTag_tagged_CvL__194->SetBinContent(7,190);
   _QuadJet_TripleTag_tagged_CvL__194->SetBinContent(8,291);
   _QuadJet_TripleTag_tagged_CvL__194->SetBinContent(9,460);
   _QuadJet_TripleTag_tagged_CvL__194->SetBinContent(10,916);
   _QuadJet_TripleTag_tagged_CvL__194->SetEntries(3088);
   ...
   ptstats_LaTex = ptstats->AddText("Mean  = 0.6227");
