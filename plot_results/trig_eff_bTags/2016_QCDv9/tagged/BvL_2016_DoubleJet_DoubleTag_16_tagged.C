...
//=========  (Thu Apr 27 10:19:46 2023) by ROOT version 6.26/06
   ...
   BvL_2016_DoubleJet_DoubleTag_16_tagged->Range(-0.2183529,0.00957967,1.171633,0.03986813);
   ...
   _DoubleJet_DoubleTag_tagged_BvL__190->SetBinContent(1,0.0300158);
   _DoubleJet_DoubleTag_tagged_BvL__190->SetBinContent(2,0.02380952);
   _DoubleJet_DoubleTag_tagged_BvL__190->SetBinContent(3,0.01886792);
   _DoubleJet_DoubleTag_tagged_BvL__190->SetBinContent(4,0.03571429);
   _DoubleJet_DoubleTag_tagged_BvL__190->SetBinContent(5,0.02909091);
   _DoubleJet_DoubleTag_tagged_BvL__190->SetBinContent(6,0.03212851);
   _DoubleJet_DoubleTag_tagged_BvL__190->SetBinContent(7,0.01428571);
   _DoubleJet_DoubleTag_tagged_BvL__190->SetBinContent(8,0.0167364);
   _DoubleJet_DoubleTag_tagged_BvL__190->SetBinContent(9,0.02651515);
   _DoubleJet_DoubleTag_tagged_BvL__190->SetBinContent(10,0.03032258);
   _DoubleJet_DoubleTag_tagged_BvL__190->SetEntries(0.2574868);
   ...
   ptstats_LaTex = ptstats->AddText("Mean  = 0.4903");
   ptstats_LaTex = ptstats->AddText("Std Dev   = 0.2914");
