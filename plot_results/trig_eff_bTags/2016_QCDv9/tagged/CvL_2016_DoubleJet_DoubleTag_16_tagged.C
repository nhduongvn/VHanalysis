...
//=========  (Thu Apr 27 10:19:47 2023) by ROOT version 6.26/06
   ...
   CvL_2016_DoubleJet_DoubleTag_16_tagged->Range(-0.2183529,0.01497668,1.171633,0.04094447);
   ...
   _DoubleJet_DoubleTag_tagged_CvL__202->SetBinContent(1,0.03191489);
   _DoubleJet_DoubleTag_tagged_CvL__202->SetBinContent(2,0.02880658);
   _DoubleJet_DoubleTag_tagged_CvL__202->SetBinContent(3,0.02040816);
   _DoubleJet_DoubleTag_tagged_CvL__202->SetBinContent(4,0.02192982);
   _DoubleJet_DoubleTag_tagged_CvL__202->SetBinContent(5,0.03738318);
   _DoubleJet_DoubleTag_tagged_CvL__202->SetBinContent(6,0.0242915);
   _DoubleJet_DoubleTag_tagged_CvL__202->SetBinContent(7,0.01901141);
   _DoubleJet_DoubleTag_tagged_CvL__202->SetBinContent(8,0.02387268);
   _DoubleJet_DoubleTag_tagged_CvL__202->SetBinContent(9,0.02504472);
   _DoubleJet_DoubleTag_tagged_CvL__202->SetBinContent(10,0.03436123);
   _DoubleJet_DoubleTag_tagged_CvL__202->SetEntries(0.2670242);
   ...
   ptstats_LaTex = ptstats->AddText("Mean  = 0.4983");
   ptstats_LaTex = ptstats->AddText("Std Dev   = 0.2989");
