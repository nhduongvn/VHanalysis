...
//=========  (Thu Apr 27 10:19:48 2023) by ROOT version 6.26/06
   ...
   CvL_2016_DoubleJet_TripleTag_16_ideal_ref->Range(-0.2,1.699799,1.133333,3.364682);
   ...
   _DoubleJet_TripleTag_ideal_CvL_ref__309->SetBinContent(1,386);
   _DoubleJet_TripleTag_ideal_CvL_ref__309->SetBinContent(2,200);
   _DoubleJet_TripleTag_ideal_CvL_ref__309->SetBinContent(3,154);
   _DoubleJet_TripleTag_ideal_CvL_ref__309->SetBinContent(4,169);
   _DoubleJet_TripleTag_ideal_CvL_ref__309->SetBinContent(5,147);
   _DoubleJet_TripleTag_ideal_CvL_ref__309->SetBinContent(6,167);
   _DoubleJet_TripleTag_ideal_CvL_ref__309->SetBinContent(7,182);
   _DoubleJet_TripleTag_ideal_CvL_ref__309->SetBinContent(8,276);
   _DoubleJet_TripleTag_ideal_CvL_ref__309->SetBinContent(9,398);
   _DoubleJet_TripleTag_ideal_CvL_ref__309->SetBinContent(10,833);
   _DoubleJet_TripleTag_ideal_CvL_ref__309->SetEntries(2912);
   ...
   ptstats_LaTex = ptstats->AddText("Mean  = 0.6084");
   ptstats_LaTex = ptstats->AddText("Std Dev   = 0.3356");
