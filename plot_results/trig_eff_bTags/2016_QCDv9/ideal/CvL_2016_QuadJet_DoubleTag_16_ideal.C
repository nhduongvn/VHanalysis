...
//=========  (Thu Apr 27 10:19:48 2023) by ROOT version 6.26/06
   ...
   CvL_2016_QuadJet_DoubleTag_16_ideal->Range(-0.2183529,0.0159101,1.171633,0.03728217);
   ...
   _QuadJet_DoubleTag_ideal_CvL__304->SetBinContent(1,0.01923077);
   _QuadJet_DoubleTag_ideal_CvL__304->SetBinContent(2,0.02904564);
   _QuadJet_DoubleTag_ideal_CvL__304->SetBinContent(3,0.03092784);
   _QuadJet_DoubleTag_ideal_CvL__304->SetBinContent(4,0.02643172);
   _QuadJet_DoubleTag_ideal_CvL__304->SetBinContent(5,0.03271028);
   _QuadJet_DoubleTag_ideal_CvL__304->SetBinContent(6,0.0203252);
   _QuadJet_DoubleTag_ideal_CvL__304->SetBinContent(7,0.03435115);
   _QuadJet_DoubleTag_ideal_CvL__304->SetBinContent(8,0.02133333);
   _QuadJet_DoubleTag_ideal_CvL__304->SetBinContent(9,0.03057554);
   _QuadJet_DoubleTag_ideal_CvL__304->SetBinContent(10,0.02302923);
   _QuadJet_DoubleTag_ideal_CvL__304->SetEntries(0.2679607);
   ...
   ptstats_LaTex = ptstats->AddText("Std Dev   = 0.2774");
