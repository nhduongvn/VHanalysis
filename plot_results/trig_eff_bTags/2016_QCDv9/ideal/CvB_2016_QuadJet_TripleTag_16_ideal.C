...
//=========  (Thu Apr 27 10:19:48 2023) by ROOT version 6.26/06
   ...
   CvB_2016_QuadJet_TripleTag_16_ideal->Range(-0.2183529,0.6743473,1.171633,0.9257876);
   ...
   _QuadJet_TripleTag_ideal_CvB__313->SetBinContent(1,0.8002429);
   _QuadJet_TripleTag_ideal_CvB__313->SetBinContent(2,0.7430939);
   _QuadJet_TripleTag_ideal_CvB__313->SetBinContent(3,0.7236467);
   _QuadJet_TripleTag_ideal_CvB__313->SetBinContent(4,0.7134146);
   _QuadJet_TripleTag_ideal_CvB__313->SetBinContent(5,0.7714286);
   _QuadJet_TripleTag_ideal_CvB__313->SetBinContent(6,0.7548077);
   _QuadJet_TripleTag_ideal_CvB__313->SetBinContent(7,0.7739726);
   _QuadJet_TripleTag_ideal_CvB__313->SetBinContent(8,0.8242424);
   _QuadJet_TripleTag_ideal_CvB__313->SetBinContent(9,0.8641115);
   _QuadJet_TripleTag_ideal_CvB__313->SetBinContent(10,0.8913043);
   _QuadJet_TripleTag_ideal_CvB__313->SetEntries(7.860265);
   ...
   ptstats_LaTex = ptstats->AddText("Mean  = 0.5149");
