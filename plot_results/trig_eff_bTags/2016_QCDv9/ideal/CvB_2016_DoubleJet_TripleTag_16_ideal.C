...
//=========  (Thu Apr 27 10:19:48 2023) by ROOT version 6.26/06
   ...
   CvB_2016_DoubleJet_TripleTag_16_ideal->Range(-0.2183529,0.7260491,1.171633,0.9065762);
   ...
   _DoubleJet_TripleTag_ideal_CvB__319->SetBinContent(1,0.8518519);
   _DoubleJet_TripleTag_ideal_CvB__319->SetBinContent(2,0.7854545);
   _DoubleJet_TripleTag_ideal_CvB__319->SetBinContent(3,0.784);
   _DoubleJet_TripleTag_ideal_CvB__319->SetBinContent(4,0.7540984);
   _DoubleJet_TripleTag_ideal_CvB__319->SetBinContent(5,0.8134715);
   _DoubleJet_TripleTag_ideal_CvB__319->SetBinContent(6,0.7823129);
   _DoubleJet_TripleTag_ideal_CvB__319->SetBinContent(7,0.853211);
   _DoubleJet_TripleTag_ideal_CvB__319->SetBinContent(8,0.8372093);
   _DoubleJet_TripleTag_ideal_CvB__319->SetBinContent(9,0.8625);
   _DoubleJet_TripleTag_ideal_CvB__319->SetBinContent(10,0.8818182);
   _DoubleJet_TripleTag_ideal_CvB__319->SetEntries(8.205928);
   ...
   ptstats_LaTex = ptstats->AddText("Std Dev   = 0.2908");
