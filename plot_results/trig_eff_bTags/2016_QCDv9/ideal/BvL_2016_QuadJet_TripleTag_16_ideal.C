...
//=========  (Thu Apr 27 10:19:48 2023) by ROOT version 6.26/06
   ...
   BvL_2016_QuadJet_TripleTag_16_ideal->Range(-0.2183529,0.6560186,1.171633,0.8909492);
   ...
   _QuadJet_TripleTag_ideal_BvL__289->SetBinContent(1,0.8587302);
   _QuadJet_TripleTag_ideal_BvL__289->SetBinContent(2,0.8571429);
   _QuadJet_TripleTag_ideal_BvL__289->SetBinContent(3,0.7924528);
   _QuadJet_TripleTag_ideal_BvL__289->SetBinContent(4,0.6925208);
   _QuadJet_TripleTag_ideal_BvL__289->SetBinContent(5,0.7007299);
   _QuadJet_TripleTag_ideal_BvL__289->SetBinContent(6,0.7165992);
   _QuadJet_TripleTag_ideal_BvL__289->SetBinContent(7,0.7714286);
   _QuadJet_TripleTag_ideal_BvL__289->SetBinContent(8,0.8101266);
   _QuadJet_TripleTag_ideal_BvL__289->SetBinContent(9,0.7414449);
   _QuadJet_TripleTag_ideal_BvL__289->SetBinContent(10,0.8035019);
   _QuadJet_TripleTag_ideal_BvL__289->SetEntries(7.744678);
   ...
   ptstats_LaTex = ptstats->AddText("Std Dev   = 0.2939");
