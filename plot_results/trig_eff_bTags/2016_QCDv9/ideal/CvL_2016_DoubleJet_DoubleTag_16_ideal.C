...
//=========  (Thu Apr 27 10:19:48 2023) by ROOT version 6.26/06
   ...
   CvL_2016_DoubleJet_DoubleTag_16_ideal->Range(-0.2183529,0.01972646,1.171633,0.05993625);
   ...
   _DoubleJet_DoubleTag_ideal_CvL__310->SetBinContent(1,0.0388601);
   _DoubleJet_DoubleTag_ideal_CvL__310->SetBinContent(2,0.035);
   _DoubleJet_DoubleTag_ideal_CvL__310->SetBinContent(3,0.02597403);
   _DoubleJet_DoubleTag_ideal_CvL__310->SetBinContent(4,0.0295858);
   _DoubleJet_DoubleTag_ideal_CvL__310->SetBinContent(5,0.05442177);
   _DoubleJet_DoubleTag_ideal_CvL__310->SetBinContent(6,0.03592814);
   _DoubleJet_DoubleTag_ideal_CvL__310->SetBinContent(7,0.02747253);
   _DoubleJet_DoubleTag_ideal_CvL__310->SetBinContent(8,0.0326087);
   _DoubleJet_DoubleTag_ideal_CvL__310->SetBinContent(9,0.03517588);
   _DoubleJet_DoubleTag_ideal_CvL__310->SetBinContent(10,0.04681873);
   _DoubleJet_DoubleTag_ideal_CvL__310->SetEntries(0.3618457);
   ...
   ptstats_LaTex = ptstats->AddText("Mean  = 0.5112");
   ptstats_LaTex = ptstats->AddText("Std Dev   =  0.293");
