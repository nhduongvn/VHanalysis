...
#endif
void CutFlow_TT_tagFirst_18_logY()
{
...
//=========  (Thu May 23 15:31:42 2024) by ROOT version 6.28/10
   ...
   CutFlow_TT_tagFirst_18->Range(-1.2,4.927441,6.8,8.313197);
   ...
   CutFlow_TT_tagFirst_18->SetLogy();
   ...
   CutFlow_evt_tagFirst__18->SetBinContent(2,4.721103e+07);
   CutFlow_evt_tagFirst__18->SetBinContent(3,1.515919e+07);
   CutFlow_evt_tagFirst__18->SetBinContent(4,1284611);
   CutFlow_evt_tagFirst__18->SetBinContent(5,369017.5);
   CutFlow_evt_tagFirst__18->SetBinError(1,1758.551);
   CutFlow_evt_tagFirst__18->SetBinError(2,1722.958);
   CutFlow_evt_tagFirst__18->SetBinError(3,1030.144);
   CutFlow_evt_tagFirst__18->SetBinError(4,300.583);
   CutFlow_evt_tagFirst__18->SetBinError(5,162.7419);
   CutFlow_evt_tagFirst__18->SetEntries(1.909494e+09);
