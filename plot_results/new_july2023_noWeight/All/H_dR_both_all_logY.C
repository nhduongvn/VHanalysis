...
// ------------>Primitives in pad: topPad
   ...
   topPad->Draw();
   topPad->cd();
   topPad->Range(-0.9499975,-1.356964,6.525,12.60171);
   ...
   st->SetTitle("");
   st->SetMinimum(0.3);
   st->SetMaximum(4.952527e+10);
   
   TH1F *st_stack_216 = new TH1F("st_stack_216","",30,0,6);
   st_stack_216->SetMinimum(0.04539366);
   st_stack_216->SetMaximum(1.606373e+11);
   ...
   Graph_Graph_from_VbbHcc_both_H_dR_all1431->SetMinimum(75.81671);
