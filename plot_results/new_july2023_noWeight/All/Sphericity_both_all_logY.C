...
// ------------>Primitives in pad: topPad
   ...
   topPad->Draw();
   topPad->cd();
   topPad->Range(-0.1532254,-1.375923,1.052419,13.25218);
   ...
   st->SetTitle("");
   st->SetMinimum(0.3);
   st->SetMaximum(1.833931e+11);
   
   TH1F *st_stack_252 = new TH1F("st_stack_252","",25,0,1);
   st_stack_252->SetMinimum(0.04352159);
   st_stack_252->SetMaximum(6.156971e+11);
   ...
   VbbHcc_both_Sphericity_all__692->SetBinContent(1,86726);
   VbbHcc_both_Sphericity_all__692->SetBinContent(2,88307);
   VbbHcc_both_Sphericity_all__692->SetBinContent(3,65855);
   VbbHcc_both_Sphericity_all__692->SetBinContent(4,49736);
   VbbHcc_both_Sphericity_all__692->SetBinContent(5,39070);
   VbbHcc_both_Sphericity_all__692->SetBinContent(6,31358);
   VbbHcc_both_Sphericity_all__692->SetBinContent(7,25794);
   VbbHcc_both_Sphericity_all__692->SetBinContent(8,21281);
   VbbHcc_both_Sphericity_all__692->SetBinContent(9,17658);
   VbbHcc_both_Sphericity_all__692->SetBinContent(10,14824);
   VbbHcc_both_Sphericity_all__692->SetBinContent(11,12724);
   VbbHcc_both_Sphericity_all__692->SetBinContent(12,10823);
   VbbHcc_both_Sphericity_all__692->SetBinContent(13,9329);
   VbbHcc_both_Sphericity_all__692->SetBinContent(14,7462);
   VbbHcc_both_Sphericity_all__692->SetBinContent(15,6288);
   VbbHcc_both_Sphericity_all__692->SetBinContent(16,4798);
   VbbHcc_both_Sphericity_all__692->SetBinContent(17,3827);
   VbbHcc_both_Sphericity_all__692->SetBinContent(18,2766);
   VbbHcc_both_Sphericity_all__692->SetBinContent(19,1548);
   VbbHcc_both_Sphericity_all__692->SetBinContent(20,639);
   VbbHcc_both_Sphericity_all__692->SetBinContent(21,242);
   VbbHcc_both_Sphericity_all__692->SetBinContent(22,78);
   ...
   VbbHcc_both_Sphericity_all__692->SetEntries(501189);
...
// ------------>Primitives in pad: bottomPad
   ...
   data_mc_ratio__693->SetBinContent(1,0.8591397);
   data_mc_ratio__693->SetBinContent(2,0.754176);
   data_mc_ratio__693->SetBinContent(3,0.7665066);
   data_mc_ratio__693->SetBinContent(4,0.6756628);
   data_mc_ratio__693->SetBinContent(5,0.745182);
   data_mc_ratio__693->SetBinContent(6,0.7377298);
   data_mc_ratio__693->SetBinContent(7,0.6983965);
   data_mc_ratio__693->SetBinContent(8,0.9919655);
   data_mc_ratio__693->SetBinContent(9,0.3354657);
   data_mc_ratio__693->SetBinContent(10,0.6898464);
   data_mc_ratio__693->SetBinContent(11,0.8313677);
   data_mc_ratio__693->SetBinContent(12,0.6974496);
   data_mc_ratio__693->SetBinContent(13,0.8599083);
   data_mc_ratio__693->SetBinContent(14,0.8741215);
   data_mc_ratio__693->SetBinContent(15,0.7069786);
   data_mc_ratio__693->SetBinContent(16,0.8394594);
   data_mc_ratio__693->SetBinContent(17,0.7122447);
   data_mc_ratio__693->SetBinContent(18,0.8086867);
   data_mc_ratio__693->SetBinContent(19,0.9788778);
   data_mc_ratio__693->SetBinContent(20,0.5905123);
   data_mc_ratio__693->SetBinContent(21,0.4274769);
   data_mc_ratio__693->SetBinContent(22,0.5657103);
   data_mc_ratio__693->SetBinContent(23,0.09183393);
   data_mc_ratio__693->SetBinContent(24,11.99025);
   data_mc_ratio__693->SetBinContent(25,8.0379);
   data_mc_ratio__693->SetBinError(1,0.002917354);
   data_mc_ratio__693->SetBinError(2,0.002537904);
   data_mc_ratio__693->SetBinError(3,0.002986906);
   data_mc_ratio__693->SetBinError(4,0.003029665);
   data_mc_ratio__693->SetBinError(5,0.003769994);
   data_mc_ratio__693->SetBinError(6,0.004166037);
   data_mc_ratio__693->SetBinError(7,0.004348532);
   data_mc_ratio__693->SetBinError(8,0.006799869);
   data_mc_ratio__693->SetBinError(9,0.002524512);
   data_mc_ratio__693->SetBinError(10,0.00566591);
   data_mc_ratio__693->SetBinError(11,0.007370235);
   data_mc_ratio__693->SetBinError(12,0.006704078);
   data_mc_ratio__693->SetBinError(13,0.008902963);
   data_mc_ratio__693->SetBinError(14,0.01011915);
   data_mc_ratio__693->SetBinError(15,0.008915588);
   data_mc_ratio__693->SetBinError(16,0.01211908);
   data_mc_ratio__693->SetBinError(17,0.0115133);
   data_mc_ratio__693->SetBinError(18,0.01537638);
   data_mc_ratio__693->SetBinError(19,0.02487958);
   data_mc_ratio__693->SetBinError(20,0.0233603);
   data_mc_ratio__693->SetBinError(21,0.02747926);
   data_mc_ratio__693->SetBinError(22,0.06405408);
   data_mc_ratio__693->SetBinError(23,0.01767345);
   data_mc_ratio__693->SetBinError(24,5.995125);
   data_mc_ratio__693->SetBinError(25,8.0379);
   data_mc_ratio__693->SetMinimum(0.4);
   data_mc_ratio__693->SetMaximum(1.6);
   data_mc_ratio__693->SetEntries(8.483613);
