...
// ------------>Primitives in pad: topPad
   ...
   VbbHcc_both_H_dR_Bj0_all__471->SetBinContent(1,18991);
   VbbHcc_both_H_dR_Bj0_all__471->SetBinContent(2,63091);
   VbbHcc_both_H_dR_Bj0_all__471->SetBinContent(3,63351);
   VbbHcc_both_H_dR_Bj0_all__471->SetBinContent(4,49858);
   VbbHcc_both_H_dR_Bj0_all__471->SetBinContent(5,40981);
   VbbHcc_both_H_dR_Bj0_all__471->SetBinContent(6,34481);
   VbbHcc_both_H_dR_Bj0_all__471->SetBinContent(7,29350);
   VbbHcc_both_H_dR_Bj0_all__471->SetBinContent(8,25598);
   VbbHcc_both_H_dR_Bj0_all__471->SetBinContent(9,23046);
   VbbHcc_both_H_dR_Bj0_all__471->SetBinContent(10,20790);
   VbbHcc_both_H_dR_Bj0_all__471->SetBinContent(11,19360);
   VbbHcc_both_H_dR_Bj0_all__471->SetBinContent(12,17991);
   VbbHcc_both_H_dR_Bj0_all__471->SetBinContent(13,17019);
   VbbHcc_both_H_dR_Bj0_all__471->SetBinContent(14,16464);
   VbbHcc_both_H_dR_Bj0_all__471->SetBinContent(15,15852);
   VbbHcc_both_H_dR_Bj0_all__471->SetBinContent(16,14676);
   VbbHcc_both_H_dR_Bj0_all__471->SetBinContent(17,9387);
   VbbHcc_both_H_dR_Bj0_all__471->SetBinContent(18,6438);
   VbbHcc_both_H_dR_Bj0_all__471->SetBinContent(19,4588);
   VbbHcc_both_H_dR_Bj0_all__471->SetBinContent(20,3257);
   VbbHcc_both_H_dR_Bj0_all__471->SetBinContent(21,2269);
   VbbHcc_both_H_dR_Bj0_all__471->SetBinContent(22,1595);
   VbbHcc_both_H_dR_Bj0_all__471->SetBinContent(23,1049);
   VbbHcc_both_H_dR_Bj0_all__471->SetBinContent(24,655);
   VbbHcc_both_H_dR_Bj0_all__471->SetBinContent(25,391);
   VbbHcc_both_H_dR_Bj0_all__471->SetBinContent(26,286);
   VbbHcc_both_H_dR_Bj0_all__471->SetBinContent(27,127);
   VbbHcc_both_H_dR_Bj0_all__471->SetBinContent(28,95);
   VbbHcc_both_H_dR_Bj0_all__471->SetBinContent(29,54);
   VbbHcc_both_H_dR_Bj0_all__471->SetBinContent(30,28);
   VbbHcc_both_H_dR_Bj0_all__471->SetBinContent(31,47);
   VbbHcc_both_H_dR_Bj0_all__471->SetEntries(501194);
...
// ------------>Primitives in pad: bottomPad
   ...
   data_mc_ratio__472->SetBinContent(1,0.8944364);
   data_mc_ratio__472->SetBinContent(2,0.597712);
   data_mc_ratio__472->SetBinContent(3,0.7409473);
   data_mc_ratio__472->SetBinContent(4,0.770946);
   data_mc_ratio__472->SetBinContent(5,0.7153234);
   data_mc_ratio__472->SetBinContent(6,0.8145555);
   data_mc_ratio__472->SetBinContent(7,0.7626325);
   data_mc_ratio__472->SetBinContent(8,0.7872557);
   data_mc_ratio__472->SetBinContent(9,0.491135);
   data_mc_ratio__472->SetBinContent(10,0.8189085);
   data_mc_ratio__472->SetBinContent(11,0.8222528);
   data_mc_ratio__472->SetBinContent(12,0.6449855);
   data_mc_ratio__472->SetBinContent(13,0.7496556);
   data_mc_ratio__472->SetBinContent(14,0.7578757);
   data_mc_ratio__472->SetBinContent(15,0.9872106);
   data_mc_ratio__472->SetBinContent(16,0.873397);
   data_mc_ratio__472->SetBinContent(17,0.9121231);
   data_mc_ratio__472->SetBinContent(18,1.023057);
   data_mc_ratio__472->SetBinContent(19,0.9267321);
   data_mc_ratio__472->SetBinContent(20,0.745343);
   data_mc_ratio__472->SetBinContent(21,1.000043);
   data_mc_ratio__472->SetBinContent(22,0.6319003);
   data_mc_ratio__472->SetBinContent(23,0.6100079);
   data_mc_ratio__472->SetBinContent(24,1.140924);
   data_mc_ratio__472->SetBinContent(25,2.499337);
   data_mc_ratio__472->SetBinContent(26,0.8438509);
   data_mc_ratio__472->SetBinContent(27,2.128113);
   data_mc_ratio__472->SetBinContent(28,1.246655);
   data_mc_ratio__472->SetBinContent(29,1.455649);
   data_mc_ratio__472->SetBinContent(30,9.24793);
   data_mc_ratio__472->SetBinContent(31,9.356103);
   data_mc_ratio__472->SetBinError(1,0.006490461);
   data_mc_ratio__472->SetBinError(2,0.002379624);
   data_mc_ratio__472->SetBinError(3,0.002943815);
   data_mc_ratio__472->SetBinError(4,0.003452682);
   data_mc_ratio__472->SetBinError(5,0.003533549);
   data_mc_ratio__472->SetBinError(6,0.004386627);
   data_mc_ratio__472->SetBinError(7,0.00445155);
   data_mc_ratio__472->SetBinError(8,0.00492054);
   data_mc_ratio__472->SetBinError(9,0.003235215);
   data_mc_ratio__472->SetBinError(10,0.005679475);
   data_mc_ratio__472->SetBinError(11,0.005909526);
   data_mc_ratio__472->SetBinError(12,0.00480864);
   data_mc_ratio__472->SetBinError(13,0.005746386);
   data_mc_ratio__472->SetBinError(14,0.005906501);
   data_mc_ratio__472->SetBinError(15,0.007840934);
   data_mc_ratio__472->SetBinError(16,0.007209545);
   data_mc_ratio__472->SetBinError(17,0.009414343);
   data_mc_ratio__472->SetBinError(18,0.01275041);
   data_mc_ratio__472->SetBinError(19,0.01368178);
   data_mc_ratio__472->SetBinError(20,0.01306012);
   data_mc_ratio__472->SetBinError(21,0.02099429);
   data_mc_ratio__472->SetBinError(22,0.01582225);
   data_mc_ratio__472->SetBinError(23,0.01883422);
   data_mc_ratio__472->SetBinError(24,0.04457957);
   data_mc_ratio__472->SetBinError(25,0.1263969);
   data_mc_ratio__472->SetBinError(26,0.04989795);
   data_mc_ratio__472->SetBinError(27,0.1888395);
   data_mc_ratio__472->SetBinError(28,0.1279041);
   data_mc_ratio__472->SetBinError(29,0.1980888);
   data_mc_ratio__472->SetBinError(30,1.747694);
   data_mc_ratio__472->SetBinError(31,1.798119);
   data_mc_ratio__472->SetMinimum(0.4);
   data_mc_ratio__472->SetMaximum(1.6);
   data_mc_ratio__472->SetEntries(141.0093);
