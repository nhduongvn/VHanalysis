...
// ------------>Primitives in pad: topPad
   ...
   topPad->Draw();
   topPad->cd();
   topPad->Range(-0.9193524,-206.2076,6.314516,206301.4);
   ...
   VbbHcc_tags_H_dR_Bj0_all__87->SetBinContent(1,14654);
   VbbHcc_tags_H_dR_Bj0_all__87->SetBinContent(2,57394);
   VbbHcc_tags_H_dR_Bj0_all__87->SetBinContent(3,58276);
   VbbHcc_tags_H_dR_Bj0_all__87->SetBinContent(4,48268);
   VbbHcc_tags_H_dR_Bj0_all__87->SetBinContent(5,40730);
   VbbHcc_tags_H_dR_Bj0_all__87->SetBinContent(6,33500);
   VbbHcc_tags_H_dR_Bj0_all__87->SetBinContent(7,28237);
   VbbHcc_tags_H_dR_Bj0_all__87->SetBinContent(8,24528);
   VbbHcc_tags_H_dR_Bj0_all__87->SetBinContent(9,21613);
   VbbHcc_tags_H_dR_Bj0_all__87->SetBinContent(10,19590);
   VbbHcc_tags_H_dR_Bj0_all__87->SetBinContent(11,17882);
   VbbHcc_tags_H_dR_Bj0_all__87->SetBinContent(12,16621);
   VbbHcc_tags_H_dR_Bj0_all__87->SetBinContent(13,15117);
   VbbHcc_tags_H_dR_Bj0_all__87->SetBinContent(14,13697);
   VbbHcc_tags_H_dR_Bj0_all__87->SetBinContent(15,12611);
   VbbHcc_tags_H_dR_Bj0_all__87->SetBinContent(16,10879);
   VbbHcc_tags_H_dR_Bj0_all__87->SetBinContent(17,8888);
   VbbHcc_tags_H_dR_Bj0_all__87->SetBinContent(18,7416);
   VbbHcc_tags_H_dR_Bj0_all__87->SetBinContent(19,6048);
   VbbHcc_tags_H_dR_Bj0_all__87->SetBinContent(20,5153);
   VbbHcc_tags_H_dR_Bj0_all__87->SetBinContent(21,4160);
   VbbHcc_tags_H_dR_Bj0_all__87->SetBinContent(22,3400);
   VbbHcc_tags_H_dR_Bj0_all__87->SetBinContent(23,2796);
   VbbHcc_tags_H_dR_Bj0_all__87->SetBinContent(24,2198);
   VbbHcc_tags_H_dR_Bj0_all__87->SetBinContent(25,1668);
   VbbHcc_tags_H_dR_Bj0_all__87->SetBinContent(26,1304);
   VbbHcc_tags_H_dR_Bj0_all__87->SetBinContent(27,924);
   VbbHcc_tags_H_dR_Bj0_all__87->SetBinContent(28,663);
   VbbHcc_tags_H_dR_Bj0_all__87->SetBinContent(29,397);
   VbbHcc_tags_H_dR_Bj0_all__87->SetBinContent(30,266);
   VbbHcc_tags_H_dR_Bj0_all__87->SetBinContent(31,433);
   VbbHcc_tags_H_dR_Bj0_all__87->SetEntries(479340);
...
// ------------>Primitives in pad: bottomPad
   ...
   data_mc_ratio__88->SetBinContent(1,0.9794194);
   data_mc_ratio__88->SetBinContent(2,0.7866668);
   data_mc_ratio__88->SetBinContent(3,0.7324368);
   data_mc_ratio__88->SetBinContent(4,0.7186154);
   data_mc_ratio__88->SetBinContent(5,0.814786);
   data_mc_ratio__88->SetBinContent(6,0.5514813);
   data_mc_ratio__88->SetBinContent(7,0.6735079);
   data_mc_ratio__88->SetBinContent(8,0.6778478);
   data_mc_ratio__88->SetBinContent(9,0.6892909);
   data_mc_ratio__88->SetBinContent(10,0.7618775);
   data_mc_ratio__88->SetBinContent(11,0.7945221);
   data_mc_ratio__88->SetBinContent(12,0.6825244);
   data_mc_ratio__88->SetBinContent(13,0.6574193);
   data_mc_ratio__88->SetBinContent(14,0.7522726);
   data_mc_ratio__88->SetBinContent(15,0.8001883);
   data_mc_ratio__88->SetBinContent(16,0.7100814);
   data_mc_ratio__88->SetBinContent(17,0.8469635);
   data_mc_ratio__88->SetBinContent(18,0.876113);
   data_mc_ratio__88->SetBinContent(19,0.2672025);
   data_mc_ratio__88->SetBinContent(20,1.299268);
   data_mc_ratio__88->SetBinContent(21,0.8864187);
   data_mc_ratio__88->SetBinContent(22,1.208359);
   data_mc_ratio__88->SetBinContent(23,0.5676403);
   data_mc_ratio__88->SetBinContent(24,0.9800988);
   data_mc_ratio__88->SetBinContent(25,0.6997749);
   data_mc_ratio__88->SetBinContent(26,1.322311);
   data_mc_ratio__88->SetBinContent(27,1.006324);
   data_mc_ratio__88->SetBinContent(28,0.9027186);
   data_mc_ratio__88->SetBinContent(29,2.989241);
   data_mc_ratio__88->SetBinContent(30,1.257586);
   data_mc_ratio__88->SetBinContent(31,1.23758);
   data_mc_ratio__88->SetBinError(1,0.008090784);
   data_mc_ratio__88->SetBinError(2,0.003283655);
   data_mc_ratio__88->SetBinError(3,0.003034068);
   data_mc_ratio__88->SetBinError(4,0.003270897);
   data_mc_ratio__88->SetBinError(5,0.004037257);
   data_mc_ratio__88->SetBinError(6,0.003013064);
   data_mc_ratio__88->SetBinError(7,0.004008053);
   data_mc_ratio__88->SetBinError(8,0.004328138);
   data_mc_ratio__88->SetBinError(9,0.00468862);
   data_mc_ratio__88->SetBinError(10,0.005443371);
   data_mc_ratio__88->SetBinError(11,0.005941525);
   data_mc_ratio__88->SetBinError(12,0.005294069);
   data_mc_ratio__88->SetBinError(13,0.005346994);
   data_mc_ratio__88->SetBinError(14,0.006427802);
   data_mc_ratio__88->SetBinError(15,0.007125534);
   data_mc_ratio__88->SetBinError(16,0.006807907);
   data_mc_ratio__88->SetBinError(17,0.008983854);
   data_mc_ratio__88->SetBinError(18,0.01017361);
   data_mc_ratio__88->SetBinError(19,0.003435853);
   data_mc_ratio__88->SetBinError(20,0.01809958);
   data_mc_ratio__88->SetBinError(21,0.01374334);
   data_mc_ratio__88->SetBinError(22,0.02072318);
   data_mc_ratio__88->SetBinError(23,0.01073506);
   data_mc_ratio__88->SetBinError(24,0.02090528);
   data_mc_ratio__88->SetBinError(25,0.01713406);
   data_mc_ratio__88->SetBinError(26,0.03661801);
   data_mc_ratio__88->SetBinError(27,0.03310564);
   data_mc_ratio__88->SetBinError(28,0.03505869);
   data_mc_ratio__88->SetBinError(29,0.1500257);
   data_mc_ratio__88->SetBinError(30,0.07710755);
   data_mc_ratio__88->SetBinError(31,0.3091332);
   data_mc_ratio__88->SetMinimum(0.4);
   data_mc_ratio__88->SetMaximum(1.6);
   data_mc_ratio__88->SetEntries(491.5614);
