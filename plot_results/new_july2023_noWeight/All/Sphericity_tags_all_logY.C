...
// ------------>Primitives in pad: topPad
   ...
   topPad->Draw();
   topPad->cd();
   topPad->Range(-0.1532254,-1.39645,1.052419,13.98607);
   ...
   st->SetTitle("");
   st->SetMinimum(0.3);
   st->SetMaximum(8.045112e+11);
   
   TH1F *st_stack_60 = new TH1F("st_stack_60","",25,0,1);
   st_stack_60->SetMinimum(0.04158462);
   st_stack_60->SetMaximum(2.80427e+12);
   ...
   Graph_Graph_from_VbbHcc_tags_Sphericity_all1119->SetMinimum(268.42);
