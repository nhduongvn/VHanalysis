...
// ------------>Primitives in pad: topPad
   ...
   VbbHcc_both_H_dR_Bj1_all__479->SetBinContent(1,29404);
   VbbHcc_both_H_dR_Bj1_all__479->SetBinContent(2,76553);
   VbbHcc_both_H_dR_Bj1_all__479->SetBinContent(3,71098);
   VbbHcc_both_H_dR_Bj1_all__479->SetBinContent(4,55497);
   VbbHcc_both_H_dR_Bj1_all__479->SetBinContent(5,43499);
   VbbHcc_both_H_dR_Bj1_all__479->SetBinContent(6,35076);
   VbbHcc_both_H_dR_Bj1_all__479->SetBinContent(7,28319);
   VbbHcc_both_H_dR_Bj1_all__479->SetBinContent(8,23628);
   VbbHcc_both_H_dR_Bj1_all__479->SetBinContent(9,20305);
   VbbHcc_both_H_dR_Bj1_all__479->SetBinContent(10,18018);
   VbbHcc_both_H_dR_Bj1_all__479->SetBinContent(11,16001);
   VbbHcc_both_H_dR_Bj1_all__479->SetBinContent(12,14678);
   VbbHcc_both_H_dR_Bj1_all__479->SetBinContent(13,13431);
   VbbHcc_both_H_dR_Bj1_all__479->SetBinContent(14,12677);
   VbbHcc_both_H_dR_Bj1_all__479->SetBinContent(15,11963);
   VbbHcc_both_H_dR_Bj1_all__479->SetBinContent(16,11042);
   VbbHcc_both_H_dR_Bj1_all__479->SetBinContent(17,6345);
   VbbHcc_both_H_dR_Bj1_all__479->SetBinContent(18,4352);
   VbbHcc_both_H_dR_Bj1_all__479->SetBinContent(19,2977);
   VbbHcc_both_H_dR_Bj1_all__479->SetBinContent(20,2085);
   VbbHcc_both_H_dR_Bj1_all__479->SetBinContent(21,1453);
   VbbHcc_both_H_dR_Bj1_all__479->SetBinContent(22,997);
   VbbHcc_both_H_dR_Bj1_all__479->SetBinContent(23,665);
   VbbHcc_both_H_dR_Bj1_all__479->SetBinContent(24,458);
   VbbHcc_both_H_dR_Bj1_all__479->SetBinContent(25,270);
   VbbHcc_both_H_dR_Bj1_all__479->SetBinContent(26,162);
   VbbHcc_both_H_dR_Bj1_all__479->SetBinContent(27,82);
   VbbHcc_both_H_dR_Bj1_all__479->SetBinContent(28,46);
   VbbHcc_both_H_dR_Bj1_all__479->SetBinContent(29,22);
   VbbHcc_both_H_dR_Bj1_all__479->SetBinContent(30,27);
   VbbHcc_both_H_dR_Bj1_all__479->SetBinContent(31,35);
   VbbHcc_both_H_dR_Bj1_all__479->SetEntries(501194);
...
// ------------>Primitives in pad: bottomPad
   ...
   data_mc_ratio__480->SetBinContent(1,0.8876727);
   data_mc_ratio__480->SetBinContent(2,0.5804047);
   data_mc_ratio__480->SetBinContent(3,0.7933617);
   data_mc_ratio__480->SetBinContent(4,0.7711472);
   data_mc_ratio__480->SetBinContent(5,0.7894693);
   data_mc_ratio__480->SetBinContent(6,0.7576223);
   data_mc_ratio__480->SetBinContent(7,0.7324542);
   data_mc_ratio__480->SetBinContent(8,0.8607895);
   data_mc_ratio__480->SetBinContent(9,0.7833477);
   data_mc_ratio__480->SetBinContent(10,0.6595357);
   data_mc_ratio__480->SetBinContent(11,0.6728598);
   data_mc_ratio__480->SetBinContent(12,0.7683058);
   data_mc_ratio__480->SetBinContent(13,0.8086111);
   data_mc_ratio__480->SetBinContent(14,0.6947735);
   data_mc_ratio__480->SetBinContent(15,0.6966232);
   data_mc_ratio__480->SetBinContent(16,0.7914947);
   data_mc_ratio__480->SetBinContent(17,0.9774998);
   data_mc_ratio__480->SetBinContent(18,0.6328441);
   data_mc_ratio__480->SetBinContent(19,0.9791019);
   data_mc_ratio__480->SetBinContent(20,0.9380741);
   data_mc_ratio__480->SetBinContent(21,0.374073);
   data_mc_ratio__480->SetBinContent(22,0.8055952);
   data_mc_ratio__480->SetBinContent(23,0.6699746);
   data_mc_ratio__480->SetBinContent(24,0.9157625);
   data_mc_ratio__480->SetBinContent(25,1.204611);
   data_mc_ratio__480->SetBinContent(26,2.246331);
   data_mc_ratio__480->SetBinContent(27,0.1862414);
   data_mc_ratio__480->SetBinContent(28,1.554438);
   data_mc_ratio__480->SetBinContent(29,0.7924745);
   data_mc_ratio__480->SetBinContent(30,17.04631);
   data_mc_ratio__480->SetBinContent(31,1.338609);
   data_mc_ratio__480->SetBinError(1,0.00517666);
   data_mc_ratio__480->SetBinError(2,0.002097731);
   data_mc_ratio__480->SetBinError(3,0.002975381);
   data_mc_ratio__480->SetBinError(4,0.003273426);
   data_mc_ratio__480->SetBinError(5,0.003785259);
   data_mc_ratio__480->SetBinError(6,0.004045272);
   data_mc_ratio__480->SetBinError(7,0.004352527);
   data_mc_ratio__480->SetBinError(8,0.005599942);
   data_mc_ratio__480->SetBinError(9,0.005497346);
   data_mc_ratio__480->SetBinError(10,0.004913433);
   data_mc_ratio__480->SetBinError(11,0.005319258);
   data_mc_ratio__480->SetBinError(12,0.006341627);
   data_mc_ratio__480->SetBinError(13,0.00697727);
   data_mc_ratio__480->SetBinError(14,0.006170708);
   data_mc_ratio__480->SetBinError(15,0.006369097);
   data_mc_ratio__480->SetBinError(16,0.00753224);
   data_mc_ratio__480->SetBinError(17,0.01227159);
   data_mc_ratio__480->SetBinError(18,0.009592952);
   data_mc_ratio__480->SetBinError(19,0.01794479);
   data_mc_ratio__480->SetBinError(20,0.02054396);
   data_mc_ratio__480->SetBinError(21,0.00981349);
   data_mc_ratio__480->SetBinError(22,0.02551346);
   data_mc_ratio__480->SetBinError(23,0.0259805);
   data_mc_ratio__480->SetBinError(24,0.04279077);
   data_mc_ratio__480->SetBinError(25,0.07331028);
   data_mc_ratio__480->SetBinError(26,0.1764885);
   data_mc_ratio__480->SetBinError(27,0.02056692);
   data_mc_ratio__480->SetBinError(28,0.2291894);
   data_mc_ratio__480->SetBinError(29,0.1689561);
   data_mc_ratio__480->SetBinError(30,3.280564);
   data_mc_ratio__480->SetBinError(31,1.152761);
   data_mc_ratio__480->SetMinimum(0.4);
   data_mc_ratio__480->SetMaximum(1.6);
   data_mc_ratio__480->SetEntries(67.54763);
