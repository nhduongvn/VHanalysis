...
// ------------>Primitives in pad: topPad
   ...
   topPad->Draw();
   topPad->cd();
   topPad->Range(-0.1532254,-1.464159,1.052419,16.64179);
   ...
   st->SetTitle("");
   st->SetMinimum(0.3);
   st->SetMaximum(1.71569e+14);
   
   TH1F *st_stack_156 = new TH1F("st_stack_156","",25,0,1);
   st_stack_156->SetMinimum(0.03580525);
   st_stack_156->SetMaximum(6.779486e+14);
   ...
   VbbHcc_algo_Sphericity_all__428->SetBinContent(1,1089037);
   VbbHcc_algo_Sphericity_all__428->SetBinContent(2,994983);
   VbbHcc_algo_Sphericity_all__428->SetBinContent(3,569534);
   VbbHcc_algo_Sphericity_all__428->SetBinContent(4,316769);
   VbbHcc_algo_Sphericity_all__428->SetBinContent(5,162598);
   VbbHcc_algo_Sphericity_all__428->SetBinContent(6,70360);
   VbbHcc_algo_Sphericity_all__428->SetBinContent(7,25443);
   VbbHcc_algo_Sphericity_all__428->SetBinContent(8,9444);
   VbbHcc_algo_Sphericity_all__428->SetBinContent(9,4135);
   VbbHcc_algo_Sphericity_all__428->SetBinContent(10,2214);
   VbbHcc_algo_Sphericity_all__428->SetBinContent(11,1263);
   VbbHcc_algo_Sphericity_all__428->SetBinContent(12,833);
   VbbHcc_algo_Sphericity_all__428->SetBinContent(13,540);
   VbbHcc_algo_Sphericity_all__428->SetBinContent(14,381);
   VbbHcc_algo_Sphericity_all__428->SetBinContent(15,296);
   VbbHcc_algo_Sphericity_all__428->SetBinContent(16,207);
   VbbHcc_algo_Sphericity_all__428->SetBinContent(17,127);
   VbbHcc_algo_Sphericity_all__428->SetBinContent(18,87);
   VbbHcc_algo_Sphericity_all__428->SetBinContent(19,53);
   ...
   VbbHcc_algo_Sphericity_all__428->SetEntries(3248367);
   ...
   Graph_Graph_from_VbbHcc_algo_Sphericity_all1311->SetMinimum(2839.257);
...
// ------------>Primitives in pad: bottomPad
   ...
   data_mc_ratio__429->SetBinContent(1,0.4280999);
   data_mc_ratio__429->SetBinContent(2,0.4125627);
   data_mc_ratio__429->SetBinContent(3,0.4216775);
   data_mc_ratio__429->SetBinContent(4,0.4152432);
   data_mc_ratio__429->SetBinContent(5,0.4496368);
   data_mc_ratio__429->SetBinContent(6,0.4411545);
   data_mc_ratio__429->SetBinContent(7,0.4725056);
   data_mc_ratio__429->SetBinContent(8,0.5559184);
   data_mc_ratio__429->SetBinContent(9,0.6395169);
   data_mc_ratio__429->SetBinContent(10,0.5670195);
   data_mc_ratio__429->SetBinContent(11,0.5967701);
   data_mc_ratio__429->SetBinContent(12,0.609663);
   data_mc_ratio__429->SetBinContent(13,0.5123343);
   data_mc_ratio__429->SetBinContent(14,0.4387535);
   data_mc_ratio__429->SetBinContent(15,0.8909135);
   data_mc_ratio__429->SetBinContent(16,0.3589889);
   data_mc_ratio__429->SetBinContent(17,0.1380316);
   data_mc_ratio__429->SetBinContent(18,0.3528564);
   data_mc_ratio__429->SetBinContent(19,0.6035649);
   data_mc_ratio__429->SetBinContent(20,0.4857993);
   data_mc_ratio__429->SetBinContent(21,3.874246);
   data_mc_ratio__429->SetBinContent(22,1.099388);
   data_mc_ratio__429->SetBinError(1,0.0004102266);
   data_mc_ratio__429->SetBinError(2,0.0004136015);
   data_mc_ratio__429->SetBinError(3,0.0005587539);
   data_mc_ratio__429->SetBinError(4,0.0007377874);
   data_mc_ratio__429->SetBinError(5,0.001115076);
   data_mc_ratio__429->SetBinError(6,0.001663136);
   data_mc_ratio__429->SetBinError(7,0.002962257);
   data_mc_ratio__429->SetBinError(8,0.005720488);
   data_mc_ratio__429->SetBinError(9,0.009945217);
   data_mc_ratio__429->SetBinError(10,0.01205062);
   data_mc_ratio__429->SetBinError(11,0.01679212);
   data_mc_ratio__429->SetBinError(12,0.02112357);
   data_mc_ratio__429->SetBinError(13,0.02204736);
   data_mc_ratio__429->SetBinError(14,0.02247802);
   data_mc_ratio__429->SetBinError(15,0.0517833);
   data_mc_ratio__429->SetBinError(16,0.02495145);
   data_mc_ratio__429->SetBinError(17,0.01224833);
   data_mc_ratio__429->SetBinError(18,0.03783018);
   data_mc_ratio__429->SetBinError(19,0.08290602);
   data_mc_ratio__429->SetBinError(20,0.09527309);
   data_mc_ratio__429->SetBinError(21,1.118399);
   data_mc_ratio__429->SetBinError(22,1.099388);
   data_mc_ratio__429->SetMinimum(0.4);
   data_mc_ratio__429->SetMaximum(1.6);
   data_mc_ratio__429->SetEntries(70.38012);
