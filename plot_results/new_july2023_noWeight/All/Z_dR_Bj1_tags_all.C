...
// ------------>Primitives in pad: topPad
   ...
   VbbHcc_tags_Z_dR_Bj1_all__111->SetBinContent(1,16063);
   VbbHcc_tags_Z_dR_Bj1_all__111->SetBinContent(2,65337);
   VbbHcc_tags_Z_dR_Bj1_all__111->SetBinContent(3,63931);
   VbbHcc_tags_Z_dR_Bj1_all__111->SetBinContent(4,51234);
   VbbHcc_tags_Z_dR_Bj1_all__111->SetBinContent(5,42091);
   VbbHcc_tags_Z_dR_Bj1_all__111->SetBinContent(6,33506);
   VbbHcc_tags_Z_dR_Bj1_all__111->SetBinContent(7,27613);
   VbbHcc_tags_Z_dR_Bj1_all__111->SetBinContent(8,23480);
   VbbHcc_tags_Z_dR_Bj1_all__111->SetBinContent(9,20342);
   VbbHcc_tags_Z_dR_Bj1_all__111->SetBinContent(10,18094);
   VbbHcc_tags_Z_dR_Bj1_all__111->SetBinContent(11,16600);
   VbbHcc_tags_Z_dR_Bj1_all__111->SetBinContent(12,15301);
   VbbHcc_tags_Z_dR_Bj1_all__111->SetBinContent(13,13639);
   VbbHcc_tags_Z_dR_Bj1_all__111->SetBinContent(14,12106);
   VbbHcc_tags_Z_dR_Bj1_all__111->SetBinContent(15,10794);
   VbbHcc_tags_Z_dR_Bj1_all__111->SetBinContent(16,9315);
   VbbHcc_tags_Z_dR_Bj1_all__111->SetBinContent(17,7768);
   VbbHcc_tags_Z_dR_Bj1_all__111->SetBinContent(18,6580);
   VbbHcc_tags_Z_dR_Bj1_all__111->SetBinContent(19,5380);
   VbbHcc_tags_Z_dR_Bj1_all__111->SetBinContent(20,4546);
   VbbHcc_tags_Z_dR_Bj1_all__111->SetBinContent(21,3700);
   VbbHcc_tags_Z_dR_Bj1_all__111->SetBinContent(22,3012);
   VbbHcc_tags_Z_dR_Bj1_all__111->SetBinContent(23,2473);
   VbbHcc_tags_Z_dR_Bj1_all__111->SetBinContent(24,1949);
   VbbHcc_tags_Z_dR_Bj1_all__111->SetBinContent(25,1401);
   VbbHcc_tags_Z_dR_Bj1_all__111->SetBinContent(26,1061);
   VbbHcc_tags_Z_dR_Bj1_all__111->SetBinContent(27,750);
   VbbHcc_tags_Z_dR_Bj1_all__111->SetBinContent(28,464);
   VbbHcc_tags_Z_dR_Bj1_all__111->SetBinContent(29,319);
   VbbHcc_tags_Z_dR_Bj1_all__111->SetBinContent(30,163);
   VbbHcc_tags_Z_dR_Bj1_all__111->SetBinContent(31,299);
   VbbHcc_tags_Z_dR_Bj1_all__111->SetEntries(479340);
...
// ------------>Primitives in pad: bottomPad
   ...
   data_mc_ratio__112->SetBinContent(1,0.9683628);
   data_mc_ratio__112->SetBinContent(2,0.8278162);
   data_mc_ratio__112->SetBinContent(3,0.7191432);
   data_mc_ratio__112->SetBinContent(4,0.7382735);
   data_mc_ratio__112->SetBinContent(5,0.8343516);
   data_mc_ratio__112->SetBinContent(6,0.6989144);
   data_mc_ratio__112->SetBinContent(7,0.7332398);
   data_mc_ratio__112->SetBinContent(8,0.7271628);
   data_mc_ratio__112->SetBinContent(9,0.770776);
   data_mc_ratio__112->SetBinContent(10,0.4364326);
   data_mc_ratio__112->SetBinContent(11,0.6057801);
   data_mc_ratio__112->SetBinContent(12,0.7667449);
   data_mc_ratio__112->SetBinContent(13,0.41109);
   data_mc_ratio__112->SetBinContent(14,0.596103);
   data_mc_ratio__112->SetBinContent(15,0.7411533);
   data_mc_ratio__112->SetBinContent(16,0.8712666);
   data_mc_ratio__112->SetBinContent(17,0.9242362);
   data_mc_ratio__112->SetBinContent(18,0.9265121);
   data_mc_ratio__112->SetBinContent(19,0.7963814);
   data_mc_ratio__112->SetBinContent(20,0.6972148);
   data_mc_ratio__112->SetBinContent(21,0.8693622);
   data_mc_ratio__112->SetBinContent(22,0.5298722);
   data_mc_ratio__112->SetBinContent(23,0.7467954);
   data_mc_ratio__112->SetBinContent(24,1.312619);
   data_mc_ratio__112->SetBinContent(25,0.5786268);
   data_mc_ratio__112->SetBinContent(26,0.695902);
   data_mc_ratio__112->SetBinContent(27,1.439674);
   data_mc_ratio__112->SetBinContent(28,0.4365015);
   data_mc_ratio__112->SetBinContent(29,1.730181);
   data_mc_ratio__112->SetBinContent(30,1.345875);
   data_mc_ratio__112->SetBinContent(31,1.448446);
   data_mc_ratio__112->SetBinError(1,0.007640552);
   data_mc_ratio__112->SetBinError(2,0.003238578);
   data_mc_ratio__112->SetBinError(3,0.002844197);
   data_mc_ratio__112->SetBinError(4,0.003261656);
   data_mc_ratio__112->SetBinError(5,0.004066815);
   data_mc_ratio__112->SetBinError(6,0.003818235);
   data_mc_ratio__112->SetBinError(7,0.004412546);
   data_mc_ratio__112->SetBinError(8,0.004745507);
   data_mc_ratio__112->SetBinError(9,0.005404199);
   data_mc_ratio__112->SetBinError(10,0.003244516);
   data_mc_ratio__112->SetBinError(11,0.004701765);
   data_mc_ratio__112->SetBinError(12,0.006198563);
   data_mc_ratio__112->SetBinError(13,0.003520024);
   data_mc_ratio__112->SetBinError(14,0.005417775);
   data_mc_ratio__112->SetBinError(15,0.007133733);
   data_mc_ratio__112->SetBinError(16,0.009027336);
   data_mc_ratio__112->SetBinError(17,0.01048645);
   data_mc_ratio__112->SetBinError(18,0.01142189);
   data_mc_ratio__112->SetBinError(19,0.0108575);
   data_mc_ratio__112->SetBinError(20,0.01034075);
   data_mc_ratio__112->SetBinError(21,0.01429223);
   data_mc_ratio__112->SetBinError(22,0.009654808);
   data_mc_ratio__112->SetBinError(23,0.01501722);
   data_mc_ratio__112->SetBinError(24,0.0297326);
   data_mc_ratio__112->SetBinError(25,0.01545893);
   data_mc_ratio__112->SetBinError(26,0.02136439);
   data_mc_ratio__112->SetBinError(27,0.05256948);
   data_mc_ratio__112->SetBinError(28,0.02026408);
   data_mc_ratio__112->SetBinError(29,0.09687154);
   data_mc_ratio__112->SetBinError(30,0.1054171);
   data_mc_ratio__112->SetBinError(31,0.4552672);
   data_mc_ratio__112->SetMinimum(0.4);
   data_mc_ratio__112->SetMaximum(1.6);
   data_mc_ratio__112->SetEntries(613.3232);
