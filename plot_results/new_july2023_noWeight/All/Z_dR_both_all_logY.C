...
// ------------>Primitives in pad: topPad
   ...
   topPad->Draw();
   topPad->cd();
   topPad->Range(-0.9193524,-1.351391,6.314516,12.41541);
   ...
   st->SetTitle("");
   st->SetMinimum(0.3);
   st->SetMaximum(3.404799e+10);
   
   TH1F *st_stack_212 = new TH1F("st_stack_212","",30,0,6);
   st_stack_212->SetMinimum(0.04595951);
   st_stack_212->SetMaximum(1.093279e+11);
   ...
   VbbHcc_both_Z_dR_all__582->SetBinContent(2,25);
   VbbHcc_both_Z_dR_all__582->SetBinContent(3,35704);
   VbbHcc_both_Z_dR_all__582->SetBinContent(4,40096);
   VbbHcc_both_Z_dR_all__582->SetBinContent(5,30367);
   VbbHcc_both_Z_dR_all__582->SetBinContent(6,26766);
   VbbHcc_both_Z_dR_all__582->SetBinContent(7,24282);
   VbbHcc_both_Z_dR_all__582->SetBinContent(8,22587);
   VbbHcc_both_Z_dR_all__582->SetBinContent(9,21695);
   VbbHcc_both_Z_dR_all__582->SetBinContent(10,20962);
   VbbHcc_both_Z_dR_all__582->SetBinContent(11,20932);
   VbbHcc_both_Z_dR_all__582->SetBinContent(12,20900);
   VbbHcc_both_Z_dR_all__582->SetBinContent(13,21566);
   VbbHcc_both_Z_dR_all__582->SetBinContent(14,21920);
   VbbHcc_both_Z_dR_all__582->SetBinContent(15,22533);
   VbbHcc_both_Z_dR_all__582->SetBinContent(16,22167);
   VbbHcc_both_Z_dR_all__582->SetBinContent(17,20699);
   VbbHcc_both_Z_dR_all__582->SetBinContent(18,18975);
   VbbHcc_both_Z_dR_all__582->SetBinContent(19,17262);
   VbbHcc_both_Z_dR_all__582->SetBinContent(20,15268);
   VbbHcc_both_Z_dR_all__582->SetBinContent(21,13215);
   VbbHcc_both_Z_dR_all__582->SetBinContent(22,11279);
   VbbHcc_both_Z_dR_all__582->SetBinContent(23,9419);
   VbbHcc_both_Z_dR_all__582->SetBinContent(24,8189);
   VbbHcc_both_Z_dR_all__582->SetBinContent(25,7003);
   VbbHcc_both_Z_dR_all__582->SetBinContent(26,6120);
   VbbHcc_both_Z_dR_all__582->SetBinContent(27,5582);
   VbbHcc_both_Z_dR_all__582->SetBinContent(28,5103);
   VbbHcc_both_Z_dR_all__582->SetBinContent(29,4832);
   VbbHcc_both_Z_dR_all__582->SetBinContent(30,3316);
   VbbHcc_both_Z_dR_all__582->SetBinContent(31,2401);
   VbbHcc_both_Z_dR_all__582->SetEntries(501194);
   ...
   Graph_Graph_from_VbbHcc_both_Z_dR_all1423->SetMinimum(77.04113);
...
// ------------>Primitives in pad: bottomPad
   ...
   data_mc_ratio__583->SetBinContent(2,9.425391);
   data_mc_ratio__583->SetBinContent(3,0.7200503);
   data_mc_ratio__583->SetBinContent(4,0.7980952);
   data_mc_ratio__583->SetBinContent(5,0.5533001);
   data_mc_ratio__583->SetBinContent(6,0.7994244);
   data_mc_ratio__583->SetBinContent(7,0.8307585);
   data_mc_ratio__583->SetBinContent(8,0.7532261);
   data_mc_ratio__583->SetBinContent(9,1.000571);
   data_mc_ratio__583->SetBinContent(10,0.916985);
   data_mc_ratio__583->SetBinContent(11,0.7169071);
   data_mc_ratio__583->SetBinContent(12,0.7176611);
   data_mc_ratio__583->SetBinContent(13,0.759983);
   data_mc_ratio__583->SetBinContent(14,0.7589916);
   data_mc_ratio__583->SetBinContent(15,0.6317589);
   data_mc_ratio__583->SetBinContent(16,0.6535276);
   data_mc_ratio__583->SetBinContent(17,0.6753907);
   data_mc_ratio__583->SetBinContent(18,0.4809499);
   data_mc_ratio__583->SetBinContent(19,0.8014546);
   data_mc_ratio__583->SetBinContent(20,0.7485393);
   data_mc_ratio__583->SetBinContent(21,0.8915899);
   data_mc_ratio__583->SetBinContent(22,0.7971632);
   data_mc_ratio__583->SetBinContent(23,0.7280206);
   data_mc_ratio__583->SetBinContent(24,0.7888217);
   data_mc_ratio__583->SetBinContent(25,0.6566275);
   data_mc_ratio__583->SetBinContent(26,0.8688514);
   data_mc_ratio__583->SetBinContent(27,0.8699502);
   data_mc_ratio__583->SetBinContent(28,0.8050933);
   data_mc_ratio__583->SetBinContent(29,0.9807354);
   data_mc_ratio__583->SetBinContent(30,1.316666);
   data_mc_ratio__583->SetBinContent(31,0.8179301);
   data_mc_ratio__583->SetBinError(2,1.885078);
   data_mc_ratio__583->SetBinError(3,0.003810697);
   data_mc_ratio__583->SetBinError(4,0.003985696);
   data_mc_ratio__583->SetBinError(5,0.003175118);
   data_mc_ratio__583->SetBinError(6,0.004886362);
   data_mc_ratio__583->SetBinError(7,0.005331293);
   data_mc_ratio__583->SetBinError(8,0.005011827);
   data_mc_ratio__583->SetBinError(9,0.006793104);
   data_mc_ratio__583->SetBinError(10,0.00633353);
   data_mc_ratio__583->SetBinError(11,0.004955158);
   data_mc_ratio__583->SetBinError(12,0.004964165);
   data_mc_ratio__583->SetBinError(13,0.005175104);
   data_mc_ratio__583->SetBinError(14,0.00512645);
   data_mc_ratio__583->SetBinError(15,0.004208641);
   data_mc_ratio__583->SetBinError(16,0.004389454);
   data_mc_ratio__583->SetBinError(17,0.004694403);
   data_mc_ratio__583->SetBinError(18,0.003491475);
   data_mc_ratio__583->SetBinError(19,0.00610005);
   data_mc_ratio__583->SetBinError(20,0.00605792);
   data_mc_ratio__583->SetBinError(21,0.007755889);
   data_mc_ratio__583->SetBinError(22,0.007506059);
   data_mc_ratio__583->SetBinError(23,0.007501382);
   data_mc_ratio__583->SetBinError(24,0.008716927);
   data_mc_ratio__583->SetBinError(25,0.007846518);
   data_mc_ratio__583->SetBinError(26,0.01110631);
   data_mc_ratio__583->SetBinError(27,0.01164393);
   data_mc_ratio__583->SetBinError(28,0.01127025);
   data_mc_ratio__583->SetBinError(29,0.01410875);
   data_mc_ratio__583->SetBinError(30,0.02286485);
   data_mc_ratio__583->SetBinError(31,0.1876383);
   data_mc_ratio__583->SetMinimum(0.4);
   data_mc_ratio__583->SetMaximum(1.6);
   data_mc_ratio__583->SetEntries(167.753);
