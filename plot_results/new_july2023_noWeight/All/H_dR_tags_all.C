...
// ------------>Primitives in pad: topPad
   ...
   VbbHcc_tags_H_dR_all__65->SetBinContent(3,22936);
   VbbHcc_tags_H_dR_all__65->SetBinContent(4,24165);
   VbbHcc_tags_H_dR_all__65->SetBinContent(5,18382);
   VbbHcc_tags_H_dR_all__65->SetBinContent(6,17296);
   VbbHcc_tags_H_dR_all__65->SetBinContent(7,16618);
   VbbHcc_tags_H_dR_all__65->SetBinContent(8,16524);
   VbbHcc_tags_H_dR_all__65->SetBinContent(9,16911);
   VbbHcc_tags_H_dR_all__65->SetBinContent(10,17612);
   VbbHcc_tags_H_dR_all__65->SetBinContent(11,19161);
   VbbHcc_tags_H_dR_all__65->SetBinContent(12,20859);
   VbbHcc_tags_H_dR_all__65->SetBinContent(13,23026);
   VbbHcc_tags_H_dR_all__65->SetBinContent(14,26002);
   VbbHcc_tags_H_dR_all__65->SetBinContent(15,28054);
   VbbHcc_tags_H_dR_all__65->SetBinContent(16,30146);
   VbbHcc_tags_H_dR_all__65->SetBinContent(17,28785);
   VbbHcc_tags_H_dR_all__65->SetBinContent(18,26622);
   VbbHcc_tags_H_dR_all__65->SetBinContent(19,24244);
   VbbHcc_tags_H_dR_all__65->SetBinContent(20,20831);
   VbbHcc_tags_H_dR_all__65->SetBinContent(21,17546);
   VbbHcc_tags_H_dR_all__65->SetBinContent(22,13868);
   VbbHcc_tags_H_dR_all__65->SetBinContent(23,11217);
   VbbHcc_tags_H_dR_all__65->SetBinContent(24,8902);
   VbbHcc_tags_H_dR_all__65->SetBinContent(25,7098);
   VbbHcc_tags_H_dR_all__65->SetBinContent(26,5611);
   VbbHcc_tags_H_dR_all__65->SetBinContent(27,4734);
   VbbHcc_tags_H_dR_all__65->SetBinContent(28,3919);
   VbbHcc_tags_H_dR_all__65->SetBinContent(29,3580);
   VbbHcc_tags_H_dR_all__65->SetBinContent(30,2544);
   VbbHcc_tags_H_dR_all__65->SetBinContent(31,2096);
   VbbHcc_tags_H_dR_all__65->SetEntries(479340);
...
// ------------>Primitives in pad: bottomPad
   ...
   data_mc_ratio__66->SetBinContent(2,10.91882);
   data_mc_ratio__66->SetBinContent(3,0.6178599);
   data_mc_ratio__66->SetBinContent(4,0.7518602);
   data_mc_ratio__66->SetBinContent(5,0.7867477);
   data_mc_ratio__66->SetBinContent(6,0.796795);
   data_mc_ratio__66->SetBinContent(7,0.9152405);
   data_mc_ratio__66->SetBinContent(8,0.8250051);
   data_mc_ratio__66->SetBinContent(9,0.8975988);
   data_mc_ratio__66->SetBinContent(10,0.7158378);
   data_mc_ratio__66->SetBinContent(11,0.7899956);
   data_mc_ratio__66->SetBinContent(12,0.7680878);
   data_mc_ratio__66->SetBinContent(13,0.6658902);
   data_mc_ratio__66->SetBinContent(14,0.6837576);
   data_mc_ratio__66->SetBinContent(15,0.7640308);
   data_mc_ratio__66->SetBinContent(16,0.5336061);
   data_mc_ratio__66->SetBinContent(17,0.7257985);
   data_mc_ratio__66->SetBinContent(18,0.6507595);
   data_mc_ratio__66->SetBinContent(19,0.748086);
   data_mc_ratio__66->SetBinContent(20,0.7374267);
   data_mc_ratio__66->SetBinContent(21,0.9128509);
   data_mc_ratio__66->SetBinContent(22,1.012364);
   data_mc_ratio__66->SetBinContent(23,0.8351236);
   data_mc_ratio__66->SetBinContent(24,0.3692963);
   data_mc_ratio__66->SetBinContent(25,0.7876811);
   data_mc_ratio__66->SetBinContent(26,0.7986355);
   data_mc_ratio__66->SetBinContent(27,0.7690218);
   data_mc_ratio__66->SetBinContent(28,0.9005144);
   data_mc_ratio__66->SetBinContent(29,0.5694187);
   data_mc_ratio__66->SetBinContent(30,0.6250332);
   data_mc_ratio__66->SetBinContent(31,0.5406206);
   data_mc_ratio__66->SetBinError(2,2.3279);
   data_mc_ratio__66->SetBinError(3,0.004079728);
   data_mc_ratio__66->SetBinError(4,0.004836639);
   data_mc_ratio__66->SetBinError(5,0.00580282);
   data_mc_ratio__66->SetBinError(6,0.006058621);
   data_mc_ratio__66->SetBinError(7,0.007099796);
   data_mc_ratio__66->SetBinError(8,0.00641799);
   data_mc_ratio__66->SetBinError(9,0.006902361);
   data_mc_ratio__66->SetBinError(10,0.005393992);
   data_mc_ratio__66->SetBinError(11,0.005707101);
   data_mc_ratio__66->SetBinError(12,0.005318194);
   data_mc_ratio__66->SetBinError(13,0.00438827);
   data_mc_ratio__66->SetBinError(14,0.004240322);
   data_mc_ratio__66->SetBinError(15,0.004561561);
   data_mc_ratio__66->SetBinError(16,0.003073307);
   data_mc_ratio__66->SetBinError(17,0.004277923);
   data_mc_ratio__66->SetBinError(18,0.003988414);
   data_mc_ratio__66->SetBinError(19,0.004804513);
   data_mc_ratio__66->SetBinError(20,0.005109328);
   data_mc_ratio__66->SetBinError(21,0.006891452);
   data_mc_ratio__66->SetBinError(22,0.008596659);
   data_mc_ratio__66->SetBinError(23,0.007885194);
   data_mc_ratio__66->SetBinError(24,0.003914094);
   data_mc_ratio__66->SetBinError(25,0.009349371);
   data_mc_ratio__66->SetBinError(26,0.01066175);
   data_mc_ratio__66->SetBinError(27,0.01117698);
   data_mc_ratio__66->SetBinError(28,0.01438477);
   data_mc_ratio__66->SetBinError(29,0.009516784);
   data_mc_ratio__66->SetBinError(30,0.01239209);
   data_mc_ratio__66->SetBinError(31,0.1203556);
   data_mc_ratio__66->SetMinimum(0.4);
   data_mc_ratio__66->SetMaximum(1.6);
   data_mc_ratio__66->SetEntries(108.3965);
