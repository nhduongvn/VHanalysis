...
// ------------>Primitives in pad: topPad
   ...
   topPad->Draw();
   topPad->cd();
   topPad->Range(-0.9499975,-1.352352,6.525,12.44739);
   ...
   st->SetTitle("");
   st->SetMinimum(0.3);
   st->SetMaximum(3.630946e+10);
   
   TH1F *st_stack_24 = new TH1F("st_stack_24","",30,0,6);
   st_stack_24->SetMinimum(0.0458614);
   st_stack_24->SetMaximum(1.167923e+11);
   ...
   Graph_Graph_from_VbbHcc_tags_H_dR_all1047->SetMinimum(78.7999);
