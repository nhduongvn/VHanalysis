...
// ------------>Primitives in pad: topPad
   ...
   topPad->Draw();
   topPad->cd();
   topPad->Range(-0.9193524,-2.907468,6.314516,13.79179);
   ...
   st->SetTitle("");
   st->SetMinimum(0.01);
   st->SetMaximum(3.568043e+11);
   
   TH1F *st_stack_115 = new TH1F("st_stack_115","",30,0,6);
   st_stack_115->SetMinimum(0.001285973);
   st_stack_115->SetMaximum(1.323917e+12);
   ...
   Graph_Graph_from_VbbHcc_algo_Z_dR1229->SetMinimum(179.2333);
