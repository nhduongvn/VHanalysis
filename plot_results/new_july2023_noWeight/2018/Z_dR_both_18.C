...
// ------------>Primitives in pad: topPad
   ...
   topPad->Draw();
   topPad->cd();
   topPad->Range(-0.9193524,-66.5458,6.314516,66489.25);
   ...
   VbbHcc_both_Z_dR__421->SetBinContent(2,17);
   VbbHcc_both_Z_dR__421->SetBinContent(3,22776);
   VbbHcc_both_Z_dR__421->SetBinContent(4,25643);
   VbbHcc_both_Z_dR__421->SetBinContent(5,19553);
   VbbHcc_both_Z_dR__421->SetBinContent(6,17225);
   VbbHcc_both_Z_dR__421->SetBinContent(7,15577);
   VbbHcc_both_Z_dR__421->SetBinContent(8,14388);
   VbbHcc_both_Z_dR__421->SetBinContent(9,13919);
   VbbHcc_both_Z_dR__421->SetBinContent(10,13368);
   VbbHcc_both_Z_dR__421->SetBinContent(11,13432);
   VbbHcc_both_Z_dR__421->SetBinContent(12,13562);
   VbbHcc_both_Z_dR__421->SetBinContent(13,14008);
   VbbHcc_both_Z_dR__421->SetBinContent(14,14403);
   VbbHcc_both_Z_dR__421->SetBinContent(15,14941);
   VbbHcc_both_Z_dR__421->SetBinContent(16,14724);
   VbbHcc_both_Z_dR__421->SetBinContent(17,13853);
   VbbHcc_both_Z_dR__421->SetBinContent(18,12685);
   VbbHcc_both_Z_dR__421->SetBinContent(19,11481);
   VbbHcc_both_Z_dR__421->SetBinContent(20,10198);
   VbbHcc_both_Z_dR__421->SetBinContent(21,8768);
   VbbHcc_both_Z_dR__421->SetBinContent(22,7493);
   VbbHcc_both_Z_dR__421->SetBinContent(23,6144);
   VbbHcc_both_Z_dR__421->SetBinContent(24,5523);
   VbbHcc_both_Z_dR__421->SetBinContent(25,4678);
   VbbHcc_both_Z_dR__421->SetBinContent(26,4051);
   VbbHcc_both_Z_dR__421->SetBinContent(27,3606);
   VbbHcc_both_Z_dR__421->SetBinContent(28,3395);
   VbbHcc_both_Z_dR__421->SetBinContent(29,3183);
   VbbHcc_both_Z_dR__421->SetBinContent(30,2159);
   VbbHcc_both_Z_dR__421->SetBinContent(31,1615);
   VbbHcc_both_Z_dR__421->SetEntries(326397);
...
// ------------>Primitives in pad: bottomPad
   ...
   data_mc_ratio__422->SetBinContent(2,21.31039);
   data_mc_ratio__422->SetBinContent(3,1.191629);
   data_mc_ratio__422->SetBinContent(4,1.372447);
   data_mc_ratio__422->SetBinContent(5,1.219396);
   data_mc_ratio__422->SetBinContent(6,1.422125);
   data_mc_ratio__422->SetBinContent(7,1.43726);
   data_mc_ratio__422->SetBinContent(8,1.126038);
   data_mc_ratio__422->SetBinContent(9,1.706509);
   data_mc_ratio__422->SetBinContent(10,1.466288);
   data_mc_ratio__422->SetBinContent(11,1.46528);
   data_mc_ratio__422->SetBinContent(12,1.128094);
   data_mc_ratio__422->SetBinContent(13,1.503826);
   data_mc_ratio__422->SetBinContent(14,1.227863);
   data_mc_ratio__422->SetBinContent(15,1.131892);
   data_mc_ratio__422->SetBinContent(16,1.130171);
   data_mc_ratio__422->SetBinContent(17,1.120195);
   data_mc_ratio__422->SetBinContent(18,1.096766);
   data_mc_ratio__422->SetBinContent(19,1.230528);
   data_mc_ratio__422->SetBinContent(20,1.179929);
   data_mc_ratio__422->SetBinContent(21,1.312708);
   data_mc_ratio__422->SetBinContent(22,1.345834);
   data_mc_ratio__422->SetBinContent(23,1.721774);
   data_mc_ratio__422->SetBinContent(24,1.070175);
   data_mc_ratio__422->SetBinContent(25,1.160695);
   data_mc_ratio__422->SetBinContent(26,2.073592);
   data_mc_ratio__422->SetBinContent(27,1.965839);
   data_mc_ratio__422->SetBinContent(28,1.286341);
   data_mc_ratio__422->SetBinContent(29,1.768193);
   data_mc_ratio__422->SetBinContent(30,2.057996);
   data_mc_ratio__422->SetBinContent(31,1.475557);
   data_mc_ratio__422->SetBinError(2,5.168528);
   data_mc_ratio__422->SetBinError(3,0.007895913);
   data_mc_ratio__422->SetBinError(4,0.008570601);
   data_mc_ratio__422->SetBinError(5,0.00872043);
   data_mc_ratio__422->SetBinError(6,0.01083573);
   data_mc_ratio__422->SetBinError(7,0.01151578);
   data_mc_ratio__422->SetBinError(8,0.009387558);
   data_mc_ratio__422->SetBinError(9,0.01446454);
   data_mc_ratio__422->SetBinError(10,0.01268195);
   data_mc_ratio__422->SetBinError(11,0.012643);
   data_mc_ratio__422->SetBinError(12,0.009686873);
   data_mc_ratio__422->SetBinError(13,0.01270602);
   data_mc_ratio__422->SetBinError(14,0.01023112);
   data_mc_ratio__422->SetBinError(15,0.009260085);
   data_mc_ratio__422->SetBinError(16,0.009313892);
   data_mc_ratio__422->SetBinError(17,0.00951747);
   data_mc_ratio__422->SetBinError(18,0.009737973);
   data_mc_ratio__422->SetBinError(19,0.01148422);
   data_mc_ratio__422->SetBinError(20,0.01168418);
   data_mc_ratio__422->SetBinError(21,0.01401902);
   data_mc_ratio__422->SetBinError(22,0.01554761);
   data_mc_ratio__422->SetBinError(23,0.02196598);
   data_mc_ratio__422->SetBinError(24,0.01440016);
   data_mc_ratio__422->SetBinError(25,0.01697024);
   data_mc_ratio__422->SetBinError(26,0.03257934);
   data_mc_ratio__422->SetBinError(27,0.03273671);
   data_mc_ratio__422->SetBinError(28,0.02207681);
   data_mc_ratio__422->SetBinError(29,0.0313409);
   data_mc_ratio__422->SetBinError(30,0.04429128);
   data_mc_ratio__422->SetBinError(31,0.5270487);
   data_mc_ratio__422->SetMinimum(0.4);
   data_mc_ratio__422->SetMaximum(1.6);
   data_mc_ratio__422->SetEntries(58.36404);
