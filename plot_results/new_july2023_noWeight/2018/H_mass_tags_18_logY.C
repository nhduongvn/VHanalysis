...
// ------------>Primitives in pad: topPad
   ...
   topPad->Draw();
   topPad->cd();
   topPad->Range(-45.96762,-2.815727,315.7258,10.51894);
   ...
   st->SetTitle("");
   st->SetMinimum(0.01);
   st->SetMaximum(4.884866e+08);
   
   TH1F *st_stack_7 = new TH1F("st_stack_7","",40,0,400);
   st_stack_7->SetMinimum(0.001576187);
   st_stack_7->SetMaximum(1.532759e+09);
   ...
   VbbHcc_tags_H_mass__18->SetBinContent(3,127);
   VbbHcc_tags_H_mass__18->SetBinContent(4,1819);
   VbbHcc_tags_H_mass__18->SetBinContent(5,4760);
   VbbHcc_tags_H_mass__18->SetBinContent(6,7166);
   VbbHcc_tags_H_mass__18->SetBinContent(7,8109);
   VbbHcc_tags_H_mass__18->SetBinContent(15,6265);
   VbbHcc_tags_H_mass__18->SetBinContent(16,6214);
   VbbHcc_tags_H_mass__18->SetBinContent(17,5826);
   VbbHcc_tags_H_mass__18->SetBinContent(18,5779);
   VbbHcc_tags_H_mass__18->SetBinContent(19,5450);
   VbbHcc_tags_H_mass__18->SetBinContent(20,5132);
   VbbHcc_tags_H_mass__18->SetBinContent(21,5020);
   VbbHcc_tags_H_mass__18->SetBinContent(22,4815);
   VbbHcc_tags_H_mass__18->SetBinContent(23,4815);
   VbbHcc_tags_H_mass__18->SetBinContent(24,4484);
   VbbHcc_tags_H_mass__18->SetBinContent(25,4288);
   VbbHcc_tags_H_mass__18->SetBinContent(26,4368);
   VbbHcc_tags_H_mass__18->SetBinContent(27,4093);
   VbbHcc_tags_H_mass__18->SetBinContent(28,4091);
   VbbHcc_tags_H_mass__18->SetBinContent(29,4016);
   VbbHcc_tags_H_mass__18->SetBinContent(30,3876);
   VbbHcc_tags_H_mass__18->SetBinContent(31,3750);
   VbbHcc_tags_H_mass__18->SetBinContent(32,3752);
   VbbHcc_tags_H_mass__18->SetBinContent(33,3693);
   VbbHcc_tags_H_mass__18->SetBinContent(34,3632);
   VbbHcc_tags_H_mass__18->SetBinContent(35,3555);
   VbbHcc_tags_H_mass__18->SetBinContent(36,3432);
   VbbHcc_tags_H_mass__18->SetBinContent(37,3336);
   VbbHcc_tags_H_mass__18->SetBinContent(38,3300);
   VbbHcc_tags_H_mass__18->SetBinContent(39,3343);
   VbbHcc_tags_H_mass__18->SetBinContent(40,3133);
   VbbHcc_tags_H_mass__18->SetBinContent(41,127680);
   VbbHcc_tags_H_mass__18->SetEntries(314274);
   ...
   Graph_Graph_from_VbbHcc_tags_H_mass1013->SetMinimum(9.630811);
...
// ------------>Primitives in pad: bottomPad
   ...
   data_mc_ratio__19->SetBinContent(3,1.331783);
   data_mc_ratio__19->SetBinContent(4,0.8641338);
   data_mc_ratio__19->SetBinContent(5,0.95958);
   data_mc_ratio__19->SetBinContent(6,1.002677);
   data_mc_ratio__19->SetBinContent(7,1.074556);
   data_mc_ratio__19->SetBinContent(8,1.128195);
   data_mc_ratio__19->SetBinContent(9,1.585763);
   data_mc_ratio__19->SetBinContent(10,1.265951);
   data_mc_ratio__19->SetBinContent(11,1.298069);
   data_mc_ratio__19->SetBinContent(12,1.312297);
   data_mc_ratio__19->SetBinContent(13,1.665815);
   data_mc_ratio__19->SetBinContent(14,0.9684433);
   data_mc_ratio__19->SetBinContent(15,1.28614);
   data_mc_ratio__19->SetBinContent(16,1.313183);
   data_mc_ratio__19->SetBinContent(17,0.8914986);
   data_mc_ratio__19->SetBinContent(18,1.370003);
   data_mc_ratio__19->SetBinContent(19,2.082193);
   data_mc_ratio__19->SetBinContent(20,1.251749);
   data_mc_ratio__19->SetBinContent(21,0.9594501);
   data_mc_ratio__19->SetBinContent(22,1.584793);
   data_mc_ratio__19->SetBinContent(23,1.103597);
   data_mc_ratio__19->SetBinContent(24,1.071121);
   data_mc_ratio__19->SetBinContent(25,1.183377);
   data_mc_ratio__19->SetBinContent(26,1.528632);
   data_mc_ratio__19->SetBinContent(27,1.407733);
   data_mc_ratio__19->SetBinContent(28,1.161772);
   data_mc_ratio__19->SetBinContent(29,1.480463);
   data_mc_ratio__19->SetBinContent(30,1.783348);
   data_mc_ratio__19->SetBinContent(31,0.8821196);
   data_mc_ratio__19->SetBinContent(32,1.221919);
   data_mc_ratio__19->SetBinContent(33,1.629213);
   data_mc_ratio__19->SetBinContent(34,2.032709);
   data_mc_ratio__19->SetBinContent(35,0.7258448);
   data_mc_ratio__19->SetBinContent(36,2.515946);
   data_mc_ratio__19->SetBinContent(37,0.8427753);
   data_mc_ratio__19->SetBinContent(38,1.553905);
   data_mc_ratio__19->SetBinContent(39,1.612499);
   data_mc_ratio__19->SetBinContent(40,1.133363);
   data_mc_ratio__19->SetBinContent(41,1.360453);
   data_mc_ratio__19->SetBinError(3,0.1181767);
   data_mc_ratio__19->SetBinError(4,0.02026118);
   data_mc_ratio__19->SetBinError(5,0.01390842);
   data_mc_ratio__19->SetBinError(6,0.01184466);
   data_mc_ratio__19->SetBinError(7,0.01193288);
   data_mc_ratio__19->SetBinError(8,0.01251389);
   data_mc_ratio__19->SetBinError(9,0.01772937);
   data_mc_ratio__19->SetBinError(10,0.01464335);
   data_mc_ratio__19->SetBinError(11,0.01518547);
   data_mc_ratio__19->SetBinError(12,0.01567711);
   data_mc_ratio__19->SetBinError(13,0.02035877);
   data_mc_ratio__19->SetBinError(14,0.01200744);
   data_mc_ratio__19->SetBinError(15,0.01624904);
   data_mc_ratio__19->SetBinError(16,0.01665864);
   data_mc_ratio__19->SetBinError(17,0.0116798);
   data_mc_ratio__19->SetBinError(18,0.01802167);
   data_mc_ratio__19->SetBinError(19,0.02820478);
   data_mc_ratio__19->SetBinError(20,0.01747326);
   data_mc_ratio__19->SetBinError(21,0.01354162);
   data_mc_ratio__19->SetBinError(22,0.02283886);
   data_mc_ratio__19->SetBinError(23,0.01590422);
   data_mc_ratio__19->SetBinError(24,0.01599579);
   data_mc_ratio__19->SetBinError(25,0.01807156);
   data_mc_ratio__19->SetBinError(26,0.02312925);
   data_mc_ratio__19->SetBinError(27,0.02200389);
   data_mc_ratio__19->SetBinError(28,0.01816377);
   data_mc_ratio__19->SetBinError(29,0.02336151);
   data_mc_ratio__19->SetBinError(30,0.0286447);
   data_mc_ratio__19->SetBinError(31,0.01440495);
   data_mc_ratio__19->SetBinError(32,0.01994854);
   data_mc_ratio__19->SetBinError(33,0.02680947);
   data_mc_ratio__19->SetBinError(34,0.03372891);
   data_mc_ratio__19->SetBinError(35,0.01217374);
   data_mc_ratio__19->SetBinError(36,0.04294649);
   data_mc_ratio__19->SetBinError(37,0.01459146);
   data_mc_ratio__19->SetBinError(38,0.02705001);
   data_mc_ratio__19->SetBinError(39,0.0278889);
   data_mc_ratio__19->SetBinError(40,0.02024832);
   data_mc_ratio__19->SetBinError(41,0.0587183);
   data_mc_ratio__19->SetMinimum(0.4);
   data_mc_ratio__19->SetMaximum(1.6);
   data_mc_ratio__19->SetEntries(715.6986);
