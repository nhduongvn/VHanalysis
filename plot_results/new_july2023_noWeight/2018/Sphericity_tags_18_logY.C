...
// ------------>Primitives in pad: topPad
   ...
   topPad->Draw();
   topPad->cd();
   topPad->Range(-0.1532254,-2.89712,1.052419,13.39055);
   ...
   st->SetTitle("");
   st->SetMinimum(0.01);
   st->SetMaximum(1.587309e+11);
   
   TH1F *st_stack_59 = new TH1F("st_stack_59","",25,0,1);
   st_stack_59->SetMinimum(0.001315732);
   st_stack_59->SetMaximum(5.778015e+11);
   ...
   Graph_Graph_from_VbbHcc_tags_Sphericity1117->SetMinimum(91.55089);
