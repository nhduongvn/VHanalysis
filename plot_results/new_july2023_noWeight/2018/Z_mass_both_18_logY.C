...
// ------------>Primitives in pad: topPad
   ...
   topPad->Draw();
   topPad->cd();
   topPad->Range(-45.96762,-2.829919,315.7258,10.98512);
   ...
   st->SetTitle("");
   st->SetMinimum(0.01);
   st->SetMaximum(1.24701e+09);
   
   TH1F *st_stack_195 = new TH1F("st_stack_195","",40,0,400);
   st_stack_195->SetMinimum(0.001527199);
   st_stack_195->SetMaximum(4.014341e+09);
   ...
   Graph_Graph_from_VbbHcc_both_Z_mass1389->SetMinimum(14.35615);
