...
// ------------>Primitives in pad: topPad
   ...
   topPad->Draw();
   topPad->cd();
   topPad->Range(-0.9193524,-2.844455,6.314516,11.47716);
   ...
   st->SetTitle("");
   st->SetMinimum(0.01);
   st->SetMaximum(3.355893e+09);
   
   TH1F *st_stack_19 = new TH1F("st_stack_19","",30,0,6);
   st_stack_19->SetMinimum(0.001478655);
   st_stack_19->SetMaximum(1.109177e+10);
   ...
   Graph_Graph_from_VbbHcc_tags_Z_dR1037->SetMinimum(19.17667);
