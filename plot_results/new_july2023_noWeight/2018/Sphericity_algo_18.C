...
// ------------>Primitives in pad: topPad
   ...
   VbbHcc_algo_Sphericity__309->SetBinContent(1,710920);
   VbbHcc_algo_Sphericity__309->SetBinContent(2,663547);
   VbbHcc_algo_Sphericity__309->SetBinContent(3,381247);
   VbbHcc_algo_Sphericity__309->SetBinContent(4,210624);
   VbbHcc_algo_Sphericity__309->SetBinContent(5,105888);
   VbbHcc_algo_Sphericity__309->SetBinContent(6,44549);
   VbbHcc_algo_Sphericity__309->SetBinContent(7,15506);
   VbbHcc_algo_Sphericity__309->SetBinContent(8,5593);
   VbbHcc_algo_Sphericity__309->SetBinContent(9,2432);
   VbbHcc_algo_Sphericity__309->SetBinContent(10,1304);
   VbbHcc_algo_Sphericity__309->SetBinContent(11,740);
   VbbHcc_algo_Sphericity__309->SetBinContent(12,490);
   VbbHcc_algo_Sphericity__309->SetBinContent(13,342);
   VbbHcc_algo_Sphericity__309->SetBinContent(14,228);
   VbbHcc_algo_Sphericity__309->SetBinContent(15,183);
   VbbHcc_algo_Sphericity__309->SetBinContent(16,133);
   VbbHcc_algo_Sphericity__309->SetBinContent(17,68);
   VbbHcc_algo_Sphericity__309->SetBinContent(18,60);
   VbbHcc_algo_Sphericity__309->SetBinContent(19,24);
   VbbHcc_algo_Sphericity__309->SetBinContent(20,13);
   VbbHcc_algo_Sphericity__309->SetBinContent(21,8);
   VbbHcc_algo_Sphericity__309->SetBinContent(22,1);
   VbbHcc_algo_Sphericity__309->SetEntries(2143924);
...
// ------------>Primitives in pad: bottomPad
   ...
   data_mc_ratio__310->SetBinContent(1,1.002199);
   data_mc_ratio__310->SetBinContent(2,1.038039);
   data_mc_ratio__310->SetBinContent(3,1.034055);
   data_mc_ratio__310->SetBinContent(4,1.062889);
   data_mc_ratio__310->SetBinContent(5,1.10403);
   data_mc_ratio__310->SetBinContent(6,0.9093289);
   data_mc_ratio__310->SetBinContent(7,1.007767);
   data_mc_ratio__310->SetBinContent(8,1.151274);
   data_mc_ratio__310->SetBinContent(9,1.073409);
   data_mc_ratio__310->SetBinContent(10,1.058538);
   data_mc_ratio__310->SetBinContent(11,1.329468);
   data_mc_ratio__310->SetBinContent(12,0.7300717);
   data_mc_ratio__310->SetBinContent(13,1.328839);
   data_mc_ratio__310->SetBinContent(14,1.284829);
   data_mc_ratio__310->SetBinContent(15,1.467133);
   data_mc_ratio__310->SetBinContent(16,1.090181);
   data_mc_ratio__310->SetBinContent(17,0.1377633);
   data_mc_ratio__310->SetBinContent(18,0.6472165);
   data_mc_ratio__310->SetBinContent(19,1.499646);
   data_mc_ratio__310->SetBinContent(20,0.5747421);
   data_mc_ratio__310->SetBinContent(21,7.792395);
   data_mc_ratio__310->SetBinContent(22,3.169399);
   data_mc_ratio__310->SetBinError(1,0.001188621);
   data_mc_ratio__310->SetBinError(2,0.001274318);
   data_mc_ratio__310->SetBinError(3,0.001674713);
   data_mc_ratio__310->SetBinError(4,0.002315976);
   data_mc_ratio__310->SetBinError(5,0.003392795);
   data_mc_ratio__310->SetBinError(6,0.004308261);
   data_mc_ratio__310->SetBinError(7,0.008093011);
   data_mc_ratio__310->SetBinError(8,0.01539417);
   data_mc_ratio__310->SetBinError(9,0.02176624);
   data_mc_ratio__310->SetBinError(10,0.02931349);
   data_mc_ratio__310->SetBinError(11,0.04887221);
   data_mc_ratio__310->SetBinError(12,0.03298128);
   data_mc_ratio__310->SetBinError(13,0.07185539);
   data_mc_ratio__310->SetBinError(14,0.08508986);
   data_mc_ratio__310->SetBinError(15,0.1084536);
   data_mc_ratio__310->SetBinError(16,0.09453067);
   data_mc_ratio__310->SetBinError(17,0.01670625);
   data_mc_ratio__310->SetBinError(18,0.08355529);
   data_mc_ratio__310->SetBinError(19,0.306114);
   data_mc_ratio__310->SetBinError(20,0.1594048);
   data_mc_ratio__310->SetBinError(21,2.755028);
   data_mc_ratio__310->SetBinError(22,3.169399);
   data_mc_ratio__310->SetMinimum(0.4);
   data_mc_ratio__310->SetMaximum(1.6);
   data_mc_ratio__310->SetEntries(39.50611);
