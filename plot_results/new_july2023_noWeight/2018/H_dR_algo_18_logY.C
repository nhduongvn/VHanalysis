...
// ------------>Primitives in pad: topPad
   ...
   topPad->Draw();
   topPad->cd();
   topPad->Range(-0.9499975,-2.902738,6.525,13.60733);
   ...
   st->SetTitle("");
   st->SetMinimum(0.01);
   st->SetMaximum(2.458652e+11);
   
   TH1F *st_stack_119 = new TH1F("st_stack_119","",30,0,6);
   st_stack_119->SetMinimum(0.001299486);
   st_stack_119->SetMaximum(9.043264e+11);
   ...
   Graph_Graph_from_VbbHcc_algo_H_dR1237->SetMinimum(152.6619);
