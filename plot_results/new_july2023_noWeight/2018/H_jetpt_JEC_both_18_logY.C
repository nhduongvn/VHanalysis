...
// ------------>Primitives in pad: topPad
   ...
   topPad->Draw();
   topPad->cd();
   topPad->Range(-45.96762,-2.896546,315.7258,13.36853);
   ...
   st->SetTitle("");
   st->SetMinimum(0.01);
   st->SetMaximum(1.518327e+11);
   
   TH1F *st_stack_263 = new TH1F("st_stack_263","",150,0,300);
   st_stack_263->SetMinimum(0.001317405);
   st_stack_263->SetMaximum(5.521053e+11);
   ...
   Graph_Graph_from_VbbHcc_both_H_jetpt_JEC1525->SetMinimum(96.09658);
