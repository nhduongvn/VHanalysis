...
// ------------>Primitives in pad: topPad
   ...
   topPad->Draw();
   topPad->cd();
   topPad->Range(-0.1532254,-2.878524,1.052419,12.69081);
   ...
   st->SetTitle("");
   st->SetMinimum(0.01);
   st->SetMaximum(3.869361e+10);
   
   TH1F *st_stack_251 = new TH1F("st_stack_251","",25,0,1);
   st_stack_251->SetMinimum(0.001371024);
   st_stack_251->SetMaximum(1.361059e+11);
   ...
   VbbHcc_both_Sphericity__689->SetBinContent(1,56518);
   VbbHcc_both_Sphericity__689->SetBinContent(2,58135);
   VbbHcc_both_Sphericity__689->SetBinContent(3,43214);
   VbbHcc_both_Sphericity__689->SetBinContent(4,32717);
   VbbHcc_both_Sphericity__689->SetBinContent(5,25564);
   VbbHcc_both_Sphericity__689->SetBinContent(6,20279);
   VbbHcc_both_Sphericity__689->SetBinContent(7,16647);
   VbbHcc_both_Sphericity__689->SetBinContent(8,13714);
   VbbHcc_both_Sphericity__689->SetBinContent(9,11283);
   VbbHcc_both_Sphericity__689->SetBinContent(10,9601);
   VbbHcc_both_Sphericity__689->SetBinContent(11,8128);
   VbbHcc_both_Sphericity__689->SetBinContent(12,6904);
   VbbHcc_both_Sphericity__689->SetBinContent(13,5941);
   VbbHcc_both_Sphericity__689->SetBinContent(14,4752);
   VbbHcc_both_Sphericity__689->SetBinContent(15,4041);
   VbbHcc_both_Sphericity__689->SetBinContent(16,3037);
   VbbHcc_both_Sphericity__689->SetBinContent(17,2505);
   VbbHcc_both_Sphericity__689->SetBinContent(18,1776);
   VbbHcc_both_Sphericity__689->SetBinContent(19,971);
   VbbHcc_both_Sphericity__689->SetBinContent(20,406);
   VbbHcc_both_Sphericity__689->SetBinContent(21,164);
   VbbHcc_both_Sphericity__689->SetBinContent(22,50);
   ...
   VbbHcc_both_Sphericity__689->SetEntries(326392);
   ...
   Graph_Graph_from_VbbHcc_both_Sphericity1501->SetMinimum(0.01642971);
...
// ------------>Primitives in pad: bottomPad
   ...
   data_mc_ratio__690->SetBinContent(1,1.412583);
   data_mc_ratio__690->SetBinContent(2,1.38698);
   data_mc_ratio__690->SetBinContent(3,1.428457);
   data_mc_ratio__690->SetBinContent(4,1.053977);
   data_mc_ratio__690->SetBinContent(5,1.251852);
   data_mc_ratio__690->SetBinContent(6,1.145386);
   data_mc_ratio__690->SetBinContent(7,1.09158);
   data_mc_ratio__690->SetBinContent(8,1.564513);
   data_mc_ratio__690->SetBinContent(9,1.154926);
   data_mc_ratio__690->SetBinContent(10,1.226669);
   data_mc_ratio__690->SetBinContent(11,1.455166);
   data_mc_ratio__690->SetBinContent(12,1.11922);
   data_mc_ratio__690->SetBinContent(13,1.331471);
   data_mc_ratio__690->SetBinContent(14,1.447137);
   data_mc_ratio__690->SetBinContent(15,1.417261);
   data_mc_ratio__690->SetBinContent(16,1.517153);
   data_mc_ratio__690->SetBinContent(17,1.20985);
   data_mc_ratio__690->SetBinContent(18,1.455455);
   data_mc_ratio__690->SetBinContent(19,1.082442);
   data_mc_ratio__690->SetBinContent(20,0.7283789);
   data_mc_ratio__690->SetBinContent(21,0.3535698);
   data_mc_ratio__690->SetBinContent(22,0.8564001);
   data_mc_ratio__690->SetBinContent(23,11.85451);
   data_mc_ratio__690->SetBinContent(24,15.0071);
   data_mc_ratio__690->SetBinContent(25,18.25961);
   data_mc_ratio__690->SetBinError(1,0.005941834);
   data_mc_ratio__690->SetBinError(2,0.00575243);
   data_mc_ratio__690->SetBinError(3,0.006871556);
   data_mc_ratio__690->SetBinError(4,0.005826991);
   data_mc_ratio__690->SetBinError(5,0.00782958);
   data_mc_ratio__690->SetBinError(6,0.008043197);
   data_mc_ratio__690->SetBinError(7,0.008460333);
   data_mc_ratio__690->SetBinError(8,0.01335971);
   data_mc_ratio__690->SetBinError(9,0.01087282);
   data_mc_ratio__690->SetBinError(10,0.01251898);
   data_mc_ratio__690->SetBinError(11,0.01614064);
   data_mc_ratio__690->SetBinError(12,0.01346992);
   data_mc_ratio__690->SetBinError(13,0.01727436);
   data_mc_ratio__690->SetBinError(14,0.02099286);
   data_mc_ratio__690->SetBinError(15,0.02229489);
   data_mc_ratio__690->SetBinError(16,0.02753005);
   data_mc_ratio__690->SetBinError(17,0.02417284);
   data_mc_ratio__690->SetBinError(18,0.03453641);
   data_mc_ratio__690->SetBinError(19,0.03473722);
   data_mc_ratio__690->SetBinError(20,0.03614884);
   data_mc_ratio__690->SetBinError(21,0.02760916);
   data_mc_ratio__690->SetBinError(22,0.1211133);
   data_mc_ratio__690->SetBinError(23,2.87514);
   data_mc_ratio__690->SetBinError(24,8.664356);
   data_mc_ratio__690->SetBinError(25,18.25961);
   data_mc_ratio__690->SetMinimum(0.4);
   data_mc_ratio__690->SetMaximum(1.6);
   data_mc_ratio__690->SetEntries(6.309963);
