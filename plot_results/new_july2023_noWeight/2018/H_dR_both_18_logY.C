...
// ------------>Primitives in pad: topPad
   ...
   topPad->Draw();
   topPad->cd();
   topPad->Range(-0.9499975,-2.859135,6.525,11.98955);
   ...
   st->SetTitle("");
   st->SetMinimum(0.01);
   st->SetMaximum(9.416024e+09);
   
   TH1F *st_stack_215 = new TH1F("st_stack_215","",30,0,6);
   st_stack_215->SetMinimum(0.001431243);
   st_stack_215->SetMaximum(3.196527e+10);
   ...
   VbbHcc_both_H_dR__590->SetBinContent(3,14743);
   VbbHcc_both_H_dR__590->SetBinContent(4,16701);
   VbbHcc_both_H_dR__590->SetBinContent(5,13760);
   VbbHcc_both_H_dR__590->SetBinContent(6,13959);
   VbbHcc_both_H_dR__590->SetBinContent(7,13792);
   VbbHcc_both_H_dR__590->SetBinContent(8,14306);
   VbbHcc_both_H_dR__590->SetBinContent(9,15110);
   VbbHcc_both_H_dR__590->SetBinContent(10,16413);
   VbbHcc_both_H_dR__590->SetBinContent(11,18100);
   VbbHcc_both_H_dR__590->SetBinContent(12,20834);
   VbbHcc_both_H_dR__590->SetBinContent(13,23481);
   VbbHcc_both_H_dR__590->SetBinContent(14,26920);
   VbbHcc_both_H_dR__590->SetBinContent(15,29521);
   VbbHcc_both_H_dR__590->SetBinContent(16,30778);
   VbbHcc_both_H_dR__590->SetBinContent(17,19067);
   VbbHcc_both_H_dR__590->SetBinContent(18,12918);
   VbbHcc_both_H_dR__590->SetBinContent(19,9036);
   VbbHcc_both_H_dR__590->SetBinContent(20,6332);
   VbbHcc_both_H_dR__590->SetBinContent(21,4176);
   VbbHcc_both_H_dR__590->SetBinContent(22,2749);
   VbbHcc_both_H_dR__590->SetBinContent(23,1736);
   VbbHcc_both_H_dR__590->SetBinContent(24,1001);
   VbbHcc_both_H_dR__590->SetBinContent(25,544);
   VbbHcc_both_H_dR__590->SetBinContent(26,262);
   VbbHcc_both_H_dR__590->SetBinContent(27,100);
   VbbHcc_both_H_dR__590->SetBinContent(28,19);
   VbbHcc_both_H_dR__590->SetBinContent(29,1);
   VbbHcc_both_H_dR__590->SetEntries(326397);
   ...
   Graph_Graph_from_VbbHcc_both_H_dR1429->SetMinimum(29.08014);
...
// ------------>Primitives in pad: bottomPad
   ...
   data_mc_ratio__591->SetBinContent(2,0.8535923);
   data_mc_ratio__591->SetBinContent(3,1.037444);
   data_mc_ratio__591->SetBinContent(4,1.238441);
   data_mc_ratio__591->SetBinContent(5,1.402087);
   data_mc_ratio__591->SetBinContent(6,0.998074);
   data_mc_ratio__591->SetBinContent(7,1.581711);
   data_mc_ratio__591->SetBinContent(8,1.111575);
   data_mc_ratio__591->SetBinContent(9,1.130389);
   data_mc_ratio__591->SetBinContent(10,1.268136);
   data_mc_ratio__591->SetBinContent(11,1.340154);
   data_mc_ratio__591->SetBinContent(12,1.467333);
   data_mc_ratio__591->SetBinContent(13,1.417577);
   data_mc_ratio__591->SetBinContent(14,1.249051);
   data_mc_ratio__591->SetBinContent(15,1.352022);
   data_mc_ratio__591->SetBinContent(16,1.257592);
   data_mc_ratio__591->SetBinContent(17,1.295037);
   data_mc_ratio__591->SetBinContent(18,1.257962);
   data_mc_ratio__591->SetBinContent(19,1.331732);
   data_mc_ratio__591->SetBinContent(20,1.477007);
   data_mc_ratio__591->SetBinContent(21,2.647608);
   data_mc_ratio__591->SetBinContent(22,1.825976);
   data_mc_ratio__591->SetBinContent(23,1.545128);
   data_mc_ratio__591->SetBinContent(24,1.744543);
   data_mc_ratio__591->SetBinContent(25,3.228923);
   data_mc_ratio__591->SetBinContent(26,10.57399);
   data_mc_ratio__591->SetBinContent(27,22.90449);
   data_mc_ratio__591->SetBinContent(28,12.46361);
   data_mc_ratio__591->SetBinError(2,0.2845308);
   data_mc_ratio__591->SetBinError(3,0.008544207);
   data_mc_ratio__591->SetBinError(4,0.009583059);
   data_mc_ratio__591->SetBinError(5,0.01195269);
   data_mc_ratio__591->SetBinError(6,0.008447644);
   data_mc_ratio__591->SetBinError(7,0.01346832);
   data_mc_ratio__591->SetBinError(8,0.009293507);
   data_mc_ratio__591->SetBinError(9,0.009195928);
   data_mc_ratio__591->SetBinError(10,0.009898557);
   data_mc_ratio__591->SetBinError(11,0.009961289);
   data_mc_ratio__591->SetBinError(12,0.01016582);
   data_mc_ratio__591->SetBinError(13,0.009250994);
   data_mc_ratio__591->SetBinError(14,0.007612768);
   data_mc_ratio__591->SetBinError(15,0.007868974);
   data_mc_ratio__591->SetBinError(16,0.007168355);
   data_mc_ratio__591->SetBinError(17,0.009378668);
   data_mc_ratio__591->SetBinError(18,0.01106802);
   data_mc_ratio__591->SetBinError(19,0.01400969);
   data_mc_ratio__591->SetBinError(20,0.01856146);
   data_mc_ratio__591->SetBinError(21,0.0409707);
   data_mc_ratio__591->SetBinError(22,0.03482633);
   data_mc_ratio__591->SetBinError(23,0.03708426);
   data_mc_ratio__591->SetBinError(24,0.05513974);
   data_mc_ratio__591->SetBinError(25,0.1384389);
   data_mc_ratio__591->SetBinError(26,0.6532635);
   data_mc_ratio__591->SetBinError(27,2.290449);
   data_mc_ratio__591->SetBinError(28,2.859349);
   data_mc_ratio__591->SetMinimum(0.4);
   data_mc_ratio__591->SetMaximum(1.6);
   data_mc_ratio__591->SetEntries(110.9672);
