...
// ------------>Primitives in pad: topPad
   ...
   topPad->Draw();
   topPad->cd();
   topPad->Range(-45.96762,-2.819697,315.7258,10.64796);
   ...
   st->SetTitle("");
   st->SetMinimum(0.01);
   st->SetMaximum(6.33095e+08);
   
   TH1F *st_stack_3 = new TH1F("st_stack_3","",40,0,400);
   st_stack_3->SetMinimum(0.001562321);
   st_stack_3->SetMaximum(2.000766e+09);
   ...
   Graph_Graph_from_VbbHcc_tags_Z_mass1005->SetMinimum(9.815562);
