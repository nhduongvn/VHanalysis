...
// ------------>Primitives in pad: topPad
   ...
   topPad->Draw();
   topPad->cd();
   topPad->Range(-0.9499975,-51.76715,6.525,51725.38);
   ...
   VbbHcc_tags_H_dR__45->SetBinContent(2,13);
   VbbHcc_tags_H_dR__45->SetBinContent(3,14878);
   VbbHcc_tags_H_dR__45->SetBinContent(4,15769);
   VbbHcc_tags_H_dR__45->SetBinContent(5,11871);
   VbbHcc_tags_H_dR__45->SetBinContent(6,11200);
   VbbHcc_tags_H_dR__45->SetBinContent(7,10642);
   VbbHcc_tags_H_dR__45->SetBinContent(8,10696);
   VbbHcc_tags_H_dR__45->SetBinContent(9,10902);
   VbbHcc_tags_H_dR__45->SetBinContent(10,11343);
   VbbHcc_tags_H_dR__45->SetBinContent(11,12435);
   VbbHcc_tags_H_dR__45->SetBinContent(12,13554);
   VbbHcc_tags_H_dR__45->SetBinContent(13,15129);
   VbbHcc_tags_H_dR__45->SetBinContent(14,17248);
   VbbHcc_tags_H_dR__45->SetBinContent(15,18550);
   VbbHcc_tags_H_dR__45->SetBinContent(16,19949);
   VbbHcc_tags_H_dR__45->SetBinContent(17,19191);
   VbbHcc_tags_H_dR__45->SetBinContent(18,17678);
   VbbHcc_tags_H_dR__45->SetBinContent(19,16232);
   VbbHcc_tags_H_dR__45->SetBinContent(20,13964);
   VbbHcc_tags_H_dR__45->SetBinContent(21,11619);
   VbbHcc_tags_H_dR__45->SetBinContent(22,9137);
   VbbHcc_tags_H_dR__45->SetBinContent(23,7334);
   VbbHcc_tags_H_dR__45->SetBinContent(24,5754);
   VbbHcc_tags_H_dR__45->SetBinContent(25,4616);
   VbbHcc_tags_H_dR__45->SetBinContent(26,3637);
   VbbHcc_tags_H_dR__45->SetBinContent(27,2990);
   VbbHcc_tags_H_dR__45->SetBinContent(28,2546);
   VbbHcc_tags_H_dR__45->SetBinContent(29,2337);
   VbbHcc_tags_H_dR__45->SetBinContent(30,1644);
   VbbHcc_tags_H_dR__45->SetBinContent(31,1377);
   VbbHcc_tags_H_dR__45->SetEntries(314264);
...
// ------------>Primitives in pad: bottomPad
   ...
   data_mc_ratio__46->SetBinContent(2,18.72997);
   data_mc_ratio__46->SetBinContent(3,1.046265);
   data_mc_ratio__46->SetBinContent(4,1.294985);
   data_mc_ratio__46->SetBinContent(5,1.241864);
   data_mc_ratio__46->SetBinContent(6,1.434108);
   data_mc_ratio__46->SetBinContent(7,1.451816);
   data_mc_ratio__46->SetBinContent(8,1.209374);
   data_mc_ratio__46->SetBinContent(9,1.222874);
   data_mc_ratio__46->SetBinContent(10,1.297512);
   data_mc_ratio__46->SetBinContent(11,1.269982);
   data_mc_ratio__46->SetBinContent(12,1.200612);
   data_mc_ratio__46->SetBinContent(13,1.304839);
   data_mc_ratio__46->SetBinContent(14,1.283637);
   data_mc_ratio__46->SetBinContent(15,1.166148);
   data_mc_ratio__46->SetBinContent(16,1.379107);
   data_mc_ratio__46->SetBinContent(17,1.280212);
   data_mc_ratio__46->SetBinContent(18,1.056947);
   data_mc_ratio__46->SetBinContent(19,1.235561);
   data_mc_ratio__46->SetBinContent(20,1.287244);
   data_mc_ratio__46->SetBinContent(21,1.967847);
   data_mc_ratio__46->SetBinContent(22,1.765046);
   data_mc_ratio__46->SetBinContent(23,1.606249);
   data_mc_ratio__46->SetBinContent(24,1.774008);
   data_mc_ratio__46->SetBinContent(25,1.569924);
   data_mc_ratio__46->SetBinContent(26,1.132053);
   data_mc_ratio__46->SetBinContent(27,1.003454);
   data_mc_ratio__46->SetBinContent(28,1.51673);
   data_mc_ratio__46->SetBinContent(29,0.6795262);
   data_mc_ratio__46->SetBinContent(30,0.890737);
   data_mc_ratio__46->SetBinContent(31,1.325555);
   data_mc_ratio__46->SetBinError(2,5.194759);
   data_mc_ratio__46->SetBinError(3,0.008577674);
   data_mc_ratio__46->SetBinError(4,0.01031247);
   data_mc_ratio__46->SetBinError(5,0.01139804);
   data_mc_ratio__46->SetBinError(6,0.01355105);
   data_mc_ratio__46->SetBinError(7,0.01407343);
   data_mc_ratio__46->SetBinError(8,0.01169365);
   data_mc_ratio__46->SetBinError(9,0.01171193);
   data_mc_ratio__46->SetBinError(10,0.01218281);
   data_mc_ratio__46->SetBinError(11,0.01138871);
   data_mc_ratio__46->SetBinError(12,0.01031262);
   data_mc_ratio__46->SetBinError(13,0.01060845);
   data_mc_ratio__46->SetBinError(14,0.009774012);
   data_mc_ratio__46->SetBinError(15,0.008562127);
   data_mc_ratio__46->SetBinError(16,0.009764216);
   data_mc_ratio__46->SetBinError(17,0.009241298);
   data_mc_ratio__46->SetBinError(18,0.007949443);
   data_mc_ratio__46->SetBinError(19,0.009697914);
   data_mc_ratio__46->SetBinError(20,0.01089321);
   data_mc_ratio__46->SetBinError(21,0.01825606);
   data_mc_ratio__46->SetBinError(22,0.01846521);
   data_mc_ratio__46->SetBinError(23,0.01875609);
   data_mc_ratio__46->SetBinError(24,0.02338679);
   data_mc_ratio__46->SetBinError(25,0.02310712);
   data_mc_ratio__46->SetBinError(26,0.01877133);
   data_mc_ratio__46->SetBinError(27,0.01835108);
   data_mc_ratio__46->SetBinError(28,0.03005931);
   data_mc_ratio__46->SetBinError(29,0.01405649);
   data_mc_ratio__46->SetBinError(30,0.02196841);
   data_mc_ratio__46->SetBinError(31,0.4983869);
   data_mc_ratio__46->SetMinimum(0.4);
   data_mc_ratio__46->SetMaximum(1.6);
   data_mc_ratio__46->SetEntries(51.98636);
