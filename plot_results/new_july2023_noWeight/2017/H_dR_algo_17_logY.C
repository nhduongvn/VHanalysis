...
// ------------>Primitives in pad: topPad
   ...
   topPad->Draw();
   topPad->cd();
   topPad->Range(-0.9499975,-2.899427,6.525,13.47927);
   ...
   st->SetTitle("");
   st->SetMinimum(0.01);
   st->SetMaximum(1.898584e+11);
   
   TH1F *st_stack_118 = new TH1F("st_stack_118","",30,0,6);
   st_stack_118->SetMinimum(0.001309035);
   st_stack_118->SetMaximum(6.940626e+11);
   ...
   Graph_Graph_from_VbbHcc_algo_H_dR1235->SetMinimum(147.6467);
