...
// ------------>Primitives in pad: topPad
   ...
   VbbHcc_algo_Sphericity__307->SetBinContent(1,86139);
   VbbHcc_algo_Sphericity__307->SetBinContent(2,77189);
   VbbHcc_algo_Sphericity__307->SetBinContent(3,43715);
   VbbHcc_algo_Sphericity__307->SetBinContent(4,24502);
   VbbHcc_algo_Sphericity__307->SetBinContent(5,13206);
   VbbHcc_algo_Sphericity__307->SetBinContent(6,6052);
   VbbHcc_algo_Sphericity__307->SetBinContent(7,2438);
   VbbHcc_algo_Sphericity__307->SetBinContent(8,993);
   VbbHcc_algo_Sphericity__307->SetBinContent(9,487);
   VbbHcc_algo_Sphericity__307->SetBinContent(10,235);
   VbbHcc_algo_Sphericity__307->SetBinContent(11,143);
   VbbHcc_algo_Sphericity__307->SetBinContent(12,79);
   VbbHcc_algo_Sphericity__307->SetBinContent(13,50);
   VbbHcc_algo_Sphericity__307->SetBinContent(14,40);
   VbbHcc_algo_Sphericity__307->SetBinContent(15,25);
   VbbHcc_algo_Sphericity__307->SetBinContent(16,13);
   VbbHcc_algo_Sphericity__307->SetBinContent(17,18);
   VbbHcc_algo_Sphericity__307->SetBinContent(18,3);
   VbbHcc_algo_Sphericity__307->SetBinContent(19,6);
   VbbHcc_algo_Sphericity__307->SetBinContent(20,5);
   VbbHcc_algo_Sphericity__307->SetBinContent(21,1);
   VbbHcc_algo_Sphericity__307->SetEntries(255363);
...
// ------------>Primitives in pad: bottomPad
   ...
   data_mc_ratio__308->SetBinContent(1,0.1443625);
   data_mc_ratio__308->SetBinContent(2,0.1364449);
   data_mc_ratio__308->SetBinContent(3,0.1457523);
   data_mc_ratio__308->SetBinContent(4,0.1394896);
   data_mc_ratio__308->SetBinContent(5,0.1509627);
   data_mc_ratio__308->SetBinContent(6,0.1619594);
   data_mc_ratio__308->SetBinContent(7,0.2349539);
   data_mc_ratio__308->SetBinContent(8,0.21544);
   data_mc_ratio__308->SetBinContent(9,0.263326);
   data_mc_ratio__308->SetBinContent(10,0.2514271);
   data_mc_ratio__308->SetBinContent(11,0.1585231);
   data_mc_ratio__308->SetBinContent(12,0.2737885);
   data_mc_ratio__308->SetBinContent(13,0.2161925);
   data_mc_ratio__308->SetBinContent(14,0.2322419);
   data_mc_ratio__308->SetBinContent(15,0.2700529);
   data_mc_ratio__308->SetBinContent(16,0.03642071);
   data_mc_ratio__308->SetBinContent(17,0.2687873);
   data_mc_ratio__308->SetBinContent(18,0.07074539);
   data_mc_ratio__308->SetBinContent(19,0.1779434);
   data_mc_ratio__308->SetBinContent(20,0.3215704);
   data_mc_ratio__308->SetBinContent(21,1.877565);
   data_mc_ratio__308->SetBinError(1,0.0004918746);
   data_mc_ratio__308->SetBinError(2,0.000491111);
   data_mc_ratio__308->SetBinError(3,0.0006971084);
   data_mc_ratio__308->SetBinError(4,0.0008911298);
   data_mc_ratio__308->SetBinError(5,0.001313663);
   data_mc_ratio__308->SetBinError(6,0.002081885);
   data_mc_ratio__308->SetBinError(7,0.004758453);
   data_mc_ratio__308->SetBinError(8,0.006836781);
   data_mc_ratio__308->SetBinError(9,0.01193244);
   data_mc_ratio__308->SetBinError(10,0.01640129);
   data_mc_ratio__308->SetBinError(11,0.01325637);
   data_mc_ratio__308->SetBinError(12,0.03080361);
   data_mc_ratio__308->SetBinError(13,0.03057424);
   data_mc_ratio__308->SetBinError(14,0.03672066);
   data_mc_ratio__308->SetBinError(15,0.05401057);
   data_mc_ratio__308->SetBinError(16,0.01010129);
   data_mc_ratio__308->SetBinError(17,0.06335377);
   data_mc_ratio__308->SetBinError(18,0.04084487);
   data_mc_ratio__308->SetBinError(19,0.07264511);
   data_mc_ratio__308->SetBinError(20,0.1438107);
   data_mc_ratio__308->SetBinError(21,1.877565);
   data_mc_ratio__308->SetMinimum(0.4);
   data_mc_ratio__308->SetMaximum(1.6);
   data_mc_ratio__308->SetEntries(8.127153);
