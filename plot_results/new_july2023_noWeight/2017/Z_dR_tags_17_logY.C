...
// ------------>Primitives in pad: topPad
   ...
   topPad->Draw();
   topPad->cd();
   topPad->Range(-0.9193524,-2.855012,6.314516,11.84405);
   ...
   st->SetTitle("");
   st->SetMinimum(0.01);
   st->SetMaximum(7.024284e+09);
   
   TH1F *st_stack_18 = new TH1F("st_stack_18","",30,0,6);
   st_stack_18->SetMinimum(0.001444398);
   st_stack_18->SetMaximum(2.366706e+10);
   ...
   Graph_Graph_from_VbbHcc_tags_Z_dR1035->SetMinimum(46.03335);
