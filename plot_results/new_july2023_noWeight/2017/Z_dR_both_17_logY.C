...
// ------------>Primitives in pad: topPad
   ...
   topPad->Draw();
   topPad->cd();
   topPad->Range(-0.9193524,-2.855502,6.314516,11.86125);
   ...
   st->SetTitle("");
   st->SetMinimum(0.01);
   st->SetMaximum(7.271855e+09);
   
   TH1F *st_stack_210 = new TH1F("st_stack_210","",30,0,6);
   st_stack_210->SetMinimum(0.00144283);
   st_stack_210->SetMaximum(2.452309e+10);
   ...
   Graph_Graph_from_VbbHcc_both_Z_dR1419->SetMinimum(46.49966);
