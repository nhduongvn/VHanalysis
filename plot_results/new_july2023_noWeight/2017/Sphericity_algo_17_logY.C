...
// ------------>Primitives in pad: topPad
   ...
   topPad->Draw();
   topPad->cd();
   topPad->Range(-0.1532254,-2.943379,1.052419,15.2531);
   ...
   st->SetTitle("");
   st->SetMinimum(0.01);
   st->SetMaximum(6.83896e+12);
   
   TH1F *st_stack_154 = new TH1F("st_stack_154","",25,0,1);
   st_stack_154->SetMinimum(0.001188002);
   st_stack_154->SetMaximum(2.713014e+13);
   ...
   Graph_Graph_from_VbbHcc_algo_Sphericity1307->SetMinimum(681.4287);
