...
// ------------>Primitives in pad: topPad
   ...
   topPad->Draw();
   topPad->cd();
   topPad->Range(-0.9193524,-2.903514,6.314516,13.63746);
   ...
   st->SetTitle("");
   st->SetMinimum(0.01);
   st->SetMaximum(2.612856e+11);
   
   TH1F *st_stack_114 = new TH1F("st_stack_114","",30,0,6);
   st_stack_114->SetMinimum(0.00129726);
   st_stack_114->SetMaximum(9.624252e+11);
   ...
   Graph_Graph_from_VbbHcc_algo_Z_dR1227->SetMinimum(167.9587);
