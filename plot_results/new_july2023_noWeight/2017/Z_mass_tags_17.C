...
// ------------>Primitives in pad: topPad
   ...
   topPad->Draw();
   topPad->cd();
   topPad->Range(-45.96762,-43.74403,315.7258,43710.28);
   ...
   VbbHcc_tags_Z_mass__3->SetBinContent(4,279);
   VbbHcc_tags_Z_mass__3->SetBinContent(5,1023);
   VbbHcc_tags_Z_mass__3->SetBinContent(6,1611);
   VbbHcc_tags_Z_mass__3->SetBinContent(7,1920);
   VbbHcc_tags_Z_mass__3->SetBinContent(15,1551);
   VbbHcc_tags_Z_mass__3->SetBinContent(16,1452);
   VbbHcc_tags_Z_mass__3->SetBinContent(17,1396);
   VbbHcc_tags_Z_mass__3->SetBinContent(18,1327);
   VbbHcc_tags_Z_mass__3->SetBinContent(19,1274);
   VbbHcc_tags_Z_mass__3->SetBinContent(20,1228);
   VbbHcc_tags_Z_mass__3->SetBinContent(21,1164);
   VbbHcc_tags_Z_mass__3->SetBinContent(22,1080);
   VbbHcc_tags_Z_mass__3->SetBinContent(23,981);
   VbbHcc_tags_Z_mass__3->SetBinContent(24,999);
   VbbHcc_tags_Z_mass__3->SetBinContent(25,943);
   VbbHcc_tags_Z_mass__3->SetBinContent(26,911);
   VbbHcc_tags_Z_mass__3->SetBinContent(27,842);
   VbbHcc_tags_Z_mass__3->SetBinContent(28,899);
   VbbHcc_tags_Z_mass__3->SetBinContent(29,859);
   VbbHcc_tags_Z_mass__3->SetBinContent(30,748);
   VbbHcc_tags_Z_mass__3->SetBinContent(31,782);
   VbbHcc_tags_Z_mass__3->SetBinContent(32,766);
   VbbHcc_tags_Z_mass__3->SetBinContent(33,775);
   VbbHcc_tags_Z_mass__3->SetBinContent(34,705);
   VbbHcc_tags_Z_mass__3->SetBinContent(35,700);
   VbbHcc_tags_Z_mass__3->SetBinContent(36,655);
   VbbHcc_tags_Z_mass__3->SetBinContent(37,708);
   VbbHcc_tags_Z_mass__3->SetBinContent(38,649);
   VbbHcc_tags_Z_mass__3->SetBinContent(39,640);
   VbbHcc_tags_Z_mass__3->SetBinContent(40,628);
   VbbHcc_tags_Z_mass__3->SetBinContent(41,26210);
   VbbHcc_tags_Z_mass__3->SetEntries(68570);
...
// ------------>Primitives in pad: bottomPad
   ...
   data_mc_ratio__4->SetBinContent(3,0.8839902);
   data_mc_ratio__4->SetBinContent(4,0.2815021);
   data_mc_ratio__4->SetBinContent(5,0.5928429);
   data_mc_ratio__4->SetBinContent(6,0.3099625);
   data_mc_ratio__4->SetBinContent(7,0.3066486);
   data_mc_ratio__4->SetBinContent(8,0.2845429);
   data_mc_ratio__4->SetBinContent(9,0.3452743);
   data_mc_ratio__4->SetBinContent(10,0.3171651);
   data_mc_ratio__4->SetBinContent(11,0.5287338);
   data_mc_ratio__4->SetBinContent(12,0.656671);
   data_mc_ratio__4->SetBinContent(13,0.3432992);
   data_mc_ratio__4->SetBinContent(14,0.3595748);
   data_mc_ratio__4->SetBinContent(15,0.2912616);
   data_mc_ratio__4->SetBinContent(16,0.4861014);
   data_mc_ratio__4->SetBinContent(17,0.3670629);
   data_mc_ratio__4->SetBinContent(18,0.3452868);
   data_mc_ratio__4->SetBinContent(19,0.2372885);
   data_mc_ratio__4->SetBinContent(20,0.3580958);
   data_mc_ratio__4->SetBinContent(21,0.244461);
   data_mc_ratio__4->SetBinContent(22,0.06406527);
   data_mc_ratio__4->SetBinContent(23,0.3083657);
   data_mc_ratio__4->SetBinContent(24,0.351959);
   data_mc_ratio__4->SetBinContent(25,0.2701317);
   data_mc_ratio__4->SetBinContent(26,0.4309943);
   data_mc_ratio__4->SetBinContent(27,0.3350548);
   data_mc_ratio__4->SetBinContent(28,0.383798);
   data_mc_ratio__4->SetBinContent(29,0.3432915);
   data_mc_ratio__4->SetBinContent(30,0.4343581);
   data_mc_ratio__4->SetBinContent(31,0.4629657);
   data_mc_ratio__4->SetBinContent(32,0.3872915);
   data_mc_ratio__4->SetBinContent(33,0.4878752);
   data_mc_ratio__4->SetBinContent(34,0.3343681);
   data_mc_ratio__4->SetBinContent(35,0.2890911);
   data_mc_ratio__4->SetBinContent(36,0.2613947);
   data_mc_ratio__4->SetBinContent(37,0.4576852);
   data_mc_ratio__4->SetBinContent(38,0.2193116);
   data_mc_ratio__4->SetBinContent(39,0.2535311);
   data_mc_ratio__4->SetBinContent(40,0.3313135);
   data_mc_ratio__4->SetBinContent(41,0.2807789);
   data_mc_ratio__4->SetBinError(3,0.3341169);
   data_mc_ratio__4->SetBinError(4,0.01685309);
   data_mc_ratio__4->SetBinError(5,0.01853539);
   data_mc_ratio__4->SetBinError(6,0.007722561);
   data_mc_ratio__4->SetBinError(7,0.006998264);
   data_mc_ratio__4->SetBinError(8,0.006302977);
   data_mc_ratio__4->SetBinError(9,0.007927397);
   data_mc_ratio__4->SetBinError(10,0.007243931);
   data_mc_ratio__4->SetBinError(11,0.01217492);
   data_mc_ratio__4->SetBinError(12,0.01547788);
   data_mc_ratio__4->SetBinError(13,0.008309139);
   data_mc_ratio__4->SetBinError(14,0.009063311);
   data_mc_ratio__4->SetBinError(15,0.007395668);
   data_mc_ratio__4->SetBinError(16,0.01275685);
   data_mc_ratio__4->SetBinError(17,0.009824213);
   data_mc_ratio__4->SetBinError(18,0.009478607);
   data_mc_ratio__4->SetBinError(19,0.006648014);
   data_mc_ratio__4->SetBinError(20,0.0102188);
   data_mc_ratio__4->SetBinError(21,0.007165278);
   data_mc_ratio__4->SetBinError(22,0.001949444);
   data_mc_ratio__4->SetBinError(23,0.00984536);
   data_mc_ratio__4->SetBinError(24,0.01113549);
   data_mc_ratio__4->SetBinError(25,0.0087967);
   data_mc_ratio__4->SetBinError(26,0.01427948);
   data_mc_ratio__4->SetBinError(27,0.01154675);
   data_mc_ratio__4->SetBinError(28,0.01280038);
   data_mc_ratio__4->SetBinError(29,0.01171295);
   data_mc_ratio__4->SetBinError(30,0.01588171);
   data_mc_ratio__4->SetBinError(31,0.01655562);
   data_mc_ratio__4->SetBinError(32,0.01399341);
   data_mc_ratio__4->SetBinError(33,0.017525);
   data_mc_ratio__4->SetBinError(34,0.01259303);
   data_mc_ratio__4->SetBinError(35,0.01092662);
   data_mc_ratio__4->SetBinError(36,0.01021354);
   data_mc_ratio__4->SetBinError(37,0.01720086);
   data_mc_ratio__4->SetBinError(38,0.008608732);
   data_mc_ratio__4->SetBinError(39,0.0100217);
   data_mc_ratio__4->SetBinError(40,0.01322085);
   data_mc_ratio__4->SetBinError(41,0.04556185);
   data_mc_ratio__4->SetMinimum(0.4);
   data_mc_ratio__4->SetMaximum(1.6);
   data_mc_ratio__4->SetEntries(203.2373);
