...
// ------------>Primitives in pad: topPad
   ...
   topPad->Draw();
   topPad->cd();
   topPad->Range(-45.96762,-2.842419,315.7258,11.40735);
   ...
   st->SetTitle("");
   st->SetMinimum(0.01);
   st->SetMaximum(2.916002e+09);
   
   TH1F *st_stack_6 = new TH1F("st_stack_6","",40,0,400);
   st_stack_6->SetMinimum(0.001485356);
   st_stack_6->SetMaximum(9.602271e+09);
   ...
   Graph_Graph_from_VbbHcc_tags_H_mass1011->SetMinimum(36.29319);
