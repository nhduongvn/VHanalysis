...
// ------------>Primitives in pad: topPad
   ...
   topPad->Draw();
   topPad->cd();
   topPad->Range(-45.96762,-2.884706,315.7258,12.92043);
   ...
   st->SetTitle("");
   st->SetMinimum(0.01);
   st->SetMaximum(6.148147e+10);
   
   TH1F *st_stack_262 = new TH1F("st_stack_262","",150,0,300);
   st_stack_262->SetMinimum(0.00135238);
   st_stack_262->SetMaximum(2.187356e+11);
   ...
   Graph_Graph_from_VbbHcc_both_H_jetpt_JEC1523->SetMinimum(82.76137);
