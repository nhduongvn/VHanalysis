...
// ------------>Primitives in pad: topPad
   ...
   topPad->Draw();
   topPad->cd();
   topPad->Range(-0.9499975,-2.855979,6.525,11.87807);
   ...
   st->SetTitle("");
   st->SetMinimum(0.01);
   st->SetMaximum(7.522392e+09);
   
   TH1F *st_stack_22 = new TH1F("st_stack_22","",30,0,6);
   st_stack_22->SetMinimum(0.001441301);
   st_stack_22->SetMaximum(2.539011e+10);
   ...
   Graph_Graph_from_VbbHcc_tags_H_dR1043->SetMinimum(46.96535);
