...
// ------------>Primitives in pad: topPad
   ...
   topPad->Draw();
   topPad->cd();
   topPad->Range(-0.9499975,-2.853718,6.525,11.79863);
   ...
   st->SetTitle("");
   st->SetMinimum(0.01);
   st->SetMaximum(6.41033e+09);
   
   TH1F *st_stack_214 = new TH1F("st_stack_214","",30,0,6);
   st_stack_214->SetMinimum(0.001448553);
   st_stack_214->SetMaximum(2.154753e+10);
   ...
   VbbHcc_both_H_dR__587->SetBinContent(3,3436);
   VbbHcc_both_H_dR__587->SetBinContent(4,4030);
   VbbHcc_both_H_dR__587->SetBinContent(5,3266);
   VbbHcc_both_H_dR__587->SetBinContent(6,3327);
   VbbHcc_both_H_dR__587->SetBinContent(7,3296);
   VbbHcc_both_H_dR__587->SetBinContent(8,3429);
   VbbHcc_both_H_dR__587->SetBinContent(9,3598);
   VbbHcc_both_H_dR__587->SetBinContent(10,4005);
   VbbHcc_both_H_dR__587->SetBinContent(11,4253);
   VbbHcc_both_H_dR__587->SetBinContent(12,4720);
   VbbHcc_both_H_dR__587->SetBinContent(13,5183);
   VbbHcc_both_H_dR__587->SetBinContent(14,5825);
   VbbHcc_both_H_dR__587->SetBinContent(15,6367);
   VbbHcc_both_H_dR__587->SetBinContent(16,6455);
   VbbHcc_both_H_dR__587->SetBinContent(17,3856);
   VbbHcc_both_H_dR__587->SetBinContent(18,2627);
   VbbHcc_both_H_dR__587->SetBinContent(19,1821);
   VbbHcc_both_H_dR__587->SetBinContent(20,1196);
   VbbHcc_both_H_dR__587->SetBinContent(21,837);
   VbbHcc_both_H_dR__587->SetBinContent(22,544);
   VbbHcc_both_H_dR__587->SetBinContent(23,325);
   VbbHcc_both_H_dR__587->SetBinContent(24,217);
   VbbHcc_both_H_dR__587->SetBinContent(25,93);
   VbbHcc_both_H_dR__587->SetBinContent(26,47);
   VbbHcc_both_H_dR__587->SetBinContent(27,18);
   VbbHcc_both_H_dR__587->SetBinContent(28,4);
   VbbHcc_both_H_dR__587->SetEntries(72808);
   ...
   Graph_Graph_from_VbbHcc_both_H_dR1427->SetMinimum(44.82896);
...
// ------------>Primitives in pad: bottomPad
   ...
   data_mc_ratio__588->SetBinContent(2,0.5483476);
   data_mc_ratio__588->SetBinContent(3,0.1327263);
   data_mc_ratio__588->SetBinContent(4,0.3226622);
   data_mc_ratio__588->SetBinContent(5,0.3258335);
   data_mc_ratio__588->SetBinContent(6,0.3621133);
   data_mc_ratio__588->SetBinContent(7,0.422876);
   data_mc_ratio__588->SetBinContent(8,0.4003198);
   data_mc_ratio__588->SetBinContent(9,0.4691923);
   data_mc_ratio__588->SetBinContent(10,0.1601693);
   data_mc_ratio__588->SetBinContent(11,0.3797848);
   data_mc_ratio__588->SetBinContent(12,0.4210552);
   data_mc_ratio__588->SetBinContent(13,0.3800453);
   data_mc_ratio__588->SetBinContent(14,0.3412489);
   data_mc_ratio__588->SetBinContent(15,0.3466271);
   data_mc_ratio__588->SetBinContent(16,0.306705);
   data_mc_ratio__588->SetBinContent(17,0.3824039);
   data_mc_ratio__588->SetBinContent(18,0.2677186);
   data_mc_ratio__588->SetBinContent(19,0.2474476);
   data_mc_ratio__588->SetBinContent(20,0.4342419);
   data_mc_ratio__588->SetBinContent(21,0.3382408);
   data_mc_ratio__588->SetBinContent(22,0.4357382);
   data_mc_ratio__588->SetBinContent(23,0.2706796);
   data_mc_ratio__588->SetBinContent(24,0.2735705);
   data_mc_ratio__588->SetBinContent(25,0.5003107);
   data_mc_ratio__588->SetBinContent(26,0.1423781);
   data_mc_ratio__588->SetBinContent(27,5.368591);
   data_mc_ratio__588->SetBinContent(28,3.496584);
   data_mc_ratio__588->SetBinError(2,0.2741738);
   data_mc_ratio__588->SetBinError(3,0.002264281);
   data_mc_ratio__588->SetBinError(4,0.005082713);
   data_mc_ratio__588->SetBinError(5,0.00570148);
   data_mc_ratio__588->SetBinError(6,0.006277954);
   data_mc_ratio__588->SetBinError(7,0.007365792);
   data_mc_ratio__588->SetBinError(8,0.006836334);
   data_mc_ratio__588->SetBinError(9,0.007822046);
   data_mc_ratio__588->SetBinError(10,0.002530917);
   data_mc_ratio__588->SetBinError(11,0.005823577);
   data_mc_ratio__588->SetBinError(12,0.006128695);
   data_mc_ratio__588->SetBinError(13,0.005278916);
   data_mc_ratio__588->SetBinError(14,0.004471191);
   data_mc_ratio__588->SetBinError(15,0.004344052);
   data_mc_ratio__588->SetBinError(16,0.003817445);
   data_mc_ratio__588->SetBinError(17,0.0061582);
   data_mc_ratio__588->SetBinError(18,0.005223342);
   data_mc_ratio__588->SetBinError(19,0.005798668);
   data_mc_ratio__588->SetBinError(20,0.01255643);
   data_mc_ratio__588->SetBinError(21,0.01169131);
   data_mc_ratio__588->SetBinError(22,0.01868212);
   data_mc_ratio__588->SetBinError(23,0.0150146);
   data_mc_ratio__588->SetBinError(24,0.01857118);
   data_mc_ratio__588->SetBinError(25,0.05187981);
   data_mc_ratio__588->SetBinError(26,0.02076799);
   data_mc_ratio__588->SetBinError(27,1.265389);
   data_mc_ratio__588->SetBinError(28,1.748292);
   data_mc_ratio__588->SetMinimum(0.4);
   data_mc_ratio__588->SetMaximum(1.6);
   data_mc_ratio__588->SetEntries(47.90329);
