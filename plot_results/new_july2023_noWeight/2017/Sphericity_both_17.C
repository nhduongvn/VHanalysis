...
// ------------>Primitives in pad: topPad
   ...
   topPad->Draw();
   topPad->cd();
   topPad->Range(-0.1532254,-99.20794,1.052419,99118.73);
   ...
   VbbHcc_both_Sphericity__499->SetBinContent(1,12784);
   VbbHcc_both_Sphericity__499->SetBinContent(2,12339);
   VbbHcc_both_Sphericity__499->SetBinContent(3,9350);
   VbbHcc_both_Sphericity__499->SetBinContent(4,6994);
   VbbHcc_both_Sphericity__499->SetBinContent(5,5633);
   VbbHcc_both_Sphericity__499->SetBinContent(6,4542);
   VbbHcc_both_Sphericity__499->SetBinContent(7,3805);
   VbbHcc_both_Sphericity__499->SetBinContent(8,3211);
   VbbHcc_both_Sphericity__499->SetBinContent(9,2702);
   VbbHcc_both_Sphericity__499->SetBinContent(10,2140);
   VbbHcc_both_Sphericity__499->SetBinContent(11,1969);
   VbbHcc_both_Sphericity__499->SetBinContent(12,1671);
   VbbHcc_both_Sphericity__499->SetBinContent(13,1427);
   VbbHcc_both_Sphericity__499->SetBinContent(14,1134);
   VbbHcc_both_Sphericity__499->SetBinContent(15,960);
   VbbHcc_both_Sphericity__499->SetBinContent(16,753);
   VbbHcc_both_Sphericity__499->SetBinContent(17,546);
   VbbHcc_both_Sphericity__499->SetBinContent(18,417);
   VbbHcc_both_Sphericity__499->SetBinContent(19,261);
   VbbHcc_both_Sphericity__499->SetBinContent(20,88);
   VbbHcc_both_Sphericity__499->SetBinContent(21,33);
   VbbHcc_both_Sphericity__499->SetBinContent(22,14);
   VbbHcc_both_Sphericity__499->SetBinContent(23,5);
   VbbHcc_both_Sphericity__499->SetBinContent(24,1);
   VbbHcc_both_Sphericity__499->SetEntries(72803);
...
// ------------>Primitives in pad: bottomPad
   ...
   data_mc_ratio__500->SetBinContent(1,0.4121964);
   data_mc_ratio__500->SetBinContent(2,0.3227801);
   data_mc_ratio__500->SetBinContent(3,0.3033282);
   data_mc_ratio__500->SetBinContent(4,0.3378491);
   data_mc_ratio__500->SetBinContent(5,0.3247507);
   data_mc_ratio__500->SetBinContent(6,0.3417086);
   data_mc_ratio__500->SetBinContent(7,0.3516753);
   data_mc_ratio__500->SetBinContent(8,0.4936836);
   data_mc_ratio__500->SetBinContent(9,0.07119675);
   data_mc_ratio__500->SetBinContent(10,0.3460352);
   data_mc_ratio__500->SetBinContent(11,0.3960049);
   data_mc_ratio__500->SetBinContent(12,0.4214006);
   data_mc_ratio__500->SetBinContent(13,0.4694231);
   data_mc_ratio__500->SetBinContent(14,0.4424157);
   data_mc_ratio__500->SetBinContent(15,0.5331819);
   data_mc_ratio__500->SetBinContent(16,0.3663122);
   data_mc_ratio__500->SetBinContent(17,0.2537747);
   data_mc_ratio__500->SetBinContent(18,0.6093136);
   data_mc_ratio__500->SetBinContent(19,0.4701713);
   data_mc_ratio__500->SetBinContent(20,0.246821);
   data_mc_ratio__500->SetBinContent(21,0.4979307);
   data_mc_ratio__500->SetBinContent(22,0.3488643);
   data_mc_ratio__500->SetBinContent(23,0.01715951);
   data_mc_ratio__500->SetBinContent(24,7.479484);
   data_mc_ratio__500->SetBinError(1,0.003645615);
   data_mc_ratio__500->SetBinError(2,0.002905807);
   data_mc_ratio__500->SetBinError(3,0.003136946);
   data_mc_ratio__500->SetBinError(4,0.004039801);
   data_mc_ratio__500->SetBinError(5,0.004326934);
   data_mc_ratio__500->SetBinError(6,0.005070285);
   data_mc_ratio__500->SetBinError(7,0.005701177);
   data_mc_ratio__500->SetBinError(8,0.008712214);
   data_mc_ratio__500->SetBinError(9,0.001369675);
   data_mc_ratio__500->SetBinError(10,0.007480204);
   data_mc_ratio__500->SetBinError(11,0.008924373);
   data_mc_ratio__500->SetBinError(12,0.01030877);
   data_mc_ratio__500->SetBinError(13,0.0124266);
   data_mc_ratio__500->SetBinError(14,0.01313784);
   data_mc_ratio__500->SetBinError(15,0.01720837);
   data_mc_ratio__500->SetBinError(16,0.01334916);
   data_mc_ratio__500->SetBinError(17,0.01086055);
   data_mc_ratio__500->SetBinError(18,0.02983821);
   data_mc_ratio__500->SetBinError(19,0.02910287);
   data_mc_ratio__500->SetBinError(20,0.02631121);
   data_mc_ratio__500->SetBinError(21,0.0866786);
   data_mc_ratio__500->SetBinError(22,0.0932379);
   data_mc_ratio__500->SetBinError(23,0.007673967);
   data_mc_ratio__500->SetBinError(24,7.479484);
   data_mc_ratio__500->SetMinimum(0.4);
   data_mc_ratio__500->SetMaximum(1.6);
   data_mc_ratio__500->SetEntries(3.359312);
