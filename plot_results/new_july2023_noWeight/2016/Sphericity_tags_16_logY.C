...
// ------------>Primitives in pad: topPad
   ...
   topPad->Draw();
   topPad->cd();
   topPad->Range(-0.1532254,-2.883765,1.052419,12.88528);
   ...
   st->SetTitle("");
   st->SetMinimum(0.01);
   st->SetMaximum(5.727368e+10);
   
   TH1F *st_stack_57 = new TH1F("st_stack_57","",25,0,1);
   st_stack_57->SetMinimum(0.001355201);
   st_stack_57->SetMaximum(2.034127e+11);
   ...
   Graph_Graph_from_VbbHcc_tags_Sphericity1113->SetMinimum(81.54593);
