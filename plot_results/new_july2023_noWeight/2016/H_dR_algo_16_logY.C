...
// ------------>Primitives in pad: topPad
   ...
   topPad->Draw();
   topPad->cd();
   topPad->Range(-0.9499975,-2.921442,6.525,14.34753);
   ...
   st->SetTitle("");
   st->SetMinimum(0.01);
   st->SetMaximum(1.096326e+12);
   
   TH1F *st_stack_117 = new TH1F("st_stack_117","",30,0,6);
   st_stack_117->SetMinimum(0.001246887);
   st_stack_117->SetMaximum(4.174796e+12);
   ...
   Graph_Graph_from_VbbHcc_algo_H_dR1233->SetMinimum(312.2263);
