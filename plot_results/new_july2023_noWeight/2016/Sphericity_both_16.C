...
// ------------>Primitives in pad: topPad
   ...
   topPad->Draw();
   topPad->cd();
   topPad->Range(-0.1532254,-95.89108,1.052419,95805.18);
   ...
   VbbHcc_both_Sphericity__497->SetBinContent(1,17424);
   VbbHcc_both_Sphericity__497->SetBinContent(2,17833);
   VbbHcc_both_Sphericity__497->SetBinContent(3,13291);
   VbbHcc_both_Sphericity__497->SetBinContent(4,10025);
   VbbHcc_both_Sphericity__497->SetBinContent(5,7873);
   VbbHcc_both_Sphericity__497->SetBinContent(6,6537);
   VbbHcc_both_Sphericity__497->SetBinContent(7,5342);
   VbbHcc_both_Sphericity__497->SetBinContent(8,4356);
   VbbHcc_both_Sphericity__497->SetBinContent(9,3673);
   VbbHcc_both_Sphericity__497->SetBinContent(10,3083);
   VbbHcc_both_Sphericity__497->SetBinContent(11,2627);
   VbbHcc_both_Sphericity__497->SetBinContent(12,2248);
   VbbHcc_both_Sphericity__497->SetBinContent(13,1961);
   VbbHcc_both_Sphericity__497->SetBinContent(14,1576);
   VbbHcc_both_Sphericity__497->SetBinContent(15,1287);
   VbbHcc_both_Sphericity__497->SetBinContent(16,1008);
   VbbHcc_both_Sphericity__497->SetBinContent(17,776);
   VbbHcc_both_Sphericity__497->SetBinContent(18,573);
   VbbHcc_both_Sphericity__497->SetBinContent(19,316);
   VbbHcc_both_Sphericity__497->SetBinContent(20,145);
   VbbHcc_both_Sphericity__497->SetBinContent(21,45);
   VbbHcc_both_Sphericity__497->SetBinContent(22,14);
   VbbHcc_both_Sphericity__497->SetBinContent(23,5);
   VbbHcc_both_Sphericity__497->SetEntries(102042);
   ...
   Graph_Graph_from_VbbHcc_both_Sphericity1497->SetMinimum(0);
...
// ------------>Primitives in pad: bottomPad
   ...
   data_mc_ratio__498->SetBinContent(1,0.5822536);
   data_mc_ratio__498->SetBinContent(2,0.4826341);
   data_mc_ratio__498->SetBinContent(3,0.5350662);
   data_mc_ratio__498->SetBinContent(4,0.4584349);
   data_mc_ratio__498->SetBinContent(5,0.5369089);
   data_mc_ratio__498->SetBinContent(6,0.5678905);
   data_mc_ratio__498->SetBinContent(7,0.4916975);
   data_mc_ratio__498->SetBinContent(8,0.7042859);
   data_mc_ratio__498->SetBinContent(9,0.7470159);
   data_mc_ratio__498->SetBinContent(10,0.4122779);
   data_mc_ratio__498->SetBinContent(11,0.5533054);
   data_mc_ratio__498->SetBinContent(12,0.4175357);
   data_mc_ratio__498->SetBinContent(13,0.5858188);
   data_mc_ratio__498->SetBinContent(14,0.5858196);
   data_mc_ratio__498->SetBinContent(15,0.303366);
   data_mc_ratio__498->SetBinContent(16,0.607764);
   data_mc_ratio__498->SetBinContent(17,0.6741181);
   data_mc_ratio__498->SetBinContent(18,0.3779433);
   data_mc_ratio__498->SetBinContent(19,2.445059);
   data_mc_ratio__498->SetBinContent(20,0.8621951);
   data_mc_ratio__498->SetBinContent(21,1.250082);
   data_mc_ratio__498->SetBinContent(22,0.3556404);
   data_mc_ratio__498->SetBinContent(23,4.196921);
   data_mc_ratio__498->SetBinError(1,0.004411012);
   data_mc_ratio__498->SetBinError(2,0.003614147);
   data_mc_ratio__498->SetBinError(3,0.004641183);
   data_mc_ratio__498->SetBinError(4,0.004578629);
   data_mc_ratio__498->SetBinError(5,0.006051047);
   data_mc_ratio__498->SetBinError(6,0.007023853);
   data_mc_ratio__498->SetBinError(7,0.006727381);
   data_mc_ratio__498->SetBinError(8,0.010671);
   data_mc_ratio__498->SetBinError(9,0.01232592);
   data_mc_ratio__498->SetBinError(10,0.007425117);
   data_mc_ratio__498->SetBinError(11,0.0107953);
   data_mc_ratio__498->SetBinError(12,0.008806341);
   data_mc_ratio__498->SetBinError(13,0.01322892);
   data_mc_ratio__498->SetBinError(14,0.01475658);
   data_mc_ratio__498->SetBinError(15,0.008456245);
   data_mc_ratio__498->SetBinError(16,0.01914277);
   data_mc_ratio__498->SetBinError(17,0.02419943);
   data_mc_ratio__498->SetBinError(18,0.01578881);
   data_mc_ratio__498->SetBinError(19,0.1375453);
   data_mc_ratio__498->SetBinError(20,0.0716014);
   data_mc_ratio__498->SetBinError(21,0.1863512);
   data_mc_ratio__498->SetBinError(22,0.09504889);
   data_mc_ratio__498->SetBinError(23,1.87692);
   data_mc_ratio__498->SetMinimum(0.4);
   data_mc_ratio__498->SetMaximum(1.6);
   data_mc_ratio__498->SetEntries(66.19709);
