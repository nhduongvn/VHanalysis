...
// ------------>Primitives in pad: topPad
   ...
   topPad->Draw();
   topPad->cd();
   topPad->Range(-0.1532254,-2.961998,1.052419,16.05456);
   ...
   st->SetTitle("");
   st->SetMinimum(0.01);
   st->SetMaximum(3.461661e+13);
   
   TH1F *st_stack_153 = new TH1F("st_stack_153","",25,0,1);
   st_stack_153->SetMinimum(0.001140297);
   st_stack_153->SetMaximum(1.422001e+14);
   ...
   VbbHcc_algo_Sphericity__419->SetBinContent(1,291978);
   VbbHcc_algo_Sphericity__419->SetBinContent(2,254247);
   VbbHcc_algo_Sphericity__419->SetBinContent(3,144572);
   VbbHcc_algo_Sphericity__419->SetBinContent(4,81643);
   VbbHcc_algo_Sphericity__419->SetBinContent(5,43504);
   VbbHcc_algo_Sphericity__419->SetBinContent(6,19759);
   VbbHcc_algo_Sphericity__419->SetBinContent(7,7499);
   VbbHcc_algo_Sphericity__419->SetBinContent(8,2858);
   VbbHcc_algo_Sphericity__419->SetBinContent(9,1216);
   VbbHcc_algo_Sphericity__419->SetBinContent(10,675);
   VbbHcc_algo_Sphericity__419->SetBinContent(11,380);
   VbbHcc_algo_Sphericity__419->SetBinContent(12,264);
   VbbHcc_algo_Sphericity__419->SetBinContent(13,148);
   VbbHcc_algo_Sphericity__419->SetBinContent(14,113);
   VbbHcc_algo_Sphericity__419->SetBinContent(15,88);
   VbbHcc_algo_Sphericity__419->SetBinContent(16,61);
   ...
   VbbHcc_algo_Sphericity__419->SetEntries(849128);
   ...
   Graph_Graph_from_VbbHcc_algo_Sphericity1305->SetMinimum(1391.669);
...
// ------------>Primitives in pad: bottomPad
   ...
   data_mc_ratio__420->SetBinContent(1,0.2358697);
   data_mc_ratio__420->SetBinContent(2,0.2106802);
   data_mc_ratio__420->SetBinContent(3,0.2119712);
   data_mc_ratio__420->SetBinContent(4,0.2098556);
   data_mc_ratio__420->SetBinContent(5,0.244079);
   data_mc_ratio__420->SetBinContent(6,0.270167);
   data_mc_ratio__420->SetBinContent(7,0.2670185);
   data_mc_ratio__420->SetBinContent(8,0.3800213);
   data_mc_ratio__420->SetBinContent(9,0.5172881);
   data_mc_ratio__420->SetBinContent(10,0.3883608);
   data_mc_ratio__420->SetBinContent(11,0.5777688);
   data_mc_ratio__420->SetBinContent(12,0.6492585);
   data_mc_ratio__420->SetBinContent(13,0.2616179);
   data_mc_ratio__420->SetBinContent(14,0.217861);
   data_mc_ratio__420->SetBinContent(15,0.7656454);
   data_mc_ratio__420->SetBinContent(16,0.6228963);
   data_mc_ratio__420->SetBinContent(17,0.1140437);
   data_mc_ratio__420->SetBinContent(18,0.2153453);
   data_mc_ratio__420->SetBinContent(19,0.603845);
   data_mc_ratio__420->SetBinContent(20,0.5210876);
   data_mc_ratio__420->SetBinContent(21,1.95042);
   data_mc_ratio__420->SetBinError(1,0.0004365128);
   data_mc_ratio__420->SetBinError(2,0.0004178262);
   data_mc_ratio__420->SetBinError(3,0.000557487);
   data_mc_ratio__420->SetBinError(4,0.000734448);
   data_mc_ratio__420->SetBinError(5,0.001170215);
   data_mc_ratio__420->SetBinError(6,0.001921984);
   data_mc_ratio__420->SetBinError(7,0.003083469);
   data_mc_ratio__420->SetBinError(8,0.007108481);
   data_mc_ratio__420->SetBinError(9,0.01483425);
   data_mc_ratio__420->SetBinError(10,0.01494801);
   data_mc_ratio__420->SetBinError(11,0.02963892);
   data_mc_ratio__420->SetBinError(12,0.0399591);
   data_mc_ratio__420->SetBinError(13,0.02150486);
   data_mc_ratio__420->SetBinError(14,0.02049464);
   data_mc_ratio__420->SetBinError(15,0.08161807);
   data_mc_ratio__420->SetBinError(16,0.0797537);
   data_mc_ratio__420->SetBinError(17,0.01781063);
   data_mc_ratio__420->SetBinError(18,0.04395717);
   data_mc_ratio__420->SetBinError(19,0.1259104);
   data_mc_ratio__420->SetBinError(20,0.1842323);
   data_mc_ratio__420->SetBinError(21,1.126076);
   data_mc_ratio__420->SetMinimum(0.4);
   data_mc_ratio__420->SetMaximum(1.6);
   data_mc_ratio__420->SetEntries(48.63126);
