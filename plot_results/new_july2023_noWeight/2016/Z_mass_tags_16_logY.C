...
// ------------>Primitives in pad: topPad
   ...
   topPad->Draw();
   topPad->cd();
   topPad->Range(-45.96762,-2.815862,315.7258,10.52331);
   ...
   st->SetTitle("");
   st->SetMinimum(0.01);
   st->SetMaximum(4.927899e+08);
   
   TH1F *st_stack_1 = new TH1F("st_stack_1","",40,0,400);
   st_stack_1->SetMinimum(0.001575714);
   st_stack_1->SetMaximum(1.546637e+09);
   ...
   Graph_Graph_from_VbbHcc_tags_Z_mass1001->SetMinimum(11.80987);
