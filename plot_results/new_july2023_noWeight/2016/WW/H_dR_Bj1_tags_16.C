...
//=========  (Thu Aug 10 12:27:48 2023) by ROOT version 6.14/09
   ...
   H_dR_Bj1_tags_16->Range(-1.2,-0.03527194,6.8,0.3174475);
   ...
   VbbHcc_tags_H_dR_Bj1_stack_6->GetXaxis()->SetTitle("#DeltaR(H,j_{2})");
   VbbHcc_tags_H_dR_Bj1_stack_6->GetXaxis()->SetRange(1,30);
   ...
   VbbHcc_tags_H_dR_Bj1_stack_6->Draw("HIST");
