...
// ------------>Primitives in pad: topPad
   ...
   VbbHcc_both_H_dR__584->SetBinContent(3,4740);
   VbbHcc_both_H_dR__584->SetBinContent(4,5229);
   VbbHcc_both_H_dR__584->SetBinContent(5,4263);
   VbbHcc_both_H_dR__584->SetBinContent(6,4223);
   VbbHcc_both_H_dR__584->SetBinContent(7,4396);
   VbbHcc_both_H_dR__584->SetBinContent(8,4557);
   VbbHcc_both_H_dR__584->SetBinContent(9,4939);
   VbbHcc_both_H_dR__584->SetBinContent(10,5195);
   VbbHcc_both_H_dR__584->SetBinContent(11,5833);
   VbbHcc_both_H_dR__584->SetBinContent(12,6545);
   VbbHcc_both_H_dR__584->SetBinContent(13,7308);
   VbbHcc_both_H_dR__584->SetBinContent(14,8376);
   VbbHcc_both_H_dR__584->SetBinContent(15,9224);
   VbbHcc_both_H_dR__584->SetBinContent(16,9530);
   VbbHcc_both_H_dR__584->SetBinContent(17,5902);
   VbbHcc_both_H_dR__584->SetBinContent(18,3929);
   VbbHcc_both_H_dR__584->SetBinContent(19,2724);
   VbbHcc_both_H_dR__584->SetBinContent(20,1918);
   VbbHcc_both_H_dR__584->SetBinContent(21,1307);
   VbbHcc_both_H_dR__584->SetBinContent(22,812);
   VbbHcc_both_H_dR__584->SetBinContent(23,513);
   VbbHcc_both_H_dR__584->SetBinContent(24,301);
   VbbHcc_both_H_dR__584->SetBinContent(25,154);
   VbbHcc_both_H_dR__584->SetBinContent(26,64);
   VbbHcc_both_H_dR__584->SetBinContent(27,25);
   VbbHcc_both_H_dR__584->SetBinContent(28,9);
   VbbHcc_both_H_dR__584->SetEntries(102047);
...
// ------------>Primitives in pad: bottomPad
   ...
   data_mc_ratio__585->SetBinContent(2,0.3108118);
   data_mc_ratio__585->SetBinContent(3,0.3462041);
   data_mc_ratio__585->SetBinContent(4,0.4722255);
   data_mc_ratio__585->SetBinContent(5,0.4815492);
   data_mc_ratio__585->SetBinContent(6,0.5551556);
   data_mc_ratio__585->SetBinContent(7,0.5151005);
   data_mc_ratio__585->SetBinContent(8,0.5243097);
   data_mc_ratio__585->SetBinContent(9,0.6296163);
   data_mc_ratio__585->SetBinContent(10,0.4578052);
   data_mc_ratio__585->SetBinContent(11,0.7855426);
   data_mc_ratio__585->SetBinContent(12,0.6272269);
   data_mc_ratio__585->SetBinContent(13,0.5240862);
   data_mc_ratio__585->SetBinContent(14,0.5340899);
   data_mc_ratio__585->SetBinContent(15,0.4510909);
   data_mc_ratio__585->SetBinContent(16,0.4901286);
   data_mc_ratio__585->SetBinContent(17,0.5998191);
   data_mc_ratio__585->SetBinContent(18,0.6737263);
   data_mc_ratio__585->SetBinContent(19,0.7012492);
   data_mc_ratio__585->SetBinContent(20,0.4566277);
   data_mc_ratio__585->SetBinContent(21,0.4171286);
   data_mc_ratio__585->SetBinContent(22,0.5664948);
   data_mc_ratio__585->SetBinContent(23,1.345578);
   data_mc_ratio__585->SetBinContent(24,1.593904);
   data_mc_ratio__585->SetBinContent(25,0.435226);
   data_mc_ratio__585->SetBinContent(26,1.838709);
   data_mc_ratio__585->SetBinContent(27,9.633838);
   data_mc_ratio__585->SetBinContent(28,9.568681);
   data_mc_ratio__585->SetBinError(2,0.2197772);
   data_mc_ratio__585->SetBinError(3,0.005028554);
   data_mc_ratio__585->SetBinError(4,0.006530404);
   data_mc_ratio__585->SetBinError(5,0.007375356);
   data_mc_ratio__585->SetBinError(6,0.008542877);
   data_mc_ratio__585->SetBinError(7,0.007768964);
   data_mc_ratio__585->SetBinError(8,0.007766912);
   data_mc_ratio__585->SetBinError(9,0.008958936);
   data_mc_ratio__585->SetBinError(10,0.00635167);
   data_mc_ratio__585->SetBinError(11,0.01028546);
   data_mc_ratio__585->SetBinError(12,0.007753001);
   data_mc_ratio__585->SetBinError(13,0.006130607);
   data_mc_ratio__585->SetBinError(14,0.005835741);
   data_mc_ratio__585->SetBinError(15,0.004696825);
   data_mc_ratio__585->SetBinError(16,0.005020693);
   data_mc_ratio__585->SetBinError(17,0.007807656);
   data_mc_ratio__585->SetBinError(18,0.01074837);
   data_mc_ratio__585->SetBinError(19,0.01343596);
   data_mc_ratio__585->SetBinError(20,0.01042649);
   data_mc_ratio__585->SetBinError(21,0.01153804);
   data_mc_ratio__585->SetBinError(22,0.01988007);
   data_mc_ratio__585->SetBinError(23,0.05940871);
   data_mc_ratio__585->SetBinError(24,0.09187112);
   data_mc_ratio__585->SetBinError(25,0.03507151);
   data_mc_ratio__585->SetBinError(26,0.2298386);
   data_mc_ratio__585->SetBinError(27,1.926768);
   data_mc_ratio__585->SetBinError(28,3.18956);
   data_mc_ratio__585->SetMinimum(0.4);
   data_mc_ratio__585->SetMaximum(1.6);
   data_mc_ratio__585->SetEntries(42.41823);
