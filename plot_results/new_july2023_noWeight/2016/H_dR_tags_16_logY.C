...
// ------------>Primitives in pad: topPad
   ...
   topPad->Draw();
   topPad->cd();
   topPad->Range(-0.9499975,-2.834436,6.525,11.1364);
   ...
   st->SetTitle("");
   st->SetMinimum(0.01);
   st->SetMaximum(1.690512e+09);
   
   TH1F *st_stack_21 = new TH1F("st_stack_21","",30,0,6);
   st_stack_21->SetMinimum(0.001511942);
   st_stack_21->SetMaximum(5.486731e+09);
   ...
   Graph_Graph_from_VbbHcc_tags_H_dR1041->SetMinimum(18.26994);
