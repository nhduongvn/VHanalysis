...
// ------------>Primitives in pad: topPad
   ...
   topPad->Draw();
   topPad->cd();
   topPad->Range(-0.9499975,-2.84623,6.525,11.53828);
   ...
   st->SetTitle("");
   st->SetMinimum(0.01);
   st->SetMaximum(3.795193e+09);
   
   TH1F *st_stack_213 = new TH1F("st_stack_213","",30,0,6);
   st_stack_213->SetMinimum(0.001472837);
   st_stack_213->SetMaximum(1.258428e+10);
   ...
   Graph_Graph_from_VbbHcc_both_H_dR1425->SetMinimum(24.95549);
