...
//=========  (Thu Aug  3 10:21:18 2023) by ROOT version 6.14/09
...
// ------------>Primitives in pad: topPad
   ...
   VbbHcc_algo_Z_dR__225->SetBinContent(2,42);
   VbbHcc_algo_Z_dR__225->SetBinContent(3,50386);
   VbbHcc_algo_Z_dR__225->SetBinContent(4,61159);
   VbbHcc_algo_Z_dR__225->SetBinContent(5,51576);
   VbbHcc_algo_Z_dR__225->SetBinContent(6,49544);
   VbbHcc_algo_Z_dR__225->SetBinContent(7,48781);
   VbbHcc_algo_Z_dR__225->SetBinContent(8,47374);
   VbbHcc_algo_Z_dR__225->SetBinContent(9,46661);
   VbbHcc_algo_Z_dR__225->SetBinContent(10,44620);
   VbbHcc_algo_Z_dR__225->SetBinContent(11,42943);
   VbbHcc_algo_Z_dR__225->SetBinContent(12,40707);
   VbbHcc_algo_Z_dR__225->SetBinContent(13,38601);
   VbbHcc_algo_Z_dR__225->SetBinContent(14,36001);
   VbbHcc_algo_Z_dR__225->SetBinContent(15,34159);
   VbbHcc_algo_Z_dR__225->SetBinContent(16,32487);
   VbbHcc_algo_Z_dR__225->SetBinContent(17,27425);
   VbbHcc_algo_Z_dR__225->SetBinContent(18,24253);
   VbbHcc_algo_Z_dR__225->SetBinContent(19,22135);
   VbbHcc_algo_Z_dR__225->SetBinContent(20,20064);
   VbbHcc_algo_Z_dR__225->SetBinContent(21,18104);
   VbbHcc_algo_Z_dR__225->SetBinContent(22,16418);
   VbbHcc_algo_Z_dR__225->SetBinContent(23,15364);
   VbbHcc_algo_Z_dR__225->SetBinContent(24,14210);
   VbbHcc_algo_Z_dR__225->SetBinContent(25,12918);
   VbbHcc_algo_Z_dR__225->SetBinContent(26,11876);
   VbbHcc_algo_Z_dR__225->SetBinContent(27,10741);
   VbbHcc_algo_Z_dR__225->SetBinContent(28,9890);
   VbbHcc_algo_Z_dR__225->SetBinContent(29,8703);
   VbbHcc_algo_Z_dR__225->SetBinContent(30,6351);
   VbbHcc_algo_Z_dR__225->SetBinContent(31,5611);
   VbbHcc_algo_Z_dR__225->SetEntries(849133);
...
// ------------>Primitives in pad: bottomPad
   ...
   data_mc_ratio__226->SetBinContent(2,0.6277974);
   data_mc_ratio__226->SetBinContent(3,0.2867781);
   data_mc_ratio__226->SetBinContent(4,0.2693213);
   data_mc_ratio__226->SetBinContent(5,0.2613454);
   data_mc_ratio__226->SetBinContent(6,0.2336152);
   data_mc_ratio__226->SetBinContent(7,0.2376242);
   data_mc_ratio__226->SetBinContent(8,0.2312598);
   data_mc_ratio__226->SetBinContent(9,0.2286968);
   data_mc_ratio__226->SetBinContent(10,0.2019893);
   data_mc_ratio__226->SetBinContent(11,0.2011941);
   data_mc_ratio__226->SetBinContent(12,0.1958034);
   data_mc_ratio__226->SetBinContent(13,0.2162072);
   data_mc_ratio__226->SetBinContent(14,0.2004928);
   data_mc_ratio__226->SetBinContent(15,0.2138354);
   data_mc_ratio__226->SetBinContent(16,0.2230326);
   data_mc_ratio__226->SetBinContent(17,0.1880153);
   data_mc_ratio__226->SetBinContent(18,0.17098);
   data_mc_ratio__226->SetBinContent(19,0.1989085);
   data_mc_ratio__226->SetBinContent(20,0.2246278);
   data_mc_ratio__226->SetBinContent(21,0.2169015);
   data_mc_ratio__226->SetBinContent(22,0.2158964);
   data_mc_ratio__226->SetBinContent(23,0.1967518);
   data_mc_ratio__226->SetBinContent(24,0.2430193);
   data_mc_ratio__226->SetBinContent(25,0.2148853);
   data_mc_ratio__226->SetBinContent(26,0.2311163);
   data_mc_ratio__226->SetBinContent(27,0.1945207);
   data_mc_ratio__226->SetBinContent(28,0.2213803);
   data_mc_ratio__226->SetBinContent(29,0.2373586);
   data_mc_ratio__226->SetBinContent(30,0.25368);
   data_mc_ratio__226->SetBinContent(31,0.2800581);
   data_mc_ratio__226->SetBinError(2,0.09687125);
   data_mc_ratio__226->SetBinError(3,0.001277589);
   data_mc_ratio__226->SetBinError(4,0.001089032);
   data_mc_ratio__226->SetBinError(5,0.001150777);
   data_mc_ratio__226->SetBinError(6,0.001049556);
   data_mc_ratio__226->SetBinError(7,0.001075883);
   data_mc_ratio__226->SetBinError(8,0.001062503);
   data_mc_ratio__226->SetBinError(9,0.001058725);
   data_mc_ratio__226->SetBinError(10,0.0009562328);
   data_mc_ratio__226->SetBinError(11,0.0009708876);
   data_mc_ratio__226->SetBinError(12,0.0009704781);
   data_mc_ratio__226->SetBinError(13,0.001100452);
   data_mc_ratio__226->SetBinError(14,0.001056675);
   data_mc_ratio__226->SetBinError(15,0.001156983);
   data_mc_ratio__226->SetBinError(16,0.00123741);
   data_mc_ratio__226->SetBinError(17,0.001135324);
   data_mc_ratio__226->SetBinError(18,0.001097899);
   data_mc_ratio__226->SetBinError(19,0.001336945);
   data_mc_ratio__226->SetBinError(20,0.001585823);
   data_mc_ratio__226->SetBinError(21,0.001612038);
   data_mc_ratio__226->SetBinError(22,0.001684943);
   data_mc_ratio__226->SetBinError(23,0.001587327);
   data_mc_ratio__226->SetBinError(24,0.002038655);
   data_mc_ratio__226->SetBinError(25,0.001890641);
   data_mc_ratio__226->SetBinError(26,0.002120779);
   data_mc_ratio__226->SetBinError(27,0.00187691);
   data_mc_ratio__226->SetBinError(28,0.00222608);
   data_mc_ratio__226->SetBinError(29,0.002544312);
   data_mc_ratio__226->SetBinError(30,0.003183209);
   data_mc_ratio__226->SetBinError(31,0.02453005);
   data_mc_ratio__226->SetMinimum(0.4);
   data_mc_ratio__226->SetMaximum(1.6);
   data_mc_ratio__226->SetEntries(651.4495);
