...
// ------------>Primitives in pad: topPad
   ...
   topPad->Draw();
   topPad->cd();
   topPad->Range(-0.9193524,-2.833163,6.314516,11.09364);
   ...
   st->SetTitle("");
   st->SetMinimum(0.01);
   st->SetMaximum(1.551183e+09);
   
   TH1F *st_stack_17 = new TH1F("st_stack_17","",30,0,6);
   st_stack_17->SetMinimum(0.001516224);
   st_stack_17->SetMaximum(5.022938e+09);
   ...
   Graph_Graph_from_VbbHcc_tags_Z_dR1033->SetMinimum(17.65905);
