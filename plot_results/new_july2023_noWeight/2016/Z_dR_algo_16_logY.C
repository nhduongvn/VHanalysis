...
// ------------>Primitives in pad: topPad
   ...
   topPad->Draw();
   topPad->cd();
   topPad->Range(-0.9193524,-2.917548,6.314516,14.19106);
   ...
   st->SetTitle("");
   st->SetMinimum(0.01);
   st->SetMaximum(7.991784e+11);
   
   TH1F *st_stack_113 = new TH1F("st_stack_113","",30,0,6);
   st_stack_113->SetMinimum(0.001257653);
   st_stack_113->SetMaximum(3.021317e+12);
   ...
   Graph_Graph_from_VbbHcc_algo_Z_dR1225->SetMinimum(266.7066);
