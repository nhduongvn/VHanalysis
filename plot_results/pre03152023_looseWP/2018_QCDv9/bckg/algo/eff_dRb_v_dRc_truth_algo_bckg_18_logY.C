...
#endif
void eff_dRb_v_dRc_truth_algo_bckg_18_logY()
{
//=========Macro generated from canvas: eff_dRb_v_dRc_truth_algo_bckg_18/eff_dRb_v_dRc_truth_algo_bckg_18
//=========  (Fri Mar 10 14:20:55 2023) by ROOT version 6.26/06
   TCanvas *eff_dRb_v_dRc_truth_algo_bckg_18 = new TCanvas("eff_dRb_v_dRc_truth_algo_bckg_18", "eff_dRb_v_dRc_truth_algo_bckg_18",0,0,600,600);
   gStyle->SetOptStat(0);
   eff_dRb_v_dRc_truth_algo_bckg_18->SetHighLightColor(2);
   eff_dRb_v_dRc_truth_algo_bckg_18->Range(-1.2,-0.7500001,6.8,6.75);
   eff_dRb_v_dRc_truth_algo_bckg_18->SetFillColor(0);
   eff_dRb_v_dRc_truth_algo_bckg_18->SetBorderMode(0);
   eff_dRb_v_dRc_truth_algo_bckg_18->SetBorderSize(2);
   eff_dRb_v_dRc_truth_algo_bckg_18->SetLeftMargin(0.15);
   eff_dRb_v_dRc_truth_algo_bckg_18->SetFrameBorderMode(0);
   eff_dRb_v_dRc_truth_algo_bckg_18->SetFrameBorderMode(0);
   ...
   eff_dRb_v_dRc_truth_algo_bckg_18->Modified();
   eff_dRb_v_dRc_truth_algo_bckg_18->cd();
   eff_dRb_v_dRc_truth_algo_bckg_18->SetSelected(eff_dRb_v_dRc_truth_algo_bckg_18);
}
