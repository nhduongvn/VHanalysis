...
#endif
void GenJet_VbbHcc_nGenL_bckg_18()
{
//=========Macro generated from canvas: GenJet_VbbHcc_nGenL_bckg_18/GenJet_VbbHcc_nGenL_bckg_18
//=========  (Fri Mar 10 12:49:30 2023) by ROOT version 6.26/06
   TCanvas *GenJet_VbbHcc_nGenL_bckg_18 = new TCanvas("GenJet_VbbHcc_nGenL_bckg_18", "GenJet_VbbHcc_nGenL_bckg_18",0,0,600,600);
   GenJet_VbbHcc_nGenL_bckg_18->SetHighLightColor(2);
   GenJet_VbbHcc_nGenL_bckg_18->Range(-4.867058,-0.1538462,22.93266,1.128205);
   GenJet_VbbHcc_nGenL_bckg_18->SetFillColor(0);
   GenJet_VbbHcc_nGenL_bckg_18->SetFillStyle(4000);
   GenJet_VbbHcc_nGenL_bckg_18->SetBorderMode(0);
   GenJet_VbbHcc_nGenL_bckg_18->SetBorderSize(2);
   GenJet_VbbHcc_nGenL_bckg_18->SetLeftMargin(0.15709);
   GenJet_VbbHcc_nGenL_bckg_18->SetRightMargin(0.1234783);
   GenJet_VbbHcc_nGenL_bckg_18->SetBottomMargin(0.12);
   GenJet_VbbHcc_nGenL_bckg_18->SetFrameFillStyle(1000);
   GenJet_VbbHcc_nGenL_bckg_18->SetFrameBorderMode(0);
   GenJet_VbbHcc_nGenL_bckg_18->SetFrameFillStyle(1000);
   GenJet_VbbHcc_nGenL_bckg_18->SetFrameBorderMode(0);
   ...
   TH1F *st_stack_156 = new TH1F("st_stack_156","",20,-0.5,19.5);
   st_stack_156->SetMinimum(0);
   st_stack_156->SetMaximum(0);
...
tex->SetNDC();
   ...
   tex->SetLineWidth(2);
   tex->Draw();
   GenJet_VbbHcc_nGenL_bckg_18->Modified();
   GenJet_VbbHcc_nGenL_bckg_18->cd();
   GenJet_VbbHcc_nGenL_bckg_18->SetSelected(GenJet_VbbHcc_nGenL_bckg_18);
}
