...
#endif
void GenJet_cuts_nGenC_signal_16_logY()
{
...
//=========  (Fri Mar 10 12:49:23 2023) by ROOT version 6.26/06
   ...
   GenJet_cuts_nGenC_signal_16->Range(-4.867058,-0.8526278,22.93266,3.217169);
   ...
   GenJet_cuts_nGenC_signal_16->SetLogy();
   ...
   st_stack_91->SetMinimum(0.4322627);
   st_stack_91->SetMaximum(645.9351);
