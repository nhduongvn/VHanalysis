...
#endif
void GenJet_all_nGenB_signal_16_logY()
{
...
//=========  (Fri Mar 10 12:49:21 2023) by ROOT version 6.26/06
   ...
   GenJet_all_nGenB_signal_16->Range(-4.867058,-0.9096526,22.93266,3.472852);
   ...
   GenJet_all_nGenB_signal_16->SetLogy();
   ...
   st_stack_13->SetMinimum(0.4132834);
   st_stack_13->SetMaximum(1082.932);
