...
#endif
void GenJet_VbbHcc_nGenL_bckg_16_logY()
{
//=========Macro generated from canvas: GenJet_VbbHcc_nGenL_bckg_16/GenJet_VbbHcc_nGenL_bckg_16
//=========  (Fri Mar 10 12:49:24 2023) by ROOT version 6.26/06
   TCanvas *GenJet_VbbHcc_nGenL_bckg_16 = new TCanvas("GenJet_VbbHcc_nGenL_bckg_16", "GenJet_VbbHcc_nGenL_bckg_16",0,0,600,600);
   GenJet_VbbHcc_nGenL_bckg_16->SetHighLightColor(2);
   GenJet_VbbHcc_nGenL_bckg_16->Range(-4.867058,-nan,22.93266,-nan);
   GenJet_VbbHcc_nGenL_bckg_16->SetFillColor(0);
   GenJet_VbbHcc_nGenL_bckg_16->SetFillStyle(4000);
   GenJet_VbbHcc_nGenL_bckg_16->SetBorderMode(0);
   GenJet_VbbHcc_nGenL_bckg_16->SetBorderSize(2);
   GenJet_VbbHcc_nGenL_bckg_16->SetLogy();
   GenJet_VbbHcc_nGenL_bckg_16->SetLeftMargin(0.15709);
   GenJet_VbbHcc_nGenL_bckg_16->SetRightMargin(0.1234783);
   GenJet_VbbHcc_nGenL_bckg_16->SetBottomMargin(0.12);
   GenJet_VbbHcc_nGenL_bckg_16->SetFrameFillStyle(1000);
   GenJet_VbbHcc_nGenL_bckg_16->SetFrameBorderMode(0);
   GenJet_VbbHcc_nGenL_bckg_16->SetFrameFillStyle(1000);
   GenJet_VbbHcc_nGenL_bckg_16->SetFrameBorderMode(0);
   ...
   TH1F *st_stack_152 = new TH1F("st_stack_152","",20,-0.5,19.5);
   st_stack_152->SetMinimum(-0);
   st_stack_152->SetMaximum(-nan);
...
tex->SetNDC();
   ...
   tex->SetLineWidth(2);
   tex->Draw();
   GenJet_VbbHcc_nGenL_bckg_16->Modified();
   GenJet_VbbHcc_nGenL_bckg_16->cd();
   GenJet_VbbHcc_nGenL_bckg_16->SetSelected(GenJet_VbbHcc_nGenL_bckg_16);
}
