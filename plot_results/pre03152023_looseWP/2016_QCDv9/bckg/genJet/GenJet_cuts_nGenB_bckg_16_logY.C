...
#endif
void GenJet_cuts_nGenB_bckg_16_logY()
{
...
//=========  (Fri Mar 10 12:49:23 2023) by ROOT version 6.26/06
   ...
   GenJet_cuts_nGenB_bckg_16->Range(-4.867058,-2.928736,22.93266,14.40072);
   ...
   GenJet_cuts_nGenB_bckg_16->SetLogy();
   ...
   st_stack_86->SetMinimum(0.1415136);
   st_stack_86->SetMaximum(4.653434e+12);
