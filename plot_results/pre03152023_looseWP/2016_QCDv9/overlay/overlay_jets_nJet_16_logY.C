...
#endif
void overlay_jets_nJet_16_logY()
{
...
//=========  (Fri Mar 10 12:48:05 2023) by ROOT version 6.26/06
   ...
   st_stack_55->SetMinimum(7.061365e-12);
   st_stack_55->SetMaximum(1.6029);
