...
#endif
void GenJet_VbbHcc_nGenJet_bckg_17()
{
//=========Macro generated from canvas: GenJet_VbbHcc_nGenJet_bckg_17/GenJet_VbbHcc_nGenJet_bckg_17
//=========  (Fri Mar 10 12:49:30 2023) by ROOT version 6.26/06
   TCanvas *GenJet_VbbHcc_nGenJet_bckg_17 = new TCanvas("GenJet_VbbHcc_nGenJet_bckg_17", "GenJet_VbbHcc_nGenJet_bckg_17",0,0,600,600);
   GenJet_VbbHcc_nGenJet_bckg_17->SetHighLightColor(2);
   GenJet_VbbHcc_nGenJet_bckg_17->Range(-4.867058,-0.1538462,22.93266,1.128205);
   GenJet_VbbHcc_nGenJet_bckg_17->SetFillColor(0);
   GenJet_VbbHcc_nGenJet_bckg_17->SetFillStyle(4000);
   GenJet_VbbHcc_nGenJet_bckg_17->SetBorderMode(0);
   GenJet_VbbHcc_nGenJet_bckg_17->SetBorderSize(2);
   GenJet_VbbHcc_nGenJet_bckg_17->SetLeftMargin(0.15709);
   GenJet_VbbHcc_nGenJet_bckg_17->SetRightMargin(0.1234783);
   GenJet_VbbHcc_nGenJet_bckg_17->SetBottomMargin(0.12);
   GenJet_VbbHcc_nGenJet_bckg_17->SetFrameFillStyle(1000);
   GenJet_VbbHcc_nGenJet_bckg_17->SetFrameBorderMode(0);
   GenJet_VbbHcc_nGenJet_bckg_17->SetFrameFillStyle(1000);
   GenJet_VbbHcc_nGenJet_bckg_17->SetFrameBorderMode(0);
   ...
   TH1F *st_stack_148 = new TH1F("st_stack_148","",20,-0.5,19.5);
   st_stack_148->SetMinimum(0);
   st_stack_148->SetMaximum(0);
...
tex->SetNDC();
   ...
   tex->SetLineWidth(2);
   tex->Draw();
   GenJet_VbbHcc_nGenJet_bckg_17->Modified();
   GenJet_VbbHcc_nGenJet_bckg_17->cd();
   GenJet_VbbHcc_nGenJet_bckg_17->SetSelected(GenJet_VbbHcc_nGenJet_bckg_17);
}
