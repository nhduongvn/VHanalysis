...
#endif
void GenJet_cuts_nGenB_signal_17_logY()
{
...
//=========  (Fri Mar 10 12:49:23 2023) by ROOT version 6.26/06
   ...
   GenJet_cuts_nGenB_signal_17->Range(-4.867058,-0.9457505,22.93266,3.636884);
   ...
   GenJet_cuts_nGenB_signal_17->SetLogy();
   ...
   st_stack_87->SetMinimum(0.4019441);
   st_stack_87->SetMaximum(1508.762);
