...
#endif
void GenJet_cuts_nGenC_signal_17_logY()
{
...
//=========  (Fri Mar 10 12:49:23 2023) by ROOT version 6.26/06
   ...
   GenJet_cuts_nGenC_signal_17->Range(-4.867058,-0.875647,22.93266,3.319866);
   ...
   GenJet_cuts_nGenC_signal_17->SetLogy();
   ...
   st_stack_93->SetMinimum(0.4244382);
   st_stack_93->SetMaximum(794.9032);
