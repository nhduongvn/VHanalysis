...
#endif
void GenJet_all_nGenJet_signal_17_logY()
{
...
//=========  (Fri Mar 10 12:49:21 2023) by ROOT version 6.26/06
   ...
   GenJet_all_nGenJet_signal_17->Range(-4.867058,-0.7891364,22.93266,2.937615);
   ...
   GenJet_all_nGenJet_signal_17->SetLogy();
   ...
   st_stack_3->SetMinimum(0.4550653);
   st_stack_3->SetMaximum(367.2315);
