...
//=========  (Fri Mar 10 12:27:37 2023) by ROOT version 6.26/06
   ...
   TLatex *   tex = new TLatex(0.2578218,0.3832088,"0.875");
   tex->SetTextSize(0.02);
   tex->SetLineWidth(2);
   tex->Draw();
   graph->GetListOfFunctions()->Add(383);
      tex = new TLatex(0.5908452,0.5931324,"0.825");
   tex->SetTextSize(0.02);
   tex->SetLineWidth(2);
   tex->Draw();
   graph->GetListOfFunctions()->Add(384);
      tex = new TLatex(0.7506423,0.7178247,"0.775");
   tex->SetTextSize(0.02);
   tex->SetLineWidth(2);
   tex->Draw();
   graph->GetListOfFunctions()->Add(385);
      tex = new TLatex(0.8331107,0.7980602,"0.725");
   tex->SetTextSize(0.02);
   tex->SetLineWidth(2);
   tex->Draw();
