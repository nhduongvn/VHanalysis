...
//=========  (Mon Jul 24 10:12:25 2023) by ROOT version 6.14/09
...
// ------------>Primitives in pad: topPad
   ...
   topPad->Draw();
   topPad->cd();
   topPad->Range(-45.96762,-1662.862,315.7258,1661209);
   ...
   VbbHcc_both_H_jetpt_JEC_stack_1->SetBinContent(0,789711.5);
   VbbHcc_both_H_jetpt_JEC_stack_1->SetBinContent(1,13367.98);
   VbbHcc_both_H_jetpt_JEC_stack_1->SetBinContent(2,492914.4);
   VbbHcc_both_H_jetpt_JEC_stack_1->SetBinContent(3,260094.4);
   VbbHcc_both_H_jetpt_JEC_stack_1->SetBinContent(151,47881.85);
   VbbHcc_both_H_jetpt_JEC_stack_1->SetBinError(0,11907.14);
   VbbHcc_both_H_jetpt_JEC_stack_1->SetBinError(1,10518.05);
   VbbHcc_both_H_jetpt_JEC_stack_1->SetBinError(2,9662.933);
   VbbHcc_both_H_jetpt_JEC_stack_1->SetBinError(3,4895.202);
   VbbHcc_both_H_jetpt_JEC_stack_1->SetBinError(151,26836.91);
   VbbHcc_both_H_jetpt_JEC_stack_1->SetEntries(166831);
   ...
   VbbHcc_both_H_jetpt_JEC_stack_2->SetBinContent(0,9027.937);
   VbbHcc_both_H_jetpt_JEC_stack_2->SetBinContent(1,44.74405);
   VbbHcc_both_H_jetpt_JEC_stack_2->SetBinContent(2,6768.837);
   VbbHcc_both_H_jetpt_JEC_stack_2->SetBinContent(3,2097.467);
   VbbHcc_both_H_jetpt_JEC_stack_2->SetBinContent(151,4.892693);
   VbbHcc_both_H_jetpt_JEC_stack_2->SetBinError(0,42.45952);
   VbbHcc_both_H_jetpt_JEC_stack_2->SetBinError(1,3.078812);
   VbbHcc_both_H_jetpt_JEC_stack_2->SetBinError(2,37.41793);
   VbbHcc_both_H_jetpt_JEC_stack_2->SetBinError(3,19.61262);
   VbbHcc_both_H_jetpt_JEC_stack_2->SetBinError(151,1.067529);
   VbbHcc_both_H_jetpt_JEC_stack_2->SetEntries(217888);
   ...
   VbbHcc_both_H_jetpt_JEC_stack_3->SetBinContent(0,167855.5);
   VbbHcc_both_H_jetpt_JEC_stack_3->SetBinContent(1,921.6051);
   VbbHcc_both_H_jetpt_JEC_stack_3->SetBinContent(2,134545);
   VbbHcc_both_H_jetpt_JEC_stack_3->SetBinContent(3,29382.17);
   VbbHcc_both_H_jetpt_JEC_stack_3->SetBinContent(151,3.99121);
   VbbHcc_both_H_jetpt_JEC_stack_3->SetBinError(0,113.6773);
   VbbHcc_both_H_jetpt_JEC_stack_3->SetBinError(1,8.444945);
   VbbHcc_both_H_jetpt_JEC_stack_3->SetBinError(2,101.8823);
   VbbHcc_both_H_jetpt_JEC_stack_3->SetBinError(3,47.27303);
   VbbHcc_both_H_jetpt_JEC_stack_3->SetBinError(151,0.5342344);
   VbbHcc_both_H_jetpt_JEC_stack_3->SetEntries(4843140);
   ...
   VbbHcc_both_H_jetpt_JEC_stack_4->SetBinContent(0,6586.175);
   VbbHcc_both_H_jetpt_JEC_stack_4->SetBinContent(1,40.58086);
   VbbHcc_both_H_jetpt_JEC_stack_4->SetBinContent(2,4307.027);
   VbbHcc_both_H_jetpt_JEC_stack_4->SetBinContent(3,2188.56);
   VbbHcc_both_H_jetpt_JEC_stack_4->SetBinContent(151,12.52751);
   VbbHcc_both_H_jetpt_JEC_stack_4->SetBinError(0,54.92267);
   VbbHcc_both_H_jetpt_JEC_stack_4->SetBinError(1,7.97235);
   VbbHcc_both_H_jetpt_JEC_stack_4->SetBinError(2,50.26353);
   VbbHcc_both_H_jetpt_JEC_stack_4->SetBinError(3,23.24578);
   VbbHcc_both_H_jetpt_JEC_stack_4->SetBinError(151,5.551928);
   VbbHcc_both_H_jetpt_JEC_stack_4->SetEntries(99118);
   ...
   VbbHcc_both_H_jetpt_JEC_stack_5->SetBinContent(0,3729.502);
   VbbHcc_both_H_jetpt_JEC_stack_5->SetBinContent(1,30.85733);
   VbbHcc_both_H_jetpt_JEC_stack_5->SetBinContent(2,2023.725);
   VbbHcc_both_H_jetpt_JEC_stack_5->SetBinContent(3,1458.924);
   VbbHcc_both_H_jetpt_JEC_stack_5->SetBinContent(151,31.0879);
   VbbHcc_both_H_jetpt_JEC_stack_5->SetBinError(0,72.27683);
   VbbHcc_both_H_jetpt_JEC_stack_5->SetBinError(1,12.48351);
   VbbHcc_both_H_jetpt_JEC_stack_5->SetBinError(2,55.14311);
   VbbHcc_both_H_jetpt_JEC_stack_5->SetBinError(3,31.05684);
   VbbHcc_both_H_jetpt_JEC_stack_5->SetBinError(151,14.19394);
   VbbHcc_both_H_jetpt_JEC_stack_5->SetEntries(45557);
   ...
   VbbHcc_both_H_jetpt_JEC_stack_6->SetBinContent(0,25.48878);
   VbbHcc_both_H_jetpt_JEC_stack_6->SetBinContent(1,0.2207972);
   VbbHcc_both_H_jetpt_JEC_stack_6->SetBinContent(2,9.660337);
   VbbHcc_both_H_jetpt_JEC_stack_6->SetBinContent(3,8.223035);
   VbbHcc_both_H_jetpt_JEC_stack_6->SetBinContent(151,0.3976047);
   VbbHcc_both_H_jetpt_JEC_stack_6->SetBinError(0,2.413905);
   VbbHcc_both_H_jetpt_JEC_stack_6->SetBinError(1,0.2207972);
   VbbHcc_both_H_jetpt_JEC_stack_6->SetBinError(2,1.479903);
   VbbHcc_both_H_jetpt_JEC_stack_6->SetBinError(3,1.370153);
   VbbHcc_both_H_jetpt_JEC_stack_6->SetBinError(151,0.289103);
   VbbHcc_both_H_jetpt_JEC_stack_6->SetEntries(204);
   ...
   VbbHcc_both_H_jetpt_JEC_stack_7->SetBinContent(0,56.22416);
   VbbHcc_both_H_jetpt_JEC_stack_7->SetBinContent(1,0.7334141);
   VbbHcc_both_H_jetpt_JEC_stack_7->SetBinContent(2,29.98782);
   VbbHcc_both_H_jetpt_JEC_stack_7->SetBinContent(3,13.11444);
   VbbHcc_both_H_jetpt_JEC_stack_7->SetBinError(0,3.096418);
   VbbHcc_both_H_jetpt_JEC_stack_7->SetBinError(1,0.3302134);
   VbbHcc_both_H_jetpt_JEC_stack_7->SetBinError(2,2.244254);
   VbbHcc_both_H_jetpt_JEC_stack_7->SetBinError(3,1.494018);
   VbbHcc_both_H_jetpt_JEC_stack_7->SetEntries(620);
   ...
   VbbHcc_both_H_jetpt_JEC_stack_8->SetBinContent(0,54.69729);
   VbbHcc_both_H_jetpt_JEC_stack_8->SetBinContent(1,0.2292004);
   VbbHcc_both_H_jetpt_JEC_stack_8->SetBinContent(2,32.21305);
   VbbHcc_both_H_jetpt_JEC_stack_8->SetBinContent(3,13.7004);
   VbbHcc_both_H_jetpt_JEC_stack_8->SetBinError(0,3.464986);
   VbbHcc_both_H_jetpt_JEC_stack_8->SetBinError(1,0.2292004);
   VbbHcc_both_H_jetpt_JEC_stack_8->SetBinError(2,2.640638);
   VbbHcc_both_H_jetpt_JEC_stack_8->SetBinError(3,1.742109);
   VbbHcc_both_H_jetpt_JEC_stack_8->SetEntries(481);
   ...
   VbbHcc_both_H_jetpt_JEC_stack_9->SetBinContent(0,34.65782);
   VbbHcc_both_H_jetpt_JEC_stack_9->SetBinContent(1,0.1790248);
   VbbHcc_both_H_jetpt_JEC_stack_9->SetBinContent(2,25.77563);
   VbbHcc_both_H_jetpt_JEC_stack_9->SetBinContent(3,8.559899);
   VbbHcc_both_H_jetpt_JEC_stack_9->SetBinContent(151,0.02380819);
   VbbHcc_both_H_jetpt_JEC_stack_9->SetBinError(0,0.2567879);
   VbbHcc_both_H_jetpt_JEC_stack_9->SetBinError(1,0.01843535);
   VbbHcc_both_H_jetpt_JEC_stack_9->SetBinError(2,0.2213204);
   VbbHcc_both_H_jetpt_JEC_stack_9->SetBinError(3,0.1276443);
   VbbHcc_both_H_jetpt_JEC_stack_9->SetBinError(151,0.00665673);
   VbbHcc_both_H_jetpt_JEC_stack_9->SetEntries(39482);
   ...
   VbbHcc_both_H_jetpt_JEC_stack_10->SetBinContent(0,29.85266);
   VbbHcc_both_H_jetpt_JEC_stack_10->SetBinContent(1,0.14753);
   VbbHcc_both_H_jetpt_JEC_stack_10->SetBinContent(2,23.01359);
   VbbHcc_both_H_jetpt_JEC_stack_10->SetBinContent(3,6.605895);
   VbbHcc_both_H_jetpt_JEC_stack_10->SetBinError(0,0.1149585);
   VbbHcc_both_H_jetpt_JEC_stack_10->SetBinError(1,0.008078765);
   VbbHcc_both_H_jetpt_JEC_stack_10->SetBinError(2,0.100953);
   VbbHcc_both_H_jetpt_JEC_stack_10->SetBinError(3,0.05405916);
   ...
   VbbHcc_both_H_jetpt_JEC_stack_11->SetBinContent(0,0.924573);
   VbbHcc_both_H_jetpt_JEC_stack_11->SetBinContent(1,0.005984813);
   VbbHcc_both_H_jetpt_JEC_stack_11->SetBinContent(2,0.8223976);
   VbbHcc_both_H_jetpt_JEC_stack_11->SetBinContent(3,0.1849217);
   VbbHcc_both_H_jetpt_JEC_stack_11->SetBinError(0,0.04153899);
   VbbHcc_both_H_jetpt_JEC_stack_11->SetBinError(1,0.003493303);
   VbbHcc_both_H_jetpt_JEC_stack_11->SetBinError(2,0.03936962);
   VbbHcc_both_H_jetpt_JEC_stack_11->SetBinError(3,0.01850251);
   VbbHcc_both_H_jetpt_JEC_stack_11->SetEntries(1123);
   ...
   VbbHcc_both_H_jetpt_JEC_stack_12->SetBinContent(0,0.4962536);
   VbbHcc_both_H_jetpt_JEC_stack_12->SetBinContent(1,0.002057101);
   VbbHcc_both_H_jetpt_JEC_stack_12->SetBinContent(2,0.3835693);
   VbbHcc_both_H_jetpt_JEC_stack_12->SetBinContent(3,0.08729055);
   VbbHcc_both_H_jetpt_JEC_stack_12->SetBinError(0,0.0109096);
   VbbHcc_both_H_jetpt_JEC_stack_12->SetBinError(1,0.0006972292);
   VbbHcc_both_H_jetpt_JEC_stack_12->SetBinError(2,0.009576055);
   VbbHcc_both_H_jetpt_JEC_stack_12->SetBinError(3,0.004622447);
   VbbHcc_both_H_jetpt_JEC_stack_12->SetEntries(4223);
   ...
   TH1D *VbbHcc_both_H_jetpt_JEC__523 = new TH1D("VbbHcc_both_H_jetpt_JEC__523","",150,0,300);
   VbbHcc_both_H_jetpt_JEC__523->SetBinContent(0,284415);
   VbbHcc_both_H_jetpt_JEC__523->SetBinContent(1,1074);
   VbbHcc_both_H_jetpt_JEC__523->SetBinContent(2,190117);
   VbbHcc_both_H_jetpt_JEC__523->SetBinContent(3,86410);
   VbbHcc_both_H_jetpt_JEC__523->SetEntries(562165);

   ci = TColor::GetColor("#000099");
   VbbHcc_both_H_jetpt_JEC__523->SetLineColor(ci);
   VbbHcc_both_H_jetpt_JEC__523->SetLineWidth(2);
   VbbHcc_both_H_jetpt_JEC__523->SetMarkerStyle(20);
   VbbHcc_both_H_jetpt_JEC__523->SetMarkerSize(1.2);
   VbbHcc_both_H_jetpt_JEC__523->GetXaxis()->SetRange(1,300);
   VbbHcc_both_H_jetpt_JEC__523->GetXaxis()->SetLabelFont(42);
   VbbHcc_both_H_jetpt_JEC__523->GetXaxis()->SetLabelSize(0.035);
   VbbHcc_both_H_jetpt_JEC__523->GetXaxis()->SetTitleSize(0.035);
   VbbHcc_both_H_jetpt_JEC__523->GetXaxis()->SetTitleFont(42);
   VbbHcc_both_H_jetpt_JEC__523->GetYaxis()->SetLabelFont(42);
   VbbHcc_both_H_jetpt_JEC__523->GetYaxis()->SetLabelSize(0.035);
   VbbHcc_both_H_jetpt_JEC__523->GetYaxis()->SetTitleSize(0.035);
   VbbHcc_both_H_jetpt_JEC__523->GetYaxis()->SetTitleOffset(0);
   VbbHcc_both_H_jetpt_JEC__523->GetYaxis()->SetTitleFont(42);
   VbbHcc_both_H_jetpt_JEC__523->GetZaxis()->SetLabelFont(42);
   VbbHcc_both_H_jetpt_JEC__523->GetZaxis()->SetLabelSize(0.035);
   VbbHcc_both_H_jetpt_JEC__523->GetZaxis()->SetTitleSize(0.035);
   VbbHcc_both_H_jetpt_JEC__523->GetZaxis()->SetTitleFont(42);
   VbbHcc_both_H_jetpt_JEC__523->Draw("same E");
   ...
   Graph_Graph_from_VbbHcc_both_H_jetpt_JEC1523->SetMaximum(715379.2);
...
// ------------>Primitives in pad: bottomPad
   ...
   TH1D *data_mc_ratio__524 = new TH1D("data_mc_ratio__524","",150,0,300);
   data_mc_ratio__524->SetBinContent(0,0.2910769);
   data_mc_ratio__524->SetBinContent(1,0.07454563);
   data_mc_ratio__524->SetBinContent(2,0.2967421);
   data_mc_ratio__524->SetBinContent(3,0.2926454);
   data_mc_ratio__524->SetBinError(0,0.003589105);
   data_mc_ratio__524->SetBinError(1,0.002274679);
   data_mc_ratio__524->SetBinError(2,0.0006805636);
   data_mc_ratio__524->SetBinError(3,0.0009955424);
   data_mc_ratio__524->SetMinimum(0.4);
   data_mc_ratio__524->SetMaximum(1.6);
   data_mc_ratio__524->SetEntries(146.3514);
   ...
   data_mc_ratio__524->GetXaxis()->SetTitle("c-jet p_{T} (w/ JEC) [GeV]");
   data_mc_ratio__524->GetXaxis()->SetRange(1,150);
   ...
   Graph_Graph_from_mc_statistical_error1524->SetMinimum(0.1239378);
   Graph_Graph_from_mc_statistical_error1524->SetMaximum(1.876062);
