...
// ------------>Primitives in pad: topPad
   ...
   VbbHcc_algoFirst_Sphericity__231->SetBinContent(1,40712);
   VbbHcc_algoFirst_Sphericity__231->SetBinContent(2,34522);
   VbbHcc_algoFirst_Sphericity__231->SetBinContent(3,18945);
   VbbHcc_algoFirst_Sphericity__231->SetBinContent(4,9907);
   VbbHcc_algoFirst_Sphericity__231->SetBinContent(5,4902);
   VbbHcc_algoFirst_Sphericity__231->SetBinContent(6,2082);
   VbbHcc_algoFirst_Sphericity__231->SetBinContent(7,650);
   VbbHcc_algoFirst_Sphericity__231->SetBinContent(8,208);
   VbbHcc_algoFirst_Sphericity__231->SetBinContent(9,83);
   VbbHcc_algoFirst_Sphericity__231->SetBinContent(10,52);
   VbbHcc_algoFirst_Sphericity__231->SetBinContent(11,27);
   VbbHcc_algoFirst_Sphericity__231->SetBinContent(12,9);
   VbbHcc_algoFirst_Sphericity__231->SetBinContent(13,8);
   VbbHcc_algoFirst_Sphericity__231->SetBinContent(14,4);
   VbbHcc_algoFirst_Sphericity__231->SetBinContent(15,4);
   VbbHcc_algoFirst_Sphericity__231->SetBinContent(16,3);
   VbbHcc_algoFirst_Sphericity__231->SetBinContent(17,1);
   VbbHcc_algoFirst_Sphericity__231->SetBinContent(18,1);
   VbbHcc_algoFirst_Sphericity__231->SetEntries(112144);
...
// ------------>Primitives in pad: bottomPad
   ...
   data_mc_ratio__232->SetBinContent(1,0.5937347);
   data_mc_ratio__232->SetBinContent(2,0.5746888);
   data_mc_ratio__232->SetBinContent(3,0.5728233);
   data_mc_ratio__232->SetBinContent(4,0.5815374);
   data_mc_ratio__232->SetBinContent(5,0.4617332);
   data_mc_ratio__232->SetBinContent(6,0.5634765);
   data_mc_ratio__232->SetBinContent(7,0.1758143);
   data_mc_ratio__232->SetBinContent(8,1.079446);
   data_mc_ratio__232->SetBinContent(9,0.9913051);
   data_mc_ratio__232->SetBinContent(10,1.206578);
   data_mc_ratio__232->SetBinContent(11,0.9799074);
   data_mc_ratio__232->SetBinContent(12,0.2536606);
   data_mc_ratio__232->SetBinContent(13,0.4328039);
   data_mc_ratio__232->SetBinContent(14,0.5832974);
   data_mc_ratio__232->SetBinContent(15,1.757208);
   data_mc_ratio__232->SetBinContent(16,2.346874);
   data_mc_ratio__232->SetBinContent(17,0.4591611);
   data_mc_ratio__232->SetBinContent(18,1.463068);
   data_mc_ratio__232->SetBinError(1,0.0029426);
   data_mc_ratio__232->SetBinError(2,0.003093034);
   data_mc_ratio__232->SetBinError(3,0.004161725);
   data_mc_ratio__232->SetBinError(4,0.005842605);
   data_mc_ratio__232->SetBinError(5,0.006594843);
   data_mc_ratio__232->SetBinError(6,0.0123491);
   data_mc_ratio__232->SetBinError(7,0.006896003);
   data_mc_ratio__232->SetBinError(8,0.07484612);
   data_mc_ratio__232->SetBinError(9,0.1088099);
   data_mc_ratio__232->SetBinError(10,0.1673223);
   data_mc_ratio__232->SetBinError(11,0.1885833);
   data_mc_ratio__232->SetBinError(12,0.08455353);
   data_mc_ratio__232->SetBinError(13,0.1530193);
   data_mc_ratio__232->SetBinError(14,0.2916487);
   data_mc_ratio__232->SetBinError(15,0.8786042);
   data_mc_ratio__232->SetBinError(16,1.354968);
   ...
   data_mc_ratio__232->SetEntries(35.91341);
