...
// ------------>Primitives in pad: topPad
   ...
   VbbHcc_algoFirst_Sphericity__231->SetBinContent(1,41353);
   VbbHcc_algoFirst_Sphericity__231->SetBinContent(2,35030);
   VbbHcc_algoFirst_Sphericity__231->SetBinContent(3,19249);
   VbbHcc_algoFirst_Sphericity__231->SetBinContent(4,9976);
   VbbHcc_algoFirst_Sphericity__231->SetBinContent(5,4974);
   VbbHcc_algoFirst_Sphericity__231->SetBinContent(6,2081);
   VbbHcc_algoFirst_Sphericity__231->SetBinContent(7,655);
   VbbHcc_algoFirst_Sphericity__231->SetBinContent(8,217);
   VbbHcc_algoFirst_Sphericity__231->SetBinContent(9,80);
   VbbHcc_algoFirst_Sphericity__231->SetBinContent(10,53);
   VbbHcc_algoFirst_Sphericity__231->SetBinContent(11,24);
   VbbHcc_algoFirst_Sphericity__231->SetBinContent(12,8);
   VbbHcc_algoFirst_Sphericity__231->SetBinContent(13,7);
   ...
   VbbHcc_algoFirst_Sphericity__231->SetBinContent(17,2);
   VbbHcc_algoFirst_Sphericity__231->SetBinContent(18,1);
   VbbHcc_algoFirst_Sphericity__231->SetBinContent(20,1);
   VbbHcc_algoFirst_Sphericity__231->SetEntries(113744);
...
// ------------>Primitives in pad: bottomPad
   ...
   data_mc_ratio__232->SetBinContent(1,0.6030829);
   data_mc_ratio__232->SetBinContent(2,0.5831454);
   data_mc_ratio__232->SetBinContent(3,0.5820151);
   data_mc_ratio__232->SetBinContent(4,0.5855877);
   data_mc_ratio__232->SetBinContent(5,0.4685151);
   data_mc_ratio__232->SetBinContent(6,0.5632059);
   data_mc_ratio__232->SetBinContent(7,0.1771667);
   data_mc_ratio__232->SetBinContent(8,1.126153);
   data_mc_ratio__232->SetBinContent(9,0.9554748);
   data_mc_ratio__232->SetBinContent(10,1.229782);
   data_mc_ratio__232->SetBinContent(11,0.8710288);
   data_mc_ratio__232->SetBinContent(12,0.2254761);
   data_mc_ratio__232->SetBinContent(13,0.3787034);
   ...
   data_mc_ratio__232->SetBinContent(17,0.9183222);
   data_mc_ratio__232->SetBinContent(18,1.463068);
   data_mc_ratio__232->SetBinContent(20,6.28877);
   data_mc_ratio__232->SetBinError(1,0.002965675);
   data_mc_ratio__232->SetBinError(2,0.003115709);
   data_mc_ratio__232->SetBinError(3,0.004194983);
   data_mc_ratio__232->SetBinError(4,0.005862916);
   data_mc_ratio__232->SetBinError(5,0.006643099);
   data_mc_ratio__232->SetBinError(6,0.01234614);
   data_mc_ratio__232->SetBinError(7,0.006922475);
   data_mc_ratio__232->SetBinError(8,0.07644824);
   data_mc_ratio__232->SetBinError(9,0.1068253);
   data_mc_ratio__232->SetBinError(10,0.1689235);
   data_mc_ratio__232->SetBinError(11,0.177798);
   data_mc_ratio__232->SetBinError(12,0.07971783);
   data_mc_ratio__232->SetBinError(13,0.1431364);
   ...
   data_mc_ratio__232->SetBinError(17,0.6493519);
   data_mc_ratio__232->SetBinError(18,1.463068);
   data_mc_ratio__232->SetBinError(20,6.28877);
   data_mc_ratio__232->SetMinimum(0.4);
   data_mc_ratio__232->SetMaximum(1.6);
   data_mc_ratio__232->SetEntries(7.225147);
