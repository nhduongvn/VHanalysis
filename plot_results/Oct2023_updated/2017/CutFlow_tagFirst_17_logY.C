...
// ------------>Primitives in pad: topPad
   ...
   topPad->Draw();
   topPad->cd();
   topPad->Range(-0.9193524,-3.221251,6.314516,31.01729);
   ...
   st->SetTitle("");
   st->SetMinimum(0.01);
   st->SetMaximum(5.806951e+26);
   
   TH1F *st_stack_8 = new TH1F("st_stack_8","",5,0,5);
   st_stack_8->SetMinimum(0.0006501116);
   st_stack_8->SetMaximum(3.921312e+27);
