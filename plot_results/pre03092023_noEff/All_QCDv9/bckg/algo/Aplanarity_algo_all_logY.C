...
//=========  (Thu Feb 16 10:37:40 2023) by ROOT version 6.26/06
   ...
   Aplanarity_algo_all->Range(-0.2183529,-0.9487282,1.171633,9.737027);
   ...
   st->SetTitle("");
   st->SetMinimum(10);
   st->SetMaximum(1.897944e+08);
   
   TH1F *st_stack_128 = new TH1F("st_stack_128","",50,0,1);
   st_stack_128->SetMinimum(2.155571);
   st_stack_128->SetMaximum(4.660699e+08);
