...
//=========  (Thu Feb 16 10:37:41 2023) by ROOT version 6.26/06
   ...
   Z_dR_alljet_all->Range(-1.310117,2.661503,7.029799,14.97116);
   ...
   st->SetName("st");
   st->SetTitle("");
   st->SetMinimum(71926.68);
   st->SetMaximum(2.043274e+13);
   
   TH1F *st_stack_212 = new TH1F("st_stack_212","",30,0,6);
   st_stack_212->SetMinimum(13761.35);
   st_stack_212->SetMaximum(5.497812e+13);
