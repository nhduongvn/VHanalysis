...
//=========  (Wed Mar  1 14:06:40 2023) by ROOT version 6.26/06
   ...
   nC_medium_jets_bckg_18->Range(-2.683529,-2.143697,11.21633,16.70083);
   ...
   st->SetTitle("");
   st->SetMinimum(10);
   st->SetMaximum(1.794688e+14);
   
   TH1F *st_stack_36 = new TH1F("st_stack_36","",10,-0.5,9.5);
   st_stack_36->SetMinimum(1.311132);
   st_stack_36->SetMaximum(6.552043e+14);
