...
//=========  (Wed Mar  1 14:06:43 2023) by ROOT version 6.26/06
   ...
   CSV_jets_all_signal_18->Range(-0.2183529,-0.3767773,1.171633,6.712738);
   ...
   st->SetTitle("");
   st->SetMinimum(10);
   st->SetMaximum(519159.1);
   
   TH1F *st_stack_167 = new TH1F("st_stack_167","",20,0,1);
   st_stack_167->SetMinimum(2.978273);
   st_stack_167->SetMaximum(1008757);
   ...
   st_stack_167->GetYaxis()->SetTitle("Events/0.05");
