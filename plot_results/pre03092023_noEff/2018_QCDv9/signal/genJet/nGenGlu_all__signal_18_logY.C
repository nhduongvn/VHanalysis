...
#endif
void nGenGlu_all__signal_18_logY()
{
...
//=========  (Mon Mar  6 10:58:23 2023) by ROOT version 6.26/06
   ...
   nGenGlu_all__signal_18->Range(-3.775293,0.4276209,17.0745,3.026772);
   ...
   nGenGlu_all__signal_18->SetLogy();
   ...
   st_stack_29->SetMinimum(5.489327);
   st_stack_29->SetMaximum(584.5973);
