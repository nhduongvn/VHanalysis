...
#endif
void nGenJet_all__signal_18_logY()
{
...
//=========  (Mon Mar  6 10:58:23 2023) by ROOT version 6.26/06
   ...
   nGenJet_all__signal_18->Range(-3.775293,0.4761723,17.0745,2.832593);
   ...
   nGenJet_all__signal_18->SetLogy();
   ...
   st_stack_5->SetMinimum(5.740408);
   st_stack_5->SetMaximum(395.3219);
