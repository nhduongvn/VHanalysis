...
//=========  (Wed Mar  1 14:06:11 2023) by ROOT version 6.26/06
   ...
   CvB_jets_signal_18->Range(-0.2183529,-170.1628,1.171633,1247.861);
   ...
   st_stack_23->GetYaxis()->SetTitle("Events/0.05");
