...
void dR_HZ_18()
{
//=========Macro generated from canvas: dR_HZ_18/dR_HZ_18
//=========  (Thu Feb 16 13:12:21 2023) by ROOT version 6.26/06
   TCanvas *dR_HZ_18 = new TCanvas("dR_HZ_18", "dR_HZ_18",0,0,600,600);
   dR_HZ_18->SetHighLightColor(2);
   dR_HZ_18->Range(-1.331953,-0.1538462,7.146962,1.128205);
   dR_HZ_18->SetFillColor(0);
   dR_HZ_18->SetFillStyle(4000);
   dR_HZ_18->SetBorderMode(0);
   dR_HZ_18->SetBorderSize(2);
   dR_HZ_18->SetLeftMargin(0.15709);
   dR_HZ_18->SetRightMargin(0.1234783);
   dR_HZ_18->SetBottomMargin(0.12);
   dR_HZ_18->SetFrameFillStyle(1000);
   dR_HZ_18->SetFrameBorderMode(0);
   dR_HZ_18->SetFrameFillStyle(1000);
   dR_HZ_18->SetFrameBorderMode(0);
   ...
   st_stack_54->GetYaxis()->SetTitle("Events/0.1");
   ...
   ci = TColor::GetColor("#000099");
   VbbHcc_MC_dR_HZ_stack_1->SetLineColor(ci);
   ...
   ci = TColor::GetColor("#000099");
   VbbHcc_MC_dR_HZ_stack_2->SetLineColor(ci);
