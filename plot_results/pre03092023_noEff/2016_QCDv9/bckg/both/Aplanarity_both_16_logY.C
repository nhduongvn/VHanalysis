...
//=========  (Thu Feb 16 10:37:41 2023) by ROOT version 6.26/06
   ...
   Aplanarity_both_16->Range(-0.2183529,-0.9854956,1.171633,9.939867);
   ...
   st->SetTitle("");
   st->SetMinimum(10);
   st->SetMaximum(2.825487e+08);
   
   TH1F *st_stack_189 = new TH1F("st_stack_189","",50,0,1);
   st_stack_189->SetMinimum(2.116157);
   st_stack_189->SetMaximum(7.036081e+08);
