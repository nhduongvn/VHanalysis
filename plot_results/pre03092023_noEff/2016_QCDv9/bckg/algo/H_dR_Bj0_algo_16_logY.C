...
//=========  (Thu Feb 16 10:37:39 2023) by ROOT version 6.26/06
   ...
   H_dR_Bj0_algo_16->Range(-1.310117,-0.7466957,7.029799,8.639219);
   ...
   st->SetTitle("");
   st->SetMinimum(10);
   st->SetMaximum(2.212079e+07);
   
   TH1F *st_stack_105 = new TH1F("st_stack_105","",30,0,6);
   st_stack_105->SetMinimum(2.396702);
   st_stack_105->SetMaximum(5.019118e+07);
