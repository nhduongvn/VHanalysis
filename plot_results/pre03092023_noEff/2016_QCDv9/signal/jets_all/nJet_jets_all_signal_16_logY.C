...
//=========  (Wed Mar  1 14:06:43 2023) by ROOT version 6.26/06
   ...
   nJet_jets_all_signal_16->Range(-3.556941,-0.004764087,15.90286,4.908575);
   ...
   st->SetTitle("");
   st->SetMinimum(10);
   st->SetMaximum(15932.22);
   
   TH1F *st_stack_157 = new TH1F("st_stack_157","",14,-0.5,13.5);
   st_stack_157->SetMinimum(3.844471);
   st_stack_157->SetMaximum(26136.1);
