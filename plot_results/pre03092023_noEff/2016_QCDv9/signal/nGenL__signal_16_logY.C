...
//=========  (Fri Mar  3 13:54:36 2023) by ROOT version 6.26/06
   ...
   nGenL__signal_16->Range(-2.683529,0.6626811,11.21633,2.123015);
   ...
   st_stack_7->SetMinimum(6.885274);
   st_stack_7->SetMaximum(94.83784);
