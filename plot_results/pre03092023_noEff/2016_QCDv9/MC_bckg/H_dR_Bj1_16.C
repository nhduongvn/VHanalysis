...
void H_dR_Bj1_16()
{
//=========Macro generated from canvas: H_dR_Bj1_16/H_dR_Bj1_16
//=========  (Thu Feb 16 13:12:21 2023) by ROOT version 6.26/06
   TCanvas *H_dR_Bj1_16 = new TCanvas("H_dR_Bj1_16", "H_dR_Bj1_16",0,0,600,600);
   H_dR_Bj1_16->SetHighLightColor(2);
   H_dR_Bj1_16->Range(-1.310117,-0.1538462,7.029799,1.128205);
   H_dR_Bj1_16->SetFillColor(0);
   H_dR_Bj1_16->SetFillStyle(4000);
   H_dR_Bj1_16->SetBorderMode(0);
   H_dR_Bj1_16->SetBorderSize(2);
   H_dR_Bj1_16->SetLeftMargin(0.15709);
   H_dR_Bj1_16->SetRightMargin(0.1234783);
   H_dR_Bj1_16->SetBottomMargin(0.12);
   H_dR_Bj1_16->SetFrameFillStyle(1000);
   H_dR_Bj1_16->SetFrameBorderMode(0);
   H_dR_Bj1_16->SetFrameFillStyle(1000);
   H_dR_Bj1_16->SetFrameBorderMode(0);
...
tex->SetNDC();
   ...
   tex->SetLineWidth(2);
   tex->Draw();
   H_dR_Bj1_16->Modified();
   H_dR_Bj1_16->cd();
   H_dR_Bj1_16->SetSelected(H_dR_Bj1_16);
}
