...
void Aplanarity_16()
{
//=========Macro generated from canvas: Aplanarity_16/Aplanarity_16
//=========  (Thu Feb 16 13:12:21 2023) by ROOT version 6.26/06
   TCanvas *Aplanarity_16 = new TCanvas("Aplanarity_16", "Aplanarity_16",0,0,600,600);
   Aplanarity_16->SetHighLightColor(2);
   Aplanarity_16->Range(-0.2183529,-0.1538462,1.171633,1.128205);
   Aplanarity_16->SetFillColor(0);
   Aplanarity_16->SetFillStyle(4000);
   Aplanarity_16->SetBorderMode(0);
   Aplanarity_16->SetBorderSize(2);
   Aplanarity_16->SetLeftMargin(0.15709);
   Aplanarity_16->SetRightMargin(0.1234783);
   Aplanarity_16->SetBottomMargin(0.12);
   Aplanarity_16->SetFrameFillStyle(1000);
   Aplanarity_16->SetFrameBorderMode(0);
   Aplanarity_16->SetFrameFillStyle(1000);
   Aplanarity_16->SetFrameBorderMode(0);
   ...
   st_stack_68->GetYaxis()->SetTitle("Events/0.02");
...
tex->SetNDC();
   ...
   tex->SetLineWidth(2);
   tex->Draw();
   Aplanarity_16->Modified();
   Aplanarity_16->cd();
   Aplanarity_16->SetSelected(Aplanarity_16);
}
