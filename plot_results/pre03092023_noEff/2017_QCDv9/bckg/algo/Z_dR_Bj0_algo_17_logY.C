...
//=========  (Thu Feb 16 10:37:39 2023) by ROOT version 6.26/06
   ...
   Z_dR_Bj0_algo_17->Range(-1.310117,-0.7876113,7.029799,8.85916);
   ...
   st->SetTitle("");
   st->SetMinimum(10);
   st->SetMaximum(3.400674e+07);
   
   TH1F *st_stack_114 = new TH1F("st_stack_114","",30,0,6);
   st_stack_114->SetMinimum(2.344236);
   st_stack_114->SetMaximum(7.843018e+07);
