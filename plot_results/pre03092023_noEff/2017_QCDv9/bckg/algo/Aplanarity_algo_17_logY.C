...
//=========  (Thu Feb 16 10:37:40 2023) by ROOT version 6.26/06
   ...
   Aplanarity_algo_17->Range(-0.2183529,-0.843128,1.171633,9.15957);
   ...
   st->SetTitle("");
   st->SetMinimum(10);
   st->SetMaximum(6.12169e+07);
   
   TH1F *st_stack_126 = new TH1F("st_stack_126","",50,0,1);
   st_stack_126->SetMinimum(2.276123);
   st_stack_126->SetMaximum(1.443111e+08);
