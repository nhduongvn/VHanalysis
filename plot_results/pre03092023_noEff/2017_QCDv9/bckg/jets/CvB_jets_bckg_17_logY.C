...
//=========  (Wed Mar  1 14:06:39 2023) by ROOT version 6.26/06
   ...
   CvB_jets_bckg_17->Range(-0.2183529,4.357465,1.171633,14.94431);
   ...
   st->SetName("st");
   st->SetTitle("");
   st->SetMinimum(1954227);
   st->SetMaximum(3.147635e+13);
   
   TH1F *st_stack_22 = new TH1F("st_stack_22","",20,0,1);
   st_stack_22->SetMinimum(424508.5);
   st_stack_22->SetMaximum(7.684642e+13);
