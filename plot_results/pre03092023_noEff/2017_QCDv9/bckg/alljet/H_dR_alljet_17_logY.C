...
//=========  (Thu Feb 16 10:37:41 2023) by ROOT version 6.26/06
   ...
   H_dR_alljet_17->Range(-1.353788,1.162899,7.264125,15.06706);
   ...
   st->SetName("st");
   st->SetTitle("");
   st->SetMinimum(3939.149);
   st->SetMaximum(1.624801e+13);
   
   TH1F *st_stack_214 = new TH1F("st_stack_214","",30,0,6);
   st_stack_214->SetMinimum(678.2634);
   st_stack_214->SetMaximum(4.749423e+13);
