...
#endif
void nGenL_all__signal_17_logY()
{
...
//=========  (Mon Mar  6 10:58:23 2023) by ROOT version 6.26/06
   ...
   nGenL_all__signal_17->Range(-3.775293,0.4791296,17.0745,2.820887);
   ...
   st_stack_9->SetMinimum(5.756262);
   st_stack_9->SetMaximum(386.1104);
