...
void Z_pt_17()
{
//=========Macro generated from canvas: Z_pt_17/Z_pt_17
//=========  (Thu Feb 16 13:12:21 2023) by ROOT version 6.26/06
   TCanvas *Z_pt_17 = new TCanvas("Z_pt_17", "Z_pt_17",0,0,600,600);
   Z_pt_17->SetHighLightColor(2);
   Z_pt_17->Range(37.97653,-0.262858,1705.96,1.927625);
   Z_pt_17->SetFillColor(0);
   Z_pt_17->SetFillStyle(4000);
   Z_pt_17->SetBorderMode(0);
   Z_pt_17->SetBorderSize(2);
   Z_pt_17->SetLeftMargin(0.15709);
   Z_pt_17->SetRightMargin(0.1234783);
   Z_pt_17->SetBottomMargin(0.12);
   Z_pt_17->SetFrameFillStyle(1000);
   Z_pt_17->SetFrameBorderMode(0);
   Z_pt_17->SetFrameFillStyle(1000);
   Z_pt_17->SetFrameBorderMode(0);
   ...
   st_stack_63->SetMaximum(1.708577);
