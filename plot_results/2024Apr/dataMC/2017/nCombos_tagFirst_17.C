...
// ------------>Primitives in pad: topPad
   ...
   topPad->Draw();
   topPad->cd();
   topPad->Range(-1.266127,-59825.3,4.762097,5.976548e+07);
   ...
   VH_tagFirst_nCombos_stack_1->SetBinContent(1,2.328426e+07);
   VH_tagFirst_nCombos_stack_1->SetBinContent(2,1443674);
   VH_tagFirst_nCombos_stack_1->SetBinContent(3,11462.85);
   VH_tagFirst_nCombos_stack_1->SetBinError(1,147392);
   VH_tagFirst_nCombos_stack_1->SetBinError(2,35961.48);
   VH_tagFirst_nCombos_stack_1->SetBinError(3,1124.022);
   VH_tagFirst_nCombos_stack_1->SetEntries(4475275);
   ...
   Double_t Graph_from_VH_tagFirst_nCombos_fy1003[4] = { 2.420233e+07, 1771073, 15535.3, 0 };
   Double_t Graph_from_VH_tagFirst_nCombos_fex1003[4] = { 0.5, 0.5, 0.5, 0.5 };
   Double_t Graph_from_VH_tagFirst_nCombos_fey1003[4] = { 147392.6, 35962.05, 1124.227, 0 };
   ...
   Graph_Graph_from_VH_tagFirst_nCombos1003->SetMinimum(0);
   Graph_Graph_from_VH_tagFirst_nCombos1003->SetMaximum(2.678469e+07);
...
// ------------>Primitives in pad: bottomPad
   ...
   data_mc_ratio__4->SetBinContent(1,0.4019455);
   data_mc_ratio__4->SetBinContent(2,0.7853583);
   data_mc_ratio__4->SetBinContent(3,1.070336);
   data_mc_ratio__4->SetBinError(1,0.0001288709);
   data_mc_ratio__4->SetBinError(2,0.0006659102);
   data_mc_ratio__4->SetBinError(3,0.008300423);
   data_mc_ratio__4->SetMinimum(0.4);
   data_mc_ratio__4->SetMaximum(1.6);
   data_mc_ratio__4->SetEntries(805.3224);
   ...
   Double_t Graph_from_mc_statistical_error_fey1004[4] = { 0.006090017, 0.02030523, 0.07236593, 0 };
   ...
   Graph_Graph_from_mc_statistical_error1004->SetMinimum(0.9131609);
   Graph_Graph_from_mc_statistical_error1004->SetMaximum(1.086839);
