...
// ------------>Primitives in pad: topPad
   ...
   topPad->Draw();
   topPad->cd();
   topPad->Range(-1.266127,-3.024822,4.762097,18.99673);
   ...
   st->SetTitle("");
   st->SetMinimum(0.01);
   st->SetMaximum(1.34705e+16);
   
   TH1F *st_stack_3 = new TH1F("st_stack_3","",4,-0.5,3.5);
   st_stack_3->SetMinimum(0.0009935724);
   st_stack_3->SetMaximum(6.231289e+16);
   ...
   VH_tagFirst_nCombos_stack_1->SetBinContent(1,1.648284e+07);
   VH_tagFirst_nCombos_stack_1->SetBinContent(2,2674874);
   VH_tagFirst_nCombos_stack_1->SetBinContent(3,28754.97);
   VH_tagFirst_nCombos_stack_1->SetBinError(1,210017.6);
   VH_tagFirst_nCombos_stack_1->SetBinError(2,49649.78);
   VH_tagFirst_nCombos_stack_1->SetBinError(3,3300.334);
   VH_tagFirst_nCombos_stack_1->SetEntries(525206);
   ...
   Double_t Graph_from_VH_tagFirst_nCombos_fy1005[4] = { 1.812269e+07, 3396655, 38361.91, 0 };
   Double_t Graph_from_VH_tagFirst_nCombos_fex1005[4] = { 0.5, 0.5, 0.5, 0.5 };
   Double_t Graph_from_VH_tagFirst_nCombos_fey1005[4] = { 210019.3, 49651.88, 3300.742, 0 };
   ...
   Graph_Graph_from_VH_tagFirst_nCombos1005->SetMinimum(20165.98);
   Graph_Graph_from_VH_tagFirst_nCombos1005->SetMaximum(2.016598e+07);
...
// ------------>Primitives in pad: bottomPad
   ...
   data_mc_ratio__6->SetBinContent(1,0.9700094);
   data_mc_ratio__6->SetBinContent(2,0.8722641);
   data_mc_ratio__6->SetBinContent(3,0.9115291);
   data_mc_ratio__6->SetBinError(1,0.0002313538);
   data_mc_ratio__6->SetBinError(2,0.0005067553);
   data_mc_ratio__6->SetBinError(3,0.004874557);
   data_mc_ratio__6->SetMinimum(0.4);
   data_mc_ratio__6->SetMaximum(1.6);
   data_mc_ratio__6->SetEntries(1173.13);
   ...
   Double_t Graph_from_mc_statistical_error_fey1006[4] = { 0.01158875, 0.01461788, 0.08604216, 0 };
   ...
   Graph_Graph_from_mc_statistical_error1006->SetMinimum(0.8967494);
   Graph_Graph_from_mc_statistical_error1006->SetMaximum(1.103251);
