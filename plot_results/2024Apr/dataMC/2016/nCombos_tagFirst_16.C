...
// ------------>Primitives in pad: topPad
   ...
   topPad->Draw();
   topPad->cd();
   topPad->Range(-1.266127,-285945.9,4.762097,2.8566e+08);
   ...
   Graph_Graph_from_VH_tagFirst_nCombos1001->SetMinimum(0);
