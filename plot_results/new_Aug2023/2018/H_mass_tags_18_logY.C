...
// ------------>Primitives in pad: topPad
   ...
   topPad->Draw();
   topPad->cd();
   topPad->Range(-45.96762,-2.815548,315.7258,10.51313);
   ...
   st->SetTitle("");
   st->SetMinimum(0.01);
   st->SetMaximum(4.828187e+08);
   
   TH1F *st_stack_7 = new TH1F("st_stack_7","",40,0,400);
   st_stack_7->SetMinimum(0.001576817);
   st_stack_7->SetMaximum(1.514485e+09);
   ...
   Graph_Graph_from_VbbHcc_tags_H_mass1013->SetMinimum(10.47414);
