...
// ------------>Primitives in pad: topPad
   ...
   topPad->Draw();
   topPad->cd();
   topPad->Range(-0.9193524,-2.852783,6.314516,11.76589);
   ...
   st->SetTitle("");
   st->SetMinimum(0.01);
   st->SetMaximum(6.001281e+09);
   
   TH1F *st_stack_211 = new TH1F("st_stack_211","",30,0,6);
   st_stack_211->SetMinimum(0.001451564);
   st_stack_211->SetMaximum(2.013819e+10);
   ...
   Graph_Graph_from_VbbHcc_both_Z_dR1421->SetMinimum(23.41129);
