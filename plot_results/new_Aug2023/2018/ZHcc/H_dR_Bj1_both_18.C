...
//=========  (Tue Aug 22 09:23:06 2023) by ROOT version 6.14/09
   ...
   H_dR_Bj1_both_18->Range(-1.2,-0.007467344,6.8,0.06720609);
   ...
   VbbHcc_both_H_dR_Bj1_stack_11->GetXaxis()->SetTitle("#DeltaR(H,j_{2})");
   VbbHcc_both_H_dR_Bj1_stack_11->GetXaxis()->SetRange(1,30);
   ...
   VbbHcc_both_H_dR_Bj1_stack_11->Draw("HIST");
