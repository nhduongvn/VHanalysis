...
// ------------>Primitives in pad: topPad
   ...
   topPad->Draw();
   topPad->cd();
   topPad->Range(-0.9499975,-2.902449,6.525,13.59609);
   ...
   st->SetTitle("");
   st->SetMinimum(0.01);
   st->SetMaximum(2.403477e+11);
   
   TH1F *st_stack_119 = new TH1F("st_stack_119","",30,0,6);
   st_stack_119->SetMinimum(0.001300319);
   st_stack_119->SetMaximum(8.835586e+11);
   ...
   Graph_Graph_from_VbbHcc_algo_H_dR1237->SetMinimum(151.9183);
