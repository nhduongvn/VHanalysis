...
// ------------>Primitives in pad: topPad
   ...
   topPad->Draw();
   topPad->cd();
   topPad->Range(-0.9499975,-2.844731,6.525,11.48665);
   ...
   st->SetTitle("");
   st->SetMinimum(0.01);
   st->SetMaximum(3.420605e+09);
   
   TH1F *st_stack_23 = new TH1F("st_stack_23","",30,0,6);
   st_stack_23->SetMinimum(0.001477748);
   st_stack_23->SetMaximum(1.131133e+10);
   ...
   Graph_Graph_from_VbbHcc_tags_H_dR1045->SetMinimum(20.86941);
