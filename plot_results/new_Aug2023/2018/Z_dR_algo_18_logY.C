...
// ------------>Primitives in pad: topPad
   ...
   topPad->Draw();
   topPad->cd();
   topPad->Range(-0.9193524,-2.907026,6.314516,13.77449);
   ...
   st->SetTitle("");
   st->SetMinimum(0.01);
   st->SetMaximum(3.445589e+11);
   
   TH1F *st_stack_115 = new TH1F("st_stack_115","",30,0,6);
   st_stack_115->SetMinimum(0.001287228);
   st_stack_115->SetMaximum(1.277436e+12);
   ...
   Graph_Graph_from_VbbHcc_algo_Z_dR1229->SetMinimum(177.2054);
