...
// ------------>Primitives in pad: topPad
   ...
   topPad->Draw();
   topPad->cd();
   topPad->Range(-0.9499975,-2.858392,6.525,11.96321);
   ...
   st->SetTitle("");
   st->SetMinimum(0.01);
   st->SetMaximum(8.929553e+09);
   
   TH1F *st_stack_215 = new TH1F("st_stack_215","",30,0,6);
   st_stack_215->SetMinimum(0.001433606);
   st_stack_215->SetMaximum(3.027267e+10);
   ...
   Graph_Graph_from_VbbHcc_both_H_dR1429->SetMinimum(30.02531);
