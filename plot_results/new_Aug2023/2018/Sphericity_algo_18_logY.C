...
// ------------>Primitives in pad: topPad
   ...
   topPad->Draw();
   topPad->cd();
   topPad->Range(-0.1532254,-2.94754,1.052419,15.42952);
   ...
   st->SetTitle("");
   st->SetMinimum(0.01);
   st->SetMaximum(9.771682e+12);
   
   TH1F *st_stack_155 = new TH1F("st_stack_155","",25,0,1);
   st_stack_155->SetMinimum(0.001177165);
   st_stack_155->SetMaximum(3.906712e+13);
   ...
   Graph_Graph_from_VbbHcc_algo_Sphericity1309->SetMinimum(784.6178);
