...
// ------------>Primitives in pad: topPad
   ...
   topPad->Draw();
   topPad->cd();
   topPad->Range(-0.9193524,-1.353209,6.314516,12.47595);
   ...
   st->SetTitle("");
   st->SetMinimum(0.3);
   st->SetMaximum(3.845607e+10);
   
   TH1F *st_stack_212 = new TH1F("st_stack_212","",30,0,6);
   st_stack_212->SetMinimum(0.04577412);
   st_stack_212->SetMaximum(1.238889e+11);
   ...
   Graph_Graph_from_VbbHcc_both_Z_dR_all1423->SetMinimum(86.74129);
