...
// ------------>Primitives in pad: topPad
   ...
   topPad->Draw();
   topPad->cd();
   topPad->Range(-0.1532254,-1.393407,1.052419,13.87528);
   ...
   st->SetTitle("");
   st->SetMinimum(0.3);
   st->SetMaximum(6.43501e+11);
   
   TH1F *st_stack_60 = new TH1F("st_stack_60","",25,0,1);
   st_stack_60->SetMinimum(0.04186603);
   st_stack_60->SetMaximum(2.230558e+12);
   ...
   Graph_Graph_from_VbbHcc_tags_Sphericity_all1119->SetMinimum(245.9965);
