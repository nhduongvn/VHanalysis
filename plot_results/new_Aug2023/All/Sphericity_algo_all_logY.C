...
// ------------>Primitives in pad: topPad
   ...
   topPad->Draw();
   topPad->cd();
   topPad->Range(-0.1532254,-1.459467,1.052419,16.44548);
   ...
   st->SetTitle("");
   st->SetMinimum(0.3);
   st->SetMaximum(1.153547e+14);
   
   TH1F *st_stack_156 = new TH1F("st_stack_156","",25,0,1);
   st_stack_156->SetMinimum(0.03617746);
   st_stack_156->SetMaximum(4.518423e+14);
   ...
   Graph_Graph_from_VbbHcc_algo_Sphericity_all1311->SetMinimum(2376.459);
