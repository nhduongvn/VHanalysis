...
// ------------>Primitives in pad: topPad
   ...
   topPad->Draw();
   topPad->cd();
   topPad->Range(-0.9193524,-2.85998,6.314516,12.0195);
   ...
   st->SetTitle("");
   st->SetMinimum(0.01);
   st->SetMaximum(1.000174e+10);
   
   TH1F *st_stack_18 = new TH1F("st_stack_18","",30,0,6);
   st_stack_18->SetMinimum(0.001428564);
   st_stack_18->SetMaximum(3.400607e+10);
   ...
   Graph_Graph_from_VbbHcc_tags_Z_dR1035->SetMinimum(57.47731);
