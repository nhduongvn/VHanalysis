...
//=========  (Tue Aug 22 09:19:02 2023) by ROOT version 6.14/09
   ...
   H_jetmass_JEC_both_17->Range(-60,-0.6137316,340,0.2945967);
   ...
   VbbHcc_both_H_jetmass_JEC_stack_6->SetBinContent(2,0.8437523);
   VbbHcc_both_H_jetmass_JEC_stack_6->SetBinContent(3,0.5999724);
   VbbHcc_both_H_jetmass_JEC_stack_6->SetBinError(2,0.5005675);
   VbbHcc_both_H_jetmass_JEC_stack_6->SetBinError(3,0.4243022);
