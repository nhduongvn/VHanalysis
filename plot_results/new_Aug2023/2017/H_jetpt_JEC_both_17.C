...
// ------------>Primitives in pad: topPad
   ...
   topPad->Draw();
   topPad->cd();
   topPad->Range(-45.96762,-165.5814,315.7258,165425.8);
   ...
   VbbHcc_both_H_jetpt_JEC_stack_12->SetBinContent(0,0.0317378);
   VbbHcc_both_H_jetpt_JEC_stack_12->SetBinContent(2,0.02346587);
   VbbHcc_both_H_jetpt_JEC_stack_12->SetBinContent(3,0.006476429);
   VbbHcc_both_H_jetpt_JEC_stack_12->SetBinError(0,0.002575566);
   VbbHcc_both_H_jetpt_JEC_stack_12->SetBinError(2,0.002212062);
   VbbHcc_both_H_jetpt_JEC_stack_12->SetBinError(3,0.001180638);
   ...
   VbbHcc_both_H_jetpt_JEC__719->SetBinContent(0,34151);
   VbbHcc_both_H_jetpt_JEC__719->SetBinContent(1,116);
   VbbHcc_both_H_jetpt_JEC__719->SetBinContent(2,22163);
   VbbHcc_both_H_jetpt_JEC__719->SetBinContent(3,10606);
   VbbHcc_both_H_jetpt_JEC__719->SetEntries(67185);
   ...
   Graph_Graph_from_VbbHcc_both_H_jetpt_JEC1523->SetMaximum(73730.49);
...
// ------------>Primitives in pad: bottomPad
   ...
   data_mc_ratio__720->SetBinContent(0,0.369909);
   data_mc_ratio__720->SetBinContent(1,0.8696992);
   data_mc_ratio__720->SetBinContent(2,0.3473825);
   data_mc_ratio__720->SetBinContent(3,0.3793823);
   data_mc_ratio__720->SetBinError(0,0.01353722);
   data_mc_ratio__720->SetBinError(1,0.08074954);
   data_mc_ratio__720->SetBinError(2,0.002333424);
   data_mc_ratio__720->SetBinError(3,0.003683844);
   data_mc_ratio__720->SetMinimum(0.4);
   data_mc_ratio__720->SetMaximum(1.6);
   data_mc_ratio__720->SetEntries(40.47518);
   ...
   Graph_Graph_from_mc_statistical_error1524->SetMinimum(0.6746769);
   Graph_Graph_from_mc_statistical_error1524->SetMaximum(1.325323);
