...
// ------------>Primitives in pad: topPad
   ...
   topPad->Draw();
   topPad->cd();
   topPad->Range(-45.96762,-2.854169,315.7258,11.81444);
   ...
   st->SetTitle("");
   st->SetMinimum(0.01);
   st->SetMaximum(6.617692e+09);
   
   TH1F *st_stack_194 = new TH1F("st_stack_194","",40,0,400);
   st_stack_194->SetMinimum(0.001447104);
   st_stack_194->SetMaximum(2.226285e+10);
   ...
   Graph_Graph_from_VbbHcc_both_Z_mass1387->SetMinimum(51.55864);
