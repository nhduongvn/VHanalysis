...
// ------------>Primitives in pad: topPad
   ...
   topPad->Draw();
   topPad->cd();
   topPad->Range(-0.9193524,-2.900977,6.314516,13.53909);
   ...
   st->SetTitle("");
   st->SetMinimum(0.01);
   st->SetMaximum(2.142262e+11);
   
   TH1F *st_stack_114 = new TH1F("st_stack_114","",30,0,6);
   st_stack_114->SetMinimum(0.001304557);
   st_stack_114->SetMaximum(7.853905e+11);
   ...
   Graph_Graph_from_VbbHcc_algo_Z_dR1227->SetMinimum(158.9445);
