...
// ------------>Primitives in pad: topPad
   ...
   topPad->Draw();
   topPad->cd();
   topPad->Range(-45.96762,-2.881293,315.7258,12.79328);
   ...
   st->SetTitle("");
   st->SetMinimum(0.01);
   st->SetMaximum(4.757505e+10);
   
   TH1F *st_stack_262 = new TH1F("st_stack_262","",150,0,300);
   st_stack_262->SetMinimum(0.001362641);
   st_stack_262->SetMaximum(1.682004e+11);
   ...
   Graph_Graph_from_VbbHcc_both_H_jetpt_JEC1523->SetMinimum(73.73049);
