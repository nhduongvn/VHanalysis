...
// ------------>Primitives in pad: topPad
   ...
   topPad->Draw();
   topPad->cd();
   topPad->Range(-0.1532254,-2.93982,1.052419,15.10338);
   ...
   st->SetTitle("");
   st->SetMinimum(0.01);
   st->SetMaximum(5.052224e+12);
   
   TH1F *st_stack_154 = new TH1F("st_stack_154","",25,0,1);
   st_stack_154->SetMinimum(0.001197355);
   st_stack_154->SetMaximum(1.990928e+13);
   ...
   Graph_Graph_from_VbbHcc_algo_Sphericity1307->SetMinimum(597.6518);
