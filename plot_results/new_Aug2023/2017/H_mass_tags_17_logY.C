...
// ------------>Primitives in pad: topPad
   ...
   topPad->Draw();
   topPad->cd();
   topPad->Range(-45.96762,-2.850801,315.7258,11.69671);
   ...
   st->SetTitle("");
   st->SetMinimum(0.01);
   st->SetMaximum(5.22101e+09);
   
   TH1F *st_stack_6 = new TH1F("st_stack_6","",40,0,400);
   st_stack_6->SetMinimum(0.001457965);
   st_stack_6->SetMaximum(1.745671e+10);
   ...
   Graph_Graph_from_VbbHcc_tags_H_mass1011->SetMinimum(48.62555);
