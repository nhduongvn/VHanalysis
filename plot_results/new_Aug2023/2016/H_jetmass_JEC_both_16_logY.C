...
// ------------>Primitives in pad: topPad
   ...
   topPad->Draw();
   topPad->cd();
   topPad->Range(-45.96762,-2.886027,315.7258,12.96986);
   ...
   st->SetTitle("");
   st->SetMinimum(0.01);
   st->SetMaximum(6.792717e+10);
   
   TH1F *st_stack_269 = new TH1F("st_stack_269","",150,0,300);
   st_stack_269->SetMinimum(0.001348432);
   st_stack_269->SetMaximum(2.42256e+11);
   ...
   Graph_Graph_from_VbbHcc_both_H_jetmass_JEC1537->SetMinimum(86.07346);
