...
// ------------>Primitives in pad: topPad
   ...
   topPad->Draw();
   topPad->cd();
   topPad->Range(-0.9193524,-2.909047,6.314516,13.85378);
   ...
   st->SetTitle("");
   st->SetMinimum(0.01);
   st->SetMaximum(4.043893e+11);
   
   TH1F *st_stack_113 = new TH1F("st_stack_113","",30,0,6);
   st_stack_113->SetMinimum(0.001281493);
   st_stack_113->SetMaximum(1.504878e+12);
   ...
   Graph_Graph_from_VbbHcc_algo_Z_dR1225->SetMinimum(189.2109);
