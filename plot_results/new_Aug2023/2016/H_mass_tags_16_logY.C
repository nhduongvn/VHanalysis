...
// ------------>Primitives in pad: topPad
   ...
   topPad->Draw();
   topPad->cd();
   topPad->Range(-45.96762,-2.795086,315.7258,9.86527);
   ...
   st->SetTitle("");
   st->SetMinimum(0.01);
   st->SetMaximum(1.314286e+08);
   
   TH1F *st_stack_5 = new TH1F("st_stack_5","",40,0,400);
   st_stack_5->SetMinimum(0.001650343);
   st_stack_5->SetMaximum(3.974055e+08);
   ...
   Graph_Graph_from_VbbHcc_tags_H_mass1009->SetMinimum(5.913572);
