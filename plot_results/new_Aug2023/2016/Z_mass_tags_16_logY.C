...
// ------------>Primitives in pad: topPad
   ...
   topPad->Draw();
   topPad->cd();
   topPad->Range(-45.96762,-2.805838,315.7258,10.20223);
   ...
   st->SetTitle("");
   st->SetMinimum(0.01);
   st->SetMaximum(2.585349e+08);
   
   TH1F *st_stack_1 = new TH1F("st_stack_1","",40,0,400);
   st_stack_1->SetMinimum(0.001611276);
   st_stack_1->SetMaximum(7.969347e+08);
   ...
   Graph_Graph_from_VbbHcc_tags_Z_mass1001->SetMinimum(8.934479);
