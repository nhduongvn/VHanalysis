...
//=========  (Tue Aug 22 09:20:40 2023) by ROOT version 6.14/09
   ...
   Z_dR_Bj1_tags_16->Range(-1.2,-0.001078496,6.8,0.009706467);
   ...
   VbbHcc_tags_Z_dR_Bj1_stack_12->GetXaxis()->SetTitle("#DeltaR(Z,j_{2})");
   VbbHcc_tags_Z_dR_Bj1_stack_12->GetXaxis()->SetRange(1,30);
   ...
   VbbHcc_tags_Z_dR_Bj1_stack_12->Draw("HIST");
