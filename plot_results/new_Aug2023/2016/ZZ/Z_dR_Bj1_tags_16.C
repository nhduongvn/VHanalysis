...
//=========  (Tue Aug 22 09:20:40 2023) by ROOT version 6.14/09
   ...
   Z_dR_Bj1_tags_16->Range(-1.2,-0.8031762,6.8,7.228586);
   ...
   VbbHcc_tags_Z_dR_Bj1_stack_8->GetXaxis()->SetTitle("#DeltaR(Z,j_{2})");
   VbbHcc_tags_Z_dR_Bj1_stack_8->GetXaxis()->SetRange(1,30);
   ...
   VbbHcc_tags_Z_dR_Bj1_stack_8->Draw("HIST");
