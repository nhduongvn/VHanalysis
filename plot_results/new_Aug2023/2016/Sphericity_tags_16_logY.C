...
// ------------>Primitives in pad: topPad
   ...
   topPad->Draw();
   topPad->cd();
   topPad->Range(-0.1532254,-2.875211,1.052419,12.56895);
   ...
   st->SetTitle("");
   st->SetMinimum(0.01);
   st->SetMaximum(3.026503e+10);
   
   TH1F *st_stack_57 = new TH1F("st_stack_57","",25,0,1);
   st_stack_57->SetMinimum(0.001381126);
   st_stack_57->SetMaximum(1.058122e+11);
   ...
   Graph_Graph_from_VbbHcc_tags_Sphericity1113->SetMinimum(61.11454);
