...
//=========  (Fri Mar 10 11:21:20 2023) by ROOT version 6.26/06
   ...
   H_pt_signal_17->Range(37.97653,-12.60784,1705.96,92.45753);
   ...
   st_stack_57->GetYaxis()->SetTitle("Event/50.0 GeV");
