...
#endif
void GenJet_VbbHcc_pt_b_bckg_17_logY()
{
//=========Macro generated from canvas: GenJet_VbbHcc_pt_b_bckg_17/GenJet_VbbHcc_pt_b_bckg_17
//=========  (Thu Mar  9 15:52:25 2023) by ROOT version 6.26/06
   TCanvas *GenJet_VbbHcc_pt_b_bckg_17 = new TCanvas("GenJet_VbbHcc_pt_b_bckg_17", "GenJet_VbbHcc_pt_b_bckg_17",0,0,600,600);
   GenJet_VbbHcc_pt_b_bckg_17->SetHighLightColor(2);
   GenJet_VbbHcc_pt_b_bckg_17->Range(-436.7058,-nan,2343.266,-nan);
   GenJet_VbbHcc_pt_b_bckg_17->SetFillColor(0);
   GenJet_VbbHcc_pt_b_bckg_17->SetFillStyle(4000);
   GenJet_VbbHcc_pt_b_bckg_17->SetBorderMode(0);
   GenJet_VbbHcc_pt_b_bckg_17->SetBorderSize(2);
   GenJet_VbbHcc_pt_b_bckg_17->SetLogy();
   GenJet_VbbHcc_pt_b_bckg_17->SetLeftMargin(0.15709);
   GenJet_VbbHcc_pt_b_bckg_17->SetRightMargin(0.1234783);
   GenJet_VbbHcc_pt_b_bckg_17->SetBottomMargin(0.12);
   GenJet_VbbHcc_pt_b_bckg_17->SetFrameFillStyle(1000);
   GenJet_VbbHcc_pt_b_bckg_17->SetFrameBorderMode(0);
   GenJet_VbbHcc_pt_b_bckg_17->SetFrameFillStyle(1000);
   GenJet_VbbHcc_pt_b_bckg_17->SetFrameBorderMode(0);
   ...
   st_stack_202->GetXaxis()->SetTitle("pt (b-jet) [GeV]");
...
tex->SetNDC();
   ...
   tex->SetLineWidth(2);
   tex->Draw();
   GenJet_VbbHcc_pt_b_bckg_17->Modified();
   GenJet_VbbHcc_pt_b_bckg_17->cd();
   GenJet_VbbHcc_pt_b_bckg_17->SetSelected(GenJet_VbbHcc_pt_b_bckg_17);
}
