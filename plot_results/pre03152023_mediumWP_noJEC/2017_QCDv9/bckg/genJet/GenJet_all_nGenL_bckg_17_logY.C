...
#endif
void GenJet_all_nGenL_bckg_17_logY()
{
...
//=========  (Thu Mar  9 15:52:21 2023) by ROOT version 6.26/06
   ...
   GenJet_all_nGenL_bckg_17->Range(-4.867058,-2.865432,22.93266,14.02118);
   ...
   GenJet_all_nGenL_bckg_17->SetLogy();
   ...
   st_stack_10->SetMinimum(0.1448643);
   st_stack_10->SetMaximum(2.150404e+12);
