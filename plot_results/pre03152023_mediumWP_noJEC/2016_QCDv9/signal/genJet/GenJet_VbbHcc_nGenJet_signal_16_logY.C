...
#endif
void GenJet_VbbHcc_nGenJet_signal_16_logY()
{
...
//=========  (Thu Mar  9 15:52:24 2023) by ROOT version 6.26/06
   ...
   GenJet_VbbHcc_nGenJet_signal_16->Range(-4.867058,-0.5754219,22.93266,2.039066);
   ...
   GenJet_VbbHcc_nGenJet_signal_16->SetLogy();
   ...
   st_stack_145->SetMinimum(0.547415);
   st_stack_145->SetMaximum(59.9263);
