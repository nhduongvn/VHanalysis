...
#endif
void nJet_jets_signal_16()
{
//=========Macro generated from canvas: nJet_jets_signal_16/nJet_jets_signal_16
//=========  (Thu Mar  9 13:30:48 2023) by ROOT version 6.26/06
   TCanvas *nJet_jets_signal_16 = new TCanvas("nJet_jets_signal_16", "nJet_jets_signal_16",0,0,600,600);
   nJet_jets_signal_16->SetHighLightColor(2);
   nJet_jets_signal_16->Range(-3.556941,-43.10975,15.90286,316.1382);
   nJet_jets_signal_16->SetFillColor(0);
   nJet_jets_signal_16->SetFillStyle(4000);
   nJet_jets_signal_16->SetBorderMode(0);
   nJet_jets_signal_16->SetBorderSize(2);
   nJet_jets_signal_16->SetLeftMargin(0.15709);
   nJet_jets_signal_16->SetRightMargin(0.1234783);
   nJet_jets_signal_16->SetBottomMargin(0.12);
   nJet_jets_signal_16->SetFrameFillStyle(1000);
   nJet_jets_signal_16->SetFrameBorderMode(0);
   nJet_jets_signal_16->SetFrameFillStyle(1000);
   nJet_jets_signal_16->SetFrameBorderMode(0);
...
tex->SetNDC();
   ...
   tex->SetLineWidth(2);
   tex->Draw();
   nJet_jets_signal_16->Modified();
   nJet_jets_signal_16->cd();
   nJet_jets_signal_16->SetSelected(nJet_jets_signal_16);
}
