...
#endif
void Z_dR_Bj0_bckg_16()
{
//=========Macro generated from canvas: Z_dR_Bj0_bckg_16/Z_dR_Bj0_bckg_16
//=========  (Fri Mar 10 11:21:19 2023) by ROOT version 6.26/06
   TCanvas *Z_dR_Bj0_bckg_16 = new TCanvas("Z_dR_Bj0_bckg_16", "Z_dR_Bj0_bckg_16",0,0,600,600);
   Z_dR_Bj0_bckg_16->SetHighLightColor(2);
   Z_dR_Bj0_bckg_16->Range(-1.310117,-0.1538462,7.029799,1.128205);
   Z_dR_Bj0_bckg_16->SetFillColor(0);
   Z_dR_Bj0_bckg_16->SetFillStyle(4000);
   Z_dR_Bj0_bckg_16->SetBorderMode(0);
   Z_dR_Bj0_bckg_16->SetBorderSize(2);
   Z_dR_Bj0_bckg_16->SetLeftMargin(0.15709);
   Z_dR_Bj0_bckg_16->SetRightMargin(0.1234783);
   Z_dR_Bj0_bckg_16->SetBottomMargin(0.12);
   Z_dR_Bj0_bckg_16->SetFrameFillStyle(1000);
   Z_dR_Bj0_bckg_16->SetFrameBorderMode(0);
   Z_dR_Bj0_bckg_16->SetFrameFillStyle(1000);
   Z_dR_Bj0_bckg_16->SetFrameBorderMode(0);
   ...
   st_stack_38->GetXaxis()->SetTitle("#DeltaR(Z,j_{1})");
...
tex->SetNDC();
   ...
   tex->SetLineWidth(2);
   tex->Draw();
   Z_dR_Bj0_bckg_16->Modified();
   Z_dR_Bj0_bckg_16->cd();
   Z_dR_Bj0_bckg_16->SetSelected(Z_dR_Bj0_bckg_16);
}
