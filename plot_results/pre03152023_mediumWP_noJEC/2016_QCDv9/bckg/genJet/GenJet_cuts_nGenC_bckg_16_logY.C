...
#endif
void GenJet_cuts_nGenC_bckg_16_logY()
{
...
//=========  (Thu Mar  9 15:52:23 2023) by ROOT version 6.26/06
   ...
   GenJet_cuts_nGenC_bckg_16->Range(-4.867058,-2.925915,22.93266,14.38377);
   ...
   GenJet_cuts_nGenC_bckg_16->SetLogy();
   ...
   st_stack_92->SetMinimum(0.14166);
   st_stack_92->SetMaximum(4.495752e+12);
