...
#endif
void GenJet_all_nGenC_bckg_18_logY()
{
...
//=========  (Thu Mar  9 15:52:22 2023) by ROOT version 6.26/06
   ...
   GenJet_all_nGenC_bckg_18->Range(-4.867058,-2.958696,22.93266,14.58089);
   ...
   GenJet_all_nGenC_bckg_18->SetLogy();
   ...
   st_stack_24->SetMinimum(0.1399761);
   st_stack_24->SetMaximum(6.713177e+12);
