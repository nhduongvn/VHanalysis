...
#endif
void GenJet_cuts_nGenJet_bckg_18_logY()
{
...
//=========  (Thu Mar  9 15:52:23 2023) by ROOT version 6.26/06
   ...
   GenJet_cuts_nGenJet_bckg_18->Range(-4.867058,-2.911603,22.93266,14.29784);
   ...
   GenJet_cuts_nGenJet_bckg_18->SetLogy();
   ...
   st_stack_78->SetMinimum(0.1424066);
   st_stack_78->SetMaximum(3.774843e+12);
