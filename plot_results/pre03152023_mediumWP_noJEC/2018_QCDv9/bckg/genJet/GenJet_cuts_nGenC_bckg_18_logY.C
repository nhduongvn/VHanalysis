...
//=========  (Thu Mar  9 15:52:23 2023) by ROOT version 6.26/06
   ...
   GenJet_cuts_nGenC_bckg_18->Range(-4.867058,-2.973967,22.93266,14.67286);
   ...
   st->SetTitle("");
   st->SetMinimum(1);
   st->SetMaximum(2.330279e+12);
   
   TH1F *st_stack_96 = new TH1F("st_stack_96","",20,-0.5,19.5);
   st_stack_96->SetMinimum(0.139204);
   st_stack_96->SetMaximum(8.09418e+12);
   ...
   GenJet_cuts_nGenC_stack_1->SetBinContent(1,1.934096e+12);
   GenJet_cuts_nGenC_stack_1->SetBinContent(2,1.056608e+11);
   GenJet_cuts_nGenC_stack_1->SetBinContent(3,5.300064e+09);
   GenJet_cuts_nGenC_stack_1->SetBinContent(4,8.825005e+07);
   GenJet_cuts_nGenC_stack_1->SetBinContent(5,2924494);
   GenJet_cuts_nGenC_stack_1->SetBinContent(6,77021.58);
   GenJet_cuts_nGenC_stack_1->SetBinContent(7,2447.689);
   GenJet_cuts_nGenC_stack_1->SetBinContent(8,101.6062);
   GenJet_cuts_nGenC_stack_1->SetBinContent(9,0.6768199);
   GenJet_cuts_nGenC_stack_1->SetBinError(1,2.341694e+08);
   GenJet_cuts_nGenC_stack_1->SetBinError(2,5.199719e+07);
   GenJet_cuts_nGenC_stack_1->SetBinError(3,1.015855e+07);
   GenJet_cuts_nGenC_stack_1->SetBinError(4,643041);
   GenJet_cuts_nGenC_stack_1->SetBinError(5,57947.82);
   GenJet_cuts_nGenC_stack_1->SetBinError(6,4620.871);
   GenJet_cuts_nGenC_stack_1->SetBinError(7,444.9715);
   GenJet_cuts_nGenC_stack_1->SetBinError(8,57.17177);
   GenJet_cuts_nGenC_stack_1->SetBinError(9,0.6768199);
   GenJet_cuts_nGenC_stack_1->SetEntries(3.050092e+08);
   ...
   GenJet_cuts_nGenC_stack_2->SetBinContent(1,3.517814e+07);
   GenJet_cuts_nGenC_stack_2->SetBinContent(2,1.604744e+07);
   GenJet_cuts_nGenC_stack_2->SetBinContent(3,2352753);
   GenJet_cuts_nGenC_stack_2->SetBinContent(4,132103.7);
   GenJet_cuts_nGenC_stack_2->SetBinContent(5,7719.854);
   GenJet_cuts_nGenC_stack_2->SetBinContent(6,397.5485);
   GenJet_cuts_nGenC_stack_2->SetBinContent(7,18.7638);
   GenJet_cuts_nGenC_stack_2->SetBinContent(8,1.320251);
   GenJet_cuts_nGenC_stack_2->SetBinContent(9,0.07295162);
   GenJet_cuts_nGenC_stack_2->SetBinError(1,1619.995);
   GenJet_cuts_nGenC_stack_2->SetBinError(2,1156.549);
   GenJet_cuts_nGenC_stack_2->SetBinError(3,465.2685);
   GenJet_cuts_nGenC_stack_2->SetBinError(4,109.817);
   GenJet_cuts_nGenC_stack_2->SetBinError(5,26.07633);
   GenJet_cuts_nGenC_stack_2->SetBinError(6,5.829179);
   GenJet_cuts_nGenC_stack_2->SetBinError(7,1.261273);
   GenJet_cuts_nGenC_stack_2->SetBinError(8,0.3825414);
   GenJet_cuts_nGenC_stack_2->SetBinError(9,0.07295162);
   GenJet_cuts_nGenC_stack_2->SetEntries(8.848938e+08);
