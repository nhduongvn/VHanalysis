...
#endif
void Aplanarity_bckg_18()
{
//=========Macro generated from canvas: Aplanarity_bckg_18/Aplanarity_bckg_18
//=========  (Fri Mar 10 11:21:20 2023) by ROOT version 6.26/06
   TCanvas *Aplanarity_bckg_18 = new TCanvas("Aplanarity_bckg_18", "Aplanarity_bckg_18",0,0,600,600);
   Aplanarity_bckg_18->SetHighLightColor(2);
   Aplanarity_bckg_18->Range(-0.2183529,-0.1538462,1.171633,1.128205);
   Aplanarity_bckg_18->SetFillColor(0);
   Aplanarity_bckg_18->SetFillStyle(4000);
   Aplanarity_bckg_18->SetBorderMode(0);
   Aplanarity_bckg_18->SetBorderSize(2);
   Aplanarity_bckg_18->SetLeftMargin(0.15709);
   Aplanarity_bckg_18->SetRightMargin(0.1234783);
   Aplanarity_bckg_18->SetBottomMargin(0.12);
   Aplanarity_bckg_18->SetFrameFillStyle(1000);
   Aplanarity_bckg_18->SetFrameBorderMode(0);
   Aplanarity_bckg_18->SetFrameFillStyle(1000);
   Aplanarity_bckg_18->SetFrameBorderMode(0);
   ...
   TH1F *st_stack_72 = new TH1F("st_stack_72","",50,0,1);
   st_stack_72->SetMinimum(0);
   st_stack_72->SetMaximum(0);
   ...
   st_stack_72->GetXaxis()->SetTitle("Aplanarity");
   ...
   st_stack_72->GetYaxis()->SetTitle("Event/0.02");
...
tex->SetNDC();
   ...
   tex->SetLineWidth(2);
   tex->Draw();
   Aplanarity_bckg_18->Modified();
   Aplanarity_bckg_18->cd();
   Aplanarity_bckg_18->SetSelected(Aplanarity_bckg_18);
}
