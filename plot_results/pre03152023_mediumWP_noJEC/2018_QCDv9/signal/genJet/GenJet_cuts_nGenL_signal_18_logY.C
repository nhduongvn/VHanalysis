...
#endif
void GenJet_cuts_nGenL_signal_18_logY()
{
...
//=========  (Thu Mar  9 15:52:23 2023) by ROOT version 6.26/06
   ...
   GenJet_cuts_nGenL_signal_18->Range(-4.867058,-0.9371811,22.93266,3.597794);
   ...
   GenJet_cuts_nGenL_signal_18->SetLogy();
   ...
   st_stack_83->SetMinimum(0.4045907);
   st_stack_83->SetMaximum(1394.108);
