...
#endif
void GenJet_cuts_nGenC_signal_18_logY()
{
...
//=========  (Thu Mar  9 15:52:23 2023) by ROOT version 6.26/06
   ...
   GenJet_cuts_nGenC_signal_18->Range(-4.867058,-0.9208016,22.93266,3.523336);
   ...
   GenJet_cuts_nGenC_signal_18->SetLogy();
   ...
   st_stack_95->SetMinimum(0.4097273);
   st_stack_95->SetMaximum(1199.286);
