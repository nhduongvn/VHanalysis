...
#endif
void GenJet_VbbHcc_nGenC_signal_18_logY()
{
...
//=========  (Thu Mar  9 15:52:25 2023) by ROOT version 6.26/06
   ...
   GenJet_VbbHcc_nGenC_signal_18->Range(-4.867058,-0.798768,22.93266,2.979668);
   ...
   GenJet_VbbHcc_nGenC_signal_18->SetLogy();
   ...
   st_stack_167->SetMinimum(0.451486);
   st_stack_167->SetMaximum(399.783);
