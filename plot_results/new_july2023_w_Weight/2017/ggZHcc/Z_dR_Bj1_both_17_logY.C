...
//=========  (Thu Aug 10 12:21:48 2023) by ROOT version 6.14/09
   ...
   Z_dR_Bj1_both_17->Range(-1.2,-4.290496,6.8,-1.223446);
   ...
   VbbHcc_both_Z_dR_Bj1_stack_12->GetXaxis()->SetTitle("#DeltaR(Z,j_{2})");
   VbbHcc_both_Z_dR_Bj1_stack_12->GetXaxis()->SetRange(1,30);
   ...
   VbbHcc_both_Z_dR_Bj1_stack_12->Draw("HIST");
