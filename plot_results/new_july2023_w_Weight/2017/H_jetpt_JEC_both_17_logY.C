...
// ------------>Primitives in pad: topPad
   ...
   topPad->Draw();
   topPad->cd();
   topPad->Range(-45.96762,-2.887089,315.7258,13.00974);
   ...
   st->SetTitle("");
   st->SetMinimum(0.01);
   st->SetMaximum(7.361673e+10);
   
   TH1F *st_stack_262 = new TH1F("st_stack_262","",150,0,300);
   st_stack_262->SetMinimum(0.001345263);
   st_stack_262->SetMaximum(2.630617e+11);
   ...
   VbbHcc_both_H_jetpt_JEC__719->SetBinContent(0,34570);
   VbbHcc_both_H_jetpt_JEC__719->SetBinContent(1,119);
   VbbHcc_both_H_jetpt_JEC__719->SetBinContent(2,22420);
   VbbHcc_both_H_jetpt_JEC__719->SetBinContent(3,10575);
   VbbHcc_both_H_jetpt_JEC__719->SetEntries(67833);
   ...
   Graph_Graph_from_VbbHcc_both_H_jetpt_JEC1523->SetMinimum(89.82348);
   Graph_Graph_from_VbbHcc_both_H_jetpt_JEC1523->SetMaximum(89823.48);
...
// ------------>Primitives in pad: bottomPad
   ...
   data_mc_ratio__720->SetBinContent(0,0.3038125);
   data_mc_ratio__720->SetBinContent(1,0.7761155);
   data_mc_ratio__720->SetBinContent(2,0.2887328);
   data_mc_ratio__720->SetBinContent(3,0.3097911);
   data_mc_ratio__720->SetBinError(0,0.01144167);
   data_mc_ratio__720->SetBinError(1,0.07114639);
   data_mc_ratio__720->SetBinError(2,0.001928317);
   data_mc_ratio__720->SetBinError(3,0.003012512);
   data_mc_ratio__720->SetMinimum(0.4);
   data_mc_ratio__720->SetMaximum(1.6);
   data_mc_ratio__720->SetEntries(37.42924);
   ...
   Graph_Graph_from_mc_statistical_error1524->SetMinimum(0.6726769);
   Graph_Graph_from_mc_statistical_error1524->SetMaximum(1.327323);
