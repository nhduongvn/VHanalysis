...
//=========  (Thu Aug 10 12:21:01 2023) by ROOT version 6.14/09
   ...
   Z_dR_Bj0_algo_18->Range(-1.2,-4.219344,6.8,-0.269964);
   ...
   VbbHcc_algo_Z_dR_Bj0_stack_12->GetXaxis()->SetTitle("#DeltaR(Z,j_{1})");
   VbbHcc_algo_Z_dR_Bj0_stack_12->GetXaxis()->SetRange(1,30);
   ...
   VbbHcc_algo_Z_dR_Bj0_stack_12->Draw("HIST");
