...
//=========  (Thu Aug 10 12:23:26 2023) by ROOT version 6.14/09
   ...
   H_dR_Bj0_tags_18->Range(-1.2,-0.0593306,6.8,0.5339754);
   ...
   VbbHcc_tags_H_dR_Bj0_stack_6->GetXaxis()->SetTitle("#DeltaR(H,j_{1})");
   VbbHcc_tags_H_dR_Bj0_stack_6->GetXaxis()->SetRange(1,30);
   ...
   VbbHcc_tags_H_dR_Bj0_stack_6->Draw("HIST");
