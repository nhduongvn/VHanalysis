...
// ------------>Primitives in pad: topPad
   ...
   topPad->Draw();
   topPad->cd();
   topPad->Range(-0.1532254,-150.5198,1.052419,150379.3);
   ...
   Graph_Graph_from_VbbHcc_both_Sphericity1501->SetMinimum(-4869.543);
