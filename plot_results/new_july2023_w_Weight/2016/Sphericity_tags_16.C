...
// ------------>Primitives in pad: topPad
   ...
   topPad->Draw();
   topPad->cd();
   topPad->Range(-0.1532254,-191.7332,1.052419,191551.4);
   ...
   Graph_Graph_from_VbbHcc_tags_Sphericity1113->SetMinimum(-7915.066);
