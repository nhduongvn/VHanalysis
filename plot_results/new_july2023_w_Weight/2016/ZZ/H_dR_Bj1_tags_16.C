...
//=========  (Thu Aug 10 12:23:26 2023) by ROOT version 6.14/09
   ...
   H_dR_Bj1_tags_16->Range(-1.2,-0.9257073,6.8,8.331365);
   ...
   VbbHcc_tags_H_dR_Bj1_stack_8->GetXaxis()->SetTitle("#DeltaR(H,j_{2})");
   VbbHcc_tags_H_dR_Bj1_stack_8->GetXaxis()->SetRange(1,30);
   ...
   VbbHcc_tags_H_dR_Bj1_stack_8->Draw("HIST");
