...
//=========  (Thu Aug 10 12:23:25 2023) by ROOT version 6.14/09
   ...
   H_dR_Bj0_tags_16->Range(-1.2,-0.8937863,6.8,8.044077);
   ...
   VbbHcc_tags_H_dR_Bj0_stack_8->GetXaxis()->SetTitle("#DeltaR(H,j_{1})");
   VbbHcc_tags_H_dR_Bj0_stack_8->GetXaxis()->SetRange(1,30);
   ...
   VbbHcc_tags_H_dR_Bj0_stack_8->Draw("HIST");
