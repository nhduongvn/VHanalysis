...
// ------------>Primitives in pad: topPad
   ...
   topPad->Draw();
   topPad->cd();
   topPad->Range(-0.1532254,-101.9883,1.052419,101896.3);
   ...
   Graph_Graph_from_VbbHcc_both_Sphericity1497->SetMinimum(-4318.612);
