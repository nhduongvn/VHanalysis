...
if __name__ == "__main__":
    ...
    jmeCorrections = createJMECorrector(isMC=False, dataYear="2018", runPeriod="D", jesUncert="All",applyHEMfix=False,splitJER=True)
    jmeCorrections_ak8 = createJMECorrector(isMC=False, dataYear="2018", runPeriod="D", jetType="AK8PFPuppi", jesUncert="All",applyHEMfix=False,splitJER=True)
    modules.append(jmeCorrections())
    modules.append(jmeCorrections_ak8())
