...
// Fri Jan  8 12:53:40 2021 by ROOT version 6.14/09
// from TTree Events/Events
// found on file: Tmp/88BECE13-2927-5A49-ADB3-AC014320A584_Skim.root
//////////////////////////////////////////////////////////
...
public :
   ...
   TTreeReaderValue<Float_t> MET_T1_phi = {fReader, "MET_T1_phi"};
   TTreeReaderValue<Float_t> MET_T1Smear_pt = {fReader, "MET_T1Smear_pt"};
   TTreeReaderValue<Float_t> MET_T1Smear_phi = {fReader, "MET_T1Smear_phi"};
   ...
   TTreeReaderValue<Float_t> MET_T1_phi_jerUp = {fReader, "MET_T1_phi_jerUp"};
   TTreeReaderValue<Float_t> MET_T1Smear_pt_jerUp = {fReader, "MET_T1Smear_pt_jerUp"};
   TTreeReaderValue<Float_t> MET_T1Smear_phi_jerUp = {fReader, "MET_T1Smear_phi_jerUp"};
   ...
   TTreeReaderValue<Float_t> MET_T1_phi_jesTotalUp = {fReader, "MET_T1_phi_jesTotalUp"};
   TTreeReaderValue<Float_t> MET_T1Smear_pt_jesTotalUp = {fReader, "MET_T1Smear_pt_jesTotalUp"};
   TTreeReaderValue<Float_t> MET_T1Smear_phi_jesTotalUp = {fReader, "MET_T1Smear_phi_jesTotalUp"};
   TTreeReaderArray<Float_t> Jet_pt_jesHEMIssueUp = {fReader, "Jet_pt_jesHEMIssueUp"};
   TTreeReaderArray<Float_t> Jet_mass_jesHEMIssueUp = {fReader, "Jet_mass_jesHEMIssueUp"};
   TTreeReaderValue<Float_t> MET_T1_pt_jesHEMIssueUp = {fReader, "MET_T1_pt_jesHEMIssueUp"};
   TTreeReaderValue<Float_t> MET_T1_phi_jesHEMIssueUp = {fReader, "MET_T1_phi_jesHEMIssueUp"};
   TTreeReaderValue<Float_t> MET_T1Smear_pt_jesHEMIssueUp = {fReader, "MET_T1Smear_pt_jesHEMIssueUp"};
   TTreeReaderValue<Float_t> MET_T1Smear_phi_jesHEMIssueUp = {fReader, "MET_T1Smear_phi_jesHEMIssueUp"};
   ...
   TTreeReaderValue<Float_t> MET_T1_phi_jerDown = {fReader, "MET_T1_phi_jerDown"};
   TTreeReaderValue<Float_t> MET_T1Smear_pt_jerDown = {fReader, "MET_T1Smear_pt_jerDown"};
   TTreeReaderValue<Float_t> MET_T1Smear_phi_jerDown = {fReader, "MET_T1Smear_phi_jerDown"};
   ...
   TTreeReaderValue<Float_t> MET_T1_phi_jesTotalDown = {fReader, "MET_T1_phi_jesTotalDown"};
   TTreeReaderValue<Float_t> MET_T1Smear_pt_jesTotalDown = {fReader, "MET_T1Smear_pt_jesTotalDown"};
   TTreeReaderValue<Float_t> MET_T1Smear_phi_jesTotalDown = {fReader, "MET_T1Smear_phi_jesTotalDown"};
   TTreeReaderArray<Float_t> Jet_pt_jesHEMIssueDown = {fReader, "Jet_pt_jesHEMIssueDown"};
   TTreeReaderArray<Float_t> Jet_mass_jesHEMIssueDown = {fReader, "Jet_mass_jesHEMIssueDown"};
   TTreeReaderValue<Float_t> MET_T1_pt_jesHEMIssueDown = {fReader, "MET_T1_pt_jesHEMIssueDown"};
   TTreeReaderValue<Float_t> MET_T1_phi_jesHEMIssueDown = {fReader, "MET_T1_phi_jesHEMIssueDown"};
   TTreeReaderValue<Float_t> MET_T1Smear_pt_jesHEMIssueDown = {fReader, "MET_T1Smear_pt_jesHEMIssueDown"};
   TTreeReaderValue<Float_t> MET_T1Smear_phi_jesHEMIssueDown = {fReader, "MET_T1Smear_phi_jesHEMIssueDown"};
