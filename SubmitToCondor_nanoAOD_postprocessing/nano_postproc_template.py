...
if __name__ == "__main__":
    ...
    #jmeCorrections = createJMECorrector(True, "2016", "B", "Total")
    jmeCorrections_ak4 = createJMECorrector(JMECORRECTOROPTIONAK4)
    jmeCorrections_ak8 = createJMECorrector(JMECORRECTOROPTIONAK8)
    modules.append(jmeCorrections_ak4())
