...
if __name__ == "__main__":
    ...
    jmeCorrections = createJMECorrector(isMC=True, dataYear="2018", runPeriod="D",jesUncert="All",applyHEMfix=True,splitJER=True)
    jmeCorrections_ak8 = createJMECorrector(isMC=True, dataYear="2018", runPeriod="D",jetType="AK8PFPuppi",jesUncert="All",applyHEMfix=True,splitJER=True)
