...
//=========  (Fri Mar 10 11:21:20 2023) by ROOT version 6.26/06
   ...
   Z_pt_signal_18->Range(37.97653,-18.51028,1705.96,135.742);
   ...
   st_stack_65->GetYaxis()->SetTitle("Event/50.0 GeV");
