...
#endif
void GenJet_VbbHcc_nGenJet_signal_18_logY()
{
...
//=========  (Thu Mar  9 15:52:24 2023) by ROOT version 6.26/06
   ...
   GenJet_VbbHcc_nGenJet_signal_18->Range(-4.867058,-0.6491956,22.93266,2.341548);
   ...
   GenJet_VbbHcc_nGenJet_signal_18->SetLogy();
   ...
   st_stack_149->SetMinimum(0.5124997);
   st_stack_149->SetMaximum(110.2742);
