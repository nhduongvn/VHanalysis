...
//=========  (Thu Mar  9 13:30:10 2023) by ROOT version 6.26/06
   ...
   CvB_jets_signal_18->Range(-0.2183529,0.3373627,1.171633,3.397556);
   ...
   st_stack_23->SetMinimum(5.065075);
   st_stack_23->SetMaximum(1234.629);
