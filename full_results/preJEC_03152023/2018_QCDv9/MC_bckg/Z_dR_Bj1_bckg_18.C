...
#endif
void Z_dR_Bj1_bckg_18()
{
//=========Macro generated from canvas: Z_dR_Bj1_bckg_18/Z_dR_Bj1_bckg_18
//=========  (Fri Mar 10 11:21:20 2023) by ROOT version 6.26/06
   TCanvas *Z_dR_Bj1_bckg_18 = new TCanvas("Z_dR_Bj1_bckg_18", "Z_dR_Bj1_bckg_18",0,0,600,600);
   Z_dR_Bj1_bckg_18->SetHighLightColor(2);
   Z_dR_Bj1_bckg_18->Range(-1.310117,-0.1538462,7.029799,1.128205);
   Z_dR_Bj1_bckg_18->SetFillColor(0);
   Z_dR_Bj1_bckg_18->SetFillStyle(4000);
   Z_dR_Bj1_bckg_18->SetBorderMode(0);
   Z_dR_Bj1_bckg_18->SetBorderSize(2);
   Z_dR_Bj1_bckg_18->SetLeftMargin(0.15709);
   Z_dR_Bj1_bckg_18->SetRightMargin(0.1234783);
   Z_dR_Bj1_bckg_18->SetBottomMargin(0.12);
   Z_dR_Bj1_bckg_18->SetFrameFillStyle(1000);
   Z_dR_Bj1_bckg_18->SetFrameBorderMode(0);
   Z_dR_Bj1_bckg_18->SetFrameFillStyle(1000);
   Z_dR_Bj1_bckg_18->SetFrameBorderMode(0);
   ...
   st_stack_48->GetXaxis()->SetTitle("#DeltaR(Z,j_{2})");
...
tex->SetNDC();
   ...
   tex->SetLineWidth(2);
   tex->Draw();
   Z_dR_Bj1_bckg_18->Modified();
   Z_dR_Bj1_bckg_18->cd();
   Z_dR_Bj1_bckg_18->SetSelected(Z_dR_Bj1_bckg_18);
}
