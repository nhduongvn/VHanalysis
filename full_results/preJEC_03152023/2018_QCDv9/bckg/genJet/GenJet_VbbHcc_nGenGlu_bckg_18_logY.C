...
#endif
void GenJet_VbbHcc_nGenGlu_bckg_18_logY()
{
...
//=========  (Thu Mar  9 15:52:25 2023) by ROOT version 6.26/06
   ...
   GenJet_VbbHcc_nGenGlu_bckg_18->Range(-4.867058,-nan,22.93266,-nan);
   ...
   GenJet_VbbHcc_nGenGlu_bckg_18->SetLogy();
