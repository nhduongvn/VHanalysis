...
#endif
void Aplanarity_bckg_17()
{
//=========Macro generated from canvas: Aplanarity_bckg_17/Aplanarity_bckg_17
//=========  (Fri Mar 10 11:21:20 2023) by ROOT version 6.26/06
   TCanvas *Aplanarity_bckg_17 = new TCanvas("Aplanarity_bckg_17", "Aplanarity_bckg_17",0,0,600,600);
   Aplanarity_bckg_17->SetHighLightColor(2);
   Aplanarity_bckg_17->Range(-0.2183529,-0.1538462,1.171633,1.128205);
   Aplanarity_bckg_17->SetFillColor(0);
   Aplanarity_bckg_17->SetFillStyle(4000);
   Aplanarity_bckg_17->SetBorderMode(0);
   Aplanarity_bckg_17->SetBorderSize(2);
   Aplanarity_bckg_17->SetLeftMargin(0.15709);
   Aplanarity_bckg_17->SetRightMargin(0.1234783);
   Aplanarity_bckg_17->SetBottomMargin(0.12);
   Aplanarity_bckg_17->SetFrameFillStyle(1000);
   Aplanarity_bckg_17->SetFrameBorderMode(0);
   Aplanarity_bckg_17->SetFrameFillStyle(1000);
   Aplanarity_bckg_17->SetFrameBorderMode(0);
   ...
   TH1F *st_stack_70 = new TH1F("st_stack_70","",50,0,1);
   st_stack_70->SetMinimum(0);
   st_stack_70->SetMaximum(0);
   ...
   st_stack_70->GetXaxis()->SetTitle("Aplanarity");
   ...
   st_stack_70->GetYaxis()->SetTitle("Event/0.02");
...
tex->SetNDC();
   ...
   tex->SetLineWidth(2);
   tex->Draw();
   Aplanarity_bckg_17->Modified();
   Aplanarity_bckg_17->cd();
   Aplanarity_bckg_17->SetSelected(Aplanarity_bckg_17);
}
