...
//=========  (Thu Mar  9 13:30:10 2023) by ROOT version 6.26/06
   ...
   CvB_jets_signal_16->Range(-0.2183529,0.4234122,1.171633,3.043781);
   ...
   st_stack_19->SetMinimum(5.468352);
   st_stack_19->SetMaximum(604.9846);
