...
#endif
void GenJet_cuts_nGenB_signal_16_logY()
{
...
//=========  (Thu Mar  9 15:52:23 2023) by ROOT version 6.26/06
   ...
   GenJet_cuts_nGenB_signal_16->Range(-4.867058,-0.9230622,22.93266,3.533592);
   ...
   GenJet_cuts_nGenB_signal_16->SetLogy();
   ...
   st_stack_85->SetMinimum(0.4090122);
   st_stack_85->SetMaximum(1224.41);
