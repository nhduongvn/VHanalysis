...
//=========  (Tue Feb 14 16:02:04 2023) by ROOT version 6.26/06
   ...
   H_dR_alljet_17->Range(-1.353788,1.163434,7.264125,15.06701);
   ...
   st->SetName("st");
   st->SetTitle("");
   st->SetMinimum(3943.222);
   st->SetMaximum(1.624886e+13);
   
   TH1F *st_stack_214 = new TH1F("st_stack_214","",30,0,6);
   st_stack_214->SetMinimum(678.9896);
   st_stack_214->SetMaximum(4.749532e+13);
