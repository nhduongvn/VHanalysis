...
//=========  (Tue Feb 14 16:02:02 2023) by ROOT version 6.26/06
   ...
   Z_dR_Bj0_algo_17->Range(-1.310117,-0.9408181,7.029799,9.693505);
   ...
   st->SetTitle("");
   st->SetMinimum(10);
   st->SetMaximum(1.742683e+08);
   
   TH1F *st_stack_114 = new TH1F("st_stack_114","",30,0,6);
   st_stack_114->SetMinimum(2.164217);
   st_stack_114->SetMaximum(4.266513e+08);
