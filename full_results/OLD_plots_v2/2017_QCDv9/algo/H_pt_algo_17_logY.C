...
//=========  (Tue Dec  6 14:34:32 2022) by ROOT version 6.26/06
   ...
   H_pt_algo_17->Range(37.97653,-3.255896,1705.96,9.92251);
   ...
   st->SetName("st");
   st->SetTitle("");
   st->SetMinimum(0.1172851);
   st->SetMaximum(1.428444e+08);
   
   TH1F *st_stack_62 = new TH1F("st_stack_62","",40,0,2000);
   st_stack_62->SetMinimum(0.02115986);
   st_stack_62->SetMaximum(4.024104e+08);
