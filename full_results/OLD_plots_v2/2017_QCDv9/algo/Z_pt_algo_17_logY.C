...
//=========  (Tue Dec  6 14:34:32 2022) by ROOT version 6.26/06
   ...
   Z_pt_algo_17->Range(37.97653,-3.332891,1705.96,10.03122);
   ...
   st->SetName("st");
   st->SetTitle("");
   st->SetMinimum(0.1046659);
   st->SetMaximum(1.741196e+08);
   
   TH1F *st_stack_58 = new TH1F("st_stack_58","",40,0,2000);
   st_stack_58->SetMinimum(0.0186553);
   st_stack_58->SetMaximum(4.952325e+08);
