...
//=========  (Fri Dec  9 13:00:01 2022) by ROOT version 6.26/06
   ...
   CutFlow_both_17->Range(-1.091764,5.143176,5.858166,14.0425);
   ...
   st->SetName("st");
   st->SetTitle("");
   st->SetMinimum(6501383);
   st->SetMaximum(6.460363e+12);
   
   TH1F *st_stack_90 = new TH1F("st_stack_90","",4,0,4);
   st_stack_90->SetMinimum(1625904);
   st_stack_90->SetMaximum(1.420925e+13);
   ...
   VbbHcc_both_CutFlow_stack_12->SetBinContent(1,102.9919);
   VbbHcc_both_CutFlow_stack_12->SetBinContent(2,102.748);
   VbbHcc_both_CutFlow_stack_12->SetBinContent(3,66.10757);
   VbbHcc_both_CutFlow_stack_12->SetBinContent(4,3.331949);
   VbbHcc_both_CutFlow_stack_12->SetBinError(1,0.1507917);
   VbbHcc_both_CutFlow_stack_12->SetBinError(2,0.150613);
   VbbHcc_both_CutFlow_stack_12->SetBinError(3,0.1208096);
   VbbHcc_both_CutFlow_stack_12->SetBinError(4,0.0271222);
