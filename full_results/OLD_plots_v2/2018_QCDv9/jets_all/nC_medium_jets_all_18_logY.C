...
//=========  (Mon Dec 12 10:47:57 2022) by ROOT version 6.26/06
   ...
   nC_medium_jets_all_18->Range(-2.683529,2.050099,11.21633,14.31685);
   ...
   st->SetName("st");
   st->SetTitle("");
   st->SetMinimum(17339.7);
   st->SetMaximum(4.584755e+12);
   
   TH1F *st_stack_67 = new TH1F("st_stack_67","",10,-0.5,9.5);
   st_stack_67->SetMinimum(3327.431);
   st_stack_67->SetMaximum(1.230757e+13);
