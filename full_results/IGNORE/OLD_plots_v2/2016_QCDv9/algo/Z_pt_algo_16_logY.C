...
//=========  (Tue Dec  6 14:34:32 2022) by ROOT version 6.26/06
   ...
   Z_pt_algo_16->Range(37.97653,-3.275692,1705.96,9.794194);
   ...
   st->SetName("st");
   st->SetTitle("");
   st->SetMinimum(0.107973);
   st->SetMaximum(1.096087e+08);
   
   TH1F *st_stack_57 = new TH1F("st_stack_57","",40,0,2000);
   st_stack_57->SetMinimum(0.01961981);
   st_stack_57->SetMaximum(3.070476e+08);
