...
//=========  (Tue Dec  6 14:34:32 2022) by ROOT version 6.26/06
   ...
   H_pt_algo_18->Range(37.97653,-3.202874,1705.96,10.04356);
   ...
   st->SetName("st");
   st->SetTitle("");
   st->SetMinimum(0.1356336);
   st->SetMaximum(1.851766e+08);
   
   TH1F *st_stack_63 = new TH1F("st_stack_63","",40,0,2000);
   st_stack_63->SetMinimum(0.0243612);
   st_stack_63->SetMaximum(5.235022e+08);
   ...
   VbbHcc_algo_H_pt_stack_12->SetBinContent(4,4794.893);
   ...
   VbbHcc_algo_H_pt_stack_12->SetBinError(4,182.2329);
