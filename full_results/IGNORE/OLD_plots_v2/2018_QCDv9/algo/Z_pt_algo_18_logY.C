...
//=========  (Tue Dec  6 14:34:32 2022) by ROOT version 6.26/06
   ...
   Z_pt_algo_18->Range(37.97653,-3.357005,1705.96,10.17981);
   ...
   st->SetName("st");
   st->SetTitle("");
   st->SetMinimum(0.1050185);
   st->SetMaximum(2.335239e+08);
   
   TH1F *st_stack_59 = new TH1F("st_stack_59","",40,0,2000);
   st_stack_59->SetMinimum(0.01851025);
   st_stack_59->SetMaximum(6.700764e+08);
