...
// ------------>Primitives in pad: topPad
   ...
   VbbHcc_algo_CutFlow_stack_1->SetBinContent(2,9.278075e+10);
   VbbHcc_algo_CutFlow_stack_1->SetBinContent(3,9.096041e+09);
   VbbHcc_algo_CutFlow_stack_1->SetBinContent(4,6.983375e+07);
   VbbHcc_algo_CutFlow_stack_1->SetBinContent(5,3579363);
   VbbHcc_algo_CutFlow_stack_1->SetBinError(1,1.182801e+07);
   VbbHcc_algo_CutFlow_stack_1->SetBinError(2,1.182746e+07);
   VbbHcc_algo_CutFlow_stack_1->SetBinError(3,3703298);
   VbbHcc_algo_CutFlow_stack_1->SetBinError(4,324485.4);
   VbbHcc_algo_CutFlow_stack_1->SetBinError(5,73462.44);
   VbbHcc_algo_CutFlow_stack_1->SetEntries(1.291603e+08);
   ...
   VbbHcc_algo_CutFlow_stack_2->SetBinContent(2,1.687543e+07);
   VbbHcc_algo_CutFlow_stack_2->SetBinContent(3,3908194);
   VbbHcc_algo_CutFlow_stack_2->SetBinContent(4,221496);
   VbbHcc_algo_CutFlow_stack_2->SetBinContent(5,20634.03);
   VbbHcc_algo_CutFlow_stack_2->SetBinError(1,1373.002);
   VbbHcc_algo_CutFlow_stack_2->SetBinError(2,1349.898);
   VbbHcc_algo_CutFlow_stack_2->SetBinError(3,768.8912);
   VbbHcc_algo_CutFlow_stack_2->SetBinError(4,168.4031);
   VbbHcc_algo_CutFlow_stack_2->SetBinError(5,51.94016);
   VbbHcc_algo_CutFlow_stack_2->SetEntries(6.166762e+08);
   ...
   VbbHcc_algo_CutFlow_stack_3->SetBinContent(2,4.710352e+07);
   VbbHcc_algo_CutFlow_stack_3->SetBinContent(3,2.905504e+07);
   VbbHcc_algo_CutFlow_stack_3->SetBinContent(4,1949124);
   VbbHcc_algo_CutFlow_stack_3->SetBinContent(5,176962.9);
   VbbHcc_algo_CutFlow_stack_3->SetBinError(1,1671.907);
   VbbHcc_algo_CutFlow_stack_3->SetBinError(2,1636.591);
   VbbHcc_algo_CutFlow_stack_3->SetBinError(3,1327.347);
   VbbHcc_algo_CutFlow_stack_3->SetBinError(4,337.4507);
   VbbHcc_algo_CutFlow_stack_3->SetBinError(5,102.4106);
   VbbHcc_algo_CutFlow_stack_3->SetEntries(2.367012e+09);
   ...
   VbbHcc_algo_CutFlow_stack_4->SetBinContent(2,6808645);
   VbbHcc_algo_CutFlow_stack_4->SetBinContent(3,3445178);
   VbbHcc_algo_CutFlow_stack_4->SetBinContent(4,97951.16);
   VbbHcc_algo_CutFlow_stack_4->SetBinContent(5,6362.442);
   VbbHcc_algo_CutFlow_stack_4->SetBinError(1,1826.965);
   VbbHcc_algo_CutFlow_stack_4->SetBinError(2,1825.593);
   VbbHcc_algo_CutFlow_stack_4->SetBinError(3,1298.612);
   VbbHcc_algo_CutFlow_stack_4->SetBinError(4,218.9669);
   VbbHcc_algo_CutFlow_stack_4->SetBinError(5,55.8066);
   VbbHcc_algo_CutFlow_stack_4->SetEntries(3.509138e+07);
   ...
   VbbHcc_algo_CutFlow_stack_5->SetBinContent(2,1.648927e+07);
   VbbHcc_algo_CutFlow_stack_5->SetBinContent(3,8186633);
   VbbHcc_algo_CutFlow_stack_5->SetBinContent(4,30687.74);
   VbbHcc_algo_CutFlow_stack_5->SetBinContent(5,2843.827);
   VbbHcc_algo_CutFlow_stack_5->SetBinError(1,5984.41);
   VbbHcc_algo_CutFlow_stack_5->SetBinError(2,5980.685);
   VbbHcc_algo_CutFlow_stack_5->SetBinError(3,4214.081);
   VbbHcc_algo_CutFlow_stack_5->SetBinError(4,258.0077);
   VbbHcc_algo_CutFlow_stack_5->SetBinError(5,78.54199);
   VbbHcc_algo_CutFlow_stack_5->SetEntries(1.900201e+07);
   ...
   VbbHcc_algo_CutFlow_stack_6->SetBinContent(2,4458452);
   VbbHcc_algo_CutFlow_stack_6->SetBinContent(3,348710.5);
   VbbHcc_algo_CutFlow_stack_6->SetBinContent(4,1045.793);
   VbbHcc_algo_CutFlow_stack_6->SetBinContent(5,95.19186);
   VbbHcc_algo_CutFlow_stack_6->SetBinError(1,1221.787);
   VbbHcc_algo_CutFlow_stack_6->SetBinError(2,1211.834);
   VbbHcc_algo_CutFlow_stack_6->SetBinError(3,338.9093);
   VbbHcc_algo_CutFlow_stack_6->SetBinError(4,18.55982);
   VbbHcc_algo_CutFlow_stack_6->SetBinError(5,5.599521);
   VbbHcc_algo_CutFlow_stack_6->SetEntries(2.835688e+07);
   ...
   VbbHcc_algo_CutFlow_stack_7->SetBinContent(2,1607420);
   VbbHcc_algo_CutFlow_stack_7->SetBinContent(3,146933.3);
   VbbHcc_algo_CutFlow_stack_7->SetBinContent(4,3818.407);
   VbbHcc_algo_CutFlow_stack_7->SetBinContent(5,343.5467);
   VbbHcc_algo_CutFlow_stack_7->SetBinError(1,584.2162);
   VbbHcc_algo_CutFlow_stack_7->SetBinError(2,577.2932);
   VbbHcc_algo_CutFlow_stack_7->SetBinError(3,174.5387);
   VbbHcc_algo_CutFlow_stack_7->SetBinError(4,28.13668);
   VbbHcc_algo_CutFlow_stack_7->SetBinError(5,8.439653);
   VbbHcc_algo_CutFlow_stack_7->SetEntries(1.64217e+07);
   ...
   VbbHcc_algo_CutFlow_stack_8->SetBinContent(2,707562.1);
   VbbHcc_algo_CutFlow_stack_8->SetBinContent(3,71613.34);
   VbbHcc_algo_CutFlow_stack_8->SetBinContent(4,3780.707);
   VbbHcc_algo_CutFlow_stack_8->SetBinContent(5,347.8787);
   VbbHcc_algo_CutFlow_stack_8->SetBinError(1,386.9871);
   VbbHcc_algo_CutFlow_stack_8->SetBinError(2,381.8651);
   VbbHcc_algo_CutFlow_stack_8->SetBinError(3,121.4855);
   VbbHcc_algo_CutFlow_stack_8->SetBinError(4,27.91349);
   VbbHcc_algo_CutFlow_stack_8->SetBinError(5,8.467234);
   VbbHcc_algo_CutFlow_stack_8->SetEntries(7326800);
   ...
   VbbHcc_algo_CutFlow_stack_11->SetBinContent(5,3.257438);
   ...
   VbbHcc_algo_CutFlow_stack_11->SetBinError(5,0.08871701);
   VbbHcc_algo_CutFlow_stack_11->SetEntries(1148881);
   ...
   VbbHcc_algo_CutFlow_stack_12->SetBinContent(5,18450.48);
   ...
   VbbHcc_algo_CutFlow_stack_12->SetBinError(5,341.6171);
   VbbHcc_algo_CutFlow_stack_12->SetEntries(1339773);
   ...
   TH1D *VbbHcc_algo_CutFlow__69 = new TH1D("VbbHcc_algo_CutFlow__69","",5,0,5);
   VbbHcc_algo_CutFlow__69->SetBinContent(1,6.348219e+08);
   VbbHcc_algo_CutFlow__69->SetBinContent(2,6.199315e+08);
   VbbHcc_algo_CutFlow__69->SetBinContent(3,2.514592e+08);
   VbbHcc_algo_CutFlow__69->SetBinContent(4,8880131);
   VbbHcc_algo_CutFlow__69->SetBinContent(5,835761);
   VbbHcc_algo_CutFlow__69->SetEntries(1.515929e+09);

   ci = TColor::GetColor("#000099");
   VbbHcc_algo_CutFlow__69->SetLineColor(ci);
   VbbHcc_algo_CutFlow__69->SetLineWidth(2);
   VbbHcc_algo_CutFlow__69->SetMarkerStyle(20);
   VbbHcc_algo_CutFlow__69->SetMarkerSize(1.2);
   VbbHcc_algo_CutFlow__69->GetXaxis()->SetBinLabel(1,"Total");
   VbbHcc_algo_CutFlow__69->GetXaxis()->SetBinLabel(2,"MET cut");
   VbbHcc_algo_CutFlow__69->GetXaxis()->SetBinLabel(3,"jet cuts");
   VbbHcc_algo_CutFlow__69->GetXaxis()->SetBinLabel(4,"b-tags");
   VbbHcc_algo_CutFlow__69->GetXaxis()->SetBinLabel(5,"c-tags");
   VbbHcc_algo_CutFlow__69->GetXaxis()->SetRange(1,5);
   VbbHcc_algo_CutFlow__69->GetXaxis()->SetLabelFont(42);
   VbbHcc_algo_CutFlow__69->GetXaxis()->SetLabelSize(0.035);
   VbbHcc_algo_CutFlow__69->GetXaxis()->SetTitleSize(0.035);
   VbbHcc_algo_CutFlow__69->GetXaxis()->SetTitleFont(42);
   VbbHcc_algo_CutFlow__69->GetYaxis()->SetLabelFont(42);
   VbbHcc_algo_CutFlow__69->GetYaxis()->SetLabelSize(0.035);
   VbbHcc_algo_CutFlow__69->GetYaxis()->SetTitleSize(0.035);
   VbbHcc_algo_CutFlow__69->GetYaxis()->SetTitleOffset(0);
   VbbHcc_algo_CutFlow__69->GetYaxis()->SetTitleFont(42);
   VbbHcc_algo_CutFlow__69->GetZaxis()->SetLabelFont(42);
   VbbHcc_algo_CutFlow__69->GetZaxis()->SetLabelSize(0.035);
   VbbHcc_algo_CutFlow__69->GetZaxis()->SetTitleSize(0.035);
   VbbHcc_algo_CutFlow__69->GetZaxis()->SetTitleFont(42);
   VbbHcc_algo_CutFlow__69->Draw("same E");
   
   Double_t Graph_from_VbbHcc_algo_CutFlow_fx1069[5] = {
   0.5,
   1.5,
   2.5,
   3.5,
   4.5};
   Double_t Graph_from_VbbHcc_algo_CutFlow_fy1069[5] = {
   9.288964e+10,
   9.287797e+10,
   9.143271e+09,
   7.224409e+07,
   3805520};
   Double_t Graph_from_VbbHcc_algo_CutFlow_fex1069[5] = {
   0.5,
   0.5,
   0.5,
   0.5,
   0.5};
   Double_t Graph_from_VbbHcc_algo_CutFlow_fey1069[5] = {
   1.182801e+07,
   1.182746e+07,
   3703303,
   324486.8,
   73463.38};
   TGraphErrors *gre = new TGraphErrors(5,Graph_from_VbbHcc_algo_CutFlow_fx1069,Graph_from_VbbHcc_algo_CutFlow_fy1069,Graph_from_VbbHcc_algo_CutFlow_fex1069,Graph_from_VbbHcc_algo_CutFlow_fey1069);
   gre->SetName("Graph_from_VbbHcc_algo_CutFlow");
   gre->SetTitle("");
   ...
   TH1F *Graph_Graph_from_VbbHcc_algo_CutFlow1069 = new TH1F("Graph_Graph_from_VbbHcc_algo_CutFlow1069","",100,0,5.5);
   Graph_Graph_from_VbbHcc_algo_CutFlow1069->SetMinimum(3358851);
   Graph_Graph_from_VbbHcc_algo_CutFlow1069->SetMaximum(1.021912e+11);
   Graph_Graph_from_VbbHcc_algo_CutFlow1069->SetDirectory(0);
   Graph_Graph_from_VbbHcc_algo_CutFlow1069->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph_from_VbbHcc_algo_CutFlow1069->SetLineColor(ci);
   Graph_Graph_from_VbbHcc_algo_CutFlow1069->GetXaxis()->SetLabelFont(42);
   Graph_Graph_from_VbbHcc_algo_CutFlow1069->GetXaxis()->SetLabelSize(0.035);
   Graph_Graph_from_VbbHcc_algo_CutFlow1069->GetXaxis()->SetTitleSize(0.035);
   Graph_Graph_from_VbbHcc_algo_CutFlow1069->GetXaxis()->SetTitleFont(42);
   Graph_Graph_from_VbbHcc_algo_CutFlow1069->GetYaxis()->SetLabelFont(42);
   Graph_Graph_from_VbbHcc_algo_CutFlow1069->GetYaxis()->SetLabelSize(0.035);
   Graph_Graph_from_VbbHcc_algo_CutFlow1069->GetYaxis()->SetTitleSize(0.035);
   Graph_Graph_from_VbbHcc_algo_CutFlow1069->GetYaxis()->SetTitleOffset(0);
   Graph_Graph_from_VbbHcc_algo_CutFlow1069->GetYaxis()->SetTitleFont(42);
   Graph_Graph_from_VbbHcc_algo_CutFlow1069->GetZaxis()->SetLabelFont(42);
   Graph_Graph_from_VbbHcc_algo_CutFlow1069->GetZaxis()->SetLabelSize(0.035);
   Graph_Graph_from_VbbHcc_algo_CutFlow1069->GetZaxis()->SetTitleSize(0.035);
   Graph_Graph_from_VbbHcc_algo_CutFlow1069->GetZaxis()->SetTitleFont(42);
   gre->SetHistogram(Graph_Graph_from_VbbHcc_algo_CutFlow1069);
   ...
   TLegendEntry *entry=leg->AddEntry("VbbHcc_algo_CutFlow","Data (JetHT, 2018)","p");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(42);
   entry=leg->AddEntry("Graph_from_VbbHcc_algo_CutFlow","MC unc. (stat.)","fl");
...
// ------------>Primitives in pad: bottomPad
   ...
   data_mc_ratio__70->SetBinContent(4,0.1229184);
   data_mc_ratio__70->SetBinContent(5,0.2196181);
   ...
   data_mc_ratio__70->SetBinError(4,4.124842e-05);
   data_mc_ratio__70->SetBinError(5,0.0002402299);
   data_mc_ratio__70->SetMinimum(0.4);
   data_mc_ratio__70->SetMaximum(1.6);
   data_mc_ratio__70->SetEntries(8021.817);
   ...
   Graph_Graph_from_mc_statistical_error1070->SetMinimum(0.9768347);
   Graph_Graph_from_mc_statistical_error1070->SetMaximum(1.023165);
