...
// ------------>Primitives in pad: topPad
   ...
   VbbHcc_algo_CutFlow_stack_1->SetBinContent(2,5.572848e+10);
   VbbHcc_algo_CutFlow_stack_1->SetBinContent(3,5.387062e+09);
   VbbHcc_algo_CutFlow_stack_1->SetBinContent(4,3.45653e+07);
   VbbHcc_algo_CutFlow_stack_1->SetBinContent(5,1822005);
   VbbHcc_algo_CutFlow_stack_1->SetBinError(1,8471090);
   VbbHcc_algo_CutFlow_stack_1->SetBinError(2,8471008);
   VbbHcc_algo_CutFlow_stack_1->SetBinError(3,2633738);
   VbbHcc_algo_CutFlow_stack_1->SetBinError(4,210968);
   VbbHcc_algo_CutFlow_stack_1->SetBinError(5,48436.34);
   VbbHcc_algo_CutFlow_stack_1->SetEntries(9.077215e+07);
   ...
   VbbHcc_algo_CutFlow_stack_2->SetBinContent(2,1.015225e+07);
   VbbHcc_algo_CutFlow_stack_2->SetBinContent(3,2340385);
   VbbHcc_algo_CutFlow_stack_2->SetBinContent(4,110910.6);
   VbbHcc_algo_CutFlow_stack_2->SetBinContent(5,11004.5);
   VbbHcc_algo_CutFlow_stack_2->SetBinError(1,1034.78);
   VbbHcc_algo_CutFlow_stack_2->SetBinError(2,1018.087);
   VbbHcc_algo_CutFlow_stack_2->SetBinError(3,583.2034);
   VbbHcc_algo_CutFlow_stack_2->SetBinError(4,116.3015);
   VbbHcc_algo_CutFlow_stack_2->SetBinError(5,36.96016);
   VbbHcc_algo_CutFlow_stack_2->SetEntries(4.124816e+08);
   ...
   VbbHcc_algo_CutFlow_stack_3->SetBinContent(2,2.837201e+07);
   VbbHcc_algo_CutFlow_stack_3->SetBinContent(3,1.745421e+07);
   VbbHcc_algo_CutFlow_stack_3->SetBinContent(4,986989.1);
   VbbHcc_algo_CutFlow_stack_3->SetBinContent(5,93871.43);
   VbbHcc_algo_CutFlow_stack_3->SetBinError(1,1292.715);
   VbbHcc_algo_CutFlow_stack_3->SetBinError(2,1266.199);
   VbbHcc_algo_CutFlow_stack_3->SetBinError(3,1022.11);
   VbbHcc_algo_CutFlow_stack_3->SetBinError(4,239.0264);
   VbbHcc_algo_CutFlow_stack_3->SetBinError(5,74.15703);
   VbbHcc_algo_CutFlow_stack_3->SetEntries(1.415065e+09);
   ...
   VbbHcc_algo_CutFlow_stack_4->SetBinContent(2,4091236);
   VbbHcc_algo_CutFlow_stack_4->SetBinContent(3,2074511);
   VbbHcc_algo_CutFlow_stack_4->SetBinContent(4,50478.26);
   VbbHcc_algo_CutFlow_stack_4->SetBinContent(5,3601.018);
   VbbHcc_algo_CutFlow_stack_4->SetBinError(1,1069.928);
   VbbHcc_algo_CutFlow_stack_4->SetBinError(2,1069.378);
   VbbHcc_algo_CutFlow_stack_4->SetBinError(3,761.4862);
   VbbHcc_algo_CutFlow_stack_4->SetBinError(4,118.7836);
   VbbHcc_algo_CutFlow_stack_4->SetBinError(5,31.72611);
   VbbHcc_algo_CutFlow_stack_4->SetEntries(3.69039e+07);
   ...
   VbbHcc_algo_CutFlow_stack_6->SetBinContent(2,2680963);
   VbbHcc_algo_CutFlow_stack_6->SetBinContent(3,207649.3);
   VbbHcc_algo_CutFlow_stack_6->SetBinContent(4,491.6307);
   VbbHcc_algo_CutFlow_stack_6->SetBinContent(5,47.85709);
   VbbHcc_algo_CutFlow_stack_6->SetBinError(1,483.5971);
   VbbHcc_algo_CutFlow_stack_6->SetBinError(2,479.9444);
   VbbHcc_algo_CutFlow_stack_6->SetBinError(3,133.5706);
   VbbHcc_algo_CutFlow_stack_6->SetBinError(4,6.499277);
   VbbHcc_algo_CutFlow_stack_6->SetBinError(5,2.02777);
   VbbHcc_algo_CutFlow_stack_6->SetEntries(6.530631e+07);
   ...
   VbbHcc_algo_CutFlow_stack_7->SetBinContent(2,966744);
   VbbHcc_algo_CutFlow_stack_7->SetBinContent(3,87547.31);
   VbbHcc_algo_CutFlow_stack_7->SetBinContent(4,1887.658);
   VbbHcc_algo_CutFlow_stack_7->SetBinContent(5,178.0172);
   VbbHcc_algo_CutFlow_stack_7->SetBinError(1,250.9883);
   VbbHcc_algo_CutFlow_stack_7->SetBinError(2,248.1838);
   VbbHcc_algo_CutFlow_stack_7->SetBinError(3,74.68599);
   VbbHcc_algo_CutFlow_stack_7->SetBinError(4,10.96679);
   VbbHcc_algo_CutFlow_stack_7->SetBinError(5,3.367819);
   VbbHcc_algo_CutFlow_stack_7->SetEntries(3.209764e+07);
   ...
   VbbHcc_algo_CutFlow_stack_8->SetBinContent(2,425521.8);
   VbbHcc_algo_CutFlow_stack_8->SetBinContent(3,42590.71);
   VbbHcc_algo_CutFlow_stack_8->SetBinContent(4,1866.667);
   VbbHcc_algo_CutFlow_stack_8->SetBinContent(5,173.2847);
   VbbHcc_algo_CutFlow_stack_8->SetBinError(1,279.8041);
   VbbHcc_algo_CutFlow_stack_8->SetBinError(2,276.2819);
   VbbHcc_algo_CutFlow_stack_8->SetBinError(3,87.40755);
   VbbHcc_algo_CutFlow_stack_8->SetBinError(4,18.2989);
   VbbHcc_algo_CutFlow_stack_8->SetBinError(5,5.575342);
   VbbHcc_algo_CutFlow_stack_8->SetEntries(5053932);
   ...
   VbbHcc_algo_CutFlow_stack_9->SetBinContent(2,12871.73);
   VbbHcc_algo_CutFlow_stack_9->SetBinContent(3,4059.265);
   VbbHcc_algo_CutFlow_stack_9->SetBinContent(4,573.7357);
   VbbHcc_algo_CutFlow_stack_9->SetBinContent(5,49.36605);
   VbbHcc_algo_CutFlow_stack_9->SetBinError(1,4.340257);
   VbbHcc_algo_CutFlow_stack_9->SetBinError(2,4.337374);
   VbbHcc_algo_CutFlow_stack_9->SetBinError(3,2.390571);
   VbbHcc_algo_CutFlow_stack_9->SetBinError(4,0.9020539);
   VbbHcc_algo_CutFlow_stack_9->SetBinError(5,0.2649838);
   VbbHcc_algo_CutFlow_stack_9->SetEntries(2.344039e+07);
   ...
   TH1D *VbbHcc_algo_CutFlow__65 = new TH1D("VbbHcc_algo_CutFlow__65","",5,0,5);
   VbbHcc_algo_CutFlow__65->SetBinContent(1,5.534693e+08);
   VbbHcc_algo_CutFlow__65->SetBinContent(2,5.497068e+08);
   VbbHcc_algo_CutFlow__65->SetBinContent(3,2.530938e+08);
   VbbHcc_algo_CutFlow__65->SetBinContent(4,3312655);
   VbbHcc_algo_CutFlow__65->SetBinContent(5,315376);
   VbbHcc_algo_CutFlow__65->SetEntries(1.359898e+09);

   ci = TColor::GetColor("#000099");
   VbbHcc_algo_CutFlow__65->SetLineColor(ci);
   VbbHcc_algo_CutFlow__65->SetLineWidth(2);
   VbbHcc_algo_CutFlow__65->SetMarkerStyle(20);
   VbbHcc_algo_CutFlow__65->SetMarkerSize(1.2);
   VbbHcc_algo_CutFlow__65->GetXaxis()->SetBinLabel(1,"Total");
   VbbHcc_algo_CutFlow__65->GetXaxis()->SetBinLabel(2,"MET cut");
   VbbHcc_algo_CutFlow__65->GetXaxis()->SetBinLabel(3,"jet cuts");
   VbbHcc_algo_CutFlow__65->GetXaxis()->SetBinLabel(4,"b-tags");
   VbbHcc_algo_CutFlow__65->GetXaxis()->SetBinLabel(5,"c-tags");
   VbbHcc_algo_CutFlow__65->GetXaxis()->SetRange(1,5);
   VbbHcc_algo_CutFlow__65->GetXaxis()->SetLabelFont(42);
   VbbHcc_algo_CutFlow__65->GetXaxis()->SetLabelSize(0.035);
   VbbHcc_algo_CutFlow__65->GetXaxis()->SetTitleSize(0.035);
   VbbHcc_algo_CutFlow__65->GetXaxis()->SetTitleFont(42);
   VbbHcc_algo_CutFlow__65->GetYaxis()->SetLabelFont(42);
   VbbHcc_algo_CutFlow__65->GetYaxis()->SetLabelSize(0.035);
   VbbHcc_algo_CutFlow__65->GetYaxis()->SetTitleSize(0.035);
   VbbHcc_algo_CutFlow__65->GetYaxis()->SetTitleOffset(0);
   VbbHcc_algo_CutFlow__65->GetYaxis()->SetTitleFont(42);
   VbbHcc_algo_CutFlow__65->GetZaxis()->SetLabelFont(42);
   VbbHcc_algo_CutFlow__65->GetZaxis()->SetLabelSize(0.035);
   VbbHcc_algo_CutFlow__65->GetZaxis()->SetTitleSize(0.035);
   VbbHcc_algo_CutFlow__65->GetZaxis()->SetTitleFont(42);
   VbbHcc_algo_CutFlow__65->Draw("same E");
   
   Double_t Graph_from_VbbHcc_algo_CutFlow_fx1065[5] = {
   0.5,
   1.5,
   2.5,
   3.5,
   4.5};
   Double_t Graph_from_VbbHcc_algo_CutFlow_fy1065[5] = {
   5.578979e+10,
   5.578698e+10,
   5.415463e+09,
   3.578989e+07,
   1941283};
   Double_t Graph_from_VbbHcc_algo_CutFlow_fex1065[5] = {
   0.5,
   0.5,
   0.5,
   0.5,
   0.5};
   Double_t Graph_from_VbbHcc_algo_CutFlow_fey1065[5] = {
   8471091,
   8471010,
   2633740,
   210968.8,
   48436.78};
   TGraphErrors *gre = new TGraphErrors(5,Graph_from_VbbHcc_algo_CutFlow_fx1065,Graph_from_VbbHcc_algo_CutFlow_fy1065,Graph_from_VbbHcc_algo_CutFlow_fex1065,Graph_from_VbbHcc_algo_CutFlow_fey1065);
   ...
   TH1F *Graph_Graph_from_VbbHcc_algo_CutFlow1065 = new TH1F("Graph_Graph_from_VbbHcc_algo_CutFlow1065","",100,0,5.5);
   Graph_Graph_from_VbbHcc_algo_CutFlow1065->SetMinimum(1703562);
   Graph_Graph_from_VbbHcc_algo_CutFlow1065->SetMaximum(6.137789e+10);
   Graph_Graph_from_VbbHcc_algo_CutFlow1065->SetDirectory(0);
   Graph_Graph_from_VbbHcc_algo_CutFlow1065->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph_from_VbbHcc_algo_CutFlow1065->SetLineColor(ci);
   Graph_Graph_from_VbbHcc_algo_CutFlow1065->GetXaxis()->SetLabelFont(42);
   Graph_Graph_from_VbbHcc_algo_CutFlow1065->GetXaxis()->SetLabelSize(0.035);
   Graph_Graph_from_VbbHcc_algo_CutFlow1065->GetXaxis()->SetTitleSize(0.035);
   Graph_Graph_from_VbbHcc_algo_CutFlow1065->GetXaxis()->SetTitleFont(42);
   Graph_Graph_from_VbbHcc_algo_CutFlow1065->GetYaxis()->SetLabelFont(42);
   Graph_Graph_from_VbbHcc_algo_CutFlow1065->GetYaxis()->SetLabelSize(0.035);
   Graph_Graph_from_VbbHcc_algo_CutFlow1065->GetYaxis()->SetTitleSize(0.035);
   Graph_Graph_from_VbbHcc_algo_CutFlow1065->GetYaxis()->SetTitleOffset(0);
   Graph_Graph_from_VbbHcc_algo_CutFlow1065->GetYaxis()->SetTitleFont(42);
   Graph_Graph_from_VbbHcc_algo_CutFlow1065->GetZaxis()->SetLabelFont(42);
   Graph_Graph_from_VbbHcc_algo_CutFlow1065->GetZaxis()->SetLabelSize(0.035);
   Graph_Graph_from_VbbHcc_algo_CutFlow1065->GetZaxis()->SetTitleSize(0.035);
   Graph_Graph_from_VbbHcc_algo_CutFlow1065->GetZaxis()->SetTitleFont(42);
   gre->SetHistogram(Graph_Graph_from_VbbHcc_algo_CutFlow1065);
   ...
   TLegendEntry *entry=leg->AddEntry("VbbHcc_algo_CutFlow","Data (JetHT, 2016)","p");
...
// ------------>Primitives in pad: bottomPad
   ...
   data_mc_ratio__66->SetBinContent(4,0.09255839);
   data_mc_ratio__66->SetBinContent(5,0.1624575);
   ...
   data_mc_ratio__66->SetBinError(4,5.08543e-05);
   data_mc_ratio__66->SetBinError(5,0.0002892846);
   data_mc_ratio__66->SetMinimum(0.4);
   data_mc_ratio__66->SetMaximum(1.6);
   data_mc_ratio__66->SetEntries(6147.993);
   ...
   Graph_Graph_from_mc_statistical_error1066->SetMinimum(0.9700589);
   Graph_Graph_from_mc_statistical_error1066->SetMaximum(1.029941);
