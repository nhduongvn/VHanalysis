...
// ------------>Primitives in pad: topPad
   ...
   VbbHcc_algo_CutFlow_stack_1->SetBinContent(2,6.452713e+10);
   VbbHcc_algo_CutFlow_stack_1->SetBinContent(3,6.470291e+09);
   VbbHcc_algo_CutFlow_stack_1->SetBinContent(4,5.14866e+07);
   VbbHcc_algo_CutFlow_stack_1->SetBinContent(5,2718623);
   VbbHcc_algo_CutFlow_stack_1->SetBinError(1,8511159);
   VbbHcc_algo_CutFlow_stack_1->SetBinError(2,8510570);
   VbbHcc_algo_CutFlow_stack_1->SetBinError(3,2694942);
   VbbHcc_algo_CutFlow_stack_1->SetBinError(4,240400.1);
   VbbHcc_algo_CutFlow_stack_1->SetBinError(5,55241.06);
   VbbHcc_algo_CutFlow_stack_1->SetEntries(1.20794e+08);
   ...
   VbbHcc_algo_CutFlow_stack_2->SetBinContent(2,1.173642e+07);
   VbbHcc_algo_CutFlow_stack_2->SetBinContent(3,2738942);
   VbbHcc_algo_CutFlow_stack_2->SetBinContent(4,160281.7);
   VbbHcc_algo_CutFlow_stack_2->SetBinContent(5,15617.94);
   VbbHcc_algo_CutFlow_stack_2->SetBinError(1,1120.847);
   VbbHcc_algo_CutFlow_stack_2->SetBinError(2,1101.902);
   VbbHcc_algo_CutFlow_stack_2->SetBinError(3,630.4643);
   VbbHcc_algo_CutFlow_stack_2->SetBinError(4,140.4613);
   VbbHcc_algo_CutFlow_stack_2->SetBinError(5,44.32848);
   VbbHcc_algo_CutFlow_stack_2->SetEntries(4.521035e+08);
   ...
   VbbHcc_algo_CutFlow_stack_3->SetBinContent(2,3.275408e+07);
   VbbHcc_algo_CutFlow_stack_3->SetBinContent(3,2.02548e+07);
   VbbHcc_algo_CutFlow_stack_3->SetBinContent(4,1407831);
   VbbHcc_algo_CutFlow_stack_3->SetBinContent(5,132638.7);
   VbbHcc_algo_CutFlow_stack_3->SetBinError(1,1386.565);
   VbbHcc_algo_CutFlow_stack_3->SetBinError(2,1358.379);
   VbbHcc_algo_CutFlow_stack_3->SetBinError(3,1108.581);
   VbbHcc_algo_CutFlow_stack_3->SetBinError(4,286.1248);
   VbbHcc_algo_CutFlow_stack_3->SetBinError(5,88.53033);
   VbbHcc_algo_CutFlow_stack_3->SetEntries(1.690904e+09);
   ...
   VbbHcc_algo_CutFlow_stack_4->SetBinContent(2,4734947);
   VbbHcc_algo_CutFlow_stack_4->SetBinContent(3,2405500);
   VbbHcc_algo_CutFlow_stack_4->SetBinContent(4,70484.46);
   VbbHcc_algo_CutFlow_stack_4->SetBinContent(5,4934.406);
   VbbHcc_algo_CutFlow_stack_4->SetBinError(1,1266.741);
   VbbHcc_algo_CutFlow_stack_4->SetBinError(2,1265.717);
   VbbHcc_algo_CutFlow_stack_4->SetBinError(3,902.1563);
   VbbHcc_algo_CutFlow_stack_4->SetBinError(4,154.4279);
   VbbHcc_algo_CutFlow_stack_4->SetBinError(5,40.85983);
   VbbHcc_algo_CutFlow_stack_4->SetEntries(3.534416e+07);
   ...
   VbbHcc_algo_CutFlow_stack_5->SetBinContent(3,5717605);
   VbbHcc_algo_CutFlow_stack_5->SetBinContent(4,23095.56);
   VbbHcc_algo_CutFlow_stack_5->SetBinContent(5,2351.426);
   VbbHcc_algo_CutFlow_stack_5->SetBinError(1,3644.351);
   VbbHcc_algo_CutFlow_stack_5->SetBinError(2,3641.92);
   VbbHcc_algo_CutFlow_stack_5->SetBinError(3,2571.603);
   VbbHcc_algo_CutFlow_stack_5->SetBinError(4,163.4411);
   VbbHcc_algo_CutFlow_stack_5->SetBinError(5,52.15099);
   VbbHcc_algo_CutFlow_stack_5->SetEntries(2.480768e+07);
   ...
   VbbHcc_algo_CutFlow_stack_6->SetBinContent(2,3100617);
   VbbHcc_algo_CutFlow_stack_6->SetBinContent(3,246164.8);
   VbbHcc_algo_CutFlow_stack_6->SetBinContent(4,814.3236);
   VbbHcc_algo_CutFlow_stack_6->SetBinContent(5,76.61375);
   VbbHcc_algo_CutFlow_stack_6->SetBinError(1,797.1833);
   VbbHcc_algo_CutFlow_stack_6->SetBinError(2,790.6525);
   VbbHcc_algo_CutFlow_stack_6->SetBinError(3,222.7792);
   VbbHcc_algo_CutFlow_stack_6->SetBinError(4,12.81327);
   VbbHcc_algo_CutFlow_stack_6->SetBinError(5,3.930203);
   VbbHcc_algo_CutFlow_stack_6->SetEntries(3.223827e+07);
   ...
   VbbHcc_algo_CutFlow_stack_8->SetBinContent(2,492130.6);
   VbbHcc_algo_CutFlow_stack_8->SetBinContent(3,50561.34);
   VbbHcc_algo_CutFlow_stack_8->SetBinContent(4,2700.365);
   VbbHcc_algo_CutFlow_stack_8->SetBinContent(5,255.5056);
   VbbHcc_algo_CutFlow_stack_8->SetBinError(1,307.2403);
   VbbHcc_algo_CutFlow_stack_8->SetBinError(2,303.1777);
   VbbHcc_algo_CutFlow_stack_8->SetBinError(3,97.17765);
   VbbHcc_algo_CutFlow_stack_8->SetBinError(4,22.45786);
   VbbHcc_algo_CutFlow_stack_8->SetBinError(5,6.908079);
   VbbHcc_algo_CutFlow_stack_8->SetEntries(5627448);
   ...
   VbbHcc_algo_CutFlow_stack_11->SetBinContent(5,2.452036);
   ...
   VbbHcc_algo_CutFlow_stack_11->SetBinError(5,0.06385896);
   VbbHcc_algo_CutFlow_stack_11->SetEntries(1169076);
   ...
   VbbHcc_algo_CutFlow_stack_12->SetBinContent(5,13599.96);
   ...
   VbbHcc_algo_CutFlow_stack_12->SetBinError(5,252.8503);
   VbbHcc_algo_CutFlow_stack_12->SetEntries(1249853);
   ...
   TH1D *VbbHcc_algo_CutFlow__67 = new TH1D("VbbHcc_algo_CutFlow__67","",5,0,5);
   VbbHcc_algo_CutFlow__67->SetBinContent(1,3.063729e+08);
   VbbHcc_algo_CutFlow__67->SetBinContent(2,3.025317e+08);
   VbbHcc_algo_CutFlow__67->SetBinContent(3,9.926474e+07);
   VbbHcc_algo_CutFlow__67->SetBinContent(4,1538700);
   VbbHcc_algo_CutFlow__67->SetBinContent(5,144663);
   VbbHcc_algo_CutFlow__67->SetEntries(7.098527e+08);

   ci = TColor::GetColor("#000099");
   VbbHcc_algo_CutFlow__67->SetLineColor(ci);
   VbbHcc_algo_CutFlow__67->SetLineWidth(2);
   VbbHcc_algo_CutFlow__67->SetMarkerStyle(20);
   VbbHcc_algo_CutFlow__67->SetMarkerSize(1.2);
   VbbHcc_algo_CutFlow__67->GetXaxis()->SetBinLabel(1,"Total");
   VbbHcc_algo_CutFlow__67->GetXaxis()->SetBinLabel(2,"MET cut");
   VbbHcc_algo_CutFlow__67->GetXaxis()->SetBinLabel(3,"jet cuts");
   VbbHcc_algo_CutFlow__67->GetXaxis()->SetBinLabel(4,"b-tags");
   VbbHcc_algo_CutFlow__67->GetXaxis()->SetBinLabel(5,"c-tags");
   VbbHcc_algo_CutFlow__67->GetXaxis()->SetRange(1,5);
   VbbHcc_algo_CutFlow__67->GetXaxis()->SetLabelFont(42);
   VbbHcc_algo_CutFlow__67->GetXaxis()->SetLabelSize(0.035);
   VbbHcc_algo_CutFlow__67->GetXaxis()->SetTitleSize(0.035);
   VbbHcc_algo_CutFlow__67->GetXaxis()->SetTitleFont(42);
   VbbHcc_algo_CutFlow__67->GetYaxis()->SetLabelFont(42);
   VbbHcc_algo_CutFlow__67->GetYaxis()->SetLabelSize(0.035);
   VbbHcc_algo_CutFlow__67->GetYaxis()->SetTitleSize(0.035);
   VbbHcc_algo_CutFlow__67->GetYaxis()->SetTitleOffset(0);
   VbbHcc_algo_CutFlow__67->GetYaxis()->SetTitleFont(42);
   VbbHcc_algo_CutFlow__67->GetZaxis()->SetLabelFont(42);
   VbbHcc_algo_CutFlow__67->GetZaxis()->SetLabelSize(0.035);
   VbbHcc_algo_CutFlow__67->GetZaxis()->SetTitleSize(0.035);
   VbbHcc_algo_CutFlow__67->GetZaxis()->SetTitleFont(42);
   VbbHcc_algo_CutFlow__67->Draw("same E");
   
   Double_t Graph_from_VbbHcc_algo_CutFlow_fx1067[5] = {
   0.5,
   1.5,
   2.5,
   3.5,
   4.5};
   Double_t Graph_from_VbbHcc_algo_CutFlow_fy1067[5] = {
   6.460582e+10,
   6.459474e+10,
   6.503222e+09,
   5.322908e+07,
   2888443};
   Double_t Graph_from_VbbHcc_algo_CutFlow_fex1067[5] = {
   0.5,
   0.5,
   0.5,
   0.5,
   0.5};
   Double_t Graph_from_VbbHcc_algo_CutFlow_fey1067[5] = {
   8511161,
   8510572,
   2694945,
   240401.1,
   55241.77};
   TGraphErrors *gre = new TGraphErrors(5,Graph_from_VbbHcc_algo_CutFlow_fx1067,Graph_from_VbbHcc_algo_CutFlow_fy1067,Graph_from_VbbHcc_algo_CutFlow_fex1067,Graph_from_VbbHcc_algo_CutFlow_fey1067);
   ...
   TH1F *Graph_Graph_from_VbbHcc_algo_CutFlow1067 = new TH1F("Graph_Graph_from_VbbHcc_algo_CutFlow1067","",100,0,5.5);
   Graph_Graph_from_VbbHcc_algo_CutFlow1067->SetMinimum(2549881);
   Graph_Graph_from_VbbHcc_algo_CutFlow1067->SetMaximum(7.107549e+10);
   Graph_Graph_from_VbbHcc_algo_CutFlow1067->SetDirectory(0);
   Graph_Graph_from_VbbHcc_algo_CutFlow1067->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph_from_VbbHcc_algo_CutFlow1067->SetLineColor(ci);
   Graph_Graph_from_VbbHcc_algo_CutFlow1067->GetXaxis()->SetLabelFont(42);
   Graph_Graph_from_VbbHcc_algo_CutFlow1067->GetXaxis()->SetLabelSize(0.035);
   Graph_Graph_from_VbbHcc_algo_CutFlow1067->GetXaxis()->SetTitleSize(0.035);
   Graph_Graph_from_VbbHcc_algo_CutFlow1067->GetXaxis()->SetTitleFont(42);
   Graph_Graph_from_VbbHcc_algo_CutFlow1067->GetYaxis()->SetLabelFont(42);
   Graph_Graph_from_VbbHcc_algo_CutFlow1067->GetYaxis()->SetLabelSize(0.035);
   Graph_Graph_from_VbbHcc_algo_CutFlow1067->GetYaxis()->SetTitleSize(0.035);
   Graph_Graph_from_VbbHcc_algo_CutFlow1067->GetYaxis()->SetTitleOffset(0);
   Graph_Graph_from_VbbHcc_algo_CutFlow1067->GetYaxis()->SetTitleFont(42);
   Graph_Graph_from_VbbHcc_algo_CutFlow1067->GetZaxis()->SetLabelFont(42);
   Graph_Graph_from_VbbHcc_algo_CutFlow1067->GetZaxis()->SetLabelSize(0.035);
   Graph_Graph_from_VbbHcc_algo_CutFlow1067->GetZaxis()->SetTitleSize(0.035);
   Graph_Graph_from_VbbHcc_algo_CutFlow1067->GetZaxis()->SetTitleFont(42);
   gre->SetHistogram(Graph_Graph_from_VbbHcc_algo_CutFlow1067);
   ...
   TLegendEntry *entry=leg->AddEntry("VbbHcc_algo_CutFlow","Data (JetHT, 2017)","p");
...
// ------------>Primitives in pad: bottomPad
   ...
   data_mc_ratio__68->SetBinContent(4,0.02890713);
   data_mc_ratio__68->SetBinContent(5,0.05008338);
   ...
   data_mc_ratio__68->SetBinError(4,2.330387e-05);
   data_mc_ratio__68->SetBinError(5,0.0001316785);
   data_mc_ratio__68->SetMinimum(0.4);
   data_mc_ratio__68->SetMaximum(1.6);
   data_mc_ratio__68->SetEntries(11286.28);
   ...
   Graph_Graph_from_mc_statistical_error1068->SetMinimum(0.9770499);
   Graph_Graph_from_mc_statistical_error1068->SetMaximum(1.02295);
