...
//=========  (Thu Feb  9 09:44:36 2023) by ROOT version 6.14/09
   ...
   Z_pt_alljet_all->Range(37.97653,-0.251683,1705.96,6.089561);
   ...
   st->SetTitle("");
   st->SetMinimum(10);
   st->SetMaximum(155253.6);
   
   TH1F *st_stack_204 = new TH1F("st_stack_204","",40,0,2000);
   st_stack_204->SetMinimum(3.230474);
   st_stack_204->SetMaximum(285388.5);
   ...
   st_stack_204->GetYaxis()->SetLabelSize(0.035);
   st_stack_204->GetYaxis()->SetTitleSize(0.037);
   st_stack_204->GetYaxis()->SetTitleOffset(0);
   ...
   VbbHcc_alljet_Z_pt_all_stack_1->GetXaxis()->SetLabelSize(0.035);
   VbbHcc_alljet_Z_pt_all_stack_1->GetXaxis()->SetTitleSize(0.035);
   VbbHcc_alljet_Z_pt_all_stack_1->GetXaxis()->SetTitleFont(42);
   VbbHcc_alljet_Z_pt_all_stack_1->GetYaxis()->SetLabelFont(42);
   VbbHcc_alljet_Z_pt_all_stack_1->GetYaxis()->SetLabelSize(0.035);
   VbbHcc_alljet_Z_pt_all_stack_1->GetYaxis()->SetTitleSize(0.035);
   VbbHcc_alljet_Z_pt_all_stack_1->GetYaxis()->SetTitleOffset(0);
   VbbHcc_alljet_Z_pt_all_stack_1->GetYaxis()->SetTitleFont(42);
   VbbHcc_alljet_Z_pt_all_stack_1->GetZaxis()->SetLabelFont(42);
   VbbHcc_alljet_Z_pt_all_stack_1->GetZaxis()->SetLabelSize(0.035);
   VbbHcc_alljet_Z_pt_all_stack_1->GetZaxis()->SetTitleSize(0.035);
   ...
   VbbHcc_alljet_Z_pt_all_stack_2->GetXaxis()->SetLabelSize(0.035);
   VbbHcc_alljet_Z_pt_all_stack_2->GetXaxis()->SetTitleSize(0.035);
   VbbHcc_alljet_Z_pt_all_stack_2->GetXaxis()->SetTitleFont(42);
   VbbHcc_alljet_Z_pt_all_stack_2->GetYaxis()->SetLabelFont(42);
   VbbHcc_alljet_Z_pt_all_stack_2->GetYaxis()->SetLabelSize(0.035);
   VbbHcc_alljet_Z_pt_all_stack_2->GetYaxis()->SetTitleSize(0.035);
   VbbHcc_alljet_Z_pt_all_stack_2->GetYaxis()->SetTitleOffset(0);
   VbbHcc_alljet_Z_pt_all_stack_2->GetYaxis()->SetTitleFont(42);
   VbbHcc_alljet_Z_pt_all_stack_2->GetZaxis()->SetLabelFont(42);
   VbbHcc_alljet_Z_pt_all_stack_2->GetZaxis()->SetLabelSize(0.035);
   VbbHcc_alljet_Z_pt_all_stack_2->GetZaxis()->SetTitleSize(0.035);
