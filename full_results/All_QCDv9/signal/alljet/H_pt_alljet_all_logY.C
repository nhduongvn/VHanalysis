...
//=========  (Thu Feb  9 09:44:37 2023) by ROOT version 6.14/09
   ...
   H_pt_alljet_all->Range(37.97653,-0.236195,1705.96,6.013511);
   ...
   st->SetTitle("");
   st->SetMinimum(10);
   st->SetMaximum(134021.4);
   
   TH1F *st_stack_208 = new TH1F("st_stack_208","",40,0,2000);
   st_stack_208->SetMinimum(3.264147);
   st_stack_208->SetMaximum(244647.4);
   ...
   VbbHcc_alljet_H_pt_all_stack_1->GetXaxis()->SetLabelSize(0.035);
   VbbHcc_alljet_H_pt_all_stack_1->GetXaxis()->SetTitleSize(0.035);
   VbbHcc_alljet_H_pt_all_stack_1->GetXaxis()->SetTitleFont(42);
   VbbHcc_alljet_H_pt_all_stack_1->GetYaxis()->SetLabelFont(42);
   VbbHcc_alljet_H_pt_all_stack_1->GetYaxis()->SetLabelSize(0.035);
   VbbHcc_alljet_H_pt_all_stack_1->GetYaxis()->SetTitleSize(0.035);
   VbbHcc_alljet_H_pt_all_stack_1->GetYaxis()->SetTitleOffset(0);
   VbbHcc_alljet_H_pt_all_stack_1->GetYaxis()->SetTitleFont(42);
   VbbHcc_alljet_H_pt_all_stack_1->GetZaxis()->SetLabelFont(42);
   VbbHcc_alljet_H_pt_all_stack_1->GetZaxis()->SetLabelSize(0.035);
   VbbHcc_alljet_H_pt_all_stack_1->GetZaxis()->SetTitleSize(0.035);
   ...
   VbbHcc_alljet_H_pt_all_stack_2->GetXaxis()->SetLabelSize(0.035);
   VbbHcc_alljet_H_pt_all_stack_2->GetXaxis()->SetTitleSize(0.035);
   VbbHcc_alljet_H_pt_all_stack_2->GetXaxis()->SetTitleFont(42);
   VbbHcc_alljet_H_pt_all_stack_2->GetYaxis()->SetLabelFont(42);
   VbbHcc_alljet_H_pt_all_stack_2->GetYaxis()->SetLabelSize(0.035);
   VbbHcc_alljet_H_pt_all_stack_2->GetYaxis()->SetTitleSize(0.035);
   VbbHcc_alljet_H_pt_all_stack_2->GetYaxis()->SetTitleOffset(0);
   VbbHcc_alljet_H_pt_all_stack_2->GetYaxis()->SetTitleFont(42);
   VbbHcc_alljet_H_pt_all_stack_2->GetZaxis()->SetLabelFont(42);
   VbbHcc_alljet_H_pt_all_stack_2->GetZaxis()->SetLabelSize(0.035);
   VbbHcc_alljet_H_pt_all_stack_2->GetZaxis()->SetTitleSize(0.035);
