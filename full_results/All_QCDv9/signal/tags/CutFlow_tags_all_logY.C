...
//=========  (Thu Dec 15 14:28:57 2022) by ROOT version 6.26/06
   ...
   CutFlow_tags_all->Range(-1.310117,-0.3127623,7.029799,6.391883);
   ...
   st_stack_4->SetMinimum(3.103095);
   st_stack_4->SetMaximum(526524);
   ...
   VbbHcc_tags_CutFlow_all_stack_1->SetBinContent(1,2447.253);
   VbbHcc_tags_CutFlow_all_stack_1->SetBinContent(2,2444.728);
   VbbHcc_tags_CutFlow_all_stack_1->SetBinContent(3,855.7293);
   VbbHcc_tags_CutFlow_all_stack_1->SetBinContent(4,144.6798);
   VbbHcc_tags_CutFlow_all_stack_1->SetBinContent(5,29.78815);
   VbbHcc_tags_CutFlow_all_stack_1->SetBinError(1,2.204878);
   VbbHcc_tags_CutFlow_all_stack_1->SetBinError(2,2.20377);
   VbbHcc_tags_CutFlow_all_stack_1->SetBinError(3,1.281492);
   VbbHcc_tags_CutFlow_all_stack_1->SetBinError(4,0.5262321);
   VbbHcc_tags_CutFlow_all_stack_1->SetBinError(5,0.2405316);
   VbbHcc_tags_CutFlow_all_stack_1->SetEntries(3501528);
   ...
   VbbHcc_tags_CutFlow_all_stack_2->SetBinContent(1,340.0105);
   VbbHcc_tags_CutFlow_all_stack_2->SetBinContent(2,339.0681);
   VbbHcc_tags_CutFlow_all_stack_2->SetBinContent(3,221.9233);
   VbbHcc_tags_CutFlow_all_stack_2->SetBinContent(4,41.54237);
   VbbHcc_tags_CutFlow_all_stack_2->SetBinContent(5,9.434885);
   VbbHcc_tags_CutFlow_all_stack_2->SetBinError(1,0.2995158);
   VbbHcc_tags_CutFlow_all_stack_2->SetBinError(2,0.2990875);
   VbbHcc_tags_CutFlow_all_stack_2->SetBinError(3,0.241895);
   VbbHcc_tags_CutFlow_all_stack_2->SetBinError(4,0.1044414);
   VbbHcc_tags_CutFlow_all_stack_2->SetBinError(5,0.05008148);
   VbbHcc_tags_CutFlow_all_stack_2->SetEntries(3895655);
   ...
   TLegendEntry *entry=leg->AddEntry("VbbHcc_tags_CutFlow_all_stack_2","ggZHcc","F");
   ...
   entry=leg->AddEntry("VbbHcc_tags_CutFlow_all_stack_1","ZHcc","F");
