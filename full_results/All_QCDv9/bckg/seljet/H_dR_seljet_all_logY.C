...
//=========  (Mon Dec 19 11:15:41 2022) by ROOT version 6.26/06
   ...
   H_dR_seljet_all->Range(-1.353788,0.4613231,7.264125,13.82025);
   ...
   st->SetName("st");
   st->SetTitle("");
   st->SetMinimum(650.5059);
   st->SetMaximum(1.072782e+12);
   
   TH1F *st_stack_248 = new TH1F("st_stack_248","",30,0,6);
   st_stack_248->SetMinimum(115.983);
   st_stack_248->SetMaximum(3.050405e+12);
