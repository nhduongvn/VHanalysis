...
//=========  (Thu Feb 16 10:37:42 2023) by ROOT version 6.26/06
   ...
   H_dR_seljet_all->Range(-1.353788,-0.2937884,7.264125,12.97098);
   ...
   st->SetName("st");
   st->SetTitle("");
   st->SetMinimum(110.7068);
   st->SetMaximum(1.558702e+11);
   
   TH1F *st_stack_280 = new TH1F("st_stack_280","",30,0,6);
   st_stack_280->SetMinimum(19.86023);
   st_stack_280->SetMaximum(4.410686e+11);
