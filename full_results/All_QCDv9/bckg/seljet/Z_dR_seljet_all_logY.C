...
//=========  (Tue Feb 14 16:02:05 2023) by ROOT version 6.26/06
   ...
   Z_dR_seljet_all->Range(-1.310117,0.5209829,7.029799,13.43232);
   ...
   st->SetName("st");
   st->SetTitle("");
   st->SetMinimum(640.2978);
   st->SetMaximum(4.982157e+11);
   
   TH1F *st_stack_276 = new TH1F("st_stack_276","",30,0,6);
   st_stack_276->SetMinimum(117.5825);
   st_stack_276->SetMaximum(1.384146e+12);
