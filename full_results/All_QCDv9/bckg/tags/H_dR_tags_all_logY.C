...
//=========  (Mon Dec 19 11:15:37 2022) by ROOT version 6.26/06
   ...
   H_dR_tags_all->Range(-1.353788,-1.488899,7.264125,10.98184);
   ...
   st->SetName("st");
   st->SetTitle("");
   st->SetMinimum(5.378415);
   st->SetMaximum(2.000507e+09);
   
   TH1F *st_stack_24 = new TH1F("st_stack_24","",30,0,6);
   st_stack_24->SetMinimum(1.017629);
   st_stack_24->SetMaximum(5.429571e+09);
