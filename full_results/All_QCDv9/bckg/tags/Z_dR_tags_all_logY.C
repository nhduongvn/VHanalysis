...
//=========  (Mon Dec 19 11:15:37 2022) by ROOT version 6.26/06
   ...
   Z_dR_tags_all->Range(-1.310117,-2.095161,7.029799,11.00668);
   ...
   st->SetName("st");
   st->SetTitle("");
   st->SetMinimum(1.654236);
   st->SetMaximum(1.771788e+09);
   
   TH1F *st_stack_20 = new TH1F("st_stack_20","",30,0,6);
   st_stack_20->SetMinimum(0.2999572);
   st_stack_20->SetMaximum(4.971571e+09);
