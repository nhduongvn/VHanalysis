...
//=========  (Tue Feb 14 16:02:03 2023) by ROOT version 6.26/06
   ...
   H_dR_both_all->Range(-1.353788,-1.500653,7.264125,10.79208);
   ...
   st->SetName("st");
   st->SetTitle("");
   st->SetMinimum(4.922586);
   st->SetMaximum(1.359375e+09);
   
   TH1F *st_stack_152 = new TH1F("st_stack_152","",30,0,6);
   st_stack_152->SetMinimum(0.9429207);
   st_stack_152->SetMaximum(3.654312e+09);
