...
//=========  (Wed Jan 18 11:42:53 2023) by ROOT version 6.26/06
   ...
   Z_dR_both_all->Range(-1.310117,-2.124016,7.029799,11.02323);
   ...
   st->SetName("st");
   st->SetTitle("");
   st->SetMinimum(1.572144);
   st->SetMaximum(1.817186e+09);
   
   TH1F *st_stack_148 = new TH1F("st_stack_148","",30,0,6);
   st_stack_148->SetMinimum(0.284219);
   st_stack_148->SetMaximum(5.110984e+09);
