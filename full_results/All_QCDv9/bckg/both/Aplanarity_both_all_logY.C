...
//=========  (Wed Jan 18 11:42:54 2023) by ROOT version 6.26/06
   ...
   Aplanarity_both_all->Range(-0.2183529,-1.309125,1.171633,11.76156);
   ...
   st->SetTitle("");
   st->SetMinimum(10);
   st->SetMaximum(1.016505e+10);
   
   TH1F *st_stack_192 = new TH1F("st_stack_192","",50,0,1);
   st_stack_192->SetMinimum(1.817007);
   st_stack_192->SetMaximum(2.84766e+10);
