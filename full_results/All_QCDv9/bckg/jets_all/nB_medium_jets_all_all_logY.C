...
//=========  (Mon Dec 19 11:02:06 2022) by ROOT version 6.26/06
   ...
   nB_medium_jets_all_all->Range(-2.683529,-2.208873,11.21633,17.09829);
   ...
   st->SetTitle("");
   st->SetMinimum(10);
   st->SetMaximum(3.954545e+14);
   
   TH1F *st_stack_124 = new TH1F("st_stack_124","",10,-0.5,9.5);
   st_stack_124->SetMinimum(1.28229);
   st_stack_124->SetMaximum(1.470861e+15);
