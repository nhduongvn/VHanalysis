...
//=========  (Mon Dec 19 11:15:40 2022) by ROOT version 6.26/06
   ...
   Z_dR_alljet_all->Range(-1.310117,2.670628,7.029799,14.9692);
   ...
   st->SetName("st");
   st->SetTitle("");
   st->SetMinimum(73173.11);
   st->SetMaximum(2.040511e+13);
   
   TH1F *st_stack_188 = new TH1F("st_stack_188","",30,0,6);
   st_stack_188->SetMinimum(14010.61);
   st_stack_188->SetMaximum(5.487092e+13);
