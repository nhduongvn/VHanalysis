...
//=========  (Wed Jan 18 11:42:53 2023) by ROOT version 6.26/06
   ...
   Z_dR_Bj0_algo_all->Range(-1.310117,-1.064547,7.029799,10.37897);
   ...
   st->SetTitle("");
   st->SetMinimum(10);
   st->SetMaximum(6.691325e+08);
   
   TH1F *st_stack_116 = new TH1F("st_stack_116","",30,0,6);
   st_stack_116->SetMinimum(2.035517);
   st_stack_116->SetMaximum(1.716393e+09);
