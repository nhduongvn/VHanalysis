...
//=========  (Wed Jan 18 11:42:53 2023) by ROOT version 6.26/06
   ...
   H_dR_Bj1_algo_all->Range(-1.310117,-0.9688049,7.029799,9.847675);
   ...
   st->SetTitle("");
   st->SetMinimum(10);
   st->SetMaximum(2.357971e+08);
   
   TH1F *st_stack_112 = new TH1F("st_stack_112","",30,0,6);
   st_stack_112->SetMinimum(2.133894);
   st_stack_112->SetMaximum(5.834818e+08);
