...
//=========  (Tue Feb 14 16:02:02 2023) by ROOT version 6.26/06
   ...
   H_dR_Bj0_algo_all->Range(-1.310117,-1.034136,7.029799,10.20957);
   ...
   st->SetTitle("");
   st->SetMinimum(10);
   st->SetMaximum(4.797538e+08);
   
   TH1F *st_stack_108 = new TH1F("st_stack_108","",30,0,6);
   st_stack_108->SetMinimum(2.065898);
   st_stack_108->SetMaximum(1.216753e+09);
