...
//=========  (Thu Feb 16 10:37:42 2023) by ROOT version 6.26/06
   ...
   Aplanarity_alljet_all->Range(-0.2183529,-2.183716,1.171633,16.94471);
   ...
   st->SetTitle("");
   st->SetMinimum(10);
   st->SetMaximum(2.914041e+14);
   
   TH1F *st_stack_256 = new TH1F("st_stack_256","",50,0,1);
   st_stack_256->SetMinimum(1.293285);
   st_stack_256->SetMaximum(1.076126e+15);
