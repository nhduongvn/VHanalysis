...
//=========  (Thu Feb 16 10:37:42 2023) by ROOT version 6.26/06
   ...
   Z_dR_seljet_all->Range(-1.310117,-0.3446223,7.029799,12.69907);
   ...
   st->SetName("st");
   st->SetTitle("");
   st->SetMinimum(91.30338);
   st->SetMaximum(8.870102e+10);
   
   TH1F *st_stack_276 = new TH1F("st_stack_276","",30,0,6);
   st_stack_276->SetMinimum(16.61959);
   st_stack_276->SetMaximum(2.481401e+11);
