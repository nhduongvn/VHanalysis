...
#endif
void eff_dRb_v_dRc_truth_algo_bckg_17_logY()
{
//=========Macro generated from canvas: eff_dRb_v_dRc_truth_algo_bckg_17/eff_dRb_v_dRc_truth_algo_bckg_17
//=========  (Fri Mar  3 10:54:20 2023) by ROOT version 6.26/06
   TCanvas *eff_dRb_v_dRc_truth_algo_bckg_17 = new TCanvas("eff_dRb_v_dRc_truth_algo_bckg_17", "eff_dRb_v_dRc_truth_algo_bckg_17",0,0,600,600);
   gStyle->SetOptStat(0);
   eff_dRb_v_dRc_truth_algo_bckg_17->SetHighLightColor(2);
   eff_dRb_v_dRc_truth_algo_bckg_17->Range(-1.2,-0.7500001,6.8,6.75);
   eff_dRb_v_dRc_truth_algo_bckg_17->SetFillColor(0);
   eff_dRb_v_dRc_truth_algo_bckg_17->SetBorderMode(0);
   eff_dRb_v_dRc_truth_algo_bckg_17->SetBorderSize(2);
   eff_dRb_v_dRc_truth_algo_bckg_17->SetLeftMargin(0.15);
   eff_dRb_v_dRc_truth_algo_bckg_17->SetFrameBorderMode(0);
   eff_dRb_v_dRc_truth_algo_bckg_17->SetFrameBorderMode(0);
   ...
   eff_dRb_v_dRc_truth_algo_bckg_17->Modified();
   eff_dRb_v_dRc_truth_algo_bckg_17->cd();
   eff_dRb_v_dRc_truth_algo_bckg_17->SetSelected(eff_dRb_v_dRc_truth_algo_bckg_17);
}
