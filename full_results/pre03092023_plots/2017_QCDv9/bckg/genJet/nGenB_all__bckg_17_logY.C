...
//=========  (Mon Mar  6 10:58:23 2023) by ROOT version 6.26/06
   ...
   nGenB_all__bckg_17->Range(-3.775293,-1.730355,17.0745,14.21678);
   ...
   st_stack_16->SetMinimum(1.525107);
   st_stack_16->SetMaximum(4.188533e+12);
