...
//=========  (Thu Feb 16 10:37:43 2023) by ROOT version 6.26/06
   ...
   Aplanarity_seljet_17->Range(-0.2183529,-1.532629,1.171633,13.05363);
   ...
   st->SetTitle("");
   st->SetMinimum(10);
   st->SetMaximum(1.30189e+11);
   
   TH1F *st_stack_318 = new TH1F("st_stack_318","",50,0,1);
   st_stack_318->SetMinimum(1.650904);
   st_stack_318->SetMaximum(3.935502e+11);
