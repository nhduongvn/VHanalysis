...
//=========  (Wed Mar  1 14:06:43 2023) by ROOT version 6.26/06
   ...
   nJet_jets_all_signal_17->Range(-3.556941,-0.009222735,15.90286,4.929276);
   ...
   st->SetTitle("");
   st->SetMinimum(10);
   st->SetMaximum(16578.61);
   
   TH1F *st_stack_159 = new TH1F("st_stack_159","",14,-0.5,13.5);
   st_stack_159->SetMinimum(3.831749);
   st_stack_159->SetMaximum(27253.73);
