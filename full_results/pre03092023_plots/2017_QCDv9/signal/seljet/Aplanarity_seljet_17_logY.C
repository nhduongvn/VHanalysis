...
//=========  (Thu Feb 16 10:37:22 2023) by ROOT version 6.26/06
   ...
   Aplanarity_seljet_17->Range(-0.2183529,0.1377149,1.171633,4.260168);
   ...
   st->SetTitle("");
   st->SetMinimum(10);
   st->SetMaximum(4597.488);
   
   TH1F *st_stack_318 = new TH1F("st_stack_318","",50,0,1);
   st_stack_318->SetMinimum(4.289525);
   st_stack_318->SetMaximum(7045.669);
