...
#endif
void nGenJet_all__signal_17_logY()
{
...
//=========  (Mon Mar  6 10:58:23 2023) by ROOT version 6.26/06
   ...
   nGenJet_all__signal_17->Range(-3.775293,0.5291756,17.0745,2.624969);
   ...
   nGenJet_all__signal_17->SetLogy();
   ...
   st_stack_3->SetMinimum(6.034909);
   st_stack_3->SetMaximum(260.2493);
