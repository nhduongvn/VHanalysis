...
#endif
void nGenB_all__signal_17_logY()
{
...
//=========  (Mon Mar  6 10:58:23 2023) by ROOT version 6.26/06
   ...
   nGenB_all__signal_17->Range(-3.775293,0.3674456,17.0745,3.272587);
   ...
   st_stack_15->SetMinimum(5.200709);
   st_stack_15->SetMaximum(959.5612);
