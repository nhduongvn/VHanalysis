...
//=========  (Wed Mar  1 15:14:08 2023) by ROOT version 6.26/06
   ...
   st_stack_59->SetMinimum(0.0005396258);
   st_stack_59->SetMaximum(1.353019);
   ...
   VbbHcc_jets_CSV_stack_2->SetBinContent(1,0.8648162);
   VbbHcc_jets_CSV_stack_2->SetBinContent(2,0.05083898);
   VbbHcc_jets_CSV_stack_2->SetBinContent(3,0.0195001);
   VbbHcc_jets_CSV_stack_2->SetBinContent(4,0.01087331);
   VbbHcc_jets_CSV_stack_2->SetBinContent(5,0.007083226);
   VbbHcc_jets_CSV_stack_2->SetBinContent(6,0.00514421);
   VbbHcc_jets_CSV_stack_2->SetBinContent(7,0.003999664);
   VbbHcc_jets_CSV_stack_2->SetBinContent(8,0.003217922);
   VbbHcc_jets_CSV_stack_2->SetBinContent(9,0.00262347);
   VbbHcc_jets_CSV_stack_2->SetBinContent(10,0.002248845);
   VbbHcc_jets_CSV_stack_2->SetBinContent(11,0.002013293);
   VbbHcc_jets_CSV_stack_2->SetBinContent(12,0.001792437);
   VbbHcc_jets_CSV_stack_2->SetBinContent(13,0.001592461);
   VbbHcc_jets_CSV_stack_2->SetBinContent(14,0.001493078);
   VbbHcc_jets_CSV_stack_2->SetBinContent(15,0.001445772);
   VbbHcc_jets_CSV_stack_2->SetBinContent(16,0.001486452);
   VbbHcc_jets_CSV_stack_2->SetBinContent(17,0.001533173);
   VbbHcc_jets_CSV_stack_2->SetBinContent(18,0.001656461);
   VbbHcc_jets_CSV_stack_2->SetBinContent(19,0.002317846);
   VbbHcc_jets_CSV_stack_2->SetBinContent(20,0.01432305);
   VbbHcc_jets_CSV_stack_2->SetBinError(1,0.0001136946);
   VbbHcc_jets_CSV_stack_2->SetBinError(2,2.742455e-05);
   VbbHcc_jets_CSV_stack_2->SetBinError(3,1.695824e-05);
   VbbHcc_jets_CSV_stack_2->SetBinError(4,1.265683e-05);
   VbbHcc_jets_CSV_stack_2->SetBinError(5,1.020486e-05);
   VbbHcc_jets_CSV_stack_2->SetBinError(6,8.692158e-06);
   VbbHcc_jets_CSV_stack_2->SetBinError(7,7.653695e-06);
   VbbHcc_jets_CSV_stack_2->SetBinError(8,6.858927e-06);
   VbbHcc_jets_CSV_stack_2->SetBinError(9,6.18423e-06);
   VbbHcc_jets_CSV_stack_2->SetBinError(10,5.715995e-06);
   VbbHcc_jets_CSV_stack_2->SetBinError(11,5.40145e-06);
   VbbHcc_jets_CSV_stack_2->SetBinError(12,5.089196e-06);
   VbbHcc_jets_CSV_stack_2->SetBinError(13,4.789153e-06);
   VbbHcc_jets_CSV_stack_2->SetBinError(14,4.628307e-06);
   VbbHcc_jets_CSV_stack_2->SetBinError(15,4.552746e-06);
   VbbHcc_jets_CSV_stack_2->SetBinError(16,4.611142e-06);
   VbbHcc_jets_CSV_stack_2->SetBinError(17,4.679854e-06);
   VbbHcc_jets_CSV_stack_2->SetBinError(18,4.848351e-06);
   VbbHcc_jets_CSV_stack_2->SetBinError(19,5.727151e-06);
   VbbHcc_jets_CSV_stack_2->SetBinError(20,1.428906e-05);
   VbbHcc_jets_CSV_stack_2->SetEntries(2.383807e+09);
