...
void dR_HZ_17()
{
//=========Macro generated from canvas: dR_HZ_17/dR_HZ_17
//=========  (Thu Feb 16 13:12:21 2023) by ROOT version 6.26/06
   TCanvas *dR_HZ_17 = new TCanvas("dR_HZ_17", "dR_HZ_17",0,0,600,600);
   dR_HZ_17->SetHighLightColor(2);
   dR_HZ_17->Range(-1.331953,-0.1538462,7.146962,1.128205);
   dR_HZ_17->SetFillColor(0);
   dR_HZ_17->SetFillStyle(4000);
   dR_HZ_17->SetBorderMode(0);
   dR_HZ_17->SetBorderSize(2);
   dR_HZ_17->SetLeftMargin(0.15709);
   dR_HZ_17->SetRightMargin(0.1234783);
   dR_HZ_17->SetBottomMargin(0.12);
   dR_HZ_17->SetFrameFillStyle(1000);
   dR_HZ_17->SetFrameBorderMode(0);
   dR_HZ_17->SetFrameFillStyle(1000);
   dR_HZ_17->SetFrameBorderMode(0);
   ...
   st_stack_52->GetYaxis()->SetTitle("Events/0.1");
