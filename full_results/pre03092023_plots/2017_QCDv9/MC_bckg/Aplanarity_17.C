...
void Aplanarity_17()
{
//=========Macro generated from canvas: Aplanarity_17/Aplanarity_17
//=========  (Thu Feb 16 13:12:22 2023) by ROOT version 6.26/06
   TCanvas *Aplanarity_17 = new TCanvas("Aplanarity_17", "Aplanarity_17",0,0,600,600);
   Aplanarity_17->SetHighLightColor(2);
   Aplanarity_17->Range(-0.2183529,-0.1538462,1.171633,1.128205);
   Aplanarity_17->SetFillColor(0);
   Aplanarity_17->SetFillStyle(4000);
   Aplanarity_17->SetBorderMode(0);
   Aplanarity_17->SetBorderSize(2);
   Aplanarity_17->SetLeftMargin(0.15709);
   Aplanarity_17->SetRightMargin(0.1234783);
   Aplanarity_17->SetBottomMargin(0.12);
   Aplanarity_17->SetFrameFillStyle(1000);
   Aplanarity_17->SetFrameBorderMode(0);
   Aplanarity_17->SetFrameFillStyle(1000);
   Aplanarity_17->SetFrameBorderMode(0);
...
tex->SetNDC();
   ...
   tex->SetLineWidth(2);
   tex->Draw();
   Aplanarity_17->Modified();
   Aplanarity_17->cd();
   Aplanarity_17->SetSelected(Aplanarity_17);
}
