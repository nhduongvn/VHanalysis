...
//=========  (Thu Feb 16 10:37:21 2023) by ROOT version 6.26/06
   ...
   Aplanarity_alljet_18->Range(-0.2183529,-0.1750962,1.171633,5.715984);
   ...
   st->SetTitle("");
   st->SetMinimum(10);
   st->SetMaximum(75431.52);
   
   TH1F *st_stack_255 = new TH1F("st_stack_255","",50,0,1);
   st_stack_255->SetMinimum(3.402777);
   st_stack_255->SetMaximum(133929.5);
