...
#endif
void nGenGlu_all__bckg_18_logY()
{
...
//=========  (Mon Mar  6 10:58:23 2023) by ROOT version 6.26/06
   ...
   nGenGlu_all__bckg_18->Range(-3.775293,2.405886,17.0745,13.19712);
   ...
   st->SetName("st");
   st->SetTitle("");
   st->SetMinimum(23486.45);
   
   TH1F *st_stack_30 = new TH1F("st_stack_30","",15,-0.5,14.5);
   st_stack_30->SetMinimum(5021.513);
   st_stack_30->SetMaximum(1.312193e+12);
