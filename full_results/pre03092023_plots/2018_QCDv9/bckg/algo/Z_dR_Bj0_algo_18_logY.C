...
//=========  (Thu Feb 16 10:37:39 2023) by ROOT version 6.26/06
   ...
   Z_dR_Bj0_algo_18->Range(-1.310117,-0.8103675,7.029799,8.982026);
   ...
   st->SetTitle("");
   st->SetMinimum(10);
   st->SetMaximum(4.324682e+07);
   
   TH1F *st_stack_115 = new TH1F("st_stack_115","",30,0,6);
   st_stack_115->SetMinimum(2.315899);
   st_stack_115->SetMaximum(1.006436e+08);
