...
#endif
void dR_bjets_truth_algo_bckg_16_logY()
{
//=========Macro generated from canvas: dR_bjets_truth_algo_bckg_16/dR_bjets_truth_algo_bckg_16
//=========  (Thu Mar  2 13:32:45 2023) by ROOT version 6.26/06
   TCanvas *dR_bjets_truth_algo_bckg_16 = new TCanvas("dR_bjets_truth_algo_bckg_16", "dR_bjets_truth_algo_bckg_16",0,0,600,600);
   dR_bjets_truth_algo_bckg_16->SetHighLightColor(2);
   dR_bjets_truth_algo_bckg_16->Range(-1.310117,-0.1538462,7.029799,1.128205);
   dR_bjets_truth_algo_bckg_16->SetFillColor(0);
   dR_bjets_truth_algo_bckg_16->SetFillStyle(4000);
   dR_bjets_truth_algo_bckg_16->SetBorderMode(0);
   dR_bjets_truth_algo_bckg_16->SetBorderSize(2);
   dR_bjets_truth_algo_bckg_16->SetLogy();
   dR_bjets_truth_algo_bckg_16->SetLeftMargin(0.15709);
   dR_bjets_truth_algo_bckg_16->SetRightMargin(0.1234783);
   dR_bjets_truth_algo_bckg_16->SetBottomMargin(0.12);
   dR_bjets_truth_algo_bckg_16->SetFrameFillStyle(1000);
   dR_bjets_truth_algo_bckg_16->SetFrameBorderMode(0);
   dR_bjets_truth_algo_bckg_16->SetFrameFillStyle(1000);
   dR_bjets_truth_algo_bckg_16->SetFrameBorderMode(0);
   ...
   TH1F *st_stack_14 = new TH1F("st_stack_14","",60,0,6);
   ...
   st_stack_14->GetXaxis()->SetTitle("#Delta R(b,b-jet)");
   st_stack_14->GetXaxis()->SetRange(1,60);
   st_stack_14->GetXaxis()->SetLabelFont(42);
   st_stack_14->GetXaxis()->SetTitleOffset(1);
   st_stack_14->GetXaxis()->SetTitleFont(42);
   st_stack_14->GetYaxis()->SetTitle("Events/0.1");
...
tex->SetNDC();
   ...
   tex->SetLineWidth(2);
   tex->Draw();
   dR_bjets_truth_algo_bckg_16->Modified();
   dR_bjets_truth_algo_bckg_16->cd();
   dR_bjets_truth_algo_bckg_16->SetSelected(dR_bjets_truth_algo_bckg_16);
}
