...
//=========  (Wed Mar  1 14:06:43 2023) by ROOT version 6.26/06
   ...
   nC_medium_jets_all_bckg_16->Range(-2.683529,2.48577,11.21633,15.37103);
   ...
   st->SetName("st");
   st->SetTitle("");
   st->SetMinimum(58517.04);
   st->SetMaximum(4.358462e+13);
   
   TH1F *st_stack_188 = new TH1F("st_stack_188","",10,-0.5,9.5);
   st_stack_188->SetMinimum(10764.67);
   st_stack_188->SetMaximum(1.209216e+14);
