...
//=========  (Mon Mar  6 10:58:23 2023) by ROOT version 6.26/06
   ...
   nGenB_all__bckg_16->Range(-3.775293,-1.71315,17.0745,14.11486);
   ...
   st_stack_14->SetMinimum(1.535367);
   st_stack_14->SetMaximum(3.404577e+12);
