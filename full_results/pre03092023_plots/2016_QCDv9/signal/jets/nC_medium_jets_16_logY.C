...
//=========  (Wed Mar  1 13:43:14 2023) by ROOT version 6.26/06
   ...
   nC_medium_jets_16->Range(-2.683529,-0.0763545,11.21633,5.24384);
   ...
   st->SetTitle("");
   st->SetMinimum(10);
   st->SetMaximum(30358.37);
   
   TH1F *st_stack_31 = new TH1F("st_stack_31","",10,-0.5,9.5);
   st_stack_31->SetMinimum(3.648118);
   st_stack_31->SetMaximum(51501.63);
   ...
   st_stack_31->GetYaxis()->SetTitle("Events/1.0");
