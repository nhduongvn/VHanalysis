...
#endif
void nGenL_all__signal_16_logY()
{
...
//=========  (Mon Mar  6 10:58:23 2023) by ROOT version 6.26/06
   ...
   nGenL_all__signal_16->Range(-3.775293,0.5061137,17.0745,2.714739);
   ...
   st_stack_7->SetMinimum(5.904033);
   st_stack_7->SetMaximum(311.8005);
