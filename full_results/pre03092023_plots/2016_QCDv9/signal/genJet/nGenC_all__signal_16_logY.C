...
#endif
void nGenC_all__signal_16_logY()
{
...
//=========  (Mon Mar  6 10:58:23 2023) by ROOT version 6.26/06
   ...
   nGenC_all__signal_16->Range(-3.775293,0.4163327,17.0745,3.072455);
   ...
   st_stack_19->SetMinimum(5.433346);
   st_stack_19->SetMaximum(640.9776);
