...
//=========  (Wed Mar  1 14:06:15 2023) by ROOT version 6.26/06
   ...
   nC_medium_jets_all_signal_16->Range(-2.683529,-55.20246,11.21633,404.8181);
   ...
   st_stack_187->GetYaxis()->SetTitle("Events/1.0");
