...
//=========  (Thu Feb 16 13:09:05 2023) by ROOT version 6.26/06
   TCanvas *H_mass_16 = new TCanvas("H_mass_16", "H_mass_16",0,0,600,600);
   H_mass_16->SetHighLightColor(2);
   H_mass_16->Range(-65.50587,-0.01044292,351.4899,4.934945);
   H_mass_16->SetFillColor(0);
   H_mass_16->SetFillStyle(4000);
   H_mass_16->SetBorderMode(0);
   H_mass_16->SetBorderSize(2);
   H_mass_16->SetLogy();
   H_mass_16->SetLeftMargin(0.15709);
   H_mass_16->SetRightMargin(0.1234783);
   H_mass_16->SetBottomMargin(0.12);
   ...
   st->SetTitle("");
   st->SetMinimum(10);
   st->SetMaximum(16760.18);
   
   TH1F *st_stack_1 = new TH1F("st_stack_1","",40,0,400);
   st_stack_1->SetMinimum(3.82828);
   st_stack_1->SetMaximum(27568.07);
