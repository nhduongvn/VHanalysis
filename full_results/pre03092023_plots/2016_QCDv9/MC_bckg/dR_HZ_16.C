...
void dR_HZ_16()
{
//=========Macro generated from canvas: dR_HZ_16/dR_HZ_16
//=========  (Thu Feb 16 13:12:21 2023) by ROOT version 6.26/06
   TCanvas *dR_HZ_16 = new TCanvas("dR_HZ_16", "dR_HZ_16",0,0,600,600);
   dR_HZ_16->SetHighLightColor(2);
   dR_HZ_16->Range(-1.331953,-0.1538462,7.146962,1.128205);
   dR_HZ_16->SetFillColor(0);
   dR_HZ_16->SetFillStyle(4000);
   dR_HZ_16->SetBorderMode(0);
   dR_HZ_16->SetBorderSize(2);
   dR_HZ_16->SetLeftMargin(0.15709);
   dR_HZ_16->SetRightMargin(0.1234783);
   dR_HZ_16->SetBottomMargin(0.12);
   dR_HZ_16->SetFrameFillStyle(1000);
   dR_HZ_16->SetFrameBorderMode(0);
   dR_HZ_16->SetFrameFillStyle(1000);
   dR_HZ_16->SetFrameBorderMode(0);
   ...
   st_stack_50->GetYaxis()->SetTitle("Events/0.1");
