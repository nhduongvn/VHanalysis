...
//=========  (Wed Jan 25 10:51:22 2023) by ROOT version 6.26/06
   ...
   0.8520927,
   0.8737198};
   TGraph *graph = new TGraph(8,Graph_fx42,Graph_fy42);
   graph->SetName("Graph");
   ...
   TH1F *Graph_Graph42 = new TH1F("Graph_Graph42","Tagging Only",100,0.006649708,0.8615471);
   Graph_Graph42->SetMinimum(0.1325256);
   Graph_Graph42->SetMaximum(0.9411011);
   ...
   TLatex *   tex = new TLatex(0.09847694,0.2947494,"#pm0");
   tex->SetTextSize(0.02);
   tex->SetLineWidth(2);
   tex->Draw();
   graph->GetListOfFunctions()->Add(43);
      tex = new TLatex(0.2803246,0.6719807,"#pm1");
   tex->SetTextSize(0.02);
   tex->SetLineWidth(2);
   tex->Draw();
   graph->GetListOfFunctions()->Add(44);
      tex = new TLatex(0.4360675,0.848547,"#pm2");
   tex->SetTextSize(0.02);
   tex->SetLineWidth(2);
   tex->Draw();
   graph->GetListOfFunctions()->Add(45);
      tex = new TLatex(0.5604029,0.9212316,"#pm3");
   tex->SetTextSize(0.02);
   tex->SetLineWidth(2);
   tex->Draw();
   graph->GetListOfFunctions()->Add(46);
      tex = new TLatex(0.7010871,0.9658493,"#pm4");
   tex->SetTextSize(0.02);
   tex->SetLineWidth(2);
   tex->Draw();
   ...
   0.9534344,
   0.9617382};
   graph = new TGraph(8,Graph_fx48,Graph_fy48);
   graph->SetName("Graph");
   ...
   TH1F *Graph_Graph48 = new TH1F("Graph_Graph48","Mass-Matching Prioritized",100,0.0147271,1.019725);
   Graph_Graph48->SetMinimum(0.1840505);
   Graph_Graph48->SetMaximum(1.032437);
   ...
   0.8417696,
   0.8646489};
   graph = new TGraph(8,Graph_fx49,Graph_fy49);
   graph->SetName("Graph");
   ...
   TH1F *Graph_Graph49 = new TH1F("Graph_Graph49","Tagging Prioritized",100,0.006184996,0.8609539);
   Graph_Graph49->SetMinimum(0.1246905);
   Graph_Graph49->SetMaximum(0.9319178);
