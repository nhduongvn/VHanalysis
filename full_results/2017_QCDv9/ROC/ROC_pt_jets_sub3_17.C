...
//=========  (Thu Jan 19 11:41:34 2023) by ROOT version 6.26/06
   ...
   1,
   1};
   TGraph *graph = new TGraph(1000,Graph_fx40,Graph_fy40);
   graph->SetName("Graph");
   ...
   TH1F *Graph_Graph40 = new TH1F("Graph_Graph40","l-jets",1000,0,1.1);
   ...
   1,
   1};
   graph = new TGraph(1000,Graph_fx41,Graph_fy41);
   graph->SetName("Graph");
   ...
   TH1F *Graph_Graph41 = new TH1F("Graph_Graph41","b-jets",1000,0,1.1);
   ...
   1,
   1};
   graph = new TGraph(1000,Graph_fx42,Graph_fy42);
   graph->SetName("Graph");
   ...
   TH1F *Graph_Graph42 = new TH1F("Graph_Graph42","c-jets",1000,0,1.1);
