...
//=========  (Thu Jan 19 10:33:19 2023) by ROOT version 6.26/06
   ...
   1,
   1};
   TGraph *graph = new TGraph(50,Graph_fx130,Graph_fy130);
   graph->SetName("Graph");
   ...
   TH1F *Graph_Graph130 = new TH1F("Graph_Graph130","Tagging Only",100,0,1.1);
   ...
   TH1F *Graph_Graph131 = new TH1F("Graph_Graph131","Mass-Matching Prioritized",100,0,1.1);
   ...
   1,
   1};
   graph = new TGraph(50,Graph_fx132,Graph_fy132);
   graph->SetName("Graph");
   ...
   TH1F *Graph_Graph132 = new TH1F("Graph_Graph132","Tagging Prioritized",100,0,1.1);
   Graph_Graph132->SetMinimum(0);
   Graph_Graph132->SetMaximum(1.1);
   ...
   Graph_Graph132->GetXaxis()->SetTitleOffset(1);
   ...
   Graph_Graph132->GetZaxis()->SetTitleOffset(1);
