...
void Z_mass_bckg_17()
{
//=========Macro generated from canvas: Z_mass_bckg_17/Z_mass_bckg_17
//=========  (Fri Mar 10 11:21:19 2023) by ROOT version 6.26/06
   TCanvas *Z_mass_bckg_17 = new TCanvas("Z_mass_bckg_17", "Z_mass_bckg_17",0,0,600,600);
   Z_mass_bckg_17->SetHighLightColor(2);
   Z_mass_bckg_17->Range(-65.50587,-0.1538462,351.4899,1.128205);
   Z_mass_bckg_17->SetFillColor(0);
   Z_mass_bckg_17->SetFillStyle(4000);
   Z_mass_bckg_17->SetBorderMode(0);
   Z_mass_bckg_17->SetBorderSize(2);
   Z_mass_bckg_17->SetLeftMargin(0.15709);
   Z_mass_bckg_17->SetRightMargin(0.1234783);
   Z_mass_bckg_17->SetBottomMargin(0.12);
   Z_mass_bckg_17->SetFrameFillStyle(1000);
   Z_mass_bckg_17->SetFrameBorderMode(0);
   Z_mass_bckg_17->SetFrameFillStyle(1000);
   Z_mass_bckg_17->SetFrameBorderMode(0);
   ...
   TH1F *st_stack_28 = new TH1F("st_stack_28","",40,0,400);
   st_stack_28->SetMinimum(0);
   st_stack_28->SetMaximum(0);
   ...
   st_stack_28->GetXaxis()->SetTitle("M_{Z} [GeV]");
   st_stack_28->GetXaxis()->SetRange(1,30);
   st_stack_28->GetXaxis()->SetLabelFont(42);
   st_stack_28->GetXaxis()->SetTitleOffset(1);
   st_stack_28->GetXaxis()->SetTitleFont(42);
   st_stack_28->GetYaxis()->SetTitle("Event/10.0 GeV");
...
tex->SetNDC();
   ...
   tex->SetLineWidth(2);
   tex->Draw();
   Z_mass_bckg_17->Modified();
   Z_mass_bckg_17->cd();
   Z_mass_bckg_17->SetSelected(Z_mass_bckg_17);
}
