...
//=========  (Fri Dec  9 13:00:00 2022) by ROOT version 6.26/06
   ...
   st->SetName("st");
   st->SetTitle("");
   st->SetMinimum(53062.75);
   st->SetMaximum(6.460363e+12);
   
   TH1F *st_stack_46 = new TH1F("st_stack_46","",5,0,5);
   st_stack_46->SetMinimum(10522.62);
   st_stack_46->SetMaximum(1.690737e+13);
   ...
   VbbHcc_algo_CutFlow_stack_12->SetBinContent(1,102.9919);
   VbbHcc_algo_CutFlow_stack_12->SetBinContent(2,102.748);
   VbbHcc_algo_CutFlow_stack_12->SetBinContent(3,66.10757);
   VbbHcc_algo_CutFlow_stack_12->SetBinContent(4,3.451168);
   VbbHcc_algo_CutFlow_stack_12->SetBinContent(5,0.641133);
   VbbHcc_algo_CutFlow_stack_12->SetBinError(1,0.1507917);
   VbbHcc_algo_CutFlow_stack_12->SetBinError(2,0.150613);
   VbbHcc_algo_CutFlow_stack_12->SetBinError(3,0.1208096);
   VbbHcc_algo_CutFlow_stack_12->SetBinError(4,0.02760316);
   VbbHcc_algo_CutFlow_stack_12->SetBinError(5,0.01189734);
