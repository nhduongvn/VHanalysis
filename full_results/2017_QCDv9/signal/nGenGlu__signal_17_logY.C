...
//=========  (Fri Mar  3 13:54:36 2023) by ROOT version 6.26/06
   ...
   nGenGlu__signal_17->Range(-2.683529,0.6932764,11.21633,2.012374);
   ...
   st_stack_27->SetMinimum(7.105067);
   st_stack_27->SetMaximum(75.93892);
