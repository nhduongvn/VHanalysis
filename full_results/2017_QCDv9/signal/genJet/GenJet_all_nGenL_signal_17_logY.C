...
#endif
void GenJet_all_nGenL_signal_17_logY()
{
...
//=========  (Thu Mar  9 15:52:21 2023) by ROOT version 6.26/06
   ...
   GenJet_all_nGenL_signal_17->Range(-4.867058,-0.8332168,22.93266,3.13112);
   ...
   GenJet_all_nGenL_signal_17->SetLogy();
   ...
   st_stack_9->SetMinimum(0.4390395);
   st_stack_9->SetMaximum(542.8579);
