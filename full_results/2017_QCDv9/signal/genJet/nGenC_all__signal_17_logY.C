...
#endif
void nGenC_all__signal_17_logY()
{
...
//=========  (Mon Mar  6 10:58:23 2023) by ROOT version 6.26/06
   ...
   nGenC_all__signal_17->Range(-3.775293,0.3907647,17.0745,3.176663);
   ...
   st_stack_21->SetMinimum(5.309732);
   st_stack_21->SetMaximum(790.8124);
