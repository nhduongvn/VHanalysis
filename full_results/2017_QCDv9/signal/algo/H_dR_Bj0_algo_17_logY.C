...
//=========  (Thu Feb  9 09:44:33 2023) by ROOT version 6.14/09
   ...
   H_dR_Bj0_algo_17->Range(-1.310117,0.5879171,7.029799,2.400336);
   ...
   st->SetTitle("");
   st->SetMinimum(10);
   st->SetMaximum(135.0715);
   
   TH1F *st_stack_106 = new TH1F("st_stack_106","",30,0,6);
   st_stack_106->SetMinimum(6.388625);
   st_stack_106->SetMaximum(165.6129);
   ...
   st_stack_106->GetYaxis()->SetLabelSize(0.035);
   st_stack_106->GetYaxis()->SetTitleSize(0.037);
   st_stack_106->GetYaxis()->SetTitleOffset(0);
   ...
   VbbHcc_algo_H_dR_Bj0_stack_1->SetBinContent(1,0.295507);
   VbbHcc_algo_H_dR_Bj0_stack_1->SetBinContent(2,1.012941);
   VbbHcc_algo_H_dR_Bj0_stack_1->SetBinContent(3,0.9323482);
   VbbHcc_algo_H_dR_Bj0_stack_1->SetBinContent(4,0.5673102);
   VbbHcc_algo_H_dR_Bj0_stack_1->SetBinContent(5,0.320791);
   VbbHcc_algo_H_dR_Bj0_stack_1->SetBinContent(6,0.1627659);
   VbbHcc_algo_H_dR_Bj0_stack_1->SetBinContent(7,0.09323482);
   VbbHcc_algo_H_dR_Bj0_stack_1->SetBinContent(8,0.03792603);
   VbbHcc_algo_H_dR_Bj0_stack_1->SetBinContent(9,0.01896301);
   VbbHcc_algo_H_dR_Bj0_stack_1->SetBinContent(10,0.02528402);
   ...
   VbbHcc_algo_H_dR_Bj0_stack_1->SetBinError(1,0.02160961);
   VbbHcc_algo_H_dR_Bj0_stack_1->SetBinError(2,0.04000876);
   VbbHcc_algo_H_dR_Bj0_stack_1->SetBinError(3,0.03838417);
   VbbHcc_algo_H_dR_Bj0_stack_1->SetBinError(4,0.02994149);
   VbbHcc_algo_H_dR_Bj0_stack_1->SetBinError(5,0.02251511);
   VbbHcc_algo_H_dR_Bj0_stack_1->SetBinError(6,0.0160378);
   VbbHcc_algo_H_dR_Bj0_stack_1->SetBinError(7,0.01213814);
   VbbHcc_algo_H_dR_Bj0_stack_1->SetBinError(8,0.007741618);
   VbbHcc_algo_H_dR_Bj0_stack_1->SetBinError(9,0.005474151);
   VbbHcc_algo_H_dR_Bj0_stack_1->SetBinError(10,0.006321005);
   ...
   VbbHcc_algo_H_dR_Bj0_stack_1->SetEntries(2209);
   ...
   VbbHcc_algo_H_dR_Bj0_stack_2->SetBinContent(1,0.08200423);
   VbbHcc_algo_H_dR_Bj0_stack_2->SetBinContent(2,0.3377744);
   VbbHcc_algo_H_dR_Bj0_stack_2->SetBinContent(3,0.2794372);
   VbbHcc_algo_H_dR_Bj0_stack_2->SetBinContent(4,0.1393034);
   VbbHcc_algo_H_dR_Bj0_stack_2->SetBinContent(5,0.05273184);
   VbbHcc_algo_H_dR_Bj0_stack_2->SetBinContent(6,0.0220062);
   VbbHcc_algo_H_dR_Bj0_stack_2->SetBinContent(7,0.01266394);
   VbbHcc_algo_H_dR_Bj0_stack_2->SetBinContent(8,0.007681409);
   VbbHcc_algo_H_dR_Bj0_stack_2->SetBinContent(9,0.00477493);
   ...
   VbbHcc_algo_H_dR_Bj0_stack_2->SetBinError(1,0.004126081);
   VbbHcc_algo_H_dR_Bj0_stack_2->SetBinError(2,0.008374);
   VbbHcc_algo_H_dR_Bj0_stack_2->SetBinError(3,0.00761661);
   VbbHcc_algo_H_dR_Bj0_stack_2->SetBinError(4,0.005377748);
   VbbHcc_algo_H_dR_Bj0_stack_2->SetBinError(5,0.00330869);
   VbbHcc_algo_H_dR_Bj0_stack_2->SetBinError(6,0.002137431);
   VbbHcc_algo_H_dR_Bj0_stack_2->SetBinError(7,0.001621452);
   VbbHcc_algo_H_dR_Bj0_stack_2->SetBinError(8,0.001262816);
   VbbHcc_algo_H_dR_Bj0_stack_2->SetBinError(9,0.0009956417);
   ...
   VbbHcc_algo_H_dR_Bj0_stack_2->SetEntries(4555);
