...
//=========  (Wed Jan 18 11:42:14 2023) by ROOT version 6.26/06
   ...
   H_dR_algo_17->Range(-1.310117,-0.06481596,7.029799,0.4753171);
   ...
   st->SetTitle("");
   st->SetMinimum(1e+10);
   st->SetMaximum(40.12417);
   
   TH1F *st_stack_86 = new TH1F("st_stack_86","",30,0,6);
   st_stack_86->SetMinimum(-3.126664e+09);
   st_stack_86->SetMaximum(-27.2571);
   ...
   VbbHcc_algo_H_dR_stack_1->SetBinContent(4,0.1069507);
   VbbHcc_algo_H_dR_stack_1->SetBinContent(5,0.0885392);
   VbbHcc_algo_H_dR_stack_1->SetBinContent(6,0.1467068);
   VbbHcc_algo_H_dR_stack_1->SetBinContent(7,0.2843642);
   VbbHcc_algo_H_dR_stack_1->SetBinContent(8,0.264458);
   VbbHcc_algo_H_dR_stack_1->SetBinContent(9,0.3100556);
   VbbHcc_algo_H_dR_stack_1->SetBinContent(10,0.2944513);
   VbbHcc_algo_H_dR_stack_1->SetBinContent(11,0.2479329);
   VbbHcc_algo_H_dR_stack_1->SetBinContent(12,0.1603745);
   ...
   VbbHcc_algo_H_dR_stack_1->SetBinContent(17,0.01726907);
   VbbHcc_algo_H_dR_stack_1->SetBinContent(18,0.01614096);
   ...
   VbbHcc_algo_H_dR_stack_1->SetBinError(4,0.01384433);
   VbbHcc_algo_H_dR_stack_1->SetBinError(5,0.01233385);
   VbbHcc_algo_H_dR_stack_1->SetBinError(6,0.01649994);
   VbbHcc_algo_H_dR_stack_1->SetBinError(7,0.02285918);
   VbbHcc_algo_H_dR_stack_1->SetBinError(8,0.02199077);
   VbbHcc_algo_H_dR_stack_1->SetBinError(9,0.02413875);
   VbbHcc_algo_H_dR_stack_1->SetBinError(10,0.02343184);
   VbbHcc_algo_H_dR_stack_1->SetBinError(11,0.02140601);
   VbbHcc_algo_H_dR_stack_1->SetBinError(12,0.01780073);
   ...
   VbbHcc_algo_H_dR_stack_1->SetBinError(17,0.00538124);
   VbbHcc_algo_H_dR_stack_1->SetBinError(18,0.00517057);
   ...
   VbbHcc_algo_H_dR_stack_1->SetEntries(1599);
   ...
   VbbHcc_algo_H_dR_stack_2->SetBinContent(4,0.02044109);
   VbbHcc_algo_H_dR_stack_2->SetBinContent(5,0.03092867);
   VbbHcc_algo_H_dR_stack_2->SetBinContent(6,0.06186864);
   VbbHcc_algo_H_dR_stack_2->SetBinContent(7,0.09326257);
   VbbHcc_algo_H_dR_stack_2->SetBinContent(8,0.09706761);
   VbbHcc_algo_H_dR_stack_2->SetBinContent(9,0.09118611);
   VbbHcc_algo_H_dR_stack_2->SetBinContent(10,0.05846333);
   VbbHcc_algo_H_dR_stack_2->SetBinContent(11,0.0441865);
   VbbHcc_algo_H_dR_stack_2->SetBinContent(12,0.02708161);
   VbbHcc_algo_H_dR_stack_2->SetBinContent(13,0.02452162);
   VbbHcc_algo_H_dR_stack_2->SetBinContent(14,0.01509186);
   VbbHcc_algo_H_dR_stack_2->SetBinContent(15,0.01582917);
   VbbHcc_algo_H_dR_stack_2->SetBinContent(16,0.01489356);
   ...
   VbbHcc_algo_H_dR_stack_2->SetBinError(4,0.002223133);
   VbbHcc_algo_H_dR_stack_2->SetBinError(5,0.002746525);
   VbbHcc_algo_H_dR_stack_2->SetBinError(6,0.003878469);
   VbbHcc_algo_H_dR_stack_2->SetBinError(7,0.004804657);
   VbbHcc_algo_H_dR_stack_2->SetBinError(8,0.004893611);
   VbbHcc_algo_H_dR_stack_2->SetBinError(9,0.004730655);
   VbbHcc_algo_H_dR_stack_2->SetBinError(10,0.003770214);
   VbbHcc_algo_H_dR_stack_2->SetBinError(11,0.003281324);
   VbbHcc_algo_H_dR_stack_2->SetBinError(12,0.002561383);
   VbbHcc_algo_H_dR_stack_2->SetBinError(13,0.002441299);
   VbbHcc_algo_H_dR_stack_2->SetBinError(14,0.001906189);
   VbbHcc_algo_H_dR_stack_2->SetBinError(15,0.001944066);
   VbbHcc_algo_H_dR_stack_2->SetBinError(16,0.001929571);
   ...
   VbbHcc_algo_H_dR_stack_2->SetEntries(2887);
