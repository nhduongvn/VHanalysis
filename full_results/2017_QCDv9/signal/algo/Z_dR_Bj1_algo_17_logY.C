...
//=========  (Thu Feb 16 10:37:19 2023) by ROOT version 6.26/06
   ...
   Z_dR_Bj1_algo_17->Range(-1.310117,-0.1080033,7.029799,0.7920245);
   ...
   st->SetTitle("");
   st->SetMinimum(1e+10);
   st->SetMaximum(66.85921);
   
   TH1F *st_stack_118 = new TH1F("st_stack_118","",30,0,6);
   st_stack_118->SetMinimum(-3.238951e+09);
   st_stack_118->SetMaximum(-42.45344);
