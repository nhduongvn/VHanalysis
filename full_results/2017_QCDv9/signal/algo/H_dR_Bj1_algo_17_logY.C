...
//=========  (Thu Feb 16 10:37:19 2023) by ROOT version 6.26/06
   ...
   H_dR_Bj1_algo_17->Range(-1.310117,-0.07015694,7.029799,0.5144842);
   ...
   st->SetTitle("");
   st->SetMinimum(1e+10);
   st->SetMaximum(43.43049);
   
   TH1F *st_stack_110 = new TH1F("st_stack_110","",30,0,6);
   st_stack_110->SetMinimum(-3.143564e+09);
   st_stack_110->SetMaximum(-29.20444);
