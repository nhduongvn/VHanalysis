...
//=========  (Thu Feb  9 09:44:38 2023) by ROOT version 6.14/09
   ...
   st_stack_254->GetYaxis()->SetLabelSize(0.035);
   st_stack_254->GetYaxis()->SetTitleSize(0.037);
   st_stack_254->GetYaxis()->SetTitleOffset(0);
   ...
   VbbHcc_alljet_Aplanarity_stack_1->GetXaxis()->SetLabelSize(0.035);
   VbbHcc_alljet_Aplanarity_stack_1->GetXaxis()->SetTitleSize(0.035);
   VbbHcc_alljet_Aplanarity_stack_1->GetXaxis()->SetTitleFont(42);
   VbbHcc_alljet_Aplanarity_stack_1->GetYaxis()->SetLabelFont(42);
   VbbHcc_alljet_Aplanarity_stack_1->GetYaxis()->SetLabelSize(0.035);
   VbbHcc_alljet_Aplanarity_stack_1->GetYaxis()->SetTitleSize(0.035);
   VbbHcc_alljet_Aplanarity_stack_1->GetYaxis()->SetTitleOffset(0);
   VbbHcc_alljet_Aplanarity_stack_1->GetYaxis()->SetTitleFont(42);
   VbbHcc_alljet_Aplanarity_stack_1->GetZaxis()->SetLabelFont(42);
   VbbHcc_alljet_Aplanarity_stack_1->GetZaxis()->SetLabelSize(0.035);
   VbbHcc_alljet_Aplanarity_stack_1->GetZaxis()->SetTitleSize(0.035);
   ...
   VbbHcc_alljet_Aplanarity_stack_2->GetXaxis()->SetLabelSize(0.035);
   VbbHcc_alljet_Aplanarity_stack_2->GetXaxis()->SetTitleSize(0.035);
   VbbHcc_alljet_Aplanarity_stack_2->GetXaxis()->SetTitleFont(42);
   VbbHcc_alljet_Aplanarity_stack_2->GetYaxis()->SetLabelFont(42);
   VbbHcc_alljet_Aplanarity_stack_2->GetYaxis()->SetLabelSize(0.035);
   VbbHcc_alljet_Aplanarity_stack_2->GetYaxis()->SetTitleSize(0.035);
   VbbHcc_alljet_Aplanarity_stack_2->GetYaxis()->SetTitleOffset(0);
   VbbHcc_alljet_Aplanarity_stack_2->GetYaxis()->SetTitleFont(42);
   VbbHcc_alljet_Aplanarity_stack_2->GetZaxis()->SetLabelFont(42);
   VbbHcc_alljet_Aplanarity_stack_2->GetZaxis()->SetLabelSize(0.035);
   VbbHcc_alljet_Aplanarity_stack_2->GetZaxis()->SetTitleSize(0.035);
