...
//=========  (Thu Feb  9 09:44:39 2023) by ROOT version 6.14/09
   ...
   Z_pt_seljet_17->Range(37.97653,-0.003599417,1705.96,4.903171);
   ...
   st->SetTitle("");
   st->SetMinimum(10);
   st->SetMaximum(15767.71);
   
   TH1F *st_stack_266 = new TH1F("st_stack_266","",40,0,2000);
   st_stack_266->SetMinimum(3.847805);
   st_stack_266->SetMaximum(25852);
   ...
   st_stack_266->GetYaxis()->SetLabelSize(0.035);
   st_stack_266->GetYaxis()->SetTitleSize(0.037);
   st_stack_266->GetYaxis()->SetTitleOffset(0);
   ...
   VbbHcc_seljet_Z_pt_stack_1->SetBinContent(1,108.3589);
   VbbHcc_seljet_Z_pt_stack_1->SetBinContent(2,127.6263);
   VbbHcc_seljet_Z_pt_stack_1->SetBinContent(3,30.76058);
   VbbHcc_seljet_Z_pt_stack_1->SetBinContent(4,7.521783);
   VbbHcc_seljet_Z_pt_stack_1->SetBinContent(5,2.452343);
   VbbHcc_seljet_Z_pt_stack_1->SetBinContent(6,0.8949568);
   ...
   VbbHcc_seljet_Z_pt_stack_1->SetBinError(1,0.4539765);
   VbbHcc_seljet_Z_pt_stack_1->SetBinError(2,0.4916401);
   VbbHcc_seljet_Z_pt_stack_1->SetBinError(3,0.23869);
   VbbHcc_seljet_Z_pt_stack_1->SetBinError(4,0.1173858);
   VbbHcc_seljet_Z_pt_stack_1->SetBinError(5,0.06699708);
   VbbHcc_seljet_Z_pt_stack_1->SetBinError(6,0.04047913);
   ...
   VbbHcc_seljet_Z_pt_stack_1->SetEntries(162015);
   ...
   VbbHcc_seljet_Z_pt_stack_2->SetBinContent(1,22.88538);
   VbbHcc_seljet_Z_pt_stack_2->SetBinContent(2,30.05073);
   VbbHcc_seljet_Z_pt_stack_2->SetBinContent(3,13.04213);
   VbbHcc_seljet_Z_pt_stack_2->SetBinContent(4,4.253431);
   VbbHcc_seljet_Z_pt_stack_2->SetBinContent(5,1.455888);
   VbbHcc_seljet_Z_pt_stack_2->SetBinContent(6,0.5057628);
   ...
   VbbHcc_seljet_Z_pt_stack_2->SetBinError(1,0.07437459);
   VbbHcc_seljet_Z_pt_stack_2->SetBinError(2,0.08516983);
   VbbHcc_seljet_Z_pt_stack_2->SetBinError(3,0.05596991);
   VbbHcc_seljet_Z_pt_stack_2->SetBinError(4,0.03187827);
   VbbHcc_seljet_Z_pt_stack_2->SetBinError(5,0.01862354);
   VbbHcc_seljet_Z_pt_stack_2->SetBinError(6,0.01098212);
   ...
   VbbHcc_seljet_Z_pt_stack_2->SetEntries(314233);
