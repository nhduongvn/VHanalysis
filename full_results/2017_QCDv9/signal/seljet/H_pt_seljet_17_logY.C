...
//=========  (Thu Feb  9 09:44:39 2023) by ROOT version 6.14/09
   ...
   H_pt_seljet_17->Range(37.97653,0.00894696,1705.96,4.845067);
   ...
   st->SetTitle("");
   st->SetMinimum(10);
   st->SetMaximum(14102.78);
   
   TH1F *st_stack_270 = new TH1F("st_stack_270","",40,0,2000);
   st_stack_270->SetMinimum(3.88402);
   st_stack_270->SetMaximum(22985.57);
   ...
   VbbHcc_seljet_H_pt_stack_1->SetBinContent(1,95.3051);
   VbbHcc_seljet_H_pt_stack_1->SetBinContent(2,113.9827);
   VbbHcc_seljet_H_pt_stack_1->SetBinContent(3,46.51955);
   VbbHcc_seljet_H_pt_stack_1->SetBinContent(4,13.66627);
   VbbHcc_seljet_H_pt_stack_1->SetBinContent(5,5.086558);
   VbbHcc_seljet_H_pt_stack_1->SetBinContent(6,2.030886);
   VbbHcc_seljet_H_pt_stack_1->SetBinContent(7,0.9119938);
   VbbHcc_seljet_H_pt_stack_1->SetBinContent(8,0.3965664);
   ...
   VbbHcc_seljet_H_pt_stack_1->SetBinError(1,0.4265993);
   VbbHcc_seljet_H_pt_stack_1->SetBinError(2,0.4652759);
   VbbHcc_seljet_H_pt_stack_1->SetBinError(3,0.2942847);
   VbbHcc_seljet_H_pt_stack_1->SetBinError(4,0.1581614);
   VbbHcc_seljet_H_pt_stack_1->SetBinError(5,0.09584968);
   VbbHcc_seljet_H_pt_stack_1->SetBinError(6,0.06023114);
   VbbHcc_seljet_H_pt_stack_1->SetBinError(7,0.04041587);
   VbbHcc_seljet_H_pt_stack_1->SetBinError(8,0.02629795);
   ...
   VbbHcc_seljet_H_pt_stack_1->SetEntries(162015);
   ...
   VbbHcc_seljet_H_pt_stack_2->SetBinContent(1,18.74645);
   VbbHcc_seljet_H_pt_stack_2->SetBinContent(2,27.0451);
   VbbHcc_seljet_H_pt_stack_2->SetBinContent(3,15.07041);
   VbbHcc_seljet_H_pt_stack_2->SetBinContent(4,6.663695);
   VbbHcc_seljet_H_pt_stack_2->SetBinContent(5,2.863896);
   VbbHcc_seljet_H_pt_stack_2->SetBinContent(6,1.186549);
   VbbHcc_seljet_H_pt_stack_2->SetBinContent(7,0.5108943);
   VbbHcc_seljet_H_pt_stack_2->SetBinContent(8,0.2261941);
   ...
   VbbHcc_seljet_H_pt_stack_2->SetBinError(1,0.06746446);
   VbbHcc_seljet_H_pt_stack_2->SetBinError(2,0.0809055);
   VbbHcc_seljet_H_pt_stack_2->SetBinError(3,0.06021951);
   VbbHcc_seljet_H_pt_stack_2->SetBinError(4,0.03986628);
   VbbHcc_seljet_H_pt_stack_2->SetBinError(5,0.02597531);
   VbbHcc_seljet_H_pt_stack_2->SetBinError(6,0.01659076);
   VbbHcc_seljet_H_pt_stack_2->SetBinError(7,0.01082225);
   VbbHcc_seljet_H_pt_stack_2->SetBinError(8,0.007181436);
   ...
   VbbHcc_seljet_H_pt_stack_2->SetEntries(314233);
