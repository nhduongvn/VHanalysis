...
//=========  (Fri Mar  3 13:54:36 2023) by ROOT version 6.26/06
   ...
   nGenC__signal_17->Range(-2.683529,0.5716351,11.21633,2.462015);
   ...
   st_stack_21->SetMinimum(6.287538);
   st_stack_21->SetMaximum(187.4893);
