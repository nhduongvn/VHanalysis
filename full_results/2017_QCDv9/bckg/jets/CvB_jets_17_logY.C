...
//=========  (Mon Dec 19 11:02:03 2022) by ROOT version 6.26/06
   ...
   CvB_jets_17->Range(-0.2183529,4.752854,1.171633,15.22355);
   ...
   st->SetName("st");
   st->SetTitle("");
   st->SetMinimum(4660821);
   st->SetMaximum(6.191956e+13);
   
   TH1F *st_stack_14 = new TH1F("st_stack_14","",20,0,1);
   st_stack_14->SetMinimum(1021733);
   st_stack_14->SetMaximum(1.501347e+14);
