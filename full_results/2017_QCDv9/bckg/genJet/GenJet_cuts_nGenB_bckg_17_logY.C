...
#endif
void GenJet_cuts_nGenB_bckg_17_logY()
{
...
//=========  (Thu Mar  9 15:52:23 2023) by ROOT version 6.26/06
   ...
   GenJet_cuts_nGenB_bckg_17->Range(-4.867058,-2.945661,22.93266,14.50245);
   ...
   GenJet_cuts_nGenB_bckg_17->SetLogy();
   ...
   st_stack_88->SetMinimum(0.1406414);
   st_stack_88->SetMaximum(5.723254e+12);
