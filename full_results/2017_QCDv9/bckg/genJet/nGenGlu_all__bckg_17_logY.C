...
#endif
void nGenGlu_all__bckg_17_logY()
{
...
//=========  (Mon Mar  6 10:58:23 2023) by ROOT version 6.26/06
   ...
   nGenGlu_all__bckg_17->Range(-3.775293,2.200718,17.0745,13.04205);
   ...
   st->SetName("st");
   st->SetTitle("");
   st->SetMinimum(14905.08);
   
   TH1F *st_stack_28 = new TH1F("st_stack_28","",15,-0.5,14.5);
   st_stack_28->SetMinimum(3174.515);
   st_stack_28->SetMaximum(9.076392e+11);
