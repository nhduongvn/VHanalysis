...
#endif
void dR_cjets_truth_tags_bckg_17_logY()
{
//=========Macro generated from canvas: dR_cjets_truth_tags_bckg_17/dR_cjets_truth_tags_bckg_17
//=========  (Thu Mar  2 13:32:45 2023) by ROOT version 6.26/06
   TCanvas *dR_cjets_truth_tags_bckg_17 = new TCanvas("dR_cjets_truth_tags_bckg_17", "dR_cjets_truth_tags_bckg_17",0,0,600,600);
   dR_cjets_truth_tags_bckg_17->SetHighLightColor(2);
   dR_cjets_truth_tags_bckg_17->Range(-1.310117,-0.1538462,7.029799,1.128205);
   dR_cjets_truth_tags_bckg_17->SetFillColor(0);
   dR_cjets_truth_tags_bckg_17->SetFillStyle(4000);
   dR_cjets_truth_tags_bckg_17->SetBorderMode(0);
   dR_cjets_truth_tags_bckg_17->SetBorderSize(2);
   dR_cjets_truth_tags_bckg_17->SetLogy();
   dR_cjets_truth_tags_bckg_17->SetLeftMargin(0.15709);
   dR_cjets_truth_tags_bckg_17->SetRightMargin(0.1234783);
   dR_cjets_truth_tags_bckg_17->SetBottomMargin(0.12);
   dR_cjets_truth_tags_bckg_17->SetFrameFillStyle(1000);
   dR_cjets_truth_tags_bckg_17->SetFrameBorderMode(0);
   dR_cjets_truth_tags_bckg_17->SetFrameFillStyle(1000);
   dR_cjets_truth_tags_bckg_17->SetFrameBorderMode(0);
   ...
   st_stack_10->GetXaxis()->SetTitle("#Delta R(c,c-jet)");
   st_stack_10->GetXaxis()->SetRange(1,60);
...
tex->SetNDC();
   ...
   tex->SetLineWidth(2);
   tex->Draw();
   dR_cjets_truth_tags_bckg_17->Modified();
   dR_cjets_truth_tags_bckg_17->cd();
   dR_cjets_truth_tags_bckg_17->SetSelected(dR_cjets_truth_tags_bckg_17);
}
