...
//=========  (Mon Dec 19 11:15:39 2022) by ROOT version 6.26/06
   ...
   H_dR_Bj0_algo_17->Range(-1.310117,-0.9599806,7.029799,9.799009);
   ...
   st->SetTitle("");
   st->SetMinimum(10);
   st->SetMaximum(2.143279e+08);
   
   TH1F *st_stack_98 = new TH1F("st_stack_98","",30,0,6);
   st_stack_98->SetMinimum(2.143375);
   st_stack_98->SetMaximum(5.285787e+08);
