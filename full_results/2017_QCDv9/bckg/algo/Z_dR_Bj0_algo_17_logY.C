...
//=========  (Wed Jan 18 11:42:53 2023) by ROOT version 6.26/06
   ...
   Z_dR_Bj0_algo_17->Range(-1.310117,-0.9686276,7.029799,9.846697);
   ...
   st->SetTitle("");
   st->SetMinimum(10);
   st->SetMaximum(2.353451e+08);
   
   TH1F *st_stack_114 = new TH1F("st_stack_114","",30,0,6);
   st_stack_114->SetMinimum(2.134083);
   st_stack_114->SetMaximum(5.82324e+08);
