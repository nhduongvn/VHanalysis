...
//=========  (Mon Dec 19 11:15:39 2022) by ROOT version 6.26/06
   ...
   Z_dR_Bj0_algo_17->Range(-1.310117,-0.9683245,7.029799,9.845025);
   ...
   st->SetTitle("");
   st->SetMinimum(10);
   st->SetMaximum(2.345743e+08);
   
   TH1F *st_stack_106 = new TH1F("st_stack_106","",30,0,6);
   st_stack_106->SetMinimum(2.134408);
   st_stack_106->SetMaximum(5.8035e+08);
