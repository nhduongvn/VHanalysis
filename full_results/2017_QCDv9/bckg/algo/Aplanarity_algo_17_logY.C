...
//=========  (Tue Feb 14 16:02:03 2023) by ROOT version 6.26/06
   ...
   Aplanarity_algo_17->Range(-0.2183529,-1.004827,1.171633,10.04687);
   ...
   st->SetTitle("");
   st->SetMinimum(10);
   st->SetMaximum(3.485735e+08);
   
   TH1F *st_stack_126 = new TH1F("st_stack_126","",50,0,1);
   st_stack_126->SetMinimum(2.095932);
   st_stack_126->SetMaximum(8.743823e+08);
