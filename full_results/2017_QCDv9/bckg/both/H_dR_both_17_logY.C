...
//=========  (Mon Dec 19 11:15:39 2022) by ROOT version 6.26/06
   ...
   H_dR_both_17->Range(-1.353788,-1.779884,7.264125,10.529);
   ...
   st->SetName("st");
   st->SetTitle("");
   st->SetMinimum(2.602487);
   st->SetMaximum(7.383639e+08);
   
   TH1F *st_stack_134 = new TH1F("st_stack_134","",30,0,6);
   st_stack_134->SetMinimum(0.4979464);
   st_stack_134->SetMaximum(1.986624e+09);
