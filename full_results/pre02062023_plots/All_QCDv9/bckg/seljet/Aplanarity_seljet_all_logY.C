...
//=========  (Wed Jan 18 11:42:57 2023) by ROOT version 6.26/06
   ...
   Aplanarity_seljet_all->Range(-0.2183529,-1.80373,1.171633,14.6528);
   ...
   st->SetTitle("");
   st->SetMinimum(10);
   st->SetMaximum(3.08263e+12);
   
   TH1F *st_stack_320 = new TH1F("st_stack_320","",50,0,1);
   st_stack_320->SetMinimum(1.482698);
   st_stack_320->SetMaximum(1.016585e+13);
