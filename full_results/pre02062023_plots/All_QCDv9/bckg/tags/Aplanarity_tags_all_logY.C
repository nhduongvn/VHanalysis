...
//=========  (Wed Jan 18 11:42:52 2023) by ROOT version 6.26/06
   ...
   Aplanarity_tags_all->Range(-0.2183529,-1.306777,1.171633,11.74812);
   ...
   st->SetTitle("");
   st->SetMinimum(10);
   st->SetMaximum(9.899389e+09);
   
   TH1F *st_stack_64 = new TH1F("st_stack_64","",50,0,1);
   st_stack_64->SetMinimum(1.818908);
   st_stack_64->SetMaximum(2.770959e+10);
