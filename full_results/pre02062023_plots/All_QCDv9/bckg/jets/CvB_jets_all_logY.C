...
//=========  (Mon Dec 19 11:02:03 2022) by ROOT version 6.26/06
   ...
   CvB_jets_all->Range(-0.2183529,5.243648,1.171633,15.73506);
   ...
   st->SetName("st");
   st->SetTitle("");
   st->SetMinimum(1.453624e+07);
   st->SetMaximum(1.998638e+14);
   
   TH1F *st_stack_16 = new TH1F("st_stack_16","",20,0,1);
   st_stack_16->SetMinimum(3181394);
   st_stack_16->SetMaximum(4.852006e+14);
