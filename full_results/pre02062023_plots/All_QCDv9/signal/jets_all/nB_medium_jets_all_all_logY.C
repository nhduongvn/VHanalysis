...
//=========  (Mon Dec 19 11:03:35 2022) by ROOT version 6.26/06
   ...
   nB_medium_jets_all_all->Range(-2.683529,-0.2389342,11.21633,6.026943);
   ...
   st->SetTitle("");
   st->SetMinimum(10);
   st->SetMaximum(137547.5);
   
   TH1F *st_stack_124 = new TH1F("st_stack_124","",10,-0.5,9.5);
   st_stack_124->SetMinimum(3.25815);
   st_stack_124->SetMaximum(251394.2);
