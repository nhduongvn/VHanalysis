...
//=========  (Wed Jan 18 11:42:18 2023) by ROOT version 6.26/06
   ...
   Aplanarity_seljet_all->Range(-0.2183529,-0.07904224,1.171633,5.256545);
   ...
   st->SetTitle("");
   st->SetMinimum(10);
   st->SetMaximum(31110.03);
   
   TH1F *st_stack_320 = new TH1F("st_stack_320","",50,0,1);
   st_stack_320->SetMinimum(3.641064);
   st_stack_320->SetMaximum(52842.88);
