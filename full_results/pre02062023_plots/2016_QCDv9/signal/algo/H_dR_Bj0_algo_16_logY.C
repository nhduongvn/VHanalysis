...
//=========  (Wed Jan 18 11:42:14 2023) by ROOT version 6.26/06
   ...
   H_dR_Bj0_algo_16->Range(-1.310117,-0.08837048,7.029799,0.6480502);
   ...
   st->SetTitle("");
   st->SetMinimum(1e+10);
   st->SetMaximum(54.70553);
   
   TH1F *st_stack_105 = new TH1F("st_stack_105","",30,0,6);
   st_stack_105->SetMinimum(-3.193884e+09);
   st_stack_105->SetMaximum(-35.68955);
