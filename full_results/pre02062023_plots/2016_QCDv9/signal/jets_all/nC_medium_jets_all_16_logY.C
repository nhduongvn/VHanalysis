...
//=========  (Mon Dec 19 11:03:35 2022) by ROOT version 6.26/06
   ...
   nC_medium_jets_all_16->Range(-2.683529,-0.05731323,11.21633,5.154075);
   ...
   st->SetTitle("");
   st->SetMinimum(10);
   st->SetMaximum(25541.84);
   
   TH1F *st_stack_125 = new TH1F("st_stack_125","",10,-0.5,9.5);
   st_stack_125->SetMinimum(3.698736);
   st_stack_125->SetMaximum(42947.34);
