...
//=========  (Wed Jan 18 11:42:53 2023) by ROOT version 6.26/06
   ...
   H_dR_Bj0_algo_16->Range(-1.310117,-0.9199846,7.029799,9.579084);
   ...
   st->SetTitle("");
   st->SetMinimum(10);
   st->SetMaximum(1.392493e+08);
   
   TH1F *st_stack_105 = new TH1F("st_stack_105","",30,0,6);
   st_stack_105->SetMinimum(2.187276);
   st_stack_105->SetMaximum(3.382028e+08);
