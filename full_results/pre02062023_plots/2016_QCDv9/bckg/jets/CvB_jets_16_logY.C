...
//=========  (Mon Dec 19 11:02:03 2022) by ROOT version 6.26/06
   ...
   CvB_jets_16->Range(-0.2183529,4.620786,1.171633,15.11054);
   ...
   st->SetName("st");
   st->SetTitle("");
   st->SetMinimum(3462057);
   st->SetMaximum(4.74703e+13);
   
   TH1F *st_stack_13 = new TH1F("st_stack_13","",20,0,1);
   st_stack_13->SetMinimum(757803.2);
   st_stack_13->SetMaximum(1.152302e+14);
