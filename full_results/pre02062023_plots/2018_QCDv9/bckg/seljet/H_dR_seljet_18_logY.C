...
//=========  (Wed Jan 18 11:42:56 2023) by ROOT version 6.26/06
   ...
   H_dR_seljet_18->Range(-1.353788,0.146279,7.264125,13.4541);
   ...
   st->SetName("st");
   st->SetTitle("");
   st->SetMinimum(309.4775);
   st->SetMaximum(4.683975e+11);
   
   TH1F *st_stack_279 = new TH1F("st_stack_279","",30,0,6);
   st_stack_279->SetMinimum(55.36278);
   st_stack_279->SetMaximum(1.328374e+12);
