...
//=========  (Wed Jan 18 11:42:53 2023) by ROOT version 6.26/06
   ...
   H_dR_Bj1_algo_18->Range(-1.310117,-0.8892903,7.029799,9.411047);
   ...
   st->SetTitle("");
   st->SetMinimum(10);
   st->SetMaximum(1.001783e+08);
   
   TH1F *st_stack_111 = new TH1F("st_stack_111","",30,0,6);
   st_stack_111->SetMinimum(2.222031);
   st_stack_111->SetMaximum(2.404434e+08);
