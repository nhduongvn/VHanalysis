...
//=========  (Wed Jan 18 11:42:53 2023) by ROOT version 6.26/06
   ...
   Z_dR_Bj0_algo_18->Range(-1.310117,-0.9890374,7.029799,9.959454);
   ...
   st->SetTitle("");
   st->SetMinimum(10);
   st->SetMaximum(2.936199e+08);
   
   TH1F *st_stack_115 = new TH1F("st_stack_115","",30,0,6);
   st_stack_115->SetMinimum(2.112426);
   st_stack_115->SetMaximum(7.32158e+08);
