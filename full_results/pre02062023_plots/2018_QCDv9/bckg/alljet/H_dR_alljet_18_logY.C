...
//=========  (Wed Jan 18 11:42:55 2023) by ROOT version 6.26/06
   ...
   H_dR_alljet_18->Range(-1.353788,1.382946,7.264125,15.1985);
   ...
   st->SetName("st");
   st->SetTitle("");
   st->SetMinimum(6344.377);
   st->SetMaximum(2.254424e+13);
   
   TH1F *st_stack_215 = new TH1F("st_stack_215","",30,0,6);
   st_stack_215->SetMinimum(1098.532);
   st_stack_215->SetMaximum(6.560665e+13);
