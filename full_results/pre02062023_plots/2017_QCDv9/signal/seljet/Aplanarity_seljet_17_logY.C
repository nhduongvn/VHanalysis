...
//=========  (Wed Jan 18 11:42:18 2023) by ROOT version 6.26/06
   ...
   Aplanarity_seljet_17->Range(-0.2183529,0.05967866,1.171633,4.612108);
   ...
   st->SetTitle("");
   st->SetMinimum(10);
   st->SetMaximum(9019.544);
   
   TH1F *st_stack_318 = new TH1F("st_stack_318","",50,0,1);
   st_stack_318->SetMinimum(4.036177);
   st_stack_318->SetMaximum(14350.43);
