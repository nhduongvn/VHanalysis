...
//=========  (Mon Dec 19 11:03:32 2022) by ROOT version 6.26/06
   ...
   nC_medium_jets_17->Range(-2.683529,-0.08529827,11.21633,5.28615);
   ...
   st->SetTitle("");
   st->SetMinimum(10);
   st->SetMaximum(32934.78);
   
   TH1F *st_stack_22 = new TH1F("st_stack_22","",10,-0.5,9.5);
   st_stack_22->SetMinimum(3.624728);
   st_stack_22->SetMaximum(56105.41);
   ...
   VbbHcc_jets_nC_medium_stack_1->SetBinContent(1,198.4782);
   VbbHcc_jets_nC_medium_stack_1->SetBinContent(2,290.5529);
   VbbHcc_jets_nC_medium_stack_1->SetBinContent(3,175.5619);
   VbbHcc_jets_nC_medium_stack_1->SetBinContent(4,47.77449);
   VbbHcc_jets_nC_medium_stack_1->SetBinContent(5,6.124735);
   VbbHcc_jets_nC_medium_stack_1->SetBinContent(6,0.3184223);
   VbbHcc_jets_nC_medium_stack_1->SetBinContent(7,0.00789296);
   VbbHcc_jets_nC_medium_stack_1->SetBinContent(8,0.001999757);
   VbbHcc_jets_nC_medium_stack_1->SetBinError(1,0.6114088);
   VbbHcc_jets_nC_medium_stack_1->SetBinError(2,0.7343461);
   VbbHcc_jets_nC_medium_stack_1->SetBinError(3,0.5690782);
   VbbHcc_jets_nC_medium_stack_1->SetBinError(4,0.2959638);
   VbbHcc_jets_nC_medium_stack_1->SetBinError(5,0.1057372);
   VbbHcc_jets_nC_medium_stack_1->SetBinError(6,0.02391469);
   VbbHcc_jets_nC_medium_stack_1->SetBinError(7,0.003887538);
   VbbHcc_jets_nC_medium_stack_1->SetBinError(8,0.001999757);
   VbbHcc_jets_nC_medium_stack_1->SetEntries(495304);
   ...
   VbbHcc_jets_nC_medium_stack_2->SetBinContent(1,17.28211);
   VbbHcc_jets_nC_medium_stack_2->SetBinContent(2,38.79489);
   VbbHcc_jets_nC_medium_stack_2->SetBinContent(3,30.55532);
   VbbHcc_jets_nC_medium_stack_2->SetBinContent(4,10.82984);
   VbbHcc_jets_nC_medium_stack_2->SetBinContent(5,1.851297);
   VbbHcc_jets_nC_medium_stack_2->SetBinContent(6,0.1101853);
   VbbHcc_jets_nC_medium_stack_2->SetBinContent(7,0.001781934);
   VbbHcc_jets_nC_medium_stack_2->SetBinError(1,0.06467782);
   VbbHcc_jets_nC_medium_stack_2->SetBinError(2,0.09720218);
   VbbHcc_jets_nC_medium_stack_2->SetBinError(3,0.08634518);
   VbbHcc_jets_nC_medium_stack_2->SetBinError(4,0.05141528);
   VbbHcc_jets_nC_medium_stack_2->SetBinError(5,0.02129174);
   VbbHcc_jets_nC_medium_stack_2->SetBinError(6,0.005178906);
   VbbHcc_jets_nC_medium_stack_2->SetBinError(7,0.0006506692);
   VbbHcc_jets_nC_medium_stack_2->SetEntries(465395);
