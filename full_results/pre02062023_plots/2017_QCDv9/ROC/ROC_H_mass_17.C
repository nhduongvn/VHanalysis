...
//=========  (Tue Jan 31 11:21:42 2023) by ROOT version 6.26/06
   ...
   0.9120908,
   0.9225733};
   TGraph *graph = new TGraph(12,Graph_fx206,Graph_fy206);
   graph->SetName("Graph");
   ...
   TH1F *Graph_Graph206 = new TH1F("Graph_Graph206","Tagging Only",100,0,0.9775961);
   Graph_Graph206->SetMinimum(0.05448482);
   Graph_Graph206->SetMaximum(1.00149);
   ...
   TLatex *   tex = new TLatex(0.193601,0.6197692,"#pm10.0");
   tex->SetTextSize(0.02);
   tex->SetLineWidth(2);
   tex->Draw();
   graph->GetListOfFunctions()->Add(207);
      tex = new TLatex(0.3037148,0.7948858,"#pm20.0");
   tex->SetTextSize(0.02);
   tex->SetLineWidth(2);
   tex->Draw();
   graph->GetListOfFunctions()->Add(208);
      tex = new TLatex(0.4163034,0.895902,"#pm30.0");
   tex->SetTextSize(0.02);
   tex->SetLineWidth(2);
   tex->Draw();
   graph->GetListOfFunctions()->Add(209);
      tex = new TLatex(0.5152151,0.901312,"#pm40.0");
   tex->SetTextSize(0.02);
   tex->SetLineWidth(2);
   tex->Draw();
   graph->GetListOfFunctions()->Add(210);
      tex = new TLatex(0.6053802,0.944699,"#pm50.0");
   tex->SetTextSize(0.02);
   tex->SetLineWidth(2);
   tex->Draw();
   graph->GetListOfFunctions()->Add(211);
      tex = new TLatex(0.699142,0.9654049,"#pm60.0");
   tex->SetTextSize(0.02);
   tex->SetLineWidth(2);
   tex->Draw();
   graph->GetListOfFunctions()->Add(212);
      tex = new TLatex(0.782721,0.9784207,"#pm70.0");
   tex->SetTextSize(0.02);
   tex->SetLineWidth(2);
   tex->Draw();
   ...
   0.9648367,
   0.9685859};
   graph = new TGraph(12,Graph_fx214,Graph_fy214);
   graph->SetName("Graph");
   ...
   TH1F *Graph_Graph214 = new TH1F("Graph_Graph214","Mass-Matching Prioritized",100,0,1.027041);
   Graph_Graph214->SetMinimum(0.1206918);
   Graph_Graph214->SetMaximum(1.045667);
   ...
   0.9008802,
   0.9126311};
   graph = new TGraph(12,Graph_fx215,Graph_fy215);
   graph->SetName("Graph");
   ...
   TH1F *Graph_Graph215 = new TH1F("Graph_Graph215","Tagging Prioritized",100,0,0.9772293);
   Graph_Graph215->SetMinimum(0.04558878);
   Graph_Graph215->SetMaximum(0.9914532);
