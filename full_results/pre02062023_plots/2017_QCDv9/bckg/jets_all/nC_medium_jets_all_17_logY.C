...
//=========  (Mon Dec 19 11:02:06 2022) by ROOT version 6.26/06
   ...
   nC_medium_jets_all_17->Range(-2.683529,3.182596,11.21633,15.34573);
   ...
   st->SetName("st");
   st->SetTitle("");
   st->SetMinimum(226965.1);
   st->SetMaximum(5.046679e+13);
   
   TH1F *st_stack_126 = new TH1F("st_stack_126","",10,-0.5,9.5);
   st_stack_126->SetMinimum(43870.51);
   st_stack_126->SetMaximum(1.347165e+14);
