...
//=========  (Wed Jan 18 11:42:51 2023) by ROOT version 6.26/06
   ...
   H_dR_tags_17->Range(-1.353788,-1.770727,7.264125,10.51183);
   ...
   st->SetName("st");
   st->SetTitle("");
   st->SetMinimum(2.633846);
   st->SetMaximum(7.150654e+08);
   
   TH1F *st_stack_22 = new TH1F("st_stack_22","",30,0,6);
   st_stack_22->SetMinimum(0.5048703);
   st_stack_22->SetMaximum(1.921203e+09);
