...
//=========  (Wed Jan 18 11:42:53 2023) by ROOT version 6.26/06
   ...
   H_dR_Bj1_algo_17->Range(-1.310117,-0.8776793,7.029799,9.347652);
   ...
   st->SetTitle("");
   st->SetMinimum(10);
   st->SetMaximum(8.847815e+07);
   
   TH1F *st_stack_110 = new TH1F("st_stack_110","",30,0,6);
   st_stack_110->SetMinimum(2.235427);
   st_stack_110->SetMaximum(2.114068e+08);
