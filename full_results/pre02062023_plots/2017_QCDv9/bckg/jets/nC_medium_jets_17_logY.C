...
//=========  (Mon Dec 19 11:02:03 2022) by ROOT version 6.26/06
   ...
   nC_medium_jets_17->Range(-2.683529,-3.240603,11.21633,16.56983);
   ...
   st->SetName("st");
   st->SetTitle("");
   st->SetMinimum(1.093816);
   st->SetMaximum(1.022528e+14);
   
   TH1F *st_stack_22 = new TH1F("st_stack_22","",10,-0.5,9.5);
   st_stack_22->SetMinimum(0.1369776);
   st_stack_22->SetMaximum(3.879621e+14);
