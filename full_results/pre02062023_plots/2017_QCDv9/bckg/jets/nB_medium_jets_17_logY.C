...
//=========  (Mon Dec 19 11:02:03 2022) by ROOT version 6.26/06
   ...
   nB_medium_jets_17->Range(-2.683529,-2.118196,11.21633,16.54572);
   ...
   st->SetTitle("");
   st->SetMinimum(10);
   st->SetMaximum(1.318682e+14);
   
   TH1F *st_stack_18 = new TH1F("st_stack_18","",10,-0.5,9.5);
   st_stack_18->SetMinimum(1.322739);
   st_stack_18->SetMaximum(4.77894e+14);
