...
//=========  (Wed Jan 18 11:42:57 2023) by ROOT version 6.26/06
   ...
   Aplanarity_seljet_17->Range(-0.2183529,-1.705526,1.171633,14.06975);
   ...
   st->SetTitle("");
   st->SetMinimum(10);
   st->SetMaximum(9.71443e+11);
   
   TH1F *st_stack_318 = new TH1F("st_stack_318","",50,0,1);
   st_stack_318->SetMinimum(1.539952);
   st_stack_318->SetMaximum(3.106173e+12);
