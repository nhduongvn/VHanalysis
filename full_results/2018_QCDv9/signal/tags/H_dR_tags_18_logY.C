...
//=========  (Wed Jan 18 11:42:13 2023) by ROOT version 6.26/06
   ...
   H_dR_tags_18->Range(-1.353788,0.5848626,7.264125,2.411873);
   ...
   st->SetTitle("");
   st->SetMinimum(10);
   st->SetMaximum(138.0305);
   
   TH1F *st_stack_23 = new TH1F("st_stack_23","",30,0,6);
   st_stack_23->SetMinimum(6.369477);
   st_stack_23->SetMaximum(169.5008);
   ...
   VbbHcc_tags_H_dR_stack_2->SetBinContent(3,0.1006751);
   VbbHcc_tags_H_dR_stack_2->SetBinContent(4,0.184298);
   VbbHcc_tags_H_dR_stack_2->SetBinContent(5,0.2321273);
   VbbHcc_tags_H_dR_stack_2->SetBinContent(6,0.3142018);
   VbbHcc_tags_H_dR_stack_2->SetBinContent(7,0.380776);
   VbbHcc_tags_H_dR_stack_2->SetBinContent(8,0.4047173);
   VbbHcc_tags_H_dR_stack_2->SetBinContent(9,0.3312825);
   VbbHcc_tags_H_dR_stack_2->SetBinContent(10,0.3130357);
   VbbHcc_tags_H_dR_stack_2->SetBinContent(11,0.2597018);
   VbbHcc_tags_H_dR_stack_2->SetBinContent(12,0.2627012);
   VbbHcc_tags_H_dR_stack_2->SetBinContent(13,0.2493417);
   VbbHcc_tags_H_dR_stack_2->SetBinContent(14,0.2589647);
   VbbHcc_tags_H_dR_stack_2->SetBinContent(15,0.2872343);
   VbbHcc_tags_H_dR_stack_2->SetBinContent(16,0.2555682);
   VbbHcc_tags_H_dR_stack_2->SetBinContent(17,0.1390986);
   VbbHcc_tags_H_dR_stack_2->SetBinContent(18,0.08420881);
   VbbHcc_tags_H_dR_stack_2->SetBinContent(19,0.05291445);
   VbbHcc_tags_H_dR_stack_2->SetBinContent(20,0.0305596);
   VbbHcc_tags_H_dR_stack_2->SetBinContent(21,0.02513363);
   VbbHcc_tags_H_dR_stack_2->SetBinContent(22,0.01458319);
   VbbHcc_tags_H_dR_stack_2->SetBinContent(23,0.01054919);
   VbbHcc_tags_H_dR_stack_2->SetBinContent(24,0.007651558);
   VbbHcc_tags_H_dR_stack_2->SetBinContent(25,0.002047458);
   VbbHcc_tags_H_dR_stack_2->SetBinContent(26,0.002065267);
   VbbHcc_tags_H_dR_stack_2->SetBinContent(27,0.001561402);
   VbbHcc_tags_H_dR_stack_2->SetBinError(3,0.006353991);
   VbbHcc_tags_H_dR_stack_2->SetBinError(4,0.008369669);
   VbbHcc_tags_H_dR_stack_2->SetBinError(5,0.009413831);
   VbbHcc_tags_H_dR_stack_2->SetBinError(6,0.0109893);
   VbbHcc_tags_H_dR_stack_2->SetBinError(7,0.01216433);
   VbbHcc_tags_H_dR_stack_2->SetBinError(8,0.01258437);
   VbbHcc_tags_H_dR_stack_2->SetBinError(9,0.0112269);
   VbbHcc_tags_H_dR_stack_2->SetBinError(10,0.01095879);
   VbbHcc_tags_H_dR_stack_2->SetBinError(11,0.009895081);
   VbbHcc_tags_H_dR_stack_2->SetBinError(12,0.0100316);
   VbbHcc_tags_H_dR_stack_2->SetBinError(13,0.009787452);
   VbbHcc_tags_H_dR_stack_2->SetBinError(14,0.009925387);
   VbbHcc_tags_H_dR_stack_2->SetBinError(15,0.01052416);
   VbbHcc_tags_H_dR_stack_2->SetBinError(16,0.009941653);
   VbbHcc_tags_H_dR_stack_2->SetBinError(17,0.007145722);
   VbbHcc_tags_H_dR_stack_2->SetBinError(18,0.005576899);
   VbbHcc_tags_H_dR_stack_2->SetBinError(19,0.004486407);
   VbbHcc_tags_H_dR_stack_2->SetBinError(20,0.003343394);
   VbbHcc_tags_H_dR_stack_2->SetBinError(21,0.003046162);
   VbbHcc_tags_H_dR_stack_2->SetBinError(22,0.002280285);
   VbbHcc_tags_H_dR_stack_2->SetBinError(23,0.002005116);
   VbbHcc_tags_H_dR_stack_2->SetBinError(24,0.001687307);
   VbbHcc_tags_H_dR_stack_2->SetBinError(25,0.0008595409);
   VbbHcc_tags_H_dR_stack_2->SetBinError(26,0.0008133297);
   VbbHcc_tags_H_dR_stack_2->SetBinError(27,0.0009519386);
   VbbHcc_tags_H_dR_stack_2->SetEntries(12310);
