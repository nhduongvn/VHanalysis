...
//=========  (Thu Feb 16 10:37:19 2023) by ROOT version 6.26/06
   ...
   Aplanarity_algo_18->Range(-0.2183529,-0.1446858,1.171633,1.061029);
   ...
   st->SetTitle("");
   st->SetMinimum(1e+10);
   st->SetMaximum(89.56739);
   
   TH1F *st_stack_127 = new TH1F("st_stack_127","",50,0,1);
   st_stack_127->SetMinimum(-3.30696e+09);
   st_stack_127->SetMaximum(-54.59759);
