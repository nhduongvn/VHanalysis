...
#endif
void nGenC_all__signal_18_logY()
{
...
//=========  (Mon Mar  6 10:58:23 2023) by ROOT version 6.26/06
   ...
   nGenC_all__signal_18->Range(-3.775293,0.3409185,17.0745,3.382713);
   ...
   st_stack_23->SetMinimum(5.080821);
   st_stack_23->SetMaximum(1198.212);
