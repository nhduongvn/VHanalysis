...
#endif
void nGenB_all__signal_18_logY()
{
...
//=========  (Mon Mar  6 10:58:23 2023) by ROOT version 6.26/06
   ...
   nGenB_all__signal_18->Range(-3.775293,0.3178376,17.0745,3.479393);
   ...
   st_stack_17->SetMinimum(4.979942);
   st_stack_17->SetMaximum(1456.256);
