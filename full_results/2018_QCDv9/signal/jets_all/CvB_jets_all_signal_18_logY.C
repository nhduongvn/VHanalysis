...
//=========  (Wed Mar  1 14:06:43 2023) by ROOT version 6.26/06
   ...
   CvB_jets_all_signal_18->Range(-0.2183529,-0.218195,1.171633,5.925444);
   ...
   st->SetTitle("");
   st->SetMinimum(10);
   st->SetMaximum(113043.6);
   
   TH1F *st_stack_179 = new TH1F("st_stack_179","",20,0,1);
   st_stack_179->SetMinimum(3.304012);
   st_stack_179->SetMaximum(204682.2);
   ...
   st_stack_179->GetYaxis()->SetTitle("Events/0.05");
