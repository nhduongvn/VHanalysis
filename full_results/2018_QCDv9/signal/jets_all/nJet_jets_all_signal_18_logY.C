...
//=========  (Wed Mar  1 14:06:43 2023) by ROOT version 6.26/06
   ...
   nJet_jets_all_signal_18->Range(-3.556941,-0.05918547,15.90286,5.162882);
   ...
   st->SetTitle("");
   st->SetMinimum(10);
   st->SetMaximum(25978.35);
   
   TH1F *st_stack_161 = new TH1F("st_stack_161","",14,-0.5,13.5);
   st_stack_161->SetMinimum(3.693709);
   st_stack_161->SetMaximum(43719.55);
   ...
   st_stack_161->GetYaxis()->SetTitle("Events/1.0");
