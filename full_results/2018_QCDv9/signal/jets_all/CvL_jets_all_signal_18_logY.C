...
//=========  (Wed Mar  1 14:06:43 2023) by ROOT version 6.26/06
   ...
   CvL_jets_all_signal_18->Range(-0.2183529,-0.3603931,1.171633,6.630236);
   ...
   st->SetTitle("");
   st->SetMinimum(10);
   st->SetMaximum(442389.6);
   
   TH1F *st_stack_173 = new TH1F("st_stack_173","",20,0,1);
   st_stack_173->SetMinimum(3.009417);
   st_stack_173->SetMaximum(853440.7);
