...
//=========  (Thu Feb 16 10:37:43 2023) by ROOT version 6.26/06
   ...
   Aplanarity_seljet_18->Range(-0.2183529,-1.565618,1.171633,13.24644);
   ...
   st->SetTitle("");
   st->SetMinimum(10);
   st->SetMaximum(1.905806e+11);
   
   TH1F *st_stack_319 = new TH1F("st_stack_319","",50,0,1);
   st_stack_319->SetMinimum(1.628654);
   st_stack_319->SetMaximum(5.824172e+11);
