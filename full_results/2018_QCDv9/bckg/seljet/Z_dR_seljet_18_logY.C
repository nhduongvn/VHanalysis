...
//=========  (Thu Feb 16 10:37:42 2023) by ROOT version 6.26/06
   ...
   Z_dR_seljet_18->Range(-1.310117,-0.7366478,7.029799,12.34554);
   ...
   st->SetName("st");
   st->SetTitle("");
   st->SetMinimum(37.51364);
   st->SetMaximum(3.887632e+10);
   
   TH1F *st_stack_275 = new TH1F("st_stack_275","",30,0,6);
   st_stack_275->SetMinimum(6.811066);
   st_stack_275->SetMaximum(1.089742e+11);
