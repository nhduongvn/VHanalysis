...
#endif
void nGenJet_all__bckg_18_logY()
{
...
//=========  (Mon Mar  6 10:58:23 2023) by ROOT version 6.26/06
   ...
   nGenJet_all__bckg_18->Range(-3.775293,-0.5018135,17.0745,13.61132);
   ...
   st->SetName("st");
   st->SetTitle("");
   st->SetMinimum(91.50456);
   
   TH1F *st_stack_6 = new TH1F("st_stack_6","",15,-0.5,14.5);
   st_stack_6->SetMinimum(15.55115);
   st_stack_6->SetMaximum(1.584915e+12);
