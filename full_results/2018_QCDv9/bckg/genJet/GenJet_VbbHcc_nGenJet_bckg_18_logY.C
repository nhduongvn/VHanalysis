...
#endif
void GenJet_VbbHcc_nGenJet_bckg_18_logY()
{
//=========Macro generated from canvas: GenJet_VbbHcc_nGenJet_bckg_18/GenJet_VbbHcc_nGenJet_bckg_18
//=========  (Thu Mar  9 15:52:24 2023) by ROOT version 6.26/06
   TCanvas *GenJet_VbbHcc_nGenJet_bckg_18 = new TCanvas("GenJet_VbbHcc_nGenJet_bckg_18", "GenJet_VbbHcc_nGenJet_bckg_18",0,0,600,600);
   GenJet_VbbHcc_nGenJet_bckg_18->SetHighLightColor(2);
   GenJet_VbbHcc_nGenJet_bckg_18->Range(-4.867058,-nan,22.93266,-nan);
   GenJet_VbbHcc_nGenJet_bckg_18->SetFillColor(0);
   GenJet_VbbHcc_nGenJet_bckg_18->SetFillStyle(4000);
   GenJet_VbbHcc_nGenJet_bckg_18->SetBorderMode(0);
   GenJet_VbbHcc_nGenJet_bckg_18->SetBorderSize(2);
   GenJet_VbbHcc_nGenJet_bckg_18->SetLogy();
   GenJet_VbbHcc_nGenJet_bckg_18->SetLeftMargin(0.15709);
   GenJet_VbbHcc_nGenJet_bckg_18->SetRightMargin(0.1234783);
   GenJet_VbbHcc_nGenJet_bckg_18->SetBottomMargin(0.12);
   GenJet_VbbHcc_nGenJet_bckg_18->SetFrameFillStyle(1000);
   GenJet_VbbHcc_nGenJet_bckg_18->SetFrameBorderMode(0);
   GenJet_VbbHcc_nGenJet_bckg_18->SetFrameFillStyle(1000);
   GenJet_VbbHcc_nGenJet_bckg_18->SetFrameBorderMode(0);
   ...
   TH1F *st_stack_150 = new TH1F("st_stack_150","",20,-0.5,19.5);
   st_stack_150->SetMinimum(-0);
   st_stack_150->SetMaximum(-nan);
...
tex->SetNDC();
   ...
   tex->SetLineWidth(2);
   tex->Draw();
   GenJet_VbbHcc_nGenJet_bckg_18->Modified();
   GenJet_VbbHcc_nGenJet_bckg_18->cd();
   GenJet_VbbHcc_nGenJet_bckg_18->SetSelected(GenJet_VbbHcc_nGenJet_bckg_18);
}
