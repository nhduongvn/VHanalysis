...
#endif
void GenJet_VbbHcc_eta_bckg_18_logY()
{
...
//=========  (Thu Mar  9 15:52:25 2023) by ROOT version 6.26/06
   ...
   GenJet_VbbHcc_eta_bckg_18->Range(-3.591764,-nan,3.358166,-nan);
   ...
   GenJet_VbbHcc_eta_bckg_18->SetLogy();
