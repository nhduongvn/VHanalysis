...
//=========  (Tue Feb 14 16:02:02 2023) by ROOT version 6.26/06
   ...
   Z_dR_Bj0_algo_18->Range(-1.310117,-0.9709172,7.029799,9.859333);
   ...
   st->SetTitle("");
   st->SetMinimum(10);
   st->SetMaximum(2.412518e+08);
   
   TH1F *st_stack_115 = new TH1F("st_stack_115","",30,0,6);
   st_stack_115->SetMinimum(2.131635);
   st_stack_115->SetMaximum(5.974586e+08);
