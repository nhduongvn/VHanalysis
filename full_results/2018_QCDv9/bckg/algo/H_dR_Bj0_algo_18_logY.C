...
//=========  (Mon Dec 19 11:15:39 2022) by ROOT version 6.26/06
   ...
   H_dR_Bj0_algo_18->Range(-1.310117,-0.9732666,7.029799,9.872302);
   ...
   st->SetTitle("");
   st->SetMinimum(10);
   st->SetMaximum(2.474686e+08);
   
   TH1F *st_stack_99 = new TH1F("st_stack_99","",30,0,6);
   st_stack_99->SetMinimum(2.129127);
   st_stack_99->SetMaximum(6.134014e+08);
