...
#endif
void dR_bjets_truth_algo_bckg_18_logY()
{
//=========Macro generated from canvas: dR_bjets_truth_algo_bckg_18/dR_bjets_truth_algo_bckg_18
//=========  (Thu Mar  2 13:32:45 2023) by ROOT version 6.26/06
   TCanvas *dR_bjets_truth_algo_bckg_18 = new TCanvas("dR_bjets_truth_algo_bckg_18", "dR_bjets_truth_algo_bckg_18",0,0,600,600);
   dR_bjets_truth_algo_bckg_18->SetHighLightColor(2);
   dR_bjets_truth_algo_bckg_18->Range(-1.310117,-0.1538462,7.029799,1.128205);
   dR_bjets_truth_algo_bckg_18->SetFillColor(0);
   dR_bjets_truth_algo_bckg_18->SetFillStyle(4000);
   dR_bjets_truth_algo_bckg_18->SetBorderMode(0);
   dR_bjets_truth_algo_bckg_18->SetBorderSize(2);
   dR_bjets_truth_algo_bckg_18->SetLogy();
   dR_bjets_truth_algo_bckg_18->SetLeftMargin(0.15709);
   dR_bjets_truth_algo_bckg_18->SetRightMargin(0.1234783);
   dR_bjets_truth_algo_bckg_18->SetBottomMargin(0.12);
   dR_bjets_truth_algo_bckg_18->SetFrameFillStyle(1000);
   dR_bjets_truth_algo_bckg_18->SetFrameBorderMode(0);
   dR_bjets_truth_algo_bckg_18->SetFrameFillStyle(1000);
   dR_bjets_truth_algo_bckg_18->SetFrameBorderMode(0);
   ...
   TH1F *st_stack_18 = new TH1F("st_stack_18","",60,0,6);
   st_stack_18->SetMinimum(-0);
   st_stack_18->SetMaximum(-nan);
   ...
   st_stack_18->GetXaxis()->SetTitle("#Delta R(b,b-jet)");
   st_stack_18->GetXaxis()->SetRange(1,60);
   st_stack_18->GetXaxis()->SetLabelFont(42);
   st_stack_18->GetXaxis()->SetTitleOffset(1);
   st_stack_18->GetXaxis()->SetTitleFont(42);
   st_stack_18->GetYaxis()->SetTitle("Events/0.1");
   ...
   TLegendEntry *entry=leg->AddEntry("VbbHcc_eff_algo_dR_bjets_truth_stack_2","t#bar{t}","F");
   ...
   entry=leg->AddEntry("VbbHcc_eff_algo_dR_bjets_truth_stack_1","QCD","F");
...
tex->SetNDC();
   ...
   tex->SetLineWidth(2);
   tex->Draw();
   dR_bjets_truth_algo_bckg_18->Modified();
   dR_bjets_truth_algo_bckg_18->cd();
   dR_bjets_truth_algo_bckg_18->SetSelected(dR_bjets_truth_algo_bckg_18);
}
