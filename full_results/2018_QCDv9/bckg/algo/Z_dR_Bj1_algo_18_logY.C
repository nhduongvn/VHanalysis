...
//=========  (Wed Jan 18 11:42:53 2023) by ROOT version 6.26/06
   ...
   Z_dR_Bj1_algo_18->Range(-1.310117,-0.9502385,7.029799,9.745341);
   ...
   st->SetTitle("");
   st->SetMinimum(10);
   st->SetMaximum(1.929144e+08);
   
   TH1F *st_stack_119 = new TH1F("st_stack_119","",30,0,6);
   st_stack_119->SetMinimum(2.153927);
   st_stack_119->SetMaximum(4.740047e+08);
