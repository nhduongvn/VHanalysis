...
//=========  (Mon Dec 19 11:02:03 2022) by ROOT version 6.26/06
   ...
   nC_medium_jets_18->Range(-2.683529,-3.24161,11.21633,16.76039);
   ...
   st->SetName("st");
   st->SetTitle("");
   st->SetMinimum(1.160854);
   st->SetMaximum(1.506002e+14);
   
   TH1F *st_stack_23 = new TH1F("st_stack_23","",10,-0.5,9.5);
   st_stack_23->SetMinimum(0.1440886);
   st_stack_23->SetMaximum(5.756858e+14);
