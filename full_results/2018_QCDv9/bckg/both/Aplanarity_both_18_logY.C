...
//=========  (Wed Jan 18 11:42:54 2023) by ROOT version 6.26/06
   ...
   Aplanarity_both_18->Range(-0.2183529,-1.23161,1.171633,11.31962);
   ...
   st->SetTitle("");
   st->SetMinimum(10);
   st->SetMaximum(4.256018e+09);
   
   TH1F *st_stack_191 = new TH1F("st_stack_191","",50,0,1);
   st_stack_191->SetMinimum(1.881644);
   st_stack_191->SetMaximum(1.160106e+10);
