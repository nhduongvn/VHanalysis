...
#endif
void dR_cjets_truth_both_bckg_18_logY()
{
//=========Macro generated from canvas: dR_cjets_truth_both_bckg_18/dR_cjets_truth_both_bckg_18
//=========  (Thu Mar  2 13:32:45 2023) by ROOT version 6.26/06
   TCanvas *dR_cjets_truth_both_bckg_18 = new TCanvas("dR_cjets_truth_both_bckg_18", "dR_cjets_truth_both_bckg_18",0,0,600,600);
   dR_cjets_truth_both_bckg_18->SetHighLightColor(2);
   dR_cjets_truth_both_bckg_18->Range(-1.310117,-0.1538462,7.029799,1.128205);
   dR_cjets_truth_both_bckg_18->SetFillColor(0);
   dR_cjets_truth_both_bckg_18->SetFillStyle(4000);
   dR_cjets_truth_both_bckg_18->SetBorderMode(0);
   dR_cjets_truth_both_bckg_18->SetBorderSize(2);
   dR_cjets_truth_both_bckg_18->SetLogy();
   dR_cjets_truth_both_bckg_18->SetLeftMargin(0.15709);
   dR_cjets_truth_both_bckg_18->SetRightMargin(0.1234783);
   dR_cjets_truth_both_bckg_18->SetBottomMargin(0.12);
   dR_cjets_truth_both_bckg_18->SetFrameFillStyle(1000);
   dR_cjets_truth_both_bckg_18->SetFrameBorderMode(0);
   dR_cjets_truth_both_bckg_18->SetFrameFillStyle(1000);
   dR_cjets_truth_both_bckg_18->SetFrameBorderMode(0);
   ...
   TH1F *st_stack_36 = new TH1F("st_stack_36","",60,0,6);
   st_stack_36->SetMinimum(-0);
   st_stack_36->SetMaximum(-nan);
   ...
   st_stack_36->GetXaxis()->SetTitle("#Delta R(c,c-jet)");
   st_stack_36->GetXaxis()->SetRange(1,60);
...
tex->SetNDC();
   ...
   tex->SetLineWidth(2);
   tex->Draw();
   dR_cjets_truth_both_bckg_18->Modified();
   dR_cjets_truth_both_bckg_18->cd();
   dR_cjets_truth_both_bckg_18->SetSelected(dR_cjets_truth_both_bckg_18);
}
