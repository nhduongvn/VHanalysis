...
//=========  (Mon Dec 19 11:02:05 2022) by ROOT version 6.26/06
   ...
   CvB_jets_all_18->Range(-0.2183529,5.295957,1.171633,15.60718);
   ...
   st->SetName("st");
   st->SetTitle("");
   st->SetMinimum(1.537913e+07);
   st->SetMaximum(1.568698e+14);
   
   TH1F *st_stack_119 = new TH1F("st_stack_119","",20,0,1);
   st_stack_119->SetMinimum(3414319);
   st_stack_119->SetMaximum(3.767576e+14);
