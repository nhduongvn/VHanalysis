...
#endif
void nB_medium_jets_all_18_logY()
{
...
//=========  (Mon Dec 19 11:02:06 2022) by ROOT version 6.26/06
   ...
   nB_medium_jets_all_18->Range(-2.683529,-2.141387,11.21633,16.68677);
   ...
   st->SetTitle("");
   st->SetMinimum(10);
   st->SetMaximum(1.745238e+14);
   
   TH1F *st_stack_123 = new TH1F("st_stack_123","",10,-0.5,9.5);
   st_stack_123->SetMinimum(1.312176);
   st_stack_123->SetMaximum(6.367277e+14);
