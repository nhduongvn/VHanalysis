...
//=========  (Mon Dec 19 11:15:37 2022) by ROOT version 6.26/06
   ...
   H_dR_tags_18->Range(-1.353788,-2.190235,7.264125,10.67266);
   ...
   st->SetName("st");
   st->SetTitle("");
   st->SetMinimum(1.224457);
   st->SetMaximum(8.784387e+08);
   
   TH1F *st_stack_23 = new TH1F("st_stack_23","",30,0,6);
   st_stack_23->SetMinimum(0.2255865);
   st_stack_23->SetMaximum(2.434288e+09);
