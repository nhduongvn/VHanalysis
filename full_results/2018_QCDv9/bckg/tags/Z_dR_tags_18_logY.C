...
//=========  (Wed Jan 18 11:42:51 2023) by ROOT version 6.26/06
   ...
   Z_dR_tags_18->Range(-1.310117,-2.051379,7.029799,10.58251);
   ...
   st->SetName("st");
   st->SetTitle("");
   st->SetMinimum(1.558115);
   st->SetMaximum(7.615796e+08);
   
   TH1F *st_stack_19 = new TH1F("st_stack_19","",30,0,6);
   st_stack_19->SetMinimum(0.291533);
   st_stack_19->SetMaximum(2.08507e+09);
