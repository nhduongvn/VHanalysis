...
//=========  (Mon Dec 19 11:15:37 2022) by ROOT version 6.26/06
   ...
   Z_dR_tags_18->Range(-1.310117,-2.106991,7.029799,10.59321);
   ...
   st->SetName("st");
   st->SetTitle("");
   st->SetMinimum(1.402494);
   st->SetMaximum(7.660527e+08);
   
   TH1F *st_stack_19 = new TH1F("st_stack_19","",30,0,6);
   st_stack_19->SetMinimum(0.2612364);
   st_stack_19->SetMaximum(2.104708e+09);
