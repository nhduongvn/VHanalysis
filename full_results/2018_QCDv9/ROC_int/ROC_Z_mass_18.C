...
//=========  (Wed Jan 25 10:51:22 2023) by ROOT version 6.26/06
   ...
   0.8468579,
   0.8670663};
   TGraph *graph = new TGraph(8,Graph_fx50,Graph_fy50);
   graph->SetName("Graph");
   ...
   TH1F *Graph_Graph50 = new TH1F("Graph_Graph50","Tagging Only",100,0,0.863154);
   Graph_Graph50->SetMinimum(0.1234857);
   Graph_Graph50->SetMaximum(0.9346645);
   ...
   TLatex *   tex = new TLatex(0.06924884,0.2923408,"#pm0");
   tex->SetTextSize(0.02);
   tex->SetLineWidth(2);
   tex->Draw();
   graph->GetListOfFunctions()->Add(51);
      tex = new TLatex(0.2374241,0.6644368,"#pm1");
   tex->SetTextSize(0.02);
   tex->SetLineWidth(2);
   tex->Draw();
   graph->GetListOfFunctions()->Add(52);
      tex = new TLatex(0.3990098,0.8560993,"#pm2");
   tex->SetTextSize(0.02);
   tex->SetLineWidth(2);
   tex->Draw();
   graph->GetListOfFunctions()->Add(53);
      tex = new TLatex(0.5315278,0.930751,"#pm3");
   tex->SetTextSize(0.02);
   tex->SetLineWidth(2);
   tex->Draw();
   graph->GetListOfFunctions()->Add(54);
      tex = new TLatex(0.6812387,0.9740134,"#pm4");
   tex->SetTextSize(0.02);
   tex->SetLineWidth(2);
   tex->Draw();
   ...
   0.9625961,
   0.9680196};
   graph = new TGraph(8,Graph_fx56,Graph_fy56);
   graph->SetName("Graph");
   ...
   TH1F *Graph_Graph56 = new TH1F("Graph_Graph56","Mass-Matching Prioritized",100,0,1.006697);
   Graph_Graph56->SetMinimum(0.180773);
   Graph_Graph56->SetMaximum(1.039587);
   ...
   0.83616,
   0.8576833};
   graph = new TGraph(8,Graph_fx57,Graph_fy57);
   graph->SetName("Graph");
   ...
   TH1F *Graph_Graph57 = new TH1F("Graph_Graph57","Tagging Prioritized",100,0,0.8613955);
   Graph_Graph57->SetMinimum(0.1181714);
   Graph_Graph57->SetMaximum(0.9249117);
