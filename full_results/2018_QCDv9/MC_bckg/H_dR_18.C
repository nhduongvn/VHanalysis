...
void H_dR_18()
{
//=========Macro generated from canvas: H_dR_18/H_dR_18
//=========  (Thu Feb 16 13:12:21 2023) by ROOT version 6.26/06
   TCanvas *H_dR_18 = new TCanvas("H_dR_18", "H_dR_18",0,0,600,600);
   H_dR_18->SetHighLightColor(2);
   H_dR_18->Range(-1.353788,-0.1538462,7.264125,1.128205);
   H_dR_18->SetFillColor(0);
   H_dR_18->SetFillStyle(4000);
   H_dR_18->SetBorderMode(0);
   H_dR_18->SetBorderSize(2);
   H_dR_18->SetLeftMargin(0.15709);
   H_dR_18->SetRightMargin(0.1234783);
   H_dR_18->SetBottomMargin(0.12);
   H_dR_18->SetFrameFillStyle(1000);
   H_dR_18->SetFrameBorderMode(0);
   H_dR_18->SetFrameFillStyle(1000);
   H_dR_18->SetFrameBorderMode(0);
