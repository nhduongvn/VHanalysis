...
// ------------>Primitives in pad: topPad
   ...
   VbbHcc_duong_CutFlow_stack_1->SetBinContent(1,5.572955e+10);
   VbbHcc_duong_CutFlow_stack_1->SetBinContent(2,5.572848e+10);
   VbbHcc_duong_CutFlow_stack_1->SetBinContent(3,5.387062e+09);
   VbbHcc_duong_CutFlow_stack_1->SetBinContent(4,1.28725e+07);
   VbbHcc_duong_CutFlow_stack_1->SetBinContent(5,1.28725e+07);
   VbbHcc_duong_CutFlow_stack_1->SetBinError(1,8471090);
   VbbHcc_duong_CutFlow_stack_1->SetBinError(2,8471008);
   VbbHcc_duong_CutFlow_stack_1->SetBinError(3,2633738);
   VbbHcc_duong_CutFlow_stack_1->SetBinError(4,128744.3);
   VbbHcc_duong_CutFlow_stack_1->SetBinError(5,128744.3);
   VbbHcc_duong_CutFlow_stack_1->SetEntries(9.076388e+07);
   ...
   VbbHcc_duong_CutFlow_stack_2->SetBinContent(1,1.035228e+07);
   VbbHcc_duong_CutFlow_stack_2->SetBinContent(2,1.015225e+07);
   VbbHcc_duong_CutFlow_stack_2->SetBinContent(3,2340385);
   VbbHcc_duong_CutFlow_stack_2->SetBinContent(4,148216.7);
   VbbHcc_duong_CutFlow_stack_2->SetBinContent(5,148216.7);
   VbbHcc_duong_CutFlow_stack_2->SetBinError(1,1034.78);
   VbbHcc_duong_CutFlow_stack_2->SetBinError(2,1018.087);
   VbbHcc_duong_CutFlow_stack_2->SetBinError(3,583.2034);
   VbbHcc_duong_CutFlow_stack_2->SetBinError(4,148.284);
   VbbHcc_duong_CutFlow_stack_2->SetBinError(5,148.284);
   VbbHcc_duong_CutFlow_stack_2->SetEntries(4.149629e+08);
   ...
   VbbHcc_duong_CutFlow_stack_3->SetBinContent(1,2.981925e+07);
   VbbHcc_duong_CutFlow_stack_3->SetBinContent(2,2.837201e+07);
   VbbHcc_duong_CutFlow_stack_3->SetBinContent(3,1.745421e+07);
   VbbHcc_duong_CutFlow_stack_3->SetBinContent(4,2179116);
   VbbHcc_duong_CutFlow_stack_3->SetBinContent(5,2179116);
   VbbHcc_duong_CutFlow_stack_3->SetBinError(1,1292.715);
   VbbHcc_duong_CutFlow_stack_3->SetBinError(2,1266.199);
   VbbHcc_duong_CutFlow_stack_3->SetBinError(3,1022.11);
   VbbHcc_duong_CutFlow_stack_3->SetBinError(4,366.0251);
   VbbHcc_duong_CutFlow_stack_3->SetBinError(5,366.0251);
   VbbHcc_duong_CutFlow_stack_3->SetEntries(1.469409e+09);
   ...
   VbbHcc_duong_CutFlow_stack_4->SetBinContent(1,4095440);
   VbbHcc_duong_CutFlow_stack_4->SetBinContent(2,4091236);
   VbbHcc_duong_CutFlow_stack_4->SetBinContent(3,2074511);
   VbbHcc_duong_CutFlow_stack_4->SetBinContent(4,36866.06);
   VbbHcc_duong_CutFlow_stack_4->SetBinContent(5,36866.06);
   VbbHcc_duong_CutFlow_stack_4->SetBinError(1,1069.928);
   VbbHcc_duong_CutFlow_stack_4->SetBinError(2,1069.378);
   VbbHcc_duong_CutFlow_stack_4->SetBinError(3,761.4862);
   VbbHcc_duong_CutFlow_stack_4->SetBinError(4,101.512);
   VbbHcc_duong_CutFlow_stack_4->SetBinError(5,101.512);
   VbbHcc_duong_CutFlow_stack_4->SetEntries(3.69742e+07);
   ...
   VbbHcc_duong_CutFlow_stack_5->SetBinContent(1,9915843);
   VbbHcc_duong_CutFlow_stack_5->SetBinContent(2,9907940);
   VbbHcc_duong_CutFlow_stack_5->SetBinContent(3,4930094);
   VbbHcc_duong_CutFlow_stack_5->SetBinContent(4,20665.57);
   VbbHcc_duong_CutFlow_stack_5->SetBinContent(5,20665.57);
   VbbHcc_duong_CutFlow_stack_5->SetBinError(1,3198.752);
   VbbHcc_duong_CutFlow_stack_5->SetBinError(2,3197.477);
   VbbHcc_duong_CutFlow_stack_5->SetBinError(3,2255.503);
   VbbHcc_duong_CutFlow_stack_5->SetBinError(4,146.0291);
   VbbHcc_duong_CutFlow_stack_5->SetBinError(5,146.0291);
   VbbHcc_duong_CutFlow_stack_5->SetEntries(2.402903e+07);
   ...
   VbbHcc_duong_CutFlow_stack_6->SetBinContent(1,2721926);
   VbbHcc_duong_CutFlow_stack_6->SetBinContent(2,2680963);
   VbbHcc_duong_CutFlow_stack_6->SetBinContent(3,207649.3);
   VbbHcc_duong_CutFlow_stack_6->SetBinContent(4,612.6911);
   VbbHcc_duong_CutFlow_stack_6->SetBinContent(5,612.6911);
   VbbHcc_duong_CutFlow_stack_6->SetBinError(1,483.5971);
   VbbHcc_duong_CutFlow_stack_6->SetBinError(2,479.9444);
   VbbHcc_duong_CutFlow_stack_6->SetBinError(3,133.5706);
   VbbHcc_duong_CutFlow_stack_6->SetBinError(4,7.255483);
   VbbHcc_duong_CutFlow_stack_6->SetBinError(5,7.255483);
   VbbHcc_duong_CutFlow_stack_6->SetEntries(6.531429e+07);
   ...
   VbbHcc_duong_CutFlow_stack_7->SetBinContent(1,988715.3);
   VbbHcc_duong_CutFlow_stack_7->SetBinContent(2,966744);
   VbbHcc_duong_CutFlow_stack_7->SetBinContent(3,87547.31);
   VbbHcc_duong_CutFlow_stack_7->SetBinContent(4,1192.218);
   VbbHcc_duong_CutFlow_stack_7->SetBinContent(5,1192.218);
   VbbHcc_duong_CutFlow_stack_7->SetBinError(1,250.9883);
   VbbHcc_duong_CutFlow_stack_7->SetBinError(2,248.1838);
   VbbHcc_duong_CutFlow_stack_7->SetBinError(3,74.68599);
   VbbHcc_duong_CutFlow_stack_7->SetBinError(4,8.715567);
   VbbHcc_duong_CutFlow_stack_7->SetBinError(5,8.715567);
   VbbHcc_duong_CutFlow_stack_7->SetEntries(3.210265e+07);
   ...
   VbbHcc_duong_CutFlow_stack_8->SetBinContent(1,436440.5);
   VbbHcc_duong_CutFlow_stack_8->SetBinContent(2,425521.8);
   VbbHcc_duong_CutFlow_stack_8->SetBinContent(3,42590.71);
   VbbHcc_duong_CutFlow_stack_8->SetBinContent(4,1180.345);
   VbbHcc_duong_CutFlow_stack_8->SetBinContent(5,1180.345);
   VbbHcc_duong_CutFlow_stack_8->SetBinError(1,279.8041);
   VbbHcc_duong_CutFlow_stack_8->SetBinError(2,276.2819);
   VbbHcc_duong_CutFlow_stack_8->SetBinError(3,87.40755);
   VbbHcc_duong_CutFlow_stack_8->SetBinError(4,14.5511);
   VbbHcc_duong_CutFlow_stack_8->SetBinError(5,14.5511);
   VbbHcc_duong_CutFlow_stack_8->SetEntries(5055720);
   ...
   VbbHcc_duong_CutFlow_stack_9->SetBinContent(1,12889.16);
   VbbHcc_duong_CutFlow_stack_9->SetBinContent(2,12871.73);
   VbbHcc_duong_CutFlow_stack_9->SetBinContent(3,4059.265);
   VbbHcc_duong_CutFlow_stack_9->SetBinContent(4,439.6395);
   VbbHcc_duong_CutFlow_stack_9->SetBinContent(5,439.6395);
   VbbHcc_duong_CutFlow_stack_9->SetBinError(1,4.340257);
   VbbHcc_duong_CutFlow_stack_9->SetBinError(2,4.337374);
   VbbHcc_duong_CutFlow_stack_9->SetBinError(3,2.390571);
   VbbHcc_duong_CutFlow_stack_9->SetBinError(4,0.7862673);
   VbbHcc_duong_CutFlow_stack_9->SetBinError(5,0.7862673);
   VbbHcc_duong_CutFlow_stack_9->SetEntries(2.362713e+07);
   ...
   VbbHcc_duong_CutFlow_stack_10->SetBinContent(1,1790.231);
   VbbHcc_duong_CutFlow_stack_10->SetBinContent(2,1782.223);
   VbbHcc_duong_CutFlow_stack_10->SetBinContent(3,1103.671);
   VbbHcc_duong_CutFlow_stack_10->SetBinContent(4,144.7921);
   VbbHcc_duong_CutFlow_stack_10->SetBinContent(5,144.7921);
   VbbHcc_duong_CutFlow_stack_10->SetBinError(1,0.8006157);
   VbbHcc_duong_CutFlow_stack_10->SetBinError(2,0.7988229);
   VbbHcc_duong_CutFlow_stack_10->SetBinError(3,0.6286218);
   VbbHcc_duong_CutFlow_stack_10->SetBinError(4,0.227689);
   VbbHcc_duong_CutFlow_stack_10->SetBinError(5,0.227689);
   ...
   VbbHcc_duong_CutFlow_stack_11->SetBinContent(1,640.1367);
   VbbHcc_duong_CutFlow_stack_11->SetBinContent(2,639.6454);
   VbbHcc_duong_CutFlow_stack_11->SetBinContent(3,221.0844);
   VbbHcc_duong_CutFlow_stack_11->SetBinContent(4,7.726185);
   VbbHcc_duong_CutFlow_stack_11->SetBinContent(5,7.726185);
   VbbHcc_duong_CutFlow_stack_11->SetBinError(1,0.9905948);
   VbbHcc_duong_CutFlow_stack_11->SetBinError(2,0.9902229);
   VbbHcc_duong_CutFlow_stack_11->SetBinError(3,0.5712739);
   VbbHcc_duong_CutFlow_stack_11->SetBinError(4,0.1066954);
   VbbHcc_duong_CutFlow_stack_11->SetBinError(5,0.1066954);
   VbbHcc_duong_CutFlow_stack_11->SetEntries(1113459);
   ...
   VbbHcc_duong_CutFlow_stack_12->SetBinContent(1,1893756);
   VbbHcc_duong_CutFlow_stack_12->SetBinContent(2,1888849);
   VbbHcc_duong_CutFlow_stack_12->SetBinContent(3,1259072);
   VbbHcc_duong_CutFlow_stack_12->SetBinContent(4,62716.28);
   VbbHcc_duong_CutFlow_stack_12->SetBinContent(5,62716.28);
   VbbHcc_duong_CutFlow_stack_12->SetBinError(1,2694.39);
   VbbHcc_duong_CutFlow_stack_12->SetBinError(2,2690.897);
   VbbHcc_duong_CutFlow_stack_12->SetBinError(3,2196.968);
   VbbHcc_duong_CutFlow_stack_12->SetBinError(4,490.3302);
   VbbHcc_duong_CutFlow_stack_12->SetBinError(5,490.3302);
   VbbHcc_duong_CutFlow_stack_12->SetEntries(1347878);
   ...
   TH1D *VbbHcc_duong_CutFlow__65 = new TH1D("VbbHcc_duong_CutFlow__65","",5,0,5);
   VbbHcc_duong_CutFlow__65->SetBinContent(1,5.534693e+08);
   VbbHcc_duong_CutFlow__65->SetBinContent(2,5.497068e+08);
   VbbHcc_duong_CutFlow__65->SetBinContent(3,2.530938e+08);
   VbbHcc_duong_CutFlow__65->SetBinContent(4,8257513);
   VbbHcc_duong_CutFlow__65->SetBinContent(5,8257513);
   VbbHcc_duong_CutFlow__65->SetEntries(1.372785e+09);

   ci = TColor::GetColor("#000099");
   VbbHcc_duong_CutFlow__65->SetLineColor(ci);
   VbbHcc_duong_CutFlow__65->SetLineWidth(2);
   VbbHcc_duong_CutFlow__65->SetMarkerStyle(20);
   VbbHcc_duong_CutFlow__65->SetMarkerSize(1.2);
   VbbHcc_duong_CutFlow__65->GetXaxis()->SetBinLabel(1,"Total");
   VbbHcc_duong_CutFlow__65->GetXaxis()->SetBinLabel(2,"MET cut");
   VbbHcc_duong_CutFlow__65->GetXaxis()->SetBinLabel(3,"jet cuts");
   VbbHcc_duong_CutFlow__65->GetXaxis()->SetBinLabel(4,"b-tags");
   VbbHcc_duong_CutFlow__65->GetXaxis()->SetBinLabel(5,"c-tags");
   VbbHcc_duong_CutFlow__65->GetXaxis()->SetRange(1,5);
   VbbHcc_duong_CutFlow__65->GetXaxis()->SetLabelFont(42);
   VbbHcc_duong_CutFlow__65->GetXaxis()->SetLabelSize(0.035);
   VbbHcc_duong_CutFlow__65->GetXaxis()->SetTitleSize(0.035);
   VbbHcc_duong_CutFlow__65->GetXaxis()->SetTitleFont(42);
   VbbHcc_duong_CutFlow__65->GetYaxis()->SetLabelFont(42);
   VbbHcc_duong_CutFlow__65->GetYaxis()->SetLabelSize(0.035);
   VbbHcc_duong_CutFlow__65->GetYaxis()->SetTitleSize(0.035);
   VbbHcc_duong_CutFlow__65->GetYaxis()->SetTitleOffset(0);
   VbbHcc_duong_CutFlow__65->GetYaxis()->SetTitleFont(42);
   VbbHcc_duong_CutFlow__65->GetZaxis()->SetLabelFont(42);
   VbbHcc_duong_CutFlow__65->GetZaxis()->SetLabelSize(0.035);
   VbbHcc_duong_CutFlow__65->GetZaxis()->SetTitleSize(0.035);
   VbbHcc_duong_CutFlow__65->GetZaxis()->SetTitleFont(42);
   VbbHcc_duong_CutFlow__65->Draw("same E");
   
   Double_t Graph_from_VbbHcc_duong_CutFlow_fx1065[5] = {
   0.5,
   1.5,
   2.5,
   3.5,
   4.5};
   Double_t Graph_from_VbbHcc_duong_CutFlow_fy1065[5] = {
   5.578979e+10,
   5.578698e+10,
   5.415463e+09,
   1.532365e+07,
   1.532365e+07};
   Double_t Graph_from_VbbHcc_duong_CutFlow_fex1065[5] = {
   0.5,
   0.5,
   0.5,
   0.5,
   0.5};
   Double_t Graph_from_VbbHcc_duong_CutFlow_fey1065[5] = {
   8471091,
   8471010,
   2633740,
   128745.9,
   128745.9};
   TGraphErrors *gre = new TGraphErrors(5,Graph_from_VbbHcc_duong_CutFlow_fx1065,Graph_from_VbbHcc_duong_CutFlow_fy1065,Graph_from_VbbHcc_duong_CutFlow_fex1065,Graph_from_VbbHcc_duong_CutFlow_fey1065);
   ...
   TH1F *Graph_Graph_from_VbbHcc_duong_CutFlow1065 = new TH1F("Graph_Graph_from_VbbHcc_duong_CutFlow1065","",100,0,5.5);
   Graph_Graph_from_VbbHcc_duong_CutFlow1065->SetMinimum(1.367542e+07);
   Graph_Graph_from_VbbHcc_duong_CutFlow1065->SetMaximum(6.137656e+10);
   Graph_Graph_from_VbbHcc_duong_CutFlow1065->SetDirectory(0);
   Graph_Graph_from_VbbHcc_duong_CutFlow1065->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph_from_VbbHcc_duong_CutFlow1065->SetLineColor(ci);
   Graph_Graph_from_VbbHcc_duong_CutFlow1065->GetXaxis()->SetLabelFont(42);
   Graph_Graph_from_VbbHcc_duong_CutFlow1065->GetXaxis()->SetLabelSize(0.035);
   Graph_Graph_from_VbbHcc_duong_CutFlow1065->GetXaxis()->SetTitleSize(0.035);
   Graph_Graph_from_VbbHcc_duong_CutFlow1065->GetXaxis()->SetTitleFont(42);
   Graph_Graph_from_VbbHcc_duong_CutFlow1065->GetYaxis()->SetLabelFont(42);
   Graph_Graph_from_VbbHcc_duong_CutFlow1065->GetYaxis()->SetLabelSize(0.035);
   Graph_Graph_from_VbbHcc_duong_CutFlow1065->GetYaxis()->SetTitleSize(0.035);
   Graph_Graph_from_VbbHcc_duong_CutFlow1065->GetYaxis()->SetTitleOffset(0);
   Graph_Graph_from_VbbHcc_duong_CutFlow1065->GetYaxis()->SetTitleFont(42);
   Graph_Graph_from_VbbHcc_duong_CutFlow1065->GetZaxis()->SetLabelFont(42);
   Graph_Graph_from_VbbHcc_duong_CutFlow1065->GetZaxis()->SetLabelSize(0.035);
   Graph_Graph_from_VbbHcc_duong_CutFlow1065->GetZaxis()->SetTitleSize(0.035);
   Graph_Graph_from_VbbHcc_duong_CutFlow1065->GetZaxis()->SetTitleFont(42);
   gre->SetHistogram(Graph_Graph_from_VbbHcc_duong_CutFlow1065);
   ...
   TLegendEntry *entry=leg->AddEntry("VbbHcc_duong_CutFlow","Data (JetHT, 2016)","p");
...
// ------------>Primitives in pad: bottomPad
   ...
   data_mc_ratio__66->SetBinContent(4,0.5388736);
   data_mc_ratio__66->SetBinContent(5,0.5388736);
   ...
   data_mc_ratio__66->SetBinError(4,0.0001875264);
   data_mc_ratio__66->SetBinError(5,0.0001875264);
   data_mc_ratio__66->SetMinimum(0.4);
   data_mc_ratio__66->SetMaximum(1.6);
   data_mc_ratio__66->SetEntries(31882.39);
   ...
   Graph_Graph_from_mc_statistical_error1066->SetMinimum(0.9899179);
   Graph_Graph_from_mc_statistical_error1066->SetMaximum(1.010082);
