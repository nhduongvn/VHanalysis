...
// ------------>Primitives in pad: topPad
   ...
   VbbHcc_tags_CutFlow_stack_1->SetBinContent(2,6.452713e+10);
   VbbHcc_tags_CutFlow_stack_1->SetBinContent(3,6.470291e+09);
   VbbHcc_tags_CutFlow_stack_1->SetBinContent(4,2.250565e+08);
   VbbHcc_tags_CutFlow_stack_1->SetBinContent(5,1.921333e+07);
   VbbHcc_tags_CutFlow_stack_1->SetBinError(1,8511159);
   VbbHcc_tags_CutFlow_stack_1->SetBinError(2,8510570);
   VbbHcc_tags_CutFlow_stack_1->SetBinError(3,2694942);
   VbbHcc_tags_CutFlow_stack_1->SetBinError(4,502612.4);
   VbbHcc_tags_CutFlow_stack_1->SetBinError(5,146855);
   VbbHcc_tags_CutFlow_stack_1->SetEntries(1.209633e+08);
   ...
   VbbHcc_tags_CutFlow_stack_2->SetBinContent(2,1.173642e+07);
   VbbHcc_tags_CutFlow_stack_2->SetBinContent(3,2738942);
   VbbHcc_tags_CutFlow_stack_2->SetBinContent(4,981162.8);
   VbbHcc_tags_CutFlow_stack_2->SetBinContent(5,198720.9);
   VbbHcc_tags_CutFlow_stack_2->SetBinError(1,1120.847);
   VbbHcc_tags_CutFlow_stack_2->SetBinError(2,1101.902);
   VbbHcc_tags_CutFlow_stack_2->SetBinError(3,630.4643);
   VbbHcc_tags_CutFlow_stack_2->SetBinError(4,360.4723);
   VbbHcc_tags_CutFlow_stack_2->SetBinError(5,172.0188);
   VbbHcc_tags_CutFlow_stack_2->SetEntries(4.681022e+08);
   ...
   VbbHcc_tags_CutFlow_stack_3->SetBinContent(2,3.275408e+07);
   VbbHcc_tags_CutFlow_stack_3->SetBinContent(3,2.02548e+07);
   VbbHcc_tags_CutFlow_stack_3->SetBinContent(4,1.082366e+07);
   VbbHcc_tags_CutFlow_stack_3->SetBinContent(5,2859399);
   VbbHcc_tags_CutFlow_stack_3->SetBinError(1,1386.565);
   VbbHcc_tags_CutFlow_stack_3->SetBinError(2,1358.379);
   VbbHcc_tags_CutFlow_stack_3->SetBinError(3,1108.581);
   VbbHcc_tags_CutFlow_stack_3->SetBinError(4,805.989);
   VbbHcc_tags_CutFlow_stack_3->SetBinError(5,423.6317);
   VbbHcc_tags_CutFlow_stack_3->SetEntries(1.904093e+09);
   ...
   VbbHcc_tags_CutFlow_stack_4->SetBinContent(2,4734947);
   VbbHcc_tags_CutFlow_stack_4->SetBinContent(3,2405500);
   VbbHcc_tags_CutFlow_stack_4->SetBinContent(4,301958.7);
   VbbHcc_tags_CutFlow_stack_4->SetBinContent(5,47888.17);
   VbbHcc_tags_CutFlow_stack_4->SetBinError(1,1266.741);
   VbbHcc_tags_CutFlow_stack_4->SetBinError(2,1265.717);
   VbbHcc_tags_CutFlow_stack_4->SetBinError(3,902.1563);
   VbbHcc_tags_CutFlow_stack_4->SetBinError(4,319.6339);
   VbbHcc_tags_CutFlow_stack_4->SetBinError(5,127.2897);
   VbbHcc_tags_CutFlow_stack_4->SetEntries(3.615525e+07);
   ...
   VbbHcc_tags_CutFlow_stack_5->SetBinContent(3,5717605);
   VbbHcc_tags_CutFlow_stack_5->SetBinContent(4,145027.3);
   VbbHcc_tags_CutFlow_stack_5->SetBinContent(5,29902.32);
   VbbHcc_tags_CutFlow_stack_5->SetBinError(1,3644.351);
   VbbHcc_tags_CutFlow_stack_5->SetBinError(2,3641.92);
   VbbHcc_tags_CutFlow_stack_5->SetBinError(3,2571.603);
   VbbHcc_tags_CutFlow_stack_5->SetBinError(4,409.5641);
   VbbHcc_tags_CutFlow_stack_5->SetBinError(5,185.9728);
   VbbHcc_tags_CutFlow_stack_5->SetEntries(2.493692e+07);
   ...
   VbbHcc_tags_CutFlow_stack_6->SetBinContent(2,3100617);
   VbbHcc_tags_CutFlow_stack_6->SetBinContent(3,246164.8);
   VbbHcc_tags_CutFlow_stack_6->SetBinContent(4,5535.545);
   VbbHcc_tags_CutFlow_stack_6->SetBinContent(5,957.6719);
   VbbHcc_tags_CutFlow_stack_6->SetBinError(1,797.1833);
   VbbHcc_tags_CutFlow_stack_6->SetBinError(2,790.6525);
   VbbHcc_tags_CutFlow_stack_6->SetBinError(3,222.7792);
   VbbHcc_tags_CutFlow_stack_6->SetBinError(4,33.40733);
   VbbHcc_tags_CutFlow_stack_6->SetBinError(5,13.89536);
   VbbHcc_tags_CutFlow_stack_6->SetEntries(3.226606e+07);
   ...
   VbbHcc_tags_CutFlow_stack_8->SetBinContent(2,492130.6);
   VbbHcc_tags_CutFlow_stack_8->SetBinContent(3,50561.34);
   VbbHcc_tags_CutFlow_stack_8->SetBinContent(4,9575.108);
   VbbHcc_tags_CutFlow_stack_8->SetBinContent(5,1578.606);
   VbbHcc_tags_CutFlow_stack_8->SetBinError(1,307.2403);
   VbbHcc_tags_CutFlow_stack_8->SetBinError(2,303.1777);
   VbbHcc_tags_CutFlow_stack_8->SetBinError(3,97.17765);
   VbbHcc_tags_CutFlow_stack_8->SetBinError(4,42.28915);
   VbbHcc_tags_CutFlow_stack_8->SetBinError(5,17.17094);
   VbbHcc_tags_CutFlow_stack_8->SetEntries(5671340);
   ...
   VbbHcc_tags_CutFlow_stack_11->SetBinContent(5,9.611348);
   ...
   VbbHcc_tags_CutFlow_stack_11->SetBinError(5,0.1256501);
   VbbHcc_tags_CutFlow_stack_11->SetEntries(1195513);
   ...
   VbbHcc_tags_CutFlow_stack_12->SetBinContent(5,57290.96);
   ...
   VbbHcc_tags_CutFlow_stack_12->SetBinError(5,518.9645);
   VbbHcc_tags_CutFlow_stack_12->SetEntries(1301917);
   ...
   TH1D *VbbHcc_tags_CutFlow__67 = new TH1D("VbbHcc_tags_CutFlow__67","",5,0,5);
   VbbHcc_tags_CutFlow__67->SetBinContent(1,3.063729e+08);
   VbbHcc_tags_CutFlow__67->SetBinContent(2,3.025317e+08);
   VbbHcc_tags_CutFlow__67->SetBinContent(3,9.926474e+07);
   VbbHcc_tags_CutFlow__67->SetBinContent(4,1.101098e+07);
   VbbHcc_tags_CutFlow__67->SetBinContent(5,3591844);
   VbbHcc_tags_CutFlow__67->SetEntries(7.227721e+08);

   ci = TColor::GetColor("#000099");
   VbbHcc_tags_CutFlow__67->SetLineColor(ci);
   VbbHcc_tags_CutFlow__67->SetLineWidth(2);
   VbbHcc_tags_CutFlow__67->SetMarkerStyle(20);
   VbbHcc_tags_CutFlow__67->SetMarkerSize(1.2);
   VbbHcc_tags_CutFlow__67->GetXaxis()->SetBinLabel(1,"Total");
   VbbHcc_tags_CutFlow__67->GetXaxis()->SetBinLabel(2,"MET cut");
   VbbHcc_tags_CutFlow__67->GetXaxis()->SetBinLabel(3,"jet cuts");
   VbbHcc_tags_CutFlow__67->GetXaxis()->SetBinLabel(4,"b-tags");
   VbbHcc_tags_CutFlow__67->GetXaxis()->SetBinLabel(5,"c-tags");
   VbbHcc_tags_CutFlow__67->GetXaxis()->SetRange(1,5);
   VbbHcc_tags_CutFlow__67->GetXaxis()->SetLabelFont(42);
   VbbHcc_tags_CutFlow__67->GetXaxis()->SetLabelSize(0.035);
   VbbHcc_tags_CutFlow__67->GetXaxis()->SetTitleSize(0.035);
   VbbHcc_tags_CutFlow__67->GetXaxis()->SetTitleFont(42);
   VbbHcc_tags_CutFlow__67->GetYaxis()->SetLabelFont(42);
   VbbHcc_tags_CutFlow__67->GetYaxis()->SetLabelSize(0.035);
   VbbHcc_tags_CutFlow__67->GetYaxis()->SetTitleSize(0.035);
   VbbHcc_tags_CutFlow__67->GetYaxis()->SetTitleOffset(0);
   VbbHcc_tags_CutFlow__67->GetYaxis()->SetTitleFont(42);
   VbbHcc_tags_CutFlow__67->GetZaxis()->SetLabelFont(42);
   VbbHcc_tags_CutFlow__67->GetZaxis()->SetLabelSize(0.035);
   VbbHcc_tags_CutFlow__67->GetZaxis()->SetTitleSize(0.035);
   VbbHcc_tags_CutFlow__67->GetZaxis()->SetTitleFont(42);
   VbbHcc_tags_CutFlow__67->Draw("same E");
   
   Double_t Graph_from_VbbHcc_tags_CutFlow_fx1067[5] = {
   0.5,
   1.5,
   2.5,
   3.5,
   4.5};
   Double_t Graph_from_VbbHcc_tags_CutFlow_fy1067[5] = {
   6.460582e+10,
   6.459474e+10,
   6.503222e+09,
   2.376125e+08,
   2.241148e+07};
   Double_t Graph_from_VbbHcc_tags_CutFlow_fex1067[5] = {
   0.5,
   0.5,
   0.5,
   0.5,
   0.5};
   Double_t Graph_from_VbbHcc_tags_CutFlow_fey1067[5] = {
   8511161,
   8510572,
   2694945,
   502614.7,
   146856.8};
   TGraphErrors *gre = new TGraphErrors(5,Graph_from_VbbHcc_tags_CutFlow_fx1067,Graph_from_VbbHcc_tags_CutFlow_fy1067,Graph_from_VbbHcc_tags_CutFlow_fex1067,Graph_from_VbbHcc_tags_CutFlow_fey1067);
   ...
   TH1F *Graph_Graph_from_VbbHcc_tags_CutFlow1067 = new TH1F("Graph_Graph_from_VbbHcc_tags_CutFlow1067","",100,0,5.5);
   Graph_Graph_from_VbbHcc_tags_CutFlow1067->SetMinimum(2.003816e+07);
   Graph_Graph_from_VbbHcc_tags_CutFlow1067->SetMaximum(7.107354e+10);
   Graph_Graph_from_VbbHcc_tags_CutFlow1067->SetDirectory(0);
   Graph_Graph_from_VbbHcc_tags_CutFlow1067->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph_from_VbbHcc_tags_CutFlow1067->SetLineColor(ci);
   Graph_Graph_from_VbbHcc_tags_CutFlow1067->GetXaxis()->SetLabelFont(42);
   Graph_Graph_from_VbbHcc_tags_CutFlow1067->GetXaxis()->SetLabelSize(0.035);
   Graph_Graph_from_VbbHcc_tags_CutFlow1067->GetXaxis()->SetTitleSize(0.035);
   Graph_Graph_from_VbbHcc_tags_CutFlow1067->GetXaxis()->SetTitleFont(42);
   Graph_Graph_from_VbbHcc_tags_CutFlow1067->GetYaxis()->SetLabelFont(42);
   Graph_Graph_from_VbbHcc_tags_CutFlow1067->GetYaxis()->SetLabelSize(0.035);
   Graph_Graph_from_VbbHcc_tags_CutFlow1067->GetYaxis()->SetTitleSize(0.035);
   Graph_Graph_from_VbbHcc_tags_CutFlow1067->GetYaxis()->SetTitleOffset(0);
   Graph_Graph_from_VbbHcc_tags_CutFlow1067->GetYaxis()->SetTitleFont(42);
   Graph_Graph_from_VbbHcc_tags_CutFlow1067->GetZaxis()->SetLabelFont(42);
   Graph_Graph_from_VbbHcc_tags_CutFlow1067->GetZaxis()->SetLabelSize(0.035);
   Graph_Graph_from_VbbHcc_tags_CutFlow1067->GetZaxis()->SetTitleSize(0.035);
   Graph_Graph_from_VbbHcc_tags_CutFlow1067->GetZaxis()->SetTitleFont(42);
   gre->SetHistogram(Graph_Graph_from_VbbHcc_tags_CutFlow1067);
   ...
   TLegendEntry *entry=leg->AddEntry("VbbHcc_tags_CutFlow","Data (JetHT, 2017)","p");
...
// ------------>Primitives in pad: bottomPad
   ...
   data_mc_ratio__68->SetBinContent(4,0.04634008);
   data_mc_ratio__68->SetBinContent(5,0.160268);
   ...
   data_mc_ratio__68->SetBinError(4,1.396509e-05);
   data_mc_ratio__68->SetBinError(5,8.45645e-05);
   data_mc_ratio__68->SetMinimum(0.4);
   data_mc_ratio__68->SetMaximum(1.6);
   data_mc_ratio__68->SetEntries(47770.53);
   ...
   Graph_Graph_from_mc_statistical_error1068->SetMinimum(0.9921367);
   Graph_Graph_from_mc_statistical_error1068->SetMaximum(1.007863);
