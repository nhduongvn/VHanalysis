...
//=========  (Wed Jan 18 11:42:57 2023) by ROOT version 6.26/06
   ...
   Aplanarity_seljet_16->Range(-0.2183529,-2.840641,1.171633,14.10316);
   ...
   st->SetName("st");
   st->SetTitle("");
   st->SetMinimum(1.078897);
   st->SetMaximum(7.606762e+11);
   
   TH1F *st_stack_317 = new TH1F("st_stack_317","",50,0,1);
   st_stack_317->SetMinimum(0.1558175);
   st_stack_317->SetMaximum(2.563208e+12);
