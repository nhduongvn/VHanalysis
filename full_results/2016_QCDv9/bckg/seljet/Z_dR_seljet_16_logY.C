...
//=========  (Wed Jan 18 11:42:56 2023) by ROOT version 6.26/06
   ...
   Z_dR_seljet_16->Range(-1.310117,0.1773074,7.029799,12.88407);
   ...
   st->SetName("st");
   st->SetTitle("");
   st->SetMinimum(270.5076);
   st->SetMaximum(1.49386e+11);
   
   TH1F *st_stack_273 = new TH1F("st_stack_273","",30,0,6);
   st_stack_273->SetMinimum(50.36386);
   st_stack_273->SetMaximum(4.105763e+11);
