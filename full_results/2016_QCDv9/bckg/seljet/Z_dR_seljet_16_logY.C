...
//=========  (Thu Feb 16 10:37:42 2023) by ROOT version 6.26/06
   ...
   Z_dR_seljet_16->Range(-1.310117,-0.9452639,7.029799,12.10945);
   ...
   st->SetName("st");
   st->SetTitle("");
   st->SetMinimum(22.9872);
   st->SetMaximum(2.274904e+10);
   
   TH1F *st_stack_273 = new TH1F("st_stack_273","",30,0,6);
   st_stack_273->SetMinimum(4.181211);
   st_stack_273->SetMaximum(6.367673e+10);
