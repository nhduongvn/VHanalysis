...
//=========  (Wed Jan 18 11:42:53 2023) by ROOT version 6.26/06
   ...
   Z_dR_Bj1_algo_16->Range(-1.310117,-0.8950108,7.029799,9.442314);
   ...
   st->SetTitle("");
   st->SetMinimum(10);
   st->SetMaximum(1.065076e+08);
   
   TH1F *st_stack_117 = new TH1F("st_stack_117","",30,0,6);
   st_stack_117->SetMinimum(2.215482);
   st_stack_117->SetMaximum(2.562016e+08);
