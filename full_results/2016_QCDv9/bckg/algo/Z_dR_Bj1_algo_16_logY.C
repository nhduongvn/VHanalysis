...
//=========  (Tue Feb 14 16:02:02 2023) by ROOT version 6.26/06
   ...
   Z_dR_Bj1_algo_16->Range(-1.310117,-0.8719742,7.029799,9.316538);
   ...
   st->SetTitle("");
   st->SetMinimum(10);
   st->SetMaximum(8.324675e+07);
   
   TH1F *st_stack_117 = new TH1F("st_stack_117","",30,0,6);
   st_stack_117->SetMinimum(2.24206);
   st_stack_117->SetMaximum(1.984664e+08);
