...
//=========  (Tue Feb 14 16:02:03 2023) by ROOT version 6.26/06
   ...
   Aplanarity_algo_16->Range(-0.2183529,-0.9603297,1.171633,9.800933);
   ...
   st->SetTitle("");
   st->SetMinimum(10);
   st->SetMaximum(2.151383e+08);
   
   TH1F *st_stack_125 = new TH1F("st_stack_125","",50,0,1);
   st_stack_125->SetMinimum(2.142998);
   st_stack_125->SetMaximum(5.306481e+08);
