...
//=========  (Tue Feb 14 16:02:02 2023) by ROOT version 6.26/06
   ...
   Z_dR_Bj0_algo_16->Range(-1.310117,-0.9080791,7.029799,9.513829);
   ...
   st->SetTitle("");
   st->SetMinimum(10);
   st->SetMaximum(1.225308e+08);
   
   TH1F *st_stack_113 = new TH1F("st_stack_113","",30,0,6);
   st_stack_113->SetMinimum(2.200645);
   st_stack_113->SetMaximum(2.962364e+08);
