...
//=========  (Tue Feb 14 16:02:02 2023) by ROOT version 6.26/06
   ...
   H_dR_Bj1_algo_16->Range(-1.310117,-0.7910896,7.029799,8.877916);
   ...
   st->SetTitle("");
   st->SetMinimum(10);
   st->SetMaximum(3.527746e+07);
   
   TH1F *st_stack_109 = new TH1F("st_stack_109","",30,0,6);
   st_stack_109->SetMinimum(2.339866);
   st_stack_109->SetMaximum(8.147327e+07);
