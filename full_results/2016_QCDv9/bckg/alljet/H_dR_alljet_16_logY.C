...
//=========  (Mon Dec 19 11:15:40 2022) by ROOT version 6.26/06
   ...
   H_dR_alljet_16->Range(-1.353788,1.26368,7.264125,14.86719);
   ...
   st->SetName("st");
   st->SetTitle("");
   st->SetMinimum(4485.528);
   st->SetMaximum(1.115758e+13);
   
   TH1F *st_stack_189 = new TH1F("st_stack_189","",30,0,6);
   st_stack_189->SetMinimum(787.2279);
   st_stack_189->SetMaximum(3.212436e+13);
