...
//=========  (Tue Feb 14 16:02:04 2023) by ROOT version 6.26/06
   ...
   Z_dR_alljet_16->Range(-1.310117,2.258016,7.029799,14.31031);
   ...
   st->SetName("st");
   st->SetTitle("");
   st->SetMinimum(25982.89);
   st->SetMaximum(4.800524e+12);
   
   TH1F *st_stack_209 = new TH1F("st_stack_209","",30,0,6);
   st_stack_209->SetMinimum(5061.635);
   st_stack_209->SetMaximum(1.273733e+13);
