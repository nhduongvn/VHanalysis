...
//=========  (Thu Feb 16 10:37:41 2023) by ROOT version 6.26/06
   ...
   Z_dR_alljet_16->Range(-1.310117,2.257839,7.029799,14.31022);
   ...
   st->SetName("st");
   st->SetTitle("");
   st->SetMinimum(25973.11);
   st->SetMaximum(4.799426e+12);
   
   TH1F *st_stack_209 = new TH1F("st_stack_209","",30,0,6);
   st_stack_209->SetMinimum(5059.697);
   st_stack_209->SetMaximum(1.273448e+13);
