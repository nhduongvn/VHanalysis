...
//=========  (Thu Dec 15 10:05:12 2022) by ROOT version 6.14/09
   ...
   CvB_jets_all_16->Range(-0.2183529,-1.845897e+11,1.171633,1.353658e+12);
   ...
   st->SetName("st");
   st->SetTitle("");
   st->SetMaximum(1.142698e+12);
   
   TH1F *st_stack_57 = new TH1F("st_stack_57","",20,0,1);
   st_stack_57->SetMinimum(0);
   st_stack_57->SetMaximum(1.199833e+12);
   ...
   st_stack_57->GetXaxis()->SetTitle("CvB tagging score");
   st_stack_57->GetXaxis()->SetRange(1,20);
   ...
   st_stack_57->GetYaxis()->SetTitle("Events/0.05");
