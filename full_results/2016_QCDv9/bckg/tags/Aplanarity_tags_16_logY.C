...
//=========  (Thu Feb 16 10:37:38 2023) by ROOT version 6.26/06
   ...
   Aplanarity_tags_16->Range(-0.2183529,-0.9837948,1.171633,9.930464);
   ...
   st->SetTitle("");
   st->SetMinimum(10);
   st->SetMaximum(2.773835e+08);
   
   TH1F *st_stack_61 = new TH1F("st_stack_61","",50,0,1);
   st_stack_61->SetMinimum(2.117953);
   st_stack_61->SetMaximum(6.90301e+08);
