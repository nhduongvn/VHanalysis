...
//=========  (Tue Feb 14 16:02:02 2023) by ROOT version 6.26/06
   ...
   Aplanarity_tags_16->Range(-0.2183529,-1.141664,1.171633,10.8111);
   ...
   st->SetTitle("");
   st->SetMinimum(10);
   st->SetMaximum(1.564609e+09);
   
   TH1F *st_stack_61 = new TH1F("st_stack_61","",50,0,1);
   st_stack_61->SetMinimum(1.96186);
   st_stack_61->SetMaximum(4.128817e+09);
