...
#endif
void nGenJet_all__bckg_16_logY()
{
...
//=========  (Mon Mar  6 10:58:23 2023) by ROOT version 6.26/06
   ...
   nGenJet_all__bckg_16->Range(-3.775293,-0.9836333,17.0745,13.39483);
   ...
   st->SetName("st");
   st->SetTitle("");
   st->SetMinimum(33.00429);
   
   TH1F *st_stack_2 = new TH1F("st_stack_2","",15,-0.5,14.5);
   st_stack_2->SetMinimum(5.518012);
   st_stack_2->SetMaximum(9.057038e+11);
