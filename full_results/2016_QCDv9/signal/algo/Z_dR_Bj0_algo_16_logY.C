...
//=========  (Thu Feb 16 10:37:19 2023) by ROOT version 6.26/06
   ...
   Z_dR_Bj0_algo_16->Range(-1.310117,-0.08132409,7.029799,0.5963767);
   ...
   st->SetTitle("");
   st->SetMinimum(1e+10);
   st->SetMaximum(50.34348);
   
   TH1F *st_stack_113 = new TH1F("st_stack_113","",30,0,6);
   st_stack_113->SetMinimum(-3.175583e+09);
   st_stack_113->SetMaximum(-33.20713);
