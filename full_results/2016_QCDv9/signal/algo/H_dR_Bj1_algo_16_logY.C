...
//=========  (Mon Dec 19 11:10:37 2022) by ROOT version 6.26/06
   ...
   H_dR_Bj1_algo_16->Range(-1.310117,-0.05337741,7.029799,0.3914343);
   ...
   st->SetTitle("");
   st->SetMinimum(1e+10);
   st->SetMaximum(33.04316);
   
   TH1F *st_stack_101 = new TH1F("st_stack_101","",30,0,6);
   st_stack_101->SetMinimum(-3.085982e+09);
   st_stack_101->SetMaximum(-23.00411);
