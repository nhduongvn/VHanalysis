...
//=========  (Thu Feb 16 10:37:19 2023) by ROOT version 6.26/06
   ...
   H_dR_Bj0_algo_16->Range(-1.310117,-0.06752662,7.029799,0.4951952);
   ...
   st->SetTitle("");
   st->SetMinimum(1e+10);
   st->SetMaximum(41.80219);
   
   TH1F *st_stack_105 = new TH1F("st_stack_105","",30,0,6);
   st_stack_105->SetMinimum(-3.135386e+09);
   st_stack_105->SetMaximum(-28.24826);
