...
//=========  (Wed Jan 18 11:42:13 2023) by ROOT version 6.26/06
   ...
   Z_pt_algo_16->Range(-436.7058,-0.09740257,2343.266,0.7142855);
   ...
   st->SetTitle("");
   st->SetMinimum(1e+10);
   st->SetMaximum(51.7475);
   
   TH1F *st_stack_73 = new TH1F("st_stack_73","",40,0,2000);
   st_stack_73->SetMinimum(-3.181618e+09);
   st_stack_73->SetMaximum(-34.0096);
   ...
   VbbHcc_algo_Z_pt_stack_1->SetBinContent(2,0.517475);
   VbbHcc_algo_Z_pt_stack_1->SetBinContent(3,0.4513852);
   VbbHcc_algo_Z_pt_stack_1->SetBinContent(4,0.2060578);
   VbbHcc_algo_Z_pt_stack_1->SetBinContent(5,0.07517916);
   VbbHcc_algo_Z_pt_stack_1->SetBinContent(6,0.05035643);
   ...
   VbbHcc_algo_Z_pt_stack_1->SetBinError(2,0.02876005);
   VbbHcc_algo_Z_pt_stack_1->SetBinError(3,0.02659152);
   VbbHcc_algo_Z_pt_stack_1->SetBinError(4,0.01814955);
   VbbHcc_algo_Z_pt_stack_1->SetBinError(5,0.01067732);
   VbbHcc_algo_Z_pt_stack_1->SetBinError(6,0.00886681);
   ...
   VbbHcc_algo_Z_pt_stack_1->SetEntries(1088);
