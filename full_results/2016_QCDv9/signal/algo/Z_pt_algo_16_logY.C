...
//=========  (Thu Feb  9 09:44:32 2023) by ROOT version 6.14/09
   ...
   Z_pt_algo_16->Range(-436.7058,-0.1456566,2343.266,1.068148);
   ...
   st->SetTitle("");
   st->SetMinimum(1e+10);
   st->SetMaximum(90.16835);
   
   TH1F *st_stack_73 = new TH1F("st_stack_73","",40,0,2000);
   st_stack_73->SetMinimum(-3.308549e+09);
   st_stack_73->SetMaximum(-54.91155);
   ...
   VbbHcc_algo_Z_pt_stack_1->SetBinContent(1,0.1460873);
   VbbHcc_algo_Z_pt_stack_1->SetBinContent(2,0.7585166);
   VbbHcc_algo_Z_pt_stack_1->SetBinContent(3,0.6701867);
   VbbHcc_algo_Z_pt_stack_1->SetBinContent(4,0.3288792);
   VbbHcc_algo_Z_pt_stack_1->SetBinContent(5,0.1835196);
   ...
   VbbHcc_algo_Z_pt_stack_1->SetBinError(1,0.02122265);
   VbbHcc_algo_Z_pt_stack_1->SetBinError(2,0.04772953);
   VbbHcc_algo_Z_pt_stack_1->SetBinError(3,0.045327);
   VbbHcc_algo_Z_pt_stack_1->SetBinError(4,0.03162155);
   VbbHcc_algo_Z_pt_stack_1->SetBinError(5,0.023566);
   ...
   VbbHcc_algo_Z_pt_stack_1->SetEntries(816);
   ...
   VbbHcc_algo_Z_pt_stack_2->SetBinContent(1,0.01714443);
   VbbHcc_algo_Z_pt_stack_2->SetBinContent(2,0.1115092);
   VbbHcc_algo_Z_pt_stack_2->SetBinContent(3,0.2314969);
   VbbHcc_algo_Z_pt_stack_2->SetBinContent(4,0.1311805);
   VbbHcc_algo_Z_pt_stack_2->SetBinContent(5,0.06483561);
   VbbHcc_algo_Z_pt_stack_2->SetBinContent(6,0.03528418);
   ...
   VbbHcc_algo_Z_pt_stack_2->SetBinError(1,0.002552133);
   VbbHcc_algo_Z_pt_stack_2->SetBinError(2,0.006534951);
   VbbHcc_algo_Z_pt_stack_2->SetBinError(3,0.009459208);
   VbbHcc_algo_Z_pt_stack_2->SetBinError(4,0.007090493);
   VbbHcc_algo_Z_pt_stack_2->SetBinError(5,0.00501346);
   VbbHcc_algo_Z_pt_stack_2->SetBinError(6,0.00366474);
   ...
   VbbHcc_algo_Z_pt_stack_2->SetEntries(1618);
