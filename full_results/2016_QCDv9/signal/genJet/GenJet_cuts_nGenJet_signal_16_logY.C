...
#endif
void GenJet_cuts_nGenJet_signal_16_logY()
{
...
//=========  (Thu Mar  9 15:52:23 2023) by ROOT version 6.26/06
   ...
   GenJet_cuts_nGenJet_signal_16->Range(-4.867058,-0.807338,22.93266,3.017193);
   ...
   GenJet_cuts_nGenJet_signal_16->SetLogy();
   ...
   st_stack_73->SetMinimum(0.4483382);
   st_stack_73->SetMaximum(431.2609);
