...
#endif
void nGenGlu_all__signal_16_logY()
{
...
//=========  (Mon Mar  6 10:58:23 2023) by ROOT version 6.26/06
   ...
   nGenGlu_all__signal_16->Range(-3.775293,0.5058542,17.0745,2.715754);
   ...
   nGenGlu_all__signal_16->SetLogy();
   ...
   st_stack_25->SetMinimum(5.902585);
   st_stack_25->SetMaximum(312.4383);
