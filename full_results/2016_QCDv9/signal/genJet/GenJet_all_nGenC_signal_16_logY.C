...
#endif
void GenJet_all_nGenC_signal_16_logY()
{
...
//=========  (Thu Mar  9 15:52:21 2023) by ROOT version 6.26/06
   ...
   GenJet_all_nGenC_signal_16->Range(-4.867058,-0.8890025,22.93266,3.37977);
   ...
   GenJet_all_nGenC_signal_16->SetLogy();
   ...
   st_stack_19->SetMinimum(0.4200009);
   st_stack_19->SetMaximum(897.2073);
