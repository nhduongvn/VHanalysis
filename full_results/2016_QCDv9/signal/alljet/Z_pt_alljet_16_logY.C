...
//=========  (Thu Feb  9 09:44:36 2023) by ROOT version 6.14/09
   ...
   Z_pt_alljet_16->Range(37.97653,-0.1020226,1705.96,5.365513);
   ...
   st->SetTitle("");
   st->SetMinimum(10);
   st->SetMaximum(38374.05);
   
   TH1F *st_stack_201 = new TH1F("st_stack_201","",40,0,2000);
   st_stack_201->SetMinimum(3.581638);
   st_stack_201->SetMaximum(65880.85);
   ...
   st_stack_201->GetYaxis()->SetLabelSize(0.035);
   st_stack_201->GetYaxis()->SetTitleSize(0.037);
   st_stack_201->GetYaxis()->SetTitleOffset(0);
