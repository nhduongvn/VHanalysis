...
//=========  (Wed Mar  1 15:14:08 2023) by ROOT version 6.26/06
   ...
   overlay_jets_CvB_16->Range(-0.2,-3.42358,1.133333,0.01997924);
   ...
   st_stack_64->SetMinimum(0.0008332518);
   st_stack_64->SetMaximum(0.4738308);
   ...
   VbbHcc_jets_CvB_stack_2->SetBinContent(1,0.01266249);
   VbbHcc_jets_CvB_stack_2->SetBinContent(2,0.00257466);
   VbbHcc_jets_CvB_stack_2->SetBinContent(3,0.001973823);
   VbbHcc_jets_CvB_stack_2->SetBinContent(4,0.00199194);
   VbbHcc_jets_CvB_stack_2->SetBinContent(5,0.002254898);
   VbbHcc_jets_CvB_stack_2->SetBinContent(6,0.002655634);
   VbbHcc_jets_CvB_stack_2->SetBinContent(7,0.003184299);
   VbbHcc_jets_CvB_stack_2->SetBinContent(8,0.003944923);
   VbbHcc_jets_CvB_stack_2->SetBinContent(9,0.00521028);
   VbbHcc_jets_CvB_stack_2->SetBinContent(10,0.007456908);
   VbbHcc_jets_CvB_stack_2->SetBinContent(11,0.01045908);
   VbbHcc_jets_CvB_stack_2->SetBinContent(12,0.01460618);
   VbbHcc_jets_CvB_stack_2->SetBinContent(13,0.02178094);
   VbbHcc_jets_CvB_stack_2->SetBinContent(14,0.03274737);
   VbbHcc_jets_CvB_stack_2->SetBinContent(15,0.05419819);
   VbbHcc_jets_CvB_stack_2->SetBinContent(16,0.09284032);
   VbbHcc_jets_CvB_stack_2->SetBinContent(17,0.1739424);
   VbbHcc_jets_CvB_stack_2->SetBinContent(18,0.3261557);
   VbbHcc_jets_CvB_stack_2->SetBinContent(19,0.2118276);
   VbbHcc_jets_CvB_stack_2->SetBinContent(20,0.01753233);
   VbbHcc_jets_CvB_stack_2->SetBinError(1,1.684527e-05);
   VbbHcc_jets_CvB_stack_2->SetBinError(2,7.582758e-06);
   VbbHcc_jets_CvB_stack_2->SetBinError(3,6.653807e-06);
   VbbHcc_jets_CvB_stack_2->SetBinError(4,6.69598e-06);
   VbbHcc_jets_CvB_stack_2->SetBinError(5,7.142381e-06);
   VbbHcc_jets_CvB_stack_2->SetBinError(6,7.782254e-06);
   VbbHcc_jets_CvB_stack_2->SetBinError(7,8.547325e-06);
   VbbHcc_jets_CvB_stack_2->SetBinError(8,9.525744e-06);
   VbbHcc_jets_CvB_stack_2->SetBinError(9,1.097037e-05);
   VbbHcc_jets_CvB_stack_2->SetBinError(10,1.315537e-05);
   VbbHcc_jets_CvB_stack_2->SetBinError(11,1.561469e-05);
   VbbHcc_jets_CvB_stack_2->SetBinError(12,1.846931e-05);
   VbbHcc_jets_CvB_stack_2->SetBinError(13,2.256224e-05);
   VbbHcc_jets_CvB_stack_2->SetBinError(14,2.772553e-05);
   VbbHcc_jets_CvB_stack_2->SetBinError(15,3.571721e-05);
   VbbHcc_jets_CvB_stack_2->SetBinError(16,4.685066e-05);
   VbbHcc_jets_CvB_stack_2->SetBinError(17,6.405559e-05);
   VbbHcc_jets_CvB_stack_2->SetBinError(18,8.768706e-05);
   VbbHcc_jets_CvB_stack_2->SetBinError(19,7.14914e-05);
   VbbHcc_jets_CvB_stack_2->SetBinError(20,1.985102e-05);
   VbbHcc_jets_CvB_stack_2->SetEntries(1.9762e+09);
