...
//=========  (Tue Dec  6 10:50:11 2022) by ROOT version 6.14/09
   ...
   Z_pt_algo_16->Range(150,-333474,1650,3001275);
   ...
   TH1F *st_stack_49 = new TH1F("st_stack_49","",40,0,2000);
   st_stack_49->SetMinimum(1);
   st_stack_49->SetMaximum(2667801);
   ...
   st_stack_49->GetXaxis()->SetRange(7,30);
   ...
   st_stack_49->GetYaxis()->SetTitle("Events/50.0");
