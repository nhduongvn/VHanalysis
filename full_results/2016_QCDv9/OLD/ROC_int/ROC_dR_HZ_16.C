...
//=========  (Wed Jan 25 10:51:22 2023) by ROOT version 6.26/06
   ...
   0.9920537,
   0.9950834};
   TGraph *graph = new TGraph(28,Graph_fx58,Graph_fy58);
   graph->SetName("Graph");
   ...
   TH1F *Graph_Graph58 = new TH1F("Graph_Graph58","Tagging Only",100,0,1.086723);
   Graph_Graph58->SetMinimum(0.05131649);
   Graph_Graph58->SetMaximum(1.08088);
   ...
   TLatex *   tex = new TLatex(0.1211644,0.2571619,"#pm0");
   tex->SetTextSize(0.02);
   tex->SetLineWidth(2);
   tex->Draw();
   graph->GetListOfFunctions()->Add(59);
      tex = new TLatex(0.2674187,0.5545174,"#pm1");
   tex->SetTextSize(0.02);
   tex->SetLineWidth(2);
   tex->Draw();
   graph->GetListOfFunctions()->Add(60);
      tex = new TLatex(0.3917257,0.7359301,"#pm2");
   tex->SetTextSize(0.02);
   tex->SetLineWidth(2);
   tex->Draw();
   graph->GetListOfFunctions()->Add(61);
      tex = new TLatex(0.4726673,0.8450269,"#pm3");
   tex->SetTextSize(0.02);
   tex->SetLineWidth(2);
   tex->Draw();
   graph->GetListOfFunctions()->Add(62);
      tex = new TLatex(0.5426335,0.8967959,"#pm4");
   tex->SetTextSize(0.02);
   tex->SetLineWidth(2);
   tex->Draw();
   graph->GetListOfFunctions()->Add(63);
      tex = new TLatex(0.6022804,0.9383321,"#pm5");
   tex->SetTextSize(0.02);
   tex->SetLineWidth(2);
   tex->Draw();
   graph->GetListOfFunctions()->Add(64);
      tex = new TLatex(0.6619487,0.968092,"#pm6");
   tex->SetTextSize(0.02);
   tex->SetLineWidth(2);
   tex->Draw();
   graph->GetListOfFunctions()->Add(65);
      tex = new TLatex(0.7115891,0.9860552,"#pm7");
   tex->SetTextSize(0.02);
   tex->SetLineWidth(2);
   tex->Draw();
   graph->GetListOfFunctions()->Add(66);
      tex = new TLatex(0.7537487,0.9984283,"#pm8");
   tex->SetTextSize(0.02);
   tex->SetLineWidth(2);
   tex->Draw();
   graph->GetListOfFunctions()->Add(67);
      tex = new TLatex(0.7829373,1.00947,"#pm9");
   tex->SetTextSize(0.02);
   tex->SetLineWidth(2);
   tex->Draw();
   ...
   1,
   1};
   graph = new TGraph(28,Graph_fx69,Graph_fy69);
   graph->SetName("Graph");
   ...
   TH1F *Graph_Graph69 = new TH1F("Graph_Graph69","Mass-Matching Prioritized",100,0.03338037,1.086789);
   Graph_Graph69->SetMinimum(0.1388781);
   Graph_Graph69->SetMaximum(1.078284);
   ...
   0.9967841,
   0.9988259};
   graph = new TGraph(29,Graph_fx70,Graph_fy70);
   graph->SetName("Graph");
   ...
   TH1F *Graph_Graph70 = new TH1F("Graph_Graph70","Tagging Prioritized",100,0,1.090286);
   Graph_Graph70->SetMinimum(0.04327728);
   Graph_Graph70->SetMaximum(1.085694);
