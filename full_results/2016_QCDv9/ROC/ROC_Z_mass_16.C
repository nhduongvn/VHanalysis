...
//=========  (Thu Feb 16 10:46:54 2023) by ROOT version 6.26/06
   ...
   0.7768234,
   0.7986816};
   TGraph *graph = new TGraph(8,Graph_fx879,Graph_fy879);
   graph->SetName("Graph");
   ...
   TH1F *Graph_Graph879 = new TH1F("Graph_Graph879","Tagging Only",100,0,0.6764085);
   Graph_Graph879->SetMinimum(0.1308734);
   Graph_Graph879->SetMaximum(0.8593915);
   Graph_Graph879->SetDirectory(0);
   Graph_Graph879->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph879->SetLineColor(ci);
   Graph_Graph879->GetXaxis()->SetLabelFont(42);
   Graph_Graph879->GetXaxis()->SetTitleOffset(1);
   ...
   Graph_Graph879->GetZaxis()->SetTitleOffset(1);
   ...
   0.9451933,
   0.9537746};
   graph = new TGraph(8,Graph_fx887,Graph_fy887);
   graph->SetName("Graph");
   ...
   TH1F *Graph_Graph887 = new TH1F("Graph_Graph887","Mass-Matching Prioritized",100,0,0.8311075);
   Graph_Graph887->SetMinimum(0.2371392);
   Graph_Graph887->SetMaximum(1.018923);
   Graph_Graph887->SetDirectory(0);
   Graph_Graph887->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph887->SetLineColor(ci);
   Graph_Graph887->GetXaxis()->SetLabelFont(42);
   Graph_Graph887->GetXaxis()->SetTitleOffset(1);
   ...
   0.7781037,
   0.7991149};
   graph = new TGraph(8,Graph_fx888,Graph_fy888);
   graph->SetName("Graph");
   ...
   TH1F *Graph_Graph888 = new TH1F("Graph_Graph888","Tagging Prioritized",100,0,0.6743188);
   Graph_Graph888->SetMinimum(0.132282);
   Graph_Graph888->SetMaximum(0.859736);
   Graph_Graph888->SetDirectory(0);
   Graph_Graph888->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph888->SetLineColor(ci);
   Graph_Graph888->GetXaxis()->SetLabelFont(42);
   Graph_Graph888->GetXaxis()->SetTitleOffset(1);
   ...
   Graph_Graph888->GetZaxis()->SetTitleOffset(1);
