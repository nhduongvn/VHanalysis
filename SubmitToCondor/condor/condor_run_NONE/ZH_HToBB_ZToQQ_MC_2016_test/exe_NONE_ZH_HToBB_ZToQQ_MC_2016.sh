...
xrdcp *.root root://cmseos.fnal.gov//store/user/peteryou/Output_VH/NONE//ZH_HToBB_ZToQQ_MC_2016/ 
rm *.root 
echo "xrdcp *.root root://cmseos.fnal.gov//store/user/peteryou/Output_VH/NONE//ZH_HToBB_ZToQQ_MC_2016/" 
