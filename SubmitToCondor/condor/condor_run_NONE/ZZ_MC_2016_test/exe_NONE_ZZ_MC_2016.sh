...
xrdcp *.root root://cmseos.fnal.gov//store/user/peteryou/Output_VH/NONE//ZZ_MC_2016/ 
rm *.root 
echo "xrdcp *.root root://cmseos.fnal.gov//store/user/peteryou/Output_VH/NONE//ZZ_MC_2016/" 
