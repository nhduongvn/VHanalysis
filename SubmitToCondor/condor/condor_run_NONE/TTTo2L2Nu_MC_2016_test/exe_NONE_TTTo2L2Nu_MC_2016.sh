...
xrdcp *.root root://cmseos.fnal.gov//store/user/peteryou/Output_VH/NONE//TTTo2L2Nu_MC_2016/ 
rm *.root 
echo "xrdcp *.root root://cmseos.fnal.gov//store/user/peteryou/Output_VH/NONE//TTTo2L2Nu_MC_2016/" 
