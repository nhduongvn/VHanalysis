...
condorRunDir = '/uscmst1b_scratch/lpc1/lpcphys/peteryou/Output_VH/trigger_efficiency_NEW/'
outputDir_eos = '/store/user/peteryou/Output_VH/mediumWP_updates042023/'+syst+'/' 
outputDir_eos = '/store/user/peteryou/Output_VH/trigger_efficiency_NEW/'+syst+'/'
...
outputDir_scratch = '/uscms_data/d3/peteryou/CMSSW_10_6_4/src/VHanalysis/condor_results/trigger_efficiency_NEW/' + syst + '/'
#Input data sets
