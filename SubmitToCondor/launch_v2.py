...
condorRunDir = '/uscmst1b_scratch/lpc1/lpcphys/peteryou/Output_VH/mediumWP_viaFlavor/'
outputDir_eos = '/store/user/peteryou/Output_VH/mediumWP_viaFlavor/'+syst+'/' 
...
outputDir_scratch = '/uscms_data/d3/peteryou/CMSSW_10_6_4/src/VHanalysis/condor_results/mediumWP_viaFlavor/' + syst + '/'
