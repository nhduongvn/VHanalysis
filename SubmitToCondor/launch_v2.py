...
condorRunDir = '/uscmst1b_scratch/lpc1/lpcphys/peteryou/Output_VH/mediumWP_updated/'
outputDir_eos = '/store/user/peteryou/Output_VH/mediumWP_updated/'+syst+'/' 
...
outputDir_scratch = '/uscms_data/d3/peteryou/CMSSW_10_6_4/src/VHanalysis/condor_results/mediumWP_updated/' + syst + '/'
